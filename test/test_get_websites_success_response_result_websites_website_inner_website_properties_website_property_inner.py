...
class TestGetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner(unittest.TestCase):
    """GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner:
        """Test GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner`
        """
        model = GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner()
        if include_optional:
            return GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner(
                property_id = '160681',
    ...
    def testGetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner(self):
        """Test GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner"""
