...
class TestGetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValues(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValues:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValues
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValues`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValues()
        if include_optional:
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValues(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValues"""
