...
class TestSendJournalEntriesSuccessResponseResultGlHeaders(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendJournalEntriesSuccessResponseResultGlHeaders:
        """Test SendJournalEntriesSuccessResponseResultGlHeaders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendJournalEntriesSuccessResponseResultGlHeaders`
        """
        model = SendJournalEntriesSuccessResponseResultGlHeaders()
        if include_optional:
    ...
    def testSendJournalEntriesSuccessResponseResultGlHeaders(self):
        """Test SendJournalEntriesSuccessResponseResultGlHeaders"""
