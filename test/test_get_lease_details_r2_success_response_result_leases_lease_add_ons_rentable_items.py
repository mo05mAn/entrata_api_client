...
class TestGetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems:
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems`
        """
    ...
    def testGetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems(self):
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems"""
