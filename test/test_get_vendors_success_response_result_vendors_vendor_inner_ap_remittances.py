...
class TestGetVendorsSuccessResponseResultVendorsVendorInnerApRemittances(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendorsVendorInnerApRemittances:
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerApRemittances
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendorsVendorInnerApRemittances`
        """
        model = GetVendorsSuccessResponseResultVendorsVendorInnerApRemittances()
        if include_optional:
    ...
    def testGetVendorsSuccessResponseResultVendorsVendorInnerApRemittances(self):
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerApRemittances"""
