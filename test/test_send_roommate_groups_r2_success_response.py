...
class TestSendRoommateGroupsR2SuccessResponse(unittest.TestCase):
    """SendRoommateGroupsR2SuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRoommateGroupsR2SuccessResponse:
        """Test SendRoommateGroupsR2SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRoommateGroupsR2SuccessResponse`
        """
        model = SendRoommateGroupsR2SuccessResponse()
        if include_optional:
            return SendRoommateGroupsR2SuccessResponse(
                response = entrata_api_client.models.send_roommate_groups_r2_success_response_response.sendRoommateGroups_r2_SuccessResponse_response(
                    request_id = '15', 
                    code = 200, 
    ...
    def testSendRoommateGroupsR2SuccessResponse(self):
        """Test SendRoommateGroupsR2SuccessResponse"""
