...
class TestGetPropertiesMethodParams(unittest.TestCase):
    """GetPropertiesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertiesMethodParams:
        """Test GetPropertiesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertiesMethodParams`
        """
        model = GetPropertiesMethodParams()
        if include_optional:
            return GetPropertiesMethodParams(
    ...
    def testGetPropertiesMethodParams(self):
        """Test GetPropertiesMethodParams"""
