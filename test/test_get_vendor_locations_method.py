...
class TestGetVendorLocationsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsMethod:
        """Test GetVendorLocationsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsMethod`
        """
        model = GetVendorLocationsMethod()
        if include_optional:
    ...
    def testGetVendorLocationsMethod(self):
        """Test GetVendorLocationsMethod"""
