...
class TestGetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner(unittest.TestCase):
    """GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner:
        """Test GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner`
        """
        model = GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner()
        if include_optional:
            return GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner(
                id = '632',
    ...
    def testGetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner(self):
        """Test GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner"""
