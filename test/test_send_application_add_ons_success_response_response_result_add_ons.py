...
class TestSendApplicationAddOnsSuccessResponseResponseResultAddOns(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationAddOnsSuccessResponseResponseResultAddOns:
        """Test SendApplicationAddOnsSuccessResponseResponseResultAddOns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationAddOnsSuccessResponseResponseResultAddOns`
        """
        model = SendApplicationAddOnsSuccessResponseResponseResultAddOns()
        if include_optional:
    ...
    def testSendApplicationAddOnsSuccessResponseResponseResultAddOns(self):
        """Test SendApplicationAddOnsSuccessResponseResponseResultAddOns"""
