...
class TestUpdateCustomersSuccessResponse(unittest.TestCase):
    """UpdateCustomersSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCustomersSuccessResponse:
        """Test UpdateCustomersSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomersSuccessResponse`
        """
        model = UpdateCustomersSuccessResponse()
        if include_optional:
            return UpdateCustomersSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.update_customers_success_response_result.updateCustomersSuccessResponse_result(
    ...
    def testUpdateCustomersSuccessResponse(self):
        """Test UpdateCustomersSuccessResponse"""
