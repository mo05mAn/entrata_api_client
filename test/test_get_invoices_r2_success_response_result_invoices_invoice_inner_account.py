...
class TestGetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerAccount(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerAccount:
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerAccount`
        """
        model = GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerAccount()
        if include_optional:
            return GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerAccount(
                id = '12345',
    ...
    def testGetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerAccount(self):
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerAccount"""
