...
class TestSendWorkOrdersSuccessResponseResponse(unittest.TestCase):
    """SendWorkOrdersSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendWorkOrdersSuccessResponseResponse:
        """Test SendWorkOrdersSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendWorkOrdersSuccessResponseResponse`
        """
        model = SendWorkOrdersSuccessResponseResponse()
        if include_optional:
            return SendWorkOrdersSuccessResponseResponse(
                code = 200,
    ...
    def testSendWorkOrdersSuccessResponseResponse(self):
        """Test SendWorkOrdersSuccessResponseResponse"""
