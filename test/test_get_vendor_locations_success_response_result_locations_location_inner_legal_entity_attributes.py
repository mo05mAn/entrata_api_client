...
class TestGetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes(unittest.TestCase):
    """GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes:
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes`
        """
        model = GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes()
        if include_optional:
            return GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes(
                id = '470'
            )
        else:
            return GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes(
    ...
    def testGetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes(self):
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes"""
