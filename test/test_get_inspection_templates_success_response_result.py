...
class TestGetInspectionTemplatesSuccessResponseResult(unittest.TestCase):
    """GetInspectionTemplatesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInspectionTemplatesSuccessResponseResult:
        """Test GetInspectionTemplatesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionTemplatesSuccessResponseResult`
        """
        model = GetInspectionTemplatesSuccessResponseResult()
        if include_optional:
            return GetInspectionTemplatesSuccessResponseResult(
    ...
    def testGetInspectionTemplatesSuccessResponseResult(self):
        """Test GetInspectionTemplatesSuccessResponseResult"""
