...
class TestGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTerms(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTerms:
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTerms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTerms`
        """
        model = GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTerms()
        if include_optional:
    ...
    def testGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTerms(self):
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTerms"""
