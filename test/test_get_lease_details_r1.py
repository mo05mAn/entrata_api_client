...
class TestGetLeaseDetailsR1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1:
        """Test GetLeaseDetailsR1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1`
        """
    ...
    def testGetLeaseDetailsR1(self):
        """Test GetLeaseDetailsR1"""
