...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyCategories(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyCategories:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyCategories
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyCategories`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyCategories()
        if include_optional:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyCategories(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyCategories"""
