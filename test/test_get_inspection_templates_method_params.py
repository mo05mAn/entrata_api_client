...
class TestGetInspectionTemplatesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInspectionTemplatesMethodParams:
        """Test GetInspectionTemplatesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionTemplatesMethodParams`
        """
        model = GetInspectionTemplatesMethodParams()
        if include_optional:
            return GetInspectionTemplatesMethodParams(
    ...
    def testGetInspectionTemplatesMethodParams(self):
        """Test GetInspectionTemplatesMethodParams"""
