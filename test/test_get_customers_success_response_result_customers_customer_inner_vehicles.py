...
class TestGetCustomersSuccessResponseResultCustomersCustomerInnerVehicles(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInnerVehicles:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerVehicles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInnerVehicles`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInnerVehicles()
        if include_optional:
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInnerVehicles(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerVehicles"""
