...
class TestGetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes:
        """Test GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes(
                id = '4446',
                name = 'Net 15'
            )
        else:
    ...
    def testGetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes"""
