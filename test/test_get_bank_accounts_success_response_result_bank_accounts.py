...
class TestGetBankAccountsSuccessResponseResultBankAccounts(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBankAccountsSuccessResponseResultBankAccounts:
        """Test GetBankAccountsSuccessResponseResultBankAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBankAccountsSuccessResponseResultBankAccounts`
        """
        model = GetBankAccountsSuccessResponseResultBankAccounts()
        if include_optional:
    ...
    def testGetBankAccountsSuccessResponseResultBankAccounts(self):
        """Test GetBankAccountsSuccessResponseResultBankAccounts"""
