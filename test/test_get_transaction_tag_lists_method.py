...
class TestGetTransactionTagListsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionTagListsMethod:
        """Test GetTransactionTagListsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTransactionTagListsMethod`
        """
        model = GetTransactionTagListsMethod()
        if include_optional:
            return GetTransactionTagListsMethod(
    ...
    def testGetTransactionTagListsMethod(self):
        """Test GetTransactionTagListsMethod"""
