...
class TestGetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner(unittest.TestCase):
    """GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner()
        if include_optional:
            return GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner(
                id = 6789,
                value = 'test123',
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner"""
