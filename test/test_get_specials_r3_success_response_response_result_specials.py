...
class TestGetSpecialsR3SuccessResponseResponseResultSpecials(unittest.TestCase):
    """GetSpecialsR3SuccessResponseResponseResultSpecials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResultSpecials:
        """Test GetSpecialsR3SuccessResponseResponseResultSpecials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResultSpecials`
        """
        model = GetSpecialsR3SuccessResponseResponseResultSpecials()
        if include_optional:
            return GetSpecialsR3SuccessResponseResponseResultSpecials(
                property_id = 171712,
    ...
    def testGetSpecialsR3SuccessResponseResponseResultSpecials(self):
        """Test GetSpecialsR3SuccessResponseResponseResultSpecials"""
