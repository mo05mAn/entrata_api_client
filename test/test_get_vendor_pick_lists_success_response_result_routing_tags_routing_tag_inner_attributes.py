...
class TestGetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes:
        """Test GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes(
                id = '93',
                name = 'routingTag1'
            )
        else:
    ...
    def testGetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes"""
