...
class TestGetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer:
        """Test GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer`
        """
    ...
    def testGetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer(self):
        """Test GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer"""
