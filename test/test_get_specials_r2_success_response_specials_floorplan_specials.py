...
class TestGetSpecialsR2SuccessResponseSpecialsFloorplanSpecials(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecialsFloorplanSpecials:
        """Test GetSpecialsR2SuccessResponseSpecialsFloorplanSpecials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecialsFloorplanSpecials`
        """
    ...
    def testGetSpecialsR2SuccessResponseSpecialsFloorplanSpecials(self):
        """Test GetSpecialsR2SuccessResponseSpecialsFloorplanSpecials"""
