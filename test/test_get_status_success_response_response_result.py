...
class TestGetStatusSuccessResponseResponseResult(unittest.TestCase):
    """GetStatusSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStatusSuccessResponseResponseResult:
        """Test GetStatusSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatusSuccessResponseResponseResult`
        """
        model = GetStatusSuccessResponseResponseResult()
        if include_optional:
            return GetStatusSuccessResponseResponseResult(
                status = 'Success',
    ...
    def testGetStatusSuccessResponseResponseResult(self):
        """Test GetStatusSuccessResponseResponseResult"""
