...
class TestUpdateAmenitiesSuccessResponseResponseResultPropertyAmenities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponseResponseResultPropertyAmenities:
        """Test UpdateAmenitiesSuccessResponseResponseResultPropertyAmenities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponseResponseResultPropertyAmenities`
        """
        model = UpdateAmenitiesSuccessResponseResponseResultPropertyAmenities()
        if include_optional:
    ...
    def testUpdateAmenitiesSuccessResponseResponseResultPropertyAmenities(self):
        """Test UpdateAmenitiesSuccessResponseResponseResultPropertyAmenities"""
