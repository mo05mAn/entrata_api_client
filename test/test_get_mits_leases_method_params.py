...
class TestGetMitsLeasesMethodParams(unittest.TestCase):
    """GetMitsLeasesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesMethodParams:
        """Test GetMitsLeasesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesMethodParams`
        """
        model = GetMitsLeasesMethodParams()
        if include_optional:
            return GetMitsLeasesMethodParams(
                property_id = 123456,
                customer_id = 123456,
    ...
    def testGetMitsLeasesMethodParams(self):
        """Test GetMitsLeasesMethodParams"""
