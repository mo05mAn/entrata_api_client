...
class TestSendApplicationVehiclesMethodParams(unittest.TestCase):
    """SendApplicationVehiclesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationVehiclesMethodParams:
        """Test SendApplicationVehiclesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationVehiclesMethodParams`
        """
        model = SendApplicationVehiclesMethodParams()
        if include_optional:
            return SendApplicationVehiclesMethodParams(
                vehicle_type_id = 2
            )
        else:
            return SendApplicationVehiclesMethodParams(
    ...
    def testSendApplicationVehiclesMethodParams(self):
        """Test SendApplicationVehiclesMethodParams"""
