...
class TestGetQuotesSuccessResponseResultApplicationsApplicationInner(unittest.TestCase):
    """GetQuotesSuccessResponseResultApplicationsApplicationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetQuotesSuccessResponseResultApplicationsApplicationInner:
        """Test GetQuotesSuccessResponseResultApplicationsApplicationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuotesSuccessResponseResultApplicationsApplicationInner`
        """
        model = GetQuotesSuccessResponseResultApplicationsApplicationInner()
        if include_optional:
            return GetQuotesSuccessResponseResultApplicationsApplicationInner(
    ...
    def testGetQuotesSuccessResponseResultApplicationsApplicationInner(self):
        """Test GetQuotesSuccessResponseResultApplicationsApplicationInner"""
