    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponse:
        ...
        if include_optional:
            return GetWorkOrderPickListsSuccessResponse(
                request_id = '15',
                code = '200',
                result = openapi_client.models.get_work_order_pick_lists_success_response_result.getWorkOrderPickListsSuccessResponse_result(
                    property = openapi_client.models.get_work_order_pick_lists_success_response_result_property.getWorkOrderPickListsSuccessResponse_result_Property(
