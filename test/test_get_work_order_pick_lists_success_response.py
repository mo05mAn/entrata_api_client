...
class TestGetWorkOrderPickListsSuccessResponse(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponse:
        """Test GetWorkOrderPickListsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponse`
        """
        model = GetWorkOrderPickListsSuccessResponse()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_work_order_pick_lists_success_response_result.getWorkOrderPickListsSuccessResponse_result(
                    property = entrata_api_client.models.get_work_order_pick_lists_success_response_result_property.getWorkOrderPickListsSuccessResponse_result_Property(
    ...
    def testGetWorkOrderPickListsSuccessResponse(self):
        """Test GetWorkOrderPickListsSuccessResponse"""
