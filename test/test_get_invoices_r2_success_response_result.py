...
class TestGetInvoicesR2SuccessResponseResult(unittest.TestCase):
    """GetInvoicesR2SuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2SuccessResponseResult:
        """Test GetInvoicesR2SuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2SuccessResponseResult`
        """
        model = GetInvoicesR2SuccessResponseResult()
        if include_optional:
            return GetInvoicesR2SuccessResponseResult(
    ...
    def testGetInvoicesR2SuccessResponseResult(self):
        """Test GetInvoicesR2SuccessResponseResult"""
