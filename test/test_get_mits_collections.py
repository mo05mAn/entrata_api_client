...
class TestGetMitsCollections(unittest.TestCase):
    """GetMitsCollections unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsCollections:
        """Test GetMitsCollections
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsCollections`
        """
        model = GetMitsCollections()
        if include_optional:
            return GetMitsCollections(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_mits_collections_method.getMitsCollections_method(
    ...
    def testGetMitsCollections(self):
        """Test GetMitsCollections"""
