...
class TestGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner(unittest.TestCase):
    """GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner:
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner`
        """
        model = GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner()
        if include_optional:
            return GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner(
    ...
    def testGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner(self):
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner"""
