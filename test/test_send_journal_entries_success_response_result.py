...
class TestSendJournalEntriesSuccessResponseResult(unittest.TestCase):
    """SendJournalEntriesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendJournalEntriesSuccessResponseResult:
        """Test SendJournalEntriesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendJournalEntriesSuccessResponseResult`
        """
        model = SendJournalEntriesSuccessResponseResult()
        if include_optional:
            return SendJournalEntriesSuccessResponseResult(
    ...
    def testSendJournalEntriesSuccessResponseResult(self):
        """Test SendJournalEntriesSuccessResponseResult"""
