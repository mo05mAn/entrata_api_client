...
class TestGetReservableAmenitiesMethodParams(unittest.TestCase):
    """GetReservableAmenitiesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesMethodParams:
        """Test GetReservableAmenitiesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservableAmenitiesMethodParams`
        """
        model = GetReservableAmenitiesMethodParams()
        if include_optional:
            return GetReservableAmenitiesMethodParams(
                property_id = 12345,
                amenity_ids = 56
            )
        else:
    ...
    def testGetReservableAmenitiesMethodParams(self):
        """Test GetReservableAmenitiesMethodParams"""
