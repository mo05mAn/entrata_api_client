...
class TestGetTaxFormDataSuccessResponse(unittest.TestCase):
    """GetTaxFormDataSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxFormDataSuccessResponse:
        """Test GetTaxFormDataSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxFormDataSuccessResponse`
        """
        model = GetTaxFormDataSuccessResponse()
        if include_optional:
            return GetTaxFormDataSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_tax_form_data_success_response_result.getTaxFormDataSuccessResponse_result(
                    properties = entrata_api_client.models.get_tax_form_data_success_response_result_properties.getTaxFormDataSuccessResponse_result_Properties(
                        property = [
                            entrata_api_client.models.get_tax_form_data_success_response_result_properties_property_inner.getTaxFormDataSuccessResponse_result_Properties_property_inner(
    ...
    def testGetTaxFormDataSuccessResponse(self):
        """Test GetTaxFormDataSuccessResponse"""
