    ...
    def make_instance(self, include_optional) -> GetTaxFormDataSuccessResponse:
        ...
        if include_optional:
            return GetTaxFormDataSuccessResponse(
                request_id = '15',
                code = '200',
                result = openapi_client.models.get_tax_form_data_success_response_result.getTaxFormDataSuccessResponse_result(
                    properties = openapi_client.models.get_tax_form_data_success_response_result_properties.getTaxFormDataSuccessResponse_result_Properties(
                        property = [
