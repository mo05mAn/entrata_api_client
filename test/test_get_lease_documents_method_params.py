...
class TestGetLeaseDocumentsMethodParams(unittest.TestCase):
    """GetLeaseDocumentsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsMethodParams:
        """Test GetLeaseDocumentsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsMethodParams`
        """
        model = GetLeaseDocumentsMethodParams()
        if include_optional:
            return GetLeaseDocumentsMethodParams(
                property_id = 123456,
                lease_id = 123456,
    ...
    def testGetLeaseDocumentsMethodParams(self):
        """Test GetLeaseDocumentsMethodParams"""
