...
class TestSendFloorplansSuccessResponseResultFloorplansFloorplanInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendFloorplansSuccessResponseResultFloorplansFloorplanInner:
        """Test SendFloorplansSuccessResponseResultFloorplansFloorplanInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFloorplansSuccessResponseResultFloorplansFloorplanInner`
        """
        model = SendFloorplansSuccessResponseResultFloorplansFloorplanInner()
        if include_optional:
            return SendFloorplansSuccessResponseResultFloorplansFloorplanInner(
                node = 1,
                status = 'Success',
                floorplan_id = 1145077,
                name = 'Floorplan 1',
                message = 'Floorplan inserted successfully.'
            )
        else:
            return SendFloorplansSuccessResponseResultFloorplansFloorplanInner(
                node = 1,
    ...
    def testSendFloorplansSuccessResponseResultFloorplansFloorplanInner(self):
        """Test SendFloorplansSuccessResponseResultFloorplansFloorplanInner"""
