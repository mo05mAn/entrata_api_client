...
class TestGetEvictedLeasesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetEvictedLeasesMethod:
        """Test GetEvictedLeasesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEvictedLeasesMethod`
        """
        model = GetEvictedLeasesMethod()
        if include_optional:
    ...
    def testGetEvictedLeasesMethod(self):
        """Test GetEvictedLeasesMethod"""
