...
class TestGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes(unittest.TestCase):
    """GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes:
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes`
        """
        model = GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes()
        if include_optional:
            return GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes(
                address_type = 'other'
            )
        else:
            return GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes(
    ...
    def testGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes(self):
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes"""
