...
class TestVoidApPaymentsSuccessResponse(unittest.TestCase):
    """VoidApPaymentsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoidApPaymentsSuccessResponse:
        """Test VoidApPaymentsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidApPaymentsSuccessResponse`
        """
        model = VoidApPaymentsSuccessResponse()
        if include_optional:
            return VoidApPaymentsSuccessResponse(
    ...
    def testVoidApPaymentsSuccessResponse(self):
        """Test VoidApPaymentsSuccessResponse"""
