...
class TestGetCallLogsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCallLogsMethod:
        """Test GetCallLogsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCallLogsMethod`
        """
        model = GetCallLogsMethod()
        if include_optional:
    ...
    def testGetCallLogsMethod(self):
        """Test GetCallLogsMethod"""
