...
class TestGetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner(
                id = 1,
                name = 'Posted'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner"""
