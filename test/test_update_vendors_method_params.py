...
class TestUpdateVendorsMethodParams(unittest.TestCase):
    """UpdateVendorsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateVendorsMethodParams:
        """Test UpdateVendorsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateVendorsMethodParams`
        """
        model = UpdateVendorsMethodParams()
        if include_optional:
            return UpdateVendorsMethodParams(
                vendor_id = 12345,
                ...
                name_on_account = 'header',
                routing_number = 12345,
                account_number = 12345,
                external_id = 'API_VENDOR_EXTRNL_ID',
                default_routing_tag_id = 123
            )
        else:
            return UpdateVendorsMethodParams(
                vendor_id = 12345,
    ...
    def testUpdateVendorsMethodParams(self):
        """Test UpdateVendorsMethodParams"""
