...
class TestUpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders(unittest.TestCase):
    """UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders:
        """Test UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders`
        """
        model = UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders()
        if include_optional:
            return UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders(
                work_order = [
    ...
    def testUpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders(self):
        """Test UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders"""
