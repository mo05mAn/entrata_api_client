...
class TestSendLeaseArTransactionsSuccessResponseResponse(unittest.TestCase):
    """SendLeaseArTransactionsSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionsSuccessResponseResponse:
        """Test SendLeaseArTransactionsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionsSuccessResponseResponse`
        """
        model = SendLeaseArTransactionsSuccessResponseResponse()
        if include_optional:
            return SendLeaseArTransactionsSuccessResponseResponse(
                request_id = '15',
    ...
    def testSendLeaseArTransactionsSuccessResponseResponse(self):
        """Test SendLeaseArTransactionsSuccessResponseResponse"""
