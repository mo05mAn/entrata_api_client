...
class TestGetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner(
                id = 1,
                name = 'Assets'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner"""
