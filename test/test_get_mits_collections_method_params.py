...
class TestGetMitsCollectionsMethodParams(unittest.TestCase):
    """GetMitsCollectionsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsCollectionsMethodParams:
        """Test GetMitsCollectionsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsCollectionsMethodParams`
        """
        model = GetMitsCollectionsMethodParams()
        if include_optional:
            return GetMitsCollectionsMethodParams(
                property_id = 123456,
                include_evictions = 0,
    ...
    def testGetMitsCollectionsMethodParams(self):
        """Test GetMitsCollectionsMethodParams"""
