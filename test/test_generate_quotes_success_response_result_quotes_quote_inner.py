...
class TestGenerateQuotesSuccessResponseResultQuotesQuoteInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GenerateQuotesSuccessResponseResultQuotesQuoteInner:
        """Test GenerateQuotesSuccessResponseResultQuotesQuoteInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateQuotesSuccessResponseResultQuotesQuoteInner`
        """
        model = GenerateQuotesSuccessResponseResultQuotesQuoteInner()
        if include_optional:
            return GenerateQuotesSuccessResponseResultQuotesQuoteInner(
                node = '1',
                status = 'Success',
                quote_id = '123',
    ...
    def testGenerateQuotesSuccessResponseResultQuotesQuoteInner(self):
        """Test GenerateQuotesSuccessResponseResultQuotesQuoteInner"""
