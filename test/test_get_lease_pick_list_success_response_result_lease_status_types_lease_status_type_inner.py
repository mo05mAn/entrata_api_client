...
class TestGetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner(unittest.TestCase):
    """GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner:
        """Test GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner`
        """
        model = GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner()
        if include_optional:
            return GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner(
                id = 1,
                name = 'Applicant',
                type = 'NA'
            )
    ...
    def testGetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner(self):
        """Test GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner"""
