...
class TestGetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType(unittest.TestCase):
    """GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType:
        """Test GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType`
        """
        model = GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType()
        if include_optional:
            return GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType(
                id = 2628,
                name = 'Bikes',
    ...
    def testGetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType(self):
        """Test GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType"""
