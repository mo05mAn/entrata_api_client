...
class TestGenerateQuotesSuccessResponseResultQuotes(unittest.TestCase):
    """GenerateQuotesSuccessResponseResultQuotes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateQuotesSuccessResponseResultQuotes:
        """Test GenerateQuotesSuccessResponseResultQuotes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateQuotesSuccessResponseResultQuotes`
        """
        model = GenerateQuotesSuccessResponseResultQuotes()
        if include_optional:
            return GenerateQuotesSuccessResponseResultQuotes(
                quote = [
    ...
    def testGenerateQuotesSuccessResponseResultQuotes(self):
        """Test GenerateQuotesSuccessResponseResultQuotes"""
