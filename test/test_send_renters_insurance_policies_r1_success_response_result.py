...
class TestSendRentersInsurancePoliciesR1SuccessResponseResult(unittest.TestCase):
    """SendRentersInsurancePoliciesR1SuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRentersInsurancePoliciesR1SuccessResponseResult:
        """Test SendRentersInsurancePoliciesR1SuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentersInsurancePoliciesR1SuccessResponseResult`
        """
        model = SendRentersInsurancePoliciesR1SuccessResponseResult()
        if include_optional:
            return SendRentersInsurancePoliciesR1SuccessResponseResult(
    ...
    def testSendRentersInsurancePoliciesR1SuccessResponseResult(self):
        """Test SendRentersInsurancePoliciesR1SuccessResponseResult"""
