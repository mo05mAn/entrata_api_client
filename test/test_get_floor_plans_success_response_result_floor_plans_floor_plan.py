...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlan(unittest.TestCase):
    """GetFloorPlansSuccessResponseResultFloorPlansFloorPlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlan:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlan
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlan`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlan()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlan(
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlan(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlan"""
