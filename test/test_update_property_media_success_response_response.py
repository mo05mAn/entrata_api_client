...
class TestUpdatePropertyMediaSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdatePropertyMediaSuccessResponseResponse:
        """Test UpdatePropertyMediaSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyMediaSuccessResponseResponse`
        """
        model = UpdatePropertyMediaSuccessResponseResponse()
        if include_optional:
    ...
    def testUpdatePropertyMediaSuccessResponseResponse(self):
        """Test UpdatePropertyMediaSuccessResponseResponse"""
