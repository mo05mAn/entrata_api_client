...
class TestInsertPricingR2SuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InsertPricingR2SuccessResponseResult:
        """Test InsertPricingR2SuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingR2SuccessResponseResult`
        """
        model = InsertPricingR2SuccessResponseResult()
        if include_optional:
    ...
    def testInsertPricingR2SuccessResponseResult(self):
        """Test InsertPricingR2SuccessResponseResult"""
