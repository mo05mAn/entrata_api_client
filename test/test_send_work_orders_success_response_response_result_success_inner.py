...
class TestSendWorkOrdersSuccessResponseResponseResultSuccessInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendWorkOrdersSuccessResponseResponseResultSuccessInner:
        """Test SendWorkOrdersSuccessResponseResponseResultSuccessInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendWorkOrdersSuccessResponseResponseResultSuccessInner`
        """
    ...
    def testSendWorkOrdersSuccessResponseResponseResultSuccessInner(self):
        """Test SendWorkOrdersSuccessResponseResponseResultSuccessInner"""
