...
class TestUpdateLeadsR1Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateLeadsR1Method:
        """Test UpdateLeadsR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeadsR1Method`
        """
        model = UpdateLeadsR1Method()
        if include_optional:
    ...
    def testUpdateLeadsR1Method(self):
        """Test UpdateLeadsR1Method"""
