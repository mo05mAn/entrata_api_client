...
class TestGetStatusSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetStatusSuccessResponseResponse:
        """Test GetStatusSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatusSuccessResponseResponse`
        """
        model = GetStatusSuccessResponseResponse()
        if include_optional:
    ...
    def testGetStatusSuccessResponseResponse(self):
        """Test GetStatusSuccessResponseResponse"""
