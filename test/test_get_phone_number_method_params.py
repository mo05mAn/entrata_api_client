...
class TestGetPhoneNumberMethodParams(unittest.TestCase):
    """GetPhoneNumberMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPhoneNumberMethodParams:
        """Test GetPhoneNumberMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPhoneNumberMethodParams`
        """
        model = GetPhoneNumberMethodParams()
        if include_optional:
            return GetPhoneNumberMethodParams(
    ...
    def testGetPhoneNumberMethodParams(self):
        """Test GetPhoneNumberMethodParams"""
