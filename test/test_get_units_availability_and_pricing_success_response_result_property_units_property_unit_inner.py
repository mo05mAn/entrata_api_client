...
class TestGetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner(unittest.TestCase):
    """GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner:
        """Test GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner`
        """
        model = GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner()
        if include_optional:
            return GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner(
    ...
    def testGetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner(self):
        """Test GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner"""
