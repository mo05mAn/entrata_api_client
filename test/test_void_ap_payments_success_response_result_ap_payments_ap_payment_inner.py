...
class TestVoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner:
        """Test VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner`
        """
        model = VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner()
        if include_optional:
            return VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner(
                node = '1',
                status = 'Success',
    ...
    def testVoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner(self):
        """Test VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner"""
