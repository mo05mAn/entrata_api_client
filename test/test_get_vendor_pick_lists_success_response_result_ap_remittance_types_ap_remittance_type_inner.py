...
class TestGetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInner:
        """Test GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInner`
        """
    ...
    def testGetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInner(self):
        """Test GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInner"""
