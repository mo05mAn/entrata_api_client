...
class TestGetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner(unittest.TestCase):
    """GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner:
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner`
        """
        model = GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner()
        if include_optional:
            return GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner(
                id = '3214',
                name = 'NoTR',
    ...
    def testGetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner(self):
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner"""
