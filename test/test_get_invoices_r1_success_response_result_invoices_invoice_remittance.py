...
class TestGetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance(unittest.TestCase):
    """GetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance:
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance`
        """
        model = GetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance()
        if include_optional:
            return GetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance(
                id = 'XXXX',
    ...
    def testGetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance(self):
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance"""
