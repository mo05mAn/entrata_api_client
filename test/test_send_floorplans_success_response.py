...
class TestSendFloorplansSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendFloorplansSuccessResponse:
        """Test SendFloorplansSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFloorplansSuccessResponse`
        """
        model = SendFloorplansSuccessResponse()
        if include_optional:
    ...
    def testSendFloorplansSuccessResponse(self):
        """Test SendFloorplansSuccessResponse"""
