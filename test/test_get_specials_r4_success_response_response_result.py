...
class TestGetSpecialsR4SuccessResponseResponseResult(unittest.TestCase):
    """GetSpecialsR4SuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4SuccessResponseResponseResult:
        """Test GetSpecialsR4SuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4SuccessResponseResponseResult`
        """
        model = GetSpecialsR4SuccessResponseResponseResult()
        if include_optional:
            return GetSpecialsR4SuccessResponseResponseResult(
                special_groups = [
    ...
    def testGetSpecialsR4SuccessResponseResponseResult(self):
        """Test GetSpecialsR4SuccessResponseResponseResult"""
