...
class TestSendLeadsMethodParams(unittest.TestCase):
    """SendLeadsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeadsMethodParams:
        """Test SendLeadsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeadsMethodParams`
        """
        model = SendLeadsMethodParams()
        if include_optional:
            return SendLeadsMethodParams(
                property_id = 123456,
                subtype_id = 123
            )
        else:
    ...
    def testSendLeadsMethodParams(self):
        """Test SendLeadsMethodParams"""
