...
class TestOnNoticeLeaseSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OnNoticeLeaseSuccessResponseResult:
        """Test OnNoticeLeaseSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnNoticeLeaseSuccessResponseResult`
        """
        model = OnNoticeLeaseSuccessResponseResult()
        if include_optional:
            return OnNoticeLeaseSuccessResponseResult(
                status = 'Success',
    ...
    def testOnNoticeLeaseSuccessResponseResult(self):
        """Test OnNoticeLeaseSuccessResponseResult"""
