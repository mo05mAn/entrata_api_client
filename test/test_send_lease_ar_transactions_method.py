...
class TestSendLeaseArTransactionsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionsMethod:
        """Test SendLeaseArTransactionsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionsMethod`
        """
        model = SendLeaseArTransactionsMethod()
        if include_optional:
    ...
    def testSendLeaseArTransactionsMethod(self):
        """Test SendLeaseArTransactionsMethod"""
