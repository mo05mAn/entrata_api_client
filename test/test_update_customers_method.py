...
class TestUpdateCustomersMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateCustomersMethod:
        """Test UpdateCustomersMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomersMethod`
        """
        model = UpdateCustomersMethod()
        if include_optional:
    ...
    def testUpdateCustomersMethod(self):
        """Test UpdateCustomersMethod"""
