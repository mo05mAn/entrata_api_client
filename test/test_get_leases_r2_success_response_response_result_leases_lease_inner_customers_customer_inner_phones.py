...
class TestGetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones(unittest.TestCase):
    """GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones:
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones`
        """
        model = GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones()
        if include_optional:
            return GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones(
                phone = [
    ...
    def testGetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones(self):
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones"""
