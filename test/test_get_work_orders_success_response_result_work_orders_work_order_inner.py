...
class TestGetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner(unittest.TestCase):
    """GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner:
        """Test GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner`
        """
        model = GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner()
        if include_optional:
            return GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner(
    ...
    def testGetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner(self):
        """Test GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner"""
