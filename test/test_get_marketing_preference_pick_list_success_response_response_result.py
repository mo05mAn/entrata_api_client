...
class TestGetMarketingPreferencePickListSuccessResponseResponseResult(unittest.TestCase):
    """GetMarketingPreferencePickListSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencePickListSuccessResponseResponseResult:
        """Test GetMarketingPreferencePickListSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencePickListSuccessResponseResponseResult`
        """
        model = GetMarketingPreferencePickListSuccessResponseResponseResult()
        if include_optional:
            return GetMarketingPreferencePickListSuccessResponseResponseResult(
                preferences = [
    ...
    def testGetMarketingPreferencePickListSuccessResponseResponseResult(self):
        """Test GetMarketingPreferencePickListSuccessResponseResponseResult"""
