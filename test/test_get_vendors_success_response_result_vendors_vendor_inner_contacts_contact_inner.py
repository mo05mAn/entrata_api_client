...
class TestGetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner(unittest.TestCase):
    """GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner:
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner`
        """
        model = GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner()
        if include_optional:
            return GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner(
                id = '123654',
                name_first = 'Max',
                name_last = 'Collins',
                email = 'email@dot.com',
    ...
    def testGetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner(self):
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner"""
