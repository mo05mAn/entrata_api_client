...
class TestGetFinancialPickListR1SuccessResponseResultGlExportBatchTypes(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlExportBatchTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlExportBatchTypes:
        """Test GetFinancialPickListR1SuccessResponseResultGlExportBatchTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlExportBatchTypes`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlExportBatchTypes()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlExportBatchTypes(
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlExportBatchTypes(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlExportBatchTypes"""
