...
class TestSendRoommateGroupsR2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRoommateGroupsR2:
        """Test SendRoommateGroupsR2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRoommateGroupsR2`
        """
    ...
    def testSendRoommateGroupsR2(self):
        """Test SendRoommateGroupsR2"""
