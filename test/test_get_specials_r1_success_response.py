    ...
    def make_instance(self, include_optional) -> GetSpecialsR1SuccessResponse:
        ...
        if include_optional:
            return GetSpecialsR1SuccessResponse(
                response = openapi_client.models.get_specials_r1_success_response_response.getSpecials_r1_SuccessResponse_response(
                    request_id = 15, 
                    result = openapi_client.models.get_specials_r1_success_response_response_result.getSpecials_r1_SuccessResponse_response_result(
                        physical_property = openapi_client.models.get_specials_r1_success_response_response_result_physical_property.getSpecials_r1_SuccessResponse_response_result_PhysicalProperty(
                            property = openapi_client.models.get_specials_r1_success_response_response_result_physical_property_property.getSpecials_r1_SuccessResponse_response_result_PhysicalProperty_Property(
