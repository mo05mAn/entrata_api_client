...
class TestUpdateAmenitiesSuccessResponseResponse(unittest.TestCase):
    """UpdateAmenitiesSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponseResponse:
        """Test UpdateAmenitiesSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponseResponse`
        """
        model = UpdateAmenitiesSuccessResponseResponse()
        if include_optional:
            return UpdateAmenitiesSuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testUpdateAmenitiesSuccessResponseResponse(self):
        """Test UpdateAmenitiesSuccessResponseResponse"""
