...
class TestGetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner(
                id = 1,
                name = 'GL'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner"""
