...
class TestGetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner:
        """Test GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner`
        """
        model = GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner(
    ...
    def testGetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner(self):
        """Test GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner"""
