...
class TestGetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner(
                id = 1,
                name = 'Assets'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner"""
