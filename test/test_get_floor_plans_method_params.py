...
class TestGetFloorPlansMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFloorPlansMethodParams:
        """Test GetFloorPlansMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansMethodParams`
        """
        model = GetFloorPlansMethodParams()
        if include_optional:
            return GetFloorPlansMethodParams(
                property_id = 12345,
    ...
    def testGetFloorPlansMethodParams(self):
        """Test GetFloorPlansMethodParams"""
