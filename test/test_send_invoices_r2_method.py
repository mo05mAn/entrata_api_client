...
class TestSendInvoicesR2Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendInvoicesR2Method:
        """Test SendInvoicesR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR2Method`
        """
        model = SendInvoicesR2Method()
        if include_optional:
    ...
    def testSendInvoicesR2Method(self):
        """Test SendInvoicesR2Method"""
