...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner(
                id = '474887',
                name = '1'
            )
        else:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner"""
