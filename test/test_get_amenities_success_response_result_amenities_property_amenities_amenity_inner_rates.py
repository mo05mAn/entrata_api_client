...
class TestGetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates:
        """Test GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates(
                rate = [
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates"""
