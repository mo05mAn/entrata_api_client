...
class TestGetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer(unittest.TestCase):
    """GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer:
        """Test GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer`
        """
        model = GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer()
        if include_optional:
            return GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer(
                id = 31094026,
                first_name = 'Alfred',
                last_name = 'Burge',
    ...
    def testGetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer(self):
        """Test GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer"""
