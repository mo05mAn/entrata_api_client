...
class TestSendInvoicesR2SuccessResponseResult(unittest.TestCase):
    """SendInvoicesR2SuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendInvoicesR2SuccessResponseResult:
        """Test SendInvoicesR2SuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR2SuccessResponseResult`
        """
        model = SendInvoicesR2SuccessResponseResult()
        if include_optional:
            return SendInvoicesR2SuccessResponseResult(
    ...
    def testSendInvoicesR2SuccessResponseResult(self):
        """Test SendInvoicesR2SuccessResponseResult"""
