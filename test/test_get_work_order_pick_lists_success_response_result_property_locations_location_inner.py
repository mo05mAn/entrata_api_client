...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner(
                id = '26900',
                name = 'Basement',
                type = 'Unit',
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner"""
