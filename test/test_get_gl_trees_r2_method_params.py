...
class TestGetGlTreesR2MethodParams(unittest.TestCase):
    """GetGlTreesR2MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR2MethodParams:
        """Test GetGlTreesR2MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR2MethodParams`
        """
        model = GetGlTreesR2MethodParams()
        if include_optional:
            return GetGlTreesR2MethodParams(
                gl_tree_id = 1234,
                gl_branch_id = 1234,
                gl_group_type_id = 1,
                gl_tree_type_id = 1,
                account_numbers = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()
            )
        else:
            return GetGlTreesR2MethodParams(
        )
    ...
    def testGetGlTreesR2MethodParams(self):
        """Test GetGlTreesR2MethodParams"""
