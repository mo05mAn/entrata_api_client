...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus(unittest.TestCase):
    """GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus`
        """
        model = GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus()
        if include_optional:
            return GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus(
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus"""
