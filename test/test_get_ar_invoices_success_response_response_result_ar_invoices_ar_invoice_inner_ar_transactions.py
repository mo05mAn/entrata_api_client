...
class TestGetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions(unittest.TestCase):
    """GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions:
        """Test GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions`
        """
        model = GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions()
        if include_optional:
            return GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions(
                ar_transaction = [
    ...
    def testGetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions(self):
        """Test GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions"""
