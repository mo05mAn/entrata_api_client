...
class TestGetMarketingPreferencesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencesMethodParams:
        """Test GetMarketingPreferencesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencesMethodParams`
        """
        model = GetMarketingPreferencesMethodParams()
        if include_optional:
            return GetMarketingPreferencesMethodParams(
                property_id = 123456,
    ...
    def testGetMarketingPreferencesMethodParams(self):
        """Test GetMarketingPreferencesMethodParams"""
