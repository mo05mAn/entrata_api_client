...
class TestGetLeasePickListSuccessResponseResultEventTags(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultEventTags:
        """Test GetLeasePickListSuccessResponseResultEventTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultEventTags`
        """
        model = GetLeasePickListSuccessResponseResultEventTags()
        if include_optional:
    ...
    def testGetLeasePickListSuccessResponseResultEventTags(self):
        """Test GetLeasePickListSuccessResponseResultEventTags"""
