...
class TestUpdatePropertyMediaSuccessResponseResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdatePropertyMediaSuccessResponseResponseResult:
        """Test UpdatePropertyMediaSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyMediaSuccessResponseResponseResult`
        """
        model = UpdatePropertyMediaSuccessResponseResponseResult()
        if include_optional:
    ...
    def testUpdatePropertyMediaSuccessResponseResponseResult(self):
        """Test UpdatePropertyMediaSuccessResponseResponseResult"""
