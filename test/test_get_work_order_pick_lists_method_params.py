...
class TestGetWorkOrderPickListsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsMethodParams:
        """Test GetWorkOrderPickListsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsMethodParams`
        """
        model = GetWorkOrderPickListsMethodParams()
        if include_optional:
            return GetWorkOrderPickListsMethodParams(
    ...
    def testGetWorkOrderPickListsMethodParams(self):
        """Test GetWorkOrderPickListsMethodParams"""
