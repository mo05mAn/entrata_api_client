...
class TestSendApplicationVehicles(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationVehicles:
        """Test SendApplicationVehicles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationVehicles`
        """
    ...
    def testSendApplicationVehicles(self):
        """Test SendApplicationVehicles"""
