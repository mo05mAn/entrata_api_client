...
class TestGetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValue:
        """Test GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValue`
        """
    ...
    def testGetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValue(self):
        """Test GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValue"""
