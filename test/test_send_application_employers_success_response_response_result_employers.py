...
class TestSendApplicationEmployersSuccessResponseResponseResultEmployers(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationEmployersSuccessResponseResponseResultEmployers:
        """Test SendApplicationEmployersSuccessResponseResponseResultEmployers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationEmployersSuccessResponseResponseResultEmployers`
        """
        model = SendApplicationEmployersSuccessResponseResponseResultEmployers()
        if include_optional:
    ...
    def testSendApplicationEmployersSuccessResponseResponseResultEmployers(self):
        """Test SendApplicationEmployersSuccessResponseResponseResultEmployers"""
