...
class TestSendRentableItemsSuccessResponse(unittest.TestCase):
    """SendRentableItemsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRentableItemsSuccessResponse:
        """Test SendRentableItemsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentableItemsSuccessResponse`
        """
        model = SendRentableItemsSuccessResponse()
        if include_optional:
            return SendRentableItemsSuccessResponse(
                request_id = '15',
                result = entrata_api_client.models.send_rentable_items_success_response_result.sendRentableItemsSuccessResponse_result(
    ...
    def testSendRentableItemsSuccessResponse(self):
        """Test SendRentableItemsSuccessResponse"""
