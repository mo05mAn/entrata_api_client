...
class TestGetFinancialPickListR1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1:
        """Test GetFinancialPickListR1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1`
        """
    ...
    def testGetFinancialPickListR1(self):
        """Test GetFinancialPickListR1"""
