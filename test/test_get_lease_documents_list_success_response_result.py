...
class TestGetLeaseDocumentsListSuccessResponseResult(unittest.TestCase):
    """GetLeaseDocumentsListSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsListSuccessResponseResult:
        """Test GetLeaseDocumentsListSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsListSuccessResponseResult`
        """
        model = GetLeaseDocumentsListSuccessResponseResult()
        if include_optional:
            return GetLeaseDocumentsListSuccessResponseResult(
    ...
    def testGetLeaseDocumentsListSuccessResponseResult(self):
        """Test GetLeaseDocumentsListSuccessResponseResult"""
