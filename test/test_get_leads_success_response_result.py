...
class TestGetLeadsSuccessResponseResult(unittest.TestCase):
    """GetLeadsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResult:
        """Test GetLeadsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResult`
        """
        model = GetLeadsSuccessResponseResult()
        if include_optional:
            return GetLeadsSuccessResponseResult(
                property_id = '1234',
                currency_code = 'USD',
    ...
    def testGetLeadsSuccessResponseResult(self):
        """Test GetLeadsSuccessResponseResult"""
