...
class TestGetTestimonialPickListsSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTestimonialPickListsSuccessResponseResult:
        """Test GetTestimonialPickListsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTestimonialPickListsSuccessResponseResult`
        """
    ...
    def testGetTestimonialPickListsSuccessResponseResult(self):
        """Test GetTestimonialPickListsSuccessResponseResult"""
