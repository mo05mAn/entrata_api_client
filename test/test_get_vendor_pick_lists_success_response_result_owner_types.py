...
class TestGetVendorPickListsSuccessResponseResultOwnerTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultOwnerTypes:
        """Test GetVendorPickListsSuccessResponseResultOwnerTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultOwnerTypes`
        """
        model = GetVendorPickListsSuccessResponseResultOwnerTypes()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultOwnerTypes(self):
        """Test GetVendorPickListsSuccessResponseResultOwnerTypes"""
