...
class TestGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes(unittest.TestCase):
    """GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes:
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes`
        """
        model = GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes()
        if include_optional:
            return GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes(
                total = '4'
            )
        else:
            return GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes(
    ...
    def testGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes(self):
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes"""
