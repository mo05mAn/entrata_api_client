...
class TestGetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner(unittest.TestCase):
    """GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner:
        """Test GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner`
        """
        model = GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner()
        if include_optional:
            return GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner(
                id = '11111',
                name = 'Testing Test',
                title = 'well it is an awesome place to live in.',
                testimonial = 'I will recommend him to do not waste your opportunity and be here soon possible.',
                property_id = '11111',
                property_name = 'test company',
                email_address = '04testing15_test.lcl@r3.com',
                testimonial_datetime = '06/03/2013 05:45:01.404402 MDT',
                testimonial_type = 'APARTMENTRATINGS',
                is_recommended = '1',
                show_on_corporate_sites = '0',
                vacancy_published = '0',
    ...
    def testGetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner(self):
        """Test GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner"""
