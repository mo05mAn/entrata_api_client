...
class TestUpdateInvoicesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateInvoicesMethod:
        """Test UpdateInvoicesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateInvoicesMethod`
        """
        model = UpdateInvoicesMethod()
        if include_optional:
    ...
    def testUpdateInvoicesMethod(self):
        """Test UpdateInvoicesMethod"""
