...
class TestGetArInvoicesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetArInvoicesMethod:
        """Test GetArInvoicesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArInvoicesMethod`
        """
        model = GetArInvoicesMethod()
        if include_optional:
    ...
    def testGetArInvoicesMethod(self):
        """Test GetArInvoicesMethod"""
