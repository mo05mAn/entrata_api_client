...
class TestGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription(unittest.TestCase):
    """GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription:
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription`
        """
        model = GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription()
        if include_optional:
            return GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription(
                b = '55 HUNDRED'
            )
        else:
            return GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription(
    ...
    def testGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription(self):
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerLongDescription"""
