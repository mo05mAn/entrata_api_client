...
class TestGetArCodesSuccessResponse(unittest.TestCase):
    """GetArCodesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetArCodesSuccessResponse:
        """Test GetArCodesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArCodesSuccessResponse`
        """
        model = GetArCodesSuccessResponse()
        if include_optional:
            return GetArCodesSuccessResponse(
    ...
    def testGetArCodesSuccessResponse(self):
        """Test GetArCodesSuccessResponse"""
