...
class TestGetPropertyPickListsR2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2:
        """Test GetPropertyPickListsR2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2`
        """
    ...
    def testGetPropertyPickListsR2(self):
        """Test GetPropertyPickListsR2"""
