...
class TestGetWorkOrderPickListsSuccessResponseResultWorkOrderTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultWorkOrderTypes:
        """Test GetWorkOrderPickListsSuccessResponseResultWorkOrderTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultWorkOrderTypes`
        """
        model = GetWorkOrderPickListsSuccessResponseResultWorkOrderTypes()
        if include_optional:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultWorkOrderTypes(self):
        """Test GetWorkOrderPickListsSuccessResponseResultWorkOrderTypes"""
