...
class TestGetFinancialPickListR1SuccessResponseResultGlLedgerTypes(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlLedgerTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlLedgerTypes:
        """Test GetFinancialPickListR1SuccessResponseResultGlLedgerTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlLedgerTypes`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlLedgerTypes()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlLedgerTypes(
                gl_ledger_type = [
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlLedgerTypes(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlLedgerTypes"""
