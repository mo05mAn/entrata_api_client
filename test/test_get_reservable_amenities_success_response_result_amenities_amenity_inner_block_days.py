...
class TestGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDays(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDays:
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDays
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDays`
        """
        model = GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDays()
        if include_optional:
    ...
    def testGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDays(self):
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDays"""
