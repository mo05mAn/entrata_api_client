...
class TestGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes(unittest.TestCase):
    """GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes:
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes`
        """
        model = GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes()
        if include_optional:
            return GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes(
                id_type = 'Lease ID',
                id_rank = 'primary',
    ...
    def testGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes(self):
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes"""
