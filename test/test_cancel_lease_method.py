...
class TestCancelLeaseMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CancelLeaseMethod:
        """Test CancelLeaseMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelLeaseMethod`
        """
        model = CancelLeaseMethod()
        if include_optional:
    ...
    def testCancelLeaseMethod(self):
        """Test CancelLeaseMethod"""
