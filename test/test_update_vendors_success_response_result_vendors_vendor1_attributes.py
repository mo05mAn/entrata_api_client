...
class TestUpdateVendorsSuccessResponseResultVendorsVendor1Attributes(unittest.TestCase):
    """UpdateVendorsSuccessResponseResultVendorsVendor1Attributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateVendorsSuccessResponseResultVendorsVendor1Attributes:
        """Test UpdateVendorsSuccessResponseResultVendorsVendor1Attributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateVendorsSuccessResponseResultVendorsVendor1Attributes`
        """
        model = UpdateVendorsSuccessResponseResultVendorsVendor1Attributes()
        if include_optional:
            return UpdateVendorsSuccessResponseResultVendorsVendor1Attributes(
                reference_id = '13245',
                status = 'Success',
    ...
    def testUpdateVendorsSuccessResponseResultVendorsVendor1Attributes(self):
        """Test UpdateVendorsSuccessResponseResultVendorsVendor1Attributes"""
