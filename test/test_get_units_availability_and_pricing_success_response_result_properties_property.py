...
class TestGetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty(unittest.TestCase):
    """GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty:
        """Test GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty`
        """
        model = GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty()
        if include_optional:
            return GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty(
                property_id = '1234',
    ...
    def testGetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty(self):
        """Test GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty"""
