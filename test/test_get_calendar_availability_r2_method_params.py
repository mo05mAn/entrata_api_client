...
class TestGetCalendarAvailabilityR2MethodParams(unittest.TestCase):
    """GetCalendarAvailabilityR2MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR2MethodParams:
        """Test GetCalendarAvailabilityR2MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR2MethodParams`
        """
        model = GetCalendarAvailabilityR2MethodParams()
        if include_optional:
            return GetCalendarAvailabilityR2MethodParams(
                property_id = 123456,
    ...
    def testGetCalendarAvailabilityR2MethodParams(self):
        """Test GetCalendarAvailabilityR2MethodParams"""
