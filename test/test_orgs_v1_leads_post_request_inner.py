...
class TestOrgsV1LeadsPostRequestInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrgsV1LeadsPostRequestInner:
        """Test OrgsV1LeadsPostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgsV1LeadsPostRequestInner`
        """
    ...
    def testOrgsV1LeadsPostRequestInner(self):
        """Test OrgsV1LeadsPostRequestInner"""
