...
class TestGetVendorLocationsSuccessResponseResultLocationsLocationInnerContactsContactInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultLocationsLocationInnerContactsContactInner:
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerContactsContactInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultLocationsLocationInnerContactsContactInner`
        """
        model = GetVendorLocationsSuccessResponseResultLocationsLocationInnerContactsContactInner()
        if include_optional:
    ...
    def testGetVendorLocationsSuccessResponseResultLocationsLocationInnerContactsContactInner(self):
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerContactsContactInner"""
