...
class TestGetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner(
                id = 1,
                name = 'GL'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner"""
