...
class TestOnNoticeLeaseSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OnNoticeLeaseSuccessResponse:
        """Test OnNoticeLeaseSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnNoticeLeaseSuccessResponse`
        """
        model = OnNoticeLeaseSuccessResponse()
        if include_optional:
    ...
    def testOnNoticeLeaseSuccessResponse(self):
        """Test OnNoticeLeaseSuccessResponse"""
