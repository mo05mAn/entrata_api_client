...
class TestGetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes:
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes(
                id = '33333',
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes"""
