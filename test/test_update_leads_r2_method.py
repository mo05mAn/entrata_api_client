...
class TestUpdateLeadsR2Method(unittest.TestCase):
    """UpdateLeadsR2Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLeadsR2Method:
        """Test UpdateLeadsR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeadsR2Method`
        """
        model = UpdateLeadsR2Method()
        if include_optional:
            return UpdateLeadsR2Method(
                name = '',
                version = 'r2',
    ...
    def testUpdateLeadsR2Method(self):
        """Test UpdateLeadsR2Method"""
