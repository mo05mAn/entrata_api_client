...
class TestMarkInvoicesExportedSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MarkInvoicesExportedSuccessResponseResult:
        """Test MarkInvoicesExportedSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkInvoicesExportedSuccessResponseResult`
        """
        model = MarkInvoicesExportedSuccessResponseResult()
        if include_optional:
            return MarkInvoicesExportedSuccessResponseResult(
    ...
    def testMarkInvoicesExportedSuccessResponseResult(self):
        """Test MarkInvoicesExportedSuccessResponseResult"""
