...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes(unittest.TestCase):
    """GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes(
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes"""
