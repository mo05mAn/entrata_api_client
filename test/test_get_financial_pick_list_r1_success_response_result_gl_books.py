...
class TestGetFinancialPickListR1SuccessResponseResultGlBooks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlBooks:
        """Test GetFinancialPickListR1SuccessResponseResultGlBooks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlBooks`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlBooks()
        if include_optional:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlBooks(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlBooks"""
