...
class TestGetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner(unittest.TestCase):
    """GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner:
        """Test GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner`
        """
        model = GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner()
        if include_optional:
            return GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner(
                id = '123456',
    ...
    def testGetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner(self):
        """Test GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner"""
