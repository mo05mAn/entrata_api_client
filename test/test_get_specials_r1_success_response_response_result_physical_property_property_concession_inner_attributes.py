...
class TestGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes(unittest.TestCase):
    """GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes:
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes`
        """
        model = GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes()
        if include_optional:
            return GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes(
                active = 1
            )
        else:
            return GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes(
    ...
    def testGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes(self):
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes"""
