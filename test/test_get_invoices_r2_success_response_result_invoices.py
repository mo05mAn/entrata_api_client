...
class TestGetInvoicesR2SuccessResponseResultInvoices(unittest.TestCase):
    """GetInvoicesR2SuccessResponseResultInvoices unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2SuccessResponseResultInvoices:
        """Test GetInvoicesR2SuccessResponseResultInvoices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2SuccessResponseResultInvoices`
        """
        model = GetInvoicesR2SuccessResponseResultInvoices()
        if include_optional:
            return GetInvoicesR2SuccessResponseResultInvoices(
                invoice = [
    ...
    def testGetInvoicesR2SuccessResponseResultInvoices(self):
        """Test GetInvoicesR2SuccessResponseResultInvoices"""
