...
class TestApplyQuoteSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApplyQuoteSuccessResponseResult:
        """Test ApplyQuoteSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplyQuoteSuccessResponseResult`
        """
        model = ApplyQuoteSuccessResponseResult()
        if include_optional:
            return ApplyQuoteSuccessResponseResult(
                status = 'Success',
                quote_id = '123',
    ...
    def testApplyQuoteSuccessResponseResult(self):
        """Test ApplyQuoteSuccessResponseResult"""
