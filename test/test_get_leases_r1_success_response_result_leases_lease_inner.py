...
class TestGetLeasesR1SuccessResponseResultLeasesLeaseInner(unittest.TestCase):
    """GetLeasesR1SuccessResponseResultLeasesLeaseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR1SuccessResponseResultLeasesLeaseInner:
        """Test GetLeasesR1SuccessResponseResultLeasesLeaseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR1SuccessResponseResultLeasesLeaseInner`
        """
        model = GetLeasesR1SuccessResponseResultLeasesLeaseInner()
        if include_optional:
            return GetLeasesR1SuccessResponseResultLeasesLeaseInner(
                id = '123456',
    ...
    def testGetLeasesR1SuccessResponseResultLeasesLeaseInner(self):
        """Test GetLeasesR1SuccessResponseResultLeasesLeaseInner"""
