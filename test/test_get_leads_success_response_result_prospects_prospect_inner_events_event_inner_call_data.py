...
class TestGetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData(unittest.TestCase):
    """GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData:
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData`
        """
        model = GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData()
        if include_optional:
            return GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData(
                call_id = '64744370',
    ...
    def testGetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData(self):
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData"""
