...
class TestSendRoommateGroupsR2Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRoommateGroupsR2Method:
        """Test SendRoommateGroupsR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRoommateGroupsR2Method`
        """
        model = SendRoommateGroupsR2Method()
        if include_optional:
    ...
    def testSendRoommateGroupsR2Method(self):
        """Test SendRoommateGroupsR2Method"""
