...
class TestGetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities:
        """Test GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities(
                amenity = [
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities"""
