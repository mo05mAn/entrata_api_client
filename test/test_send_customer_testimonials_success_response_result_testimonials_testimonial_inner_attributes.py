...
class TestSendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes(unittest.TestCase):
    """SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes:
        """Test SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes`
        """
        model = SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes()
        if include_optional:
            return SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes(
                node = 1,
                reference_id = 8530,
                status = 'Success',
    ...
    def testSendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes(self):
        """Test SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes"""
