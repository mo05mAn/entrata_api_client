...
class TestGetGlTransactionsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGlTransactionsMethod:
        """Test GetGlTransactionsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTransactionsMethod`
        """
        model = GetGlTransactionsMethod()
        if include_optional:
    ...
    def testGetGlTransactionsMethod(self):
        """Test GetGlTransactionsMethod"""
