...
class TestGetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue(unittest.TestCase):
    """GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue:
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue`
        """
        model = GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue()
        if include_optional:
            return GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue(
                id = '12019486',
                name = '90 - 61',
                show_on_website = 1,
                is_active = 1,
    ...
    def testGetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue(self):
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue"""
