...
class TestGetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor:
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor`
        """
        model = GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor()
        if include_optional:
            return GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor(
                id = '123456',
    ...
    def testGetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor(self):
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor"""
