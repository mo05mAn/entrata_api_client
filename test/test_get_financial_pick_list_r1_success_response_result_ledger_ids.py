...
class TestGetFinancialPickListR1SuccessResponseResultLedgerIds(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultLedgerIds:
        """Test GetFinancialPickListR1SuccessResponseResultLedgerIds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultLedgerIds`
        """
        model = GetFinancialPickListR1SuccessResponseResultLedgerIds()
        if include_optional:
    ...
    def testGetFinancialPickListR1SuccessResponseResultLedgerIds(self):
        """Test GetFinancialPickListR1SuccessResponseResultLedgerIds"""
