...
class TestGetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue:
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue`
        """
        model = GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue()
        if include_optional:
            return GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue(
                id = '12033041',
                name = 'Floor special2',
    ...
    def testGetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue(self):
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue"""
