...
class TestUpdateVendorsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateVendorsMethod:
        """Test UpdateVendorsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateVendorsMethod`
        """
        model = UpdateVendorsMethod()
        if include_optional:
    ...
    def testUpdateVendorsMethod(self):
        """Test UpdateVendorsMethod"""
