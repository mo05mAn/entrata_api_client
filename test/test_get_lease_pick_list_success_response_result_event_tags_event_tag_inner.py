...
class TestGetLeasePickListSuccessResponseResultEventTagsEventTagInner(unittest.TestCase):
    """GetLeasePickListSuccessResponseResultEventTagsEventTagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultEventTagsEventTagInner:
        """Test GetLeasePickListSuccessResponseResultEventTagsEventTagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultEventTagsEventTagInner`
        """
        model = GetLeasePickListSuccessResponseResultEventTagsEventTagInner()
        if include_optional:
            return GetLeasePickListSuccessResponseResultEventTagsEventTagInner(
                id = 702,
                name = 'Amenity'
            )
        else:
    ...
    def testGetLeasePickListSuccessResponseResultEventTagsEventTagInner(self):
        """Test GetLeasePickListSuccessResponseResultEventTagsEventTagInner"""
