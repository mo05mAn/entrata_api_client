...
class TestGetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypes:
        """Test GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypes`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypes()
        if include_optional:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypes(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypes"""
