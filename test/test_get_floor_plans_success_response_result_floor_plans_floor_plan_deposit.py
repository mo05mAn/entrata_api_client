...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanDeposit(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDeposit:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDeposit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDeposit`
        """
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanDeposit(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDeposit"""
