...
class TestGetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue:
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue`
        """
        model = GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue()
        if include_optional:
            return GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue(
                id = '12034174',
                name = 'Test',
                show_on_website = 1,
                is_active = 1,
    ...
    def testGetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue(self):
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue"""
