...
class TestGetAccessibleServicesSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccessibleServicesSuccessResponseResult:
        """Test GetAccessibleServicesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessibleServicesSuccessResponseResult`
        """
        model = GetAccessibleServicesSuccessResponseResult()
        if include_optional:
    ...
    def testGetAccessibleServicesSuccessResponseResult(self):
        """Test GetAccessibleServicesSuccessResponseResult"""
