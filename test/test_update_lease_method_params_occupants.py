...
class TestUpdateLeaseMethodParamsOccupants(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateLeaseMethodParamsOccupants:
        """Test UpdateLeaseMethodParamsOccupants
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeaseMethodParamsOccupants`
        """
        model = UpdateLeaseMethodParamsOccupants()
        if include_optional:
    ...
    def testUpdateLeaseMethodParamsOccupants(self):
        """Test UpdateLeaseMethodParamsOccupants"""
