...
class TestGetLeadPickListsR2SuccessResponseResultListItemTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultListItemTypes:
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultListItemTypes`
        """
        model = GetLeadPickListsR2SuccessResponseResultListItemTypes()
        if include_optional:
    ...
    def testGetLeadPickListsR2SuccessResponseResultListItemTypes(self):
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypes"""
