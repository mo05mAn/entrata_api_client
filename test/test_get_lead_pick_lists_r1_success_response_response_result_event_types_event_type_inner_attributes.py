...
class TestGetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes:
        """Test GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes`
        """
        model = GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes()
        if include_optional:
            return GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes(
                name = 'Application',
                id = 131,
    ...
    def testGetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes(self):
        """Test GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes"""
