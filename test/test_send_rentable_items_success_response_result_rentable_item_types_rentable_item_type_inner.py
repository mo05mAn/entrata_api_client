...
class TestSendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner(unittest.TestCase):
    """SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner:
        """Test SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner`
        """
        model = SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner()
        if include_optional:
            return SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner(
                node = 1,
                rentable_item_type_id = 81625,
                rentable_item_ids = '7157472,7157473,7157474',
                status = 'Success',
                message = 'rentableItemType inserted successfully.'
            )
        else:
            return SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner(
                node = 1,
    ...
    def testSendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner(self):
        """Test SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner"""
