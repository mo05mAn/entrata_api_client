...
class TestGetFinancialPickListR2SuccessResponseResultOwners(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultOwners:
        """Test GetFinancialPickListR2SuccessResponseResultOwners
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultOwners`
        """
        model = GetFinancialPickListR2SuccessResponseResultOwners()
        if include_optional:
    ...
    def testGetFinancialPickListR2SuccessResponseResultOwners(self):
        """Test GetFinancialPickListR2SuccessResponseResultOwners"""
