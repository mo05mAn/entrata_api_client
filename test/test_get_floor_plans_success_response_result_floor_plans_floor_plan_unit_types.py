...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypes:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypes`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypes()
        if include_optional:
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypes(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypes"""
