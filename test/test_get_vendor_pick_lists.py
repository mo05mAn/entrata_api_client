...
class TestGetVendorPickLists(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickLists:
        """Test GetVendorPickLists
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickLists`
        """
    ...
    def testGetVendorPickLists(self):
        """Test GetVendorPickLists"""
