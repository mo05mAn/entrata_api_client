...
class TestGetLeasingCenterPickLists(unittest.TestCase):
    """GetLeasingCenterPickLists unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasingCenterPickLists:
        """Test GetLeasingCenterPickLists
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasingCenterPickLists`
        """
        model = GetLeasingCenterPickLists()
        if include_optional:
            return GetLeasingCenterPickLists(
    ...
    def testGetLeasingCenterPickLists(self):
        """Test GetLeasingCenterPickLists"""
