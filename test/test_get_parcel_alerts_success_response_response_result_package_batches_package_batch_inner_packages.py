...
class TestGetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackages(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackages:
        """Test GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackages`
        """
        model = GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackages()
        if include_optional:
    ...
    def testGetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackages(self):
        """Test GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackages"""
