...
class TestGetMitsLeadsMethodParams(unittest.TestCase):
    """GetMitsLeadsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeadsMethodParams:
        """Test GetMitsLeadsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeadsMethodParams`
        """
        model = GetMitsLeadsMethodParams()
        if include_optional:
            return GetMitsLeadsMethodParams(
                property_id = 123456,
                lead_id = 123,
                name = 'ABC',
                ...
                event_type_ids = 56,
                send_unit_spaces = 0,
                from_date_time = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                to_date_time = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
    ...
    def testGetMitsLeadsMethodParams(self):
        """Test GetMitsLeadsMethodParams"""
