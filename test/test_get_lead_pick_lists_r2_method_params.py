...
class TestGetLeadPickListsR2MethodParams(unittest.TestCase):
    """GetLeadPickListsR2MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2MethodParams:
        """Test GetLeadPickListsR2MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2MethodParams`
        """
        model = GetLeadPickListsR2MethodParams()
        if include_optional:
            return GetLeadPickListsR2MethodParams(
                property_id = 1234
            )
        else:
            return GetLeadPickListsR2MethodParams(
    ...
    def testGetLeadPickListsR2MethodParams(self):
        """Test GetLeadPickListsR2MethodParams"""
