    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponse:
        ...
        if include_optional:
            return UpdateAmenitiesSuccessResponse(
                response = openapi_client.models.update_amenities_success_response_response.updateAmenitiesSuccessResponse_response(
                    request_id = '15', 
                    code = 200, 
                    result = openapi_client.models.update_amenities_success_response_response_result.updateAmenitiesSuccessResponse_response_result(
