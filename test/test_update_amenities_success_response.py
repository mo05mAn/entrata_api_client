...
class TestUpdateAmenitiesSuccessResponse(unittest.TestCase):
    """UpdateAmenitiesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponse:
        """Test UpdateAmenitiesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponse`
        """
        model = UpdateAmenitiesSuccessResponse()
        if include_optional:
            return UpdateAmenitiesSuccessResponse(
                response = entrata_api_client.models.update_amenities_success_response_response.updateAmenitiesSuccessResponse_response(
                    request_id = '15', 
                    code = 200, 
                    result = entrata_api_client.models.update_amenities_success_response_response_result.updateAmenitiesSuccessResponse_response_result(
    ...
    def testUpdateAmenitiesSuccessResponse(self):
        """Test UpdateAmenitiesSuccessResponse"""
