...
class TestGetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner(unittest.TestCase):
    """GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner:
        """Test GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner`
        """
        model = GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner()
        if include_optional:
            return GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner(
                id = '123456',
                resident = 'Transfer Test 3',
                lease_id = '123456',
                unit_id = '123456',
                unit_number = '123456',
                reservation_date = '2020-04-08',
                reserve_by_day = '0',
                reservation_start_time = '03:00 PM',
                reservation_end_time = '05:00 PM',
                status_type_id = '3',
                status = 'Approved'
            )
        else:
    ...
    def testGetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner(self):
        """Test GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner"""
