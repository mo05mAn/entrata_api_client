...
class TestSendPropertyUnitsSuccessResponseResponseResultUnits(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendPropertyUnitsSuccessResponseResponseResultUnits:
        """Test SendPropertyUnitsSuccessResponseResponseResultUnits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPropertyUnitsSuccessResponseResponseResultUnits`
        """
        model = SendPropertyUnitsSuccessResponseResponseResultUnits()
        if include_optional:
    ...
    def testSendPropertyUnitsSuccessResponseResponseResultUnits(self):
        """Test SendPropertyUnitsSuccessResponseResponseResultUnits"""
