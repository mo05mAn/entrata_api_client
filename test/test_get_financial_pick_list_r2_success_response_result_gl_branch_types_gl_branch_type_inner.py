...
class TestGetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner(
                id = 1,
                name = 'Standard Group'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner"""
