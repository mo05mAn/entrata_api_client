...
class TestGetLeasesR1Method(unittest.TestCase):
    """GetLeasesR1Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR1Method:
        """Test GetLeasesR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR1Method`
        """
        model = GetLeasesR1Method()
        if include_optional:
            return GetLeasesR1Method(
                name = '',
                version = 'r1',
    ...
    def testGetLeasesR1Method(self):
        """Test GetLeasesR1Method"""
