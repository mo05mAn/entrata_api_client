...
class TestGetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrders(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrders:
        """Test GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrders`
        """
        model = GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrders()
        if include_optional:
    ...
    def testGetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrders(self):
        """Test GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrders"""
