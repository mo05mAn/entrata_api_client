...
class TestUpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner(unittest.TestCase):
    """UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner:
        """Test UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner`
        """
        model = UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner()
        if include_optional:
            return UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner(
                node = 1,
                status = 'Success',
                amenity_id = 1162615,
    ...
    def testUpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner(self):
        """Test UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner"""
