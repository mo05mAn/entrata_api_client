...
class TestGetLeaseArTransactions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseArTransactions:
        """Test GetLeaseArTransactions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseArTransactions`
        """
    ...
    def testGetLeaseArTransactions(self):
        """Test GetLeaseArTransactions"""
