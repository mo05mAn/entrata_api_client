...
class TestSendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner(unittest.TestCase):
    """SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner:
        """Test SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner`
        """
        model = SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner()
        if include_optional:
            return SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner(
    ...
    def testSendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner(self):
        """Test SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner"""
