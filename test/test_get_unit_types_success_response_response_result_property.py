...
class TestGetUnitTypesSuccessResponseResponseResultProperty(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUnitTypesSuccessResponseResponseResultProperty:
        """Test GetUnitTypesSuccessResponseResponseResultProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitTypesSuccessResponseResponseResultProperty`
        """
        model = GetUnitTypesSuccessResponseResponseResultProperty()
        if include_optional:
            return GetUnitTypesSuccessResponseResponseResultProperty(
                type = 'Apartment',
                property_id = '00000',
    ...
    def testGetUnitTypesSuccessResponseResponseResultProperty(self):
        """Test GetUnitTypesSuccessResponseResponseResultProperty"""
