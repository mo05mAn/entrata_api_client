...
class TestUpdateBudgetsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateBudgetsMethod:
        """Test UpdateBudgetsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBudgetsMethod`
        """
        model = UpdateBudgetsMethod()
        if include_optional:
    ...
    def testUpdateBudgetsMethod(self):
        """Test UpdateBudgetsMethod"""
