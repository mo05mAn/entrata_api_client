...
class TestGetInspectionTemplatesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInspectionTemplatesSuccessResponse:
        """Test GetInspectionTemplatesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionTemplatesSuccessResponse`
        """
        model = GetInspectionTemplatesSuccessResponse()
        if include_optional:
    ...
    def testGetInspectionTemplatesSuccessResponse(self):
        """Test GetInspectionTemplatesSuccessResponse"""
