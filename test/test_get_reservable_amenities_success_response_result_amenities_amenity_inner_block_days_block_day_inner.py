...
class TestGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner(unittest.TestCase):
    """GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner:
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner`
        """
        model = GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner()
        if include_optional:
            return GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner(
                day = 'Sunday',
    ...
    def testGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner(self):
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner"""
