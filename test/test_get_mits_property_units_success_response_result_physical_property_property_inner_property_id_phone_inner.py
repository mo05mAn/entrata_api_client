...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner()
        if include_optional:
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner"""
