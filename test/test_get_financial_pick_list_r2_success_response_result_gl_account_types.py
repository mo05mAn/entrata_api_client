...
class TestGetFinancialPickListR2SuccessResponseResultGlAccountTypes(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlAccountTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlAccountTypes:
        """Test GetFinancialPickListR2SuccessResponseResultGlAccountTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlAccountTypes`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlAccountTypes()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlAccountTypes(
                gl_account_type = [
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlAccountTypes(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlAccountTypes"""
