...
class TestUpdateLeaseMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateLeaseMethodParams:
        """Test UpdateLeaseMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeaseMethodParams`
        """
        model = UpdateLeaseMethodParams()
        if include_optional:
            return UpdateLeaseMethodParams(
                property_id = 123456,
                lease_id = 123456,
                unit_space_id = 12345,
    ...
    def testUpdateLeaseMethodParams(self):
        """Test UpdateLeaseMethodParams"""
