...
class TestGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity:
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity(
                name = 'Unit Amenity 1',
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity"""
