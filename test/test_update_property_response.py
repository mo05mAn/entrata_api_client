...
class TestUpdatePropertyResponse(unittest.TestCase):
    """UpdatePropertyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePropertyResponse:
        """Test UpdatePropertyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyResponse`
        """
    ...
    def testUpdatePropertyResponse(self):
        """Test UpdatePropertyResponse"""
