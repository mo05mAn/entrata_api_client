...
class TestUpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner:
        """Test UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner`
        """
    ...
    def testUpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner(self):
        """Test UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner"""
