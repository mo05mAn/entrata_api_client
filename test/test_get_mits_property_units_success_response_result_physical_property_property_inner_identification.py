...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification(unittest.TestCase):
    """GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification(
                id_value = '1234',
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification"""
