...
class TestOnNoticeLeaseMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OnNoticeLeaseMethod:
        """Test OnNoticeLeaseMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnNoticeLeaseMethod`
        """
        model = OnNoticeLeaseMethod()
        if include_optional:
    ...
    def testOnNoticeLeaseMethod(self):
        """Test OnNoticeLeaseMethod"""
