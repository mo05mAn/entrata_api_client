...
class TestUpdateWorkOrdersR1SuccessResponseResponseResult(unittest.TestCase):
    """UpdateWorkOrdersR1SuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWorkOrdersR1SuccessResponseResponseResult:
        """Test UpdateWorkOrdersR1SuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWorkOrdersR1SuccessResponseResponseResult`
        """
        model = UpdateWorkOrdersR1SuccessResponseResponseResult()
        if include_optional:
            return UpdateWorkOrdersR1SuccessResponseResponseResult(
    ...
    def testUpdateWorkOrdersR1SuccessResponseResponseResult(self):
        """Test UpdateWorkOrdersR1SuccessResponseResponseResult"""
