...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone(unittest.TestCase):
    """GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone`
        """
        model = GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone()
        if include_optional:
            return GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone(
                phone_type = 'personal',
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone"""
