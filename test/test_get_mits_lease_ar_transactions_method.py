...
class TestGetMitsLeaseArTransactionsMethod(unittest.TestCase):
    """GetMitsLeaseArTransactionsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeaseArTransactionsMethod:
        """Test GetMitsLeaseArTransactionsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeaseArTransactionsMethod`
        """
        model = GetMitsLeaseArTransactionsMethod()
        if include_optional:
            return GetMitsLeaseArTransactionsMethod(
    ...
    def testGetMitsLeaseArTransactionsMethod(self):
        """Test GetMitsLeaseArTransactionsMethod"""
