...
class TestGetFinancialPickListR2SuccessResponseResultGlLedgerTypes(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlLedgerTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlLedgerTypes:
        """Test GetFinancialPickListR2SuccessResponseResultGlLedgerTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlLedgerTypes`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlLedgerTypes()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlLedgerTypes(
                gl_ledger_type = [
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlLedgerTypes(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlLedgerTypes"""
