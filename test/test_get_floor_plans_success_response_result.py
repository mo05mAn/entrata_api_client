...
class TestGetFloorPlansSuccessResponseResult(unittest.TestCase):
    """GetFloorPlansSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResult:
        """Test GetFloorPlansSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResult`
        """
        model = GetFloorPlansSuccessResponseResult()
        if include_optional:
            return GetFloorPlansSuccessResponseResult(
    ...
    def testGetFloorPlansSuccessResponseResult(self):
        """Test GetFloorPlansSuccessResponseResult"""
