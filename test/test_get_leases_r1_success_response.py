...
class TestGetLeasesR1SuccessResponse(unittest.TestCase):
    """GetLeasesR1SuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR1SuccessResponse:
        """Test GetLeasesR1SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR1SuccessResponse`
        """
        model = GetLeasesR1SuccessResponse()
        if include_optional:
            return GetLeasesR1SuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_leases_r1_success_response_result.getLeases_r1_SuccessResponse_result(
                    leases = entrata_api_client.models.get_leases_r1_success_response_result_leases.getLeases_r1_SuccessResponse_result_leases(
                        lease = [
    ...
    def testGetLeasesR1SuccessResponse(self):
        """Test GetLeasesR1SuccessResponse"""
