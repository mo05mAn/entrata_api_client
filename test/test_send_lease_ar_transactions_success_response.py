...
class TestSendLeaseArTransactionsSuccessResponse(unittest.TestCase):
    """SendLeaseArTransactionsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionsSuccessResponse:
        """Test SendLeaseArTransactionsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionsSuccessResponse`
        """
        model = SendLeaseArTransactionsSuccessResponse()
        if include_optional:
            return SendLeaseArTransactionsSuccessResponse(
    ...
    def testSendLeaseArTransactionsSuccessResponse(self):
        """Test SendLeaseArTransactionsSuccessResponse"""
