...
class TestGetGlTreesR1Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGlTreesR1Method:
        """Test GetGlTreesR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR1Method`
        """
        model = GetGlTreesR1Method()
        if include_optional:
    ...
    def testGetGlTreesR1Method(self):
        """Test GetGlTreesR1Method"""
