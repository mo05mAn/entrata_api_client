...
class TestGetArPaymentsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetArPaymentsMethod:
        """Test GetArPaymentsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArPaymentsMethod`
        """
        model = GetArPaymentsMethod()
        if include_optional:
    ...
    def testGetArPaymentsMethod(self):
        """Test GetArPaymentsMethod"""
