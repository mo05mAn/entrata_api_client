...
class TestGetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner(unittest.TestCase):
    """GetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner:
        """Test GetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner`
        """
        model = GetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner()
        if include_optional:
            return GetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner(
                communication_channel = 'email',
                recipient_type = 'LEAD',
                recipient_type_id = 1,
                consent_type = 'Message Center Email',
                consent_type_id = 1
            )
        else:
            return GetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner(
    ...
    def testGetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner(self):
        """Test GetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner"""
