...
class TestGetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData(unittest.TestCase):
    """GetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData:
        """Test GetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData`
        """
        model = GetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData()
        if include_optional:
            return GetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData(
                call_id = '123456',
    ...
    def testGetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData(self):
        """Test GetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData"""
