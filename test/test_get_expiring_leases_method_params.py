...
class TestGetExpiringLeasesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetExpiringLeasesMethodParams:
        """Test GetExpiringLeasesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExpiringLeasesMethodParams`
        """
        model = GetExpiringLeasesMethodParams()
        if include_optional:
            return GetExpiringLeasesMethodParams(
                property_id = 123456,
    ...
    def testGetExpiringLeasesMethodParams(self):
        """Test GetExpiringLeasesMethodParams"""
