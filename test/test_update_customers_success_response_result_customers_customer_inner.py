...
class TestUpdateCustomersSuccessResponseResultCustomersCustomerInner(unittest.TestCase):
    """UpdateCustomersSuccessResponseResultCustomersCustomerInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCustomersSuccessResponseResultCustomersCustomerInner:
        """Test UpdateCustomersSuccessResponseResultCustomersCustomerInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomersSuccessResponseResultCustomersCustomerInner`
        """
        model = UpdateCustomersSuccessResponseResultCustomersCustomerInner()
        if include_optional:
            return UpdateCustomersSuccessResponseResultCustomersCustomerInner(
                node = '1',
    ...
    def testUpdateCustomersSuccessResponseResultCustomersCustomerInner(self):
        """Test UpdateCustomersSuccessResponseResultCustomersCustomerInner"""
