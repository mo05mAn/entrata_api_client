...
class TestGetVendorsSuccessResponseResultVendorsVendorInnerContacts(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendorsVendorInnerContacts:
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerContacts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendorsVendorInnerContacts`
        """
        model = GetVendorsSuccessResponseResultVendorsVendorInnerContacts()
        if include_optional:
    ...
    def testGetVendorsSuccessResponseResultVendorsVendorInnerContacts(self):
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerContacts"""
