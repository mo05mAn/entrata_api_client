...
class TestUpdateApplicationMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateApplicationMethodParams:
        """Test UpdateApplicationMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateApplicationMethodParams`
        """
        model = UpdateApplicationMethodParams()
        if include_optional:
            return UpdateApplicationMethodParams(
    ...
    def testUpdateApplicationMethodParams(self):
        """Test UpdateApplicationMethodParams"""
