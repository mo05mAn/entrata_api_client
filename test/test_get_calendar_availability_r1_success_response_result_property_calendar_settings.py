...
class TestGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings:
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings`
        """
        model = GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings()
        if include_optional:
            return GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings(
                property_id = '123456',
    ...
    def testGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings(self):
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings"""
