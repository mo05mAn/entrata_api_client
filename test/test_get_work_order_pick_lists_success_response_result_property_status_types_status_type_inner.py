...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner(
                id = '15106',
                name = 'Awaiting Parts',
                code = 'AP'
            )
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner"""
