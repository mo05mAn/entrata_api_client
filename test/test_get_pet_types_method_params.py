...
class TestGetPetTypesMethodParams(unittest.TestCase):
    """GetPetTypesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPetTypesMethodParams:
        """Test GetPetTypesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPetTypesMethodParams`
        """
        model = GetPetTypesMethodParams()
        if include_optional:
            return GetPetTypesMethodParams(
    ...
    def testGetPetTypesMethodParams(self):
        """Test GetPetTypesMethodParams"""
