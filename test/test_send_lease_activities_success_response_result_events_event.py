...
class TestSendLeaseActivitiesSuccessResponseResultEventsEvent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeaseActivitiesSuccessResponseResultEventsEvent:
        """Test SendLeaseActivitiesSuccessResponseResultEventsEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseActivitiesSuccessResponseResultEventsEvent`
        """
        model = SendLeaseActivitiesSuccessResponseResultEventsEvent()
        if include_optional:
            return SendLeaseActivitiesSuccessResponseResultEventsEvent(
                node = '1',
                lease_id = '10873580',
                status = 'Success',
    ...
    def testSendLeaseActivitiesSuccessResponseResultEventsEvent(self):
        """Test SendLeaseActivitiesSuccessResponseResultEventsEvent"""
