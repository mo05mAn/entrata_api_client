...
class TestSendInvoicesR1MethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendInvoicesR1MethodParams:
        """Test SendInvoicesR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR1MethodParams`
        """
        model = SendInvoicesR1MethodParams()
        if include_optional:
            return SendInvoicesR1MethodParams(
                ap_payee_id = 12345,
    ...
    def testSendInvoicesR1MethodParams(self):
        """Test SendInvoicesR1MethodParams"""
