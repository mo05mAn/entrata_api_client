...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanFile(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFile:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFile`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFile()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFile(
                file_type = 'Floorplan',
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanFile(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFile"""
