...
class TestMarkGlTransactionsExportedMethodParams(unittest.TestCase):
    """MarkGlTransactionsExportedMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkGlTransactionsExportedMethodParams:
        """Test MarkGlTransactionsExportedMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkGlTransactionsExportedMethodParams`
        """
        model = MarkGlTransactionsExportedMethodParams()
        if include_optional:
            return MarkGlTransactionsExportedMethodParams(
                gl_detail_id = 56
            )
        else:
            return MarkGlTransactionsExportedMethodParams(
    ...
    def testMarkGlTransactionsExportedMethodParams(self):
        """Test MarkGlTransactionsExportedMethodParams"""
