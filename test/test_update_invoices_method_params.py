...
class TestUpdateInvoicesMethodParams(unittest.TestCase):
    """UpdateInvoicesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateInvoicesMethodParams:
        """Test UpdateInvoicesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateInvoicesMethodParams`
        """
        model = UpdateInvoicesMethodParams()
        if include_optional:
            return UpdateInvoicesMethodParams(
                id = 12345,
    ...
    def testUpdateInvoicesMethodParams(self):
        """Test UpdateInvoicesMethodParams"""
