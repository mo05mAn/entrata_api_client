...
class TestGetAmenityReservationsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAmenityReservationsMethodParams:
        """Test GetAmenityReservationsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenityReservationsMethodParams`
        """
        model = GetAmenityReservationsMethodParams()
        if include_optional:
            return GetAmenityReservationsMethodParams(
                property_id = 12345,
                amenity_ids = 56,
    ...
    def testGetAmenityReservationsMethodParams(self):
        """Test GetAmenityReservationsMethodParams"""
