...
class TestGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes(unittest.TestCase):
    """GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes:
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes`
        """
        model = GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes()
        if include_optional:
            return GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes(
                id = '2652',
                name = 'TEST'
            )
        else:
    ...
    def testGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes(self):
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes"""
