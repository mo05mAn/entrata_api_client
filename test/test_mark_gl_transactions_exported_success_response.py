...
class TestMarkGlTransactionsExportedSuccessResponse(unittest.TestCase):
    """MarkGlTransactionsExportedSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkGlTransactionsExportedSuccessResponse:
        """Test MarkGlTransactionsExportedSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkGlTransactionsExportedSuccessResponse`
        """
        model = MarkGlTransactionsExportedSuccessResponse()
        if include_optional:
            return MarkGlTransactionsExportedSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.mark_gl_transactions_exported_success_response_result.markGlTransactionsExportedSuccessResponse_result(
                    status = 'Success', 
                    message = 'Gl Transactions marked as exported successfully.', )
            )
        else:
            return MarkGlTransactionsExportedSuccessResponse(
                request_id = '15',
    ...
    def testMarkGlTransactionsExportedSuccessResponse(self):
        """Test MarkGlTransactionsExportedSuccessResponse"""
