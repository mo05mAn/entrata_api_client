...
class TestGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification(unittest.TestCase):
    """GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification:
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification`
        """
        model = GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification()
        if include_optional:
            return GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification(
                id_value = 21442,
    ...
    def testGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification(self):
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification"""
