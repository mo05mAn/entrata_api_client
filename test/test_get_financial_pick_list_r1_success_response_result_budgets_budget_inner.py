...
class TestGetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner:
        """Test GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner(
                id = 67183,
                name = 'test budget HV',
                status_type_id = 4,
                is_default = 0,
    ...
    def testGetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner"""
