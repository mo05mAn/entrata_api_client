...
class TestGetCompanyApplicationsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCompanyApplicationsMethod:
        """Test GetCompanyApplicationsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCompanyApplicationsMethod`
        """
        model = GetCompanyApplicationsMethod()
        if include_optional:
    ...
    def testGetCompanyApplicationsMethod(self):
        """Test GetCompanyApplicationsMethod"""
