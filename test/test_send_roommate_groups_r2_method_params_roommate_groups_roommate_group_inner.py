...
class TestSendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner(unittest.TestCase):
    """SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner:
        """Test SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner`
        """
        model = SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner()
        if include_optional:
            return SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner(
    ...
    def testSendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner(self):
        """Test SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner"""
