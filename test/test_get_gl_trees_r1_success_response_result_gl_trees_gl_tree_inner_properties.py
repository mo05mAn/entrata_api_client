...
class TestGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerProperties:
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerProperties`
        """
        model = GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerProperties()
        if include_optional:
    ...
    def testGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerProperties(self):
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerProperties"""
