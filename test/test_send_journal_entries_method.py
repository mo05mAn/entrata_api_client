...
class TestSendJournalEntriesMethod(unittest.TestCase):
    """SendJournalEntriesMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendJournalEntriesMethod:
        """Test SendJournalEntriesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendJournalEntriesMethod`
        """
        model = SendJournalEntriesMethod()
        if include_optional:
            return SendJournalEntriesMethod(
    ...
    def testSendJournalEntriesMethod(self):
        """Test SendJournalEntriesMethod"""
