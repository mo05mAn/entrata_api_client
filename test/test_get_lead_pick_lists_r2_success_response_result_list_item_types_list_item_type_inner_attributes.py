...
class TestGetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes:
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes`
        """
        model = GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes(
                id = '9',
    ...
    def testGetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes(self):
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes"""
