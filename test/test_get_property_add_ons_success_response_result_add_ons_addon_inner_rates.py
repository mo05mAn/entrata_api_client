...
class TestGetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRates(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRates:
        """Test GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRates`
        """
        model = GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRates()
        if include_optional:
    ...
    def testGetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRates(self):
        """Test GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRates"""
