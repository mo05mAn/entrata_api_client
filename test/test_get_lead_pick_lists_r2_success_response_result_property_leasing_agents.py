...
class TestGetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents:
        """Test GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents`
        """
        model = GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents()
        if include_optional:
    ...
    def testGetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents(self):
        """Test GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents"""
