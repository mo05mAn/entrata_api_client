...
class TestSendPropertyMediaMethodParams(unittest.TestCase):
    """SendPropertyMediaMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPropertyMediaMethodParams:
        """Test SendPropertyMediaMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPropertyMediaMethodParams`
        """
        model = SendPropertyMediaMethodParams()
        if include_optional:
            return SendPropertyMediaMethodParams(
                property_id = '123456',
                media = [
                    null
                    ]
    ...
    def testSendPropertyMediaMethodParams(self):
        """Test SendPropertyMediaMethodParams"""
