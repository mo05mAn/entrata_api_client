...
class TestGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName(unittest.TestCase):
    """GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName:
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName`
        """
        model = GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName()
        if include_optional:
            return GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName(
    ...
    def testGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName(self):
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName"""
