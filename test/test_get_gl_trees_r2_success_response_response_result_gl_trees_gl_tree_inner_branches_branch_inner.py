...
class TestGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner(unittest.TestCase):
    """GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner:
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner`
        """
        model = GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner()
        if include_optional:
            return GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner(
                branch_id = '12345',
    ...
    def testGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner(self):
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner"""
