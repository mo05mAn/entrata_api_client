...
class TestGetVendorPickListsSuccessResponseResultForm1099BoxTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultForm1099BoxTypes:
        """Test GetVendorPickListsSuccessResponseResultForm1099BoxTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultForm1099BoxTypes`
        """
        model = GetVendorPickListsSuccessResponseResultForm1099BoxTypes()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultForm1099BoxTypes(self):
        """Test GetVendorPickListsSuccessResponseResultForm1099BoxTypes"""
