...
class TestGetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner:
        """Test GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner`
        """
        model = GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner()
        if include_optional:
            return GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner(
                id = 12345,
                property_id = 12345,
                unit_id = 12345,
                lease_id = 12345,
    ...
    def testGetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner(self):
        """Test GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner"""
