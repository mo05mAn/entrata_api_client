...
class TestUpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner(unittest.TestCase):
    """UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner:
        """Test UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner`
        """
        model = UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner()
        if include_optional:
            return UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner(
                node = 1,
                status = 'Failure',
    ...
    def testUpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner(self):
        """Test UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner"""
