...
class TestGetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner(unittest.TestCase):
    """GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner:
        """Test GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner`
        """
        model = GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner()
        if include_optional:
            return GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner(
    ...
    def testGetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner(self):
        """Test GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner"""
