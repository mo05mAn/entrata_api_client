...
class TestGetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner(unittest.TestCase):
    """GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner:
        """Test GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner`
        """
        model = GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner()
        if include_optional:
            return GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner(
    ...
    def testGetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner(self):
        """Test GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner"""
