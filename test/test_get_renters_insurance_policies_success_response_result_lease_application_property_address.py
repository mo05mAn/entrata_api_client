...
class TestGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress:
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress`
        """
        model = GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress()
        if include_optional:
            return GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress(
    ...
    def testGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress(self):
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress"""
