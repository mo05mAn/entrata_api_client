...
class TestSendWorkOrdersSuccessResponseResponseResult(unittest.TestCase):
    """SendWorkOrdersSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendWorkOrdersSuccessResponseResponseResult:
        """Test SendWorkOrdersSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendWorkOrdersSuccessResponseResponseResult`
        """
        model = SendWorkOrdersSuccessResponseResponseResult()
        if include_optional:
            return SendWorkOrdersSuccessResponseResponseResult(
                success = [
    ...
    def testSendWorkOrdersSuccessResponseResponseResult(self):
        """Test SendWorkOrdersSuccessResponseResponseResult"""
