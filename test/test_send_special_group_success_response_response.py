...
class TestSendSpecialGroupSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendSpecialGroupSuccessResponseResponse:
        """Test SendSpecialGroupSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSpecialGroupSuccessResponseResponse`
        """
        model = SendSpecialGroupSuccessResponseResponse()
        if include_optional:
    ...
    def testSendSpecialGroupSuccessResponseResponse(self):
        """Test SendSpecialGroupSuccessResponseResponse"""
