    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesSuccessResponse:
        ...
        if include_optional:
            return GetReservableAmenitiesSuccessResponse(
                request_id = '15',
                result = openapi_client.models.get_reservable_amenities_success_response_result.getReservableAmenitiesSuccessResponse_result(
                    amenities = openapi_client.models.get_reservable_amenities_success_response_result_amenities.getReservableAmenitiesSuccessResponse_result_amenities(
                        amenity = [
