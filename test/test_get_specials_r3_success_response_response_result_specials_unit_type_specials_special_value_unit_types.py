...
class TestGetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes:
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes`
        """
        model = GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes()
        if include_optional:
    ...
    def testGetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes(self):
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes"""
