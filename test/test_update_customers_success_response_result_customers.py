...
class TestUpdateCustomersSuccessResponseResultCustomers(unittest.TestCase):
    """UpdateCustomersSuccessResponseResultCustomers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCustomersSuccessResponseResultCustomers:
        """Test UpdateCustomersSuccessResponseResultCustomers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomersSuccessResponseResultCustomers`
        """
        model = UpdateCustomersSuccessResponseResultCustomers()
        if include_optional:
            return UpdateCustomersSuccessResponseResultCustomers(
                customer = [
    ...
    def testUpdateCustomersSuccessResponseResultCustomers(self):
        """Test UpdateCustomersSuccessResponseResultCustomers"""
