...
class TestSendLeaseDocumentsSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeaseDocumentsSuccessResponse:
        """Test SendLeaseDocumentsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseDocumentsSuccessResponse`
        """
        model = SendLeaseDocumentsSuccessResponse()
        if include_optional:
    ...
    def testSendLeaseDocumentsSuccessResponse(self):
        """Test SendLeaseDocumentsSuccessResponse"""
