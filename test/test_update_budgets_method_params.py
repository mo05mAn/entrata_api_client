...
class TestUpdateBudgetsMethodParams(unittest.TestCase):
    """UpdateBudgetsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBudgetsMethodParams:
        """Test UpdateBudgetsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBudgetsMethodParams`
        """
        model = UpdateBudgetsMethodParams()
        if include_optional:
            return UpdateBudgetsMethodParams(
                property_id = 123456,
                id = 123456,
    ...
    def testUpdateBudgetsMethodParams(self):
        """Test UpdateBudgetsMethodParams"""
