...
class TestGetFinancialPickListR1MethodParams(unittest.TestCase):
    """GetFinancialPickListR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1MethodParams:
        """Test GetFinancialPickListR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1MethodParams`
        """
        model = GetFinancialPickListR1MethodParams()
        if include_optional:
            return GetFinancialPickListR1MethodParams(
                property_id = 123456
            )
        else:
            return GetFinancialPickListR1MethodParams(
    ...
    def testGetFinancialPickListR1MethodParams(self):
        """Test GetFinancialPickListR1MethodParams"""
