...
class TestGetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner(unittest.TestCase):
    """GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner:
        """Test GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner`
        """
        model = GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner()
        if include_optional:
            return GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner(
                id = '2671',
                name = 'Phase 1',
                budget = '30.00'
            )
    ...
    def testGetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner(self):
        """Test GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner"""
