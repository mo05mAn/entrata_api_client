...
class TestGetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRent:
        """Test GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRent`
        """
        model = GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRent()
        if include_optional:
    ...
    def testGetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRent(self):
        """Test GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRent"""
