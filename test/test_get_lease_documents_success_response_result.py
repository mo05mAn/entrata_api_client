...
class TestGetLeaseDocumentsSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsSuccessResponseResult:
        """Test GetLeaseDocumentsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsSuccessResponseResult`
        """
    ...
    def testGetLeaseDocumentsSuccessResponseResult(self):
        """Test GetLeaseDocumentsSuccessResponseResult"""
