...
class TestSendBudgetedRentMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendBudgetedRentMethod:
        """Test SendBudgetedRentMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetedRentMethod`
        """
        model = SendBudgetedRentMethod()
        if include_optional:
    ...
    def testSendBudgetedRentMethod(self):
        """Test SendBudgetedRentMethod"""
