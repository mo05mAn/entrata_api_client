...
class TestGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge(unittest.TestCase):
    """GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge:
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge`
        """
        model = GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge()
        if include_optional:
            return GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge(
                ar_code_id = '1858',
    ...
    def testGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge(self):
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge"""
