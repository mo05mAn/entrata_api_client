...
class TestGetPropertyUnitsSuccessResponseResponse(unittest.TestCase):
    """GetPropertyUnitsSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyUnitsSuccessResponseResponse:
        """Test GetPropertyUnitsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyUnitsSuccessResponseResponse`
        """
        model = GetPropertyUnitsSuccessResponseResponse()
        if include_optional:
            return GetPropertyUnitsSuccessResponseResponse(
                request_id = 15,
    ...
    def testGetPropertyUnitsSuccessResponseResponse(self):
        """Test GetPropertyUnitsSuccessResponseResponse"""
