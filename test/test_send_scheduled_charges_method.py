...
class TestSendScheduledChargesMethod(unittest.TestCase):
    """SendScheduledChargesMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendScheduledChargesMethod:
        """Test SendScheduledChargesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendScheduledChargesMethod`
        """
        model = SendScheduledChargesMethod()
        if include_optional:
            return SendScheduledChargesMethod(
    ...
    def testSendScheduledChargesMethod(self):
        """Test SendScheduledChargesMethod"""
