...
class TestUpdateWorkOrdersR1MethodParams(unittest.TestCase):
    """UpdateWorkOrdersR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWorkOrdersR1MethodParams:
        """Test UpdateWorkOrdersR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWorkOrdersR1MethodParams`
        """
        model = UpdateWorkOrdersR1MethodParams()
        if include_optional:
            return UpdateWorkOrdersR1MethodParams(
                property_id = 123456,
    ...
    def testUpdateWorkOrdersR1MethodParams(self):
        """Test UpdateWorkOrdersR1MethodParams"""
