...
class TestGetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes:
        """Test GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes`
        """
        model = GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes()
        if include_optional:
            return GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes(
                id = 21,
    ...
    def testGetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes(self):
        """Test GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes"""
