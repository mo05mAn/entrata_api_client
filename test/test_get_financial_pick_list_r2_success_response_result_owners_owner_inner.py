...
class TestGetFinancialPickListR2SuccessResponseResultOwnersOwnerInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner:
        """Test GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner(
                id = '60732',
                name = '0000CNYE1',
    ...
    def testGetFinancialPickListR2SuccessResponseResultOwnersOwnerInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner"""
