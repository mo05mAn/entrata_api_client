...
class TestGetParcelAlertsSuccessResponseResponse(unittest.TestCase):
    """GetParcelAlertsSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetParcelAlertsSuccessResponseResponse:
        """Test GetParcelAlertsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetParcelAlertsSuccessResponseResponse`
        """
        model = GetParcelAlertsSuccessResponseResponse()
        if include_optional:
            return GetParcelAlertsSuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testGetParcelAlertsSuccessResponseResponse(self):
        """Test GetParcelAlertsSuccessResponseResponse"""
