...
class TestGetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner(unittest.TestCase):
    """GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner()
        if include_optional:
            return GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner(
                model = 'aakash',
                color = 'aakash',
                make = 'aakash',
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner"""
