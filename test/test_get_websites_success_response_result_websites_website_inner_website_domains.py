...
class TestGetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains:
        """Test GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains`
        """
        model = GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains()
        if include_optional:
    ...
    def testGetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains(self):
        """Test GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains"""
