...
class TestGetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems:
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems`
        """
        model = GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems()
        if include_optional:
    ...
    def testGetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems(self):
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems"""
