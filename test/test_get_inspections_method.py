...
class TestGetInspectionsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInspectionsMethod:
        """Test GetInspectionsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionsMethod`
        """
        model = GetInspectionsMethod()
        if include_optional:
    ...
    def testGetInspectionsMethod(self):
        """Test GetInspectionsMethod"""
