...
class TestUpdateVendors(unittest.TestCase):
    """UpdateVendors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateVendors:
        """Test UpdateVendors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateVendors`
        """
        model = UpdateVendors()
        if include_optional:
            return UpdateVendors(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.update_vendors_method.updateVendors_method(
                    name = 'updateVendors', 
                    version = 'r1', 
