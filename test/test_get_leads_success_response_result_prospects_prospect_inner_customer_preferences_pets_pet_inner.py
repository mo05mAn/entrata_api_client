...
class TestGetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner(unittest.TestCase):
    """GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner:
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner`
        """
        model = GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner()
        if include_optional:
            return GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner(
                pet_type = [
                    ''
                    ],
                count = [
    ...
    def testGetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner(self):
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner"""
