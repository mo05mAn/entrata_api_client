...
class TestGetRentersInsurancePoliciesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetRentersInsurancePoliciesMethodParams:
        """Test GetRentersInsurancePoliciesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentersInsurancePoliciesMethodParams`
        """
        model = GetRentersInsurancePoliciesMethodParams()
        if include_optional:
            return GetRentersInsurancePoliciesMethodParams(
                property_id = 123456,
    ...
    def testGetRentersInsurancePoliciesMethodParams(self):
        """Test GetRentersInsurancePoliciesMethodParams"""
