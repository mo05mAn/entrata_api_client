...
class TestSendApplicationPetsMethod(unittest.TestCase):
    """SendApplicationPetsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationPetsMethod:
        """Test SendApplicationPetsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationPetsMethod`
        """
        model = SendApplicationPetsMethod()
        if include_optional:
            return SendApplicationPetsMethod(
    ...
    def testSendApplicationPetsMethod(self):
        """Test SendApplicationPetsMethod"""
