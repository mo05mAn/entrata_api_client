...
class TestGetBudgetActualsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBudgetActualsMethod:
        """Test GetBudgetActualsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBudgetActualsMethod`
        """
        model = GetBudgetActualsMethod()
        if include_optional:
    ...
    def testGetBudgetActualsMethod(self):
        """Test GetBudgetActualsMethod"""
