...
class TestGetVendorsSuccessResponseResultVendors(unittest.TestCase):
    """GetVendorsSuccessResponseResultVendors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendors:
        """Test GetVendorsSuccessResponseResultVendors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendors`
        """
        model = GetVendorsSuccessResponseResultVendors()
        if include_optional:
            return GetVendorsSuccessResponseResultVendors(
                vendor = [
    ...
    def testGetVendorsSuccessResponseResultVendors(self):
        """Test GetVendorsSuccessResponseResultVendors"""
