...
class TestSendInvoicesR2SuccessResponseResultApBatch(unittest.TestCase):
    """SendInvoicesR2SuccessResponseResultApBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendInvoicesR2SuccessResponseResultApBatch:
        """Test SendInvoicesR2SuccessResponseResultApBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR2SuccessResponseResultApBatch`
        """
        model = SendInvoicesR2SuccessResponseResultApBatch()
        if include_optional:
            return SendInvoicesR2SuccessResponseResultApBatch(
                ap_batch_id = 99999,
    ...
    def testSendInvoicesR2SuccessResponseResultApBatch(self):
        """Test SendInvoicesR2SuccessResponseResultApBatch"""
