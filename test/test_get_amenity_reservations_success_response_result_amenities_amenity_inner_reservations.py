...
class TestGetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations(unittest.TestCase):
    """GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations:
        """Test GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations`
        """
        model = GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations()
        if include_optional:
            return GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations(
                reservation = [
    ...
    def testGetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations(self):
        """Test GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations"""
