...
class TestSendLeaseActivitiesSuccessResponse(unittest.TestCase):
    """SendLeaseActivitiesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseActivitiesSuccessResponse:
        """Test SendLeaseActivitiesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseActivitiesSuccessResponse`
        """
        model = SendLeaseActivitiesSuccessResponse()
        if include_optional:
            return SendLeaseActivitiesSuccessResponse(
                request_id = '15',
                code = 200,
                result = entrata_api_client.models.send_lease_activities_success_response_result.sendLeaseActivitiesSuccessResponse_result(
    ...
    def testSendLeaseActivitiesSuccessResponse(self):
        """Test SendLeaseActivitiesSuccessResponse"""
