...
class TestSendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies:
        """Test SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies`
        """
        model = SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies()
        if include_optional:
    ...
    def testSendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies(self):
        """Test SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies"""
