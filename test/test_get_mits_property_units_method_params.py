...
class TestGetMitsPropertyUnitsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsMethodParams:
        """Test GetMitsPropertyUnitsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsMethodParams`
        """
        model = GetMitsPropertyUnitsMethodParams()
        if include_optional:
            return GetMitsPropertyUnitsMethodParams(
    ...
    def testGetMitsPropertyUnitsMethodParams(self):
        """Test GetMitsPropertyUnitsMethodParams"""
