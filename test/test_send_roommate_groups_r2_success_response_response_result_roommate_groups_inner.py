...
class TestSendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner(unittest.TestCase):
    """SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner:
        """Test SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner`
        """
        model = SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner()
        if include_optional:
            return SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner(
                node = 1,
    ...
    def testSendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner(self):
        """Test SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner"""
