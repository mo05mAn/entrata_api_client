...
class TestSendPurchaseOrdersSuccessResponseResultApHeaders(unittest.TestCase):
    """SendPurchaseOrdersSuccessResponseResultApHeaders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPurchaseOrdersSuccessResponseResultApHeaders:
        """Test SendPurchaseOrdersSuccessResponseResultApHeaders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPurchaseOrdersSuccessResponseResultApHeaders`
        """
        model = SendPurchaseOrdersSuccessResponseResultApHeaders()
        if include_optional:
            return SendPurchaseOrdersSuccessResponseResultApHeaders(
                ap_header = [
    ...
    def testSendPurchaseOrdersSuccessResponseResultApHeaders(self):
        """Test SendPurchaseOrdersSuccessResponseResultApHeaders"""
