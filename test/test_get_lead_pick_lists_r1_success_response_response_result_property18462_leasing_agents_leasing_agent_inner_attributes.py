...
class TestGetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes:
        """Test GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes`
        """
        model = GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes()
        if include_optional:
            return GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes(
                name = 'Abby Stevens',
                id = '175141'
            )
        else:
    ...
    def testGetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes(self):
        """Test GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes"""
