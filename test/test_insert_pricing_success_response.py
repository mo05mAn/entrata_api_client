...
class TestInsertPricingSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InsertPricingSuccessResponse:
        """Test InsertPricingSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingSuccessResponse`
        """
        model = InsertPricingSuccessResponse()
        if include_optional:
    ...
    def testInsertPricingSuccessResponse(self):
        """Test InsertPricingSuccessResponse"""
