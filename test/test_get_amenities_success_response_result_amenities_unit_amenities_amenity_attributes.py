...
class TestGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes:
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes(
                id = '33333',
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes"""
