...
class TestErrorResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ErrorResponseResponse:
        """Test ErrorResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorResponseResponse`
        """
    ...
    def testErrorResponseResponse(self):
        """Test ErrorResponseResponse"""
