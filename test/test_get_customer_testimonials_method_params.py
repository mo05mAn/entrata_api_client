...
class TestGetCustomerTestimonialsMethodParams(unittest.TestCase):
    """GetCustomerTestimonialsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomerTestimonialsMethodParams:
        """Test GetCustomerTestimonialsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomerTestimonialsMethodParams`
        """
        model = GetCustomerTestimonialsMethodParams()
        if include_optional:
            return GetCustomerTestimonialsMethodParams(
                property_id = 123456,
                is_approved = True,
    ...
    def testGetCustomerTestimonialsMethodParams(self):
        """Test GetCustomerTestimonialsMethodParams"""
