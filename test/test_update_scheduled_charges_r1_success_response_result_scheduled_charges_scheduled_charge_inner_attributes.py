...
class TestUpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInnerAttributes(unittest.TestCase):
    """UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInnerAttributes:
        """Test UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInnerAttributes`
        """
        model = UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInnerAttributes()
        if include_optional:
            return UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInnerAttributes(
                id = '1234',
                node = '1',
                status = 'Success',
    ...
    def testUpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInnerAttributes(self):
        """Test UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInnerAttributes"""
