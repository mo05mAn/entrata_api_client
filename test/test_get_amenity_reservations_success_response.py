    ...
    def make_instance(self, include_optional) -> GetAmenityReservationsSuccessResponse:
        ...
        if include_optional:
            return GetAmenityReservationsSuccessResponse(
                request_id = '15',
                code = 200,
                result = openapi_client.models.get_amenity_reservations_success_response_result.getAmenityReservationsSuccessResponse_result(
                    amenities = openapi_client.models.get_amenity_reservations_success_response_result_amenities.getAmenityReservationsSuccessResponse_result_amenities(
                        amenity = [
