...
class TestGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification:
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification`
        """
        model = GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification()
        if include_optional:
    ...
    def testGetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification(self):
        """Test GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification"""
