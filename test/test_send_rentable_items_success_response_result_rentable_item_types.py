...
class TestSendRentableItemsSuccessResponseResultRentableItemTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRentableItemsSuccessResponseResultRentableItemTypes:
        """Test SendRentableItemsSuccessResponseResultRentableItemTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentableItemsSuccessResponseResultRentableItemTypes`
        """
        model = SendRentableItemsSuccessResponseResultRentableItemTypes()
        if include_optional:
    ...
    def testSendRentableItemsSuccessResponseResultRentableItemTypes(self):
        """Test SendRentableItemsSuccessResponseResultRentableItemTypes"""
