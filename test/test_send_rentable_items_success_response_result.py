...
class TestSendRentableItemsSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRentableItemsSuccessResponseResult:
        """Test SendRentableItemsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentableItemsSuccessResponseResult`
        """
    ...
    def testSendRentableItemsSuccessResponseResult(self):
        """Test SendRentableItemsSuccessResponseResult"""
