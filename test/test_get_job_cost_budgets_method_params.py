...
class TestGetJobCostBudgetsMethodParams(unittest.TestCase):
    """GetJobCostBudgetsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobCostBudgetsMethodParams:
        """Test GetJobCostBudgetsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCostBudgetsMethodParams`
        """
        model = GetJobCostBudgetsMethodParams()
        if include_optional:
            return GetJobCostBudgetsMethodParams(
                property_ids = 56,
                job_ids = 56,
                job_status_ids = 56,
                ap_code_ids = 56,
    ...
    def testGetJobCostBudgetsMethodParams(self):
        """Test GetJobCostBudgetsMethodParams"""
