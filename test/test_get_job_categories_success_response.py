...
class TestGetJobCategoriesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetJobCategoriesSuccessResponse:
        """Test GetJobCategoriesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCategoriesSuccessResponse`
        """
        model = GetJobCategoriesSuccessResponse()
        if include_optional:
    ...
    def testGetJobCategoriesSuccessResponse(self):
        """Test GetJobCategoriesSuccessResponse"""
