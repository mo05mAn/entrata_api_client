...
class TestGetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInner:
        """Test GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInner`
        """
        model = GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInner()
        if include_optional:
    ...
    def testGetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInner(self):
        """Test GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInner"""
