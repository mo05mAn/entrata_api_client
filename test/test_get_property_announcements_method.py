...
class TestGetPropertyAnnouncementsMethod(unittest.TestCase):
    """GetPropertyAnnouncementsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyAnnouncementsMethod:
        """Test GetPropertyAnnouncementsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAnnouncementsMethod`
        """
        model = GetPropertyAnnouncementsMethod()
        if include_optional:
            return GetPropertyAnnouncementsMethod(
    ...
    def testGetPropertyAnnouncementsMethod(self):
        """Test GetPropertyAnnouncementsMethod"""
