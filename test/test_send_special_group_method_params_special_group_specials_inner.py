...
class TestSendSpecialGroupMethodParamsSpecialGroupSpecialsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendSpecialGroupMethodParamsSpecialGroupSpecialsInner:
        """Test SendSpecialGroupMethodParamsSpecialGroupSpecialsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSpecialGroupMethodParamsSpecialGroupSpecialsInner`
        """
        model = SendSpecialGroupMethodParamsSpecialGroupSpecialsInner()
        if include_optional:
            return SendSpecialGroupMethodParamsSpecialGroupSpecialsInner(
                special_type_id = '1',
    ...
    def testSendSpecialGroupMethodParamsSpecialGroupSpecialsInner(self):
        """Test SendSpecialGroupMethodParamsSpecialGroupSpecialsInner"""
