...
class TestGetSpecialsR1Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR1Method:
        """Test GetSpecialsR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR1Method`
        """
        model = GetSpecialsR1Method()
        if include_optional:
    ...
    def testGetSpecialsR1Method(self):
        """Test GetSpecialsR1Method"""
