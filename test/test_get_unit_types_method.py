...
class TestGetUnitTypesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUnitTypesMethod:
        """Test GetUnitTypesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitTypesMethod`
        """
        model = GetUnitTypesMethod()
        if include_optional:
    ...
    def testGetUnitTypesMethod(self):
        """Test GetUnitTypesMethod"""
