...
class TestUpdateInvoicesSuccessResponseResultApHeadersApHeaderInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateInvoicesSuccessResponseResultApHeadersApHeaderInner:
        """Test UpdateInvoicesSuccessResponseResultApHeadersApHeaderInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateInvoicesSuccessResponseResultApHeadersApHeaderInner`
        """
        model = UpdateInvoicesSuccessResponseResultApHeadersApHeaderInner()
        if include_optional:
            return UpdateInvoicesSuccessResponseResultApHeadersApHeaderInner(
    ...
    def testUpdateInvoicesSuccessResponseResultApHeadersApHeaderInner(self):
        """Test UpdateInvoicesSuccessResponseResultApHeadersApHeaderInner"""
