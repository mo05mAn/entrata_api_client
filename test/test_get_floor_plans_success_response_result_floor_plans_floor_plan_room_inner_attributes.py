...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes(unittest.TestCase):
    """GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes(
                room_type = 'Bedroom'
            )
        else:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes(
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes"""
