...
class TestGetCompanyApplicationsSuccessResponse(unittest.TestCase):
    """GetCompanyApplicationsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCompanyApplicationsSuccessResponse:
        """Test GetCompanyApplicationsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCompanyApplicationsSuccessResponse`
        """
        model = GetCompanyApplicationsSuccessResponse()
        if include_optional:
            return GetCompanyApplicationsSuccessResponse(
                response = entrata_api_client.models.get_company_applications_success_response_response.getCompanyApplicationsSuccessResponse_response(
                    request_id = '12345', 
                    code = 200, 
    ...
    def testGetCompanyApplicationsSuccessResponse(self):
        """Test GetCompanyApplicationsSuccessResponse"""
