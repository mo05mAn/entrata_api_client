...
class TestGetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName(unittest.TestCase):
    """GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName:
        """Test GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName`
        """
        model = GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName()
        if include_optional:
            return GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName(
                first_name = 'John',
                last_name = 'Doe'
            )
        else:
    ...
    def testGetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName(self):
        """Test GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName"""
