...
class TestGetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes(unittest.TestCase):
    """GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes:
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes`
        """
        model = GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes()
        if include_optional:
            return GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes(
                id = '123',
                name = 'Corporate'
            )
        else:
    ...
    def testGetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes(self):
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes"""
