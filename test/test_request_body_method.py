...
class TestRequestBodyMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RequestBodyMethod:
        """Test RequestBodyMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestBodyMethod`
        """
        model = RequestBodyMethod()
        if include_optional:
    ...
    def testRequestBodyMethod(self):
        """Test RequestBodyMethod"""
