...
class TestSendApplicantGeneralDetailsSuccessResponseResponseResultInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicantGeneralDetailsSuccessResponseResponseResultInner:
        """Test SendApplicantGeneralDetailsSuccessResponseResponseResultInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicantGeneralDetailsSuccessResponseResponseResultInner`
        """
        model = SendApplicantGeneralDetailsSuccessResponseResponseResultInner()
        if include_optional:
            return SendApplicantGeneralDetailsSuccessResponseResponseResultInner(
                status = 'Success',
    ...
    def testSendApplicantGeneralDetailsSuccessResponseResponseResultInner(self):
        """Test SendApplicantGeneralDetailsSuccessResponseResponseResultInner"""
