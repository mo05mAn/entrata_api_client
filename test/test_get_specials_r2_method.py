...
class TestGetSpecialsR2Method(unittest.TestCase):
    """GetSpecialsR2Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2Method:
        """Test GetSpecialsR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2Method`
        """
        model = GetSpecialsR2Method()
        if include_optional:
            return GetSpecialsR2Method(
                name = '',
                version = 'r2',
    ...
    def testGetSpecialsR2Method(self):
        """Test GetSpecialsR2Method"""
