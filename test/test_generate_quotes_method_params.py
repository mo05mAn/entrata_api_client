...
class TestGenerateQuotesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GenerateQuotesMethodParams:
        """Test GenerateQuotesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateQuotesMethodParams`
        """
        model = GenerateQuotesMethodParams()
        if include_optional:
            return GenerateQuotesMethodParams(
                property_id = 123456,
                application_id = 1234,
    ...
    def testGenerateQuotesMethodParams(self):
        """Test GenerateQuotesMethodParams"""
