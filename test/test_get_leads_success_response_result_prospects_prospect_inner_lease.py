...
class TestGetLeadsSuccessResponseResultProspectsProspectInnerLease(unittest.TestCase):
    """GetLeadsSuccessResponseResultProspectsProspectInnerLease unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResultProspectsProspectInnerLease:
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerLease
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResultProspectsProspectInnerLease`
        """
        model = GetLeadsSuccessResponseResultProspectsProspectInnerLease()
        if include_optional:
            return GetLeadsSuccessResponseResultProspectsProspectInnerLease(
                lease_id = '1234',
                status = 'Cancelled',
    ...
    def testGetLeadsSuccessResponseResultProspectsProspectInnerLease(self):
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerLease"""
