...
class TestGetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner(unittest.TestCase):
    """GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner:
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner`
        """
        model = GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner()
        if include_optional:
            return GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner(
    ...
    def testGetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner(self):
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner"""
