        ...
        if include_optional:
            return GetCustomerTestimonials(
                auth = openapi_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = openapi_client.models.get_customer_testimonials_method.getCustomerTestimonials_method(
                    name = 'getCustomerTestimonials', 
                    version = 'r1', 
                    params = openapi_client.models.get_customer_testimonials_method_params.getCustomerTestimonials_method_params(
                        property_id = 123456, 
                        is_approved = True, 
