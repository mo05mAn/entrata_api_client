...
class TestGetCustomerTestimonials(unittest.TestCase):
    """GetCustomerTestimonials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomerTestimonials:
        """Test GetCustomerTestimonials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomerTestimonials`
        """
        model = GetCustomerTestimonials()
        if include_optional:
            return GetCustomerTestimonials(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_customer_testimonials_method.getCustomerTestimonials_method(
                    name = 'getCustomerTestimonials', 
                    version = 'r1', 
                    params = entrata_api_client.models.get_customer_testimonials_method_params.getCustomerTestimonials_method_params(
                        property_id = 123456, 
                        is_approved = True, 
    ...
    def testGetCustomerTestimonials(self):
        """Test GetCustomerTestimonials"""
