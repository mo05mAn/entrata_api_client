...
class TestGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysData:
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysData`
        """
        model = GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysData()
        if include_optional:
    ...
    def testGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysData(self):
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysData"""
