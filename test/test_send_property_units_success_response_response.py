...
class TestSendPropertyUnitsSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendPropertyUnitsSuccessResponseResponse:
        """Test SendPropertyUnitsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPropertyUnitsSuccessResponseResponse`
        """
        model = SendPropertyUnitsSuccessResponseResponse()
        if include_optional:
    ...
    def testSendPropertyUnitsSuccessResponseResponse(self):
        """Test SendPropertyUnitsSuccessResponseResponse"""
