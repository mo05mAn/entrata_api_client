...
class TestSendLeaseDocumentsRequestBodyMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeaseDocumentsRequestBodyMethod:
        """Test SendLeaseDocumentsRequestBodyMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseDocumentsRequestBodyMethod`
        """
        model = SendLeaseDocumentsRequestBodyMethod()
        if include_optional:
    ...
    def testSendLeaseDocumentsRequestBodyMethod(self):
        """Test SendLeaseDocumentsRequestBodyMethod"""
