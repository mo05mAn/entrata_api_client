...
class TestGetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes:
        """Test GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes(
                id = '1',
                name = '1099 - MISC'
            )
        else:
    ...
    def testGetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes"""
