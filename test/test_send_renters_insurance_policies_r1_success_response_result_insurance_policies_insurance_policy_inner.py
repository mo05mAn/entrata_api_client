...
class TestSendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner(unittest.TestCase):
    """SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner:
        """Test SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner`
        """
        model = SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner()
        if include_optional:
            return SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner(
    ...
    def testSendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner(self):
        """Test SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner"""
