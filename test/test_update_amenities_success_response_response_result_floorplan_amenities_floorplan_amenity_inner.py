...
class TestUpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner(unittest.TestCase):
    """UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner:
        """Test UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner`
        """
        model = UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner()
        if include_optional:
            return UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner(
                node = 1,
                status = 'Success',
                amenity_id = 1139719,
    ...
    def testUpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner(self):
        """Test UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner"""
