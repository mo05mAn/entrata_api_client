...
class TestSendApplicationVehiclesSuccessResponseResponseResultVehicles(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationVehiclesSuccessResponseResponseResultVehicles:
        """Test SendApplicationVehiclesSuccessResponseResponseResultVehicles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationVehiclesSuccessResponseResponseResultVehicles`
        """
        model = SendApplicationVehiclesSuccessResponseResponseResultVehicles()
        if include_optional:
    ...
    def testSendApplicationVehiclesSuccessResponseResponseResultVehicles(self):
        """Test SendApplicationVehiclesSuccessResponseResponseResultVehicles"""
