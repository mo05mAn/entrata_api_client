...
class TestGetCompanyApplicationsSuccessResponseResponseResultCompanyApplications(unittest.TestCase):
    """GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications:
        """Test GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications`
        """
        model = GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications()
        if include_optional:
            return GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications(
                company_application = [
    ...
    def testGetCompanyApplicationsSuccessResponseResponseResultCompanyApplications(self):
        """Test GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications"""
