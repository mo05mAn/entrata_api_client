...
class TestUpdateCustomerTestimonialsMethodParams(unittest.TestCase):
    """UpdateCustomerTestimonialsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCustomerTestimonialsMethodParams:
        """Test UpdateCustomerTestimonialsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomerTestimonialsMethodParams`
        """
        model = UpdateCustomerTestimonialsMethodParams()
        if include_optional:
            return UpdateCustomerTestimonialsMethodParams(
                property_id = 123456,
    ...
    def testUpdateCustomerTestimonialsMethodParams(self):
        """Test UpdateCustomerTestimonialsMethodParams"""
