...
class TestGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner(unittest.TestCase):
    """GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner:
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner`
        """
        model = GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner()
        if include_optional:
            return GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner(
                lease_term_id = '1',
                lease_term_name = 'UVW',
    ...
    def testGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner(self):
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner"""
