...
class TestSendRentableItemsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRentableItemsMethodParams:
        """Test SendRentableItemsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentableItemsMethodParams`
        """
        model = SendRentableItemsMethodParams()
        if include_optional:
            return SendRentableItemsMethodParams(
                property_id = 12345,
                category_id = 12345,
                name = 'Furniture A',
                show_on_website = 0,
    ...
    def testSendRentableItemsMethodParams(self):
        """Test SendRentableItemsMethodParams"""
