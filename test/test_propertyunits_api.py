...
class TestPropertyunitsApi(unittest.TestCase):
    """PropertyunitsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PropertyunitsApi()

    def tearDown(self) -> None:
        pass

    def test_orgs_v1_propertyunits_post(self) -> None:
        """Test case for orgs_v1_propertyunits_post
