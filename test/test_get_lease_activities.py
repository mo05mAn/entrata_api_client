...
class TestGetLeaseActivities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseActivities:
        """Test GetLeaseActivities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseActivities`
        """
    ...
    def testGetLeaseActivities(self):
        """Test GetLeaseActivities"""
