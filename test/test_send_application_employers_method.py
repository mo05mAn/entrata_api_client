...
class TestSendApplicationEmployersMethod(unittest.TestCase):
    """SendApplicationEmployersMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationEmployersMethod:
        """Test SendApplicationEmployersMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationEmployersMethod`
        """
        model = SendApplicationEmployersMethod()
        if include_optional:
            return SendApplicationEmployersMethod(
    ...
    def testSendApplicationEmployersMethod(self):
        """Test SendApplicationEmployersMethod"""
