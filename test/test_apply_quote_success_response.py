...
class TestApplyQuoteSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApplyQuoteSuccessResponse:
        """Test ApplyQuoteSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplyQuoteSuccessResponse`
        """
        model = ApplyQuoteSuccessResponse()
        if include_optional:
    ...
    def testApplyQuoteSuccessResponse(self):
        """Test ApplyQuoteSuccessResponse"""
