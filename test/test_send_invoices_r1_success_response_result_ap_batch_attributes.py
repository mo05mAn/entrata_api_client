...
class TestSendInvoicesR1SuccessResponseResultApBatchAttributes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendInvoicesR1SuccessResponseResultApBatchAttributes:
        """Test SendInvoicesR1SuccessResponseResultApBatchAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR1SuccessResponseResultApBatchAttributes`
        """
        model = SendInvoicesR1SuccessResponseResultApBatchAttributes()
        if include_optional:
            return SendInvoicesR1SuccessResponseResultApBatchAttributes(
                reference_id = '1838'
            )
        else:
            return SendInvoicesR1SuccessResponseResultApBatchAttributes(
    ...
    def testSendInvoicesR1SuccessResponseResultApBatchAttributes(self):
        """Test SendInvoicesR1SuccessResponseResultApBatchAttributes"""
