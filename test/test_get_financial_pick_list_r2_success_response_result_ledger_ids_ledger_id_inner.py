...
class TestGetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner:
        """Test GetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner(
                id = 3,
                name = 'Military'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner"""
