...
class TestGetQuotesSuccessResponseResult(unittest.TestCase):
    """GetQuotesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetQuotesSuccessResponseResult:
        """Test GetQuotesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuotesSuccessResponseResult`
        """
        model = GetQuotesSuccessResponseResult()
        if include_optional:
            return GetQuotesSuccessResponseResult(
                currency_code = 'USD',
    ...
    def testGetQuotesSuccessResponseResult(self):
        """Test GetQuotesSuccessResponseResult"""
