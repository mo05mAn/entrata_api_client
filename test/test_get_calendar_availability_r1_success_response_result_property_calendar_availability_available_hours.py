...
class TestGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours(unittest.TestCase):
    """GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours:
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours`
        """
        model = GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours()
        if include_optional:
            return GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours(
                available_hour = [
    ...
    def testGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours(self):
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours"""
