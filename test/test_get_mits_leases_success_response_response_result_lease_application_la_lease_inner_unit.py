...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit`
        """
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit"""
