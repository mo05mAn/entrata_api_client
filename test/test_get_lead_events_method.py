...
class TestGetLeadEventsMethod(unittest.TestCase):
    """GetLeadEventsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadEventsMethod:
        """Test GetLeadEventsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadEventsMethod`
        """
        model = GetLeadEventsMethod()
        if include_optional:
            return GetLeadEventsMethod(
                name = 'getLeadEvents',
                version = 'r1',
                params = entrata_api_client.models.get_lead_events_method_params.getLeadEvents_method_params(
                    property_id = 123456, 
                    application_id = 1234, 
    ...
    def testGetLeadEventsMethod(self):
        """Test GetLeadEventsMethod"""
