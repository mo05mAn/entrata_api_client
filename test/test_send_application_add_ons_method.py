...
class TestSendApplicationAddOnsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationAddOnsMethod:
        """Test SendApplicationAddOnsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationAddOnsMethod`
        """
        model = SendApplicationAddOnsMethod()
        if include_optional:
            return SendApplicationAddOnsMethod(
    ...
    def testSendApplicationAddOnsMethod(self):
        """Test SendApplicationAddOnsMethod"""
