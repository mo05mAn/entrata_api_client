...
class TestGetInspectionsSuccessResponseResultInspections(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInspectionsSuccessResponseResultInspections:
        """Test GetInspectionsSuccessResponseResultInspections
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionsSuccessResponseResultInspections`
        """
        model = GetInspectionsSuccessResponseResultInspections()
        if include_optional:
    ...
    def testGetInspectionsSuccessResponseResultInspections(self):
        """Test GetInspectionsSuccessResponseResultInspections"""
