...
class TestSendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner(unittest.TestCase):
    """SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner:
        """Test SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner`
        """
        model = SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner()
        if include_optional:
            return SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner(
                id = '1234',
                node = '1',
                status = 'Success',
                message = 'Scheduled charge inserted successfully.'
            )
        else:
            return SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner(
                id = '1234',
    ...
    def testSendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner(self):
        """Test SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner"""
