...
class TestUpdateCustomerTestimonialsSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateCustomerTestimonialsSuccessResponse:
        """Test UpdateCustomerTestimonialsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomerTestimonialsSuccessResponse`
        """
        model = UpdateCustomerTestimonialsSuccessResponse()
        if include_optional:
    ...
    def testUpdateCustomerTestimonialsSuccessResponse(self):
        """Test UpdateCustomerTestimonialsSuccessResponse"""
