...
class TestGetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner(unittest.TestCase):
    """GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner:
        """Test GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner`
        """
        model = GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner()
        if include_optional:
            return GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner(
                id = '6789',
                name = 'ap code 1',
                gl_account_id = '1234',
                ap_code_type_id = '3',
                ap_code_type = 'Job Cost'
            )
        else:
            return GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner(
                id = '6789',
    ...
    def testGetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner(self):
        """Test GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner"""
