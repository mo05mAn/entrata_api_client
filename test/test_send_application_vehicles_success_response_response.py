...
class TestSendApplicationVehiclesSuccessResponseResponse(unittest.TestCase):
    """SendApplicationVehiclesSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationVehiclesSuccessResponseResponse:
        """Test SendApplicationVehiclesSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationVehiclesSuccessResponseResponse`
        """
        model = SendApplicationVehiclesSuccessResponseResponse()
        if include_optional:
            return SendApplicationVehiclesSuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testSendApplicationVehiclesSuccessResponseResponse(self):
        """Test SendApplicationVehiclesSuccessResponseResponse"""
