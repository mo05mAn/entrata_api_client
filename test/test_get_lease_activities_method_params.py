...
class TestGetLeaseActivitiesMethodParams(unittest.TestCase):
    """GetLeaseActivitiesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseActivitiesMethodParams:
        """Test GetLeaseActivitiesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseActivitiesMethodParams`
        """
        model = GetLeaseActivitiesMethodParams()
        if include_optional:
            return GetLeaseActivitiesMethodParams(
                property_id = 123456,
                lease_id = 123456,
    ...
    def testGetLeaseActivitiesMethodParams(self):
        """Test GetLeaseActivitiesMethodParams"""
