...
class TestGetWorkOrderPickListsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsMethod:
        """Test GetWorkOrderPickListsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsMethod`
        """
        model = GetWorkOrderPickListsMethod()
        if include_optional:
    ...
    def testGetWorkOrderPickListsMethod(self):
        """Test GetWorkOrderPickListsMethod"""
