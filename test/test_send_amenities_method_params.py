...
class TestSendAmenitiesMethodParams(unittest.TestCase):
    """SendAmenitiesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendAmenitiesMethodParams:
        """Test SendAmenitiesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAmenitiesMethodParams`
        """
        model = SendAmenitiesMethodParams()
        if include_optional:
            return SendAmenitiesMethodParams(
                property_id = 12345,
                name = 'Furniture A',
    ...
    def testSendAmenitiesMethodParams(self):
        """Test SendAmenitiesMethodParams"""
