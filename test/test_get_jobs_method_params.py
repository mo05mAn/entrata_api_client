...
class TestGetJobsMethodParams(unittest.TestCase):
    """GetJobsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobsMethodParams:
        """Test GetJobsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobsMethodParams`
        """
        model = GetJobsMethodParams()
        if include_optional:
            return GetJobsMethodParams(
                property_id = 123456,
                job_category_ids = 6,
                job_status_ids = 4
            )
    ...
    def testGetJobsMethodParams(self):
        """Test GetJobsMethodParams"""
