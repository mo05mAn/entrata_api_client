...
class TestGetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpaces(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpaces:
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpaces
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpaces`
        """
        model = GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpaces()
        if include_optional:
    ...
    def testGetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpaces(self):
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpaces"""
