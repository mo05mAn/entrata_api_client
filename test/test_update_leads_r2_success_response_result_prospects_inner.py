...
class TestUpdateLeadsR2SuccessResponseResultProspectsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateLeadsR2SuccessResponseResultProspectsInner:
        """Test UpdateLeadsR2SuccessResponseResultProspectsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeadsR2SuccessResponseResultProspectsInner`
        """
        model = UpdateLeadsR2SuccessResponseResultProspectsInner()
        if include_optional:
            return UpdateLeadsR2SuccessResponseResultProspectsInner(
                node = '1',
                status = 'Success',
    ...
    def testUpdateLeadsR2SuccessResponseResultProspectsInner(self):
        """Test UpdateLeadsR2SuccessResponseResultProspectsInner"""
