...
class TestGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRates(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRates:
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRates`
        """
        model = GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRates()
        if include_optional:
    ...
    def testGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRates(self):
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRates"""
