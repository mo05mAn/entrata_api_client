...
class TestGetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems(unittest.TestCase):
    """GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems:
        """Test GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems`
        """
        model = GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems()
        if include_optional:
            return GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems(
    ...
    def testGetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems(self):
        """Test GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems"""
