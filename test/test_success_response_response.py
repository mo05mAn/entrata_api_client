...
class TestSuccessResponseResponse(unittest.TestCase):
    """SuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuccessResponseResponse:
        """Test SuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuccessResponseResponse`
        """
        model = SuccessResponseResponse()
        if include_optional:
            return SuccessResponseResponse(
                request_id = '',
                code = 56,
    ...
    def testSuccessResponseResponse(self):
        """Test SuccessResponseResponse"""
