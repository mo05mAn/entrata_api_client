...
class TestGetSpecialsR4MethodParams(unittest.TestCase):
    """GetSpecialsR4MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4MethodParams:
        """Test GetSpecialsR4MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4MethodParams`
        """
        model = GetSpecialsR4MethodParams()
        if include_optional:
            return GetSpecialsR4MethodParams(
                property_id = '1234567'
            )
        else:
            return GetSpecialsR4MethodParams(
    ...
    def testGetSpecialsR4MethodParams(self):
        """Test GetSpecialsR4MethodParams"""
