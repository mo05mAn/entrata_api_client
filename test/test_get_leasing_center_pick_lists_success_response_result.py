...
class TestGetLeasingCenterPickListsSuccessResponseResult(unittest.TestCase):
    """GetLeasingCenterPickListsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasingCenterPickListsSuccessResponseResult:
        """Test GetLeasingCenterPickListsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasingCenterPickListsSuccessResponseResult`
        """
        model = GetLeasingCenterPickListsSuccessResponseResult()
        if include_optional:
            return GetLeasingCenterPickListsSuccessResponseResult(
    ...
    def testGetLeasingCenterPickListsSuccessResponseResult(self):
        """Test GetLeasingCenterPickListsSuccessResponseResult"""
