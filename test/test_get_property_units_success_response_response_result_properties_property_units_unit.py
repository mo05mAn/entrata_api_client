...
class TestGetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit(unittest.TestCase):
    """GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit:
        """Test GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit`
        """
        model = GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit()
        if include_optional:
            return GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit(
                id = 5678,
                unit_number = 302,
                building_id = 34,
    ...
    def testGetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit(self):
        """Test GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit"""
