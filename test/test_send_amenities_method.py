...
class TestSendAmenitiesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendAmenitiesMethod:
        """Test SendAmenitiesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAmenitiesMethod`
        """
        model = SendAmenitiesMethod()
        if include_optional:
    ...
    def testSendAmenitiesMethod(self):
        """Test SendAmenitiesMethod"""
