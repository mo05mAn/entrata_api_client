...
class TestSendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner:
        """Test SendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner`
        """
        model = SendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner()
        if include_optional:
            return SendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner(
                node = 1,
                status = 'Success',
                amenity_id = 1200113,
    ...
    def testSendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner(self):
        """Test SendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner"""
