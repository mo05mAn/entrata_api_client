...
class TestGetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner(
                id = 1,
                name = 'Standard'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner"""
