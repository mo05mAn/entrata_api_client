...
class TestSendLeaseArTransactionsMethodParams(unittest.TestCase):
    """SendLeaseArTransactionsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionsMethodParams:
        """Test SendLeaseArTransactionsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionsMethodParams`
        """
        model = SendLeaseArTransactionsMethodParams()
        if include_optional:
            return SendLeaseArTransactionsMethodParams(
                transaction_id = 1234,
                lease_id = 2342,
                ar_code_id = 11,
                transaction_amount = 56,
                transaction_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                ar_post_month = 'MM/YYYY'
            )
        else:
            return SendLeaseArTransactionsMethodParams(
                transaction_id = 1234,
    ...
    def testSendLeaseArTransactionsMethodParams(self):
        """Test SendLeaseArTransactionsMethodParams"""
