...
class TestSendPropertyMediaMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendPropertyMediaMethod:
        """Test SendPropertyMediaMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPropertyMediaMethod`
        """
        model = SendPropertyMediaMethod()
        if include_optional:
    ...
    def testSendPropertyMediaMethod(self):
        """Test SendPropertyMediaMethod"""
