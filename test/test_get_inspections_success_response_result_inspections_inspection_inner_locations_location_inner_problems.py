...
class TestGetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems:
        """Test GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems`
        """
        model = GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems()
        if include_optional:
    ...
    def testGetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems(self):
        """Test GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems"""
