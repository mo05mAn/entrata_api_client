...
class TestGetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals(unittest.TestCase):
    """GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals:
        """Test GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals`
        """
        model = GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals()
        if include_optional:
            return GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals(
                lease_interval = [
    ...
    def testGetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals(self):
        """Test GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals"""
