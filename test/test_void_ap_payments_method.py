...
class TestVoidApPaymentsMethod(unittest.TestCase):
    """VoidApPaymentsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoidApPaymentsMethod:
        """Test VoidApPaymentsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidApPaymentsMethod`
        """
        model = VoidApPaymentsMethod()
        if include_optional:
            return VoidApPaymentsMethod(
                name = 'voidApPayments',
                version = 'r1',
    ...
    def testVoidApPaymentsMethod(self):
        """Test VoidApPaymentsMethod"""
