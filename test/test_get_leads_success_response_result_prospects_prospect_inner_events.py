...
class TestGetLeadsSuccessResponseResultProspectsProspectInnerEvents(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResultProspectsProspectInnerEvents:
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerEvents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResultProspectsProspectInnerEvents`
        """
        model = GetLeadsSuccessResponseResultProspectsProspectInnerEvents()
        if include_optional:
    ...
    def testGetLeadsSuccessResponseResultProspectsProspectInnerEvents(self):
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerEvents"""
