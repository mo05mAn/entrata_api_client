...
class TestSendPropertyMediaSuccessResponseResponseResultMediaInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendPropertyMediaSuccessResponseResponseResultMediaInner:
        """Test SendPropertyMediaSuccessResponseResponseResultMediaInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPropertyMediaSuccessResponseResponseResultMediaInner`
        """
        model = SendPropertyMediaSuccessResponseResponseResultMediaInner()
        if include_optional:
            return SendPropertyMediaSuccessResponseResponseResultMediaInner(
                node = 1,
                id = 200001,
                status = 'Success',
    ...
    def testSendPropertyMediaSuccessResponseResponseResultMediaInner(self):
        """Test SendPropertyMediaSuccessResponseResponseResultMediaInner"""
