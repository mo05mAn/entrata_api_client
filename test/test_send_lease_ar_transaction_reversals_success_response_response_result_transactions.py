...
class TestSendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions:
        """Test SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions`
        """
        model = SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions()
        if include_optional:
    ...
    def testSendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions(self):
        """Test SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions"""
