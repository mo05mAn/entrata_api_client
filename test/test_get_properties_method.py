...
class TestGetPropertiesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertiesMethod:
        """Test GetPropertiesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertiesMethod`
        """
        model = GetPropertiesMethod()
        if include_optional:
    ...
    def testGetPropertiesMethod(self):
        """Test GetPropertiesMethod"""
