...
class TestGetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes:
        """Test GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes`
        """
        model = GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes(
    ...
    def testGetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes(self):
        """Test GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes"""
