...
class TestUpdateCustomerTestimonialsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateCustomerTestimonialsMethod:
        """Test UpdateCustomerTestimonialsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomerTestimonialsMethod`
        """
        model = UpdateCustomerTestimonialsMethod()
        if include_optional:
    ...
    def testUpdateCustomerTestimonialsMethod(self):
        """Test UpdateCustomerTestimonialsMethod"""
