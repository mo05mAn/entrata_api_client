...
class TestGetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner:
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner`
        """
        model = GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner()
        if include_optional:
            return GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner(
                event_id = '1234',
                type = 'Email - Outgoing',
                type_id = '2',
                lease_id = '123456',
    ...
    def testGetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner(self):
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner"""
