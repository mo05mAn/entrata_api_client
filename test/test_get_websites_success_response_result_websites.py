...
class TestGetWebsitesSuccessResponseResultWebsites(unittest.TestCase):
    """GetWebsitesSuccessResponseResultWebsites unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebsitesSuccessResponseResultWebsites:
        """Test GetWebsitesSuccessResponseResultWebsites
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebsitesSuccessResponseResultWebsites`
        """
        model = GetWebsitesSuccessResponseResultWebsites()
        if include_optional:
            return GetWebsitesSuccessResponseResultWebsites(
                website = [
    ...
    def testGetWebsitesSuccessResponseResultWebsites(self):
        """Test GetWebsitesSuccessResponseResultWebsites"""
