...
class TestSendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner(unittest.TestCase):
    """SendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner:
        """Test SendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner`
        """
        model = SendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner()
        if include_optional:
            return SendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner(
                node = 1,
    ...
    def testSendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner(self):
        """Test SendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner"""
