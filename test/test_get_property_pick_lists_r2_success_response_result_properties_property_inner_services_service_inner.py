...
class TestGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner(unittest.TestCase):
    """GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner:
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner`
        """
        model = GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner()
        if include_optional:
            return GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner(
                id = 77455,
    ...
    def testGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner(self):
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner"""
