...
class TestGetPricingPicklistsSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponse:
        """Test GetPricingPicklistsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponse`
        """
        model = GetPricingPicklistsSuccessResponseResponse()
        if include_optional:
    ...
    def testGetPricingPicklistsSuccessResponseResponse(self):
        """Test GetPricingPicklistsSuccessResponseResponse"""
