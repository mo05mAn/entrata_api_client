...
class TestGetVendorPickListsSuccessResponseResultApRemittanceTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultApRemittanceTypes:
        """Test GetVendorPickListsSuccessResponseResultApRemittanceTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultApRemittanceTypes`
        """
        model = GetVendorPickListsSuccessResponseResultApRemittanceTypes()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultApRemittanceTypes(self):
        """Test GetVendorPickListsSuccessResponseResultApRemittanceTypes"""
