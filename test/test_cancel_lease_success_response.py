...
class TestCancelLeaseSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CancelLeaseSuccessResponse:
        """Test CancelLeaseSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelLeaseSuccessResponse`
        """
        model = CancelLeaseSuccessResponse()
        if include_optional:
    ...
    def testCancelLeaseSuccessResponse(self):
        """Test CancelLeaseSuccessResponse"""
