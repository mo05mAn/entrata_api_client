...
class TestGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner(unittest.TestCase):
    """GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner:
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner`
        """
        model = GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner()
        if include_optional:
            return GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner(
                id = 8377,
                name = 'Gym Card'
            )
        else:
    ...
    def testGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner(self):
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner"""
