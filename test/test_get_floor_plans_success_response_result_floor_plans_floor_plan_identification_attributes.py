...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes(unittest.TestCase):
    """GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes(
                id_rank = 'primary',
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes"""
