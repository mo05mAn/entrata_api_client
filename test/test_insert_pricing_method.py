...
class TestInsertPricingMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InsertPricingMethod:
        """Test InsertPricingMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingMethod`
        """
        model = InsertPricingMethod()
        if include_optional:
    ...
    def testInsertPricingMethod(self):
        """Test InsertPricingMethod"""
