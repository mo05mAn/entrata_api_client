...
class TestGetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner:
        """Test GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner(
                id = 3,
                name = 'Military'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner"""
