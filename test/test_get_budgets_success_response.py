...
class TestGetBudgetsSuccessResponse(unittest.TestCase):
    """GetBudgetsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBudgetsSuccessResponse:
        """Test GetBudgetsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBudgetsSuccessResponse`
        """
        model = GetBudgetsSuccessResponse()
        if include_optional:
            return GetBudgetsSuccessResponse(
                request_id = '15',
                result = entrata_api_client.models.get_budgets_success_response_result.getBudgetsSuccessResponse_result(
                    properties = entrata_api_client.models.get_budgets_success_response_result_properties.getBudgetsSuccessResponse_result_properties(
                        property = [
                            entrata_api_client.models.get_budgets_success_response_result_properties_property_inner.getBudgetsSuccessResponse_result_properties_property_inner(
                                property_id = '123', 
                                property_name = 'Property Name', 
                                budgets = entrata_api_client.models.get_budgets_success_response_result_properties_property_inner_budgets.getBudgetsSuccessResponse_result_properties_property_inner_budgets(
                                    budget = [
    ...
    def testGetBudgetsSuccessResponse(self):
        """Test GetBudgetsSuccessResponse"""
