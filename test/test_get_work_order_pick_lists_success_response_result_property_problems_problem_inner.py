...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner(
                id = '67718',
                name = 'Wet Floor',
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner"""
