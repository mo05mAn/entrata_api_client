...
class TestSendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes(unittest.TestCase):
    """SendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes:
        """Test SendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes`
        """
        model = SendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes()
        if include_optional:
            return SendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes(
    ...
    def testSendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes(self):
        """Test SendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes"""
