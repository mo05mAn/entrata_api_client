...
class TestUpdateLeaseMethod(unittest.TestCase):
    """UpdateLeaseMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLeaseMethod:
        """Test UpdateLeaseMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeaseMethod`
        """
        model = UpdateLeaseMethod()
        if include_optional:
            return UpdateLeaseMethod(
                name = 'updateLease',
                version = 'r1',
    ...
    def testUpdateLeaseMethod(self):
        """Test UpdateLeaseMethod"""
