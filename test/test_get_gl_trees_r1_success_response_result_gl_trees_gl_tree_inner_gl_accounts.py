...
class TestGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccounts(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccounts:
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccounts`
        """
        model = GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccounts()
        if include_optional:
    ...
    def testGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccounts(self):
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccounts"""
