...
class TestGetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner(unittest.TestCase):
    """GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner:
        """Test GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner`
        """
        model = GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner()
        if include_optional:
            return GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner(
                id = 302,
                name = 'Daily'
            )
        else:
    ...
    def testGetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner(self):
        """Test GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner"""
