...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner(
                value = '10.00',
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner"""
