...
class TestGetJobCategoriesMethodParams(unittest.TestCase):
    """GetJobCategoriesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobCategoriesMethodParams:
        """Test GetJobCategoriesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCategoriesMethodParams`
        """
        model = GetJobCategoriesMethodParams()
        if include_optional:
            return GetJobCategoriesMethodParams(
                gl_account_ids = 56
            )
        else:
            return GetJobCategoriesMethodParams(
    ...
    def testGetJobCategoriesMethodParams(self):
        """Test GetJobCategoriesMethodParams"""
