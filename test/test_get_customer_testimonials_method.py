...
class TestGetCustomerTestimonialsMethod(unittest.TestCase):
    """GetCustomerTestimonialsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomerTestimonialsMethod:
        """Test GetCustomerTestimonialsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomerTestimonialsMethod`
        """
        model = GetCustomerTestimonialsMethod()
        if include_optional:
            return GetCustomerTestimonialsMethod(
    ...
    def testGetCustomerTestimonialsMethod(self):
        """Test GetCustomerTestimonialsMethod"""
