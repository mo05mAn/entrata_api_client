...
class TestSendScheduledChargesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendScheduledChargesSuccessResponse:
        """Test SendScheduledChargesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendScheduledChargesSuccessResponse`
        """
        model = SendScheduledChargesSuccessResponse()
        if include_optional:
    ...
    def testSendScheduledChargesSuccessResponse(self):
        """Test SendScheduledChargesSuccessResponse"""
