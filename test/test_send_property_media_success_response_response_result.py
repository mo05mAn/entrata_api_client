...
class TestSendPropertyMediaSuccessResponseResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendPropertyMediaSuccessResponseResponseResult:
        """Test SendPropertyMediaSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPropertyMediaSuccessResponseResponseResult`
        """
        model = SendPropertyMediaSuccessResponseResponseResult()
        if include_optional:
    ...
    def testSendPropertyMediaSuccessResponseResponseResult(self):
        """Test SendPropertyMediaSuccessResponseResponseResult"""
