...
class TestGetCompanyApplicationsSuccessResponseResponseResult(unittest.TestCase):
    """GetCompanyApplicationsSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCompanyApplicationsSuccessResponseResponseResult:
        """Test GetCompanyApplicationsSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCompanyApplicationsSuccessResponseResponseResult`
        """
        model = GetCompanyApplicationsSuccessResponseResponseResult()
        if include_optional:
            return GetCompanyApplicationsSuccessResponseResponseResult(
    ...
    def testGetCompanyApplicationsSuccessResponseResponseResult(self):
        """Test GetCompanyApplicationsSuccessResponseResponseResult"""
