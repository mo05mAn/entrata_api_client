...
class TestGetBudgetActualsSuccessResponseResultBudgetVsActuals(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBudgetActualsSuccessResponseResultBudgetVsActuals:
        """Test GetBudgetActualsSuccessResponseResultBudgetVsActuals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBudgetActualsSuccessResponseResultBudgetVsActuals`
        """
        model = GetBudgetActualsSuccessResponseResultBudgetVsActuals()
        if include_optional:
    ...
    def testGetBudgetActualsSuccessResponseResultBudgetVsActuals(self):
        """Test GetBudgetActualsSuccessResponseResultBudgetVsActuals"""
