...
class TestGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes(unittest.TestCase):
    """GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes:
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes`
        """
        model = GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes()
        if include_optional:
            return GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes(
                id = '1283',
                name = 'Master GL Tree'
            )
        else:
    ...
    def testGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes(self):
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes"""
