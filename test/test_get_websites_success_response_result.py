...
class TestGetWebsitesSuccessResponseResult(unittest.TestCase):
    """GetWebsitesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebsitesSuccessResponseResult:
        """Test GetWebsitesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebsitesSuccessResponseResult`
        """
        model = GetWebsitesSuccessResponseResult()
        if include_optional:
            return GetWebsitesSuccessResponseResult(
    ...
    def testGetWebsitesSuccessResponseResult(self):
        """Test GetWebsitesSuccessResponseResult"""
