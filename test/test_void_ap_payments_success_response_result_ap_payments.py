...
class TestVoidApPaymentsSuccessResponseResultApPayments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VoidApPaymentsSuccessResponseResultApPayments:
        """Test VoidApPaymentsSuccessResponseResultApPayments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidApPaymentsSuccessResponseResultApPayments`
        """
        model = VoidApPaymentsSuccessResponseResultApPayments()
        if include_optional:
    ...
    def testVoidApPaymentsSuccessResponseResultApPayments(self):
        """Test VoidApPaymentsSuccessResponseResultApPayments"""
