    ...
    def make_instance(self, include_optional) -> GetQuotesSuccessResponse:
        ...
        if include_optional:
            return GetQuotesSuccessResponse(
                request_id = '15',
                code = '200',
                result = openapi_client.models.get_quotes_success_response_result.getQuotesSuccessResponse_result(
                    currency_code = 'USD', 
                    applications = openapi_client.models.get_quotes_success_response_result_applications.getQuotesSuccessResponse_result_applications(
                        application = [
                            openapi_client.models.get_quotes_success_response_result_applications_application_inner.getQuotesSuccessResponse_result_applications_application_inner(
                                application_id = '123456', 
                                application_status_id = '1', 
                                application_status = 'Started', 
                                quotes = openapi_client.models.get_quotes_success_response_result_applications_application_inner_quotes.getQuotesSuccessResponse_result_applications_application_inner_quotes(
                                    quote = [
