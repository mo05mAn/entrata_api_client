...
class TestGetQuotesSuccessResponse(unittest.TestCase):
    """GetQuotesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetQuotesSuccessResponse:
        """Test GetQuotesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuotesSuccessResponse`
        """
        model = GetQuotesSuccessResponse()
        if include_optional:
            return GetQuotesSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_quotes_success_response_result.getQuotesSuccessResponse_result(
                    currency_code = 'USD', 
                    applications = entrata_api_client.models.get_quotes_success_response_result_applications.getQuotesSuccessResponse_result_applications(
                        application = [
                            entrata_api_client.models.get_quotes_success_response_result_applications_application_inner.getQuotesSuccessResponse_result_applications_application_inner(
                                application_id = '123456', 
                                application_status_id = '1', 
                                application_status = 'Started', 
                                quotes = entrata_api_client.models.get_quotes_success_response_result_applications_application_inner_quotes.getQuotesSuccessResponse_result_applications_application_inner_quotes(
                                    quote = [
    ...
    def testGetQuotesSuccessResponse(self):
        """Test GetQuotesSuccessResponse"""
