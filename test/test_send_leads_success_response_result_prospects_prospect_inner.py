...
class TestSendLeadsSuccessResponseResultProspectsProspectInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeadsSuccessResponseResultProspectsProspectInner:
        """Test SendLeadsSuccessResponseResultProspectsProspectInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeadsSuccessResponseResultProspectsProspectInner`
        """
        model = SendLeadsSuccessResponseResultProspectsProspectInner()
        if include_optional:
            return SendLeadsSuccessResponseResultProspectsProspectInner(
                node = '1',
    ...
    def testSendLeadsSuccessResponseResultProspectsProspectInner(self):
        """Test SendLeadsSuccessResponseResultProspectsProspectInner"""
