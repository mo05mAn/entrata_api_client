...
class TestGetPropertyPickListsR2Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2Method:
        """Test GetPropertyPickListsR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2Method`
        """
        model = GetPropertyPickListsR2Method()
        if include_optional:
    ...
    def testGetPropertyPickListsR2Method(self):
        """Test GetPropertyPickListsR2Method"""
