...
class TestInsertPricingR2Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InsertPricingR2Method:
        """Test InsertPricingR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingR2Method`
        """
        model = InsertPricingR2Method()
        if include_optional:
    ...
    def testInsertPricingR2Method(self):
        """Test InsertPricingR2Method"""
