...
class TestInsertPricingR2MethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InsertPricingR2MethodParams:
        """Test InsertPricingR2MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingR2MethodParams`
        """
        model = InsertPricingR2MethodParams()
        if include_optional:
    ...
    def testInsertPricingR2MethodParams(self):
        """Test InsertPricingR2MethodParams"""
