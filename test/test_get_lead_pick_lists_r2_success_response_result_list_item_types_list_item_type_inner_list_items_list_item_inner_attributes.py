...
class TestGetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes:
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes`
        """
        model = GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes(
                id = '134417',
                name = 'Archived'
            )
        else:
    ...
    def testGetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes(self):
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes"""
