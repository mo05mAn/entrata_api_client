...
class TestSendApplicationSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationSuccessResponseResponse:
        """Test SendApplicationSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationSuccessResponseResponse`
        """
        model = SendApplicationSuccessResponseResponse()
        if include_optional:
    ...
    def testSendApplicationSuccessResponseResponse(self):
        """Test SendApplicationSuccessResponseResponse"""
