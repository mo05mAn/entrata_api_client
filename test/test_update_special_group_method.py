...
class TestUpdateSpecialGroupMethod(unittest.TestCase):
    """UpdateSpecialGroupMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSpecialGroupMethod:
        """Test UpdateSpecialGroupMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpecialGroupMethod`
        """
        model = UpdateSpecialGroupMethod()
        if include_optional:
            return UpdateSpecialGroupMethod(
    ...
    def testUpdateSpecialGroupMethod(self):
        """Test UpdateSpecialGroupMethod"""
