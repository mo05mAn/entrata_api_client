...
class TestGetUnitTypesMethodParams(unittest.TestCase):
    """GetUnitTypesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUnitTypesMethodParams:
        """Test GetUnitTypesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitTypesMethodParams`
        """
        model = GetUnitTypesMethodParams()
        if include_optional:
            return GetUnitTypesMethodParams(
                property_id = 12345
            )
        else:
            return GetUnitTypesMethodParams(
    ...
    def testGetUnitTypesMethodParams(self):
        """Test GetUnitTypesMethodParams"""
