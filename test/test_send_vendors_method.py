...
class TestSendVendorsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendVendorsMethod:
        """Test SendVendorsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVendorsMethod`
        """
        model = SendVendorsMethod()
        if include_optional:
    ...
    def testSendVendorsMethod(self):
        """Test SendVendorsMethod"""
