...
class TestGetVendorPickListsSuccessResponseResultBankAccountTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultBankAccountTypes:
        """Test GetVendorPickListsSuccessResponseResultBankAccountTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultBankAccountTypes`
        """
        model = GetVendorPickListsSuccessResponseResultBankAccountTypes()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultBankAccountTypes(self):
        """Test GetVendorPickListsSuccessResponseResultBankAccountTypes"""
