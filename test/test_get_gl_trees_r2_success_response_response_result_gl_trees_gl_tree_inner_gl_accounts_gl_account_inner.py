...
class TestGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner(unittest.TestCase):
    """GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner:
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner`
        """
        model = GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner()
        if include_optional:
            return GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner(
                id = '12345',
                branch_id = '12345',
    ...
    def testGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner(self):
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner"""
