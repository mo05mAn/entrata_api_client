...
class TestUpdateBudgetsSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateBudgetsSuccessResponse:
        """Test UpdateBudgetsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBudgetsSuccessResponse`
        """
        model = UpdateBudgetsSuccessResponse()
        if include_optional:
    ...
    def testUpdateBudgetsSuccessResponse(self):
        """Test UpdateBudgetsSuccessResponse"""
