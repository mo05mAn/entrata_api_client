...
class TestGetInspections(unittest.TestCase):
    """GetInspections unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInspections:
        """Test GetInspections
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspections`
        """
        model = GetInspections()
        if include_optional:
            return GetInspections(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_inspections_method.getInspections_method(
                    name = 'getInspections', 
                    version = 'r1', 
