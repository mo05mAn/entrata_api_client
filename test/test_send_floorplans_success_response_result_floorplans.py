...
class TestSendFloorplansSuccessResponseResultFloorplans(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendFloorplansSuccessResponseResultFloorplans:
        """Test SendFloorplansSuccessResponseResultFloorplans
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFloorplansSuccessResponseResultFloorplans`
        """
        model = SendFloorplansSuccessResponseResultFloorplans()
        if include_optional:
    ...
    def testSendFloorplansSuccessResponseResultFloorplans(self):
        """Test SendFloorplansSuccessResponseResultFloorplans"""
