...
class TestGetPricingPicklistsSuccessResponseResponseResultPricingLevels(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResultPricingLevels:
        """Test GetPricingPicklistsSuccessResponseResponseResultPricingLevels
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResultPricingLevels`
        """
        model = GetPricingPicklistsSuccessResponseResponseResultPricingLevels()
        if include_optional:
    ...
    def testGetPricingPicklistsSuccessResponseResponseResultPricingLevels(self):
        """Test GetPricingPicklistsSuccessResponseResponseResultPricingLevels"""
