...
class TestGetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial(unittest.TestCase):
    """GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial:
        """Test GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial`
        """
        model = GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial()
        if include_optional:
            return GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial(
                id = '12015764',
    ...
    def testGetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial(self):
        """Test GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial"""
