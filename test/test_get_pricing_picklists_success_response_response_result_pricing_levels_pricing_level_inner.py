...
class TestGetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner(unittest.TestCase):
    """GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner:
        """Test GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner`
        """
        model = GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner()
        if include_optional:
            return GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner(
    ...
    def testGetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner(self):
        """Test GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner"""
