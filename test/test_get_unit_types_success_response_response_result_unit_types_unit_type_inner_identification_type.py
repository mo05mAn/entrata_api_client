...
class TestGetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationType:
        """Test GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationType`
        """
    ...
    def testGetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationType(self):
        """Test GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationType"""
