...
class TestGetInvoicesR1MethodParams(unittest.TestCase):
    """GetInvoicesR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1MethodParams:
        """Test GetInvoicesR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1MethodParams`
        """
        model = GetInvoicesR1MethodParams()
        if include_optional:
            return GetInvoicesR1MethodParams(
                ids = 56,
    ...
    def testGetInvoicesR1MethodParams(self):
        """Test GetInvoicesR1MethodParams"""
