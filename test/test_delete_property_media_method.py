...
class TestDeletePropertyMediaMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeletePropertyMediaMethod:
        """Test DeletePropertyMediaMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletePropertyMediaMethod`
        """
        model = DeletePropertyMediaMethod()
        if include_optional:
    ...
    def testDeletePropertyMediaMethod(self):
        """Test DeletePropertyMediaMethod"""
