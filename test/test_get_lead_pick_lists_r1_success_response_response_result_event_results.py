...
class TestGetLeadPickListsR1SuccessResponseResponseResultEventResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1SuccessResponseResponseResultEventResults:
        """Test GetLeadPickListsR1SuccessResponseResponseResultEventResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1SuccessResponseResponseResultEventResults`
        """
        model = GetLeadPickListsR1SuccessResponseResponseResultEventResults()
        if include_optional:
    ...
    def testGetLeadPickListsR1SuccessResponseResponseResultEventResults(self):
        """Test GetLeadPickListsR1SuccessResponseResponseResultEventResults"""
