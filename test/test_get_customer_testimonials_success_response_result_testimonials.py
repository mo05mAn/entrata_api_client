...
class TestGetCustomerTestimonialsSuccessResponseResultTestimonials(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomerTestimonialsSuccessResponseResultTestimonials:
        """Test GetCustomerTestimonialsSuccessResponseResultTestimonials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomerTestimonialsSuccessResponseResultTestimonials`
        """
        model = GetCustomerTestimonialsSuccessResponseResultTestimonials()
        if include_optional:
    ...
    def testGetCustomerTestimonialsSuccessResponseResultTestimonials(self):
        """Test GetCustomerTestimonialsSuccessResponseResultTestimonials"""
