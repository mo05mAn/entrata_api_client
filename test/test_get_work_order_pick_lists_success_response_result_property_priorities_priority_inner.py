...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner(
                id = '19421',
                name = 'Normal'
            )
        else:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner"""
