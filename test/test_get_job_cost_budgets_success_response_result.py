...
class TestGetJobCostBudgetsSuccessResponseResult(unittest.TestCase):
    """GetJobCostBudgetsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobCostBudgetsSuccessResponseResult:
        """Test GetJobCostBudgetsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCostBudgetsSuccessResponseResult`
        """
        model = GetJobCostBudgetsSuccessResponseResult()
        if include_optional:
            return GetJobCostBudgetsSuccessResponseResult(
    ...
    def testGetJobCostBudgetsSuccessResponseResult(self):
        """Test GetJobCostBudgetsSuccessResponseResult"""
