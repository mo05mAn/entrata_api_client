    ...
    def make_instance(self, include_optional) -> GetInvoicesR2SuccessResponse:
        ...
        if include_optional:
            return GetInvoicesR2SuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_invoices_r2_success_response_result.getInvoices_r2_SuccessResponse_result(
                    invoices = entrata_api_client.models.get_invoices_r2_success_response_result_invoices.getInvoices_r2_SuccessResponse_result_invoices(
                        invoice = [
                            entrata_api_client.models.get_invoices_r2_success_response_result_invoices_invoice_inner.getInvoices_r2_SuccessResponse_result_invoices_invoice_inner(
                                id = '123456', 
                                is_on_hold = '0', 
