...
class TestGetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner:
        """Test GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner`
        """
        model = GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner(
                id = '299001',
    ...
    def testGetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner(self):
        """Test GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner"""
