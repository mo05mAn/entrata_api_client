...
class TestGetLeaseDetailsR1Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1Method:
        """Test GetLeaseDetailsR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1Method`
        """
        model = GetLeaseDetailsR1Method()
        if include_optional:
    ...
    def testGetLeaseDetailsR1Method(self):
        """Test GetLeaseDetailsR1Method"""
