...
class TestGetVendorPickListsSuccessResponseResultRoutingTags(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultRoutingTags:
        """Test GetVendorPickListsSuccessResponseResultRoutingTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultRoutingTags`
        """
        model = GetVendorPickListsSuccessResponseResultRoutingTags()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultRoutingTags(self):
        """Test GetVendorPickListsSuccessResponseResultRoutingTags"""
