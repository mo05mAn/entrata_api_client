...
class TestGetCustomersSuccessResponseResultCustomersCustomerInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInner:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInner`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInner()
        if include_optional:
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInner(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInner"""
