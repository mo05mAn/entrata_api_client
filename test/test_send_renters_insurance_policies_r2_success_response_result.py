...
class TestSendRentersInsurancePoliciesR2SuccessResponseResult(unittest.TestCase):
    """SendRentersInsurancePoliciesR2SuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRentersInsurancePoliciesR2SuccessResponseResult:
        """Test SendRentersInsurancePoliciesR2SuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentersInsurancePoliciesR2SuccessResponseResult`
        """
        model = SendRentersInsurancePoliciesR2SuccessResponseResult()
        if include_optional:
            return SendRentersInsurancePoliciesR2SuccessResponseResult(
    ...
    def testSendRentersInsurancePoliciesR2SuccessResponseResult(self):
        """Test SendRentersInsurancePoliciesR2SuccessResponseResult"""
