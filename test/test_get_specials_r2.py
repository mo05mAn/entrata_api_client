...
class TestGetSpecialsR2(unittest.TestCase):
    """GetSpecialsR2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2:
        """Test GetSpecialsR2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2`
        """
        model = GetSpecialsR2()
        if include_optional:
            return GetSpecialsR2(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_specials_r2_method.getSpecials_r2_method(
                    name = '', 
                    version = 'r2', 
