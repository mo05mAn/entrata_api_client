...
class TestUpdateLeaseSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateLeaseSuccessResponse:
        """Test UpdateLeaseSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeaseSuccessResponse`
        """
        model = UpdateLeaseSuccessResponse()
        if include_optional:
    ...
    def testUpdateLeaseSuccessResponse(self):
        """Test UpdateLeaseSuccessResponse"""
