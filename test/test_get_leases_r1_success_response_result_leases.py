...
class TestGetLeasesR1SuccessResponseResultLeases(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasesR1SuccessResponseResultLeases:
        """Test GetLeasesR1SuccessResponseResultLeases
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR1SuccessResponseResultLeases`
        """
        model = GetLeasesR1SuccessResponseResultLeases()
        if include_optional:
    ...
    def testGetLeasesR1SuccessResponseResultLeases(self):
        """Test GetLeasesR1SuccessResponseResultLeases"""
