...
class TestSendVendorsSuccessResponseResultVendorsVendorInnerAttributes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendVendorsSuccessResponseResultVendorsVendorInnerAttributes:
        """Test SendVendorsSuccessResponseResultVendorsVendorInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVendorsSuccessResponseResultVendorsVendorInnerAttributes`
        """
        model = SendVendorsSuccessResponseResultVendorsVendorInnerAttributes()
        if include_optional:
            return SendVendorsSuccessResponseResultVendorsVendorInnerAttributes(
                vendor_id = 13019,
                status = 'Success',
    ...
    def testSendVendorsSuccessResponseResultVendorsVendorInnerAttributes(self):
        """Test SendVendorsSuccessResponseResultVendorsVendorInnerAttributes"""
