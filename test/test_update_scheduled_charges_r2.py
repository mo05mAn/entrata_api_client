...
class TestUpdateScheduledChargesR2(unittest.TestCase):
    """UpdateScheduledChargesR2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR2:
        """Test UpdateScheduledChargesR2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR2`
        """
        model = UpdateScheduledChargesR2()
        if include_optional:
            return UpdateScheduledChargesR2(
    ...
    def testUpdateScheduledChargesR2(self):
        """Test UpdateScheduledChargesR2"""
