...
class TestGetPropertyMediaSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyMediaSuccessResponse:
        """Test GetPropertyMediaSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyMediaSuccessResponse`
        """
    ...
    def testGetPropertyMediaSuccessResponse(self):
        """Test GetPropertyMediaSuccessResponse"""
