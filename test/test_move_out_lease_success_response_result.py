...
class TestMoveOutLeaseSuccessResponseResult(unittest.TestCase):
    """MoveOutLeaseSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoveOutLeaseSuccessResponseResult:
        """Test MoveOutLeaseSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveOutLeaseSuccessResponseResult`
        """
        model = MoveOutLeaseSuccessResponseResult()
        if include_optional:
            return MoveOutLeaseSuccessResponseResult(
                status = 'Success',
    ...
    def testMoveOutLeaseSuccessResponseResult(self):
        """Test MoveOutLeaseSuccessResponseResult"""
