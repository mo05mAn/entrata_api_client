...
class TestGetReservableAmenitiesMethod(unittest.TestCase):
    """GetReservableAmenitiesMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesMethod:
        """Test GetReservableAmenitiesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservableAmenitiesMethod`
        """
        model = GetReservableAmenitiesMethod()
        if include_optional:
            return GetReservableAmenitiesMethod(
    ...
    def testGetReservableAmenitiesMethod(self):
        """Test GetReservableAmenitiesMethod"""
