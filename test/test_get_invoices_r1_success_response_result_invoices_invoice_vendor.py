...
class TestGetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor:
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor`
        """
        model = GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor()
        if include_optional:
            return GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor(
                id = '18418',
                name = 'Test, Corporate',
    ...
    def testGetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor(self):
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor"""
