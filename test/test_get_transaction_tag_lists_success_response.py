...
class TestGetTransactionTagListsSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionTagListsSuccessResponse:
        """Test GetTransactionTagListsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTransactionTagListsSuccessResponse`
        """
        model = GetTransactionTagListsSuccessResponse()
        if include_optional:
    ...
    def testGetTransactionTagListsSuccessResponse(self):
        """Test GetTransactionTagListsSuccessResponse"""
