...
class TestGetFinancialPickListR2SuccessResponseResultGlExportBatchTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlExportBatchTypes:
        """Test GetFinancialPickListR2SuccessResponseResultGlExportBatchTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlExportBatchTypes`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlExportBatchTypes()
        if include_optional:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlExportBatchTypes(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlExportBatchTypes"""
