...
class TestGetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner(unittest.TestCase):
    """GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner:
        """Test GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner`
        """
        model = GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner()
        if include_optional:
            return GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner(
                location_id = '1234',
    ...
    def testGetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner(self):
        """Test GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner"""
