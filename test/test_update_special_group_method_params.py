...
class TestUpdateSpecialGroupMethodParams(unittest.TestCase):
    """UpdateSpecialGroupMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSpecialGroupMethodParams:
        """Test UpdateSpecialGroupMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpecialGroupMethodParams`
        """
        model = UpdateSpecialGroupMethodParams()
        if include_optional:
            return UpdateSpecialGroupMethodParams(
                property_id = '123456',
    ...
    def testUpdateSpecialGroupMethodParams(self):
        """Test UpdateSpecialGroupMethodParams"""
