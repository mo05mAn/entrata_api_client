...
class TestGetSpecialsR3(unittest.TestCase):
    """GetSpecialsR3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3:
        """Test GetSpecialsR3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3`
        """
        model = GetSpecialsR3()
        if include_optional:
            return GetSpecialsR3(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_specials_r3_method.getSpecials_r3_method(
                    name = '', 
                    version = 'r3', 
