...
class TestGetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal(unittest.TestCase):
    """GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal:
        """Test GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal`
        """
        model = GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal()
        if include_optional:
            return GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal(
                total_charge = '10.27',
                total_minutes = 616
            )
        else:
    ...
    def testGetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal(self):
        """Test GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal"""
