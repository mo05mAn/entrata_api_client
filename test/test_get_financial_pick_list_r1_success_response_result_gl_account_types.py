...
class TestGetFinancialPickListR1SuccessResponseResultGlAccountTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlAccountTypes:
        """Test GetFinancialPickListR1SuccessResponseResultGlAccountTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlAccountTypes`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlAccountTypes()
        if include_optional:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlAccountTypes(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlAccountTypes"""
