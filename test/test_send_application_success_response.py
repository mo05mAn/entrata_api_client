...
class TestSendApplicationSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationSuccessResponse:
        """Test SendApplicationSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationSuccessResponse`
        """
    ...
    def testSendApplicationSuccessResponse(self):
        """Test SendApplicationSuccessResponse"""
