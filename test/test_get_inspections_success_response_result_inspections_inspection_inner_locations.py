...
class TestGetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations(unittest.TestCase):
    """GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations:
        """Test GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations`
        """
        model = GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations()
        if include_optional:
            return GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations(
                location = [
    ...
    def testGetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations(self):
        """Test GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations"""
