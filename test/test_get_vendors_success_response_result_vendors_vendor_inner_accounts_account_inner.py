...
class TestGetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner(unittest.TestCase):
    """GetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner:
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner`
        """
        model = GetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner()
        if include_optional:
            return GetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner(
                account_id = '123456',
    ...
    def testGetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner(self):
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner"""
