...
class TestGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilities:
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilities`
        """
        model = GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilities()
        if include_optional:
    ...
    def testGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilities(self):
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilities"""
