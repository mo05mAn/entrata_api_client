...
class TestGetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes(unittest.TestCase):
    """GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes:
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes`
        """
        model = GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes()
        if include_optional:
            return GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes(
                account_id = '1234',
    ...
    def testGetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes(self):
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes"""
