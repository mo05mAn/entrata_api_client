...
class TestGetInvoicesR1SuccessResponseResultInvoices(unittest.TestCase):
    """GetInvoicesR1SuccessResponseResultInvoices unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1SuccessResponseResultInvoices:
        """Test GetInvoicesR1SuccessResponseResultInvoices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1SuccessResponseResultInvoices`
        """
        model = GetInvoicesR1SuccessResponseResultInvoices()
        if include_optional:
            return GetInvoicesR1SuccessResponseResultInvoices(
    ...
    def testGetInvoicesR1SuccessResponseResultInvoices(self):
        """Test GetInvoicesR1SuccessResponseResultInvoices"""
