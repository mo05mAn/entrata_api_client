...
class TestSendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId(unittest.TestCase):
    """SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId:
        """Test SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId`
        """
        model = SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId()
        if include_optional:
            return SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId(
            )
        else:
            return SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId(
        )
    ...
    def testSendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId(self):
        """Test SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId"""
