...
class TestSendCustomerTestimonialsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendCustomerTestimonialsMethodParams:
        """Test SendCustomerTestimonialsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendCustomerTestimonialsMethodParams`
        """
        model = SendCustomerTestimonialsMethodParams()
        if include_optional:
            return SendCustomerTestimonialsMethodParams(
                customer_id = 123456,
    ...
    def testSendCustomerTestimonialsMethodParams(self):
        """Test SendCustomerTestimonialsMethodParams"""
