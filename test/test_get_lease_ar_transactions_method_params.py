...
class TestGetLeaseArTransactionsMethodParams(unittest.TestCase):
    """GetLeaseArTransactionsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseArTransactionsMethodParams:
        """Test GetLeaseArTransactionsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseArTransactionsMethodParams`
        """
        model = GetLeaseArTransactionsMethodParams()
        if include_optional:
            return GetLeaseArTransactionsMethodParams(
                property_id = 123456,
                lease_ids = 56,
                lease_status_type_ids = 56,
                transaction_type_ids = 56,
                ar_code_ids = 56,
                show_full_ledger = 0,
    ...
    def testGetLeaseArTransactionsMethodParams(self):
        """Test GetLeaseArTransactionsMethodParams"""
