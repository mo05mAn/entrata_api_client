...
class TestGetPropertyMediaSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyMediaSuccessResponseResponse:
        """Test GetPropertyMediaSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyMediaSuccessResponseResponse`
        """
        model = GetPropertyMediaSuccessResponseResponse()
        if include_optional:
    ...
    def testGetPropertyMediaSuccessResponseResponse(self):
        """Test GetPropertyMediaSuccessResponseResponse"""
