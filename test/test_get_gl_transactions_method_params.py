...
class TestGetGlTransactionsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGlTransactionsMethodParams:
        """Test GetGlTransactionsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTransactionsMethodParams`
        """
        model = GetGlTransactionsMethodParams()
        if include_optional:
            return GetGlTransactionsMethodParams(
                property_ids = '123456,112233',
                gl_account_from = 1234,
                gl_account_to = 1234,
                post_month_from = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                post_month_to = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                post_date_from = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                post_date_to = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                is_cash_book = 0,
                is_detailed = 0,
                gl_tree_id = 1234,
                gl_book_type_ids = 56,
                ...
                exclude_ap_transactions = 0,
                exclude_ar_transactions = 0,
                exclude_exported_transactions = 0
            )
        else:
            return GetGlTransactionsMethodParams(
                property_ids = '123456,112233',
    ...
    def testGetGlTransactionsMethodParams(self):
        """Test GetGlTransactionsMethodParams"""
