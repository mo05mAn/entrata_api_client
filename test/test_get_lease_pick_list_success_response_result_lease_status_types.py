...
class TestGetLeasePickListSuccessResponseResultLeaseStatusTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultLeaseStatusTypes:
        """Test GetLeasePickListSuccessResponseResultLeaseStatusTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultLeaseStatusTypes`
        """
        model = GetLeasePickListSuccessResponseResultLeaseStatusTypes()
        if include_optional:
    ...
    def testGetLeasePickListSuccessResponseResultLeaseStatusTypes(self):
        """Test GetLeasePickListSuccessResponseResultLeaseStatusTypes"""
