...
class TestGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyID(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyID:
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyID`
        """
    ...
    def testGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyID(self):
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyID"""
