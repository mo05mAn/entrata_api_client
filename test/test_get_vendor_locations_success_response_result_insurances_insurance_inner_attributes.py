...
class TestGetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes(unittest.TestCase):
    """GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes:
        """Test GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes`
        """
        model = GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes()
        if include_optional:
            return GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes(
                id = '1031',
                provider = 'Provider 7'
            )
        else:
    ...
    def testGetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes(self):
        """Test GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes"""
