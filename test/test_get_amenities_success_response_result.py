...
class TestGetAmenitiesSuccessResponseResult(unittest.TestCase):
    """GetAmenitiesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResult:
        """Test GetAmenitiesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResult`
        """
        model = GetAmenitiesSuccessResponseResult()
        if include_optional:
            return GetAmenitiesSuccessResponseResult(
    ...
    def testGetAmenitiesSuccessResponseResult(self):
        """Test GetAmenitiesSuccessResponseResult"""
