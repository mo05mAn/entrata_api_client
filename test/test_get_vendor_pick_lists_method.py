...
class TestGetVendorPickListsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsMethod:
        """Test GetVendorPickListsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsMethod`
        """
        model = GetVendorPickListsMethod()
        if include_optional:
            return GetVendorPickListsMethod(
    ...
    def testGetVendorPickListsMethod(self):
        """Test GetVendorPickListsMethod"""
