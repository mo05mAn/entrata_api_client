...
class TestGetVendorPickListsSuccessResponseResultPolicies(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultPolicies:
        """Test GetVendorPickListsSuccessResponseResultPolicies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultPolicies`
        """
        model = GetVendorPickListsSuccessResponseResultPolicies()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultPolicies(self):
        """Test GetVendorPickListsSuccessResponseResultPolicies"""
