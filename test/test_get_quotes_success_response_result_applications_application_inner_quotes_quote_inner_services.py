...
class TestGetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServices(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServices:
        """Test GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServices`
        """
        model = GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServices()
        if include_optional:
    ...
    def testGetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServices(self):
        """Test GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServices"""
