...
class TestMarkGlTransactionsExportedMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MarkGlTransactionsExportedMethod:
        """Test MarkGlTransactionsExportedMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkGlTransactionsExportedMethod`
        """
        model = MarkGlTransactionsExportedMethod()
        if include_optional:
    ...
    def testMarkGlTransactionsExportedMethod(self):
        """Test MarkGlTransactionsExportedMethod"""
