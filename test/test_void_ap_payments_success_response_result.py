...
class TestVoidApPaymentsSuccessResponseResult(unittest.TestCase):
    """VoidApPaymentsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoidApPaymentsSuccessResponseResult:
        """Test VoidApPaymentsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidApPaymentsSuccessResponseResult`
        """
        model = VoidApPaymentsSuccessResponseResult()
        if include_optional:
            return VoidApPaymentsSuccessResponseResult(
    ...
    def testVoidApPaymentsSuccessResponseResult(self):
        """Test VoidApPaymentsSuccessResponseResult"""
