...
class TestGetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions:
        """Test GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions`
        """
        model = GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions()
        if include_optional:
    ...
    def testGetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions(self):
        """Test GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions"""
