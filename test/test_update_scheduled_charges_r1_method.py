...
class TestUpdateScheduledChargesR1Method(unittest.TestCase):
    """UpdateScheduledChargesR1Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR1Method:
        """Test UpdateScheduledChargesR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR1Method`
        """
        model = UpdateScheduledChargesR1Method()
        if include_optional:
            return UpdateScheduledChargesR1Method(
                name = '',
                version = 'r1',
    ...
    def testUpdateScheduledChargesR1Method(self):
        """Test UpdateScheduledChargesR1Method"""
