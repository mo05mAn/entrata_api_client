...
class TestGetArCodesSuccessResponseResponseResultArcodes(unittest.TestCase):
    """GetArCodesSuccessResponseResponseResultArcodes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetArCodesSuccessResponseResponseResultArcodes:
        """Test GetArCodesSuccessResponseResponseResultArcodes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArCodesSuccessResponseResponseResultArcodes`
        """
        model = GetArCodesSuccessResponseResponseResultArcodes()
        if include_optional:
            return GetArCodesSuccessResponseResponseResultArcodes(
                arcode = [
    ...
    def testGetArCodesSuccessResponseResponseResultArcodes(self):
        """Test GetArCodesSuccessResponseResponseResultArcodes"""
