...
class TestGetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePayments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePayments:
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePayments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePayments`
        """
        model = GetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePayments()
        if include_optional:
    ...
    def testGetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePayments(self):
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePayments"""
