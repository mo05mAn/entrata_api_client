...
class TestGetUnitsAvailabilityAndPricingSuccessResponseResult(unittest.TestCase):
    """GetUnitsAvailabilityAndPricingSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUnitsAvailabilityAndPricingSuccessResponseResult:
        """Test GetUnitsAvailabilityAndPricingSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitsAvailabilityAndPricingSuccessResponseResult`
        """
        model = GetUnitsAvailabilityAndPricingSuccessResponseResult()
        if include_optional:
            return GetUnitsAvailabilityAndPricingSuccessResponseResult(
    ...
    def testGetUnitsAvailabilityAndPricingSuccessResponseResult(self):
        """Test GetUnitsAvailabilityAndPricingSuccessResponseResult"""
