...
class TestGetMarketingPreferencesMethod(unittest.TestCase):
    """GetMarketingPreferencesMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencesMethod:
        """Test GetMarketingPreferencesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencesMethod`
        """
        model = GetMarketingPreferencesMethod()
        if include_optional:
            return GetMarketingPreferencesMethod(
    ...
    def testGetMarketingPreferencesMethod(self):
        """Test GetMarketingPreferencesMethod"""
