...
class TestGetFloorPlansSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponse:
        """Test GetFloorPlansSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponse`
        """
        model = GetFloorPlansSuccessResponse()
        if include_optional:
    ...
    def testGetFloorPlansSuccessResponse(self):
        """Test GetFloorPlansSuccessResponse"""
