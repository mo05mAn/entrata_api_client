...
class TestDeletePropertyMediaSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeletePropertyMediaSuccessResponseResponse:
        """Test DeletePropertyMediaSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletePropertyMediaSuccessResponseResponse`
        """
        model = DeletePropertyMediaSuccessResponseResponse()
        if include_optional:
    ...
    def testDeletePropertyMediaSuccessResponseResponse(self):
        """Test DeletePropertyMediaSuccessResponseResponse"""
