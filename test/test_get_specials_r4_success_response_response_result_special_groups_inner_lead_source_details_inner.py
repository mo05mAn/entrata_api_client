...
class TestGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeadSourceDetailsInner(unittest.TestCase):
    """GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeadSourceDetailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeadSourceDetailsInner:
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeadSourceDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeadSourceDetailsInner`
        """
        model = GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeadSourceDetailsInner()
        if include_optional:
            return GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeadSourceDetailsInner(
                id = 2,
                name = 'ABC'
            )
        else:
    ...
    def testGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeadSourceDetailsInner(self):
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeadSourceDetailsInner"""
