...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes(unittest.TestCase):
    """GetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes(
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes"""
