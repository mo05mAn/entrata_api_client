...
class TestSendPurchaseOrdersMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendPurchaseOrdersMethod:
        """Test SendPurchaseOrdersMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPurchaseOrdersMethod`
        """
        model = SendPurchaseOrdersMethod()
        if include_optional:
    ...
    def testSendPurchaseOrdersMethod(self):
        """Test SendPurchaseOrdersMethod"""
