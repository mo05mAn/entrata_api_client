...
class TestGetAccessibleClientsSuccessResponseResultOrgsInner(unittest.TestCase):
    """GetAccessibleClientsSuccessResponseResultOrgsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccessibleClientsSuccessResponseResultOrgsInner:
        """Test GetAccessibleClientsSuccessResponseResultOrgsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessibleClientsSuccessResponseResultOrgsInner`
        """
        model = GetAccessibleClientsSuccessResponseResultOrgsInner()
        if include_optional:
            return GetAccessibleClientsSuccessResponseResultOrgsInner(
                subdomain = 'demoold',
                id = 235,
                name = 'Demo Account'
            )
    ...
    def testGetAccessibleClientsSuccessResponseResultOrgsInner(self):
        """Test GetAccessibleClientsSuccessResponseResultOrgsInner"""
