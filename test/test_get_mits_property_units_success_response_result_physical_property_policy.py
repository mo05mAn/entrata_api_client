...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicy(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicy:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicy`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicy()
        if include_optional:
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicy(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicy"""
