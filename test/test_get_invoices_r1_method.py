...
class TestGetInvoicesR1Method(unittest.TestCase):
    """GetInvoicesR1Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1Method:
        """Test GetInvoicesR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1Method`
        """
        model = GetInvoicesR1Method()
        if include_optional:
            return GetInvoicesR1Method(
                name = '',
                version = 'r1',
    ...
    def testGetInvoicesR1Method(self):
        """Test GetInvoicesR1Method"""
