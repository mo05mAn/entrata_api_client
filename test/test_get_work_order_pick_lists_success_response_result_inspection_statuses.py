...
class TestGetWorkOrderPickListsSuccessResponseResultInspectionStatuses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultInspectionStatuses:
        """Test GetWorkOrderPickListsSuccessResponseResultInspectionStatuses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultInspectionStatuses`
        """
        model = GetWorkOrderPickListsSuccessResponseResultInspectionStatuses()
        if include_optional:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultInspectionStatuses(self):
        """Test GetWorkOrderPickListsSuccessResponseResultInspectionStatuses"""
