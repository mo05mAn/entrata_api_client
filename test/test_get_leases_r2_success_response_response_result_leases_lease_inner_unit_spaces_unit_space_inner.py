...
class TestGetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner(unittest.TestCase):
    """GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner:
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner`
        """
        model = GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner()
        if include_optional:
            return GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner(
    ...
    def testGetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner(self):
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner"""
