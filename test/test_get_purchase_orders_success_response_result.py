...
class TestGetPurchaseOrdersSuccessResponseResult(unittest.TestCase):
    """GetPurchaseOrdersSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPurchaseOrdersSuccessResponseResult:
        """Test GetPurchaseOrdersSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPurchaseOrdersSuccessResponseResult`
        """
        model = GetPurchaseOrdersSuccessResponseResult()
        if include_optional:
            return GetPurchaseOrdersSuccessResponseResult(
    ...
    def testGetPurchaseOrdersSuccessResponseResult(self):
        """Test GetPurchaseOrdersSuccessResponseResult"""
