...
class TestGetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes(unittest.TestCase):
    """GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes:
        """Test GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes`
        """
        model = GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes()
        if include_optional:
            return GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes(
                id_type = 'unitTypeId'
            )
        else:
            return GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes(
    ...
    def testGetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes(self):
        """Test GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes"""
