...
class TestGetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes(unittest.TestCase):
    """GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes:
        """Test GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes`
        """
        model = GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes()
        if include_optional:
            return GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes(
                id = 4940016
            )
        else:
            return GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes(
    ...
    def testGetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes(self):
        """Test GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes"""
