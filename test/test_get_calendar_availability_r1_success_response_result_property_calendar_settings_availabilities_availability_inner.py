...
class TestGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner(unittest.TestCase):
    """GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner:
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner`
        """
        model = GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner()
        if include_optional:
            return GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner(
                day = 'Monday',
    ...
    def testGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner(self):
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner"""
