...
class TestUpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner:
        """Test UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner`
        """
        model = UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner()
        if include_optional:
            return UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner(
                special_id = '1234567',
                special_type_id = '1',
    ...
    def testUpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner(self):
        """Test UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner"""
