...
class TestGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner(unittest.TestCase):
    """GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner()
        if include_optional:
            return GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner(
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner"""
