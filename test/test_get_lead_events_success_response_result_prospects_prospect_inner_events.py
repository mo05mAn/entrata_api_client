...
class TestGetLeadEventsSuccessResponseResultProspectsProspectInnerEvents(unittest.TestCase):
    """GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents:
        """Test GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents`
        """
        model = GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents()
        if include_optional:
            return GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents(
                event = [
    ...
    def testGetLeadEventsSuccessResponseResultProspectsProspectInnerEvents(self):
        """Test GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents"""
