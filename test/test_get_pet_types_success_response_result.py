...
class TestGetPetTypesSuccessResponseResult(unittest.TestCase):
    """GetPetTypesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPetTypesSuccessResponseResult:
        """Test GetPetTypesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPetTypesSuccessResponseResult`
        """
        model = GetPetTypesSuccessResponseResult()
        if include_optional:
            return GetPetTypesSuccessResponseResult(
    ...
    def testGetPetTypesSuccessResponseResult(self):
        """Test GetPetTypesSuccessResponseResult"""
