...
class TestGetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes(unittest.TestCase):
    """GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes:
        """Test GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes`
        """
        model = GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes()
        if include_optional:
            return GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes(
    ...
    def testGetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes(self):
        """Test GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes"""
