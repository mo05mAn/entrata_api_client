...
class TestGetLeadEventsSuccessResponseResultProspectsProspectInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadEventsSuccessResponseResultProspectsProspectInner:
        """Test GetLeadEventsSuccessResponseResultProspectsProspectInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadEventsSuccessResponseResultProspectsProspectInner`
        """
        model = GetLeadEventsSuccessResponseResultProspectsProspectInner()
        if include_optional:
    ...
    def testGetLeadEventsSuccessResponseResultProspectsProspectInner(self):
        """Test GetLeadEventsSuccessResponseResultProspectsProspectInner"""
