...
class TestSendLeaseDocumentsRequestBodyMethodParams(unittest.TestCase):
    """SendLeaseDocumentsRequestBodyMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseDocumentsRequestBodyMethodParams:
        """Test SendLeaseDocumentsRequestBodyMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseDocumentsRequestBodyMethodParams`
        """
        model = SendLeaseDocumentsRequestBodyMethodParams()
        if include_optional:
            return SendLeaseDocumentsRequestBodyMethodParams(
                property_id = 123456,
                lease_id = 123456,
    ...
    def testSendLeaseDocumentsRequestBodyMethodParams(self):
        """Test SendLeaseDocumentsRequestBodyMethodParams"""
