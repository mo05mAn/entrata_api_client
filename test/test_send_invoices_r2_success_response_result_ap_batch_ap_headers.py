...
class TestSendInvoicesR2SuccessResponseResultApBatchApHeaders(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendInvoicesR2SuccessResponseResultApBatchApHeaders:
        """Test SendInvoicesR2SuccessResponseResultApBatchApHeaders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR2SuccessResponseResultApBatchApHeaders`
        """
        model = SendInvoicesR2SuccessResponseResultApBatchApHeaders()
        if include_optional:
    ...
    def testSendInvoicesR2SuccessResponseResultApBatchApHeaders(self):
        """Test SendInvoicesR2SuccessResponseResultApBatchApHeaders"""
