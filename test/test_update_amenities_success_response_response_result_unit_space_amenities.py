...
class TestUpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenities:
        """Test UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenities`
        """
        model = UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenities()
        if include_optional:
    ...
    def testUpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenities(self):
        """Test UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenities"""
