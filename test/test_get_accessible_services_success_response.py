...
class TestGetAccessibleServicesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccessibleServicesSuccessResponse:
        """Test GetAccessibleServicesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessibleServicesSuccessResponse`
        """
        model = GetAccessibleServicesSuccessResponse()
        if include_optional:
    ...
    def testGetAccessibleServicesSuccessResponse(self):
        """Test GetAccessibleServicesSuccessResponse"""
