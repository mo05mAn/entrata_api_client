...
class TestSendCustomerTestimonialsSuccessResponseResultTestimonials(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendCustomerTestimonialsSuccessResponseResultTestimonials:
        """Test SendCustomerTestimonialsSuccessResponseResultTestimonials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendCustomerTestimonialsSuccessResponseResultTestimonials`
        """
        model = SendCustomerTestimonialsSuccessResponseResultTestimonials()
        if include_optional:
    ...
    def testSendCustomerTestimonialsSuccessResponseResultTestimonials(self):
        """Test SendCustomerTestimonialsSuccessResponseResultTestimonials"""
