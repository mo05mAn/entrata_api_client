...
class TestGetLeadsSuccessResponseResultProspectsProspectInner(unittest.TestCase):
    """GetLeadsSuccessResponseResultProspectsProspectInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResultProspectsProspectInner:
        """Test GetLeadsSuccessResponseResultProspectsProspectInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResultProspectsProspectInner`
        """
        model = GetLeadsSuccessResponseResultProspectsProspectInner()
        if include_optional:
            return GetLeadsSuccessResponseResultProspectsProspectInner(
                application_id = '1234',
    ...
    def testGetLeadsSuccessResponseResultProspectsProspectInner(self):
        """Test GetLeadsSuccessResponseResultProspectsProspectInner"""
