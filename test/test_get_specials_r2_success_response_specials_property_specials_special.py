...
class TestGetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial(unittest.TestCase):
    """GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial:
        """Test GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial`
        """
        model = GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial()
        if include_optional:
            return GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial(
                id = '505909',
                name = 'aaa',
    ...
    def testGetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial(self):
        """Test GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial"""
