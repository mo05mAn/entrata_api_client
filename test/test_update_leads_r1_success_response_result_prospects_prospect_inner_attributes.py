...
class TestUpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes(unittest.TestCase):
    """UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes:
        """Test UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes`
        """
        model = UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes()
        if include_optional:
            return UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes(
                node = '1',
                reference_id = '123456',
                applicant_id = '12345',
                status = 'Success',
    ...
    def testUpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes(self):
        """Test UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes"""
