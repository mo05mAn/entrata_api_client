...
class TestGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge(unittest.TestCase):
    """GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge:
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge`
        """
        model = GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge()
        if include_optional:
            return GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge(
                ar_code_id = '120044',
    ...
    def testGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge(self):
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge"""
