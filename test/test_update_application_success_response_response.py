...
class TestUpdateApplicationSuccessResponseResponse(unittest.TestCase):
    """UpdateApplicationSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateApplicationSuccessResponseResponse:
        """Test UpdateApplicationSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateApplicationSuccessResponseResponse`
        """
        model = UpdateApplicationSuccessResponseResponse()
        if include_optional:
            return UpdateApplicationSuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testUpdateApplicationSuccessResponseResponse(self):
        """Test UpdateApplicationSuccessResponseResponse"""
