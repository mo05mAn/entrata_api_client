...
class TestSendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner:
        """Test SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner`
        """
        model = SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner()
        if include_optional:
            return SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner(
                node = '1',
                status = 'Success',
    ...
    def testSendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner(self):
        """Test SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner"""
