...
class TestGetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes:
        """Test GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes(
                id = '1',
    ...
    def testGetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes"""
