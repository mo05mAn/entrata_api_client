...
class TestGetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner(
                id = 616,
                name = 'Standard'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner"""
