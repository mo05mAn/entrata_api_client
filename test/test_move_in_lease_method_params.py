...
class TestMoveInLeaseMethodParams(unittest.TestCase):
    """MoveInLeaseMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoveInLeaseMethodParams:
        """Test MoveInLeaseMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveInLeaseMethodParams`
        """
        model = MoveInLeaseMethodParams()
        if include_optional:
            return MoveInLeaseMethodParams(
                property_id = 123456,
                lease_id = 123456
            )
        else:
    ...
    def testMoveInLeaseMethodParams(self):
        """Test MoveInLeaseMethodParams"""
