...
class TestGetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type:
        """Test GetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type`
        """
    ...
    def testGetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type(self):
        """Test GetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type"""
