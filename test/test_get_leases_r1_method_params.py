...
class TestGetLeasesR1MethodParams(unittest.TestCase):
    """GetLeasesR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR1MethodParams:
        """Test GetLeasesR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR1MethodParams`
        """
        model = GetLeasesR1MethodParams()
        if include_optional:
            return GetLeasesR1MethodParams(
                property_id = 123456,
    ...
    def testGetLeasesR1MethodParams(self):
        """Test GetLeasesR1MethodParams"""
