...
class TestMoveOutLeaseMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MoveOutLeaseMethodParams:
        """Test MoveOutLeaseMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveOutLeaseMethodParams`
        """
        model = MoveOutLeaseMethodParams()
        if include_optional:
            return MoveOutLeaseMethodParams(
                property_id = 123456,
                lease_id = 123456,
                ...
                end_continuing_scheduled_charges = 0,
                post_accelerated_rent = 0,
    ...
    def testMoveOutLeaseMethodParams(self):
        """Test MoveOutLeaseMethodParams"""
