...
class TestGetMitsLeasesSuccessResponseResponse(unittest.TestCase):
    """GetMitsLeasesSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponse:
        """Test GetMitsLeasesSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponse`
        """
        model = GetMitsLeasesSuccessResponseResponse()
        if include_optional:
            return GetMitsLeasesSuccessResponseResponse(
                request_id = '15',
    ...
    def testGetMitsLeasesSuccessResponseResponse(self):
        """Test GetMitsLeasesSuccessResponseResponse"""
