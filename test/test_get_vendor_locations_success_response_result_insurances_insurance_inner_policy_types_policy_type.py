...
class TestGetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType(unittest.TestCase):
    """GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType:
        """Test GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType`
        """
        model = GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType()
        if include_optional:
            return GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType(
    ...
    def testGetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType(self):
        """Test GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType"""
