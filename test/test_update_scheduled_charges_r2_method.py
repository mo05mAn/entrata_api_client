...
class TestUpdateScheduledChargesR2Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR2Method:
        """Test UpdateScheduledChargesR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR2Method`
        """
        model = UpdateScheduledChargesR2Method()
        if include_optional:
    ...
    def testUpdateScheduledChargesR2Method(self):
        """Test UpdateScheduledChargesR2Method"""
