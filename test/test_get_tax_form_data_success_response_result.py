...
class TestGetTaxFormDataSuccessResponseResult(unittest.TestCase):
    """GetTaxFormDataSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxFormDataSuccessResponseResult:
        """Test GetTaxFormDataSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxFormDataSuccessResponseResult`
        """
        model = GetTaxFormDataSuccessResponseResult()
        if include_optional:
            return GetTaxFormDataSuccessResponseResult(
    ...
    def testGetTaxFormDataSuccessResponseResult(self):
        """Test GetTaxFormDataSuccessResponseResult"""
