...
class TestGetPropertiesSuccessResponse(unittest.TestCase):
    """GetPropertiesSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertiesSuccessResponse:
        """Test GetPropertiesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertiesSuccessResponse`
        """
        model = GetPropertiesSuccessResponse()
        if include_optional:
            return GetPropertiesSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_properties_success_response_result.getPropertiesSuccessResponse_result(
    ...
    def testGetPropertiesSuccessResponse(self):
        """Test GetPropertiesSuccessResponse"""
