...
class TestSendLeadsSuccessResponseResultProspects(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeadsSuccessResponseResultProspects:
        """Test SendLeadsSuccessResponseResultProspects
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeadsSuccessResponseResultProspects`
        """
        model = SendLeadsSuccessResponseResultProspects()
        if include_optional:
    ...
    def testSendLeadsSuccessResponseResultProspects(self):
        """Test SendLeadsSuccessResponseResultProspects"""
