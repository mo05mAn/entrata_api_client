...
class TestGetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerCharges(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerCharges:
        """Test GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerCharges`
        """
        model = GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerCharges()
        if include_optional:
    ...
    def testGetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerCharges(self):
        """Test GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerCharges"""
