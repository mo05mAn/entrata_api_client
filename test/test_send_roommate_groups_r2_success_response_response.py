...
class TestSendRoommateGroupsR2SuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRoommateGroupsR2SuccessResponseResponse:
        """Test SendRoommateGroupsR2SuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRoommateGroupsR2SuccessResponseResponse`
        """
        model = SendRoommateGroupsR2SuccessResponseResponse()
        if include_optional:
    ...
    def testSendRoommateGroupsR2SuccessResponseResponse(self):
        """Test SendRoommateGroupsR2SuccessResponseResponse"""
