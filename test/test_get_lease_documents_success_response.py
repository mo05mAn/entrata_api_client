...
class TestGetLeaseDocumentsSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsSuccessResponse:
        """Test GetLeaseDocumentsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsSuccessResponse`
        """
        model = GetLeaseDocumentsSuccessResponse()
        if include_optional:
    ...
    def testGetLeaseDocumentsSuccessResponse(self):
        """Test GetLeaseDocumentsSuccessResponse"""
