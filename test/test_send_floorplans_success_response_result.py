...
class TestSendFloorplansSuccessResponseResult(unittest.TestCase):
    """SendFloorplansSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendFloorplansSuccessResponseResult:
        """Test SendFloorplansSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFloorplansSuccessResponseResult`
        """
        model = SendFloorplansSuccessResponseResult()
        if include_optional:
            return SendFloorplansSuccessResponseResult(
    ...
    def testSendFloorplansSuccessResponseResult(self):
        """Test SendFloorplansSuccessResponseResult"""
