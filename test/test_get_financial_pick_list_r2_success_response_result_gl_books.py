...
class TestGetFinancialPickListR2SuccessResponseResultGlBooks(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlBooks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlBooks:
        """Test GetFinancialPickListR2SuccessResponseResultGlBooks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlBooks`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlBooks()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlBooks(
                gl_book = [
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlBooks(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlBooks"""
