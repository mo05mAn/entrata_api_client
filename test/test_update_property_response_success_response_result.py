...
class TestUpdatePropertyResponseSuccessResponseResult(unittest.TestCase):
    """UpdatePropertyResponseSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePropertyResponseSuccessResponseResult:
        """Test UpdatePropertyResponseSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyResponseSuccessResponseResult`
        """
        model = UpdatePropertyResponseSuccessResponseResult()
        if include_optional:
            return UpdatePropertyResponseSuccessResponseResult(
    ...
    def testUpdatePropertyResponseSuccessResponseResult(self):
        """Test UpdatePropertyResponseSuccessResponseResult"""
