...
class TestGetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial(unittest.TestCase):
    """GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial:
        """Test GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial`
        """
        model = GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial()
        if include_optional:
            return GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial(
                id = '12015763',
    ...
    def testGetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial(self):
        """Test GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial"""
