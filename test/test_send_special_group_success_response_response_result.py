...
class TestSendSpecialGroupSuccessResponseResponseResult(unittest.TestCase):
    """SendSpecialGroupSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSpecialGroupSuccessResponseResponseResult:
        """Test SendSpecialGroupSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSpecialGroupSuccessResponseResponseResult`
        """
        model = SendSpecialGroupSuccessResponseResponseResult()
        if include_optional:
            return SendSpecialGroupSuccessResponseResponseResult(
                status = 'success',
    ...
    def testSendSpecialGroupSuccessResponseResponseResult(self):
        """Test SendSpecialGroupSuccessResponseResponseResult"""
