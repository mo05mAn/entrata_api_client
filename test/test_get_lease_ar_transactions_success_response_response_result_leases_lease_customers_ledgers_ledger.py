...
class TestGetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger:
        """Test GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger`
        """
        model = GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger()
        if include_optional:
            return GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger(
                id = 11,
                name = 'Resident',
                balance = -924,
    ...
    def testGetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger(self):
        """Test GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger"""
