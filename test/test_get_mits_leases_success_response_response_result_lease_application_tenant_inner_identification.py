...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification(unittest.TestCase):
    """GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification`
        """
        model = GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification()
        if include_optional:
            return GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification(
                id_type = 'Customer ID',
                id_rank = 'primary',
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification"""
