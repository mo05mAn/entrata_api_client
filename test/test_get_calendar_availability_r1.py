        ...
        if include_optional:
            return GetCalendarAvailabilityR1(
                auth = openapi_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = openapi_client.models.get_calendar_availability_r1_method.getCalendarAvailability_r1_method(
                    name = '', 
                    version = 'r1', 
                    params = openapi_client.models.get_calendar_availability_r1_method_params.getCalendarAvailability_r1_method_params(
                        property_id = 123456, 
