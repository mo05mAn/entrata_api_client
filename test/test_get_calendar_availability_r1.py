...
class TestGetCalendarAvailabilityR1(unittest.TestCase):
    """GetCalendarAvailabilityR1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR1:
        """Test GetCalendarAvailabilityR1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR1`
        """
        model = GetCalendarAvailabilityR1()
        if include_optional:
            return GetCalendarAvailabilityR1(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_calendar_availability_r1_method.getCalendarAvailability_r1_method(
                    name = '', 
                    version = 'r1', 
                    params = entrata_api_client.models.get_calendar_availability_r1_method_params.getCalendarAvailability_r1_method_params(
                        property_id = 123456, 
                        from_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        to_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        calendar_event_category_ids = 56, ), )
            )
        else:
            return GetCalendarAvailabilityR1(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
    ...
    def testGetCalendarAvailabilityR1(self):
        """Test GetCalendarAvailabilityR1"""
