...
class TestOrgsV1FinancialPostRequestInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrgsV1FinancialPostRequestInner:
        """Test OrgsV1FinancialPostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgsV1FinancialPostRequestInner`
        """
    ...
    def testOrgsV1FinancialPostRequestInner(self):
        """Test OrgsV1FinancialPostRequestInner"""
