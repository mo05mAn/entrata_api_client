...
class TestGetFinancialPickListR1SuccessResponseResultGlTreeTypes(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlTreeTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlTreeTypes:
        """Test GetFinancialPickListR1SuccessResponseResultGlTreeTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlTreeTypes`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlTreeTypes()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlTreeTypes(
                gl_tree_type = [
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlTreeTypes(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlTreeTypes"""
