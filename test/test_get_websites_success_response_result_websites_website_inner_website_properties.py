...
class TestGetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties:
        """Test GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties`
        """
        model = GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties()
        if include_optional:
    ...
    def testGetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties(self):
        """Test GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties"""
