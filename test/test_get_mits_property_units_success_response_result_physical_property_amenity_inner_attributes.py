...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes(unittest.TestCase):
    """GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes(
                amenity_type = 'Other'
            )
        else:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes(
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes"""
