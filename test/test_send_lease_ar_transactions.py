...
class TestSendLeaseArTransactions(unittest.TestCase):
    """SendLeaseArTransactions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactions:
        """Test SendLeaseArTransactions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactions`
        """
        model = SendLeaseArTransactions()
        if include_optional:
            return SendLeaseArTransactions(
    ...
    def testSendLeaseArTransactions(self):
        """Test SendLeaseArTransactions"""
