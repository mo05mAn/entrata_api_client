...
class TestGetLeaseDetailsR2SuccessResponseResultLeasesLease(unittest.TestCase):
    """GetLeaseDetailsR2SuccessResponseResultLeasesLease unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2SuccessResponseResultLeasesLease:
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLease
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2SuccessResponseResultLeasesLease`
        """
        model = GetLeaseDetailsR2SuccessResponseResultLeasesLease()
        if include_optional:
            return GetLeaseDetailsR2SuccessResponseResultLeasesLease(
                lease_id = '12269740',
                name = 'Ggkl Kkkkk',
    ...
    def testGetLeaseDetailsR2SuccessResponseResultLeasesLease(self):
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLease"""
