...
class TestDeletePropertyMediaMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeletePropertyMediaMethodParams:
        """Test DeletePropertyMediaMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletePropertyMediaMethodParams`
        """
        model = DeletePropertyMediaMethodParams()
        if include_optional:
            return DeletePropertyMediaMethodParams(
                property_id = '999999',
                id = '555555'
            )
        else:
    ...
    def testDeletePropertyMediaMethodParams(self):
        """Test DeletePropertyMediaMethodParams"""
