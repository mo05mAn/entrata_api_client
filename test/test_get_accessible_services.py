...
class TestGetAccessibleServices(unittest.TestCase):
    """GetAccessibleServices unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccessibleServices:
        """Test GetAccessibleServices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessibleServices`
        """
        model = GetAccessibleServices()
        if include_optional:
            return GetAccessibleServices(
    ...
    def testGetAccessibleServices(self):
        """Test GetAccessibleServices"""
