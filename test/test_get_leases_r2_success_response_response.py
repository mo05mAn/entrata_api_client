...
class TestGetLeasesR2SuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasesR2SuccessResponseResponse:
        """Test GetLeasesR2SuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR2SuccessResponseResponse`
        """
        model = GetLeasesR2SuccessResponseResponse()
        if include_optional:
    ...
    def testGetLeasesR2SuccessResponseResponse(self):
        """Test GetLeasesR2SuccessResponseResponse"""
