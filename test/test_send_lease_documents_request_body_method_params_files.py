...
class TestSendLeaseDocumentsRequestBodyMethodParamsFiles(unittest.TestCase):
    """SendLeaseDocumentsRequestBodyMethodParamsFiles unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseDocumentsRequestBodyMethodParamsFiles:
        """Test SendLeaseDocumentsRequestBodyMethodParamsFiles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseDocumentsRequestBodyMethodParamsFiles`
        """
        model = SendLeaseDocumentsRequestBodyMethodParamsFiles()
        if include_optional:
            return SendLeaseDocumentsRequestBodyMethodParamsFiles(
                file = [
    ...
    def testSendLeaseDocumentsRequestBodyMethodParamsFiles(self):
        """Test SendLeaseDocumentsRequestBodyMethodParamsFiles"""
