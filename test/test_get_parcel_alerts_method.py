...
class TestGetParcelAlertsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetParcelAlertsMethod:
        """Test GetParcelAlertsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetParcelAlertsMethod`
        """
        model = GetParcelAlertsMethod()
        if include_optional:
    ...
    def testGetParcelAlertsMethod(self):
        """Test GetParcelAlertsMethod"""
