...
class TestSendAmenitiesSuccessResponseResponse(unittest.TestCase):
    """SendAmenitiesSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendAmenitiesSuccessResponseResponse:
        """Test SendAmenitiesSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAmenitiesSuccessResponseResponse`
        """
        model = SendAmenitiesSuccessResponseResponse()
        if include_optional:
            return SendAmenitiesSuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testSendAmenitiesSuccessResponseResponse(self):
        """Test SendAmenitiesSuccessResponseResponse"""
