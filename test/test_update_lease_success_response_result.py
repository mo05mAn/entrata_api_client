...
class TestUpdateLeaseSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateLeaseSuccessResponseResult:
        """Test UpdateLeaseSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeaseSuccessResponseResult`
        """
        model = UpdateLeaseSuccessResponseResult()
        if include_optional:
            return UpdateLeaseSuccessResponseResult(
                status = 'Success',
                lease_id = '123456',
    ...
    def testUpdateLeaseSuccessResponseResult(self):
        """Test UpdateLeaseSuccessResponseResult"""
