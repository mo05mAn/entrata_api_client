...
class TestGetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner(unittest.TestCase):
    """GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner:
        """Test GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner`
        """
        model = GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner()
        if include_optional:
            return GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner(
                id = '2',
                name = 'Unknown'
            )
        else:
    ...
    def testGetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner(self):
        """Test GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner"""
