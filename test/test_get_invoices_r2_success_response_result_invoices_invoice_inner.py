...
class TestGetInvoicesR2SuccessResponseResultInvoicesInvoiceInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2SuccessResponseResultInvoicesInvoiceInner:
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2SuccessResponseResultInvoicesInvoiceInner`
        """
        model = GetInvoicesR2SuccessResponseResultInvoicesInvoiceInner()
        if include_optional:
            return GetInvoicesR2SuccessResponseResultInvoicesInvoiceInner(
                id = '123456',
                is_on_hold = '0',
    ...
    def testGetInvoicesR2SuccessResponseResultInvoicesInvoiceInner(self):
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInner"""
