...
class TestMarkInvoicesExportedMethod(unittest.TestCase):
    """MarkInvoicesExportedMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkInvoicesExportedMethod:
        """Test MarkInvoicesExportedMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkInvoicesExportedMethod`
        """
        model = MarkInvoicesExportedMethod()
        if include_optional:
            return MarkInvoicesExportedMethod(
    ...
    def testMarkInvoicesExportedMethod(self):
        """Test MarkInvoicesExportedMethod"""
