...
class TestSendPropertyMedia(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendPropertyMedia:
        """Test SendPropertyMedia
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPropertyMedia`
        """
    ...
    def testSendPropertyMedia(self):
        """Test SendPropertyMedia"""
