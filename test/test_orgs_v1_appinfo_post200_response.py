...
class TestOrgsV1AppinfoPost200Response(unittest.TestCase):
    """OrgsV1AppinfoPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgsV1AppinfoPost200Response:
        """Test OrgsV1AppinfoPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgsV1AppinfoPost200Response`
        """
        model = OrgsV1AppinfoPost200Response()
        if include_optional:
            return OrgsV1AppinfoPost200Response(
                request_id = '15',
                code = 200,
    ...
    def testOrgsV1AppinfoPost200Response(self):
        """Test OrgsV1AppinfoPost200Response"""
