...
class TestGetLeasePickListMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasePickListMethod:
        """Test GetLeasePickListMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListMethod`
        """
        model = GetLeasePickListMethod()
        if include_optional:
            return GetLeasePickListMethod(
    ...
    def testGetLeasePickListMethod(self):
        """Test GetLeasePickListMethod"""
