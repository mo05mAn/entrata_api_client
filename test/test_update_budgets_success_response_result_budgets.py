...
class TestUpdateBudgetsSuccessResponseResultBudgets(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateBudgetsSuccessResponseResultBudgets:
        """Test UpdateBudgetsSuccessResponseResultBudgets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBudgetsSuccessResponseResultBudgets`
        """
        model = UpdateBudgetsSuccessResponseResultBudgets()
        if include_optional:
    ...
    def testUpdateBudgetsSuccessResponseResultBudgets(self):
        """Test UpdateBudgetsSuccessResponseResultBudgets"""
