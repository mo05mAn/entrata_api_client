...
class TestGetTaxFormDataMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTaxFormDataMethod:
        """Test GetTaxFormDataMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxFormDataMethod`
        """
        model = GetTaxFormDataMethod()
        if include_optional:
    ...
    def testGetTaxFormDataMethod(self):
        """Test GetTaxFormDataMethod"""
