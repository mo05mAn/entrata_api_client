...
class TestGetLeadPickListsR1MethodParams(unittest.TestCase):
    """GetLeadPickListsR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1MethodParams:
        """Test GetLeadPickListsR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1MethodParams`
        """
        model = GetLeadPickListsR1MethodParams()
        if include_optional:
            return GetLeadPickListsR1MethodParams(
    ...
    def testGetLeadPickListsR1MethodParams(self):
        """Test GetLeadPickListsR1MethodParams"""
