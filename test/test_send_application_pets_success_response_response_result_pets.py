...
class TestSendApplicationPetsSuccessResponseResponseResultPets(unittest.TestCase):
    """SendApplicationPetsSuccessResponseResponseResultPets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationPetsSuccessResponseResponseResultPets:
        """Test SendApplicationPetsSuccessResponseResponseResultPets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationPetsSuccessResponseResponseResultPets`
        """
        model = SendApplicationPetsSuccessResponseResponseResultPets()
        if include_optional:
            return SendApplicationPetsSuccessResponseResponseResultPets(
                pet = [
    ...
    def testSendApplicationPetsSuccessResponseResponseResultPets(self):
        """Test SendApplicationPetsSuccessResponseResponseResultPets"""
