...
class TestMoveInLeaseMethod(unittest.TestCase):
    """MoveInLeaseMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoveInLeaseMethod:
        """Test MoveInLeaseMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveInLeaseMethod`
        """
        model = MoveInLeaseMethod()
        if include_optional:
            return MoveInLeaseMethod(
                name = 'moveInLease',
                version = 'r1',
    ...
    def testMoveInLeaseMethod(self):
        """Test MoveInLeaseMethod"""
