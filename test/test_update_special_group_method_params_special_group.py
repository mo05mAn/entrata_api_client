...
class TestUpdateSpecialGroupMethodParamsSpecialGroup(unittest.TestCase):
    """UpdateSpecialGroupMethodParamsSpecialGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSpecialGroupMethodParamsSpecialGroup:
        """Test UpdateSpecialGroupMethodParamsSpecialGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpecialGroupMethodParamsSpecialGroup`
        """
        model = UpdateSpecialGroupMethodParamsSpecialGroup()
        if include_optional:
            return UpdateSpecialGroupMethodParamsSpecialGroup(
    ...
    def testUpdateSpecialGroupMethodParamsSpecialGroup(self):
        """Test UpdateSpecialGroupMethodParamsSpecialGroup"""
