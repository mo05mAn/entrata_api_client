...
class TestGetApCodesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetApCodesMethod:
        """Test GetApCodesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApCodesMethod`
        """
        model = GetApCodesMethod()
        if include_optional:
