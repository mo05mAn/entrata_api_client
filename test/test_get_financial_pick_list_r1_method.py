...
class TestGetFinancialPickListR1Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1Method:
        """Test GetFinancialPickListR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1Method`
        """
        model = GetFinancialPickListR1Method()
        if include_optional:
    ...
    def testGetFinancialPickListR1Method(self):
        """Test GetFinancialPickListR1Method"""
