...
class TestSendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner:
        """Test SendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner`
        """
        model = SendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner()
        if include_optional:
            return SendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner(
                node = 1,
                status = 'Success',
    ...
    def testSendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner(self):
        """Test SendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner"""
