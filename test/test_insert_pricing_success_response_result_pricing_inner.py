...
class TestInsertPricingSuccessResponseResultPricingInner(unittest.TestCase):
    """InsertPricingSuccessResponseResultPricingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsertPricingSuccessResponseResultPricingInner:
        """Test InsertPricingSuccessResponseResultPricingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingSuccessResponseResultPricingInner`
        """
        model = InsertPricingSuccessResponseResultPricingInner()
        if include_optional:
            return InsertPricingSuccessResponseResultPricingInner(
                node = '1',
                reference_id = '391937229',
                status = 'Success',
                is_valid = 'Yes',
                message = 'Rate inserted/updated successfully.'
            )
        else:
            return InsertPricingSuccessResponseResultPricingInner(
                node = '1',
    ...
    def testInsertPricingSuccessResponseResultPricingInner(self):
        """Test InsertPricingSuccessResponseResultPricingInner"""
