...
class TestGetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInner:
        """Test GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInner`
        """
    ...
    def testGetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInner(self):
        """Test GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInner"""
