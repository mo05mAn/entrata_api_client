...
class TestSendLeaseArTransactionsSuccessResponseResponseResultTransactions(unittest.TestCase):
    """SendLeaseArTransactionsSuccessResponseResponseResultTransactions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionsSuccessResponseResponseResultTransactions:
        """Test SendLeaseArTransactionsSuccessResponseResponseResultTransactions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionsSuccessResponseResponseResultTransactions`
        """
        model = SendLeaseArTransactionsSuccessResponseResponseResultTransactions()
        if include_optional:
            return SendLeaseArTransactionsSuccessResponseResponseResultTransactions(
                transaction = [
    ...
    def testSendLeaseArTransactionsSuccessResponseResponseResultTransactions(self):
        """Test SendLeaseArTransactionsSuccessResponseResponseResultTransactions"""
