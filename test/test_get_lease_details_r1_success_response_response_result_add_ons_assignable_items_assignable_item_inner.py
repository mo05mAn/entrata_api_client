...
class TestGetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner(unittest.TestCase):
    """GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner()
        if include_optional:
            return GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner(
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner"""
