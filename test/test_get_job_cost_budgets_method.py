...
class TestGetJobCostBudgetsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetJobCostBudgetsMethod:
        """Test GetJobCostBudgetsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCostBudgetsMethod`
        """
        model = GetJobCostBudgetsMethod()
        if include_optional:
    ...
    def testGetJobCostBudgetsMethod(self):
        """Test GetJobCostBudgetsMethod"""
