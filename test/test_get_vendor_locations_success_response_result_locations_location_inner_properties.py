...
class TestGetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties:
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties`
        """
    ...
    def testGetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties(self):
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties"""
