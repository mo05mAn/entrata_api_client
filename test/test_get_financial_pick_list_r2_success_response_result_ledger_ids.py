...
class TestGetFinancialPickListR2SuccessResponseResultLedgerIds(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultLedgerIds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultLedgerIds:
        """Test GetFinancialPickListR2SuccessResponseResultLedgerIds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultLedgerIds`
        """
        model = GetFinancialPickListR2SuccessResponseResultLedgerIds()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultLedgerIds(
                ledger_id = [
    ...
    def testGetFinancialPickListR2SuccessResponseResultLedgerIds(self):
        """Test GetFinancialPickListR2SuccessResponseResultLedgerIds"""
