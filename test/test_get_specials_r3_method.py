...
class TestGetSpecialsR3Method(unittest.TestCase):
    """GetSpecialsR3Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3Method:
        """Test GetSpecialsR3Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3Method`
        """
        model = GetSpecialsR3Method()
        if include_optional:
            return GetSpecialsR3Method(
                name = '',
                version = 'r3',
    ...
    def testGetSpecialsR3Method(self):
        """Test GetSpecialsR3Method"""
