...
class TestUpdateInvoicesSuccessResponseResult(unittest.TestCase):
    """UpdateInvoicesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateInvoicesSuccessResponseResult:
        """Test UpdateInvoicesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateInvoicesSuccessResponseResult`
        """
        model = UpdateInvoicesSuccessResponseResult()
        if include_optional:
            return UpdateInvoicesSuccessResponseResult(
    ...
    def testUpdateInvoicesSuccessResponseResult(self):
        """Test UpdateInvoicesSuccessResponseResult"""
