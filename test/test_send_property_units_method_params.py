...
class TestSendPropertyUnitsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendPropertyUnitsMethodParams:
        """Test SendPropertyUnitsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPropertyUnitsMethodParams`
        """
        model = SendPropertyUnitsMethodParams()
        if include_optional:
            return SendPropertyUnitsMethodParams(
                unit_number = '20',
                unit_prefix = 'CC',
                unit_suffix = 'BB',
                space_number = 1,
    ...
    def testSendPropertyUnitsMethodParams(self):
        """Test SendPropertyUnitsMethodParams"""
