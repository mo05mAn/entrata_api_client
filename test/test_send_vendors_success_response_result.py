...
class TestSendVendorsSuccessResponseResult(unittest.TestCase):
    """SendVendorsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVendorsSuccessResponseResult:
        """Test SendVendorsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVendorsSuccessResponseResult`
        """
        model = SendVendorsSuccessResponseResult()
        if include_optional:
            return SendVendorsSuccessResponseResult(
    ...
    def testSendVendorsSuccessResponseResult(self):
        """Test SendVendorsSuccessResponseResult"""
