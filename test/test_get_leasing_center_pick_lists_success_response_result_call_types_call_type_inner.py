...
class TestGetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner(unittest.TestCase):
    """GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner:
        """Test GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner`
        """
        model = GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner()
        if include_optional:
            return GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner(
                id = '23',
    ...
    def testGetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner(self):
        """Test GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner"""
