...
class TestSendBudgetedRentSuccessResponseResultPricingInner(unittest.TestCase):
    """SendBudgetedRentSuccessResponseResultPricingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendBudgetedRentSuccessResponseResultPricingInner:
        """Test SendBudgetedRentSuccessResponseResultPricingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetedRentSuccessResponseResultPricingInner`
        """
        model = SendBudgetedRentSuccessResponseResultPricingInner()
        if include_optional:
            return SendBudgetedRentSuccessResponseResultPricingInner(
                node = 1,
                status = 'Success',
    ...
    def testSendBudgetedRentSuccessResponseResultPricingInner(self):
        """Test SendBudgetedRentSuccessResponseResultPricingInner"""
