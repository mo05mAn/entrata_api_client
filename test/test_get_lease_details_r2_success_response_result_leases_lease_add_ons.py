...
class TestGetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns(unittest.TestCase):
    """GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns:
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns`
        """
        model = GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns()
        if include_optional:
            return GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns(
    ...
    def testGetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns(self):
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns"""
