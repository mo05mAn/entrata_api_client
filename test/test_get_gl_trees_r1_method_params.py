...
class TestGetGlTreesR1MethodParams(unittest.TestCase):
    """GetGlTreesR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR1MethodParams:
        """Test GetGlTreesR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR1MethodParams`
        """
        model = GetGlTreesR1MethodParams()
        if include_optional:
            return GetGlTreesR1MethodParams(
                property_id = 123456,
                gl_tree_id = 1234,
                gl_branch_id = 1234,
                gl_group_type_id = 1,
    ...
    def testGetGlTreesR1MethodParams(self):
        """Test GetGlTreesR1MethodParams"""
