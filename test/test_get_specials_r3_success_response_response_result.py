...
class TestGetSpecialsR3SuccessResponseResponseResult(unittest.TestCase):
    """GetSpecialsR3SuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResult:
        """Test GetSpecialsR3SuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResult`
        """
        model = GetSpecialsR3SuccessResponseResponseResult()
        if include_optional:
            return GetSpecialsR3SuccessResponseResponseResult(
    ...
    def testGetSpecialsR3SuccessResponseResponseResult(self):
        """Test GetSpecialsR3SuccessResponseResponseResult"""
