...
class TestGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner:
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner`
        """
        model = GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner()
        if include_optional:
            return GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner(
    ...
    def testGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner(self):
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner"""
