...
class TestGetParcelAlertsSuccessResponseResponseResult(unittest.TestCase):
    """GetParcelAlertsSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetParcelAlertsSuccessResponseResponseResult:
        """Test GetParcelAlertsSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetParcelAlertsSuccessResponseResponseResult`
        """
        model = GetParcelAlertsSuccessResponseResponseResult()
        if include_optional:
            return GetParcelAlertsSuccessResponseResponseResult(
    ...
    def testGetParcelAlertsSuccessResponseResponseResult(self):
        """Test GetParcelAlertsSuccessResponseResponseResult"""
