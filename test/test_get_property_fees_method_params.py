...
class TestGetPropertyFeesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyFeesMethodParams:
        """Test GetPropertyFeesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyFeesMethodParams`
        """
        model = GetPropertyFeesMethodParams()
        if include_optional:
            return GetPropertyFeesMethodParams(
                property_id = '12345'
            )
        else:
            return GetPropertyFeesMethodParams(
    ...
    def testGetPropertyFeesMethodParams(self):
        """Test GetPropertyFeesMethodParams"""
