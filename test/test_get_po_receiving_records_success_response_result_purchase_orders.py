...
class TestGetPoReceivingRecordsSuccessResponseResultPurchaseOrders(unittest.TestCase):
    """GetPoReceivingRecordsSuccessResponseResultPurchaseOrders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPoReceivingRecordsSuccessResponseResultPurchaseOrders:
        """Test GetPoReceivingRecordsSuccessResponseResultPurchaseOrders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPoReceivingRecordsSuccessResponseResultPurchaseOrders`
        """
        model = GetPoReceivingRecordsSuccessResponseResultPurchaseOrders()
        if include_optional:
            return GetPoReceivingRecordsSuccessResponseResultPurchaseOrders(
    ...
    def testGetPoReceivingRecordsSuccessResponseResultPurchaseOrders(self):
        """Test GetPoReceivingRecordsSuccessResponseResultPurchaseOrders"""
