...
class TestGetMarketingPreferences(unittest.TestCase):
    """GetMarketingPreferences unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferences:
        """Test GetMarketingPreferences
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferences`
        """
        model = GetMarketingPreferences()
        if include_optional:
            return GetMarketingPreferences(
    ...
    def testGetMarketingPreferences(self):
        """Test GetMarketingPreferences"""
