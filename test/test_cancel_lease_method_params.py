...
class TestCancelLeaseMethodParams(unittest.TestCase):
    """CancelLeaseMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelLeaseMethodParams:
        """Test CancelLeaseMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelLeaseMethodParams`
        """
        model = CancelLeaseMethodParams()
        if include_optional:
            return CancelLeaseMethodParams(
                property_id = 123456,
                lease_id = 123
            )
        else:
    ...
    def testCancelLeaseMethodParams(self):
        """Test CancelLeaseMethodParams"""
