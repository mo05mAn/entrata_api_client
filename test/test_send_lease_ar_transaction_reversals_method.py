...
class TestSendLeaseArTransactionReversalsMethod(unittest.TestCase):
    """SendLeaseArTransactionReversalsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionReversalsMethod:
        """Test SendLeaseArTransactionReversalsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionReversalsMethod`
        """
        model = SendLeaseArTransactionReversalsMethod()
        if include_optional:
            return SendLeaseArTransactionReversalsMethod(
    ...
    def testSendLeaseArTransactionReversalsMethod(self):
        """Test SendLeaseArTransactionReversalsMethod"""
