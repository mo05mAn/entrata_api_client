...
class TestSendSpecialGroupMethodParams(unittest.TestCase):
    """SendSpecialGroupMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSpecialGroupMethodParams:
        """Test SendSpecialGroupMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSpecialGroupMethodParams`
        """
        model = SendSpecialGroupMethodParams()
        if include_optional:
            return SendSpecialGroupMethodParams(
                property_id = '123456',
    ...
    def testSendSpecialGroupMethodParams(self):
        """Test SendSpecialGroupMethodParams"""
