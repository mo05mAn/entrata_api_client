...
class TestGetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes:
        """Test GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes(
                id = '80',
                name = '100 Packing',
                type = 'Area'
            )
    ...
    def testGetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes"""
