...
class TestGetLeaseArTransactionsSuccessResponseResponseResult(unittest.TestCase):
    """GetLeaseArTransactionsSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseArTransactionsSuccessResponseResponseResult:
        """Test GetLeaseArTransactionsSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseArTransactionsSuccessResponseResponseResult`
        """
        model = GetLeaseArTransactionsSuccessResponseResponseResult()
        if include_optional:
            return GetLeaseArTransactionsSuccessResponseResponseResult(
    ...
    def testGetLeaseArTransactionsSuccessResponseResponseResult(self):
        """Test GetLeaseArTransactionsSuccessResponseResponseResult"""
