...
class TestGetPricingPicklistsSuccessResponseResponseResultChargeTimings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResultChargeTimings:
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeTimings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResultChargeTimings`
        """
        model = GetPricingPicklistsSuccessResponseResponseResultChargeTimings()
        if include_optional:
    ...
    def testGetPricingPicklistsSuccessResponseResponseResultChargeTimings(self):
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeTimings"""
