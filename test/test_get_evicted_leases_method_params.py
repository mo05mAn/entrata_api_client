...
class TestGetEvictedLeasesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetEvictedLeasesMethodParams:
        """Test GetEvictedLeasesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEvictedLeasesMethodParams`
        """
        model = GetEvictedLeasesMethodParams()
        if include_optional:
            return GetEvictedLeasesMethodParams(
                property_id = 123456,
    ...
    def testGetEvictedLeasesMethodParams(self):
        """Test GetEvictedLeasesMethodParams"""
