...
class TestGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner(unittest.TestCase):
    """GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner:
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner`
        """
        model = GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner()
        if include_optional:
            return GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner(
                id = 12345,
                name = 'Master GL Tree',
                is_master_gl_tree = 1,
    ...
    def testGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner(self):
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner"""
