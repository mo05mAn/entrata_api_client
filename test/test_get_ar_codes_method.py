...
class TestGetArCodesMethod(unittest.TestCase):
    """GetArCodesMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetArCodesMethod:
        """Test GetArCodesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArCodesMethod`
        """
        model = GetArCodesMethod()
        if include_optional:
            return GetArCodesMethod(
                name = 'getArCodes',
                version = 'r1',
