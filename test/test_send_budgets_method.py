...
class TestSendBudgetsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendBudgetsMethod:
        """Test SendBudgetsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetsMethod`
        """
        model = SendBudgetsMethod()
        if include_optional:
    ...
    def testSendBudgetsMethod(self):
        """Test SendBudgetsMethod"""
