...
class TestGetReservableAmenitiesSuccessResponseResultAmenities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesSuccessResponseResultAmenities:
        """Test GetReservableAmenitiesSuccessResponseResultAmenities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservableAmenitiesSuccessResponseResultAmenities`
        """
        model = GetReservableAmenitiesSuccessResponseResultAmenities()
        if include_optional:
    ...
    def testGetReservableAmenitiesSuccessResponseResultAmenities(self):
        """Test GetReservableAmenitiesSuccessResponseResultAmenities"""
