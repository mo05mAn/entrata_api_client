...
class TestApplyQuoteMethod(unittest.TestCase):
    """ApplyQuoteMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplyQuoteMethod:
        """Test ApplyQuoteMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplyQuoteMethod`
        """
        model = ApplyQuoteMethod()
        if include_optional:
            return ApplyQuoteMethod(
                name = 'applyQuote',
                version = 'r1'
            )
        else:
