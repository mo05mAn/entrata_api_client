...
class TestGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerConcessionInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerConcessionInner:
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerConcessionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerConcessionInner`
        """
    ...
    def testGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerConcessionInner(self):
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerConcessionInner"""
