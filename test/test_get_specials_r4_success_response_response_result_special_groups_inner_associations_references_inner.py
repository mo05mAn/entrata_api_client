...
class TestGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner(unittest.TestCase):
    """GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner:
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner`
        """
        model = GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner()
        if include_optional:
            return GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner(
                id = '7777777',
                name = 'PQR'
            )
        else:
    ...
    def testGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner(self):
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner"""
