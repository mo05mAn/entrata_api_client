...
class TestGetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes:
        """Test GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes`
        """
        model = GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes(
                id = '21',
    ...
    def testGetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes(self):
        """Test GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes"""
