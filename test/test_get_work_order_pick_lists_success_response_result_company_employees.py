...
class TestGetWorkOrderPickListsSuccessResponseResultCompanyEmployees(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultCompanyEmployees:
        """Test GetWorkOrderPickListsSuccessResponseResultCompanyEmployees
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultCompanyEmployees`
        """
        model = GetWorkOrderPickListsSuccessResponseResultCompanyEmployees()
        if include_optional:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultCompanyEmployees(self):
        """Test GetWorkOrderPickListsSuccessResponseResultCompanyEmployees"""
