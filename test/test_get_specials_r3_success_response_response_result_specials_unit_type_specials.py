...
class TestGetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecials(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecials:
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecials`
        """
        model = GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecials()
        if include_optional:
    ...
    def testGetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecials(self):
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecials"""
