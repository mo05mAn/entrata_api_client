...
class TestGetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems()
        if include_optional:
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems"""
