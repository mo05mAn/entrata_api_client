...
class TestSendLeasesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeasesMethod:
        """Test SendLeasesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeasesMethod`
        """
        model = SendLeasesMethod()
        if include_optional:
