...
class TestGetLeadPickListsR1SuccessResponseResponseResultLeadStatuses(unittest.TestCase):
    """GetLeadPickListsR1SuccessResponseResponseResultLeadStatuses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1SuccessResponseResponseResultLeadStatuses:
        """Test GetLeadPickListsR1SuccessResponseResponseResultLeadStatuses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1SuccessResponseResponseResultLeadStatuses`
        """
        model = GetLeadPickListsR1SuccessResponseResponseResultLeadStatuses()
        if include_optional:
            return GetLeadPickListsR1SuccessResponseResponseResultLeadStatuses(
                lead_status = [
    ...
    def testGetLeadPickListsR1SuccessResponseResponseResultLeadStatuses(self):
        """Test GetLeadPickListsR1SuccessResponseResponseResultLeadStatuses"""
