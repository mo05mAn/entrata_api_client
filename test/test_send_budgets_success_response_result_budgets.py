...
class TestSendBudgetsSuccessResponseResultBudgets(unittest.TestCase):
    """SendBudgetsSuccessResponseResultBudgets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendBudgetsSuccessResponseResultBudgets:
        """Test SendBudgetsSuccessResponseResultBudgets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetsSuccessResponseResultBudgets`
        """
        model = SendBudgetsSuccessResponseResultBudgets()
        if include_optional:
            return SendBudgetsSuccessResponseResultBudgets(
                budget = [
    ...
    def testSendBudgetsSuccessResponseResultBudgets(self):
        """Test SendBudgetsSuccessResponseResultBudgets"""
