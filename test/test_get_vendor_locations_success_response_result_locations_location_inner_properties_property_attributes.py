...
class TestGetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes(unittest.TestCase):
    """GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes:
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes`
        """
        model = GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes()
        if include_optional:
            return GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes(
                id = '19463',
                name = '22 Exchange'
            )
        else:
    ...
    def testGetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes(self):
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes"""
