...
class TestSendLeaseActivitiesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeaseActivitiesMethod:
        """Test SendLeaseActivitiesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseActivitiesMethod`
        """
        model = SendLeaseActivitiesMethod()
        if include_optional:
    ...
    def testSendLeaseActivitiesMethod(self):
        """Test SendLeaseActivitiesMethod"""
