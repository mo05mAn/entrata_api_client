...
class TestGetLeadPickListsR2Method(unittest.TestCase):
    """GetLeadPickListsR2Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2Method:
        """Test GetLeadPickListsR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2Method`
        """
        model = GetLeadPickListsR2Method()
        if include_optional:
            return GetLeadPickListsR2Method(
                name = '',
                version = 'r2',
    ...
    def testGetLeadPickListsR2Method(self):
        """Test GetLeadPickListsR2Method"""
