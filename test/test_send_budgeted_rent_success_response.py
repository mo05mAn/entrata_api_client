...
class TestSendBudgetedRentSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendBudgetedRentSuccessResponse:
        """Test SendBudgetedRentSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetedRentSuccessResponse`
        """
        model = SendBudgetedRentSuccessResponse()
        if include_optional:
    ...
    def testSendBudgetedRentSuccessResponse(self):
        """Test SendBudgetedRentSuccessResponse"""
