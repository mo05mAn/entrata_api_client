...
class TestSendJournalEntries(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendJournalEntries:
        """Test SendJournalEntries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendJournalEntries`
        """
    ...
    def testSendJournalEntries(self):
        """Test SendJournalEntries"""
