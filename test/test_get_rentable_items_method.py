...
class TestGetRentableItemsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetRentableItemsMethod:
        """Test GetRentableItemsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentableItemsMethod`
        """
        model = GetRentableItemsMethod()
        if include_optional:
    ...
    def testGetRentableItemsMethod(self):
        """Test GetRentableItemsMethod"""
