...
class TestGetPoReceivingRecordsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPoReceivingRecordsMethod:
        """Test GetPoReceivingRecordsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPoReceivingRecordsMethod`
        """
        model = GetPoReceivingRecordsMethod()
        if include_optional:
    ...
    def testGetPoReceivingRecordsMethod(self):
        """Test GetPoReceivingRecordsMethod"""
