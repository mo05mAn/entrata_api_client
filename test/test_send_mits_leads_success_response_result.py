...
class TestSendMitsLeadsSuccessResponseResult(unittest.TestCase):
    """SendMitsLeadsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMitsLeadsSuccessResponseResult:
        """Test SendMitsLeadsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMitsLeadsSuccessResponseResult`
        """
        model = SendMitsLeadsSuccessResponseResult()
        if include_optional:
            return SendMitsLeadsSuccessResponseResult(
    ...
    def testSendMitsLeadsSuccessResponseResult(self):
        """Test SendMitsLeadsSuccessResponseResult"""
