...
class TestGetApCodesSuccessResponseResultApCodeCategories(unittest.TestCase):
    """GetApCodesSuccessResponseResultApCodeCategories unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetApCodesSuccessResponseResultApCodeCategories:
        """Test GetApCodesSuccessResponseResultApCodeCategories
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApCodesSuccessResponseResultApCodeCategories`
        """
        model = GetApCodesSuccessResponseResultApCodeCategories()
        if include_optional:
            return GetApCodesSuccessResponseResultApCodeCategories(
                ap_code_category = [
    ...
    def testGetApCodesSuccessResponseResultApCodeCategories(self):
        """Test GetApCodesSuccessResponseResultApCodeCategories"""
