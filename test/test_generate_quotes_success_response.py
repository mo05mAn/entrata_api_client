...
class TestGenerateQuotesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GenerateQuotesSuccessResponse:
        """Test GenerateQuotesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateQuotesSuccessResponse`
        """
        model = GenerateQuotesSuccessResponse()
        if include_optional:
    ...
    def testGenerateQuotesSuccessResponse(self):
        """Test GenerateQuotesSuccessResponse"""
