...
class TestGetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity:
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity(
                name = 'Unit Amenity 1',
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity"""
