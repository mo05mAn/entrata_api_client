...
class TestGetLeadPickListsR2SuccessResponseResultLeadStatuses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultLeadStatuses:
        """Test GetLeadPickListsR2SuccessResponseResultLeadStatuses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultLeadStatuses`
        """
        model = GetLeadPickListsR2SuccessResponseResultLeadStatuses()
        if include_optional:
    ...
    def testGetLeadPickListsR2SuccessResponseResultLeadStatuses(self):
        """Test GetLeadPickListsR2SuccessResponseResultLeadStatuses"""
