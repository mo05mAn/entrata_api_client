...
class TestGetArInvoicesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetArInvoicesMethodParams:
        """Test GetArInvoicesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArInvoicesMethodParams`
        """
        model = GetArInvoicesMethodParams()
        if include_optional:
            return GetArInvoicesMethodParams(
                property_id = 123456,
                lease_ids = '123456',
    ...
    def testGetArInvoicesMethodParams(self):
        """Test GetArInvoicesMethodParams"""
