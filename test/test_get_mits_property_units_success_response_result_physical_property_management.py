...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement(unittest.TestCase):
    """GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement(
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement"""
