...
class TestSendApplicationPetsSuccessResponseResponseResultPetsPetInner(unittest.TestCase):
    """SendApplicationPetsSuccessResponseResponseResultPetsPetInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationPetsSuccessResponseResponseResultPetsPetInner:
        """Test SendApplicationPetsSuccessResponseResponseResultPetsPetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationPetsSuccessResponseResponseResultPetsPetInner`
        """
        model = SendApplicationPetsSuccessResponseResponseResultPetsPetInner()
        if include_optional:
            return SendApplicationPetsSuccessResponseResponseResultPetsPetInner(
                status = 'Success',
                message = 'Customer pets saved successfully.',
                id = 205354,
                customer_id = 31674581,
                type_id = 15288,
                node = 1
            )
        else:
    ...
    def testSendApplicationPetsSuccessResponseResponseResultPetsPetInner(self):
        """Test SendApplicationPetsSuccessResponseResponseResultPetsPetInner"""
