...
class TestGetPropertyAddOnsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyAddOnsMethodParams:
        """Test GetPropertyAddOnsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAddOnsMethodParams`
        """
        model = GetPropertyAddOnsMethodParams()
        if include_optional:
            return GetPropertyAddOnsMethodParams(
                property_id = 12345
            )
        else:
            return GetPropertyAddOnsMethodParams(
    ...
    def testGetPropertyAddOnsMethodParams(self):
        """Test GetPropertyAddOnsMethodParams"""
