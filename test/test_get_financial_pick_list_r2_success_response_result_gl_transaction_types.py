...
class TestGetFinancialPickListR2SuccessResponseResultGlTransactionTypes(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlTransactionTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlTransactionTypes:
        """Test GetFinancialPickListR2SuccessResponseResultGlTransactionTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlTransactionTypes`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlTransactionTypes()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlTransactionTypes(
                gl_transaction_type = [
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlTransactionTypes(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlTransactionTypes"""
