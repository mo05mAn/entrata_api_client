...
class TestSendMitsLeadsSuccessResponseResultProspects(unittest.TestCase):
    """SendMitsLeadsSuccessResponseResultProspects unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMitsLeadsSuccessResponseResultProspects:
        """Test SendMitsLeadsSuccessResponseResultProspects
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMitsLeadsSuccessResponseResultProspects`
        """
        model = SendMitsLeadsSuccessResponseResultProspects()
        if include_optional:
            return SendMitsLeadsSuccessResponseResultProspects(
                prospect = [
    ...
    def testSendMitsLeadsSuccessResponseResultProspects(self):
        """Test SendMitsLeadsSuccessResponseResultProspects"""
