...
class TestGetVendorsSuccessResponse(unittest.TestCase):
    """GetVendorsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponse:
        """Test GetVendorsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponse`
        """
        model = GetVendorsSuccessResponse()
        if include_optional:
            return GetVendorsSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_vendors_success_response_result.getVendorsSuccessResponse_result(
    ...
    def testGetVendorsSuccessResponse(self):
        """Test GetVendorsSuccessResponse"""
