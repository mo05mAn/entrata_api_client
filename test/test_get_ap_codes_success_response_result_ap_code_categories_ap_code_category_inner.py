...
class TestGetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner(unittest.TestCase):
    """GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner:
        """Test GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner`
        """
        model = GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner()
        if include_optional:
            return GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner(
                id = '1234',
                name = 'ap category 1',
    ...
    def testGetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner(self):
        """Test GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner"""
