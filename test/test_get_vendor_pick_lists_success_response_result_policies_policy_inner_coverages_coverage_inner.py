...
class TestGetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner:
        """Test GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner`
        """
        model = GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner(
                id = '12',
    ...
    def testGetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner(self):
        """Test GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner"""
