...
class TestGetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes:
        """Test GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes`
        """
        model = GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes(
                name = 'Application',
                id = '131',
    ...
    def testGetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes(self):
        """Test GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes"""
