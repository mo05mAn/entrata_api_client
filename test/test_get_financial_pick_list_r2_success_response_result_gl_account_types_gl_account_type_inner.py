...
class TestGetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner(
                id = 201,
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner"""
