...
class TestSendApplicationMethodParams(unittest.TestCase):
    """SendApplicationMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationMethodParams:
        """Test SendApplicationMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationMethodParams`
        """
        model = SendApplicationMethodParams()
        if include_optional:
            return SendApplicationMethodParams(
                property_id = 123456,
    ...
    def testSendApplicationMethodParams(self):
        """Test SendApplicationMethodParams"""
