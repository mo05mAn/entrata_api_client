...
class TestGetCalendarAvailabilityR2SuccessResponseResponseResult(unittest.TestCase):
    """GetCalendarAvailabilityR2SuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR2SuccessResponseResponseResult:
        """Test GetCalendarAvailabilityR2SuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR2SuccessResponseResponseResult`
        """
        model = GetCalendarAvailabilityR2SuccessResponseResponseResult()
        if include_optional:
            return GetCalendarAvailabilityR2SuccessResponseResponseResult(
    ...
    def testGetCalendarAvailabilityR2SuccessResponseResponseResult(self):
        """Test GetCalendarAvailabilityR2SuccessResponseResponseResult"""
