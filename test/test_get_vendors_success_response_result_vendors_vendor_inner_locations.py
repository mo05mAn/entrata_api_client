...
class TestGetVendorsSuccessResponseResultVendorsVendorInnerLocations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendorsVendorInnerLocations:
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerLocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendorsVendorInnerLocations`
        """
        model = GetVendorsSuccessResponseResultVendorsVendorInnerLocations()
        if include_optional:
    ...
    def testGetVendorsSuccessResponseResultVendorsVendorInnerLocations(self):
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerLocations"""
