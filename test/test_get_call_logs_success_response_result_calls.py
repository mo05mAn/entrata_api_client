...
class TestGetCallLogsSuccessResponseResultCalls(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCallLogsSuccessResponseResultCalls:
        """Test GetCallLogsSuccessResponseResultCalls
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCallLogsSuccessResponseResultCalls`
        """
        model = GetCallLogsSuccessResponseResultCalls()
        if include_optional:
    ...
    def testGetCallLogsSuccessResponseResultCalls(self):
        """Test GetCallLogsSuccessResponseResultCalls"""
