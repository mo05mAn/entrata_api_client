...
class TestGetCustomersMethodParams(unittest.TestCase):
    """GetCustomersMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomersMethodParams:
        """Test GetCustomersMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersMethodParams`
        """
        model = GetCustomersMethodParams()
        if include_optional:
            return GetCustomersMethodParams(
                property_id = 123456,
                customer_ids = '1234,5678,9865',
                lease_status_type_ids = '1,2',
                is_agreed_to_terms_only = False,
                company_identification_type_ids = 123456
            )
        else:
            return GetCustomersMethodParams(
                property_id = 123456,
    ...
    def testGetCustomersMethodParams(self):
        """Test GetCustomersMethodParams"""
