...
class TestGetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner:
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner`
        """
        model = GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner()
        if include_optional:
            return GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner(
                id = 31061984,
    ...
    def testGetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner(self):
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner"""
