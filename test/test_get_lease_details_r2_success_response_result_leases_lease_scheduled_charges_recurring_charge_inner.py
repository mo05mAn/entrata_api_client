...
class TestGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner(unittest.TestCase):
    """GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner:
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner`
        """
        model = GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner()
        if include_optional:
            return GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner(
    ...
    def testGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner(self):
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner"""
