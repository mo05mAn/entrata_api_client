...
class TestGetPoReceivingRecords(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPoReceivingRecords:
        """Test GetPoReceivingRecords
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPoReceivingRecords`
        """
    ...
    def testGetPoReceivingRecords(self):
        """Test GetPoReceivingRecords"""
