...
class TestGetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes(unittest.TestCase):
    """GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes:
        """Test GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes`
        """
        model = GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes()
        if include_optional:
            return GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes(
                id = 1,
                name = 'Property'
            )
        else:
    ...
    def testGetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes(self):
        """Test GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes"""
