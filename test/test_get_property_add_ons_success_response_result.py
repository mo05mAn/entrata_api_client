...
class TestGetPropertyAddOnsSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyAddOnsSuccessResponseResult:
        """Test GetPropertyAddOnsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAddOnsSuccessResponseResult`
        """
        model = GetPropertyAddOnsSuccessResponseResult()
        if include_optional:
    ...
    def testGetPropertyAddOnsSuccessResponseResult(self):
        """Test GetPropertyAddOnsSuccessResponseResult"""
