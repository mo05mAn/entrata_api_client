...
class TestUpdateInvoicesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateInvoicesSuccessResponse:
        """Test UpdateInvoicesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateInvoicesSuccessResponse`
        """
    ...
    def testUpdateInvoicesSuccessResponse(self):
        """Test UpdateInvoicesSuccessResponse"""
