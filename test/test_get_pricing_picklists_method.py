...
class TestGetPricingPicklistsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsMethod:
        """Test GetPricingPicklistsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsMethod`
        """
        model = GetPricingPicklistsMethod()
        if include_optional:
            return GetPricingPicklistsMethod(
    ...
    def testGetPricingPicklistsMethod(self):
        """Test GetPricingPicklistsMethod"""
