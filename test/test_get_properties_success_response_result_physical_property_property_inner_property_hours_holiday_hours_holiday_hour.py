...
class TestGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour(unittest.TestCase):
    """GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour:
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour`
        """
        model = GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour()
        if include_optional:
            return GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour(
                name = 'Columbus Day',
                var_date = '10/08/2018'
            )
        else:
    ...
    def testGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour(self):
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour"""
