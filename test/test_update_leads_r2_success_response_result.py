...
class TestUpdateLeadsR2SuccessResponseResult(unittest.TestCase):
    """UpdateLeadsR2SuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLeadsR2SuccessResponseResult:
        """Test UpdateLeadsR2SuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeadsR2SuccessResponseResult`
        """
        model = UpdateLeadsR2SuccessResponseResult()
        if include_optional:
            return UpdateLeadsR2SuccessResponseResult(
                prospects = [
    ...
    def testUpdateLeadsR2SuccessResponseResult(self):
        """Test UpdateLeadsR2SuccessResponseResult"""
