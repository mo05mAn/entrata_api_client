...
class TestGetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner(
                id = 1,
                name = 'Posted'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner"""
