...
class TestGetPropertyAnnouncementsSuccessResponseResultAnnouncements(unittest.TestCase):
    """GetPropertyAnnouncementsSuccessResponseResultAnnouncements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyAnnouncementsSuccessResponseResultAnnouncements:
        """Test GetPropertyAnnouncementsSuccessResponseResultAnnouncements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAnnouncementsSuccessResponseResultAnnouncements`
        """
        model = GetPropertyAnnouncementsSuccessResponseResultAnnouncements()
        if include_optional:
            return GetPropertyAnnouncementsSuccessResponseResultAnnouncements(
                announcement = [
    ...
    def testGetPropertyAnnouncementsSuccessResponseResultAnnouncements(self):
        """Test GetPropertyAnnouncementsSuccessResponseResultAnnouncements"""
