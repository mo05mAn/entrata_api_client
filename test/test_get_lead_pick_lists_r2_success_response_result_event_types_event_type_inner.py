...
class TestGetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner:
        """Test GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner`
        """
        model = GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner(
    ...
    def testGetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner(self):
        """Test GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner"""
