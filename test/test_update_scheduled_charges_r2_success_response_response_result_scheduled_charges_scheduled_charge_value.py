...
class TestUpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValue(unittest.TestCase):
    """UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValue:
        """Test UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValue`
        """
        model = UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValue()
        if include_optional:
            return UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValue(
    ...
    def testUpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValue(self):
        """Test UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValue"""
