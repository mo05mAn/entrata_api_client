...
class TestGetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours(unittest.TestCase):
    """GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours:
        """Test GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours`
        """
        model = GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours()
        if include_optional:
            return GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours(
                available_tour = [
    ...
    def testGetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours(self):
        """Test GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours"""
