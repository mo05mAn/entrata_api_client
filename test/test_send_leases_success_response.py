...
class TestSendLeasesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeasesSuccessResponse:
        """Test SendLeasesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeasesSuccessResponse`
        """
        model = SendLeasesSuccessResponse()
        if include_optional:
    ...
    def testSendLeasesSuccessResponse(self):
        """Test SendLeasesSuccessResponse"""
