...
class TestSendLeaseDocumentsRequestBodyMethodParamsFilesFileInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeaseDocumentsRequestBodyMethodParamsFilesFileInner:
        """Test SendLeaseDocumentsRequestBodyMethodParamsFilesFileInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseDocumentsRequestBodyMethodParamsFilesFileInner`
        """
        model = SendLeaseDocumentsRequestBodyMethodParamsFilesFileInner()
        if include_optional:
            return SendLeaseDocumentsRequestBodyMethodParamsFilesFileInner(
                file_name = 'lease.pdf',
                lease_file_type = 'POI',
                file_type_id = 12345,
    ...
    def testSendLeaseDocumentsRequestBodyMethodParamsFilesFileInner(self):
        """Test SendLeaseDocumentsRequestBodyMethodParamsFilesFileInner"""
