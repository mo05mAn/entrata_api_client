...
class TestGetLeasePickListSuccessResponseResultChargeCodeTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultChargeCodeTypes:
        """Test GetLeasePickListSuccessResponseResultChargeCodeTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultChargeCodeTypes`
        """
        model = GetLeasePickListSuccessResponseResultChargeCodeTypes()
        if include_optional:
    ...
    def testGetLeasePickListSuccessResponseResultChargeCodeTypes(self):
        """Test GetLeasePickListSuccessResponseResultChargeCodeTypes"""
