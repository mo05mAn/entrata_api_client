...
class TestGetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner(unittest.TestCase):
    """GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner:
        """Test GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner`
        """
        model = GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner()
        if include_optional:
            return GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner(
                id = 2,
                name = 'Rent',
    ...
    def testGetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner(self):
        """Test GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner"""
