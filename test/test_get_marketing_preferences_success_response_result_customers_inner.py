...
class TestGetMarketingPreferencesSuccessResponseResultCustomersInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencesSuccessResponseResultCustomersInner:
        """Test GetMarketingPreferencesSuccessResponseResultCustomersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencesSuccessResponseResultCustomersInner`
        """
        model = GetMarketingPreferencesSuccessResponseResultCustomersInner()
        if include_optional:
    ...
    def testGetMarketingPreferencesSuccessResponseResultCustomersInner(self):
        """Test GetMarketingPreferencesSuccessResponseResultCustomersInner"""
