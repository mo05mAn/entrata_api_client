...
class TestSendJournalEntriesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendJournalEntriesSuccessResponse:
        """Test SendJournalEntriesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendJournalEntriesSuccessResponse`
        """
        model = SendJournalEntriesSuccessResponse()
        if include_optional:
    ...
    def testSendJournalEntriesSuccessResponse(self):
        """Test SendJournalEntriesSuccessResponse"""
