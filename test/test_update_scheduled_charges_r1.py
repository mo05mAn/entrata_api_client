...
class TestUpdateScheduledChargesR1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR1:
        """Test UpdateScheduledChargesR1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR1`
        """
    ...
    def testUpdateScheduledChargesR1(self):
        """Test UpdateScheduledChargesR1"""
