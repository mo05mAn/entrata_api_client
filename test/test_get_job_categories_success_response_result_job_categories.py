...
class TestGetJobCategoriesSuccessResponseResultJobCategories(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetJobCategoriesSuccessResponseResultJobCategories:
        """Test GetJobCategoriesSuccessResponseResultJobCategories
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCategoriesSuccessResponseResultJobCategories`
        """
        model = GetJobCategoriesSuccessResponseResultJobCategories()
        if include_optional:
    ...
    def testGetJobCategoriesSuccessResponseResultJobCategories(self):
        """Test GetJobCategoriesSuccessResponseResultJobCategories"""
