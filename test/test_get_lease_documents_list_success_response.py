...
class TestGetLeaseDocumentsListSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsListSuccessResponse:
        """Test GetLeaseDocumentsListSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsListSuccessResponse`
        """
        model = GetLeaseDocumentsListSuccessResponse()
        if include_optional:
    ...
    def testGetLeaseDocumentsListSuccessResponse(self):
        """Test GetLeaseDocumentsListSuccessResponse"""
