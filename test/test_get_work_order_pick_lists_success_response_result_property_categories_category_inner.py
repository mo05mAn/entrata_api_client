...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner(
                id = '91983',
                name = 'demo'
            )
        else:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner"""
