...
class TestSendApplicantGeneralDetailsMethodParams(unittest.TestCase):
    """SendApplicantGeneralDetailsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicantGeneralDetailsMethodParams:
        """Test SendApplicantGeneralDetailsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicantGeneralDetailsMethodParams`
        """
        model = SendApplicantGeneralDetailsMethodParams()
        if include_optional:
            return SendApplicantGeneralDetailsMethodParams(
    ...
    def testSendApplicantGeneralDetailsMethodParams(self):
        """Test SendApplicantGeneralDetailsMethodParams"""
