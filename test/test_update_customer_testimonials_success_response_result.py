...
class TestUpdateCustomerTestimonialsSuccessResponseResult(unittest.TestCase):
    """UpdateCustomerTestimonialsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCustomerTestimonialsSuccessResponseResult:
        """Test UpdateCustomerTestimonialsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomerTestimonialsSuccessResponseResult`
        """
        model = UpdateCustomerTestimonialsSuccessResponseResult()
        if include_optional:
            return UpdateCustomerTestimonialsSuccessResponseResult(
    ...
    def testUpdateCustomerTestimonialsSuccessResponseResult(self):
        """Test UpdateCustomerTestimonialsSuccessResponseResult"""
