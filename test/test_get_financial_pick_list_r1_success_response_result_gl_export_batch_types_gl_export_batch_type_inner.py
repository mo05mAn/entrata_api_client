...
class TestGetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner(
                id = 88,
                name = 'AMSI'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner"""
