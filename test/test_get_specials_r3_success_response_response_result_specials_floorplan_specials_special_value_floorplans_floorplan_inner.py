...
class TestGetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner(unittest.TestCase):
    """GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner:
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner`
        """
        model = GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner()
        if include_optional:
            return GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner(
                id = '935877',
    ...
    def testGetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner(self):
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner"""
