...
class TestSendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner(unittest.TestCase):
    """SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner:
        """Test SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner`
        """
        model = SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner()
        if include_optional:
            return SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner(
                status = 'Success',
                message = 'Vehicle saved successfully.',
                id = 56853778,
                customer_id = 28138538,
                vehicle_type_id = 2,
                node = 1
            )
        else:
    ...
    def testSendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner(self):
        """Test SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner"""
