...
class TestGetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial(unittest.TestCase):
    """GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial:
        """Test GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial`
        """
        model = GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial()
        if include_optional:
            return GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial(
                id = '12015762',
                name = 'TestFloorPlan',
    ...
    def testGetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial(self):
        """Test GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial"""
