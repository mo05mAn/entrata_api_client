...
class TestGetGlTreesR2SuccessResponseResponse(unittest.TestCase):
    """GetGlTreesR2SuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR2SuccessResponseResponse:
        """Test GetGlTreesR2SuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR2SuccessResponseResponse`
        """
        model = GetGlTreesR2SuccessResponseResponse()
        if include_optional:
            return GetGlTreesR2SuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testGetGlTreesR2SuccessResponseResponse(self):
        """Test GetGlTreesR2SuccessResponseResponse"""
