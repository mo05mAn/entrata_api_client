...
class TestUpdatePropertyResponseMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdatePropertyResponseMethodParams:
        """Test UpdatePropertyResponseMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyResponseMethodParams`
        """
        model = UpdatePropertyResponseMethodParams()
        if include_optional:
            return UpdatePropertyResponseMethodParams(
                property_id = 123456,
    ...
    def testUpdatePropertyResponseMethodParams(self):
        """Test UpdatePropertyResponseMethodParams"""
