...
class TestGetFinancialPickListR2SuccessResponseResultGlTreeTypes(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlTreeTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlTreeTypes:
        """Test GetFinancialPickListR2SuccessResponseResultGlTreeTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlTreeTypes`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlTreeTypes()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlTreeTypes(
                gl_tree_type = [
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlTreeTypes(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlTreeTypes"""
