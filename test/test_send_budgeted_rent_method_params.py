...
class TestSendBudgetedRentMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendBudgetedRentMethodParams:
        """Test SendBudgetedRentMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetedRentMethodParams`
        """
        model = SendBudgetedRentMethodParams()
        if include_optional:
            return SendBudgetedRentMethodParams(
                property_id = 4,
    ...
    def testSendBudgetedRentMethodParams(self):
        """Test SendBudgetedRentMethodParams"""
