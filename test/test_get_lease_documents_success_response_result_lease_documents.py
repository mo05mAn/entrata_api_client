...
class TestGetLeaseDocumentsSuccessResponseResultLeaseDocuments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsSuccessResponseResultLeaseDocuments:
        """Test GetLeaseDocumentsSuccessResponseResultLeaseDocuments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsSuccessResponseResultLeaseDocuments`
        """
        model = GetLeaseDocumentsSuccessResponseResultLeaseDocuments()
        if include_optional:
    ...
    def testGetLeaseDocumentsSuccessResponseResultLeaseDocuments(self):
        """Test GetLeaseDocumentsSuccessResponseResultLeaseDocuments"""
