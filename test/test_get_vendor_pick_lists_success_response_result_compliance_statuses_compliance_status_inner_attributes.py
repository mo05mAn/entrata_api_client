...
class TestGetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes:
        """Test GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes(
                id = '5',
                name = 'Compliant'
            )
        else:
    ...
    def testGetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes"""
