...
class TestErrorResponseResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ErrorResponseResponseError:
        """Test ErrorResponseResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorResponseResponseError`
        """
        model = ErrorResponseResponseError()
        if include_optional:
            return ErrorResponseResponseError(
                code = 56,
                message = ''
            )
        else:
    ...
    def testErrorResponseResponseError(self):
        """Test ErrorResponseResponseError"""
