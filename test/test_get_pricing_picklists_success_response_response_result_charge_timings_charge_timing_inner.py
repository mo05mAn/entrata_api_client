...
class TestGetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner:
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner`
        """
    ...
    def testGetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner(self):
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner"""
