...
class TestGetBudgetActualsSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBudgetActualsSuccessResponse:
        """Test GetBudgetActualsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBudgetActualsSuccessResponse`
        """
        model = GetBudgetActualsSuccessResponse()
        if include_optional:
    ...
    def testGetBudgetActualsSuccessResponse(self):
        """Test GetBudgetActualsSuccessResponse"""
