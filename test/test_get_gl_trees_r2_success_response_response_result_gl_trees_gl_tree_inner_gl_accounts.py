...
class TestGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts(unittest.TestCase):
    """GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts:
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts`
        """
        model = GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts()
        if include_optional:
            return GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts(
                gl_account = [
    ...
    def testGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts(self):
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts"""
