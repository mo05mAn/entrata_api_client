...
class TestGetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner(
                id = 1,
                name = 'Standard'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner"""
