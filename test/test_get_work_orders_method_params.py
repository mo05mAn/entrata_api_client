...
class TestGetWorkOrdersMethodParams(unittest.TestCase):
    """GetWorkOrdersMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrdersMethodParams:
        """Test GetWorkOrdersMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrdersMethodParams`
        """
        model = GetWorkOrdersMethodParams()
        if include_optional:
            return GetWorkOrdersMethodParams(
                property_id = 123456,
                work_order_id = 123456,
                property_unit_id = 123456,
                vendor_id = 123456,
                lease_status_type_ids = 56,
                work_order_type_ids = 56,
                building_name = 'ABC',
                unit_number = 'ABC',
                maintenance_priority_id = 123456,
                maintenance_category_id = 3,
                maintenance_problem_id = 123456,
                include_child_work_orders = 0,
                include_deleted_work_orders = 0,
                created_on_from_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                created_on_to_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                last_updated_on_from_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                last_updated_on_to_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                completed_on_from_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                completed_on_to_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()
            )
        else:
            return GetWorkOrdersMethodParams(
                property_id = 123456,
    ...
    def testGetWorkOrdersMethodParams(self):
        """Test GetWorkOrdersMethodParams"""
