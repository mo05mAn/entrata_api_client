...
class TestGetExpiringLeasesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetExpiringLeasesMethod:
        """Test GetExpiringLeasesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExpiringLeasesMethod`
        """
        model = GetExpiringLeasesMethod()
        if include_optional:
    ...
    def testGetExpiringLeasesMethod(self):
        """Test GetExpiringLeasesMethod"""
