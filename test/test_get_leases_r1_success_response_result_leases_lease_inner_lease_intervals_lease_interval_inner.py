...
class TestGetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner(unittest.TestCase):
    """GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner:
        """Test GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner`
        """
        model = GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner()
        if include_optional:
            return GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner(
                id = '123456',
    ...
    def testGetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner(self):
        """Test GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner"""
