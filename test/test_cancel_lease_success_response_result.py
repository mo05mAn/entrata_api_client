...
class TestCancelLeaseSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CancelLeaseSuccessResponseResult:
        """Test CancelLeaseSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelLeaseSuccessResponseResult`
        """
        model = CancelLeaseSuccessResponseResult()
        if include_optional:
            return CancelLeaseSuccessResponseResult(
                status = 'success',
    ...
    def testCancelLeaseSuccessResponseResult(self):
        """Test CancelLeaseSuccessResponseResult"""
