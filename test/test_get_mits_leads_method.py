...
class TestGetMitsLeadsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsLeadsMethod:
        """Test GetMitsLeadsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeadsMethod`
        """
        model = GetMitsLeadsMethod()
        if include_optional:
    ...
    def testGetMitsLeadsMethod(self):
        """Test GetMitsLeadsMethod"""
