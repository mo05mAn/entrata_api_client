...
class TestGetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes(unittest.TestCase):
    """GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes:
        """Test GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes`
        """
        model = GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes()
        if include_optional:
            return GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes(
                name = 'Cat',
                id = 3467
            )
        else:
    ...
    def testGetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes(self):
        """Test GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes"""
