...
class TestGetPropertyPickListsR1Method(unittest.TestCase):
    """GetPropertyPickListsR1Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR1Method:
        """Test GetPropertyPickListsR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR1Method`
        """
        model = GetPropertyPickListsR1Method()
        if include_optional:
            return GetPropertyPickListsR1Method(
                name = '',
                version = 'r1',
    ...
    def testGetPropertyPickListsR1Method(self):
        """Test GetPropertyPickListsR1Method"""
