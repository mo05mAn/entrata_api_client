...
class TestSendLeaseActivitiesMethodParams(unittest.TestCase):
    """SendLeaseActivitiesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseActivitiesMethodParams:
        """Test SendLeaseActivitiesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseActivitiesMethodParams`
        """
        model = SendLeaseActivitiesMethodParams()
        if include_optional:
            return SendLeaseActivitiesMethodParams(
                property_id = 123456,
                lease_id = 123456,
                event_type_id = 8,
                event_date_time = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                comment = 'ABC',
                hazard_end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                hazard_note = 'ABC',
                lease_interval_id = 1234,
                leasing_agent_id = 1234,
                event_result_id = 5,
                customer_ids = '1234,5678',
                schedule_date_time = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()
            )
        else:
            return SendLeaseActivitiesMethodParams(
                property_id = 123456,
    ...
    def testSendLeaseActivitiesMethodParams(self):
        """Test SendLeaseActivitiesMethodParams"""
