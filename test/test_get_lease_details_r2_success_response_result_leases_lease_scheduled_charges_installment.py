...
class TestGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment(unittest.TestCase):
    """GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment:
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment`
        """
        model = GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment()
        if include_optional:
            return GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment(
    ...
    def testGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment(self):
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment"""
