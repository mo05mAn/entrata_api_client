...
class TestGetPoReceivingRecordsSuccessResponse(unittest.TestCase):
    """GetPoReceivingRecordsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPoReceivingRecordsSuccessResponse:
        """Test GetPoReceivingRecordsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPoReceivingRecordsSuccessResponse`
        """
        model = GetPoReceivingRecordsSuccessResponse()
        if include_optional:
            return GetPoReceivingRecordsSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_po_receiving_records_success_response_result.getPoReceivingRecordsSuccessResponse_result(
    ...
    def testGetPoReceivingRecordsSuccessResponse(self):
        """Test GetPoReceivingRecordsSuccessResponse"""
