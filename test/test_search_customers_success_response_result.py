...
class TestSearchCustomersSuccessResponseResult(unittest.TestCase):
    """SearchCustomersSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchCustomersSuccessResponseResult:
        """Test SearchCustomersSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchCustomersSuccessResponseResult`
        """
        model = SearchCustomersSuccessResponseResult()
        if include_optional:
            return SearchCustomersSuccessResponseResult(
    ...
    def testSearchCustomersSuccessResponseResult(self):
        """Test SearchCustomersSuccessResponseResult"""
