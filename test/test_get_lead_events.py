...
class TestGetLeadEvents(unittest.TestCase):
    """GetLeadEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadEvents:
        """Test GetLeadEvents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadEvents`
        """
        model = GetLeadEvents()
        if include_optional:
            return GetLeadEvents(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_lead_events_method.getLeadEvents_method(
                    name = 'getLeadEvents', 
                    version = 'r1', 
