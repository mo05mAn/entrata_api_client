...
class TestUpdateSpecialGroupSuccessResponseResponse(unittest.TestCase):
    """UpdateSpecialGroupSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSpecialGroupSuccessResponseResponse:
        """Test UpdateSpecialGroupSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpecialGroupSuccessResponseResponse`
        """
        model = UpdateSpecialGroupSuccessResponseResponse()
        if include_optional:
            return UpdateSpecialGroupSuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testUpdateSpecialGroupSuccessResponseResponse(self):
        """Test UpdateSpecialGroupSuccessResponseResponse"""
