...
class TestGetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInnerAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInnerAttributes:
        """Test GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInnerAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInnerAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInnerAttributes(
                id = '1',
                name = 'Wire Transfer'
            )
        else:
    ...
    def testGetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInnerAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInnerAttributes"""
