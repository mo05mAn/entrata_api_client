...
class TestGetLeasingCenterPickListsSuccessResponseResultCallSources(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasingCenterPickListsSuccessResponseResultCallSources:
        """Test GetLeasingCenterPickListsSuccessResponseResultCallSources
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasingCenterPickListsSuccessResponseResultCallSources`
        """
        model = GetLeasingCenterPickListsSuccessResponseResultCallSources()
        if include_optional:
    ...
    def testGetLeasingCenterPickListsSuccessResponseResultCallSources(self):
        """Test GetLeasingCenterPickListsSuccessResponseResultCallSources"""
