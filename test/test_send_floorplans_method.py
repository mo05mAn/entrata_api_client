...
class TestSendFloorplansMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendFloorplansMethod:
        """Test SendFloorplansMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFloorplansMethod`
        """
        model = SendFloorplansMethod()
        if include_optional:
    ...
    def testSendFloorplansMethod(self):
        """Test SendFloorplansMethod"""
