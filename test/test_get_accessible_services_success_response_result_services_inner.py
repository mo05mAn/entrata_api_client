...
class TestGetAccessibleServicesSuccessResponseResultServicesInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccessibleServicesSuccessResponseResultServicesInner:
        """Test GetAccessibleServicesSuccessResponseResultServicesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessibleServicesSuccessResponseResultServicesInner`
        """
        model = GetAccessibleServicesSuccessResponseResultServicesInner()
        if include_optional:
            return GetAccessibleServicesSuccessResponseResultServicesInner(
    ...
    def testGetAccessibleServicesSuccessResponseResultServicesInner(self):
        """Test GetAccessibleServicesSuccessResponseResultServicesInner"""
