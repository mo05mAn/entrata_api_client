...
class TestGetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner(unittest.TestCase):
    """GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner:
        """Test GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner`
        """
        model = GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner()
        if include_optional:
            return GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner(
                job_phase_id = '2700',
    ...
    def testGetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner(self):
        """Test GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner"""
