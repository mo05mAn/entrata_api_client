...
class TestGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner(unittest.TestCase):
    """GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner:
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner`
        """
        model = GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner()
        if include_optional:
            return GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner(
    ...
    def testGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner(self):
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner"""
