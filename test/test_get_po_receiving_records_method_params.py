...
class TestGetPoReceivingRecordsMethodParams(unittest.TestCase):
    """GetPoReceivingRecordsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPoReceivingRecordsMethodParams:
        """Test GetPoReceivingRecordsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPoReceivingRecordsMethodParams`
        """
        model = GetPoReceivingRecordsMethodParams()
        if include_optional:
            return GetPoReceivingRecordsMethodParams(
                vendor_id = 12345,
                vendor_code = '12345',
                purchase_order_numbers = 12345,
                property_ids = '12345,4564',
                po_from_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                po_to_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                received_from_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                received_to_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()
            )
        else:
            return GetPoReceivingRecordsMethodParams(
        )
    ...
    def testGetPoReceivingRecordsMethodParams(self):
        """Test GetPoReceivingRecordsMethodParams"""
