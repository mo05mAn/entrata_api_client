...
class TestGetFloorPlansMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFloorPlansMethod:
        """Test GetFloorPlansMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansMethod`
        """
        model = GetFloorPlansMethod()
        if include_optional:
    ...
    def testGetFloorPlansMethod(self):
        """Test GetFloorPlansMethod"""
