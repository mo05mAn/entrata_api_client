...
class TestGetAccessibleServicesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccessibleServicesMethod:
        """Test GetAccessibleServicesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessibleServicesMethod`
        """
        model = GetAccessibleServicesMethod()
        if include_optional:
            return GetAccessibleServicesMethod(
    ...
    def testGetAccessibleServicesMethod(self):
        """Test GetAccessibleServicesMethod"""
