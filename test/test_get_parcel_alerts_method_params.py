...
class TestGetParcelAlertsMethodParams(unittest.TestCase):
    """GetParcelAlertsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetParcelAlertsMethodParams:
        """Test GetParcelAlertsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetParcelAlertsMethodParams`
        """
        model = GetParcelAlertsMethodParams()
        if include_optional:
            return GetParcelAlertsMethodParams(
                property_id = 123456,
                lease_id = 123456,
                customer_id = 123456,
                is_active = 0
    ...
    def testGetParcelAlertsMethodParams(self):
        """Test GetParcelAlertsMethodParams"""
