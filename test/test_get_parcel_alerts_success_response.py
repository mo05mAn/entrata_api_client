...
class TestGetParcelAlertsSuccessResponse(unittest.TestCase):
    """GetParcelAlertsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetParcelAlertsSuccessResponse:
        """Test GetParcelAlertsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetParcelAlertsSuccessResponse`
        """
        model = GetParcelAlertsSuccessResponse()
        if include_optional:
            return GetParcelAlertsSuccessResponse(
                response = entrata_api_client.models.get_parcel_alerts_success_response_response.getParcelAlertsSuccessResponse_response(
                    request_id = '15', 
                    code = 200, 
                    result = entrata_api_client.models.get_parcel_alerts_success_response_response_result.getParcelAlertsSuccessResponse_response_result(
                        package_batches = entrata_api_client.models.get_parcel_alerts_success_response_response_result_package_batches.getParcelAlertsSuccessResponse_response_result_packageBatches(
                            package_batch = [
                                entrata_api_client.models.get_parcel_alerts_success_response_response_result_package_batches_package_batch_inner.getParcelAlertsSuccessResponse_response_result_packageBatches_packageBatch_inner(
    ...
    def testGetParcelAlertsSuccessResponse(self):
        """Test GetParcelAlertsSuccessResponse"""
