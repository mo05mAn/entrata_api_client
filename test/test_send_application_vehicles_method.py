...
class TestSendApplicationVehiclesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationVehiclesMethod:
        """Test SendApplicationVehiclesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationVehiclesMethod`
        """
        model = SendApplicationVehiclesMethod()
        if include_optional:
    ...
    def testSendApplicationVehiclesMethod(self):
        """Test SendApplicationVehiclesMethod"""
