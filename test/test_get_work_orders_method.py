...
class TestGetWorkOrdersMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrdersMethod:
        """Test GetWorkOrdersMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrdersMethod`
        """
        model = GetWorkOrdersMethod()
        if include_optional:
    ...
    def testGetWorkOrdersMethod(self):
        """Test GetWorkOrdersMethod"""
