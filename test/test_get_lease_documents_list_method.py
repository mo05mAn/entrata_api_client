...
class TestGetLeaseDocumentsListMethod(unittest.TestCase):
    """GetLeaseDocumentsListMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsListMethod:
        """Test GetLeaseDocumentsListMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsListMethod`
        """
        model = GetLeaseDocumentsListMethod()
        if include_optional:
            return GetLeaseDocumentsListMethod(
    ...
    def testGetLeaseDocumentsListMethod(self):
        """Test GetLeaseDocumentsListMethod"""
