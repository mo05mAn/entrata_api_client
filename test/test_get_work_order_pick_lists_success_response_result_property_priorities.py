...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyPriorities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyPriorities:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyPriorities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyPriorities`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyPriorities()
        if include_optional:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyPriorities(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyPriorities"""
