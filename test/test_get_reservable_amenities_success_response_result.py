...
class TestGetReservableAmenitiesSuccessResponseResult(unittest.TestCase):
    """GetReservableAmenitiesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesSuccessResponseResult:
        """Test GetReservableAmenitiesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservableAmenitiesSuccessResponseResult`
        """
        model = GetReservableAmenitiesSuccessResponseResult()
        if include_optional:
            return GetReservableAmenitiesSuccessResponseResult(
    ...
    def testGetReservableAmenitiesSuccessResponseResult(self):
        """Test GetReservableAmenitiesSuccessResponseResult"""
