...
class TestGenerateQuotesMethod(unittest.TestCase):
    """GenerateQuotesMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateQuotesMethod:
        """Test GenerateQuotesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateQuotesMethod`
        """
        model = GenerateQuotesMethod()
        if include_optional:
            return GenerateQuotesMethod(
                name = 'generateQuotes',
                version = 'r1',
    ...
    def testGenerateQuotesMethod(self):
        """Test GenerateQuotesMethod"""
