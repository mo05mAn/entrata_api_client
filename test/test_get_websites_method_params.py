...
class TestGetWebsitesMethodParams(unittest.TestCase):
    """GetWebsitesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebsitesMethodParams:
        """Test GetWebsitesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebsitesMethodParams`
        """
        model = GetWebsitesMethodParams()
        if include_optional:
            return GetWebsitesMethodParams(
                property_ids = 56
            )
        else:
            return GetWebsitesMethodParams(
    ...
    def testGetWebsitesMethodParams(self):
        """Test GetWebsitesMethodParams"""
