...
class TestGetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItems:
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItems`
        """
        model = GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItems()
        if include_optional:
    ...
    def testGetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItems(self):
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItems"""
