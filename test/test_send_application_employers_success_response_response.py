...
class TestSendApplicationEmployersSuccessResponseResponse(unittest.TestCase):
    """SendApplicationEmployersSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationEmployersSuccessResponseResponse:
        """Test SendApplicationEmployersSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationEmployersSuccessResponseResponse`
        """
        model = SendApplicationEmployersSuccessResponseResponse()
        if include_optional:
            return SendApplicationEmployersSuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testSendApplicationEmployersSuccessResponseResponse(self):
        """Test SendApplicationEmployersSuccessResponseResponse"""
