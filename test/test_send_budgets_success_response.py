...
class TestSendBudgetsSuccessResponse(unittest.TestCase):
    """SendBudgetsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendBudgetsSuccessResponse:
        """Test SendBudgetsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetsSuccessResponse`
        """
        model = SendBudgetsSuccessResponse()
        if include_optional:
            return SendBudgetsSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.send_budgets_success_response_result.sendBudgetsSuccessResponse_result(
    ...
    def testSendBudgetsSuccessResponse(self):
        """Test SendBudgetsSuccessResponse"""
