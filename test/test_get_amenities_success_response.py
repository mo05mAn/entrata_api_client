...
class TestGetAmenitiesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponse:
        """Test GetAmenitiesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponse`
        """
        model = GetAmenitiesSuccessResponse()
        if include_optional:
    ...
    def testGetAmenitiesSuccessResponse(self):
        """Test GetAmenitiesSuccessResponse"""
