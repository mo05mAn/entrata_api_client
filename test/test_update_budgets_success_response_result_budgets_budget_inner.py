...
class TestUpdateBudgetsSuccessResponseResultBudgetsBudgetInner(unittest.TestCase):
    """UpdateBudgetsSuccessResponseResultBudgetsBudgetInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBudgetsSuccessResponseResultBudgetsBudgetInner:
        """Test UpdateBudgetsSuccessResponseResultBudgetsBudgetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBudgetsSuccessResponseResultBudgetsBudgetInner`
        """
        model = UpdateBudgetsSuccessResponseResultBudgetsBudgetInner()
        if include_optional:
            return UpdateBudgetsSuccessResponseResultBudgetsBudgetInner(
                node = '1',
                status = 'Success',
    ...
    def testUpdateBudgetsSuccessResponseResultBudgetsBudgetInner(self):
        """Test UpdateBudgetsSuccessResponseResultBudgetsBudgetInner"""
