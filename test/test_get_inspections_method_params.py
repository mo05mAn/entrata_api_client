...
class TestGetInspectionsMethodParams(unittest.TestCase):
    """GetInspectionsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInspectionsMethodParams:
        """Test GetInspectionsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionsMethodParams`
        """
        model = GetInspectionsMethodParams()
        if include_optional:
            return GetInspectionsMethodParams(
                property_id = 123456,
                lease_id = 123456,
                unit_space_id = 12345,
    ...
    def testGetInspectionsMethodParams(self):
        """Test GetInspectionsMethodParams"""
