...
class TestGetVendorLocationsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsMethodParams:
        """Test GetVendorLocationsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsMethodParams`
        """
        model = GetVendorLocationsMethodParams()
        if include_optional:
            return GetVendorLocationsMethodParams(
                property_ids = 56,
                show_all_status = 0,
                ...
                vendor_code = '123456',
                last_modified_on = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()
            )
        else:
            return GetVendorLocationsMethodParams(
        )
    ...
    def testGetVendorLocationsMethodParams(self):
        """Test GetVendorLocationsMethodParams"""
