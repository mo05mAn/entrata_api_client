...
class TestGetLeaseDocumentsListMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsListMethodParams:
        """Test GetLeaseDocumentsListMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsListMethodParams`
        """
        model = GetLeaseDocumentsListMethodParams()
        if include_optional:
            return GetLeaseDocumentsListMethodParams(
                property_id = 123456,
                lease_id = 123456,
    ...
    def testGetLeaseDocumentsListMethodParams(self):
        """Test GetLeaseDocumentsListMethodParams"""
