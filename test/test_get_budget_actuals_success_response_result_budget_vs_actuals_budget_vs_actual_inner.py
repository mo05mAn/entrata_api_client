...
class TestGetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner(unittest.TestCase):
    """GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner:
        """Test GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner`
        """
        model = GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner()
        if include_optional:
            return GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner(
                account_name = 'Testgldetails',
                account_id = '171693',
                mtd_actual_income = '150.00',
                mtd_budget_income = '10000.00',
                mtd_variance = '-9850.00',
                mtd_percentage_variance = '-98.5',
                ytd_actual_income = '0.00',
                ytd_budget_income = '0.00',
                ytd_variance = '0.00',
                ytd_percentage_variance = '0.00',
                annual_budget_income = '10000.00'
            )
        else:
            return GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner(
                account_name = 'Testgldetails',
    ...
    def testGetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner(self):
        """Test GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner"""
