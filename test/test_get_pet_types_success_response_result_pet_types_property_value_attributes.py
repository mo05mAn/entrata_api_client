...
class TestGetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes(unittest.TestCase):
    """GetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes:
        """Test GetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes`
        """
        model = GetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes()
        if include_optional:
            return GetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes(
                id = 11111
            )
        else:
            return GetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes(
    ...
    def testGetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes(self):
        """Test GetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes"""
