...
class TestGetLeasesR2MethodParams(unittest.TestCase):
    """GetLeasesR2MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR2MethodParams:
        """Test GetLeasesR2MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR2MethodParams`
        """
        model = GetLeasesR2MethodParams()
        if include_optional:
            return GetLeasesR2MethodParams(
                property_id = 123456,
    ...
    def testGetLeasesR2MethodParams(self):
        """Test GetLeasesR2MethodParams"""
