...
class TestGetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner(unittest.TestCase):
    """GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner:
        """Test GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner`
        """
        model = GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner()
        if include_optional:
            return GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner(
                id = '123456',
                name = 'Cats',
    ...
    def testGetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner(self):
        """Test GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner"""
