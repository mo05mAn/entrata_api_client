...
class TestGetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress(unittest.TestCase):
    """GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress:
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress`
        """
        model = GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress()
        if include_optional:
            return GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress(
    ...
    def testGetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress(self):
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress"""
