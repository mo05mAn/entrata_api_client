...
class TestGetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner(
                id = 1,
                name = 'Reconciled'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner"""
