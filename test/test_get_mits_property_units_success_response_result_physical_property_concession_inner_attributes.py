...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes(unittest.TestCase):
    """GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes(
                active = '1'
            )
        else:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes(
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes"""
