...
class TestGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner(unittest.TestCase):
    """GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner:
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner`
        """
        model = GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner()
        if include_optional:
            return GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner(
                id = 582099,
                name = 'Unit type 2'
            )
        else:
    ...
    def testGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner(self):
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner"""
