...
class TestGetBankAccountsSuccessResponseResultBankAccountsBankAccountInner(unittest.TestCase):
    """GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner:
        """Test GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner`
        """
        model = GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner()
        if include_optional:
            return GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner(
                id = '11111',
    ...
    def testGetBankAccountsSuccessResponseResultBankAccountsBankAccountInner(self):
        """Test GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner"""
