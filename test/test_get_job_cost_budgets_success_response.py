...
class TestGetJobCostBudgetsSuccessResponse(unittest.TestCase):
    """GetJobCostBudgetsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobCostBudgetsSuccessResponse:
        """Test GetJobCostBudgetsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCostBudgetsSuccessResponse`
        """
        model = GetJobCostBudgetsSuccessResponse()
        if include_optional:
            return GetJobCostBudgetsSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_job_cost_budgets_success_response_result.getJobCostBudgetsSuccessResponse_result(
                    jobs = entrata_api_client.models.get_job_cost_budgets_success_response_result_jobs.getJobCostBudgetsSuccessResponse_result_jobs(
                        job = [
                            entrata_api_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner.getJobCostBudgetsSuccessResponse_result_jobs_job_inner(
                                property_id = '172775', 
                                job_id = '1249', 
                                job_status_id = '1', 
                                job_phases = entrata_api_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner_job_phases.getJobCostBudgetsSuccessResponse_result_jobs_job_inner_jobPhases(
                                    job_phase = [
                                        entrata_api_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner_job_phases_job_phase_inner.getJobCostBudgetsSuccessResponse_result_jobs_job_inner_jobPhases_jobPhase_inner(
                                            job_phase_id = '2700', 
                                            job_phase_name = 'PhaseGlAccountTest', 
                                            ap_codes = [
                                                entrata_api_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner_job_phases_job_phase_inner_ap_codes_inner.getJobCostBudgetsSuccessResponse_result_jobs_job_inner_jobPhases_jobPhase_inner_apCodes_inner(
                                                    ap_code = entrata_api_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner_job_phases_job_phase_inner_ap_codes_inner_ap_code.getJobCostBudgetsSuccessResponse_result_jobs_job_inner_jobPhases_jobPhase_inner_apCodes_inner_apCode(
                                                        ap_code_id = '176844', 
                                                        ap_code_name = '1234 - Electrical', 
                                                        unit_type_budget = '12', 
                                                        location_budget = '0', 
                                                        general_budget = '0', 
    ...
    def testGetJobCostBudgetsSuccessResponse(self):
        """Test GetJobCostBudgetsSuccessResponse"""
