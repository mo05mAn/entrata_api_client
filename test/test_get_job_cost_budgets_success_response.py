    ...
    def make_instance(self, include_optional) -> GetJobCostBudgetsSuccessResponse:
        ...
        if include_optional:
            return GetJobCostBudgetsSuccessResponse(
                request_id = '15',
                code = '200',
                result = openapi_client.models.get_job_cost_budgets_success_response_result.getJobCostBudgetsSuccessResponse_result(
                    jobs = openapi_client.models.get_job_cost_budgets_success_response_result_jobs.getJobCostBudgetsSuccessResponse_result_jobs(
                        job = [
                            openapi_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner.getJobCostBudgetsSuccessResponse_result_jobs_job_inner(
                                property_id = '172775', 
                                job_id = '1249', 
                                job_status_id = '1', 
                                job_phases = openapi_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner_job_phases.getJobCostBudgetsSuccessResponse_result_jobs_job_inner_jobPhases(
                                    job_phase = [
                                        openapi_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner_job_phases_job_phase_inner.getJobCostBudgetsSuccessResponse_result_jobs_job_inner_jobPhases_jobPhase_inner(
                                            job_phase_id = '2700', 
                                            job_phase_name = 'PhaseGlAccountTest', 
                                            ap_codes = [
                                                openapi_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner_job_phases_job_phase_inner_ap_codes_inner.getJobCostBudgetsSuccessResponse_result_jobs_job_inner_jobPhases_jobPhase_inner_apCodes_inner(
                                                    ap_code = openapi_client.models.get_job_cost_budgets_success_response_result_jobs_job_inner_job_phases_job_phase_inner_ap_codes_inner_ap_code.getJobCostBudgetsSuccessResponse_result_jobs_job_inner_jobPhases_jobPhase_inner_apCodes_inner_apCode(
                                                        ap_code_id = '176844', 
