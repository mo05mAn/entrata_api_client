...
class TestGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges()
        if include_optional:
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges"""
