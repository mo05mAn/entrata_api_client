...
class TestGetMitsPropertyUnitsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsMethod:
        """Test GetMitsPropertyUnitsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsMethod`
        """
        model = GetMitsPropertyUnitsMethod()
        if include_optional:
    ...
    def testGetMitsPropertyUnitsMethod(self):
        """Test GetMitsPropertyUnitsMethod"""
