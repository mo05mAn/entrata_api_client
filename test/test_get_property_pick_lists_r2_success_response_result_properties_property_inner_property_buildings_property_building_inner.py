...
class TestGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner(unittest.TestCase):
    """GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner:
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner`
        """
        model = GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner()
        if include_optional:
            return GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner(
                id = 56457,
                name = 'Building A'
            )
        else:
    ...
    def testGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner(self):
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner"""
