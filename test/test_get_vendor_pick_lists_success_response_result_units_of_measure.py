...
class TestGetVendorPickListsSuccessResponseResultUnitsOfMeasure(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultUnitsOfMeasure:
        """Test GetVendorPickListsSuccessResponseResultUnitsOfMeasure
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultUnitsOfMeasure`
        """
        model = GetVendorPickListsSuccessResponseResultUnitsOfMeasure()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultUnitsOfMeasure(self):
        """Test GetVendorPickListsSuccessResponseResultUnitsOfMeasure"""
