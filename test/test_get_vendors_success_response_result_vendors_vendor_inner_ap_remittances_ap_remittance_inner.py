...
class TestGetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner(unittest.TestCase):
    """GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner:
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner`
        """
        model = GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner()
        if include_optional:
            return GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner(
                id = '5433',
                name = 'Check Name',
    ...
    def testGetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner(self):
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner"""
