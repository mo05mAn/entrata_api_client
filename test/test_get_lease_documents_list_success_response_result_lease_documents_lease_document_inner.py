...
class TestGetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner(unittest.TestCase):
    """GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner:
        """Test GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner`
        """
        model = GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner()
        if include_optional:
            return GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner(
                id = 13862207,
    ...
    def testGetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner(self):
        """Test GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner"""
