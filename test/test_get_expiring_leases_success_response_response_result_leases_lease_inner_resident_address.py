...
class TestGetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress(unittest.TestCase):
    """GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress:
        """Test GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress`
        """
        model = GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress()
        if include_optional:
            return GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress(
    ...
    def testGetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress(self):
        """Test GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress"""
