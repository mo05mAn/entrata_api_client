...
class TestGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServices(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServices:
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServices`
        """
        model = GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServices()
        if include_optional:
    ...
    def testGetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServices(self):
        """Test GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServices"""
