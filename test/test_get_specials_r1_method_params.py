...
class TestGetSpecialsR1MethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR1MethodParams:
        """Test GetSpecialsR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR1MethodParams`
        """
        model = GetSpecialsR1MethodParams()
        if include_optional:
            return GetSpecialsR1MethodParams(
                property_id = 12345
            )
        else:
            return GetSpecialsR1MethodParams(
    ...
    def testGetSpecialsR1MethodParams(self):
        """Test GetSpecialsR1MethodParams"""
