...
class TestGetLeasePickListSuccessResponseResultChargeTimings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultChargeTimings:
        """Test GetLeasePickListSuccessResponseResultChargeTimings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultChargeTimings`
        """
        model = GetLeasePickListSuccessResponseResultChargeTimings()
        if include_optional:
    ...
    def testGetLeasePickListSuccessResponseResultChargeTimings(self):
        """Test GetLeasePickListSuccessResponseResultChargeTimings"""
