...
class TestGetPropertyAnnouncementsSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyAnnouncementsSuccessResponseResult:
        """Test GetPropertyAnnouncementsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAnnouncementsSuccessResponseResult`
        """
    ...
    def testGetPropertyAnnouncementsSuccessResponseResult(self):
        """Test GetPropertyAnnouncementsSuccessResponseResult"""
