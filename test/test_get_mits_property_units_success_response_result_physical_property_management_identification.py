...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification(unittest.TestCase):
    """GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification(
                id_value = '1234',
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification"""
