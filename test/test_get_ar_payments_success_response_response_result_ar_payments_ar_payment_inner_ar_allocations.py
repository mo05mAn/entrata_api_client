...
class TestGetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocations:
        """Test GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocations`
        """
        model = GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocations()
        if include_optional:
    ...
    def testGetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocations(self):
        """Test GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocations"""
