...
class TestGetLeadsMethodParams(unittest.TestCase):
    """GetLeadsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadsMethodParams:
        """Test GetLeadsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsMethodParams`
        """
        model = GetLeadsMethodParams()
        if include_optional:
            return GetLeadsMethodParams(
                property_id = 123456,
                lead_id = 123,
                name = 'ABC',
                ...
                created_on_date_from = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
    ...
    def testGetLeadsMethodParams(self):
        """Test GetLeadsMethodParams"""
