...
class TestUpdateWorkOrdersR2Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateWorkOrdersR2Method:
        """Test UpdateWorkOrdersR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWorkOrdersR2Method`
        """
        model = UpdateWorkOrdersR2Method()
        if include_optional:
    ...
    def testUpdateWorkOrdersR2Method(self):
        """Test UpdateWorkOrdersR2Method"""
