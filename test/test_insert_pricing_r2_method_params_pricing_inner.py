...
class TestInsertPricingR2MethodParamsPricingInner(unittest.TestCase):
    """InsertPricingR2MethodParamsPricingInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsertPricingR2MethodParamsPricingInner:
        """Test InsertPricingR2MethodParamsPricingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingR2MethodParamsPricingInner`
        """
        model = InsertPricingR2MethodParamsPricingInner()
        if include_optional:
            return InsertPricingR2MethodParamsPricingInner(
                pricing_level_id = 3,
    ...
    def testInsertPricingR2MethodParamsPricingInner(self):
        """Test InsertPricingR2MethodParamsPricingInner"""
