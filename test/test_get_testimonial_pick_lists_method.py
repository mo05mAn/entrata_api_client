...
class TestGetTestimonialPickListsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTestimonialPickListsMethod:
        """Test GetTestimonialPickListsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTestimonialPickListsMethod`
        """
        model = GetTestimonialPickListsMethod()
        if include_optional:
            return GetTestimonialPickListsMethod(
    ...
    def testGetTestimonialPickListsMethod(self):
        """Test GetTestimonialPickListsMethod"""
