...
class TestGetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes(unittest.TestCase):
    """GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes:
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes`
        """
        model = GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes()
        if include_optional:
            return GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes(
                id = '1234',
    ...
    def testGetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes(self):
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes"""
