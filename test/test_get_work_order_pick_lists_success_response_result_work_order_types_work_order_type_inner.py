...
class TestGetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner:
        """Test GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner`
        """
        model = GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner(
                id = '1',
                name = 'Make Ready'
            )
        else:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner(self):
        """Test GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner"""
