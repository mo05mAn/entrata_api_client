...
class TestGetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner(unittest.TestCase):
    """GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner:
        """Test GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner`
        """
        model = GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner()
        if include_optional:
            return GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner(
                id = '545',
                name = '021',
                code = 'T0021',
    ...
    def testGetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner(self):
        """Test GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner"""
