...
class TestGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner(unittest.TestCase):
    """GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner()
        if include_optional:
            return GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner(
                charge_code = '10aug',
                charge_usage = 'Base',
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner"""
