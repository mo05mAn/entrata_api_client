...
class TestSendRentableItems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRentableItems:
        """Test SendRentableItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentableItems`
        """
    ...
    def testSendRentableItems(self):
        """Test SendRentableItems"""
