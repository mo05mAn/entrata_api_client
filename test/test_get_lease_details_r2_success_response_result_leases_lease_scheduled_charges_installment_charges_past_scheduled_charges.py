...
class TestGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges(unittest.TestCase):
    """GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges:
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges`
        """
        model = GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges()
        if include_optional:
            return GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges(
    ...
    def testGetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges(self):
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges"""
