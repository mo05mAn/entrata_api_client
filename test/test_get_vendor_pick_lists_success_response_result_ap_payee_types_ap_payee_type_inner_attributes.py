...
class TestGetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes:
        """Test GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes(
                id = '2',
                name = 'Owner'
            )
        else:
    ...
    def testGetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes"""
