...
class TestUpdatePropertyMediaAuth(unittest.TestCase):
    """UpdatePropertyMediaAuth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePropertyMediaAuth:
        """Test UpdatePropertyMediaAuth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyMediaAuth`
        """
        model = UpdatePropertyMediaAuth()
        if include_optional:
            return UpdatePropertyMediaAuth(
                type = 'basic'
            )
        else:
            return UpdatePropertyMediaAuth(
    ...
    def testUpdatePropertyMediaAuth(self):
        """Test UpdatePropertyMediaAuth"""
