...
class TestGetPropertyMediaMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyMediaMethodParams:
        """Test GetPropertyMediaMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyMediaMethodParams`
        """
        model = GetPropertyMediaMethodParams()
        if include_optional:
            return GetPropertyMediaMethodParams(
                property_id = '123456',
                media_type_id = '6',
                media_sub_type_id = '24',
                reference_ids = '987654'
            )
        else:
            return GetPropertyMediaMethodParams(
                property_id = '123456',
    ...
    def testGetPropertyMediaMethodParams(self):
        """Test GetPropertyMediaMethodParams"""
