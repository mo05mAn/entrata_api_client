...
class TestSendApplicationMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationMethod:
        """Test SendApplicationMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationMethod`
        """
        model = SendApplicationMethod()
        if include_optional:
    ...
    def testSendApplicationMethod(self):
        """Test SendApplicationMethod"""
