...
class TestGetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes:
        """Test GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes(
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes"""
