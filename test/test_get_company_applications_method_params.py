...
class TestGetCompanyApplicationsMethodParams(unittest.TestCase):
    """GetCompanyApplicationsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCompanyApplicationsMethodParams:
        """Test GetCompanyApplicationsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCompanyApplicationsMethodParams`
        """
        model = GetCompanyApplicationsMethodParams()
        if include_optional:
            return GetCompanyApplicationsMethodParams(
                property_id = 123456
            )
        else:
            return GetCompanyApplicationsMethodParams(
    ...
    def testGetCompanyApplicationsMethodParams(self):
        """Test GetCompanyApplicationsMethodParams"""
