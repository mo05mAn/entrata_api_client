...
class TestGetBankAccountsSuccessResponseResult(unittest.TestCase):
    """GetBankAccountsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBankAccountsSuccessResponseResult:
        """Test GetBankAccountsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBankAccountsSuccessResponseResult`
        """
        model = GetBankAccountsSuccessResponseResult()
        if include_optional:
            return GetBankAccountsSuccessResponseResult(
    ...
    def testGetBankAccountsSuccessResponseResult(self):
        """Test GetBankAccountsSuccessResponseResult"""
