...
class TestGetVendorPickListsSuccessResponseResultApPayeeTypes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultApPayeeTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultApPayeeTypes:
        """Test GetVendorPickListsSuccessResponseResultApPayeeTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultApPayeeTypes`
        """
        model = GetVendorPickListsSuccessResponseResultApPayeeTypes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultApPayeeTypes(
                ap_payee_type = [
    ...
    def testGetVendorPickListsSuccessResponseResultApPayeeTypes(self):
        """Test GetVendorPickListsSuccessResponseResultApPayeeTypes"""
