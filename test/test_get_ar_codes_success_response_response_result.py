...
class TestGetArCodesSuccessResponseResponseResult(unittest.TestCase):
    """GetArCodesSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetArCodesSuccessResponseResponseResult:
        """Test GetArCodesSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArCodesSuccessResponseResponseResult`
        """
        model = GetArCodesSuccessResponseResponseResult()
        if include_optional:
            return GetArCodesSuccessResponseResponseResult(
    ...
    def testGetArCodesSuccessResponseResponseResult(self):
        """Test GetArCodesSuccessResponseResponseResult"""
