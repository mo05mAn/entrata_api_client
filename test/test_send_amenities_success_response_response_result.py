...
class TestSendAmenitiesSuccessResponseResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendAmenitiesSuccessResponseResponseResult:
        """Test SendAmenitiesSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAmenitiesSuccessResponseResponseResult`
        """
        model = SendAmenitiesSuccessResponseResponseResult()
        if include_optional:
    ...
    def testSendAmenitiesSuccessResponseResponseResult(self):
        """Test SendAmenitiesSuccessResponseResponseResult"""
