...
class TestGetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident(unittest.TestCase):
    """GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident:
        """Test GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident`
        """
        model = GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident()
        if include_optional:
            return GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident(
    ...
    def testGetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident(self):
        """Test GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident"""
