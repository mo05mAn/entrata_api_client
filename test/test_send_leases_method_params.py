...
class TestSendLeasesMethodParams(unittest.TestCase):
    """SendLeasesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeasesMethodParams:
        """Test SendLeasesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeasesMethodParams`
        """
        model = SendLeasesMethodParams()
        if include_optional:
            return SendLeasesMethodParams(
                property_id = 123456,
    ...
    def testSendLeasesMethodParams(self):
        """Test SendLeasesMethodParams"""
