...
class TestGetVendorPickListsSuccessResponseResultComplianceStatuses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultComplianceStatuses:
        """Test GetVendorPickListsSuccessResponseResultComplianceStatuses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultComplianceStatuses`
        """
        model = GetVendorPickListsSuccessResponseResultComplianceStatuses()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultComplianceStatuses(self):
        """Test GetVendorPickListsSuccessResponseResultComplianceStatuses"""
