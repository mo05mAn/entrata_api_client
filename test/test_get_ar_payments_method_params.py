...
class TestGetArPaymentsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetArPaymentsMethodParams:
        """Test GetArPaymentsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArPaymentsMethodParams`
        """
        model = GetArPaymentsMethodParams()
        if include_optional:
            return GetArPaymentsMethodParams(
    ...
    def testGetArPaymentsMethodParams(self):
        """Test GetArPaymentsMethodParams"""
