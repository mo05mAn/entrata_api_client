...
class TestGetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner(unittest.TestCase):
    """GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner()
        if include_optional:
            return GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner(
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner"""
