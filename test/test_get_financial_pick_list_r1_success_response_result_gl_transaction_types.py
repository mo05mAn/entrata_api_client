...
class TestGetFinancialPickListR1SuccessResponseResultGlTransactionTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlTransactionTypes:
        """Test GetFinancialPickListR1SuccessResponseResultGlTransactionTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlTransactionTypes`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlTransactionTypes()
        if include_optional:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlTransactionTypes(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlTransactionTypes"""
