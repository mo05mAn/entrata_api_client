...
class TestSendScheduledChargesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendScheduledChargesMethodParams:
        """Test SendScheduledChargesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendScheduledChargesMethodParams`
        """
        model = SendScheduledChargesMethodParams()
        if include_optional:
            return SendScheduledChargesMethodParams(
                property_id = 123456,
                lease_id = 123456,
    ...
    def testSendScheduledChargesMethodParams(self):
        """Test SendScheduledChargesMethodParams"""
