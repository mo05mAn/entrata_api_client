...
class TestGetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor(unittest.TestCase):
    """GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor:
        """Test GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor`
        """
        model = GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor()
        if include_optional:
            return GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor(
                id = '67645',
                name = '22 Exchange'
            )
        else:
    ...
    def testGetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor(self):
        """Test GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor"""
