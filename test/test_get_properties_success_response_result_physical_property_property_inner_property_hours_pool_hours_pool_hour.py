...
class TestGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour(unittest.TestCase):
    """GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour:
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour`
        """
        model = GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour()
        if include_optional:
            return GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour(
                day = 'Monday',
                open_time = '8:20 AM',
                close_time = '4:06 PM'
            )
    ...
    def testGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour(self):
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour"""
