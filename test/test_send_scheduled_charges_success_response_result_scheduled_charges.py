...
class TestSendScheduledChargesSuccessResponseResultScheduledCharges(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendScheduledChargesSuccessResponseResultScheduledCharges:
        """Test SendScheduledChargesSuccessResponseResultScheduledCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendScheduledChargesSuccessResponseResultScheduledCharges`
        """
        model = SendScheduledChargesSuccessResponseResultScheduledCharges()
        if include_optional:
    ...
    def testSendScheduledChargesSuccessResponseResultScheduledCharges(self):
        """Test SendScheduledChargesSuccessResponseResultScheduledCharges"""
