...
class TestGetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner(unittest.TestCase):
    """GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner:
        """Test GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner`
        """
        model = GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner()
        if include_optional:
            return GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner(
    ...
    def testGetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner(self):
        """Test GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner"""
