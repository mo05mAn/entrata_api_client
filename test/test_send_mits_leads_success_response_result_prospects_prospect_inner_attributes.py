...
class TestSendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes(unittest.TestCase):
    """SendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes:
        """Test SendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes`
        """
        model = SendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes()
        if include_optional:
            return SendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes(
                node = '1',
    ...
    def testSendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes(self):
        """Test SendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes"""
