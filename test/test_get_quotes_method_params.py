...
class TestGetQuotesMethodParams(unittest.TestCase):
    """GetQuotesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetQuotesMethodParams:
        """Test GetQuotesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetQuotesMethodParams`
        """
        model = GetQuotesMethodParams()
        if include_optional:
            return GetQuotesMethodParams(
                property_id = 123456,
                application_id = 123,
                lease_start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                quote_id = 123,
                include_expired_quotes = 0
            )
        else:
            return GetQuotesMethodParams(
                property_id = 123456,
    ...
    def testGetQuotesMethodParams(self):
        """Test GetQuotesMethodParams"""
