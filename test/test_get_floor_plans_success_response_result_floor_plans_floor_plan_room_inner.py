...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInner:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInner`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInner()
        if include_optional:
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInner(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInner"""
