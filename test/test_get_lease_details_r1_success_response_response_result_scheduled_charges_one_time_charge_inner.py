...
class TestGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInner:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInner`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInner()
        if include_optional:
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInner(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInner"""
