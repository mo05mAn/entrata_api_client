...
class TestGetPricingPicklistsSuccessResponseResponseResultChargeCodeTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResultChargeCodeTypes:
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeCodeTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResultChargeCodeTypes`
        """
        model = GetPricingPicklistsSuccessResponseResponseResultChargeCodeTypes()
        if include_optional:
    ...
    def testGetPricingPicklistsSuccessResponseResponseResultChargeCodeTypes(self):
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeCodeTypes"""
