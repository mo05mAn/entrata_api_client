...
class TestGetBudgetsSuccessResponseResultPropertiesPropertyInner(unittest.TestCase):
    """GetBudgetsSuccessResponseResultPropertiesPropertyInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBudgetsSuccessResponseResultPropertiesPropertyInner:
        """Test GetBudgetsSuccessResponseResultPropertiesPropertyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBudgetsSuccessResponseResultPropertiesPropertyInner`
        """
        model = GetBudgetsSuccessResponseResultPropertiesPropertyInner()
        if include_optional:
            return GetBudgetsSuccessResponseResultPropertiesPropertyInner(
                property_id = '123',
    ...
    def testGetBudgetsSuccessResponseResultPropertiesPropertyInner(self):
        """Test GetBudgetsSuccessResponseResultPropertiesPropertyInner"""
