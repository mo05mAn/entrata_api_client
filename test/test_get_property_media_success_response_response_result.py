...
class TestGetPropertyMediaSuccessResponseResponseResult(unittest.TestCase):
    """GetPropertyMediaSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyMediaSuccessResponseResponseResult:
        """Test GetPropertyMediaSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyMediaSuccessResponseResponseResult`
        """
        model = GetPropertyMediaSuccessResponseResponseResult()
        if include_optional:
            return GetPropertyMediaSuccessResponseResponseResult(
                property_id = 123456,
                media = [
                    null
                    ]
    ...
    def testGetPropertyMediaSuccessResponseResponseResult(self):
        """Test GetPropertyMediaSuccessResponseResponseResult"""
