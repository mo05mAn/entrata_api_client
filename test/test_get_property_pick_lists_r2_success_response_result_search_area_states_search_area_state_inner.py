...
class TestGetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner(unittest.TestCase):
    """GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner:
        """Test GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner`
        """
        model = GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner()
        if include_optional:
            return GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner(
    ...
    def testGetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner(self):
        """Test GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner"""
