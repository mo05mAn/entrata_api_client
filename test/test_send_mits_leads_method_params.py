...
class TestSendMitsLeadsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendMitsLeadsMethodParams:
        """Test SendMitsLeadsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMitsLeadsMethodParams`
        """
        model = SendMitsLeadsMethodParams()
        if include_optional:
            return SendMitsLeadsMethodParams(
                property_id = 123456,
    ...
    def testSendMitsLeadsMethodParams(self):
        """Test SendMitsLeadsMethodParams"""
