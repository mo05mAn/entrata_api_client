...
class TestGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates:
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates(
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates"""
