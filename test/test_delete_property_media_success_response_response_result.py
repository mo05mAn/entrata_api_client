...
class TestDeletePropertyMediaSuccessResponseResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeletePropertyMediaSuccessResponseResponseResult:
        """Test DeletePropertyMediaSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletePropertyMediaSuccessResponseResponseResult`
        """
        model = DeletePropertyMediaSuccessResponseResponseResult()
        if include_optional:
            return DeletePropertyMediaSuccessResponseResponseResult(
                status = 'Success',
    ...
    def testDeletePropertyMediaSuccessResponseResponseResult(self):
        """Test DeletePropertyMediaSuccessResponseResponseResult"""
