...
class TestUpdateScheduledChargesR1SuccessResponseResultScheduledCharges(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR1SuccessResponseResultScheduledCharges:
        """Test UpdateScheduledChargesR1SuccessResponseResultScheduledCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR1SuccessResponseResultScheduledCharges`
        """
        model = UpdateScheduledChargesR1SuccessResponseResultScheduledCharges()
        if include_optional:
    ...
    def testUpdateScheduledChargesR1SuccessResponseResultScheduledCharges(self):
        """Test UpdateScheduledChargesR1SuccessResponseResultScheduledCharges"""
