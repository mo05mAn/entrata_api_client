...
class TestGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner(unittest.TestCase):
    """GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner:
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner`
        """
        model = GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner()
        if include_optional:
            return GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner(
                ar_code_id = '1234',
                ar_code_type_id = '7',
                charge_type_id = '410',
                amount = '$1.00',
    ...
    def testGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner(self):
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner"""
