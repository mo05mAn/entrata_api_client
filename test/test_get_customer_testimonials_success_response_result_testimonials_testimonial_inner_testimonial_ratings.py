...
class TestGetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatings:
        """Test GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatings`
        """
        model = GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatings()
        if include_optional:
    ...
    def testGetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatings(self):
        """Test GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatings"""
