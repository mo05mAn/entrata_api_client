...
class TestSendLeaseArTransactionReversalsSuccessResponseResponse(unittest.TestCase):
    """SendLeaseArTransactionReversalsSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionReversalsSuccessResponseResponse:
        """Test SendLeaseArTransactionReversalsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionReversalsSuccessResponseResponse`
        """
        model = SendLeaseArTransactionReversalsSuccessResponseResponse()
        if include_optional:
            return SendLeaseArTransactionReversalsSuccessResponseResponse(
                request_id = '15',
    ...
    def testSendLeaseArTransactionReversalsSuccessResponseResponse(self):
        """Test SendLeaseArTransactionReversalsSuccessResponseResponse"""
