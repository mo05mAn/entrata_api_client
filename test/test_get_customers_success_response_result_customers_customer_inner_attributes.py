...
class TestGetCustomersSuccessResponseResultCustomersCustomerInnerAttributes(unittest.TestCase):
    """GetCustomersSuccessResponseResultCustomersCustomerInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInnerAttributes:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInnerAttributes`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInnerAttributes()
        if include_optional:
            return GetCustomersSuccessResponseResultCustomersCustomerInnerAttributes(
                id = '6526235',
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInnerAttributes(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerAttributes"""
