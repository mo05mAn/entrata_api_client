...
class TestGetVendorsSuccessResponseResultVendorsVendorInnerLegalEntities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntities:
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntities`
        """
        model = GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntities()
        if include_optional:
    ...
    def testGetVendorsSuccessResponseResultVendorsVendorInnerLegalEntities(self):
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntities"""
