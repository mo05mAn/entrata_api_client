...
class TestGetPropertyMediaMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyMediaMethod:
        """Test GetPropertyMediaMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyMediaMethod`
        """
        model = GetPropertyMediaMethod()
        if include_optional:
    ...
    def testGetPropertyMediaMethod(self):
        """Test GetPropertyMediaMethod"""
