...
class TestSendApplicantGeneralDetailsSuccessResponseResponse(unittest.TestCase):
    """SendApplicantGeneralDetailsSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicantGeneralDetailsSuccessResponseResponse:
        """Test SendApplicantGeneralDetailsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicantGeneralDetailsSuccessResponseResponse`
        """
        model = SendApplicantGeneralDetailsSuccessResponseResponse()
        if include_optional:
            return SendApplicantGeneralDetailsSuccessResponseResponse(
                request_id = 'req98765',
                code = 200,
                result = [
    ...
    def testSendApplicantGeneralDetailsSuccessResponseResponse(self):
        """Test SendApplicantGeneralDetailsSuccessResponseResponse"""
