...
class TestGetAmenitiesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAmenitiesMethod:
        """Test GetAmenitiesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesMethod`
        """
        model = GetAmenitiesMethod()
        if include_optional:
    ...
    def testGetAmenitiesMethod(self):
        """Test GetAmenitiesMethod"""
