...
class TestSendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner(unittest.TestCase):
    """SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner:
        """Test SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner`
        """
        model = SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner()
        if include_optional:
            return SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner(
                node = '1',
                reference_id = '123456',
                lease_id = '123456',
    ...
    def testSendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner(self):
        """Test SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner"""
