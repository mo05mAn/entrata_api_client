...
class TestGetCustomersSuccessResponseResultCustomers(unittest.TestCase):
    """GetCustomersSuccessResponseResultCustomers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomers:
        """Test GetCustomersSuccessResponseResultCustomers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomers`
        """
        model = GetCustomersSuccessResponseResultCustomers()
        if include_optional:
            return GetCustomersSuccessResponseResultCustomers(
                customer = [
    ...
    def testGetCustomersSuccessResponseResultCustomers(self):
        """Test GetCustomersSuccessResponseResultCustomers"""
