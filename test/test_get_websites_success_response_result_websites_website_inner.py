...
class TestGetWebsitesSuccessResponseResultWebsitesWebsiteInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWebsitesSuccessResponseResultWebsitesWebsiteInner:
        """Test GetWebsitesSuccessResponseResultWebsitesWebsiteInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebsitesSuccessResponseResultWebsitesWebsiteInner`
        """
        model = GetWebsitesSuccessResponseResultWebsitesWebsiteInner()
        if include_optional:
            return GetWebsitesSuccessResponseResultWebsitesWebsiteInner(
                id = '25079',
                name = 'Abhi_website',
    ...
    def testGetWebsitesSuccessResponseResultWebsitesWebsiteInner(self):
        """Test GetWebsitesSuccessResponseResultWebsitesWebsiteInner"""
