...
class TestSendBudgetsSuccessResponseResultBudgetsBudgetInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendBudgetsSuccessResponseResultBudgetsBudgetInner:
        """Test SendBudgetsSuccessResponseResultBudgetsBudgetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetsSuccessResponseResultBudgetsBudgetInner`
        """
        model = SendBudgetsSuccessResponseResultBudgetsBudgetInner()
        if include_optional:
            return SendBudgetsSuccessResponseResultBudgetsBudgetInner(
                node = 1,
                status = 'Success',
    ...
    def testSendBudgetsSuccessResponseResultBudgetsBudgetInner(self):
        """Test SendBudgetsSuccessResponseResultBudgetsBudgetInner"""
