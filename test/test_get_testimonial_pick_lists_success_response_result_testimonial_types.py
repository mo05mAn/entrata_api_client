...
class TestGetTestimonialPickListsSuccessResponseResultTestimonialTypes(unittest.TestCase):
    """GetTestimonialPickListsSuccessResponseResultTestimonialTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTestimonialPickListsSuccessResponseResultTestimonialTypes:
        """Test GetTestimonialPickListsSuccessResponseResultTestimonialTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTestimonialPickListsSuccessResponseResultTestimonialTypes`
        """
        model = GetTestimonialPickListsSuccessResponseResultTestimonialTypes()
        if include_optional:
            return GetTestimonialPickListsSuccessResponseResultTestimonialTypes(
                testimonial_type = [
    ...
    def testGetTestimonialPickListsSuccessResponseResultTestimonialTypes(self):
        """Test GetTestimonialPickListsSuccessResponseResultTestimonialTypes"""
