...
class TestOrgsV1MaintenancePostRequestInner(unittest.TestCase):
    """OrgsV1MaintenancePostRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgsV1MaintenancePostRequestInner:
        """Test OrgsV1MaintenancePostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgsV1MaintenancePostRequestInner`
        """
        model = OrgsV1MaintenancePostRequestInner()
        if include_optional:
            return OrgsV1MaintenancePostRequestInner(
    ...
    def testOrgsV1MaintenancePostRequestInner(self):
        """Test OrgsV1MaintenancePostRequestInner"""
