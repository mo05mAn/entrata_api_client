...
class TestGetPurchaseOrdersMethod(unittest.TestCase):
    """GetPurchaseOrdersMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPurchaseOrdersMethod:
        """Test GetPurchaseOrdersMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPurchaseOrdersMethod`
        """
        model = GetPurchaseOrdersMethod()
        if include_optional:
            return GetPurchaseOrdersMethod(
                ...
                params = openapi_client.models.get_purchase_orders_method_params.getPurchaseOrders_method_params(
                    ...
                    created_on_from = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    created_on_to = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    po_status_ids = 56, 
                    po_type_ids = 56, 
                    purchase_order_approval_type_ids = 56, )
            )
        else:
            return GetPurchaseOrdersMethod(
                name = 'getPurchaseOrders',
    ...
    def testGetPurchaseOrdersMethod(self):
        """Test GetPurchaseOrdersMethod"""
