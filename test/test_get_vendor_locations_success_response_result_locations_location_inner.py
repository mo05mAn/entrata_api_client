...
class TestGetVendorLocationsSuccessResponseResultLocationsLocationInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultLocationsLocationInner:
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultLocationsLocationInner`
        """
        model = GetVendorLocationsSuccessResponseResultLocationsLocationInner()
        if include_optional:
            return GetVendorLocationsSuccessResponseResultLocationsLocationInner(
                vendor_id = '2726',
    ...
    def testGetVendorLocationsSuccessResponseResultLocationsLocationInner(self):
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInner"""
