...
class TestUpdateApplicationSuccessResponseResponseResultApplication(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateApplicationSuccessResponseResponseResultApplication:
        """Test UpdateApplicationSuccessResponseResponseResultApplication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateApplicationSuccessResponseResponseResultApplication`
        """
        model = UpdateApplicationSuccessResponseResponseResultApplication()
        if include_optional:
            return UpdateApplicationSuccessResponseResponseResultApplication(
                status = 'Success',
    ...
    def testUpdateApplicationSuccessResponseResponseResultApplication(self):
        """Test UpdateApplicationSuccessResponseResponseResultApplication"""
