...
class TestGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability(unittest.TestCase):
    """GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability:
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability`
        """
        model = GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability()
        if include_optional:
            return GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability(
    ...
    def testGetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability(self):
        """Test GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability"""
