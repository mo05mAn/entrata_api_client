...
class TestSendVendorsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendVendorsMethodParams:
        """Test SendVendorsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVendorsMethodParams`
        """
        model = SendVendorsMethodParams()
        if include_optional:
            return SendVendorsMethodParams(
                business_name = 'Vendor name',
                name_on_tax_return = 'Legal entity name',
                remittance_name = 'header',
                ap_payment_type_id = 12345,
    ...
    def testSendVendorsMethodParams(self):
        """Test SendVendorsMethodParams"""
