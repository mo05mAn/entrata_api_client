...
class TestGetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices()
        if include_optional:
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices"""
