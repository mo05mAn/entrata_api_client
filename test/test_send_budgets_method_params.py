...
class TestSendBudgetsMethodParams(unittest.TestCase):
    """SendBudgetsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendBudgetsMethodParams:
        """Test SendBudgetsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetsMethodParams`
        """
        model = SendBudgetsMethodParams()
        if include_optional:
            return SendBudgetsMethodParams(
                property_id = 123456,
                budget_name = 'budgets name 1',
                fiscal_year = 56,
                fiscal_start_month = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                fiscal_end_month = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                id = 123,
                budget_month = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                amount = 56
            )
        else:
            return SendBudgetsMethodParams(
    ...
    def testSendBudgetsMethodParams(self):
        """Test SendBudgetsMethodParams"""
