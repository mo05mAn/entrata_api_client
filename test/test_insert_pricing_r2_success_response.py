...
class TestInsertPricingR2SuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InsertPricingR2SuccessResponse:
        """Test InsertPricingR2SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingR2SuccessResponse`
        """
        model = InsertPricingR2SuccessResponse()
        if include_optional:
    ...
    def testInsertPricingR2SuccessResponse(self):
        """Test InsertPricingR2SuccessResponse"""
