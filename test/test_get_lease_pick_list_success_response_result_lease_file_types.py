...
class TestGetLeasePickListSuccessResponseResultLeaseFileTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultLeaseFileTypes:
        """Test GetLeasePickListSuccessResponseResultLeaseFileTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultLeaseFileTypes`
        """
        model = GetLeasePickListSuccessResponseResultLeaseFileTypes()
        if include_optional:
    ...
    def testGetLeasePickListSuccessResponseResultLeaseFileTypes(self):
        """Test GetLeasePickListSuccessResponseResultLeaseFileTypes"""
