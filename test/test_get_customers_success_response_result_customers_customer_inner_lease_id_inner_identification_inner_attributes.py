...
class TestGetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes(unittest.TestCase):
    """GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes()
        if include_optional:
            return GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes(
                id_type = 'Lease Id',
                id_rank = 'primary',
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes"""
