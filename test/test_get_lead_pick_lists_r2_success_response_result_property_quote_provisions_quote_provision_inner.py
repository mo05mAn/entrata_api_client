...
class TestGetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner:
        """Test GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner`
        """
        model = GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner(
    ...
    def testGetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner(self):
        """Test GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner"""
