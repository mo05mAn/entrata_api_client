...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner()
        if include_optional:
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner"""
