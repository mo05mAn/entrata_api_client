...
class TestGetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInner:
        """Test GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInner`
        """
    ...
    def testGetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInner(self):
        """Test GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInner"""
