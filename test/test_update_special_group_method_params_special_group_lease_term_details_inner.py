...
class TestUpdateSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner(unittest.TestCase):
    """UpdateSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner:
        """Test UpdateSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner`
        """
        model = UpdateSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner()
        if include_optional:
            return UpdateSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner(
                lease_term_id = '55555',
    ...
    def testUpdateSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner(self):
        """Test UpdateSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner"""
