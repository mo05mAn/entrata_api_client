...
class TestGetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits(unittest.TestCase):
    """GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits:
        """Test GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits`
        """
        model = GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits()
        if include_optional:
            return GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits(
                property_unit = [
    ...
    def testGetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits(self):
        """Test GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits"""
