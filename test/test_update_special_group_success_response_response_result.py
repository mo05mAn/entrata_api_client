...
class TestUpdateSpecialGroupSuccessResponseResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateSpecialGroupSuccessResponseResponseResult:
        """Test UpdateSpecialGroupSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpecialGroupSuccessResponseResponseResult`
        """
        model = UpdateSpecialGroupSuccessResponseResponseResult()
        if include_optional:
            return UpdateSpecialGroupSuccessResponseResponseResult(
                status = 'success',
    ...
    def testUpdateSpecialGroupSuccessResponseResponseResult(self):
        """Test UpdateSpecialGroupSuccessResponseResponseResult"""
