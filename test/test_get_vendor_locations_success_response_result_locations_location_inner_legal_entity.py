...
class TestGetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity:
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity`
        """
        model = GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity()
        if include_optional:
    ...
    def testGetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity(self):
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity"""
