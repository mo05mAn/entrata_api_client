...
class TestGetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents(unittest.TestCase):
    """GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents:
        """Test GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents`
        """
        model = GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents()
        if include_optional:
            return GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents(
    ...
    def testGetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents(self):
        """Test GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents"""
