...
class TestSendApplicationVehiclesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationVehiclesSuccessResponse:
        """Test SendApplicationVehiclesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationVehiclesSuccessResponse`
        """
    ...
    def testSendApplicationVehiclesSuccessResponse(self):
        """Test SendApplicationVehiclesSuccessResponse"""
