...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner`
        """
        model = GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner()
        if include_optional:
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner"""
