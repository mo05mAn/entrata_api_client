...
class TestGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations:
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations`
        """
        model = GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations()
        if include_optional:
            return GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations(
                level_id = '1',
                level_name = 'XYZ',
                unit_count = 1,
                references = [
    ...
    def testGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations(self):
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations"""
