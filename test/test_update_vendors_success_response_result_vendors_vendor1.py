...
class TestUpdateVendorsSuccessResponseResultVendorsVendor1(unittest.TestCase):
    """UpdateVendorsSuccessResponseResultVendorsVendor1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateVendorsSuccessResponseResultVendorsVendor1:
        """Test UpdateVendorsSuccessResponseResultVendorsVendor1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateVendorsSuccessResponseResultVendorsVendor1`
        """
        model = UpdateVendorsSuccessResponseResultVendorsVendor1()
        if include_optional:
            return UpdateVendorsSuccessResponseResultVendorsVendor1(
    ...
    def testUpdateVendorsSuccessResponseResultVendorsVendor1(self):
        """Test UpdateVendorsSuccessResponseResultVendorsVendor1"""
