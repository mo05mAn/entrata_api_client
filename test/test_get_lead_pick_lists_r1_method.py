...
class TestGetLeadPickListsR1Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1Method:
        """Test GetLeadPickListsR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1Method`
        """
        model = GetLeadPickListsR1Method()
        if include_optional:
    ...
    def testGetLeadPickListsR1Method(self):
        """Test GetLeadPickListsR1Method"""
