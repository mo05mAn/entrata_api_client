...
class TestGetLeaseDocumentsListSuccessResponseResultLeaseDocuments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsListSuccessResponseResultLeaseDocuments:
        """Test GetLeaseDocumentsListSuccessResponseResultLeaseDocuments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsListSuccessResponseResultLeaseDocuments`
        """
        model = GetLeaseDocumentsListSuccessResponseResultLeaseDocuments()
        if include_optional:
    ...
    def testGetLeaseDocumentsListSuccessResponseResultLeaseDocuments(self):
        """Test GetLeaseDocumentsListSuccessResponseResultLeaseDocuments"""
