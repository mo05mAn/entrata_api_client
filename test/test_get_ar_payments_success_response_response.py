...
class TestGetArPaymentsSuccessResponseResponse(unittest.TestCase):
    """GetArPaymentsSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetArPaymentsSuccessResponseResponse:
        """Test GetArPaymentsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArPaymentsSuccessResponseResponse`
        """
        model = GetArPaymentsSuccessResponseResponse()
        if include_optional:
            return GetArPaymentsSuccessResponseResponse(
                request_id = '15',
                code = '200',
    ...
    def testGetArPaymentsSuccessResponseResponse(self):
        """Test GetArPaymentsSuccessResponseResponse"""
