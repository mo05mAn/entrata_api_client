...
class TestGetMarketingPreferencePickListSuccessResponseResponse(unittest.TestCase):
    """GetMarketingPreferencePickListSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencePickListSuccessResponseResponse:
        """Test GetMarketingPreferencePickListSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencePickListSuccessResponseResponse`
        """
        model = GetMarketingPreferencePickListSuccessResponseResponse()
        if include_optional:
            return GetMarketingPreferencePickListSuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testGetMarketingPreferencePickListSuccessResponseResponse(self):
        """Test GetMarketingPreferencePickListSuccessResponseResponse"""
