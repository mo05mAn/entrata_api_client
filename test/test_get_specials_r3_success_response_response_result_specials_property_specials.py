...
class TestGetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecials(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecials:
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecials`
        """
        model = GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecials()
        if include_optional:
    ...
    def testGetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecials(self):
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecials"""
