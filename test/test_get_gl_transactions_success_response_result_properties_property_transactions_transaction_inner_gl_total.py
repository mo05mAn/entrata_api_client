...
class TestGetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal(unittest.TestCase):
    """GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal:
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal`
        """
        model = GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal()
        if include_optional:
            return GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal(
    ...
    def testGetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal(self):
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal"""
