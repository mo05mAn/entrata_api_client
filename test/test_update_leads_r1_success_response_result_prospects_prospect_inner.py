...
class TestUpdateLeadsR1SuccessResponseResultProspectsProspectInner(unittest.TestCase):
    """UpdateLeadsR1SuccessResponseResultProspectsProspectInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLeadsR1SuccessResponseResultProspectsProspectInner:
        """Test UpdateLeadsR1SuccessResponseResultProspectsProspectInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeadsR1SuccessResponseResultProspectsProspectInner`
        """
        model = UpdateLeadsR1SuccessResponseResultProspectsProspectInner()
        if include_optional:
            return UpdateLeadsR1SuccessResponseResultProspectsProspectInner(
    ...
    def testUpdateLeadsR1SuccessResponseResultProspectsProspectInner(self):
        """Test UpdateLeadsR1SuccessResponseResultProspectsProspectInner"""
