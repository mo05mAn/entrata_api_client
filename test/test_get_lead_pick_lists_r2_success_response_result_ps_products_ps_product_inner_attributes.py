...
class TestGetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes:
        """Test GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes`
        """
        model = GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes(
                id = '7',
                name = 'API Services'
            )
        else:
    ...
    def testGetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes(self):
        """Test GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes"""
