...
class TestSendLeasesSuccessResponseResultLeasesLeaseInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeasesSuccessResponseResultLeasesLeaseInner:
        """Test SendLeasesSuccessResponseResultLeasesLeaseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeasesSuccessResponseResultLeasesLeaseInner`
        """
        model = SendLeasesSuccessResponseResultLeasesLeaseInner()
        if include_optional:
            return SendLeasesSuccessResponseResultLeasesLeaseInner(
                node = '1',
                lease_id = '123456',
                status = 'Success',
    ...
    def testSendLeasesSuccessResponseResultLeasesLeaseInner(self):
        """Test SendLeasesSuccessResponseResultLeasesLeaseInner"""
