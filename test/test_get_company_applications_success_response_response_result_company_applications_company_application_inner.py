...
class TestGetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner(unittest.TestCase):
    """GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner:
        """Test GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner`
        """
        model = GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner()
        if include_optional:
            return GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner(
    ...
    def testGetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner(self):
        """Test GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner"""
