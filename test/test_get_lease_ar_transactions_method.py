...
class TestGetLeaseArTransactionsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseArTransactionsMethod:
        """Test GetLeaseArTransactionsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseArTransactionsMethod`
        """
        model = GetLeaseArTransactionsMethod()
        if include_optional:
    ...
    def testGetLeaseArTransactionsMethod(self):
        """Test GetLeaseArTransactionsMethod"""
