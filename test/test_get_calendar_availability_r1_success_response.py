...
class TestGetCalendarAvailabilityR1SuccessResponse(unittest.TestCase):
    """GetCalendarAvailabilityR1SuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR1SuccessResponse:
        """Test GetCalendarAvailabilityR1SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR1SuccessResponse`
        """
        model = GetCalendarAvailabilityR1SuccessResponse()
        if include_optional:
            return GetCalendarAvailabilityR1SuccessResponse(
                request_id = '15',
                code = 200,
                result = entrata_api_client.models.get_calendar_availability_r1_success_response_result.getCalendarAvailability_r1_SuccessResponse_result(
    ...
    def testGetCalendarAvailabilityR1SuccessResponse(self):
        """Test GetCalendarAvailabilityR1SuccessResponse"""
