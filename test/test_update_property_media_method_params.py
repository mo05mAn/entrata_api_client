...
class TestUpdatePropertyMediaMethodParams(unittest.TestCase):
    """UpdatePropertyMediaMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePropertyMediaMethodParams:
        """Test UpdatePropertyMediaMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyMediaMethodParams`
        """
        model = UpdatePropertyMediaMethodParams()
        if include_optional:
            return UpdatePropertyMediaMethodParams(
                property_id = '999999',
                media = [
                    null
                    ]
    ...
    def testUpdatePropertyMediaMethodParams(self):
        """Test UpdatePropertyMediaMethodParams"""
