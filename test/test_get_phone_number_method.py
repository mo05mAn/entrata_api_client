...
class TestGetPhoneNumberMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPhoneNumberMethod:
        """Test GetPhoneNumberMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPhoneNumberMethod`
        """
        model = GetPhoneNumberMethod()
        if include_optional:
    ...
    def testGetPhoneNumberMethod(self):
        """Test GetPhoneNumberMethod"""
