...
class TestUpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes(unittest.TestCase):
    """UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes:
        """Test UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes`
        """
        model = UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes()
        if include_optional:
            return UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes(
                id = '32847564',
                node = '1',
                status = 'Success',
    ...
    def testUpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes(self):
        """Test UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes"""
