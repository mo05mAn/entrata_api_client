...
class TestGetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer(unittest.TestCase):
    """GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer:
        """Test GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer`
        """
        model = GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer()
        if include_optional:
            return GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer(
                identification = [
    ...
    def testGetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer(self):
        """Test GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer"""
