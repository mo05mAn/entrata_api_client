...
class TestGetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddresses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddresses:
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddresses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddresses`
        """
        model = GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddresses()
        if include_optional:
    ...
    def testGetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddresses(self):
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddresses"""
