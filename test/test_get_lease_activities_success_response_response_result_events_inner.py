...
class TestGetLeaseActivitiesSuccessResponseResponseResultEventsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseActivitiesSuccessResponseResponseResultEventsInner:
        """Test GetLeaseActivitiesSuccessResponseResponseResultEventsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseActivitiesSuccessResponseResponseResultEventsInner`
        """
        model = GetLeaseActivitiesSuccessResponseResponseResultEventsInner()
        if include_optional:
            return GetLeaseActivitiesSuccessResponseResponseResultEventsInner(
                event_id = 123456,
                type_id = 3,
                lease_id = 123456,
    ...
    def testGetLeaseActivitiesSuccessResponseResponseResultEventsInner(self):
        """Test GetLeaseActivitiesSuccessResponseResponseResultEventsInner"""
