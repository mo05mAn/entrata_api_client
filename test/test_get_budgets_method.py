...
class TestGetBudgetsMethod(unittest.TestCase):
    """GetBudgetsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBudgetsMethod:
        """Test GetBudgetsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBudgetsMethod`
        """
        model = GetBudgetsMethod()
        if include_optional:
            return GetBudgetsMethod(
                name = 'getBudgets',
                version = 'r1',
