...
class TestSendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies:
        """Test SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies`
        """
        model = SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies()
        if include_optional:
    ...
    def testSendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies(self):
        """Test SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies"""
