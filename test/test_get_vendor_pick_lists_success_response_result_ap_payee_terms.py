...
class TestGetVendorPickListsSuccessResponseResultApPayeeTerms(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultApPayeeTerms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultApPayeeTerms:
        """Test GetVendorPickListsSuccessResponseResultApPayeeTerms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultApPayeeTerms`
        """
        model = GetVendorPickListsSuccessResponseResultApPayeeTerms()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultApPayeeTerms(
                ap_payee_term = [
    ...
    def testGetVendorPickListsSuccessResponseResultApPayeeTerms(self):
        """Test GetVendorPickListsSuccessResponseResultApPayeeTerms"""
