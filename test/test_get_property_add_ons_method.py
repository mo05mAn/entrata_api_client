...
class TestGetPropertyAddOnsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyAddOnsMethod:
        """Test GetPropertyAddOnsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAddOnsMethod`
        """
        model = GetPropertyAddOnsMethod()
        if include_optional:
    ...
    def testGetPropertyAddOnsMethod(self):
        """Test GetPropertyAddOnsMethod"""
