...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes(unittest.TestCase):
    """GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes(
                max = '850',
                min = '850'
            )
        else:
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes"""
