...
class TestGetSpecialsR4Method(unittest.TestCase):
    """GetSpecialsR4Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4Method:
        """Test GetSpecialsR4Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4Method`
        """
        model = GetSpecialsR4Method()
        if include_optional:
            return GetSpecialsR4Method(
                name = 'getSpecials',
                version = 'r4',
    ...
    def testGetSpecialsR4Method(self):
        """Test GetSpecialsR4Method"""
