...
class TestGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes:
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes(
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes"""
