...
class TestGetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts(unittest.TestCase):
    """GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts:
        """Test GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts`
        """
        model = GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts()
        if include_optional:
            return GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts(
    ...
    def testGetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts(self):
        """Test GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts"""
