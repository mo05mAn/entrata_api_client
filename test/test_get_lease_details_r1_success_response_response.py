...
class TestGetLeaseDetailsR1SuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponse:
        """Test GetLeaseDetailsR1SuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponse`
        """
        model = GetLeaseDetailsR1SuccessResponseResponse()
        if include_optional:
    ...
    def testGetLeaseDetailsR1SuccessResponseResponse(self):
        """Test GetLeaseDetailsR1SuccessResponseResponse"""
