...
class TestGetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner(unittest.TestCase):
    """GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner:
        """Test GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner`
        """
        model = GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner()
        if include_optional:
            return GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner(
                name = 'Cancelled',
                id = 57024
            )
        else:
    ...
    def testGetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner(self):
        """Test GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner"""
