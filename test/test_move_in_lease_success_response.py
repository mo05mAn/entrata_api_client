...
class TestMoveInLeaseSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MoveInLeaseSuccessResponse:
        """Test MoveInLeaseSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveInLeaseSuccessResponse`
        """
        model = MoveInLeaseSuccessResponse()
        if include_optional:
    ...
    def testMoveInLeaseSuccessResponse(self):
        """Test MoveInLeaseSuccessResponse"""
