...
class TestUpdateWorkOrdersR1Method(unittest.TestCase):
    """UpdateWorkOrdersR1Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWorkOrdersR1Method:
        """Test UpdateWorkOrdersR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWorkOrdersR1Method`
        """
        model = UpdateWorkOrdersR1Method()
        if include_optional:
            return UpdateWorkOrdersR1Method(
    ...
    def testUpdateWorkOrdersR1Method(self):
        """Test UpdateWorkOrdersR1Method"""
