...
class TestOrgsV1CommunicationsPostRequestInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrgsV1CommunicationsPostRequestInner:
        """Test OrgsV1CommunicationsPostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgsV1CommunicationsPostRequestInner`
        """
    ...
    def testOrgsV1CommunicationsPostRequestInner(self):
        """Test OrgsV1CommunicationsPostRequestInner"""
