...
class TestGetCalendarAvailabilityR1MethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR1MethodParams:
        """Test GetCalendarAvailabilityR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR1MethodParams`
        """
        model = GetCalendarAvailabilityR1MethodParams()
        if include_optional:
            return GetCalendarAvailabilityR1MethodParams(
                property_id = 123456,
    ...
    def testGetCalendarAvailabilityR1MethodParams(self):
        """Test GetCalendarAvailabilityR1MethodParams"""
