...
class TestGetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner(unittest.TestCase):
    """GetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner:
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner`
        """
        model = GetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner()
        if include_optional:
            return GetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner(
                id = '26685',
                name = 'Corporate',
    ...
    def testGetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner(self):
        """Test GetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner"""
