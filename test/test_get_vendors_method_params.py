...
class TestGetVendorsMethodParams(unittest.TestCase):
    """GetVendorsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorsMethodParams:
        """Test GetVendorsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorsMethodParams`
        """
        model = GetVendorsMethodParams()
        if include_optional:
            return GetVendorsMethodParams(
                vendor_ids = 56,
    ...
    def testGetVendorsMethodParams(self):
        """Test GetVendorsMethodParams"""
