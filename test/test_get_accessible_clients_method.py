...
class TestGetAccessibleClientsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccessibleClientsMethod:
        """Test GetAccessibleClientsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessibleClientsMethod`
        """
        model = GetAccessibleClientsMethod()
        if include_optional:
            return GetAccessibleClientsMethod(
    ...
    def testGetAccessibleClientsMethod(self):
        """Test GetAccessibleClientsMethod"""
