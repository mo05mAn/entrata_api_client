...
class TestSendRoommateGroupsR2MethodParams(unittest.TestCase):
    """SendRoommateGroupsR2MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRoommateGroupsR2MethodParams:
        """Test SendRoommateGroupsR2MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRoommateGroupsR2MethodParams`
        """
        model = SendRoommateGroupsR2MethodParams()
        if include_optional:
            return SendRoommateGroupsR2MethodParams(
    ...
    def testSendRoommateGroupsR2MethodParams(self):
        """Test SendRoommateGroupsR2MethodParams"""
