...
class TestGetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner(unittest.TestCase):
    """GetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner:
        """Test GetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner`
        """
        model = GetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner()
        if include_optional:
            return GetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner(
                id = 1,
                system_code = 'LEASE',
    ...
    def testGetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner(self):
        """Test GetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner"""
