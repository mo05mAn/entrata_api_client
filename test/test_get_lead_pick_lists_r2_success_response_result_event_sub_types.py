...
class TestGetLeadPickListsR2SuccessResponseResultEventSubTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultEventSubTypes:
        """Test GetLeadPickListsR2SuccessResponseResultEventSubTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultEventSubTypes`
        """
        model = GetLeadPickListsR2SuccessResponseResultEventSubTypes()
        if include_optional:
    ...
    def testGetLeadPickListsR2SuccessResponseResultEventSubTypes(self):
        """Test GetLeadPickListsR2SuccessResponseResultEventSubTypes"""
