...
class TestGetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner(unittest.TestCase):
    """GetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner:
        """Test GetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner`
        """
        model = GetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner()
        if include_optional:
            return GetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner(
                frequency_id = 5,
    ...
    def testGetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner(self):
        """Test GetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner"""
