...
class TestGetUnitTypesSuccessResponseResponse(unittest.TestCase):
    """GetUnitTypesSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUnitTypesSuccessResponseResponse:
        """Test GetUnitTypesSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitTypesSuccessResponseResponse`
        """
        model = GetUnitTypesSuccessResponseResponse()
        if include_optional:
            return GetUnitTypesSuccessResponseResponse(
                request_id = 15,
    ...
    def testGetUnitTypesSuccessResponseResponse(self):
        """Test GetUnitTypesSuccessResponseResponse"""
