...
class TestSendSpecialGroupMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendSpecialGroupMethod:
        """Test SendSpecialGroupMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSpecialGroupMethod`
        """
        model = SendSpecialGroupMethod()
        if include_optional:
    ...
    def testSendSpecialGroupMethod(self):
        """Test SendSpecialGroupMethod"""
