...
class TestGetJobCategoriesSuccessResponseResult(unittest.TestCase):
    """GetJobCategoriesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobCategoriesSuccessResponseResult:
        """Test GetJobCategoriesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCategoriesSuccessResponseResult`
        """
        model = GetJobCategoriesSuccessResponseResult()
        if include_optional:
            return GetJobCategoriesSuccessResponseResult(
    ...
    def testGetJobCategoriesSuccessResponseResult(self):
        """Test GetJobCategoriesSuccessResponseResult"""
