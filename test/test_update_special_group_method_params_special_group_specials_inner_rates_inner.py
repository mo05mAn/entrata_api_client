...
class TestUpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner(unittest.TestCase):
    """UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner:
        """Test UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner`
        """
        model = UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner()
        if include_optional:
            return UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner(
                ar_code_id = '444444',
                ar_trigger_id = '201',
                ar_code_type_id = '2',
    ...
    def testUpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner(self):
        """Test UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner"""
