...
class TestUpdateLeadsR1MethodParams(unittest.TestCase):
    """UpdateLeadsR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLeadsR1MethodParams:
        """Test UpdateLeadsR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeadsR1MethodParams`
        """
        model = UpdateLeadsR1MethodParams()
        if include_optional:
            return UpdateLeadsR1MethodParams(
                property_id = 123456,
                application_id = 123
            )
        else:
    ...
    def testUpdateLeadsR1MethodParams(self):
        """Test UpdateLeadsR1MethodParams"""
