...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes(unittest.TestCase):
    """GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes(
                count = '0',
                description = 'Cat',
                pet_type = 'Cat',
                size = 'Medium',
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes"""
