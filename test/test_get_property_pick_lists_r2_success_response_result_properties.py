...
class TestGetPropertyPickListsR2SuccessResponseResultProperties(unittest.TestCase):
    """GetPropertyPickListsR2SuccessResponseResultProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponseResultProperties:
        """Test GetPropertyPickListsR2SuccessResponseResultProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponseResultProperties`
        """
        model = GetPropertyPickListsR2SuccessResponseResultProperties()
        if include_optional:
            return GetPropertyPickListsR2SuccessResponseResultProperties(
                var_property = [
    ...
    def testGetPropertyPickListsR2SuccessResponseResultProperties(self):
        """Test GetPropertyPickListsR2SuccessResponseResultProperties"""
