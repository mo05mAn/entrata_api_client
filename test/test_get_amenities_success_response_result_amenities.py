...
class TestGetAmenitiesSuccessResponseResultAmenities(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenities:
        """Test GetAmenitiesSuccessResponseResultAmenities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenities`
        """
        model = GetAmenitiesSuccessResponseResultAmenities()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenities(
    ...
    def testGetAmenitiesSuccessResponseResultAmenities(self):
        """Test GetAmenitiesSuccessResponseResultAmenities"""
