...
class TestUpdateScheduledChargesR1SuccessResponse(unittest.TestCase):
    """UpdateScheduledChargesR1SuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR1SuccessResponse:
        """Test UpdateScheduledChargesR1SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR1SuccessResponse`
        """
        model = UpdateScheduledChargesR1SuccessResponse()
        if include_optional:
            return UpdateScheduledChargesR1SuccessResponse(
                request_id = '15',
    ...
    def testUpdateScheduledChargesR1SuccessResponse(self):
        """Test UpdateScheduledChargesR1SuccessResponse"""
