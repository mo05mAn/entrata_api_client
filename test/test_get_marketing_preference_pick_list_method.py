...
class TestGetMarketingPreferencePickListMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencePickListMethod:
        """Test GetMarketingPreferencePickListMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencePickListMethod`
        """
        model = GetMarketingPreferencePickListMethod()
        if include_optional:
            return GetMarketingPreferencePickListMethod(
    ...
    def testGetMarketingPreferencePickListMethod(self):
        """Test GetMarketingPreferencePickListMethod"""
