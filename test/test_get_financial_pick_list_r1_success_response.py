...
class TestGetFinancialPickListR1SuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponse:
        """Test GetFinancialPickListR1SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponse`
        """
        model = GetFinancialPickListR1SuccessResponse()
        if include_optional:
    ...
    def testGetFinancialPickListR1SuccessResponse(self):
        """Test GetFinancialPickListR1SuccessResponse"""
