...
class TestGetFinancialPickListR2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2:
        """Test GetFinancialPickListR2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2`
        """
    ...
    def testGetFinancialPickListR2(self):
        """Test GetFinancialPickListR2"""
