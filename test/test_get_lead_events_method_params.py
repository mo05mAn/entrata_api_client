...
class TestGetLeadEventsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadEventsMethodParams:
        """Test GetLeadEventsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadEventsMethodParams`
        """
        model = GetLeadEventsMethodParams()
        if include_optional:
            return GetLeadEventsMethodParams(
                property_id = 123456,
                application_id = 1234,
    ...
    def testGetLeadEventsMethodParams(self):
        """Test GetLeadEventsMethodParams"""
