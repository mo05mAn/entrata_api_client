...
class TestSendScheduledCharges(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendScheduledCharges:
        """Test SendScheduledCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendScheduledCharges`
        """
    ...
    def testSendScheduledCharges(self):
        """Test SendScheduledCharges"""
