...
class TestGetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner(
                id = 1,
                name = 'GJ'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner"""
