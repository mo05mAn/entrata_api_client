...
class TestSendCustomerTestimonialsMethod(unittest.TestCase):
    """SendCustomerTestimonialsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendCustomerTestimonialsMethod:
        """Test SendCustomerTestimonialsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendCustomerTestimonialsMethod`
        """
        model = SendCustomerTestimonialsMethod()
        if include_optional:
            return SendCustomerTestimonialsMethod(
                ...
                params = entrata_api_client.models.send_customer_testimonials_method_params.sendCustomerTestimonials_method_params(
                    ...
                    name = 'Bryan Murfy', 
                    title = 'So far a great experience', 
                    review = 'This is a nice community that makes you feel like you are a valued memeber.', 
                    recommend_to_friend = 0, 
                    authorize_to_show_on_corporate_sites = False, 
                    rating_type_id = 1, 
                    rating = 3, 
                    auto_approve_for_prospect_portal = 0, 
                    auto_approve_for_vacancy = 0, 
                    property_id = 123456, 
                    testimonial_datetime = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    transmission_vendor_id = 123456, 
                    email = 'br@mycomp.com', 
                    property_response = 'Property Response...', )
            )
        else:
            return SendCustomerTestimonialsMethod(
                name = 'sendCustomerTestimonials',
    ...
    def testSendCustomerTestimonialsMethod(self):
        """Test SendCustomerTestimonialsMethod"""
