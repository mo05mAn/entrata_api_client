...
class TestGetUnitsAvailabilityAndPricingMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetUnitsAvailabilityAndPricingMethodParams:
        """Test GetUnitsAvailabilityAndPricingMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUnitsAvailabilityAndPricingMethodParams`
        """
        model = GetUnitsAvailabilityAndPricingMethodParams()
        if include_optional:
            return GetUnitsAvailabilityAndPricingMethodParams(
                property_id = 12345,
                floorplan_id = 12345,
                unit_type_id = 12345,
    ...
    def testGetUnitsAvailabilityAndPricingMethodParams(self):
        """Test GetUnitsAvailabilityAndPricingMethodParams"""
