...
class TestSendSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner:
        """Test SendSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner`
        """
        model = SendSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner()
        if include_optional:
            return SendSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner(
                lease_term_id = '12345',
    ...
    def testSendSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner(self):
        """Test SendSpecialGroupMethodParamsSpecialGroupLeaseTermDetailsInner"""
