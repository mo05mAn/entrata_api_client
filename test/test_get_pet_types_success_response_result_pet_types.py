...
class TestGetPetTypesSuccessResponseResultPetTypes(unittest.TestCase):
    """GetPetTypesSuccessResponseResultPetTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPetTypesSuccessResponseResultPetTypes:
        """Test GetPetTypesSuccessResponseResultPetTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPetTypesSuccessResponseResultPetTypes`
        """
        model = GetPetTypesSuccessResponseResultPetTypes()
        if include_optional:
            return GetPetTypesSuccessResponseResultPetTypes(
                var_property = {
    ...
    def testGetPetTypesSuccessResponseResultPetTypes(self):
        """Test GetPetTypesSuccessResponseResultPetTypes"""
