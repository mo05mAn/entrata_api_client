...
class TestSendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner(unittest.TestCase):
    """SendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner:
        """Test SendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner`
        """
        model = SendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner()
        if include_optional:
            return SendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner(
                node = 1,
                status = 'Success',
                amenity_id = 1200111,
                rate_association_id = 9050818,
                name = 'P Amenity 1011',
    ...
    def testSendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner(self):
        """Test SendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner"""
