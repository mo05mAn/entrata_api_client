...
class TestGetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner:
        """Test GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner`
        """
        model = GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner(
    ...
    def testGetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner(self):
        """Test GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner"""
