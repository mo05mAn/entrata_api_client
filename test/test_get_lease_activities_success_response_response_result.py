...
class TestGetLeaseActivitiesSuccessResponseResponseResult(unittest.TestCase):
    """GetLeaseActivitiesSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseActivitiesSuccessResponseResponseResult:
        """Test GetLeaseActivitiesSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseActivitiesSuccessResponseResponseResult`
        """
        model = GetLeaseActivitiesSuccessResponseResponseResult()
        if include_optional:
            return GetLeaseActivitiesSuccessResponseResponseResult(
                events = [
    ...
    def testGetLeaseActivitiesSuccessResponseResponseResult(self):
        """Test GetLeaseActivitiesSuccessResponseResponseResult"""
