...
class TestGetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesProperty(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesProperty:
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesProperty`
        """
    ...
    def testGetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesProperty(self):
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesProperty"""
