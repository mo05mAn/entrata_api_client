...
class TestGetPropertyPickListsR2SuccessResponseResultSearchAreaStates(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponseResultSearchAreaStates:
        """Test GetPropertyPickListsR2SuccessResponseResultSearchAreaStates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponseResultSearchAreaStates`
        """
        model = GetPropertyPickListsR2SuccessResponseResultSearchAreaStates()
        if include_optional:
    ...
    def testGetPropertyPickListsR2SuccessResponseResultSearchAreaStates(self):
        """Test GetPropertyPickListsR2SuccessResponseResultSearchAreaStates"""
