...
class TestGetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner(
                id = 1,
                name = 'Standard Group'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner"""
