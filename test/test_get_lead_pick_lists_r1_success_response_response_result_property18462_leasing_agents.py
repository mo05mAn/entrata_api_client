...
class TestGetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents:
        """Test GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents`
        """
        model = GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents()
        if include_optional:
    ...
    def testGetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents(self):
        """Test GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents"""
