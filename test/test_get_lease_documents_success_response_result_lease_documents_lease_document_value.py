...
class TestGetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue(unittest.TestCase):
    """GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue:
        """Test GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue`
        """
        model = GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue()
        if include_optional:
            return GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue(
                id = 3922962,
                applies_to = 'All',
                type = 'Transfer Document (Transfer Document - UTS)',
                title = 'Scheduled Transfer Statement',
                name = 'transfer_statement_1419410849_1426025528.pdf',
                path = 'transfer_statement/2014/12/24/10548763/scheduled_transfer/',
                file_data = '',
                added_on = '12/24/2014 01:47:33'
            )
        else:
            return GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue(
                id = 3922962,
    ...
    def testGetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue(self):
        """Test GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue"""
