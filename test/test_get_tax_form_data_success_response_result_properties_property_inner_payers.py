...
class TestGetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers:
        """Test GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers`
        """
        model = GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers()
        if include_optional:
    ...
    def testGetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers(self):
        """Test GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers"""
