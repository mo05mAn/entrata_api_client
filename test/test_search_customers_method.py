...
class TestSearchCustomersMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SearchCustomersMethod:
        """Test SearchCustomersMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchCustomersMethod`
        """
        model = SearchCustomersMethod()
        if include_optional:
    ...
    def testSearchCustomersMethod(self):
        """Test SearchCustomersMethod"""
