...
class TestGetGlTreesR2SuccessResponseResponseResult(unittest.TestCase):
    """GetGlTreesR2SuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR2SuccessResponseResponseResult:
        """Test GetGlTreesR2SuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR2SuccessResponseResponseResult`
        """
        model = GetGlTreesR2SuccessResponseResponseResult()
        if include_optional:
            return GetGlTreesR2SuccessResponseResponseResult(
    ...
    def testGetGlTreesR2SuccessResponseResponseResult(self):
        """Test GetGlTreesR2SuccessResponseResponseResult"""
