...
class TestSendInvoicesR1SuccessResponseResultApBatch(unittest.TestCase):
    """SendInvoicesR1SuccessResponseResultApBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendInvoicesR1SuccessResponseResultApBatch:
        """Test SendInvoicesR1SuccessResponseResultApBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR1SuccessResponseResultApBatch`
        """
        model = SendInvoicesR1SuccessResponseResultApBatch()
        if include_optional:
            return SendInvoicesR1SuccessResponseResultApBatch(
    ...
    def testSendInvoicesR1SuccessResponseResultApBatch(self):
        """Test SendInvoicesR1SuccessResponseResultApBatch"""
