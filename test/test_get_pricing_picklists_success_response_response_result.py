...
class TestGetPricingPicklistsSuccessResponseResponseResult(unittest.TestCase):
    """GetPricingPicklistsSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResult:
        """Test GetPricingPicklistsSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResult`
        """
        model = GetPricingPicklistsSuccessResponseResponseResult()
        if include_optional:
            return GetPricingPicklistsSuccessResponseResponseResult(
    ...
    def testGetPricingPicklistsSuccessResponseResponseResult(self):
        """Test GetPricingPicklistsSuccessResponseResponseResult"""
