...
class TestGetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner(
                id = 1,
                name = 'GJ'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner"""
