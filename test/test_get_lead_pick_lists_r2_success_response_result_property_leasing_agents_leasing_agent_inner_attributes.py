...
class TestGetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes:
        """Test GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes`
        """
        model = GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes(
                name = 'Carter Babb',
                id = '315879'
            )
        else:
    ...
    def testGetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes(self):
        """Test GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes"""
