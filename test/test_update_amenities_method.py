...
class TestUpdateAmenitiesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesMethod:
        """Test UpdateAmenitiesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesMethod`
        """
        model = UpdateAmenitiesMethod()
        if include_optional:
    ...
    def testUpdateAmenitiesMethod(self):
        """Test UpdateAmenitiesMethod"""
