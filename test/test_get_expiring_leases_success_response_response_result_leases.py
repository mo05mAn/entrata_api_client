...
class TestGetExpiringLeasesSuccessResponseResponseResultLeases(unittest.TestCase):
    """GetExpiringLeasesSuccessResponseResponseResultLeases unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetExpiringLeasesSuccessResponseResponseResultLeases:
        """Test GetExpiringLeasesSuccessResponseResponseResultLeases
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExpiringLeasesSuccessResponseResponseResultLeases`
        """
        model = GetExpiringLeasesSuccessResponseResponseResultLeases()
        if include_optional:
            return GetExpiringLeasesSuccessResponseResponseResultLeases(
                lease = [
    ...
    def testGetExpiringLeasesSuccessResponseResponseResultLeases(self):
        """Test GetExpiringLeasesSuccessResponseResponseResultLeases"""
