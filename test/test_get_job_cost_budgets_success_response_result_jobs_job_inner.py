...
class TestGetJobCostBudgetsSuccessResponseResultJobsJobInner(unittest.TestCase):
    """GetJobCostBudgetsSuccessResponseResultJobsJobInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobCostBudgetsSuccessResponseResultJobsJobInner:
        """Test GetJobCostBudgetsSuccessResponseResultJobsJobInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCostBudgetsSuccessResponseResultJobsJobInner`
        """
        model = GetJobCostBudgetsSuccessResponseResultJobsJobInner()
        if include_optional:
            return GetJobCostBudgetsSuccessResponseResultJobsJobInner(
                property_id = '172775',
                job_id = '1249',
                job_status_id = '1',
    ...
    def testGetJobCostBudgetsSuccessResponseResultJobsJobInner(self):
        """Test GetJobCostBudgetsSuccessResponseResultJobsJobInner"""
