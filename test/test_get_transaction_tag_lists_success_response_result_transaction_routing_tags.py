...
class TestGetTransactionTagListsSuccessResponseResultTransactionRoutingTags(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionTagListsSuccessResponseResultTransactionRoutingTags:
        """Test GetTransactionTagListsSuccessResponseResultTransactionRoutingTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTransactionTagListsSuccessResponseResultTransactionRoutingTags`
        """
        model = GetTransactionTagListsSuccessResponseResultTransactionRoutingTags()
        if include_optional:
    ...
    def testGetTransactionTagListsSuccessResponseResultTransactionRoutingTags(self):
        """Test GetTransactionTagListsSuccessResponseResultTransactionRoutingTags"""
