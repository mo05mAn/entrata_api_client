...
class TestSendPurchaseOrdersSuccessResponseResult(unittest.TestCase):
    """SendPurchaseOrdersSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPurchaseOrdersSuccessResponseResult:
        """Test SendPurchaseOrdersSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPurchaseOrdersSuccessResponseResult`
        """
        model = SendPurchaseOrdersSuccessResponseResult()
        if include_optional:
            return SendPurchaseOrdersSuccessResponseResult(
    ...
    def testSendPurchaseOrdersSuccessResponseResult(self):
        """Test SendPurchaseOrdersSuccessResponseResult"""
