...
class TestOrgsV1VendorsPost200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrgsV1VendorsPost200Response:
        """Test OrgsV1VendorsPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgsV1VendorsPost200Response`
        """
        model = OrgsV1VendorsPost200Response()
        if include_optional:
    ...
    def testOrgsV1VendorsPost200Response(self):
        """Test OrgsV1VendorsPost200Response"""
