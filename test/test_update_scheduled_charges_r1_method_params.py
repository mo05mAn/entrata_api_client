...
class TestUpdateScheduledChargesR1MethodParams(unittest.TestCase):
    """UpdateScheduledChargesR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR1MethodParams:
        """Test UpdateScheduledChargesR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR1MethodParams`
        """
        model = UpdateScheduledChargesR1MethodParams()
        if include_optional:
            return UpdateScheduledChargesR1MethodParams(
                id = 123456,
                property_id = 123456,
                lease_id = 123456,
                amount = 5000,
    ...
    def testUpdateScheduledChargesR1MethodParams(self):
        """Test UpdateScheduledChargesR1MethodParams"""
