...
class TestGetCalendarAvailabilityR2Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR2Method:
        """Test GetCalendarAvailabilityR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR2Method`
        """
        model = GetCalendarAvailabilityR2Method()
        if include_optional:
    ...
    def testGetCalendarAvailabilityR2Method(self):
        """Test GetCalendarAvailabilityR2Method"""
