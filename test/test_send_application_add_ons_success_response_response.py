...
class TestSendApplicationAddOnsSuccessResponseResponse(unittest.TestCase):
    """SendApplicationAddOnsSuccessResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationAddOnsSuccessResponseResponse:
        """Test SendApplicationAddOnsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationAddOnsSuccessResponseResponse`
        """
        model = SendApplicationAddOnsSuccessResponseResponse()
        if include_optional:
            return SendApplicationAddOnsSuccessResponseResponse(
                request_id = '15',
                code = 200,
    ...
    def testSendApplicationAddOnsSuccessResponseResponse(self):
        """Test SendApplicationAddOnsSuccessResponseResponse"""
