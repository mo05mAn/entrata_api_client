...
class TestUpdateBudgetsSuccessResponseResult(unittest.TestCase):
    """UpdateBudgetsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBudgetsSuccessResponseResult:
        """Test UpdateBudgetsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBudgetsSuccessResponseResult`
        """
        model = UpdateBudgetsSuccessResponseResult()
        if include_optional:
            return UpdateBudgetsSuccessResponseResult(
    ...
    def testUpdateBudgetsSuccessResponseResult(self):
        """Test UpdateBudgetsSuccessResponseResult"""
