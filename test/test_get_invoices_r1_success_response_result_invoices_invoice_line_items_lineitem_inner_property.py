...
class TestGetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty(unittest.TestCase):
    """GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty:
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty`
        """
        model = GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty()
        if include_optional:
            return GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty(
                id = '19463',
                name = '22 Exchange',
    ...
    def testGetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty(self):
        """Test GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty"""
