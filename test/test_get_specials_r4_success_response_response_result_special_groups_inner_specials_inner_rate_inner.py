...
class TestGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialsInnerRateInner(unittest.TestCase):
    """GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialsInnerRateInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialsInnerRateInner:
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialsInnerRateInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialsInnerRateInner`
        """
        model = GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialsInnerRateInner()
        if include_optional:
            return GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialsInnerRateInner(
                rate_id = '999999999',
                ar_code_id = '666666',
    ...
    def testGetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialsInnerRateInner(self):
        """Test GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialsInnerRateInner"""
