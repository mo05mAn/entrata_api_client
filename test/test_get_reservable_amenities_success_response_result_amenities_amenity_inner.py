...
class TestGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner(unittest.TestCase):
    """GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner:
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner`
        """
        model = GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner()
        if include_optional:
            return GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner(
                id = '123456',
                name = 'Tennis Court',
    ...
    def testGetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner(self):
        """Test GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner"""
