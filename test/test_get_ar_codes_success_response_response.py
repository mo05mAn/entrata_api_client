...
class TestGetArCodesSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetArCodesSuccessResponseResponse:
        """Test GetArCodesSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArCodesSuccessResponseResponse`
        """
        model = GetArCodesSuccessResponseResponse()
        if include_optional:
    ...
    def testGetArCodesSuccessResponseResponse(self):
        """Test GetArCodesSuccessResponseResponse"""
