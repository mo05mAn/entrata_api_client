...
class TestGetTaxFormDataMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTaxFormDataMethodParams:
        """Test GetTaxFormDataMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxFormDataMethodParams`
        """
        model = GetTaxFormDataMethodParams()
        if include_optional:
            return GetTaxFormDataMethodParams(
                property_ids = 12345,
                start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                generate_for_property_owner = 0,
                owner_ids = '12345',
                is_for_indirect_owner = 0
            )
        else:
            return GetTaxFormDataMethodParams(
        )
    ...
    def testGetTaxFormDataMethodParams(self):
        """Test GetTaxFormDataMethodParams"""
