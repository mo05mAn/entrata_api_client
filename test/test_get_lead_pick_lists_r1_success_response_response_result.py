...
class TestGetLeadPickListsR1SuccessResponseResponseResult(unittest.TestCase):
    """GetLeadPickListsR1SuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR1SuccessResponseResponseResult:
        """Test GetLeadPickListsR1SuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR1SuccessResponseResponseResult`
        """
        model = GetLeadPickListsR1SuccessResponseResponseResult()
        if include_optional:
            return GetLeadPickListsR1SuccessResponseResponseResult(
                ...
                var_property = entrata_api_client.models.get_lead_pick_lists_r1_success_response_response_result_property.getLeadPickLists_r1_SuccessResponse_response_result_Property(
    ...
    def testGetLeadPickListsR1SuccessResponseResponseResult(self):
        """Test GetLeadPickListsR1SuccessResponseResponseResult"""
