...
class TestSendWorkOrdersMethod(unittest.TestCase):
    """SendWorkOrdersMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendWorkOrdersMethod:
        """Test SendWorkOrdersMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendWorkOrdersMethod`
        """
        model = SendWorkOrdersMethod()
        if include_optional:
            return SendWorkOrdersMethod(
                name = 'sendWorkOrders',
                version = 'r1',
    ...
    def testSendWorkOrdersMethod(self):
        """Test SendWorkOrdersMethod"""
