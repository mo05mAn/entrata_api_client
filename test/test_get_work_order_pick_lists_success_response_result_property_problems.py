...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyProblems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyProblems:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyProblems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyProblems`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyProblems()
        if include_optional:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyProblems(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyProblems"""
