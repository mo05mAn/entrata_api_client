...
class TestInsertPricingSuccessResponseResult(unittest.TestCase):
    """InsertPricingSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsertPricingSuccessResponseResult:
        """Test InsertPricingSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingSuccessResponseResult`
        """
        model = InsertPricingSuccessResponseResult()
        if include_optional:
            return InsertPricingSuccessResponseResult(
                pricing = [
    ...
    def testInsertPricingSuccessResponseResult(self):
        """Test InsertPricingSuccessResponseResult"""
