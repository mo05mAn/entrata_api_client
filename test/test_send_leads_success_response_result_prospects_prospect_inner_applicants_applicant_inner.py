...
class TestSendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner(unittest.TestCase):
    """SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner:
        """Test SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner`
        """
        model = SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner()
        if include_optional:
            return SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner(
                id = '20429586',
                first_name = 'Gail',
                last_name = 'Norberto'
            )
    ...
    def testSendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner(self):
        """Test SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner"""
