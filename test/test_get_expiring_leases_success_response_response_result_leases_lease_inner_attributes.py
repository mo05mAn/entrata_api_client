...
class TestGetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes(unittest.TestCase):
    """GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes:
        """Test GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes`
        """
        model = GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes()
        if include_optional:
            return GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes(
                id = 5641482
            )
        else:
            return GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes(
    ...
    def testGetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes(self):
        """Test GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes"""
