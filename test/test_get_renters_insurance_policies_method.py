...
class TestGetRentersInsurancePoliciesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetRentersInsurancePoliciesMethod:
        """Test GetRentersInsurancePoliciesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRentersInsurancePoliciesMethod`
        """
        model = GetRentersInsurancePoliciesMethod()
        if include_optional:
    ...
    def testGetRentersInsurancePoliciesMethod(self):
        """Test GetRentersInsurancePoliciesMethod"""
