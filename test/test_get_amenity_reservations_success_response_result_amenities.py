...
class TestGetAmenityReservationsSuccessResponseResultAmenities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAmenityReservationsSuccessResponseResultAmenities:
        """Test GetAmenityReservationsSuccessResponseResultAmenities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenityReservationsSuccessResponseResultAmenities`
        """
        model = GetAmenityReservationsSuccessResponseResultAmenities()
        if include_optional:
    ...
    def testGetAmenityReservationsSuccessResponseResultAmenities(self):
        """Test GetAmenityReservationsSuccessResponseResultAmenities"""
