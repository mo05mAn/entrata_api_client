...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification(unittest.TestCase):
    """GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification`
        """
        model = GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification()
        if include_optional:
            return GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification(
                id_type = 'Lease ID',
                id_rank = 'primary',
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification"""
