...
class TestSendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner:
        """Test SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner`
        """
    ...
    def testSendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner(self):
        """Test SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner"""
