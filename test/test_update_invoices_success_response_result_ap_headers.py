...
class TestUpdateInvoicesSuccessResponseResultApHeaders(unittest.TestCase):
    """UpdateInvoicesSuccessResponseResultApHeaders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateInvoicesSuccessResponseResultApHeaders:
        """Test UpdateInvoicesSuccessResponseResultApHeaders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateInvoicesSuccessResponseResultApHeaders`
        """
        model = UpdateInvoicesSuccessResponseResultApHeaders()
        if include_optional:
            return UpdateInvoicesSuccessResponseResultApHeaders(
                ap_header = [
    ...
    def testUpdateInvoicesSuccessResponseResultApHeaders(self):
        """Test UpdateInvoicesSuccessResponseResultApHeaders"""
