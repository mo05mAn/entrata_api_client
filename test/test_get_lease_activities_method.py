...
class TestGetLeaseActivitiesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeaseActivitiesMethod:
        """Test GetLeaseActivitiesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseActivitiesMethod`
        """
        model = GetLeaseActivitiesMethod()
        if include_optional:
    ...
    def testGetLeaseActivitiesMethod(self):
        """Test GetLeaseActivitiesMethod"""
