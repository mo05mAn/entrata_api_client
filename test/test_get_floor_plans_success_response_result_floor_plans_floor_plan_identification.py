...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentification(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentification:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentification`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentification()
        if include_optional:
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentification(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentification"""
