...
class TestGetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress(unittest.TestCase):
    """GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress:
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress`
        """
        model = GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress()
        if include_optional:
            return GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress(
    ...
    def testGetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress(self):
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress"""
