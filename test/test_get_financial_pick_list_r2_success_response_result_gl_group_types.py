...
class TestGetFinancialPickListR2SuccessResponseResultGlGroupTypes(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlGroupTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlGroupTypes:
        """Test GetFinancialPickListR2SuccessResponseResultGlGroupTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlGroupTypes`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlGroupTypes()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlGroupTypes(
                gl_group_type = [
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlGroupTypes(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlGroupTypes"""
