...
class TestSendApplicationPetsSuccessResponseResponseResult(unittest.TestCase):
    """SendApplicationPetsSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationPetsSuccessResponseResponseResult:
        """Test SendApplicationPetsSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationPetsSuccessResponseResponseResult`
        """
        model = SendApplicationPetsSuccessResponseResponseResult()
        if include_optional:
            return SendApplicationPetsSuccessResponseResponseResult(
    ...
    def testSendApplicationPetsSuccessResponseResponseResult(self):
        """Test SendApplicationPetsSuccessResponseResponseResult"""
