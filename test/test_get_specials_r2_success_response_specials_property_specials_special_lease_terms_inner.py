...
class TestGetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner(unittest.TestCase):
    """GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner:
        """Test GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner`
        """
        model = GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner()
        if include_optional:
            return GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner(
                lease_term_id = '838',
    ...
    def testGetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner(self):
        """Test GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner"""
