...
class TestMarkInvoicesExportedSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MarkInvoicesExportedSuccessResponse:
        """Test MarkInvoicesExportedSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkInvoicesExportedSuccessResponse`
        """
        model = MarkInvoicesExportedSuccessResponse()
        if include_optional:
    ...
    def testMarkInvoicesExportedSuccessResponse(self):
        """Test MarkInvoicesExportedSuccessResponse"""
