...
class TestGetPropertyPickListsR2SuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR2SuccessResponse:
        """Test GetPropertyPickListsR2SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR2SuccessResponse`
        """
        model = GetPropertyPickListsR2SuccessResponse()
        if include_optional:
    ...
    def testGetPropertyPickListsR2SuccessResponse(self):
        """Test GetPropertyPickListsR2SuccessResponse"""
