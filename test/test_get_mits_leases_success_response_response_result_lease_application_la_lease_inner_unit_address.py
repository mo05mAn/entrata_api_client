...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress(unittest.TestCase):
    """GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress`
        """
        model = GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress()
        if include_optional:
            return GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress(
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress"""
