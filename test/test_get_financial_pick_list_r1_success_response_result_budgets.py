...
class TestGetFinancialPickListR1SuccessResponseResultBudgets(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultBudgets:
        """Test GetFinancialPickListR1SuccessResponseResultBudgets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultBudgets`
        """
        model = GetFinancialPickListR1SuccessResponseResultBudgets()
        if include_optional:
    ...
    def testGetFinancialPickListR1SuccessResponseResultBudgets(self):
        """Test GetFinancialPickListR1SuccessResponseResultBudgets"""
