...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress(unittest.TestCase):
    """GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress`
        """
        model = GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress()
        if include_optional:
            return GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress(
                address_type = 'other',
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress"""
