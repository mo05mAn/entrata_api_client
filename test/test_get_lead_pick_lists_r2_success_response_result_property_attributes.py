...
class TestGetLeadPickListsR2SuccessResponseResultPropertyAttributes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultPropertyAttributes:
        """Test GetLeadPickListsR2SuccessResponseResultPropertyAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultPropertyAttributes`
        """
        model = GetLeadPickListsR2SuccessResponseResultPropertyAttributes()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultPropertyAttributes(
                id = '173769'
            )
        else:
            return GetLeadPickListsR2SuccessResponseResultPropertyAttributes(
    ...
    def testGetLeadPickListsR2SuccessResponseResultPropertyAttributes(self):
        """Test GetLeadPickListsR2SuccessResponseResultPropertyAttributes"""
