...
class TestGetAmenityReservationsMethod(unittest.TestCase):
    """GetAmenityReservationsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenityReservationsMethod:
        """Test GetAmenityReservationsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenityReservationsMethod`
        """
        model = GetAmenityReservationsMethod()
        if include_optional:
            return GetAmenityReservationsMethod(
    ...
    def testGetAmenityReservationsMethod(self):
        """Test GetAmenityReservationsMethod"""
