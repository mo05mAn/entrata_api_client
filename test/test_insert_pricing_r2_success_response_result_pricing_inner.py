...
class TestInsertPricingR2SuccessResponseResultPricingInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InsertPricingR2SuccessResponseResultPricingInner:
        """Test InsertPricingR2SuccessResponseResultPricingInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertPricingR2SuccessResponseResultPricingInner`
        """
        model = InsertPricingR2SuccessResponseResultPricingInner()
        if include_optional:
            return InsertPricingR2SuccessResponseResultPricingInner(
                node = '1',
    ...
    def testInsertPricingR2SuccessResponseResultPricingInner(self):
        """Test InsertPricingR2SuccessResponseResultPricingInner"""
