...
class TestUpdateCustomersMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateCustomersMethodParams:
        """Test UpdateCustomersMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomersMethodParams`
        """
        model = UpdateCustomersMethodParams()
        if include_optional:
            return UpdateCustomersMethodParams(
                id = 31025784,
                first_name = 'Ephraim',
                last_name = 'Kassulke',
                name_prefix = 'Ms.',
    ...
    def testUpdateCustomersMethodParams(self):
        """Test UpdateCustomersMethodParams"""
