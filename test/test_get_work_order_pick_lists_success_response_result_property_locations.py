...
class TestGetWorkOrderPickListsSuccessResponseResultPropertyLocations(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultPropertyLocations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultPropertyLocations:
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyLocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultPropertyLocations`
        """
        model = GetWorkOrderPickListsSuccessResponseResultPropertyLocations()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultPropertyLocations(
                location = [
    ...
    def testGetWorkOrderPickListsSuccessResponseResultPropertyLocations(self):
        """Test GetWorkOrderPickListsSuccessResponseResultPropertyLocations"""
