...
class TestSendApplicationVehiclesSuccessResponseResponseResult(unittest.TestCase):
    """SendApplicationVehiclesSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendApplicationVehiclesSuccessResponseResponseResult:
        """Test SendApplicationVehiclesSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationVehiclesSuccessResponseResponseResult`
        """
        model = SendApplicationVehiclesSuccessResponseResponseResult()
        if include_optional:
            return SendApplicationVehiclesSuccessResponseResponseResult(
    ...
    def testSendApplicationVehiclesSuccessResponseResponseResult(self):
        """Test SendApplicationVehiclesSuccessResponseResponseResult"""
