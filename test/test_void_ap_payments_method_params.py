...
class TestVoidApPaymentsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VoidApPaymentsMethodParams:
        """Test VoidApPaymentsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidApPaymentsMethodParams`
        """
        model = VoidApPaymentsMethodParams()
        if include_optional:
            return VoidApPaymentsMethodParams(
                payment_id = 12345,
    ...
    def testVoidApPaymentsMethodParams(self):
        """Test VoidApPaymentsMethodParams"""
