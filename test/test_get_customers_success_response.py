...
class TestGetCustomersSuccessResponse(unittest.TestCase):
    """GetCustomersSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponse:
        """Test GetCustomersSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponse`
        """
        model = GetCustomersSuccessResponse()
        if include_optional:
            return GetCustomersSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_customers_success_response_result.getCustomersSuccessResponse_result(
                    customers = entrata_api_client.models.get_customers_success_response_result_customers.getCustomersSuccessResponse_result_Customers(
                        customer = [
                            entrata_api_client.models.get_customers_success_response_result_customers_customer_inner.getCustomersSuccessResponse_result_Customers_Customer_inner(
                                lease_id = [
    ...
    def testGetCustomersSuccessResponse(self):
        """Test GetCustomersSuccessResponse"""
