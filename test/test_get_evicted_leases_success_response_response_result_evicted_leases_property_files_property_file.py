...
class TestGetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile(unittest.TestCase):
    """GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile:
        """Test GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile`
        """
        model = GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile()
        if include_optional:
            return GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile(
                var_property = entrata_api_client.models.get_evicted_leases_success_response_response_result_evicted_leases_property_files_property_file_property.getEvictedLeasesSuccessResponse_response_result_evictedLeases_propertyFiles_propertyFile_property(
                    id = '123456', 
    ...
    def testGetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile(self):
        """Test GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile"""
