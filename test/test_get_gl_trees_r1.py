...
class TestGetGlTreesR1(unittest.TestCase):
    """GetGlTreesR1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR1:
        """Test GetGlTreesR1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR1`
        """
        model = GetGlTreesR1()
        if include_optional:
            return GetGlTreesR1(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_gl_trees_r1_method.getGlTrees_r1_method(
                    name = 'getGlTrees', 
                    version = 'r1', 
