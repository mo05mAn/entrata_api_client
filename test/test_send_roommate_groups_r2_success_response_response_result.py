...
class TestSendRoommateGroupsR2SuccessResponseResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendRoommateGroupsR2SuccessResponseResponseResult:
        """Test SendRoommateGroupsR2SuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRoommateGroupsR2SuccessResponseResponseResult`
        """
        model = SendRoommateGroupsR2SuccessResponseResponseResult()
        if include_optional:
    ...
    def testSendRoommateGroupsR2SuccessResponseResponseResult(self):
        """Test SendRoommateGroupsR2SuccessResponseResponseResult"""
