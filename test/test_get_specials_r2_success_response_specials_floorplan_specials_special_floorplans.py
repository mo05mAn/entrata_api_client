...
class TestGetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans(unittest.TestCase):
    """GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans:
        """Test GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans`
        """
        model = GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans()
        if include_optional:
            return GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans(
    ...
    def testGetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans(self):
        """Test GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans"""
