...
class TestGetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID(unittest.TestCase):
    """GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID:
        """Test GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID`
        """
        model = GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID()
        if include_optional:
            return GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID(
                identification = [
    ...
    def testGetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID(self):
        """Test GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID"""
