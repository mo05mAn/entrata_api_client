...
class TestGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner(unittest.TestCase):
    """GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner()
        if include_optional:
            return GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner(
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner"""
