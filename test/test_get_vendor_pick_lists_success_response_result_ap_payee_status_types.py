...
class TestGetVendorPickListsSuccessResponseResultApPayeeStatusTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultApPayeeStatusTypes:
        """Test GetVendorPickListsSuccessResponseResultApPayeeStatusTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultApPayeeStatusTypes`
        """
        model = GetVendorPickListsSuccessResponseResultApPayeeStatusTypes()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultApPayeeStatusTypes(self):
        """Test GetVendorPickListsSuccessResponseResultApPayeeStatusTypes"""
