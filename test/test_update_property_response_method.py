...
class TestUpdatePropertyResponseMethod(unittest.TestCase):
    """UpdatePropertyResponseMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePropertyResponseMethod:
        """Test UpdatePropertyResponseMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyResponseMethod`
        """
        model = UpdatePropertyResponseMethod()
        if include_optional:
            return UpdatePropertyResponseMethod(
    ...
    def testUpdatePropertyResponseMethod(self):
        """Test UpdatePropertyResponseMethod"""
