...
class TestGetSpecialsR2SuccessResponseSpecials(unittest.TestCase):
    """GetSpecialsR2SuccessResponseSpecials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecials:
        """Test GetSpecialsR2SuccessResponseSpecials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecials`
        """
        model = GetSpecialsR2SuccessResponseSpecials()
        if include_optional:
            return GetSpecialsR2SuccessResponseSpecials(
                property_id = '54638',
    ...
    def testGetSpecialsR2SuccessResponseSpecials(self):
        """Test GetSpecialsR2SuccessResponseSpecials"""
