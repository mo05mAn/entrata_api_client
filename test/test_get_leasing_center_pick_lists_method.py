...
class TestGetLeasingCenterPickListsMethod(unittest.TestCase):
    """GetLeasingCenterPickListsMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasingCenterPickListsMethod:
        """Test GetLeasingCenterPickListsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasingCenterPickListsMethod`
        """
        model = GetLeasingCenterPickListsMethod()
        if include_optional:
            return GetLeasingCenterPickListsMethod(
    ...
    def testGetLeasingCenterPickListsMethod(self):
        """Test GetLeasingCenterPickListsMethod"""
