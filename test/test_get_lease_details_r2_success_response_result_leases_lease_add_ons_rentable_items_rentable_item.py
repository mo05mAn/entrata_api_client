...
class TestGetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem(unittest.TestCase):
    """GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem:
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem`
        """
        model = GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem()
        if include_optional:
            return GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem(
                add_on_id = 85993,
    ...
    def testGetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem(self):
        """Test GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem"""
