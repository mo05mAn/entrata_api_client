...
class TestGetLeasesR2Method(unittest.TestCase):
    """GetLeasesR2Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR2Method:
        """Test GetLeasesR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR2Method`
        """
        model = GetLeasesR2Method()
        if include_optional:
            return GetLeasesR2Method(
                name = '',
                version = 'r2',
    ...
    def testGetLeasesR2Method(self):
        """Test GetLeasesR2Method"""
