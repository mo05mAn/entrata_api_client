...
class TestMoveInLeaseSuccessResponseResult(unittest.TestCase):
    """MoveInLeaseSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoveInLeaseSuccessResponseResult:
        """Test MoveInLeaseSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveInLeaseSuccessResponseResult`
        """
        model = MoveInLeaseSuccessResponseResult()
        if include_optional:
            return MoveInLeaseSuccessResponseResult(
                status = 'success',
    ...
    def testMoveInLeaseSuccessResponseResult(self):
        """Test MoveInLeaseSuccessResponseResult"""
