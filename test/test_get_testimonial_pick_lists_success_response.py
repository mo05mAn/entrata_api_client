...
class TestGetTestimonialPickListsSuccessResponse(unittest.TestCase):
    """GetTestimonialPickListsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTestimonialPickListsSuccessResponse:
        """Test GetTestimonialPickListsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTestimonialPickListsSuccessResponse`
        """
        model = GetTestimonialPickListsSuccessResponse()
        if include_optional:
            return GetTestimonialPickListsSuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_testimonial_pick_lists_success_response_result.getTestimonialPickListsSuccessResponse_result(
    ...
    def testGetTestimonialPickListsSuccessResponse(self):
        """Test GetTestimonialPickListsSuccessResponse"""
