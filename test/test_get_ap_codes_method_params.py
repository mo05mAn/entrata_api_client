...
class TestGetApCodesMethodParams(unittest.TestCase):
    """GetApCodesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetApCodesMethodParams:
        """Test GetApCodesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetApCodesMethodParams`
        """
        model = GetApCodesMethodParams()
        if include_optional:
            return GetApCodesMethodParams(
                gl_account_ids = 56,
                ap_code_type_ids = 56
            )
        else:
    ...
    def testGetApCodesMethodParams(self):
        """Test GetApCodesMethodParams"""
