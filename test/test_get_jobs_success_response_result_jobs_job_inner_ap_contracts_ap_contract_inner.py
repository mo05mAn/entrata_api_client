...
class TestGetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner:
        """Test GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner`
        """
        model = GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner()
        if include_optional:
            return GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner(
                id = '595',
    ...
    def testGetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner(self):
        """Test GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner"""
