...
class TestGetCalendarAvailabilityR1Method(unittest.TestCase):
    """GetCalendarAvailabilityR1Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR1Method:
        """Test GetCalendarAvailabilityR1Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR1Method`
        """
        model = GetCalendarAvailabilityR1Method()
        if include_optional:
            return GetCalendarAvailabilityR1Method(
                name = '',
                version = 'r1',
    ...
    def testGetCalendarAvailabilityR1Method(self):
        """Test GetCalendarAvailabilityR1Method"""
