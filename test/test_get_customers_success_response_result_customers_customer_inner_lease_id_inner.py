...
class TestGetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInner:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInner`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInner()
        if include_optional:
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInner(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInner"""
