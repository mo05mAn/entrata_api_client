...
class TestGetInvoicesR2Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2Method:
        """Test GetInvoicesR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2Method`
        """
        model = GetInvoicesR2Method()
        if include_optional:
    ...
    def testGetInvoicesR2Method(self):
        """Test GetInvoicesR2Method"""
