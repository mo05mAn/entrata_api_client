...
class TestGetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance(unittest.TestCase):
    """GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance:
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance`
        """
        model = GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance()
        if include_optional:
            return GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance(
                id = '1234',
                name = 'Check',
    ...
    def testGetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance(self):
        """Test GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance"""
