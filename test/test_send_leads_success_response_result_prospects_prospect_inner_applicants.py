...
class TestSendLeadsSuccessResponseResultProspectsProspectInnerApplicants(unittest.TestCase):
    """SendLeadsSuccessResponseResultProspectsProspectInnerApplicants unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeadsSuccessResponseResultProspectsProspectInnerApplicants:
        """Test SendLeadsSuccessResponseResultProspectsProspectInnerApplicants
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeadsSuccessResponseResultProspectsProspectInnerApplicants`
        """
        model = SendLeadsSuccessResponseResultProspectsProspectInnerApplicants()
        if include_optional:
            return SendLeadsSuccessResponseResultProspectsProspectInnerApplicants(
                applicant = [
    ...
    def testSendLeadsSuccessResponseResultProspectsProspectInnerApplicants(self):
        """Test SendLeadsSuccessResponseResultProspectsProspectInnerApplicants"""
