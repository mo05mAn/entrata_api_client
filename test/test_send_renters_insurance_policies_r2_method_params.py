...
class TestSendRentersInsurancePoliciesR2MethodParams(unittest.TestCase):
    """SendRentersInsurancePoliciesR2MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRentersInsurancePoliciesR2MethodParams:
        """Test SendRentersInsurancePoliciesR2MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentersInsurancePoliciesR2MethodParams`
        """
        model = SendRentersInsurancePoliciesR2MethodParams()
        if include_optional:
            return SendRentersInsurancePoliciesR2MethodParams(
                property_id = 123456,
                id = 123456,
                lease_id = 123456,
    ...
    def testSendRentersInsurancePoliciesR2MethodParams(self):
        """Test SendRentersInsurancePoliciesR2MethodParams"""
