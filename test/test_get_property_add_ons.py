...
class TestGetPropertyAddOns(unittest.TestCase):
    """GetPropertyAddOns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyAddOns:
        """Test GetPropertyAddOns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAddOns`
        """
        model = GetPropertyAddOns()
        if include_optional:
            return GetPropertyAddOns(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_property_add_ons_method.getPropertyAddOns_method(
    ...
    def testGetPropertyAddOns(self):
        """Test GetPropertyAddOns"""
