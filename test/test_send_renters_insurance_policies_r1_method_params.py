...
class TestSendRentersInsurancePoliciesR1MethodParams(unittest.TestCase):
    """SendRentersInsurancePoliciesR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRentersInsurancePoliciesR1MethodParams:
        """Test SendRentersInsurancePoliciesR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentersInsurancePoliciesR1MethodParams`
        """
        model = SendRentersInsurancePoliciesR1MethodParams()
        if include_optional:
            return SendRentersInsurancePoliciesR1MethodParams(
                property_id = 123456,
                id = 123456,
                lease_id = 123456,
                customer_id = 123456,
    ...
    def testSendRentersInsurancePoliciesR1MethodParams(self):
        """Test SendRentersInsurancePoliciesR1MethodParams"""
