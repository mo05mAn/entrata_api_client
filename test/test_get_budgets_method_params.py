...
class TestGetBudgetsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBudgetsMethodParams:
        """Test GetBudgetsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBudgetsMethodParams`
        """
        model = GetBudgetsMethodParams()
        if include_optional:
            return GetBudgetsMethodParams(
    ...
    def testGetBudgetsMethodParams(self):
        """Test GetBudgetsMethodParams"""
