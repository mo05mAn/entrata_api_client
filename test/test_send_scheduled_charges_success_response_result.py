...
class TestSendScheduledChargesSuccessResponseResult(unittest.TestCase):
    """SendScheduledChargesSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendScheduledChargesSuccessResponseResult:
        """Test SendScheduledChargesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendScheduledChargesSuccessResponseResult`
        """
        model = SendScheduledChargesSuccessResponseResult()
        if include_optional:
            return SendScheduledChargesSuccessResponseResult(
    ...
    def testSendScheduledChargesSuccessResponseResult(self):
        """Test SendScheduledChargesSuccessResponseResult"""
