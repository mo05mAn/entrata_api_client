...
class TestGetJobsSuccessResponseResultJobsJobInnerJobPhases(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetJobsSuccessResponseResultJobsJobInnerJobPhases:
        """Test GetJobsSuccessResponseResultJobsJobInnerJobPhases
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobsSuccessResponseResultJobsJobInnerJobPhases`
        """
        model = GetJobsSuccessResponseResultJobsJobInnerJobPhases()
        if include_optional:
    ...
    def testGetJobsSuccessResponseResultJobsJobInnerJobPhases(self):
        """Test GetJobsSuccessResponseResultJobsJobInnerJobPhases"""
