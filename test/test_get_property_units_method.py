...
class TestGetPropertyUnitsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyUnitsMethod:
        """Test GetPropertyUnitsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyUnitsMethod`
        """
        model = GetPropertyUnitsMethod()
        if include_optional:
    ...
    def testGetPropertyUnitsMethod(self):
        """Test GetPropertyUnitsMethod"""
