...
class TestGetFinancialPickListR2Method(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2Method:
        """Test GetFinancialPickListR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2Method`
        """
        model = GetFinancialPickListR2Method()
        if include_optional:
            return GetFinancialPickListR2Method(
                name = '',
                version = 'r2'
            )
        else:
    ...
    def testGetFinancialPickListR2Method(self):
        """Test GetFinancialPickListR2Method"""
