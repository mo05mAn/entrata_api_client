...
class TestUpdatePropertyMediaMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdatePropertyMediaMethod:
        """Test UpdatePropertyMediaMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyMediaMethod`
        """
        model = UpdatePropertyMediaMethod()
        if include_optional:
    ...
    def testUpdatePropertyMediaMethod(self):
        """Test UpdatePropertyMediaMethod"""
