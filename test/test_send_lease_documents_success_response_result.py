...
class TestSendLeaseDocumentsSuccessResponseResult(unittest.TestCase):
    """SendLeaseDocumentsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseDocumentsSuccessResponseResult:
        """Test SendLeaseDocumentsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseDocumentsSuccessResponseResult`
        """
        model = SendLeaseDocumentsSuccessResponseResult()
        if include_optional:
            return SendLeaseDocumentsSuccessResponseResult(
    ...
    def testSendLeaseDocumentsSuccessResponseResult(self):
        """Test SendLeaseDocumentsSuccessResponseResult"""
