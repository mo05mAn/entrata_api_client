...
class TestGetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions(unittest.TestCase):
    """GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions:
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions`
        """
        model = GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions()
        if include_optional:
            return GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions(
                transaction = [
    ...
    def testGetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions(self):
        """Test GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions"""
