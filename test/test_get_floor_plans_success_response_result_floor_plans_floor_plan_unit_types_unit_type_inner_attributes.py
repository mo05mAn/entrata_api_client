...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes(unittest.TestCase):
    """GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes(
                id = '297171'
            )
        else:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes(
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes"""
