...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes(unittest.TestCase):
    """GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes(
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes"""
