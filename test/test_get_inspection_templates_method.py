...
class TestGetInspectionTemplatesMethod(unittest.TestCase):
    """GetInspectionTemplatesMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInspectionTemplatesMethod:
        """Test GetInspectionTemplatesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInspectionTemplatesMethod`
        """
        model = GetInspectionTemplatesMethod()
        if include_optional:
            return GetInspectionTemplatesMethod(
    ...
    def testGetInspectionTemplatesMethod(self):
        """Test GetInspectionTemplatesMethod"""
