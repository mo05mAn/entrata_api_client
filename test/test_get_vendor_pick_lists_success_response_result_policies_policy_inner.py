...
class TestGetVendorPickListsSuccessResponseResultPoliciesPolicyInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultPoliciesPolicyInner:
        """Test GetVendorPickListsSuccessResponseResultPoliciesPolicyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultPoliciesPolicyInner`
        """
        model = GetVendorPickListsSuccessResponseResultPoliciesPolicyInner()
        if include_optional:
    ...
    def testGetVendorPickListsSuccessResponseResultPoliciesPolicyInner(self):
        """Test GetVendorPickListsSuccessResponseResultPoliciesPolicyInner"""
