...
class TestGetMarketingPreferencesSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMarketingPreferencesSuccessResponseResult:
        """Test GetMarketingPreferencesSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMarketingPreferencesSuccessResponseResult`
        """
        model = GetMarketingPreferencesSuccessResponseResult()
        if include_optional:
    ...
    def testGetMarketingPreferencesSuccessResponseResult(self):
        """Test GetMarketingPreferencesSuccessResponseResult"""
