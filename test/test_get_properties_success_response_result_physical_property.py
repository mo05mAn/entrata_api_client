...
class TestGetPropertiesSuccessResponseResultPhysicalProperty(unittest.TestCase):
    """GetPropertiesSuccessResponseResultPhysicalProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertiesSuccessResponseResultPhysicalProperty:
        """Test GetPropertiesSuccessResponseResultPhysicalProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertiesSuccessResponseResultPhysicalProperty`
        """
        model = GetPropertiesSuccessResponseResultPhysicalProperty()
        if include_optional:
            return GetPropertiesSuccessResponseResultPhysicalProperty(
                var_property = [
    ...
    def testGetPropertiesSuccessResponseResultPhysicalProperty(self):
        """Test GetPropertiesSuccessResponseResultPhysicalProperty"""
