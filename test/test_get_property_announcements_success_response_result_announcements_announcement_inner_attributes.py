...
class TestGetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes(unittest.TestCase):
    """GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes:
        """Test GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes`
        """
        model = GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes()
        if include_optional:
            return GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes(
                id = 111
            )
        else:
            return GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes(
    ...
    def testGetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes(self):
        """Test GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes"""
