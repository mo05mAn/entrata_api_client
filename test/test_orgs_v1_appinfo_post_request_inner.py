...
class TestOrgsV1AppinfoPostRequestInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrgsV1AppinfoPostRequestInner:
        """Test OrgsV1AppinfoPostRequestInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgsV1AppinfoPostRequestInner`
        """
    ...
    def testOrgsV1AppinfoPostRequestInner(self):
        """Test OrgsV1AppinfoPostRequestInner"""
