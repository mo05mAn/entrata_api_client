...
class TestGetWebsitesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWebsitesMethod:
        """Test GetWebsitesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebsitesMethod`
        """
        model = GetWebsitesMethod()
        if include_optional:
    ...
    def testGetWebsitesMethod(self):
        """Test GetWebsitesMethod"""
