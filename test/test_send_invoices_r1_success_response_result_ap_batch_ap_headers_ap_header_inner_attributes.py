...
class TestSendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes(unittest.TestCase):
    """SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes:
        """Test SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes`
        """
        model = SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes()
        if include_optional:
            return SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes(
                invoice_number = '311',
                reference_id = '42652',
                status = 'Success',
    ...
    def testSendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes(self):
        """Test SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes"""
