...
class TestGetParcelAlertsSuccessResponseResponseResultPackageBatches(unittest.TestCase):
    """GetParcelAlertsSuccessResponseResponseResultPackageBatches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetParcelAlertsSuccessResponseResponseResultPackageBatches:
        """Test GetParcelAlertsSuccessResponseResponseResultPackageBatches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetParcelAlertsSuccessResponseResponseResultPackageBatches`
        """
        model = GetParcelAlertsSuccessResponseResponseResultPackageBatches()
        if include_optional:
            return GetParcelAlertsSuccessResponseResponseResultPackageBatches(
                package_batch = [
    ...
    def testGetParcelAlertsSuccessResponseResponseResultPackageBatches(self):
        """Test GetParcelAlertsSuccessResponseResponseResultPackageBatches"""
