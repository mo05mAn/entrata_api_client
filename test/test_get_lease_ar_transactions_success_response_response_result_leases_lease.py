...
class TestGetLeaseArTransactionsSuccessResponseResponseResultLeasesLease(unittest.TestCase):
    """GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease:
        """Test GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease`
        """
        model = GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease()
        if include_optional:
            return GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease(
                id = 14803775,
                property_id = 172775,
    ...
    def testGetLeaseArTransactionsSuccessResponseResponseResultLeasesLease(self):
        """Test GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease"""
