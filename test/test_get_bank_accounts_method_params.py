...
class TestGetBankAccountsMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBankAccountsMethodParams:
        """Test GetBankAccountsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBankAccountsMethodParams`
        """
        model = GetBankAccountsMethodParams()
        if include_optional:
            return GetBankAccountsMethodParams(
    ...
    def testGetBankAccountsMethodParams(self):
        """Test GetBankAccountsMethodParams"""
