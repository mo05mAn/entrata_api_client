...
class TestSendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes(unittest.TestCase):
    """SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes:
        """Test SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes`
        """
        model = SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes()
        if include_optional:
            return SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes(
                node = '1',
                reference_id = '123456',
                lease_id = '123456',
                customer_id = '123456',
    ...
    def testSendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes(self):
        """Test SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes"""
