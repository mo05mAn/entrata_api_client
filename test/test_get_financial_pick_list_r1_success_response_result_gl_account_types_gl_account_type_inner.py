...
class TestGetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner(
                id = 201,
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner"""
