...
class TestGetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner:
        """Test GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner`
        """
        model = GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner(
    ...
    def testGetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner(self):
        """Test GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner"""
