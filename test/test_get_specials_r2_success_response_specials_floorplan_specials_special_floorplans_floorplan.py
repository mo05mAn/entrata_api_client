...
class TestGetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan(unittest.TestCase):
    """GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan:
        """Test GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan`
        """
        model = GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan()
        if include_optional:
            return GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan(
                id = '145501',
                name = 'Lincoln',
                rates = [
    ...
    def testGetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan(self):
        """Test GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan"""
