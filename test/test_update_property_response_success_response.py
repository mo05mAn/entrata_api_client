...
class TestUpdatePropertyResponseSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdatePropertyResponseSuccessResponse:
        """Test UpdatePropertyResponseSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyResponseSuccessResponse`
        """
        model = UpdatePropertyResponseSuccessResponse()
        if include_optional:
    ...
    def testUpdatePropertyResponseSuccessResponse(self):
        """Test UpdatePropertyResponseSuccessResponse"""
