...
class TestSendApplicantGeneralDetailsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicantGeneralDetailsMethod:
        """Test SendApplicantGeneralDetailsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicantGeneralDetailsMethod`
        """
        model = SendApplicantGeneralDetailsMethod()
        if include_optional:
    ...
    def testSendApplicantGeneralDetailsMethod(self):
        """Test SendApplicantGeneralDetailsMethod"""
