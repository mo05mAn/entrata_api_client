...
class TestUpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges(unittest.TestCase):
    """UpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges:
        """Test UpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges`
        """
        model = UpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges()
        if include_optional:
            return UpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges(
                scheduled_charge = {
    ...
    def testUpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges(self):
        """Test UpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges"""
