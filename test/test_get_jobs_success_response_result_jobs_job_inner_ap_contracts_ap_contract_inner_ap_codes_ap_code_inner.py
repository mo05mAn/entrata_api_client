...
class TestGetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner(unittest.TestCase):
    """GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner:
        """Test GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner`
        """
        model = GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner()
        if include_optional:
            return GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner(
                id = '179174',
                job_phase_id = '2671',
                gl_account_id = '86985',
    ...
    def testGetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner(self):
        """Test GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner"""
