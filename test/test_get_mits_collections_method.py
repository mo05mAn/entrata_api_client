...
class TestGetMitsCollectionsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsCollectionsMethod:
        """Test GetMitsCollectionsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsCollectionsMethod`
        """
        model = GetMitsCollectionsMethod()
        if include_optional:
    ...
    def testGetMitsCollectionsMethod(self):
        """Test GetMitsCollectionsMethod"""
