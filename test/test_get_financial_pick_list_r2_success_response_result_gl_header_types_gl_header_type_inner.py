...
class TestGetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner(
                id = 1,
                name = 'Standard'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner"""
