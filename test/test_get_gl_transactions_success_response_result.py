...
class TestGetGlTransactionsSuccessResponseResult(unittest.TestCase):
    """GetGlTransactionsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTransactionsSuccessResponseResult:
        """Test GetGlTransactionsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTransactionsSuccessResponseResult`
        """
        model = GetGlTransactionsSuccessResponseResult()
        if include_optional:
            return GetGlTransactionsSuccessResponseResult(
    ...
    def testGetGlTransactionsSuccessResponseResult(self):
        """Test GetGlTransactionsSuccessResponseResult"""
