...
class TestGetPropertyPickListsR1MethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyPickListsR1MethodParams:
        """Test GetPropertyPickListsR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyPickListsR1MethodParams`
        """
        model = GetPropertyPickListsR1MethodParams()
        if include_optional:
            return GetPropertyPickListsR1MethodParams(
    ...
    def testGetPropertyPickListsR1MethodParams(self):
        """Test GetPropertyPickListsR1MethodParams"""
