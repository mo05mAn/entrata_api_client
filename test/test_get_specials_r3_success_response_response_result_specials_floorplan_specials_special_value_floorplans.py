...
class TestGetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans:
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans`
        """
        model = GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans()
        if include_optional:
    ...
    def testGetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans(self):
        """Test GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans"""
