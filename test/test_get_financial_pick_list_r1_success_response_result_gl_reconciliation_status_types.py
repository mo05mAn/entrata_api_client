...
class TestGetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes:
        """Test GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes(
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes"""
