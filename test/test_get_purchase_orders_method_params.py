...
class TestGetPurchaseOrdersMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPurchaseOrdersMethodParams:
        """Test GetPurchaseOrdersMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPurchaseOrdersMethodParams`
        """
        model = GetPurchaseOrdersMethodParams()
        if include_optional:
            return GetPurchaseOrdersMethodParams(
                property_ids = 56,
                vendor_id = 12345,
                vendor_code = 12345,
                po_number = 12345,
    ...
    def testGetPurchaseOrdersMethodParams(self):
        """Test GetPurchaseOrdersMethodParams"""
