...
class TestSendBudgetedRent(unittest.TestCase):
    """SendBudgetedRent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendBudgetedRent:
        """Test SendBudgetedRent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetedRent`
        """
        model = SendBudgetedRent()
        if include_optional:
            return SendBudgetedRent(
