...
class TestGetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box(unittest.TestCase):
    """GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box:
        """Test GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box`
        """
        model = GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box()
        if include_optional:
            return GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box(
                box_number = '1',
                box_value = '13'
            )
        else:
    ...
    def testGetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box(self):
        """Test GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box"""
