...
class TestUpdateLeadsR1SuccessResponseResultProspects(unittest.TestCase):
    """UpdateLeadsR1SuccessResponseResultProspects unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLeadsR1SuccessResponseResultProspects:
        """Test UpdateLeadsR1SuccessResponseResultProspects
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeadsR1SuccessResponseResultProspects`
        """
        model = UpdateLeadsR1SuccessResponseResultProspects()
        if include_optional:
            return UpdateLeadsR1SuccessResponseResultProspects(
                prospect = [
    ...
    def testUpdateLeadsR1SuccessResponseResultProspects(self):
        """Test UpdateLeadsR1SuccessResponseResultProspects"""
