...
class TestGetAmenitiesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAmenitiesMethodParams:
        """Test GetAmenitiesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesMethodParams`
        """
        model = GetAmenitiesMethodParams()
        if include_optional:
            return GetAmenitiesMethodParams(
                property_id = 12345,
                unit_number = 1,
    ...
    def testGetAmenitiesMethodParams(self):
        """Test GetAmenitiesMethodParams"""
