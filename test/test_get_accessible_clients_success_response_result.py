...
class TestGetAccessibleClientsSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccessibleClientsSuccessResponseResult:
        """Test GetAccessibleClientsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessibleClientsSuccessResponseResult`
        """
        model = GetAccessibleClientsSuccessResponseResult()
        if include_optional:
    ...
    def testGetAccessibleClientsSuccessResponseResult(self):
        """Test GetAccessibleClientsSuccessResponseResult"""
