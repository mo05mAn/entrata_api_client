...
class TestGetLeaseDetailsR2MethodParams(unittest.TestCase):
    """GetLeaseDetailsR2MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2MethodParams:
        """Test GetLeaseDetailsR2MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2MethodParams`
        """
        model = GetLeaseDetailsR2MethodParams()
        if include_optional:
            return GetLeaseDetailsR2MethodParams(
                property_id = 123456,
                lease_id = 123456,
    ...
    def testGetLeaseDetailsR2MethodParams(self):
        """Test GetLeaseDetailsR2MethodParams"""
