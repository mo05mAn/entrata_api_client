...
class TestGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification(unittest.TestCase):
    """GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification:
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification`
        """
        model = GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification()
        if include_optional:
            return GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification(
                id_value = 21442
            )
        else:
            return GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification(
    ...
    def testGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification(self):
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyIdentification"""
