...
class TestGetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes:
        """Test GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes`
        """
        model = GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes(
    ...
    def testGetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes(self):
        """Test GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes"""
