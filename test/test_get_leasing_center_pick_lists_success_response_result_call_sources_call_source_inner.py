...
class TestGetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner(unittest.TestCase):
    """GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner:
        """Test GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner`
        """
        model = GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner()
        if include_optional:
            return GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner(
                id = '1',
                name = 'On-Site'
            )
        else:
    ...
    def testGetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner(self):
        """Test GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner"""
