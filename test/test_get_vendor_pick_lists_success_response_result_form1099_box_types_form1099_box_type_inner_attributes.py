...
class TestGetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes:
        """Test GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes(
                id = '1',
                name = '1 - Rents'
            )
        else:
    ...
    def testGetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes"""
