...
class TestGetExpiringLeasesSuccessResponseResponseResult(unittest.TestCase):
    """GetExpiringLeasesSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetExpiringLeasesSuccessResponseResponseResult:
        """Test GetExpiringLeasesSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExpiringLeasesSuccessResponseResponseResult`
        """
        model = GetExpiringLeasesSuccessResponseResponseResult()
        if include_optional:
            return GetExpiringLeasesSuccessResponseResponseResult(
    ...
    def testGetExpiringLeasesSuccessResponseResponseResult(self):
        """Test GetExpiringLeasesSuccessResponseResponseResult"""
