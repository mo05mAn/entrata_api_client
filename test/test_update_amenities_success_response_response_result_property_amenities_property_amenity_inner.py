...
class TestUpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner(unittest.TestCase):
    """UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner:
        """Test UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner`
        """
        model = UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner()
        if include_optional:
            return UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner(
                node = 1,
                status = 'Success',
                amenity_id = 147852,
    ...
    def testUpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner(self):
        """Test UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner"""
