...
class TestSendBudgetedRentSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendBudgetedRentSuccessResponseResult:
        """Test SendBudgetedRentSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBudgetedRentSuccessResponseResult`
        """
        model = SendBudgetedRentSuccessResponseResult()
        if include_optional:
    ...
    def testSendBudgetedRentSuccessResponseResult(self):
        """Test SendBudgetedRentSuccessResponseResult"""
