...
class TestGetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner:
        """Test GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner`
        """
        model = GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner(
    ...
    def testGetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner(self):
        """Test GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner"""
