...
class TestGetCalendarAvailabilityR2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR2:
        """Test GetCalendarAvailabilityR2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR2`
        """
    ...
    def testGetCalendarAvailabilityR2(self):
        """Test GetCalendarAvailabilityR2"""
