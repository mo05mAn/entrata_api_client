...
class TestGetLeasingCenterPickListsSuccessResponseResultCallResults(unittest.TestCase):
    """GetLeasingCenterPickListsSuccessResponseResultCallResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasingCenterPickListsSuccessResponseResultCallResults:
        """Test GetLeasingCenterPickListsSuccessResponseResultCallResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasingCenterPickListsSuccessResponseResultCallResults`
        """
        model = GetLeasingCenterPickListsSuccessResponseResultCallResults()
        if include_optional:
            return GetLeasingCenterPickListsSuccessResponseResultCallResults(
                call_result = [
    ...
    def testGetLeasingCenterPickListsSuccessResponseResultCallResults(self):
        """Test GetLeasingCenterPickListsSuccessResponseResultCallResults"""
