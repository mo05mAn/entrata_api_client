...
class TestGetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIds(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIds:
        """Test GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIds
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIds`
        """
        model = GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIds()
        if include_optional:
    ...
    def testGetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIds(self):
        """Test GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIds"""
