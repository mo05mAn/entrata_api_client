...
class TestGetInvoicesR1SuccessResponse(unittest.TestCase):
    """GetInvoicesR1SuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR1SuccessResponse:
        """Test GetInvoicesR1SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR1SuccessResponse`
        """
        model = GetInvoicesR1SuccessResponse()
        if include_optional:
            return GetInvoicesR1SuccessResponse(
                request_id = '15',
                code = '200',
                result = entrata_api_client.models.get_invoices_r1_success_response_result.getInvoices_r1_SuccessResponse_result(
    ...
    def testGetInvoicesR1SuccessResponse(self):
        """Test GetInvoicesR1SuccessResponse"""
