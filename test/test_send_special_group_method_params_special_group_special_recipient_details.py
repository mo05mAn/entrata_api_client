...
class TestSendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails(unittest.TestCase):
    """SendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails:
        """Test SendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails`
        """
        model = SendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails()
        if include_optional:
            return SendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails(
    ...
    def testSendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails(self):
        """Test SendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails"""
