...
class TestGetVendorLocationsSuccessResponseResultInsurances(unittest.TestCase):
    """GetVendorLocationsSuccessResponseResultInsurances unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultInsurances:
        """Test GetVendorLocationsSuccessResponseResultInsurances
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultInsurances`
        """
        model = GetVendorLocationsSuccessResponseResultInsurances()
        if include_optional:
            return GetVendorLocationsSuccessResponseResultInsurances(
                insurance = [
    ...
    def testGetVendorLocationsSuccessResponseResultInsurances(self):
        """Test GetVendorLocationsSuccessResponseResultInsurances"""
