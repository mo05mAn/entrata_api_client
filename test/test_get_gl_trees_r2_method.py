...
class TestGetGlTreesR2Method(unittest.TestCase):
    """GetGlTreesR2Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlTreesR2Method:
        """Test GetGlTreesR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR2Method`
        """
        model = GetGlTreesR2Method()
        if include_optional:
            return GetGlTreesR2Method(
                name = 'getGlTrees',
                version = 'r2',
    ...
    def testGetGlTreesR2Method(self):
        """Test GetGlTreesR2Method"""
