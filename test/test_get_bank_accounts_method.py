...
class TestGetBankAccountsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBankAccountsMethod:
        """Test GetBankAccountsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBankAccountsMethod`
        """
        model = GetBankAccountsMethod()
        if include_optional:
    ...
    def testGetBankAccountsMethod(self):
        """Test GetBankAccountsMethod"""
