...
class TestGetArPaymentsSuccessResponseResponseResult(unittest.TestCase):
    """GetArPaymentsSuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetArPaymentsSuccessResponseResponseResult:
        """Test GetArPaymentsSuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArPaymentsSuccessResponseResponseResult`
        """
        model = GetArPaymentsSuccessResponseResponseResult()
        if include_optional:
            return GetArPaymentsSuccessResponseResponseResult(
    ...
    def testGetArPaymentsSuccessResponseResponseResult(self):
        """Test GetArPaymentsSuccessResponseResponseResult"""
