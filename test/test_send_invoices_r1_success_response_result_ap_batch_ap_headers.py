...
class TestSendInvoicesR1SuccessResponseResultApBatchApHeaders(unittest.TestCase):
    """SendInvoicesR1SuccessResponseResultApBatchApHeaders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendInvoicesR1SuccessResponseResultApBatchApHeaders:
        """Test SendInvoicesR1SuccessResponseResultApBatchApHeaders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendInvoicesR1SuccessResponseResultApBatchApHeaders`
        """
        model = SendInvoicesR1SuccessResponseResultApBatchApHeaders()
        if include_optional:
            return SendInvoicesR1SuccessResponseResultApBatchApHeaders(
                ap_header = [
    ...
    def testSendInvoicesR1SuccessResponseResultApBatchApHeaders(self):
        """Test SendInvoicesR1SuccessResponseResultApBatchApHeaders"""
