...
class TestGetJobCategoriesMethod(unittest.TestCase):
    """GetJobCategoriesMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobCategoriesMethod:
        """Test GetJobCategoriesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobCategoriesMethod`
        """
        model = GetJobCategoriesMethod()
        if include_optional:
            return GetJobCategoriesMethod(
    ...
    def testGetJobCategoriesMethod(self):
        """Test GetJobCategoriesMethod"""
