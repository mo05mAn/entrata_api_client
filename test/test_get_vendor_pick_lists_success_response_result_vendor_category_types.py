...
class TestGetVendorPickListsSuccessResponseResultVendorCategoryTypes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultVendorCategoryTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultVendorCategoryTypes:
        """Test GetVendorPickListsSuccessResponseResultVendorCategoryTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultVendorCategoryTypes`
        """
        model = GetVendorPickListsSuccessResponseResultVendorCategoryTypes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultVendorCategoryTypes(
    ...
    def testGetVendorPickListsSuccessResponseResultVendorCategoryTypes(self):
        """Test GetVendorPickListsSuccessResponseResultVendorCategoryTypes"""
