...
class TestGetJobsSuccessResponseResultJobsJobInnerApContracts(unittest.TestCase):
    """GetJobsSuccessResponseResultJobsJobInnerApContracts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetJobsSuccessResponseResultJobsJobInnerApContracts:
        """Test GetJobsSuccessResponseResultJobsJobInnerApContracts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetJobsSuccessResponseResultJobsJobInnerApContracts`
        """
        model = GetJobsSuccessResponseResultJobsJobInnerApContracts()
        if include_optional:
            return GetJobsSuccessResponseResultJobsJobInnerApContracts(
                ap_contract = [
    ...
    def testGetJobsSuccessResponseResultJobsJobInnerApContracts(self):
        """Test GetJobsSuccessResponseResultJobsJobInnerApContracts"""
