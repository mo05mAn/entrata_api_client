...
class TestSendLeaseDocumentsSuccessResponseResultFilesFileInner(unittest.TestCase):
    """SendLeaseDocumentsSuccessResponseResultFilesFileInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseDocumentsSuccessResponseResultFilesFileInner:
        """Test SendLeaseDocumentsSuccessResponseResultFilesFileInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseDocumentsSuccessResponseResultFilesFileInner`
        """
        model = SendLeaseDocumentsSuccessResponseResultFilesFileInner()
        if include_optional:
            return SendLeaseDocumentsSuccessResponseResultFilesFileInner(
                node = '1',
                file_id = '13858364',
                file_name = 'file1.pdf',
                status = 'Success',
    ...
    def testSendLeaseDocumentsSuccessResponseResultFilesFileInner(self):
        """Test SendLeaseDocumentsSuccessResponseResultFilesFileInner"""
