...
class TestGetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypes:
        """Test GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypes`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypes()
        if include_optional:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypes(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypes"""
