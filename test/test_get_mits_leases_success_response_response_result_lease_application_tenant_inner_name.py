...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName(unittest.TestCase):
    """GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName`
        """
        model = GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName()
        if include_optional:
            return GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName(
                first_name = 'Julanne',
                last_name = 'Abernethy'
            )
        else:
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName"""
