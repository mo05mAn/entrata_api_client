...
class TestGetAmenitiesSuccessResponseResultAmenitiesUnitAmenities(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities:
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities(
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesUnitAmenities(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities"""
