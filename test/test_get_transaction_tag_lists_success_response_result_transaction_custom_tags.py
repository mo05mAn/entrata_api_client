...
class TestGetTransactionTagListsSuccessResponseResultTransactionCustomTags(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionTagListsSuccessResponseResultTransactionCustomTags:
        """Test GetTransactionTagListsSuccessResponseResultTransactionCustomTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTransactionTagListsSuccessResponseResultTransactionCustomTags`
        """
        model = GetTransactionTagListsSuccessResponseResultTransactionCustomTags()
        if include_optional:
    ...
    def testGetTransactionTagListsSuccessResponseResultTransactionCustomTags(self):
        """Test GetTransactionTagListsSuccessResponseResultTransactionCustomTags"""
