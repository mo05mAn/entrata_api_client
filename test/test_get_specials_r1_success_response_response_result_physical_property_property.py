...
class TestGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyProperty(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyProperty:
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyProperty`
        """
    ...
    def testGetSpecialsR1SuccessResponseResponseResultPhysicalPropertyProperty(self):
        """Test GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyProperty"""
