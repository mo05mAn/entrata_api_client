...
class TestGetPropertyFeesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertyFeesMethod:
        """Test GetPropertyFeesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyFeesMethod`
        """
        model = GetPropertyFeesMethod()
        if include_optional:
    ...
    def testGetPropertyFeesMethod(self):
        """Test GetPropertyFeesMethod"""
