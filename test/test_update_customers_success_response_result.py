...
class TestUpdateCustomersSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateCustomersSuccessResponseResult:
        """Test UpdateCustomersSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomersSuccessResponseResult`
        """
    ...
    def testUpdateCustomersSuccessResponseResult(self):
        """Test UpdateCustomersSuccessResponseResult"""
