...
class TestGetPetTypesMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPetTypesMethod:
        """Test GetPetTypesMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPetTypesMethod`
        """
        model = GetPetTypesMethod()
        if include_optional:
    ...
    def testGetPetTypesMethod(self):
        """Test GetPetTypesMethod"""
