...
class TestGetLeaseDetailsR1MethodParams(unittest.TestCase):
    """GetLeaseDetailsR1MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1MethodParams:
        """Test GetLeaseDetailsR1MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1MethodParams`
        """
        model = GetLeaseDetailsR1MethodParams()
        if include_optional:
            return GetLeaseDetailsR1MethodParams(
                property_id = 123456,
                lease_id = 123456,
                include_add_ons = 0,
                include_charge = 0
    ...
    def testGetLeaseDetailsR1MethodParams(self):
        """Test GetLeaseDetailsR1MethodParams"""
