...
class TestUpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenities:
        """Test UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenities`
        """
        model = UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenities()
        if include_optional:
    ...
    def testUpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenities(self):
        """Test UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenities"""
