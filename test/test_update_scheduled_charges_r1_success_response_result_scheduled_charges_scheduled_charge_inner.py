...
class TestUpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner(unittest.TestCase):
    """UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner:
        """Test UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner`
        """
        model = UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner()
        if include_optional:
            return UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner(
    ...
    def testUpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner(self):
        """Test UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner"""
