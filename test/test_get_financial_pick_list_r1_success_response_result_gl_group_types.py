...
class TestGetFinancialPickListR1SuccessResponseResultGlGroupTypes(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlGroupTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlGroupTypes:
        """Test GetFinancialPickListR1SuccessResponseResultGlGroupTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlGroupTypes`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlGroupTypes()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlGroupTypes(
                gl_group_type = [
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlGroupTypes(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlGroupTypes"""
