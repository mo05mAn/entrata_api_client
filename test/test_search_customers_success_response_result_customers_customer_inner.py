...
class TestSearchCustomersSuccessResponseResultCustomersCustomerInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SearchCustomersSuccessResponseResultCustomersCustomerInner:
        """Test SearchCustomersSuccessResponseResultCustomersCustomerInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchCustomersSuccessResponseResultCustomersCustomerInner`
        """
        model = SearchCustomersSuccessResponseResultCustomersCustomerInner()
        if include_optional:
            return SearchCustomersSuccessResponseResultCustomersCustomerInner(
                id = '1234',
                name_prefix = 'Mr.',
                first_name = 'Dave',
    ...
    def testSearchCustomersSuccessResponseResultCustomersCustomerInner(self):
        """Test SearchCustomersSuccessResponseResultCustomersCustomerInner"""
