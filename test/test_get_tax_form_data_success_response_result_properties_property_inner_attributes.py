...
class TestGetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes(unittest.TestCase):
    """GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes:
        """Test GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes`
        """
        model = GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes()
        if include_optional:
            return GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes(
                is_company_level = '0'
            )
        else:
            return GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes(
    ...
    def testGetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes(self):
        """Test GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes"""
