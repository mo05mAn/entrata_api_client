...
class TestSendVendorsSuccessResponseResultVendors(unittest.TestCase):
    """SendVendorsSuccessResponseResultVendors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendVendorsSuccessResponseResultVendors:
        """Test SendVendorsSuccessResponseResultVendors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendVendorsSuccessResponseResultVendors`
        """
        model = SendVendorsSuccessResponseResultVendors()
        if include_optional:
            return SendVendorsSuccessResponseResultVendors(
                vendor = [
    ...
    def testSendVendorsSuccessResponseResultVendors(self):
        """Test SendVendorsSuccessResponseResultVendors"""
