...
class TestGetPropertyAddOnsSuccessResponse(unittest.TestCase):
    """GetPropertyAddOnsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyAddOnsSuccessResponse:
        """Test GetPropertyAddOnsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAddOnsSuccessResponse`
        """
        model = GetPropertyAddOnsSuccessResponse()
        if include_optional:
            return GetPropertyAddOnsSuccessResponse(
                request_id = '1',
                code = '200',
                result = entrata_api_client.models.get_property_add_ons_success_response_result.getPropertyAddOnsSuccessResponse_result(
                    currency_code = 'USD', 
    ...
    def testGetPropertyAddOnsSuccessResponse(self):
        """Test GetPropertyAddOnsSuccessResponse"""
