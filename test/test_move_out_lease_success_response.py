...
class TestMoveOutLeaseSuccessResponse(unittest.TestCase):
    """MoveOutLeaseSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoveOutLeaseSuccessResponse:
        """Test MoveOutLeaseSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveOutLeaseSuccessResponse`
        """
        model = MoveOutLeaseSuccessResponse()
        if include_optional:
            return MoveOutLeaseSuccessResponse(
                request_id = '15',
                code = 200,
                result = entrata_api_client.models.move_out_lease_success_response_result.moveOutLeaseSuccessResponse_result(
                    status = 'Success', 
                    message = 'Lease moved out successfully.', )
            )
        else:
            return MoveOutLeaseSuccessResponse(
                request_id = '15',
    ...
    def testMoveOutLeaseSuccessResponse(self):
        """Test MoveOutLeaseSuccessResponse"""
