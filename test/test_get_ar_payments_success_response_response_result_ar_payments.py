...
class TestGetArPaymentsSuccessResponseResponseResultArPayments(unittest.TestCase):
    """GetArPaymentsSuccessResponseResponseResultArPayments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetArPaymentsSuccessResponseResponseResultArPayments:
        """Test GetArPaymentsSuccessResponseResponseResultArPayments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArPaymentsSuccessResponseResponseResultArPayments`
        """
        model = GetArPaymentsSuccessResponseResponseResultArPayments()
        if include_optional:
            return GetArPaymentsSuccessResponseResponseResultArPayments(
                ar_payment = [
    ...
    def testGetArPaymentsSuccessResponseResponseResultArPayments(self):
        """Test GetArPaymentsSuccessResponseResponseResultArPayments"""
