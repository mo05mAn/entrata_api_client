...
class TestUpdateLeadsR2SuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateLeadsR2SuccessResponse:
        """Test UpdateLeadsR2SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeadsR2SuccessResponse`
        """
        model = UpdateLeadsR2SuccessResponse()
        if include_optional:
    ...
    def testUpdateLeadsR2SuccessResponse(self):
        """Test UpdateLeadsR2SuccessResponse"""
