...
class TestGetPropertyUnitsMethodParams(unittest.TestCase):
    """GetPropertyUnitsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyUnitsMethodParams:
        """Test GetPropertyUnitsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyUnitsMethodParams`
        """
        model = GetPropertyUnitsMethodParams()
        if include_optional:
            return GetPropertyUnitsMethodParams(
    ...
    def testGetPropertyUnitsMethodParams(self):
        """Test GetPropertyUnitsMethodParams"""
