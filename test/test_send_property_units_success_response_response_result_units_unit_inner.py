...
class TestSendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner(unittest.TestCase):
    """SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner:
        """Test SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner`
        """
        model = SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner()
        if include_optional:
            return SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner(
                node = 1,
                unit_id = 5242133,
                unit_number = 'CC20BB',
                unit_space = '1',
    ...
    def testSendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner(self):
        """Test SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner"""
