...
class TestSendLeaseDocumentsSuccessResponseResultFiles(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeaseDocumentsSuccessResponseResultFiles:
        """Test SendLeaseDocumentsSuccessResponseResultFiles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseDocumentsSuccessResponseResultFiles`
        """
        model = SendLeaseDocumentsSuccessResponseResultFiles()
        if include_optional:
    ...
    def testSendLeaseDocumentsSuccessResponseResultFiles(self):
        """Test SendLeaseDocumentsSuccessResponseResultFiles"""
