...
class TestGetAccessibleClientsSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAccessibleClientsSuccessResponse:
        """Test GetAccessibleClientsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccessibleClientsSuccessResponse`
        """
        model = GetAccessibleClientsSuccessResponse()
        if include_optional:
    ...
    def testGetAccessibleClientsSuccessResponse(self):
        """Test GetAccessibleClientsSuccessResponse"""
