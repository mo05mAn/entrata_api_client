...
class TestSendMitsLeadsMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendMitsLeadsMethod:
        """Test SendMitsLeadsMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMitsLeadsMethod`
        """
        model = SendMitsLeadsMethod()
        if include_optional:
    ...
    def testSendMitsLeadsMethod(self):
        """Test SendMitsLeadsMethod"""
