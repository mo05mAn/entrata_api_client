...
class TestGetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner(
                id = 88,
                name = 'AMSI'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner"""
