...
class TestGetLeasingCenterPickListsSuccessResponseResultCallTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeasingCenterPickListsSuccessResponseResultCallTypes:
        """Test GetLeasingCenterPickListsSuccessResponseResultCallTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasingCenterPickListsSuccessResponseResultCallTypes`
        """
        model = GetLeasingCenterPickListsSuccessResponseResultCallTypes()
        if include_optional:
    ...
    def testGetLeasingCenterPickListsSuccessResponseResultCallTypes(self):
        """Test GetLeasingCenterPickListsSuccessResponseResultCallTypes"""
