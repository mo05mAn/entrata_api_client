...
class TestGetLeadPickListsR2SuccessResponseResultEventTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultEventTypes:
        """Test GetLeadPickListsR2SuccessResponseResultEventTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultEventTypes`
        """
        model = GetLeadPickListsR2SuccessResponseResultEventTypes()
        if include_optional:
    ...
    def testGetLeadPickListsR2SuccessResponseResultEventTypes(self):
        """Test GetLeadPickListsR2SuccessResponseResultEventTypes"""
