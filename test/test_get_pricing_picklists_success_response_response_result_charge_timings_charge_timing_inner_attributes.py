...
class TestGetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes(unittest.TestCase):
    """GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes:
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes`
        """
        model = GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes()
        if include_optional:
            return GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes(
                id = 102,
    ...
    def testGetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes(self):
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes"""
