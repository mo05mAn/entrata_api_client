...
class TestUpdateVendorsSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateVendorsSuccessResponseResult:
        """Test UpdateVendorsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateVendorsSuccessResponseResult`
        """
    ...
    def testUpdateVendorsSuccessResponseResult(self):
        """Test UpdateVendorsSuccessResponseResult"""
