...
class TestGetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes(unittest.TestCase):
    """GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes:
        """Test GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes`
        """
        model = GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes()
        if include_optional:
            return GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes(
                id_type = 'CustID123'
            )
        else:
            return GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes(
    ...
    def testGetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes(self):
        """Test GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes"""
