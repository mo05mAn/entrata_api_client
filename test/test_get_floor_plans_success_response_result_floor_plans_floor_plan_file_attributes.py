...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes(unittest.TestCase):
    """GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes(
                file_id = '345678',
                active = 'true',
                is_default = True
            )
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes"""
