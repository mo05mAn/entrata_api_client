...
class TestGetLeadEventsSuccessResponseResultProspects(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadEventsSuccessResponseResultProspects:
        """Test GetLeadEventsSuccessResponseResultProspects
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadEventsSuccessResponseResultProspects`
        """
        model = GetLeadEventsSuccessResponseResultProspects()
        if include_optional:
    ...
    def testGetLeadEventsSuccessResponseResultProspects(self):
        """Test GetLeadEventsSuccessResponseResultProspects"""
