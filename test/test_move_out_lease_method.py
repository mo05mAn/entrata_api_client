...
class TestMoveOutLeaseMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MoveOutLeaseMethod:
        """Test MoveOutLeaseMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveOutLeaseMethod`
        """
        model = MoveOutLeaseMethod()
        if include_optional:
    ...
    def testMoveOutLeaseMethod(self):
        """Test MoveOutLeaseMethod"""
