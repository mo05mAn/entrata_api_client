...
class TestGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches:
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches`
        """
        model = GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches()
        if include_optional:
    ...
    def testGetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches(self):
        """Test GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches"""
