...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentification(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentification:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentification`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentification()
        if include_optional:
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentification(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentification"""
