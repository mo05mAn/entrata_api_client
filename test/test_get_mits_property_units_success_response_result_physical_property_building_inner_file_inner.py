...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner(
                file_type = 'Photo',
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner"""
