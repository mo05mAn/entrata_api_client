...
class TestGetLeaseDetailsR2Method(unittest.TestCase):
    """GetLeaseDetailsR2Method unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR2Method:
        """Test GetLeaseDetailsR2Method
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR2Method`
        """
        model = GetLeaseDetailsR2Method()
        if include_optional:
            return GetLeaseDetailsR2Method(
                name = '',
                version = 'r2',
    ...
    def testGetLeaseDetailsR2Method(self):
        """Test GetLeaseDetailsR2Method"""
