...
class TestGetPetTypesSuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPetTypesSuccessResponse:
        """Test GetPetTypesSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPetTypesSuccessResponse`
        """
        model = GetPetTypesSuccessResponse()
        if include_optional:
    ...
    def testGetPetTypesSuccessResponse(self):
        """Test GetPetTypesSuccessResponse"""
