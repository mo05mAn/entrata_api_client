...
class TestGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits:
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits(
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits"""
