...
class TestSendApplicationPetsSuccessResponseResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendApplicationPetsSuccessResponseResponse:
        """Test SendApplicationPetsSuccessResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendApplicationPetsSuccessResponseResponse`
        """
        model = SendApplicationPetsSuccessResponseResponse()
        if include_optional:
    ...
    def testSendApplicationPetsSuccessResponseResponse(self):
        """Test SendApplicationPetsSuccessResponseResponse"""
