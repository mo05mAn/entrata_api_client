...
class TestGetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPets(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPets:
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPets`
        """
        model = GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPets()
        if include_optional:
    ...
    def testGetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPets(self):
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPets"""
