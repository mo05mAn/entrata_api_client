...
class TestGetInvoicesR2MethodParams(unittest.TestCase):
    """GetInvoicesR2MethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2MethodParams:
        """Test GetInvoicesR2MethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2MethodParams`
        """
        model = GetInvoicesR2MethodParams()
        if include_optional:
            return GetInvoicesR2MethodParams(
                ids = 56,
                ...
                voided_payment_from_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                voided_payment_to_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                include_exported = 0,
                customer_refunds = 0,
                invoice_type_ids = 56
            )
    ...
    def testGetInvoicesR2MethodParams(self):
        """Test GetInvoicesR2MethodParams"""
