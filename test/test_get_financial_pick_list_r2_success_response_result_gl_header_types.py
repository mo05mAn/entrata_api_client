...
class TestGetFinancialPickListR2SuccessResponseResultGlHeaderTypes(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlHeaderTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlHeaderTypes:
        """Test GetFinancialPickListR2SuccessResponseResultGlHeaderTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlHeaderTypes`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlHeaderTypes()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlHeaderTypes(
                gl_header_type = [
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlHeaderTypes(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlHeaderTypes"""
