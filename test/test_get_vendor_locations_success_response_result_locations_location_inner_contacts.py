...
class TestGetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts(unittest.TestCase):
    """GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts:
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts`
        """
        model = GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts()
        if include_optional:
            return GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts(
                contact = [
    ...
    def testGetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts(self):
        """Test GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts"""
