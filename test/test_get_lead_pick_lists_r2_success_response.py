...
class TestGetLeadPickListsR2SuccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponse:
        """Test GetLeadPickListsR2SuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponse`
        """
        model = GetLeadPickListsR2SuccessResponse()
        if include_optional:
    ...
    def testGetLeadPickListsR2SuccessResponse(self):
        """Test GetLeadPickListsR2SuccessResponse"""
