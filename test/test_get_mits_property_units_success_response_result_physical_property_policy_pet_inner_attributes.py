...
class TestGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes(unittest.TestCase):
    """GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes:
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes`
        """
        model = GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes()
        if include_optional:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes(
                allowed = 'true'
            )
        else:
            return GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes(
    ...
    def testGetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes(self):
        """Test GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes"""
