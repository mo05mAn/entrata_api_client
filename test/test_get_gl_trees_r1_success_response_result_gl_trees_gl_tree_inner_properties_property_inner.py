...
class TestGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner:
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner`
        """
    ...
    def testGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner(self):
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner"""
