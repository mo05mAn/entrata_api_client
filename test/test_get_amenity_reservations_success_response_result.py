...
class TestGetAmenityReservationsSuccessResponseResult(unittest.TestCase):
    """GetAmenityReservationsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenityReservationsSuccessResponseResult:
        """Test GetAmenityReservationsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenityReservationsSuccessResponseResult`
        """
        model = GetAmenityReservationsSuccessResponseResult()
        if include_optional:
            return GetAmenityReservationsSuccessResponseResult(
    ...
    def testGetAmenityReservationsSuccessResponseResult(self):
        """Test GetAmenityReservationsSuccessResponseResult"""
