...
class TestGetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner(unittest.TestCase):
    """GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner:
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner`
        """
        model = GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner()
        if include_optional:
            return GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner(
    ...
    def testGetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner(self):
        """Test GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner"""
