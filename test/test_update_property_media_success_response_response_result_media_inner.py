...
class TestUpdatePropertyMediaSuccessResponseResponseResultMediaInner(unittest.TestCase):
    """UpdatePropertyMediaSuccessResponseResponseResultMediaInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePropertyMediaSuccessResponseResponseResultMediaInner:
        """Test UpdatePropertyMediaSuccessResponseResponseResultMediaInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePropertyMediaSuccessResponseResponseResultMediaInner`
        """
        model = UpdatePropertyMediaSuccessResponseResponseResultMediaInner()
        if include_optional:
            return UpdatePropertyMediaSuccessResponseResponseResultMediaInner(
                node = 1,
                id = '555555',
                status = 'Success',
    ...
    def testUpdatePropertyMediaSuccessResponseResponseResultMediaInner(self):
        """Test UpdatePropertyMediaSuccessResponseResponseResultMediaInner"""
