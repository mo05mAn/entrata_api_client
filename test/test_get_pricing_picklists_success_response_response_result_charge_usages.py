...
class TestGetPricingPicklistsSuccessResponseResponseResultChargeUsages(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResultChargeUsages:
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeUsages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResultChargeUsages`
        """
        model = GetPricingPicklistsSuccessResponseResponseResultChargeUsages()
        if include_optional:
    ...
    def testGetPricingPicklistsSuccessResponseResponseResultChargeUsages(self):
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeUsages"""
