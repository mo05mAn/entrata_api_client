...
class TestGetInvoicesR2(unittest.TestCase):
    """GetInvoicesR2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoicesR2:
        """Test GetInvoicesR2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoicesR2`
        """
        model = GetInvoicesR2()
        if include_optional:
            return GetInvoicesR2(
                auth = entrata_api_client.models.request_body_auth.requestBody_auth(
                    type = 'apikey', ),
                request_id = '',
                method = entrata_api_client.models.get_invoices_r2_method.getInvoices_r2_method(
                    name = '', 
                    version = 'r2', 
