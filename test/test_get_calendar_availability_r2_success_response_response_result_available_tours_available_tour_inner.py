...
class TestGetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner(unittest.TestCase):
    """GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner:
        """Test GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner`
        """
        model = GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner()
        if include_optional:
            return GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner(
    ...
    def testGetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner(self):
        """Test GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner"""
