...
class TestSendLeasesSuccessResponseResultLeases(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendLeasesSuccessResponseResultLeases:
        """Test SendLeasesSuccessResponseResultLeases
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeasesSuccessResponseResultLeases`
        """
        model = SendLeasesSuccessResponseResultLeases()
        if include_optional:
    ...
    def testSendLeasesSuccessResponseResultLeases(self):
        """Test SendLeasesSuccessResponseResultLeases"""
