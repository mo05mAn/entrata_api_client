...
class TestGetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity(unittest.TestCase):
    """GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity:
        """Test GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity`
        """
        model = GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity()
        if include_optional:
            return GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity(
    ...
    def testGetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity(self):
        """Test GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity"""
