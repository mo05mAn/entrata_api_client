...
class TestUpdateAmenitiesSuccessResponseResponseResultFloorplanAmenities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenities:
        """Test UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenities`
        """
        model = UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenities()
        if include_optional:
    ...
    def testUpdateAmenitiesSuccessResponseResponseResultFloorplanAmenities(self):
        """Test UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenities"""
