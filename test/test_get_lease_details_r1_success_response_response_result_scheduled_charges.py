...
class TestGetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges(unittest.TestCase):
    """GetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges:
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges`
        """
        model = GetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges()
        if include_optional:
            return GetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges(
                recurring_charge = [
    ...
    def testGetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges(self):
        """Test GetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges"""
