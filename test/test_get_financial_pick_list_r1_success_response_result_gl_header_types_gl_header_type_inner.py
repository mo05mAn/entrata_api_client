...
class TestGetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner(unittest.TestCase):
    """GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner:
        """Test GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner`
        """
        model = GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner()
        if include_optional:
            return GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner(
                id = 1,
                name = 'Standard'
            )
        else:
    ...
    def testGetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner(self):
        """Test GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner"""
