...
class TestGetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInner(unittest.TestCase):
    """GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInner:
        """Test GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInner`
        """
        model = GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInner()
        if include_optional:
            return GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInner(
                vendor_id = '68050',
    ...
    def testGetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInner(self):
        """Test GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInner"""
