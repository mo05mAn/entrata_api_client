...
class TestGetCustomersMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomersMethod:
        """Test GetCustomersMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersMethod`
        """
        model = GetCustomersMethod()
        if include_optional:
    ...
    def testGetCustomersMethod(self):
        """Test GetCustomersMethod"""
