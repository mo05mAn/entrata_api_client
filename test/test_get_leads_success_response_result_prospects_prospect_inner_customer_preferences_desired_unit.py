...
class TestGetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesDesiredUnit(unittest.TestCase):
    """GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesDesiredUnit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesDesiredUnit:
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesDesiredUnit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesDesiredUnit`
        """
        model = GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesDesiredUnit()
        if include_optional:
            return GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesDesiredUnit(
    ...
    def testGetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesDesiredUnit(self):
        """Test GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesDesiredUnit"""
