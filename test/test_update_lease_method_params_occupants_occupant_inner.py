...
class TestUpdateLeaseMethodParamsOccupantsOccupantInner(unittest.TestCase):
    """UpdateLeaseMethodParamsOccupantsOccupantInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateLeaseMethodParamsOccupantsOccupantInner:
        """Test UpdateLeaseMethodParamsOccupantsOccupantInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateLeaseMethodParamsOccupantsOccupantInner`
        """
        model = UpdateLeaseMethodParamsOccupantsOccupantInner()
        if include_optional:
            return UpdateLeaseMethodParamsOccupantsOccupantInner(
                first_name = 'ABC',
                last_name = 'ABC'
            )
        else:
    ...
    def testUpdateLeaseMethodParamsOccupantsOccupantInner(self):
        """Test UpdateLeaseMethodParamsOccupantsOccupantInner"""
