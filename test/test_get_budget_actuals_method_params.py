...
class TestGetBudgetActualsMethodParams(unittest.TestCase):
    """GetBudgetActualsMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBudgetActualsMethodParams:
        """Test GetBudgetActualsMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBudgetActualsMethodParams`
        """
        model = GetBudgetActualsMethodParams()
        if include_optional:
            return GetBudgetActualsMethodParams(
                property_id = 123456,
                gl_tree_id = 1234,
                budget_id = 1234,
                post_month_from = 'MM/YYYY',
                post_month_to = 'MM/YYYY',
                gl_book_type_ids = 56,
                budget_status_type_id = 1234,
    ...
    def testGetBudgetActualsMethodParams(self):
        """Test GetBudgetActualsMethodParams"""
