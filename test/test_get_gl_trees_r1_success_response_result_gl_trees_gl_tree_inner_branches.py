...
class TestGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranches(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranches:
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranches`
        """
        model = GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranches()
        if include_optional:
    ...
    def testGetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranches(self):
        """Test GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranches"""
