...
class TestGetLeasesR2SuccessResponseResponseResultLeasesLeaseInner(unittest.TestCase):
    """GetLeasesR2SuccessResponseResponseResultLeasesLeaseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR2SuccessResponseResponseResultLeasesLeaseInner:
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR2SuccessResponseResponseResultLeasesLeaseInner`
        """
        model = GetLeasesR2SuccessResponseResponseResultLeasesLeaseInner()
        if include_optional:
            return GetLeasesR2SuccessResponseResponseResultLeasesLeaseInner(
                id = '15323250',
    ...
    def testGetLeasesR2SuccessResponseResponseResultLeasesLeaseInner(self):
        """Test GetLeasesR2SuccessResponseResponseResultLeasesLeaseInner"""
