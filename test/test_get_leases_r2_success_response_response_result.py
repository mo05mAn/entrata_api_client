...
class TestGetLeasesR2SuccessResponseResponseResult(unittest.TestCase):
    """GetLeasesR2SuccessResponseResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLeasesR2SuccessResponseResponseResult:
        """Test GetLeasesR2SuccessResponseResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeasesR2SuccessResponseResponseResult`
        """
        model = GetLeasesR2SuccessResponseResponseResult()
        if include_optional:
            return GetLeasesR2SuccessResponseResponseResult(
                currency_code = 'USD',
    ...
    def testGetLeasesR2SuccessResponseResponseResult(self):
        """Test GetLeasesR2SuccessResponseResponseResult"""
