...
class TestGetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner(unittest.TestCase):
    """GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner:
        """Test GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner`
        """
        model = GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner()
        if include_optional:
            return GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner(
                id = 616,
                name = 'Standard'
            )
        else:
    ...
    def testGetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner(self):
        """Test GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner"""
