...
class TestGetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner(unittest.TestCase):
    """GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner:
        """Test GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner`
        """
        model = GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner()
        if include_optional:
            return GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner(
                id = '1',
                name = 'Not Started'
            )
        else:
    ...
    def testGetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner(self):
        """Test GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner"""
