...
class TestGetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner(unittest.TestCase):
    """GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner()
        if include_optional:
            return GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner(
                id_value = '5424549',
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner"""
