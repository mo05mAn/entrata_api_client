...
class TestGetLeadPickListsR2SuccessResponseResultProperty(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultProperty:
        """Test GetLeadPickListsR2SuccessResponseResultProperty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultProperty`
        """
    ...
    def testGetLeadPickListsR2SuccessResponseResultProperty(self):
        """Test GetLeadPickListsR2SuccessResponseResultProperty"""
