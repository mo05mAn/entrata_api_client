...
class TestSearchCustomersMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SearchCustomersMethodParams:
        """Test SearchCustomersMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchCustomersMethodParams`
        """
        model = SearchCustomersMethodParams()
        if include_optional:
            return SearchCustomersMethodParams(
                property_id = 123456,
                search = 'Thornberry'
            )
        else:
    ...
    def testSearchCustomersMethodParams(self):
        """Test SearchCustomersMethodParams"""
