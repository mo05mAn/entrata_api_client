...
class TestGetLeadPickListsR2SuccessResponseResultPsProductsPsProductInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInner:
        """Test GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInner`
        """
    ...
    def testGetLeadPickListsR2SuccessResponseResultPsProductsPsProductInner(self):
        """Test GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInner"""
