...
class TestGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddress(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddress:
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddress`
        """
        model = GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddress()
        if include_optional:
            return GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddress(
    ...
    def testGetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddress(self):
        """Test GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddress"""
