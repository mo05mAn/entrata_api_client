...
class TestGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents:
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents`
        """
        model = GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents()
        if include_optional:
    ...
    def testGetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents(self):
        """Test GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents"""
