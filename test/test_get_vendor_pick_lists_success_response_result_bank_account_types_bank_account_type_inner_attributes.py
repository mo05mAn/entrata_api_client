...
class TestGetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes:
        """Test GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes`
        """
        model = GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes()
        if include_optional:
            return GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes(
                id = '1',
    ...
    def testGetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes(self):
        """Test GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes"""
