...
class TestUpdateAmenitiesMethodParams(unittest.TestCase):
    """UpdateAmenitiesMethodParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAmenitiesMethodParams:
        """Test UpdateAmenitiesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAmenitiesMethodParams`
        """
        model = UpdateAmenitiesMethodParams()
        if include_optional:
            return UpdateAmenitiesMethodParams(
                id = 12345,
    ...
    def testUpdateAmenitiesMethodParams(self):
        """Test UpdateAmenitiesMethodParams"""
