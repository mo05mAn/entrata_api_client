...
class TestUpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails(unittest.TestCase):
    """UpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails:
        """Test UpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails`
        """
        model = UpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails()
        if include_optional:
            return UpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails(
    ...
    def testUpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails(self):
        """Test UpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails"""
