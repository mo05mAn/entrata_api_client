...
class TestGetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes(unittest.TestCase):
    """GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes:
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes`
        """
        model = GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes()
        if include_optional:
            return GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes(
                id = 1,
                name = 'Base'
            )
        else:
    ...
    def testGetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes(self):
        """Test GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes"""
