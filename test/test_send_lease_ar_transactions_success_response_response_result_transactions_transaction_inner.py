...
class TestSendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInner(unittest.TestCase):
    """SendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInner:
        """Test SendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInner`
        """
        model = SendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInner()
        if include_optional:
            return SendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInner(
    ...
    def testSendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInner(self):
        """Test SendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInner"""
