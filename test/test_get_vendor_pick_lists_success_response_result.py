...
class TestGetVendorPickListsSuccessResponseResult(unittest.TestCase):
    """GetVendorPickListsSuccessResponseResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetVendorPickListsSuccessResponseResult:
        """Test GetVendorPickListsSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetVendorPickListsSuccessResponseResult`
        """
        model = GetVendorPickListsSuccessResponseResult()
        if include_optional:
            return GetVendorPickListsSuccessResponseResult(
    ...
    def testGetVendorPickListsSuccessResponseResult(self):
        """Test GetVendorPickListsSuccessResponseResult"""
