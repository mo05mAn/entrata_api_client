...
class TestGetArCodesMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetArCodesMethodParams:
        """Test GetArCodesMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetArCodesMethodParams`
        """
        model = GetArCodesMethodParams()
        if include_optional:
            return GetArCodesMethodParams(
                property_id = 123456
            )
        else:
            return GetArCodesMethodParams(
    ...
    def testGetArCodesMethodParams(self):
        """Test GetArCodesMethodParams"""
