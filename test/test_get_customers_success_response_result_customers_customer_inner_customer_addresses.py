...
class TestGetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddresses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddresses:
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddresses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddresses`
        """
        model = GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddresses()
        if include_optional:
    ...
    def testGetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddresses(self):
        """Test GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddresses"""
