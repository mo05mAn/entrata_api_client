...
class TestMarkGlTransactionsExportedSuccessResponseResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MarkGlTransactionsExportedSuccessResponseResult:
        """Test MarkGlTransactionsExportedSuccessResponseResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkGlTransactionsExportedSuccessResponseResult`
        """
        model = MarkGlTransactionsExportedSuccessResponseResult()
        if include_optional:
            return MarkGlTransactionsExportedSuccessResponseResult(
                status = 'Success',
    ...
    def testMarkGlTransactionsExportedSuccessResponseResult(self):
        """Test MarkGlTransactionsExportedSuccessResponseResult"""
