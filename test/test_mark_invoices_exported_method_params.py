...
class TestMarkInvoicesExportedMethodParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MarkInvoicesExportedMethodParams:
        """Test MarkInvoicesExportedMethodParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkInvoicesExportedMethodParams`
        """
        model = MarkInvoicesExportedMethodParams()
        if include_optional:
            return MarkInvoicesExportedMethodParams(
                line_item_id = 56
            )
        else:
            return MarkInvoicesExportedMethodParams(
    ...
    def testMarkInvoicesExportedMethodParams(self):
        """Test MarkInvoicesExportedMethodParams"""
