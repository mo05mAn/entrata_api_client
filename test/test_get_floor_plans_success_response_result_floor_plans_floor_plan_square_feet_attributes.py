...
class TestGetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes(unittest.TestCase):
    """GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes:
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes`
        """
        model = GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes()
        if include_optional:
            return GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes(
                max = '900',
                min = '900'
            )
        else:
    ...
    def testGetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes(self):
        """Test GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes"""
