...
class TestGetPropertyAnnouncementsSuccessResponse(unittest.TestCase):
    """GetPropertyAnnouncementsSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPropertyAnnouncementsSuccessResponse:
        """Test GetPropertyAnnouncementsSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPropertyAnnouncementsSuccessResponse`
        """
        model = GetPropertyAnnouncementsSuccessResponse()
        if include_optional:
            return GetPropertyAnnouncementsSuccessResponse(
                request_id = 15,
                result = entrata_api_client.models.get_property_announcements_success_response_result.getPropertyAnnouncementsSuccessResponse_result(
    ...
    def testGetPropertyAnnouncementsSuccessResponse(self):
        """Test GetPropertyAnnouncementsSuccessResponse"""
