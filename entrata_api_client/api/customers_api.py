...
class CustomersApi:
    ...
    @validate_call
    def orgs_v1_customers_post(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        orgs_v1_customers_post_request_inner: Annotated[List[OrgsV1CustomersPostRequestInner], Field(description="arPayment related APIs")],
        ...
        :type orgs: str
        :param orgs_v1_customers_post_request_inner: arPayment related APIs (required)
        :type orgs_v1_customers_post_request_inner: List[OrgsV1CustomersPostRequestInner]
        ...
        _param = self._orgs_v1_customers_post_serialize(
            orgs=orgs,
            orgs_v1_customers_post_request_inner=orgs_v1_customers_post_request_inner,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrgsV1CustomersPost200Response",
            '400': "ErrorResponse",
        }
    ...
    @validate_call
    def orgs_v1_customers_post_with_http_info(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        orgs_v1_customers_post_request_inner: Annotated[List[OrgsV1CustomersPostRequestInner], Field(description="arPayment related APIs")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrgsV1CustomersPost200Response]:
        """Customers
    ...
    @validate_call
    def orgs_v1_customers_post_without_preload_content(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        orgs_v1_customers_post_request_inner: Annotated[List[OrgsV1CustomersPostRequestInner], Field(description="arPayment related APIs")],
        _request_timeout: Union[
    ...
    def _orgs_v1_customers_post_serialize(
        self,
        orgs,
        orgs_v1_customers_post_request_inner,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if orgs_v1_customers_post_request_inner is not None:
            _body_params = orgs_v1_customers_post_request_inner
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{orgs}/v1/customers',
