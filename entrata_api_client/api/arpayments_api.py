...
class ArpaymentsApi:
    ...
    @validate_call
    def orgs_v1_arpayments_post(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        get_ar_payments: Annotated[GetArPayments, Field(description="Retrieves AR payments details with reference to a Payment ID and for a selected date range.")],
        ...
        :type orgs: str
        :param get_ar_payments: Retrieves AR payments details with reference to a Payment ID and for a selected date range. (required)
        :type get_ar_payments: GetArPayments
        ...
        _param = self._orgs_v1_arpayments_post_serialize(
            orgs=orgs,
            get_ar_payments=get_ar_payments,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrgsV1ArpaymentsPost200Response",
            '400': "ErrorResponse",
        }
    ...
    @validate_call
    def orgs_v1_arpayments_post_with_http_info(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        get_ar_payments: Annotated[GetArPayments, Field(description="Retrieves AR payments details with reference to a Payment ID and for a selected date range.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrgsV1ArpaymentsPost200Response]:
        """arPayments
    ...
    @validate_call
    def orgs_v1_arpayments_post_without_preload_content(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        get_ar_payments: Annotated[GetArPayments, Field(description="Retrieves AR payments details with reference to a Payment ID and for a selected date range.")],
        _request_timeout: Union[
    ...
    def _orgs_v1_arpayments_post_serialize(
        self,
        orgs,
        get_ar_payments,
        _request_auth,
        ...
        if get_ar_payments is not None:
            _body_params = get_ar_payments
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{orgs}/v1/arpayments',
