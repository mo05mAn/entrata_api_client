...
class StatusApi:
    ...
    @validate_call
    def orgs_v1_status_post(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        get_status: Annotated[GetStatus, Field(description="This API will specify the API health status whether it is running or not.")],
        ...
        :type orgs: str
        :param get_status: This API will specify the API health status whether it is running or not. (required)
        :type get_status: GetStatus
        ...
        _param = self._orgs_v1_status_post_serialize(
            orgs=orgs,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrgsV1StatusPost200Response",
            '400': "ErrorResponse",
        }
    ...
    @validate_call
    def orgs_v1_status_post_with_http_info(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        get_status: Annotated[GetStatus, Field(description="This API will specify the API health status whether it is running or not.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrgsV1StatusPost200Response]:
        """API Health check
    ...
    @validate_call
    def orgs_v1_status_post_without_preload_content(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        get_status: Annotated[GetStatus, Field(description="This API will specify the API health status whether it is running or not.")],
        _request_timeout: Union[
    ...
    def _orgs_v1_status_post_serialize(
        self,
        orgs,
        get_status,
        _request_auth,
