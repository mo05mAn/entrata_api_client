...
from entrata_api_client.api_response import ApiResponse, T as ApiResponseT
import entrata_api_client.models
from entrata_api_client import rest
from entrata_api_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(entrata_api_client.models, klass)
