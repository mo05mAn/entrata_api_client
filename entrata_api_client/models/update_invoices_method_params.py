...
class UpdateInvoicesMethodParams(BaseModel):
    """
    UpdateInvoicesMethodParams
    """ # noqa: E501
    id: StrictInt = Field(description="This is a required field. This field accepts single value. Accepts apHeader id,apDetail id")
    invoice_payment_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="invoicePaymentId")
    payment_amount: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="paymentAmount")
    payment_type_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="paymentTypeId")
    payment_number: StrictStr = Field(description="This is a required field. This field accepts single value.", alias="paymentNumber")
    payment_date: date = Field(description="This is a required field. This field accepts single value.", alias="paymentDate")
    post_month: date = Field(description="This is a required field. This field accepts single value.", alias="postMonth")
    is_on_hold: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Update an invoice that is on hold, and take it off hold, and vice vers a, Allowed values ( 0, 1 )", alias="isOnHold")
    routing_tag_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Update the routing tag on an invoice, to another valid routing tag. Al low for not posted and off hold invoice.", alias="routingTagId")
    __properties: ClassVar[List[str]] = ["id", "invoicePaymentId", "paymentAmount", "paymentTypeId", "paymentNumber", "paymentDate", "postMonth", "isOnHold", "routingTagId"]
