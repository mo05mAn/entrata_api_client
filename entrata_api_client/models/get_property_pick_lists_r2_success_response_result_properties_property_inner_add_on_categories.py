...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAddOnCategories(BaseModel):
    """
    Categories of add-ons available
    """ # noqa: E501
    add_on_category: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAddOnCategoriesAddOnCategoryInner] = Field(alias="addOnCategory")
    __properties: ClassVar[List[str]] = ["addOnCategory"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in add_on_category (list)
        _items = []
        if self.add_on_category:
            for _item in self.add_on_category:
                if _item:
                    _items.append(_item.to_dict())
            _dict['addOnCategory'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addOnCategory": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAddOnCategoriesAddOnCategoryInner.from_dict(_item) for _item in obj["addOnCategory"]] if obj.get("addOnCategory") is not None else None
        })
        return _obj
