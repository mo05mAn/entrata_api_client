...
class GetBudgetActualsSuccessResponseResultBudgetVsActuals(BaseModel):
    """
    GetBudgetActualsSuccessResponseResultBudgetVsActuals
    """ # noqa: E501
    budget_vs_actual: List[GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner] = Field(description="A list of budget vs actual records.", alias="budgetVsActual")
    __properties: ClassVar[List[str]] = ["budgetVsActual"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in budget_vs_actual (list)
        _items = []
        if self.budget_vs_actual:
            for _item in self.budget_vs_actual:
                if _item:
                    _items.append(_item.to_dict())
            _dict['budgetVsActual'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budgetVsActual": [GetBudgetActualsSuccessResponseResultBudgetVsActualsBudgetVsActualInner.from_dict(_item) for _item in obj["budgetVsActual"]] if obj.get("budgetVsActual") is not None else None
        })
        return _obj
