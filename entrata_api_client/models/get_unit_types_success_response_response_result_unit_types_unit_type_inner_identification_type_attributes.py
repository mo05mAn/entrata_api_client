...
class GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes(BaseModel):
    """
    GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes
    """ # noqa: E501
    id_type: StrictStr = Field(description="The type of the identification", alias="idType")
    __properties: ClassVar[List[str]] = ["idType"]
