...
class GetTestimonialPickListsSuccessResponseResultTestimonialTypes(BaseModel):
    """
    GetTestimonialPickListsSuccessResponseResultTestimonialTypes
    """ # noqa: E501
    testimonial_type: List[GetTestimonialPickListsSuccessResponseResultTestimonialTypesTestimonialTypeInner] = Field(alias="TestimonialType")
    __properties: ClassVar[List[str]] = ["TestimonialType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in testimonial_type (list)
        _items = []
        if self.testimonial_type:
            for _item in self.testimonial_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['TestimonialType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "TestimonialType": [GetTestimonialPickListsSuccessResponseResultTestimonialTypesTestimonialTypeInner.from_dict(_item) for _item in obj["TestimonialType"]] if obj.get("TestimonialType") is not None else None
        })
        return _obj
