...
class GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType
    """ # noqa: E501
    type: StrictStr = Field(description="Type of insurance policy.", alias="Type")
    policy_number: StrictStr = Field(description="Policy number.", alias="PolicyNumber")
    expiration: StrictStr = Field(description="Expiration date of the policy.", alias="Expiration")
    coverages: GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyTypeCoverages = Field(alias="Coverages")
    __properties: ClassVar[List[str]] = ["Type", "PolicyNumber", "Expiration", "Coverages"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of coverages
        if self.coverages:
            _dict['Coverages'] = self.coverages.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Coverages": GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyTypeCoverages.from_dict(obj["Coverages"]) if obj.get("Coverages") is not None else None
        })
        return _obj
