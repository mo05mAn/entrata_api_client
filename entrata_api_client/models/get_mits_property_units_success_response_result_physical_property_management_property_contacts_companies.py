...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementPropertyContactsCompanies(BaseModel):
    """
    Companies related to the property
    """ # noqa: E501
    identification: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementPropertyContactsCompaniesIdentification] = Field(default=None, alias="Identification")
    company_name: Optional[StrictStr] = Field(default=None, description="Name of the company", alias="CompanyName")
    web_site: Optional[StrictStr] = Field(default=None, description="Company website URL", alias="WebSite")
    __properties: ClassVar[List[str]] = ["Identification", "CompanyName", "WebSite"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementPropertyContactsCompaniesIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
