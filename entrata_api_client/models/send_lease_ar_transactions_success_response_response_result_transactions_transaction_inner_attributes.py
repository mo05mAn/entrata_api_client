...
class SendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInnerAttributes(BaseModel):
    """
    SendLeaseArTransactionsSuccessResponseResponseResultTransactionsTransactionInnerAttributes
    """ # noqa: E501
    reference_id: StrictInt = Field(description="The reference identifier for the transaction")
