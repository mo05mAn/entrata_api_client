...
class GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenities(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenities
    """ # noqa: E501
    amenity: GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity = Field(alias="Amenity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Amenity": GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity.from_dict(obj["Amenity"]) if obj.get("Amenity") is not None else None
        })
        return _obj
