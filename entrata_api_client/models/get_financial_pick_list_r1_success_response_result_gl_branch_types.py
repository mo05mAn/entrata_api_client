...
class GetFinancialPickListR1SuccessResponseResultGlBranchTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlBranchTypes
    """ # noqa: E501
    gl_branch_type: List[GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner] = Field(description="A list of GL branch types.", alias="GlBranchType")
    __properties: ClassVar[List[str]] = ["GlBranchType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_branch_type (list)
        _items = []
        if self.gl_branch_type:
            for _item in self.gl_branch_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['GlBranchType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlBranchType": [GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner.from_dict(_item) for _item in obj["GlBranchType"]] if obj.get("GlBranchType") is not None else None
        })
        return _obj
