...
class GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerLeaseTermDetailsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["leaseTermId", "leaseTermName", "leaseStartWindowId"]
