...
class SendPurchaseOrdersSuccessResponseResult(BaseModel):
    """
    SendPurchaseOrdersSuccessResponseResult
    """ # noqa: E501
    ap_headers: Optional[SendPurchaseOrdersSuccessResponseResultApHeaders] = Field(default=None, alias="apHeaders")
    __properties: ClassVar[List[str]] = ["apHeaders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apHeaders": SendPurchaseOrdersSuccessResponseResultApHeaders.from_dict(obj["apHeaders"]) if obj.get("apHeaders") is not None else None
        })
        return _obj
