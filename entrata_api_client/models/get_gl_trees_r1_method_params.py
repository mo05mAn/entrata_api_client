...
class GetGlTreesR1MethodParams(BaseModel):
    """
    GetGlTreesR1MethodParams
    """ # noqa: E501
    property_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Property Id", alias="propertyId")
    gl_tree_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Gl Tree Id", alias="glTreeId")
    gl_branch_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Gl Branch Id", alias="glBranchId")
    gl_group_type_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Gl Group Type Id", alias="glGroupTypeId")
    gl_tree_type_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Gl Tree Type Id", alias="glTreeTypeId")
    account_numbers: Optional[date] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values.", alias="accountNumbers")
    __properties: ClassVar[List[str]] = ["propertyId", "glTreeId", "glBranchId", "glGroupTypeId", "glTreeTypeId", "accountNumbers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "glBranchId": obj.get("glBranchId"),
            "glGroupTypeId": obj.get("glGroupTypeId"),
            "glTreeTypeId": obj.get("glTreeTypeId"),
            "accountNumbers": obj.get("accountNumbers")
        })
        return _obj
