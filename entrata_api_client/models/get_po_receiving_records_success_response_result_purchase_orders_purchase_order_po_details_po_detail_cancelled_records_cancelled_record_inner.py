...
class GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetailsPoDetailCancelledRecordsCancelledRecordInner(BaseModel):
    """
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the cancelled record.")
    property_id: StrictInt = Field(description="Property ID where the item was cancelled.", alias="propertyId")
    qty_cancelled: StrictStr = Field(description="Quantity of items cancelled.", alias="qtyCancelled")
    unit_cost: StrictStr = Field(description="Cost per unit of the cancelled item.", alias="unitCost")
    date_cancelled: StrictStr = Field(description="Date when the item was cancelled.", alias="dateCancelled")
    post_month_cancelled: StrictStr = Field(description="Month when the cancellation was posted.", alias="postMonthCancelled")
    cancelled_by: StrictStr = Field(description="Name of the person who cancelled the item.", alias="cancelledBy")
    __properties: ClassVar[List[str]] = ["id", "propertyId", "qtyCancelled", "unitCost", "dateCancelled", "postMonthCancelled", "cancelledBy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "qtyCancelled": obj.get("qtyCancelled"),
            "unitCost": obj.get("unitCost"),
            "dateCancelled": obj.get("dateCancelled"),
            "postMonthCancelled": obj.get("postMonthCancelled"),
