...
class GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner(BaseModel):
    """
    GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner
    """ # noqa: E501
    branch_id: StrictStr = Field(description="Unique identifier for the branch", alias="branchId")
    group_type: StrictStr = Field(description="Type of the group for the branch", alias="groupType")
    is_enabled: Optional[StrictStr] = Field(default=None, description="Indicates if the branch is enabled ", alias="isEnabled")
    show_group_name: Optional[StrictInt] = Field(default=None, description="Indicates if the group name should be displayed", alias="showGroupName")
    group_name: Optional[StrictStr] = Field(default=None, description="The name of the group in the branch", alias="groupName")
    show_summary_row: Optional[StrictInt] = Field(default=None, description="Indicates if the summary row should be shown", alias="showSummaryRow")
    description: Optional[StrictStr] = Field(default=None, description="A brief description of the branch")
    __properties: ClassVar[List[str]] = ["branchId", "groupType", "isEnabled", "showGroupName", "groupName", "showSummaryRow", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "showGroupName": obj.get("showGroupName"),
            "groupName": obj.get("groupName"),
            "showSummaryRow": obj.get("showSummaryRow"),
