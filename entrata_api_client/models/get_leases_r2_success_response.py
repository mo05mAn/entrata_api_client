...
class GetLeasesR2SuccessResponse(BaseModel):
    """
    GetLeasesR2SuccessResponse
    """ # noqa: E501
    response: GetLeasesR2SuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetLeasesR2SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
