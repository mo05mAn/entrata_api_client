...
class GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the leasing agent.")
