...
class SendPropertyUnitsSuccessResponseResponseResult(BaseModel):
    """
    SendPropertyUnitsSuccessResponseResponseResult
    """ # noqa: E501
    units: SendPropertyUnitsSuccessResponseResponseResultUnits
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "units": SendPropertyUnitsSuccessResponseResponseResultUnits.from_dict(obj["units"]) if obj.get("units") is not None else None
        })
        return _obj
