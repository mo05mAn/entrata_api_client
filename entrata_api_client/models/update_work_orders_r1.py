...
class UpdateWorkOrdersR1(BaseModel):
    """
    UpdateWorkOrdersR1
    """ # noqa: E501
    ...
    method: UpdateWorkOrdersR1Method
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": UpdateWorkOrdersR1Method.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
