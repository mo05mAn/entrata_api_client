...
class GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts(BaseModel):
    """
    GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts
    """ # noqa: E501
    property_bank_account: List[GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccountsPropertyBankAccountInner] = Field(description="A list of property bank accounts associated with the bank account.", alias="PropertyBankAccount")
    __properties: ClassVar[List[str]] = ["PropertyBankAccount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in property_bank_account (list)
        _items = []
        if self.property_bank_account:
            for _item in self.property_bank_account:
                if _item:
                    _items.append(_item.to_dict())
            _dict['PropertyBankAccount'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PropertyBankAccount": [GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccountsPropertyBankAccountInner.from_dict(_item) for _item in obj["PropertyBankAccount"]] if obj.get("PropertyBankAccount") is not None else None
        })
        return _obj
