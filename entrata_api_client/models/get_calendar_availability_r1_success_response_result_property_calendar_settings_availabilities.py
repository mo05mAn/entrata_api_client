...
class GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilities(BaseModel):
    """
    Availability schedule for the property
    """ # noqa: E501
    availability: Optional[List[GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner]] = Field(default=None, description="List of availability slots")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availability": [GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner.from_dict(_item) for _item in obj["availability"]] if obj.get("availability") is not None else None
        })
        return _obj
