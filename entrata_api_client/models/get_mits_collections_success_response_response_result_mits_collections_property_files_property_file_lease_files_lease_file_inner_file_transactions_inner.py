...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerFileTransactionsInner(BaseModel):
    """
    ...
    """ # noqa: E501
    identification: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerFileTransactionsInnerIdentification = Field(alias="Identification")
    trans_date: StrictStr = Field(description="Transaction date", alias="TransDate")
    trans_type_desc: StrictStr = Field(description="Transaction type description", alias="TransTypeDesc")
    trans_type: StrictStr = Field(description="Transaction type", alias="TransType")
    trans_amount: StrictStr = Field(description="Transaction amount", alias="TransAmount")
    open_amount: StrictStr = Field(description="Open amount", alias="OpenAmount")
    __properties: ClassVar[List[str]] = ["Identification", "TransDate", "TransTypeDesc", "TransType", "TransAmount", "OpenAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerFileTransactionsInnerIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "TransDate": obj.get("TransDate"),
            "TransTypeDesc": obj.get("TransTypeDesc"),
            "TransType": obj.get("TransType"),
            "TransAmount": obj.get("TransAmount"),
