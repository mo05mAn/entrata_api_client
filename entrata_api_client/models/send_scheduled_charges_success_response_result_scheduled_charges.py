...
class SendScheduledChargesSuccessResponseResultScheduledCharges(BaseModel):
    """
    SendScheduledChargesSuccessResponseResultScheduledCharges
    """ # noqa: E501
    scheduled_charge: List[SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner] = Field(alias="scheduledCharge")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scheduledCharge": [SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner.from_dict(_item) for _item in obj["scheduledCharge"]] if obj.get("scheduledCharge") is not None else None
        })
        return _obj
