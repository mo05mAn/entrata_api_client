...
class GetLeaseDocumentsListSuccessResponseResultLeaseDocuments(BaseModel):
    """
    GetLeaseDocumentsListSuccessResponseResultLeaseDocuments
    """ # noqa: E501
    lease_document: List[GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner] = Field(alias="leaseDocument")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lease_document (list)
        _items = []
        if self.lease_document:
            for _item in self.lease_document:
                if _item:
                    _items.append(_item.to_dict())
            _dict['leaseDocument'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leaseDocument": [GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner.from_dict(_item) for _item in obj["leaseDocument"]] if obj.get("leaseDocument") is not None else None
        })
        return _obj
