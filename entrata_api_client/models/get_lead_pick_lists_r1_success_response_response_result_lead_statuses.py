...
class GetLeadPickListsR1SuccessResponseResponseResultLeadStatuses(BaseModel):
    """
    Lead statuses associated with the request.
    """ # noqa: E501
    lead_status: Optional[List[GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInner]] = Field(default=None, description="A list of lead statuses.", alias="LeadStatus")
    __properties: ClassVar[List[str]] = ["LeadStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lead_status (list)
        _items = []
        if self.lead_status:
            for _item in self.lead_status:
                if _item:
                    _items.append(_item.to_dict())
            _dict['LeadStatus'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LeadStatus": [GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInner.from_dict(_item) for _item in obj["LeadStatus"]] if obj.get("LeadStatus") is not None else None
        })
        return _obj
