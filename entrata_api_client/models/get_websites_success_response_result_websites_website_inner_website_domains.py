...
class GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains(BaseModel):
    """
    GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains
    """ # noqa: E501
    website_domain: List[GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomainsWebsiteDomainInner] = Field(alias="websiteDomain")
    __properties: ClassVar[List[str]] = ["websiteDomain"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in website_domain (list)
        _items = []
        if self.website_domain:
            for _item in self.website_domain:
                if _item:
                    _items.append(_item.to_dict())
            _dict['websiteDomain'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "websiteDomain": [GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomainsWebsiteDomainInner.from_dict(_item) for _item in obj["websiteDomain"]] if obj.get("websiteDomain") is not None else None
        })
        return _obj
