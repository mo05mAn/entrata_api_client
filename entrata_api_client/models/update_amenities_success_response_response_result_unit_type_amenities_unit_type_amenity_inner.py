...
class UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner(BaseModel):
    """
    UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner
    """ # noqa: E501
    node: StrictInt = Field(description="Unique identifier for the unit type amenity node")
    status: StrictStr = Field(description="Status of the operation")
    message: StrictStr = Field(description="Message about the unit type amenity operation")
    __properties: ClassVar[List[str]] = ["node", "status", "message"]
