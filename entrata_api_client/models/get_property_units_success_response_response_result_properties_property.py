...
class GetPropertyUnitsSuccessResponseResponseResultPropertiesProperty(BaseModel):
    """
    GetPropertyUnitsSuccessResponseResponseResultPropertiesProperty
    """ # noqa: E501
    property_id: StrictInt = Field(description="Unique identifier for the property", alias="propertyId")
    property_name: StrictStr = Field(description="Name of the property", alias="propertyName")
    remote_primary_key: StrictStr = Field(description="Identifier from the remote system", alias="remotePrimaryKey")
    unit_count: StrictInt = Field(description="Number of units in the property", alias="unitCount")
    building_count: StrictInt = Field(description="Number of buildings in the property", alias="buildingCount")
    property_availability_url: StrictStr = Field(description="URL for checking property availability", alias="propertyAvailabilityURL")
    units: GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnits
    __properties: ClassVar[List[str]] = ["propertyId", "propertyName", "remotePrimaryKey", "unitCount", "buildingCount", "propertyAvailabilityURL", "units"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "remotePrimaryKey": obj.get("remotePrimaryKey"),
            "unitCount": obj.get("unitCount"),
            "buildingCount": obj.get("buildingCount"),
            "propertyAvailabilityURL": obj.get("propertyAvailabilityURL"),
            "units": GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnits.from_dict(obj["units"]) if obj.get("units") is not None else None
        })
        return _obj
