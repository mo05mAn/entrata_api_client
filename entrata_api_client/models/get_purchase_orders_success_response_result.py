...
class GetPurchaseOrdersSuccessResponseResult(BaseModel):
    """
    GetPurchaseOrdersSuccessResponseResult
    """ # noqa: E501
    purchase_orders: Optional[GetPurchaseOrdersSuccessResponseResultPurchaseOrders] = Field(default=None, alias="purchaseOrders")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "purchaseOrders": GetPurchaseOrdersSuccessResponseResultPurchaseOrders.from_dict(obj["purchaseOrders"]) if obj.get("purchaseOrders") is not None else None
        })
        return _obj
