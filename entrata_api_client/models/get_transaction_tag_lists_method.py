...
class GetTransactionTagListsMethod(BaseModel):
    """
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['getTransactionTagLists']):
            raise ValueError("must be one of enum values ('getTransactionTagLists')")
        return value
