...
class GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddressesCustomerAddressInner(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddressesCustomerAddressInner
    """ # noqa: E501
    address: StrictStr = Field(description="Forwarding address", alias="Address")
    city: StrictStr = Field(description="City of the forwarding address", alias="City")
    state: StrictStr = Field(description="State of the forwarding address", alias="State")
    postal_code: StrictStr = Field(description="Postal code of the forwarding address", alias="PostalCode")
    country: StrictStr = Field(description="Country of the forwarding address", alias="Country")
    attributes: Optional[GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddressesCustomerAddressInnerAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["Address", "City", "State", "PostalCode", "Country", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddressesCustomerAddressInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
