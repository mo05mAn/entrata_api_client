...
class GetPropertyMediaSuccessResponse(BaseModel):
    """
    GetPropertyMediaSuccessResponse
    """ # noqa: E501
    response: GetPropertyMediaSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetPropertyMediaSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
