...
class GetLeadPickListsR2SuccessResponseResultCustomerRelationshipTypesCustomerRelationshipTypeInnerAttributes(BaseModel):
    """
    Attributes related to the customer relationship type.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the customer relationship type.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the customer relationship type.")
    is_default: Optional[StrictStr] = Field(default=None, description="Indicates if the customer relationship type is the default.", alias="isDefault")
    customer_type: Optional[StrictStr] = Field(default=None, description="The type of customer.", alias="customerType")
    customer_type_id: Optional[StrictStr] = Field(default=None, description="The unique ID of the customer type.", alias="customerTypeId")
    __properties: ClassVar[List[str]] = ["id", "name", "isDefault", "customerType", "customerTypeId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customerTypeId": obj.get("customerTypeId")
        })
        return _obj
