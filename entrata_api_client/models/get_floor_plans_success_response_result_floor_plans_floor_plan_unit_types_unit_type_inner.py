...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner(BaseModel):
    """
    GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner
    """ # noqa: E501
    value: StrictStr = Field(description="The value of the unit type", alias="@value")
    attributes: GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["@value", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@value": obj.get("@value"),
            "@attributes": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
