...
class GetVendorLocationsSuccessResponseResultInsurances(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultInsurances
    """ # noqa: E501
    insurance: Optional[List[GetVendorLocationsSuccessResponseResultInsurancesInsuranceInner]] = Field(default=None, alias="Insurance")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in insurance (list)
        _items = []
        if self.insurance:
            for _item in self.insurance:
                if _item:
                    _items.append(_item.to_dict())
            _dict['Insurance'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Insurance": [GetVendorLocationsSuccessResponseResultInsurancesInsuranceInner.from_dict(_item) for _item in obj["Insurance"]] if obj.get("Insurance") is not None else None
        })
        return _obj
