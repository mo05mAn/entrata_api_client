...
class GetQuotesSuccessResponseResultApplications(BaseModel):
    """
    The applications associated with the request.
    """ # noqa: E501
    application: Optional[List[GetQuotesSuccessResponseResultApplicationsApplicationInner]] = Field(default=None, description="A list of application entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "application": [GetQuotesSuccessResponseResultApplicationsApplicationInner.from_dict(_item) for _item in obj["application"]] if obj.get("application") is not None else None
        })
        return _obj
