...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerRentableItems(BaseModel):
    """
    Items that are rentable
    """ # noqa: E501
    rentable_item: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerRentableItemsRentableItemInner] = Field(alias="rentableItem")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rentableItem": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerRentableItemsRentableItemInner.from_dict(_item) for _item in obj["rentableItem"]] if obj.get("rentableItem") is not None else None
        })
        return _obj
