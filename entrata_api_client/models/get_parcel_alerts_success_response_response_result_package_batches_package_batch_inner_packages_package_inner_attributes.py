...
class GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackagesPackageInnerAttributes(BaseModel):
    """
    GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackagesPackageInnerAttributes
    """ # noqa: E501
    id: StrictInt = Field(description="Identifier for the package")
