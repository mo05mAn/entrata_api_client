...
class GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the legal entity.", alias="Id")
