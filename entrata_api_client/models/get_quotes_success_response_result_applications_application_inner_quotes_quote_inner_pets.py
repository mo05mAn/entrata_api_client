...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerPets(BaseModel):
    """
    The list of pets allowed with the lease.
    """ # noqa: E501
    pet: Optional[List[GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerPetsPetInner]] = Field(default=None, description="A list of pets.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pet": [GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerPetsPetInner.from_dict(_item) for _item in obj["pet"]] if obj.get("pet") is not None else None
        })
        return _obj
