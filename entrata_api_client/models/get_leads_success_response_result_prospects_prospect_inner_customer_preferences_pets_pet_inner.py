...
class GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner(BaseModel):
    """
    GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner
    """ # noqa: E501
    pet_type: Optional[List[StrictStr]] = Field(default=None, description="The types of pets.", alias="petType")
    count: Optional[List[StrictStr]] = Field(default=None, description="The number of pets.")
    __properties: ClassVar[List[str]] = ["petType", "count"]
