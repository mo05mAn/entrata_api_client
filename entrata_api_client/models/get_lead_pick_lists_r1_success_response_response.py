...
class GetLeadPickListsR1SuccessResponseResponse(BaseModel):
    """
    The response data containing request information and result.
    """ # noqa: E501
    request_id: Optional[StrictStr] = Field(default=None, description="A unique identifier for the request.", alias="requestId")
    code: Optional[StrictInt] = Field(default=None, description="Successful response code.")
    result: Optional[GetLeadPickListsR1SuccessResponseResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetLeadPickListsR1SuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
