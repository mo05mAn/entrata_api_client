...
class GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplansFloorplanAttributes(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplansFloorplanAttributes
    """ # noqa: E501
    property_floorplan_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the floorplan", alias="PropertyFloorplanId")
    external_id: Optional[StrictStr] = Field(default=None, description="External identifier for the floorplan", alias="ExternalId")
    is_optional: Optional[StrictStr] = Field(default=None, description="Indicates if the floorplan is optional", alias="IsOptional")
    is_published: Optional[StrictStr] = Field(default=None, description="Indicates if the floorplan is published", alias="IsPublished")
    is_featured: Optional[StrictStr] = Field(default=None, description="Indicates if the floorplan is featured", alias="IsFeatured")
    __properties: ClassVar[List[str]] = ["PropertyFloorplanId", "ExternalId", "IsOptional", "IsPublished", "IsFeatured"]
