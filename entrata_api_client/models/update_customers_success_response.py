...
class UpdateCustomersSuccessResponse(BaseModel):
    """
    ...
    code: StrictStr = Field(description="The response code indicating the status of the request.")
    result: UpdateCustomersSuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": UpdateCustomersSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
