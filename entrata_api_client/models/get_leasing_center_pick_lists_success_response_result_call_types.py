...
class GetLeasingCenterPickListsSuccessResponseResultCallTypes(BaseModel):
    """
    GetLeasingCenterPickListsSuccessResponseResultCallTypes
    """ # noqa: E501
    call_type: List[GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner] = Field(alias="callType")
    __properties: ClassVar[List[str]] = ["callType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in call_type (list)
        _items = []
        if self.call_type:
            for _item in self.call_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['callType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "callType": [GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner.from_dict(_item) for _item in obj["callType"]] if obj.get("callType") is not None else None
        })
        return _obj
