...
class SendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner(BaseModel):
    """
    SendAmenitiesSuccessResponseResponseResultPropertyAmenitiesInner
    """ # noqa: E501
    node: StrictInt = Field(description="Unique identifier for the amenity node")
    status: StrictStr = Field(description="Status of the amenity operation")
    amenity_id: StrictInt = Field(description="Unique identifier for the property amenity", alias="amenityId")
    rate_association_id: StrictInt = Field(description="Unique identifier for the rate association", alias="rateAssociationId")
    name: StrictStr = Field(description="Name of the property amenity")
    message: StrictStr = Field(description="Message about the amenity operation")
