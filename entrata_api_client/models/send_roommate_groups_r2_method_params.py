...
class SendRoommateGroupsR2MethodParams(BaseModel):
    """
    SendRoommateGroupsR2MethodParams
    """ # noqa: E501
    roommate_groups: SendRoommateGroupsR2MethodParamsRoommateGroups = Field(alias="roommateGroups")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of roommate_groups
        if self.roommate_groups:
            _dict['roommateGroups'] = self.roommate_groups.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roommateGroups": SendRoommateGroupsR2MethodParamsRoommateGroups.from_dict(obj["roommateGroups"]) if obj.get("roommateGroups") is not None else None
        })
        return _obj
