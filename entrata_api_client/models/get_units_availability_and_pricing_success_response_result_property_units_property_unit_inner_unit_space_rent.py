...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInnerUnitSpaceRent(BaseModel):
    """
    Rent details for the unit
    """ # noqa: E501
    term_rent: GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInnerUnitSpaceRentTermRent = Field(alias="TermRent")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "TermRent": GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInnerUnitSpaceRentTermRent.from_dict(obj["TermRent"]) if obj.get("TermRent") is not None else None
        })
        return _obj
