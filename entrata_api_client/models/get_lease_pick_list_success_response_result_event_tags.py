...
class GetLeasePickListSuccessResponseResultEventTags(BaseModel):
    """
    GetLeasePickListSuccessResponseResultEventTags
    """ # noqa: E501
    event_tag: List[GetLeasePickListSuccessResponseResultEventTagsEventTagInner] = Field(alias="eventTag")
    __properties: ClassVar[List[str]] = ["eventTag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in event_tag (list)
        _items = []
        if self.event_tag:
            for _item in self.event_tag:
                if _item:
                    _items.append(_item.to_dict())
            _dict['eventTag'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventTag": [GetLeasePickListSuccessResponseResultEventTagsEventTagInner.from_dict(_item) for _item in obj["eventTag"]] if obj.get("eventTag") is not None else None
        })
        return _obj
