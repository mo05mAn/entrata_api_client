...
class GetUnitTypesSuccessResponseResponseResult(BaseModel):
    """
    GetUnitTypesSuccessResponseResponseResult
    """ # noqa: E501
    var_property: GetUnitTypesSuccessResponseResponseResultProperty = Field(alias="property")
    unit_types: GetUnitTypesSuccessResponseResponseResultUnitTypes = Field(alias="unitTypes")
    __properties: ClassVar[List[str]] = ["property", "unitTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property": GetUnitTypesSuccessResponseResponseResultProperty.from_dict(obj["property"]) if obj.get("property") is not None else None,
            "unitTypes": GetUnitTypesSuccessResponseResponseResultUnitTypes.from_dict(obj["unitTypes"]) if obj.get("unitTypes") is not None else None
        })
        return _obj
