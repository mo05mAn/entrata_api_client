...
class GetLeadEventsSuccessResponseResultProspectsProspectInner(BaseModel):
    """
    GetLeadEventsSuccessResponseResultProspectsProspectInner
    """ # noqa: E501
    application_id: StrictStr = Field(description="The unique ID for the application.", alias="applicationId")
    events: GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents
    __properties: ClassVar[List[str]] = ["applicationId", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents.from_dict(obj["events"]) if obj.get("events") is not None else None
        })
        return _obj
