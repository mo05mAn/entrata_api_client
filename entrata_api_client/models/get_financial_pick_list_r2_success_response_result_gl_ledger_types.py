...
class GetFinancialPickListR2SuccessResponseResultGlLedgerTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlLedgerTypes
    """ # noqa: E501
    gl_ledger_type: List[GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner] = Field(description="A list of GL ledger types.", alias="glLedgerType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glLedgerType": [GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner.from_dict(_item) for _item in obj["glLedgerType"]] if obj.get("glLedgerType") is not None else None
        })
        return _obj
