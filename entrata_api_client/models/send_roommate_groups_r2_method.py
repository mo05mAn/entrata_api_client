...
class SendRoommateGroupsR2Method(BaseModel):
    """
    SendRoommateGroupsR2Method
    """ # noqa: E501
    name: StrictStr
    version: StrictStr
    params: SendRoommateGroupsR2MethodParams
    __properties: ClassVar[List[str]] = ["name", "version", "params"]

    @field_validator('name')
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['sendRoommateGroups']):
            raise ValueError("must be one of enum values ('sendRoommateGroups')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": SendRoommateGroupsR2MethodParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
