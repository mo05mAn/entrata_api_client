...
class GetVendorPickListsSuccessResponseResultApPayeeStatusTypes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultApPayeeStatusTypes
    """ # noqa: E501
    ap_payee_status_type: Optional[List[GetVendorPickListsSuccessResponseResultApPayeeStatusTypesApPayeeStatusTypeInner]] = Field(default=None, alias="apPayeeStatusType")
    __properties: ClassVar[List[str]] = ["apPayeeStatusType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_payee_status_type (list)
        _items = []
        if self.ap_payee_status_type:
            for _item in self.ap_payee_status_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['apPayeeStatusType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apPayeeStatusType": [GetVendorPickListsSuccessResponseResultApPayeeStatusTypesApPayeeStatusTypeInner.from_dict(_item) for _item in obj["apPayeeStatusType"]] if obj.get("apPayeeStatusType") is not None else None
        })
        return _obj
