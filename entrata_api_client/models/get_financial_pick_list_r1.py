...
class GetFinancialPickListR1(BaseModel):
    """
    ...
    method: GetFinancialPickListR1Method
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": GetFinancialPickListR1Method.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
