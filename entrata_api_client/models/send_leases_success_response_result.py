...
class SendLeasesSuccessResponseResult(BaseModel):
    """
    SendLeasesSuccessResponseResult
    """ # noqa: E501
    leases: SendLeasesSuccessResponseResultLeases
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leases": SendLeasesSuccessResponseResultLeases.from_dict(obj["leases"]) if obj.get("leases") is not None else None
        })
        return _obj
