...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHours(BaseModel):
    """
    Pool operating hours
    """ # noqa: E501
    pool_hour: Optional[GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour] = Field(default=None, alias="PoolHour")
    __properties: ClassVar[List[str]] = ["PoolHour"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pool_hour
        if self.pool_hour:
            _dict['PoolHour'] = self.pool_hour.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PoolHour": GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour.from_dict(obj["PoolHour"]) if obj.get("PoolHour") is not None else None
        })
        return _obj
