...
class GetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePayments(BaseModel):
    """
    GetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePayments
    """ # noqa: E501
    invoice_payment: List[GetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePaymentsInvoicePaymentInner] = Field(description="List of invoice payments", alias="invoicePayment")
    __properties: ClassVar[List[str]] = ["invoicePayment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in invoice_payment (list)
        _items = []
        if self.invoice_payment:
            for _item in self.invoice_payment:
                if _item:
                    _items.append(_item.to_dict())
            _dict['invoicePayment'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoicePayment": [GetInvoicesR1SuccessResponseResultInvoicesInvoiceInvoicePaymentsInvoicePaymentInner.from_dict(_item) for _item in obj["invoicePayment"]] if obj.get("invoicePayment") is not None else None
        })
        return _obj
