...
class RequestBodyMethod(BaseModel):
    """
    RequestBodyMethod
    """ # noqa: E501
    name: StrictStr
    version: Optional[StrictStr] = None
    params: Optional[Dict[str, Any]] = Field(default=None, description="the service request parameters if any. Replace dummy values from examples with actual values.")
    ...
    def version_validate_enum(cls, value):
        ...
        if value not in set(['r1', 'r2', 'r3']):
            raise ValueError("must be one of enum values ('r1', 'r2', 'r3')")
        return value
