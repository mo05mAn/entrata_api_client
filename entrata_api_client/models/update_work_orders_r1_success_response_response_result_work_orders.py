...
class UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders(BaseModel):
    """
    Work orders result containing the details of the work orders
    """ # noqa: E501
    work_order: Optional[List[UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner]] = Field(default=None, description="List of work order results", alias="workOrder")
    __properties: ClassVar[List[str]] = ["workOrder"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in work_order (list)
        _items = []
        if self.work_order:
            for _item in self.work_order:
                if _item:
                    _items.append(_item.to_dict())
            _dict['workOrder'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workOrder": [UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner.from_dict(_item) for _item in obj["workOrder"]] if obj.get("workOrder") is not None else None
        })
        return _obj
