...
class GetTransactionTagListsSuccessResponseResultTransactionRoutingTags(BaseModel):
    """
    GetTransactionTagListsSuccessResponseResultTransactionRoutingTags
    """ # noqa: E501
    transaction_routing_tag: List[GetTransactionTagListsSuccessResponseResultTransactionRoutingTagsTransactionRoutingTagInner] = Field(description="A list of transaction routing tags.", alias="transactionRoutingTag")
    __properties: ClassVar[List[str]] = ["transactionRoutingTag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in transaction_routing_tag (list)
        _items = []
        if self.transaction_routing_tag:
            for _item in self.transaction_routing_tag:
                if _item:
                    _items.append(_item.to_dict())
            _dict['transactionRoutingTag'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactionRoutingTag": [GetTransactionTagListsSuccessResponseResultTransactionRoutingTagsTransactionRoutingTagInner.from_dict(_item) for _item in obj["transactionRoutingTag"]] if obj.get("transactionRoutingTag") is not None else None
        })
        return _obj
