...
class GetPropertyAddOnsSuccessResponseResultAddOns(BaseModel):
    """
    Add-ons available for the property
    """ # noqa: E501
    addon: List[GetPropertyAddOnsSuccessResponseResultAddOnsAddonInner] = Field(description="List of add-ons")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in addon (list)
        _items = []
        if self.addon:
            for _item in self.addon:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addon": [GetPropertyAddOnsSuccessResponseResultAddOnsAddonInner.from_dict(_item) for _item in obj["addon"]] if obj.get("addon") is not None else None
        })
        return _obj
