...
class GetAmenityReservationsSuccessResponseResult(BaseModel):
    """
    The result containing amenities details
    """ # noqa: E501
    amenities: Optional[GetAmenityReservationsSuccessResponseResultAmenities] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amenities": GetAmenityReservationsSuccessResponseResultAmenities.from_dict(obj["amenities"]) if obj.get("amenities") is not None else None
        })
        return _obj
