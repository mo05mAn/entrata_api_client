...
class GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the unit of measure.")
    name: StrictStr = Field(description="Name of the unit of measure.")
    type: StrictStr = Field(description="Type of the unit of measure.")
