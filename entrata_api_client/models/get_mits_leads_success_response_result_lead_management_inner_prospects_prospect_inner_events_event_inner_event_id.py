...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID(BaseModel):
    """
    Event identification details.
    """ # noqa: E501
    identification: Optional[List[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventIDIdentificationInner]] = Field(default=None, description="A list of identification details for the event.", alias="Identification")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": [GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventIDIdentificationInner.from_dict(_item) for _item in obj["Identification"]] if obj.get("Identification") is not None else None
        })
        return _obj
