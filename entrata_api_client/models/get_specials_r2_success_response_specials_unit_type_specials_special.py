...
class GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial(BaseModel):
    """
    ...
    unit_types: GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes = Field(alias="unitTypes")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "startDate", "endDate", "couponCode", "cap", "remaining", "showOnWebsite", "isActive", "unitTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitTypes": GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes.from_dict(obj["unitTypes"]) if obj.get("unitTypes") is not None else None
        })
        return _obj
