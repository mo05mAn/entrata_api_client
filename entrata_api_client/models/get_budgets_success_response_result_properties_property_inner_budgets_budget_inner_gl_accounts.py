...
class GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccounts(BaseModel):
    """
    GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccounts
    """ # noqa: E501
    gl_account: List[GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInner] = Field(description="A list of GL accounts for the budget.", alias="glAccount")
    __properties: ClassVar[List[str]] = ["glAccount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_account (list)
        _items = []
        if self.gl_account:
            for _item in self.gl_account:
                if _item:
                    _items.append(_item.to_dict())
            _dict['glAccount'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glAccount": [GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInner.from_dict(_item) for _item in obj["glAccount"]] if obj.get("glAccount") is not None else None
        })
        return _obj
