...
class GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes(BaseModel):
    """
    GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerAttributes
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the lease.", alias="Id")
