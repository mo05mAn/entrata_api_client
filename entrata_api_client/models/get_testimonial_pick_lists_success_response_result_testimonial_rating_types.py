...
class GetTestimonialPickListsSuccessResponseResultTestimonialRatingTypes(BaseModel):
    """
    GetTestimonialPickListsSuccessResponseResultTestimonialRatingTypes
    """ # noqa: E501
    testimonial_rating_type: List[GetTestimonialPickListsSuccessResponseResultTestimonialRatingTypesTestimonialRatingTypeInner] = Field(alias="TestimonialRatingType")
    __properties: ClassVar[List[str]] = ["TestimonialRatingType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in testimonial_rating_type (list)
        _items = []
        if self.testimonial_rating_type:
            for _item in self.testimonial_rating_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['TestimonialRatingType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "TestimonialRatingType": [GetTestimonialPickListsSuccessResponseResultTestimonialRatingTypesTestimonialRatingTypeInner.from_dict(_item) for _item in obj["TestimonialRatingType"]] if obj.get("TestimonialRatingType") is not None else None
        })
        return _obj
