...
class GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInner(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInner
    """ # noqa: E501
    identification: List[GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner] = Field(alias="Identification")
    customer_type: StrictStr = Field(description="Type of the customer", alias="CustomerType")
    __properties: ClassVar[List[str]] = ["Identification", "CustomerType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": [GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner.from_dict(_item) for _item in obj["Identification"]] if obj.get("Identification") is not None else None,
