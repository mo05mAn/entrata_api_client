...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerOptionalItems(BaseModel):
    """
    The list of optional items for the lease.
    """ # noqa: E501
    optional_item: Optional[List[GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerOptionalItemsOptionalItemInner]] = Field(default=None, description="A list of optional items.", alias="optionalItem")
    __properties: ClassVar[List[str]] = ["optionalItem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in optional_item (list)
        _items = []
        if self.optional_item:
            for _item in self.optional_item:
                if _item:
                    _items.append(_item.to_dict())
            _dict['optionalItem'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "optionalItem": [GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerOptionalItemsOptionalItemInner.from_dict(_item) for _item in obj["optionalItem"]] if obj.get("optionalItem") is not None else None
        })
        return _obj
