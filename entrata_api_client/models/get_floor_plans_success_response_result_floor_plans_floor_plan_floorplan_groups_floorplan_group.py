...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFloorplanGroupsFloorplanGroup(BaseModel):
    """
    GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFloorplanGroupsFloorplanGroup
    """ # noqa: E501
    attributes: Optional[GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFloorplanGroupsFloorplanGroupAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFloorplanGroupsFloorplanGroupAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
