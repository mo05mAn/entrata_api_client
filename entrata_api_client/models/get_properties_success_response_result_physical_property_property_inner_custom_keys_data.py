...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysData(BaseModel):
    """
    Custom key-value data for the property
    """ # noqa: E501
    custom_key_data: Optional[List[GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysDataCustomKeyDataInner]] = Field(default=None, description="List of custom key-value pairs", alias="CustomKeyData")
    __properties: ClassVar[List[str]] = ["CustomKeyData"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in custom_key_data (list)
        _items = []
        if self.custom_key_data:
            for _item in self.custom_key_data:
                if _item:
                    _items.append(_item.to_dict())
            _dict['CustomKeyData'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CustomKeyData": [GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysDataCustomKeyDataInner.from_dict(_item) for _item in obj["CustomKeyData"]] if obj.get("CustomKeyData") is not None else None
        })
        return _obj
