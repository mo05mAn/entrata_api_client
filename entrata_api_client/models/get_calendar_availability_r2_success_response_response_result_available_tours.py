...
class GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours(BaseModel):
    """
    Available tours with their respective timeslots
    """ # noqa: E501
    available_tour: Optional[List[GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner]] = Field(default=None, description="List of available tours", alias="availableTour")
    __properties: ClassVar[List[str]] = ["availableTour"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in available_tour (list)
        _items = []
        if self.available_tour:
            for _item in self.available_tour:
                if _item:
                    _items.append(_item.to_dict())
            _dict['availableTour'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availableTour": [GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner.from_dict(_item) for _item in obj["availableTour"]] if obj.get("availableTour") is not None else None
        })
        return _obj
