...
class GetSpecialsR3SuccessResponseResponseResult(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResult
    """ # noqa: E501
    specials: GetSpecialsR3SuccessResponseResponseResultSpecials
    __properties: ClassVar[List[str]] = ["specials"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of specials
        if self.specials:
            _dict['specials'] = self.specials.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "specials": GetSpecialsR3SuccessResponseResponseResultSpecials.from_dict(obj["specials"]) if obj.get("specials") is not None else None
        })
        return _obj
