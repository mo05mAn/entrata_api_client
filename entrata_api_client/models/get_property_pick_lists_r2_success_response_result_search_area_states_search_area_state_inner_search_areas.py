...
class GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInnerSearchAreas(BaseModel):
    """
    Search areas within the state
    """ # noqa: E501
    search_area: List[GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInnerSearchAreasSearchAreaInner] = Field(alias="searchArea")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "searchArea": [GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInnerSearchAreasSearchAreaInner.from_dict(_item) for _item in obj["searchArea"]] if obj.get("searchArea") is not None else None
        })
        return _obj
