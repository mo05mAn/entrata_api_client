...
class GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInner(BaseModel):
    """
    ...
    budget_name: StrictStr = Field(description="The name of the budget.", alias="budgetName")
    budget_status_type_id: StrictStr = Field(description="The status type of the budget.", alias="budgetStatusTypeId")
    is_default: StrictStr = Field(description="Indicates if this is the default budget.", alias="isDefault")
    fiscal_start_date: date = Field(description="The fiscal start date for the budget.", alias="fiscalStartDate")
    fiscal_end_date: date = Field(description="The fiscal end date for the budget.", alias="fiscalEndDate")
    fiscal_year: StrictStr = Field(description="The fiscal year for the budget.", alias="fiscalYear")
    budget_total: StrictStr = Field(description="The total value of the budget.", alias="budgetTotal")
    gl_accounts: GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccounts = Field(alias="glAccounts")
    __properties: ClassVar[List[str]] = ["id", "budgetName", "budgetStatusTypeId", "isDefault", "fiscalStartDate", "fiscalEndDate", "fiscalYear", "budgetTotal", "glAccounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "budgetName": obj.get("budgetName"),
            "budgetStatusTypeId": obj.get("budgetStatusTypeId"),
            "isDefault": obj.get("isDefault"),
            "fiscalStartDate": obj.get("fiscalStartDate"),
            "fiscalEndDate": obj.get("fiscalEndDate"),
            "fiscalYear": obj.get("fiscalYear"),
            "budgetTotal": obj.get("budgetTotal"),
            "glAccounts": GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccounts.from_dict(obj["glAccounts"]) if obj.get("glAccounts") is not None else None
        })
        return _obj
