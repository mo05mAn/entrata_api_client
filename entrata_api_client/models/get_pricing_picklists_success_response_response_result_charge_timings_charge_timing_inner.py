...
class GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner(BaseModel):
    """
    GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner
    """ # noqa: E501
    attributes: GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
