...
class GetSpecialsR3Method(BaseModel):
    """
    GetSpecialsR3Method
    """ # noqa: E501
    name: StrictStr
    version: Optional[StrictStr] = None
    params: Optional[GetSpecialsR1MethodParams] = None
    ...
    def version_validate_enum(cls, value):
        ...
        if value not in set(['r3']):
            raise ValueError("must be one of enum values ('r3')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": GetSpecialsR1MethodParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
