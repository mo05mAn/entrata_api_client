...
class GetTransactionTagListsSuccessResponseResultTransactionCustomTags(BaseModel):
    """
    GetTransactionTagListsSuccessResponseResultTransactionCustomTags
    """ # noqa: E501
    transaction_custom_tag: List[GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner] = Field(description="A list of transaction custom tags.", alias="transactionCustomTag")
    __properties: ClassVar[List[str]] = ["transactionCustomTag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in transaction_custom_tag (list)
        _items = []
        if self.transaction_custom_tag:
            for _item in self.transaction_custom_tag:
                if _item:
                    _items.append(_item.to_dict())
            _dict['transactionCustomTag'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactionCustomTag": [GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner.from_dict(_item) for _item in obj["transactionCustomTag"]] if obj.get("transactionCustomTag") is not None else None
        })
        return _obj
