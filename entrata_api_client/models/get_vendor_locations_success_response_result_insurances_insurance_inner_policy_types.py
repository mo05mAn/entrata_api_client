...
class GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypes(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypes
    """ # noqa: E501
    policy_type: GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType = Field(alias="PolicyType")
    __properties: ClassVar[List[str]] = ["PolicyType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PolicyType": GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyType.from_dict(obj["PolicyType"]) if obj.get("PolicyType") is not None else None
        })
        return _obj
