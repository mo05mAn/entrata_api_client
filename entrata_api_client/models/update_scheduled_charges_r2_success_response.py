...
class UpdateScheduledChargesR2SuccessResponse(BaseModel):
    """
    UpdateScheduledChargesR2SuccessResponse
    """ # noqa: E501
    response: UpdateScheduledChargesR2SuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": UpdateScheduledChargesR2SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
