...
class GetPropertyPickListsR2SuccessResponseResultSearchAreaStates(BaseModel):
    """
    Search area states and associated details
    """ # noqa: E501
    search_area_state: List[GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner] = Field(alias="searchAreaState")
    __properties: ClassVar[List[str]] = ["searchAreaState"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in search_area_state (list)
        _items = []
        if self.search_area_state:
            for _item in self.search_area_state:
                if _item:
                    _items.append(_item.to_dict())
            _dict['searchAreaState'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "searchAreaState": [GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner.from_dict(_item) for _item in obj["searchAreaState"]] if obj.get("searchAreaState") is not None else None
        })
        return _obj
