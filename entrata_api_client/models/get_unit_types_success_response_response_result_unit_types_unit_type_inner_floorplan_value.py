...
class GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValue(BaseModel):
    """
    Floorplan details for this unit type
    """ # noqa: E501
    attributes: GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValueAttributes = Field(alias="@attributes")
    value: StrictStr = Field(description="Floorplan name or code", alias="@value")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValueAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "@value": obj.get("@value")
        })
        return _obj
