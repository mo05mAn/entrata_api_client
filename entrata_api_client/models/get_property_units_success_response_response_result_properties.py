...
class GetPropertyUnitsSuccessResponseResponseResultProperties(BaseModel):
    """
    GetPropertyUnitsSuccessResponseResponseResultProperties
    """ # noqa: E501
    var_property: GetPropertyUnitsSuccessResponseResponseResultPropertiesProperty = Field(alias="property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property": GetPropertyUnitsSuccessResponseResponseResultPropertiesProperty.from_dict(obj["property"]) if obj.get("property") is not None else None
        })
        return _obj
