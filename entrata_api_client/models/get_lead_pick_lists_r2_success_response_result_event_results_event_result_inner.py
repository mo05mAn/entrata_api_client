...
class GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner(BaseModel):
    """
    GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner
    """ # noqa: E501
    attributes: Optional[GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
