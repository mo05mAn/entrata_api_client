...
class GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner(BaseModel):
    """
    GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner
    """ # noqa: E501
    attributes: Optional[GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes] = Field(default=None, alias="@attributes")
    announcement_type_id: StrictInt = Field(description="Identifier for the type of announcement", alias="AnnouncementTypeId")
    frequency_id: StrictInt = Field(description="Identifier for the frequency of the announcement", alias="FrequencyId")
    title: StrictStr = Field(description="Title of the announcement", alias="Title")
    description: StrictStr = Field(description="Description of the announcement", alias="Description")
    start_date: date = Field(description="The start date of the announcement", alias="StartDate")
    end_date: date = Field(description="The end date of the announcement", alias="EndDate")
    __properties: ClassVar[List[str]] = ["@attributes", "AnnouncementTypeId", "FrequencyId", "Title", "Description", "StartDate", "EndDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "AnnouncementTypeId": obj.get("AnnouncementTypeId"),
