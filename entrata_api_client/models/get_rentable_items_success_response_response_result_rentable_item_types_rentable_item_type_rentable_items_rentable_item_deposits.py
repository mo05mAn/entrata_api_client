...
class GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItemDeposits(BaseModel):
    """
    Deposit charges for the specific item
    """ # noqa: E501
    deposit: List[GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeDepositsDeposit] = Field(alias="Deposit")
    __properties: ClassVar[List[str]] = ["Deposit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Deposit": [GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeDepositsDeposit.from_dict(_item) for _item in obj["Deposit"]] if obj.get("Deposit") is not None else None
        })
        return _obj
