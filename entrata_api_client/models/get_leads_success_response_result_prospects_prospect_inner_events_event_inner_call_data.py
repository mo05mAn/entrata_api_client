...
class GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData(BaseModel):
    """
    GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInnerCallData
    """ # noqa: E501
    call_id: Optional[StrictStr] = Field(default=None, description="The call ID.", alias="callId")
    call_from: Optional[StrictStr] = Field(default=None, description="The phone number the call was from.", alias="callFrom")
    ring_through: Optional[StrictStr] = Field(default=None, description="The phone number that rang through.", alias="ringThrough")
    duration: Optional[StrictStr] = Field(default=None, description="The call duration.")
    call_status: Optional[StrictStr] = Field(default=None, description="The status of the call.", alias="callStatus")
    __properties: ClassVar[List[str]] = ["callId", "callFrom", "ringThrough", "duration", "callStatus"]
