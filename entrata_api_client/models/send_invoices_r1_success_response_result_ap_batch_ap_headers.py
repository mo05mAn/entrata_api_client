...
class SendInvoicesR1SuccessResponseResultApBatchApHeaders(BaseModel):
    """
    SendInvoicesR1SuccessResponseResultApBatchApHeaders
    """ # noqa: E501
    ap_header: Optional[List[SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInner]] = Field(default=None, alias="ApHeader")
    __properties: ClassVar[List[str]] = ["ApHeader"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_header (list)
        _items = []
        if self.ap_header:
            for _item in self.ap_header:
                if _item:
                    _items.append(_item.to_dict())
            _dict['ApHeader'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ApHeader": [SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInner.from_dict(_item) for _item in obj["ApHeader"]] if obj.get("ApHeader") is not None else None
        })
        return _obj
