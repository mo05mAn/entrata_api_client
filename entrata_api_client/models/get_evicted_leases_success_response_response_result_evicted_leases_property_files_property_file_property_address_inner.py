...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFilePropertyAddressInner(BaseModel):
    """
    GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFilePropertyAddressInner
    """ # noqa: E501
    address_type: StrictStr = Field(description="Type of address (e.g., Primary).", alias="addressType")
    address: StrictStr = Field(description="Street address.")
    ...
    __properties: ClassVar[List[str]] = ["addressType", "address", "city", "country", "state", "postalCode"]
