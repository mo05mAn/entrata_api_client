...
class GetTransactionTagListsSuccessResponseResult(BaseModel):
    """
    GetTransactionTagListsSuccessResponseResult
    """ # noqa: E501
    transaction_custom_tags: GetTransactionTagListsSuccessResponseResultTransactionCustomTags = Field(alias="transactionCustomTags")
    transaction_routing_tags: GetTransactionTagListsSuccessResponseResultTransactionRoutingTags = Field(alias="transactionRoutingTags")
    __properties: ClassVar[List[str]] = ["transactionCustomTags", "transactionRoutingTags"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of transaction_custom_tags
        if self.transaction_custom_tags:
            _dict['transactionCustomTags'] = self.transaction_custom_tags.to_dict()
        # override the default output from pydantic by calling `to_dict()` of transaction_routing_tags
        if self.transaction_routing_tags:
            _dict['transactionRoutingTags'] = self.transaction_routing_tags.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactionCustomTags": GetTransactionTagListsSuccessResponseResultTransactionCustomTags.from_dict(obj["transactionCustomTags"]) if obj.get("transactionCustomTags") is not None else None,
            "transactionRoutingTags": GetTransactionTagListsSuccessResponseResultTransactionRoutingTags.from_dict(obj["transactionRoutingTags"]) if obj.get("transactionRoutingTags") is not None else None
        })
        return _obj
