...
class GetLeadsSuccessResponseResultProspects(BaseModel):
    """
    GetLeadsSuccessResponseResultProspects
    """ # noqa: E501
    prospect: List[GetLeadsSuccessResponseResultProspectsProspectInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prospect": [GetLeadsSuccessResponseResultProspectsProspectInner.from_dict(_item) for _item in obj["prospect"]] if obj.get("prospect") is not None else None
        })
        return _obj
