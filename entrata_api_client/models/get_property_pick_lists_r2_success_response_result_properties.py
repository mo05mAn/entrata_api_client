...
class GetPropertyPickListsR2SuccessResponseResultProperties(BaseModel):
    """
    Details of properties
    """ # noqa: E501
    var_property: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInner] = Field(description="List of properties", alias="property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInner.from_dict(_item) for _item in obj["property"]] if obj.get("property") is not None else None
        })
        return _obj
