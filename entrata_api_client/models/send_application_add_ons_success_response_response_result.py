...
class SendApplicationAddOnsSuccessResponseResponseResult(BaseModel):
    """
    SendApplicationAddOnsSuccessResponseResponseResult
    """ # noqa: E501
    add_ons: SendApplicationAddOnsSuccessResponseResponseResultAddOns = Field(alias="addOns")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addOns": SendApplicationAddOnsSuccessResponseResponseResultAddOns.from_dict(obj["addOns"]) if obj.get("addOns") is not None else None
        })
        return _obj
