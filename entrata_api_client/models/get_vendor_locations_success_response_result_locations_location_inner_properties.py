...
class GetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties
    """ # noqa: E501
    var_property: GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesProperty = Field(alias="Property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesProperty.from_dict(obj["Property"]) if obj.get("Property") is not None else None
        })
        return _obj
