...
class GetAccessibleServicesSuccessResponse(BaseModel):
    """
    GetAccessibleServicesSuccessResponse
    """ # noqa: E501
    request_id: StrictStr = Field(description="The ID of the request", alias="requestId")
    code: StrictInt = Field(description="The status code of the response")
    result: GetAccessibleServicesSuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetAccessibleServicesSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
