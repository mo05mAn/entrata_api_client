...
class GetJobCategoriesSuccessResponseResultJobCategories(BaseModel):
    """
    GetJobCategoriesSuccessResponseResultJobCategories
    """ # noqa: E501
    job_category: List[GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner] = Field(description="A list of job categories.", alias="jobCategory")
    __properties: ClassVar[List[str]] = ["jobCategory"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in job_category (list)
        _items = []
        if self.job_category:
            for _item in self.job_category:
                if _item:
                    _items.append(_item.to_dict())
            _dict['jobCategory'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobCategory": [GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner.from_dict(_item) for _item in obj["jobCategory"]] if obj.get("jobCategory") is not None else None
        })
        return _obj
