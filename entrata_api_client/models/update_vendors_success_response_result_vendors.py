...
class UpdateVendorsSuccessResponseResultVendors(BaseModel):
    """
    UpdateVendorsSuccessResponseResultVendors
    """ # noqa: E501
    vendor: Optional[UpdateVendorsSuccessResponseResultVendorsVendor] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vendor": UpdateVendorsSuccessResponseResultVendorsVendor.from_dict(obj["vendor"]) if obj.get("vendor") is not None else None
        })
        return _obj
