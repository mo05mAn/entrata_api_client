...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsTenantInner(BaseModel):
    """
    ...
    """ # noqa: E501
    customer_id: StrictStr = Field(description="Unique identifier for the tenant.", alias="customerId")
    first_name: StrictStr = Field(description="First name of the tenant.", alias="firstName")
    last_name: StrictStr = Field(description="Last name of the tenant.", alias="lastName")
    customer_type: StrictStr = Field(description="Type of customer (e.g., Primary).", alias="customerType")
    phone: List[GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsTenantInnerPhoneInner]
    date_of_birth: StrictStr = Field(description="Date of birth of the tenant.", alias="dateOfBirth")
    ssn: StrictStr = Field(description="Social Security Number.")
    __properties: ClassVar[List[str]] = ["customerId", "firstName", "lastName", "customerType", "phone", "dateOfBirth", "ssn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phone": [GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsTenantInnerPhoneInner.from_dict(_item) for _item in obj["phone"]] if obj.get("phone") is not None else None,
