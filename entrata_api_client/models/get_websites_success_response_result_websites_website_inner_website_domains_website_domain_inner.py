...
class GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomainsWebsiteDomainInner(BaseModel):
    """
    GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomainsWebsiteDomainInner
    """ # noqa: E501
    domain: StrictStr = Field(description="Domain associated with the website")
    is_primary: StrictInt = Field(description="Indicates whether the domain is primary", alias="isPrimary")
    is_secure: StrictBool = Field(description="Indicates whether the domain is secure", alias="isSecure")
    __properties: ClassVar[List[str]] = ["domain", "isPrimary", "isSecure"]
