...
class UpdateLeaseSuccessResponseResult(BaseModel):
    """
    UpdateLeaseSuccessResponseResult
    """ # noqa: E501
    status: StrictStr = Field(description="Status of the lease update")
    lease_id: StrictStr = Field(description="Unique identifier for the lease", alias="leaseId")
    message: StrictStr = Field(description="Message detailing the result of the lease update")
    __properties: ClassVar[List[str]] = ["status", "leaseId", "message"]
