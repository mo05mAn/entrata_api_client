...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSetChargeIdentification(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSetChargeIdentification
    """ # noqa: E501
    id_type: StrictStr = Field(description="Type of the charge ID", alias="IDType")
    id_rank: StrictStr = Field(description="Rank of the charge ID", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Scope type of the charge ID", alias="IDScopeType")
    id_value: StrictStr = Field(description="Value of the charge ID", alias="IDValue")
