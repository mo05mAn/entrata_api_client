...
class GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts
    """ # noqa: E501
    contact: Optional[List[GetVendorLocationsSuccessResponseResultLocationsLocationInnerContactsContactInner]] = Field(default=None, alias="Contact")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Contact": [GetVendorLocationsSuccessResponseResultLocationsLocationInnerContactsContactInner.from_dict(_item) for _item in obj["Contact"]] if obj.get("Contact") is not None else None
        })
        return _obj
