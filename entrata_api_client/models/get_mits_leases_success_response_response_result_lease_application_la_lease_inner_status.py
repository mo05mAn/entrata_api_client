...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus
    """ # noqa: E501
    approval_status: StrictStr = Field(description="Approval status of the lease", alias="ApprovalStatus")
