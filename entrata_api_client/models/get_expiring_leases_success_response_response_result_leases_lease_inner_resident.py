...
class GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident(BaseModel):
    """
    GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResident
    """ # noqa: E501
    attributes: GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes = Field(alias="@attributes")
    name: StrictStr = Field(description="Name of the resident.", alias="Name")
    phone_number: StrictStr = Field(description="Phone number of the resident.", alias="PhoneNumber")
    email_address: Optional[StrictStr] = Field(default=None, description="Email address of the resident.", alias="EmailAddress")
    address: GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress = Field(alias="Address")
    __properties: ClassVar[List[str]] = ["@attributes", "Name", "PhoneNumber", "EmailAddress", "Address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "Name": obj.get("Name"),
            "PhoneNumber": obj.get("PhoneNumber"),
            "EmailAddress": obj.get("EmailAddress"),
            "Address": GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress.from_dict(obj["Address"]) if obj.get("Address") is not None else None
        })
        return _obj
