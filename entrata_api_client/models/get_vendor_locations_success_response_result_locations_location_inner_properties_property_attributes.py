...
class GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultLocationsLocationInnerPropertiesPropertyAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the property.", alias="Id")
    name: StrictStr = Field(description="Name of the property.", alias="Name")
