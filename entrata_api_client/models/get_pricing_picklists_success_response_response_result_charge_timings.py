...
class GetPricingPicklistsSuccessResponseResponseResultChargeTimings(BaseModel):
    """
    Charge timings details
    """ # noqa: E501
    charge_timing: Optional[List[GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner]] = Field(default=None, description="List of charge timings", alias="chargeTiming")
    __properties: ClassVar[List[str]] = ["chargeTiming"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in charge_timing (list)
        _items = []
        if self.charge_timing:
            for _item in self.charge_timing:
                if _item:
                    _items.append(_item.to_dict())
            _dict['chargeTiming'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeTiming": [GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInner.from_dict(_item) for _item in obj["chargeTiming"]] if obj.get("chargeTiming") is not None else None
        })
        return _obj
