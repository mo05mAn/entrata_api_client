...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloors(BaseModel):
    """
    Floors in the property
    """ # noqa: E501
    property_floor: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloorsPropertyFloorInner] = Field(alias="propertyFloor")
    __properties: ClassVar[List[str]] = ["propertyFloor"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in property_floor (list)
        _items = []
        if self.property_floor:
            for _item in self.property_floor:
                if _item:
                    _items.append(_item.to_dict())
            _dict['propertyFloor'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "propertyFloor": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloorsPropertyFloorInner.from_dict(_item) for _item in obj["propertyFloor"]] if obj.get("propertyFloor") is not None else None
        })
        return _obj
