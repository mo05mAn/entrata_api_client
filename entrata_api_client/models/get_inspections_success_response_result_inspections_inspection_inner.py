...
class GetInspectionsSuccessResponseResultInspectionsInspectionInner(BaseModel):
    """
    GetInspectionsSuccessResponseResultInspectionsInspectionInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the inspection")
    property_id: StrictStr = Field(description="ID of the property", alias="propertyId")
    inspection_type_id: StrictStr = Field(description="ID of the inspection type", alias="inspectionTypeId")
    inspection_status_type_id: StrictStr = Field(description="ID of the inspection status type", alias="inspectionStatusTypeId")
    inspection_status_type: StrictStr = Field(description="Status of the inspection", alias="inspectionStatusType")
    inspection_form_id: StrictStr = Field(description="ID of the inspection form", alias="inspectionFormId")
    scheduled_date: date = Field(description="Scheduled date for the inspection", alias="scheduledDate")
    due_date: date = Field(description="Due date for the inspection", alias="dueDate")
    lease_id: StrictStr = Field(description="Lease ID related to the inspection", alias="leaseId")
    unit_space_id: StrictStr = Field(description="Unit space ID", alias="unitSpaceId")
    note: StrictStr = Field(description="Additional notes for the inspection")
    locations: GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations
    __properties: ClassVar[List[str]] = ["id", "propertyId", "inspectionTypeId", "inspectionStatusTypeId", "inspectionStatusType", "inspectionFormId", "scheduledDate", "dueDate", "leaseId", "unitSpaceId", "note", "locations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inspectionTypeId": obj.get("inspectionTypeId"),
            "inspectionStatusTypeId": obj.get("inspectionStatusTypeId"),
            "inspectionStatusType": obj.get("inspectionStatusType"),
            "inspectionFormId": obj.get("inspectionFormId"),
            "scheduledDate": obj.get("scheduledDate"),
            "dueDate": obj.get("dueDate"),
            "leaseId": obj.get("leaseId"),
            "unitSpaceId": obj.get("unitSpaceId"),
            "note": obj.get("note"),
            "locations": GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations.from_dict(obj["locations"]) if obj.get("locations") is not None else None
        })
        return _obj
