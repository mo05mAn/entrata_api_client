...
class SendApplicationSuccessResponseResponseResult(BaseModel):
    """
    SendApplicationSuccessResponseResponseResult
    """ # noqa: E501
    status: StrictStr = Field(description="The status of the response.")
    message: StrictStr = Field(description="A message indicating the application was inserted successfully.")
    applicant_id: StrictStr = Field(description="The unique identifier for the applicant.", alias="applicantId")
    applicant_ids: Optional[StrictStr] = Field(default=None, description="A comma-separated list of applicant IDs.", alias="applicantIds")
    __properties: ClassVar[List[str]] = ["status", "message", "applicantId", "applicantIds"]
