...
class GetWorkOrderPickListsSuccessResponse(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponse
    """ # noqa: E501
    request_id: StrictStr = Field(description="Identifier of the request", alias="requestId")
    code: StrictStr = Field(description="Status code of the response")
    result: GetWorkOrderPickListsSuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetWorkOrderPickListsSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
