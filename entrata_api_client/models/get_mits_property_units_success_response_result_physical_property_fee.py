...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyFee(BaseModel):
    """
    Fees related to the property
    """ # noqa: E501
    application_fee: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyFeeApplicationFee] = Field(default=None, alias="ApplicationFee")
    __properties: ClassVar[List[str]] = ["ApplicationFee"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of application_fee
        if self.application_fee:
            _dict['ApplicationFee'] = self.application_fee.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ApplicationFee": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyFeeApplicationFee.from_dict(obj["ApplicationFee"]) if obj.get("ApplicationFee") is not None else None
        })
        return _obj
