...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner(BaseModel):
    """
    GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInner
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Value of the concession", alias="Value")
    description_header: Optional[StrictStr] = Field(default=None, description="Header for the concession description", alias="DescriptionHeader")
    description_body: Optional[StrictStr] = Field(default=None, description="Body of the concession description", alias="DescriptionBody")
    description_footer: Optional[StrictStr] = Field(default=None, description="Footer of the concession description", alias="DescriptionFooter")
    attributes: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["Value", "DescriptionHeader", "DescriptionBody", "DescriptionFooter", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
