...
class GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledCharges(BaseModel):
    """
    GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledCharges
    """ # noqa: E501
    active_scheduled_charge: GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge = Field(alias="activeScheduledCharge")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of active_scheduled_charge
        if self.active_scheduled_charge:
            _dict['activeScheduledCharge'] = self.active_scheduled_charge.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activeScheduledCharge": GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge.from_dict(obj["activeScheduledCharge"]) if obj.get("activeScheduledCharge") is not None else None
        })
        return _obj
