...
class GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the floorplan.")
    name: StrictStr = Field(description="The name of the floorplan.")
    rates: List[GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplanRatesInner] = Field(description="List of rates associated with the floorplan.")
    lease_terms: List[GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner] = Field(description="List of lease terms for the floorplan.", alias="leaseTerms")
    __properties: ClassVar[List[str]] = ["id", "name", "rates", "leaseTerms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "rates": [GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplanRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None,
