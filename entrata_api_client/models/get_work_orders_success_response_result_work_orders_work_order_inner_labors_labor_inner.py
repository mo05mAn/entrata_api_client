...
class GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsLaborInner(BaseModel):
    """
    GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsLaborInner
    """ # noqa: E501
    employee_name: StrictStr = Field(description="Name of the employee performing the labor", alias="employeeName")
    description: StrictStr = Field(description="Description of the labor")
    labor_type: StrictStr = Field(description="Type of labor", alias="laborType")
    labor_type_id: StrictStr = Field(description="ID of the labor type", alias="laborTypeId")
    start_date_time: StrictStr = Field(description="Start date and time of labor", alias="startDateTime")
    end_date_time: StrictStr = Field(description="End date and time of labor", alias="endDateTime")
    total_minutes: StrictStr = Field(description="Total minutes worked", alias="totalMinutes")
    per_hour_rate: StrictStr = Field(description="Hourly rate of the labor", alias="perHourRate")
    total_charge: StrictStr = Field(description="Total charge for the labor", alias="totalCharge")
    __properties: ClassVar[List[str]] = ["employeeName", "description", "laborType", "laborTypeId", "startDateTime", "endDateTime", "totalMinutes", "perHourRate", "totalCharge"]
