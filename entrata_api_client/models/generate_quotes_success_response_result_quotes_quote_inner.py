...
class GenerateQuotesSuccessResponseResultQuotesQuoteInner(BaseModel):
    """
    GenerateQuotesSuccessResponseResultQuotesQuoteInner
    """ # noqa: E501
    node: Optional[StrictStr] = Field(default=None, description="The identifier for the quote node.")
    status: Optional[StrictStr] = Field(default=None, description="The status of the quote generation.")
    quote_id: Optional[StrictStr] = Field(default=None, description="The unique ID for the quote.", alias="quoteId")
    message: Optional[StrictStr] = Field(default=None, description="Message providing additional details about the quote.")
    __properties: ClassVar[List[str]] = ["node", "status", "quoteId", "message"]
