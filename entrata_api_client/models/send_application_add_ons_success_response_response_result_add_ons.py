...
class SendApplicationAddOnsSuccessResponseResponseResultAddOns(BaseModel):
    """
    SendApplicationAddOnsSuccessResponseResponseResultAddOns
    """ # noqa: E501
    add_on: List[SendApplicationAddOnsSuccessResponseResponseResultAddOnsAddOnInner] = Field(alias="addOn")
    __properties: ClassVar[List[str]] = ["addOn"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in add_on (list)
        _items = []
        if self.add_on:
            for _item in self.add_on:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addOn": [SendApplicationAddOnsSuccessResponseResponseResultAddOnsAddOnInner.from_dict(_item) for _item in obj["addOn"]] if obj.get("addOn") is not None else None
        })
        return _obj
