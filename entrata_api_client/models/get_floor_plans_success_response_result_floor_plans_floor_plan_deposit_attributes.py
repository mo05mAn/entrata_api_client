...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes(BaseModel):
    """
    Attributes related to the deposit
    """ # noqa: E501
    deposit_type: Optional[StrictStr] = Field(default=None, description="Type of deposit", alias="DepositType")
    __properties: ClassVar[List[str]] = ["DepositType"]
