...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitIdentificationAttributes(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitIdentificationAttributes
    """ # noqa: E501
    id_type: StrictStr = Field(description="Type of property unit identifier", alias="IDType")
    id_rank: StrictStr = Field(description="Rank of property unit identifier", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Scope type of property unit identifier", alias="IDScopeType")
