...
class GetInvoicesR1SuccessResponseResultInvoices(BaseModel):
    """
    GetInvoicesR1SuccessResponseResultInvoices
    """ # noqa: E501
    invoice: GetInvoicesR1SuccessResponseResultInvoicesInvoice
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoice": GetInvoicesR1SuccessResponseResultInvoicesInvoice.from_dict(obj["invoice"]) if obj.get("invoice") is not None else None
        })
        return _obj
