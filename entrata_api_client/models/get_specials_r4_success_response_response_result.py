...
class GetSpecialsR4SuccessResponseResponseResult(BaseModel):
    """
    GetSpecialsR4SuccessResponseResponseResult
    """ # noqa: E501
    special_groups: Optional[List[GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner]] = Field(default=None, alias="specialGroups")
    __properties: ClassVar[List[str]] = ["specialGroups"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in special_groups (list)
        _items = []
        if self.special_groups:
            for _item in self.special_groups:
                if _item:
                    _items.append(_item.to_dict())
            _dict['specialGroups'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "specialGroups": [GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInner.from_dict(_item) for _item in obj["specialGroups"]] if obj.get("specialGroups") is not None else None
        })
        return _obj
