...
class GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes
    """ # noqa: E501
    unit_type: List[GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypesUnitTypeInner] = Field(description="List of unit types included in the special.", alias="unitType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitType": [GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypesUnitTypeInner.from_dict(_item) for _item in obj["unitType"]] if obj.get("unitType") is not None else None
        })
        return _obj
