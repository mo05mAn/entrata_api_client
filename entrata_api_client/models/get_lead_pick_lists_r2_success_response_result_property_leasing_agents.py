...
class GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents(BaseModel):
    """
    Leasing agents associated with the property.
    """ # noqa: E501
    leasing_agent: Optional[List[GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner]] = Field(default=None, description="A list of leasing agents.", alias="leasingAgent")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leasingAgent": [GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner.from_dict(_item) for _item in obj["leasingAgent"]] if obj.get("leasingAgent") is not None else None
        })
        return _obj
