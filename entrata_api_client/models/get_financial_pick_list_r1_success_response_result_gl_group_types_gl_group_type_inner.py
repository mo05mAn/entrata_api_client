...
class GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL group type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL group type.", alias="Name")
