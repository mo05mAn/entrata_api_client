...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTerms(BaseModel):
    """
    Lease terms available for the property
    """ # noqa: E501
    lease_term: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInner] = Field(alias="leaseTerm")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leaseTerm": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInner.from_dict(_item) for _item in obj["leaseTerm"]] if obj.get("leaseTerm") is not None else None
        })
        return _obj
