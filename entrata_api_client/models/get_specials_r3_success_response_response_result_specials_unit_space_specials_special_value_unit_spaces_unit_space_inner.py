...
class GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValueUnitSpacesUnitSpaceInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "propertyUnitId", "name"]
