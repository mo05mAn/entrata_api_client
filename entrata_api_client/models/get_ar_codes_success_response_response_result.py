...
class GetArCodesSuccessResponseResponseResult(BaseModel):
    """
    GetArCodesSuccessResponseResponseResult
    """ # noqa: E501
    arcodes: GetArCodesSuccessResponseResponseResultArcodes
    __properties: ClassVar[List[str]] = ["arcodes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of arcodes
        if self.arcodes:
            _dict['arcodes'] = self.arcodes.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arcodes": GetArCodesSuccessResponseResponseResultArcodes.from_dict(obj["arcodes"]) if obj.get("arcodes") is not None else None
        })
        return _obj
