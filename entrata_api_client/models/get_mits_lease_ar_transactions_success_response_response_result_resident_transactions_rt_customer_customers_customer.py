...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer
    """ # noqa: E501
    identification: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentification = Field(alias="Identification")
    name: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName = Field(alias="Name")
    __properties: ClassVar[List[str]] = ["Identification", "Name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "Name": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName.from_dict(obj["Name"]) if obj.get("Name") is not None else None
        })
        return _obj
