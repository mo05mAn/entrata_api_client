...
class SendVendorsSuccessResponseResultVendorsVendorInner(BaseModel):
    """
    SendVendorsSuccessResponseResultVendorsVendorInner
    """ # noqa: E501
    attributes: Optional[SendVendorsSuccessResponseResultVendorsVendorInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": SendVendorsSuccessResponseResultVendorsVendorInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
