...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInner(BaseModel):
    """
    GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInner
    """ # noqa: E501
    identification: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentification] = Field(default=None, alias="Identification")
    name: Optional[StrictStr] = Field(default=None, description="Name of the building", alias="Name")
    description: Optional[StrictStr] = Field(default=None, description="Description of the building", alias="Description")
    unit_count: Optional[StrictStr] = Field(default=None, description="Number of units in the building", alias="UnitCount")
    square_feet: Optional[StrictStr] = Field(default=None, description="Square footage of the building", alias="SquareFeet")
    file: Optional[List[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner]] = Field(default=None, description="Files related to the building", alias="File")
    __properties: ClassVar[List[str]] = ["Identification", "Name", "Description", "UnitCount", "SquareFeet", "File"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "Name": obj.get("Name"),
            "Description": obj.get("Description"),
            "UnitCount": obj.get("UnitCount"),
            "SquareFeet": obj.get("SquareFeet"),
            "File": [GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner.from_dict(_item) for _item in obj["File"]] if obj.get("File") is not None else None
        })
        return _obj
