...
class UpdateApplicationSuccessResponseResponseResult(BaseModel):
    """
    UpdateApplicationSuccessResponseResponseResult
    """ # noqa: E501
    application: UpdateApplicationSuccessResponseResponseResultApplication
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "application": UpdateApplicationSuccessResponseResponseResultApplication.from_dict(obj["application"]) if obj.get("application") is not None else None
        })
        return _obj
