...
class SendLeasesSuccessResponseResultLeasesLeaseInner(BaseModel):
    """
    SendLeasesSuccessResponseResultLeasesLeaseInner
    """ # noqa: E501
    node: StrictStr = Field(description="Node identifier for the lease")
    lease_id: StrictStr = Field(description="Unique identifier for the lease", alias="leaseId")
    status: StrictStr = Field(description="Status of the lease insertion")
    message: StrictStr = Field(description="Message detailing the result of the insertion")
