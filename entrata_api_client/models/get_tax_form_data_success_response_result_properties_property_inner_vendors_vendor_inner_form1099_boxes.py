...
class GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099Boxes(BaseModel):
    """
    GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099Boxes
    """ # noqa: E501
    form1099_box: Optional[GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box] = Field(default=None, alias="form1099Box")
    __properties: ClassVar[List[str]] = ["form1099Box"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of form1099_box
        if self.form1099_box:
            _dict['form1099Box'] = self.form1099_box.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "form1099Box": GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box.from_dict(obj["form1099Box"]) if obj.get("form1099Box") is not None else None
        })
        return _obj
