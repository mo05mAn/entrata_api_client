...
class GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes(BaseModel):
    """
    GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the property.", alias="Id")
    name: StrictStr = Field(description="The name of the property.", alias="Name")
