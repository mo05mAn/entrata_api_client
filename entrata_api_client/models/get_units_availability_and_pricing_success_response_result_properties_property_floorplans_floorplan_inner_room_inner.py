...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInnerRoomInner(BaseModel):
    """
    GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInnerRoomInner
    """ # noqa: E501
    description: StrictStr = Field(description="Description of the room", alias="Description")
    count: StrictInt = Field(description="Number of rooms of this type", alias="Count")
    room_type: StrictStr = Field(description="Type of the room (e.g., Bedroom, Bathroom)", alias="RoomType")
    __properties: ClassVar[List[str]] = ["Description", "Count", "RoomType"]
