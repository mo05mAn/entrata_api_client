...
class GetPurchaseOrdersSuccessResponseResultPurchaseOrders(BaseModel):
    """
    GetPurchaseOrdersSuccessResponseResultPurchaseOrders
    """ # noqa: E501
    purchase_order: Optional[List[GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInner]] = Field(default=None, alias="purchaseOrder")
    __properties: ClassVar[List[str]] = ["purchaseOrder"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in purchase_order (list)
        _items = []
        if self.purchase_order:
            for _item in self.purchase_order:
                if _item:
                    _items.append(_item.to_dict())
            _dict['purchaseOrder'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "purchaseOrder": [GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInner.from_dict(_item) for _item in obj["purchaseOrder"]] if obj.get("purchaseOrder") is not None else None
        })
        return _obj
