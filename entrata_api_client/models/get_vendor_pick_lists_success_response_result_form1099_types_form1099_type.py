...
class GetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type
    """ # noqa: E501
    attributes: GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
