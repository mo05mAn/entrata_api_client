...
class GetVendorPickListsSuccessResponseResultBankAccountTypes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultBankAccountTypes
    """ # noqa: E501
    bank_account_type: Optional[List[GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInner]] = Field(default=None, alias="bankAccountType")
    __properties: ClassVar[List[str]] = ["bankAccountType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in bank_account_type (list)
        _items = []
        if self.bank_account_type:
            for _item in self.bank_account_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['bankAccountType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bankAccountType": [GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInner.from_dict(_item) for _item in obj["bankAccountType"]] if obj.get("bankAccountType") is not None else None
        })
        return _obj
