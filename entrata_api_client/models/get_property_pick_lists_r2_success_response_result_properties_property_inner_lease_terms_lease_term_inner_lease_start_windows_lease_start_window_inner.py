...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInnerLeaseStartWindowsLeaseStartWindowInner(BaseModel):
    """
    ...
    """ # noqa: E501
    lease_start_window_id: StrictInt = Field(description="Lease start window ID", alias="leaseStartWindowId")
    window_start_date: StrictStr = Field(description="Window start date", alias="windowStartDate")
    window_end_date: StrictStr = Field(description="Window end date", alias="windowEndDate")
    academic_year_id: StrictInt = Field(description="Academic year ID", alias="academicYearId")
    __properties: ClassVar[List[str]] = ["leaseStartWindowId", "windowStartDate", "windowEndDate", "academicYearId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "academicYearId": obj.get("academicYearId")
        })
        return _obj
