...
class GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranches(BaseModel):
    """
    GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranches
    """ # noqa: E501
    branch: List[GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranchesBranchInner] = Field(description="A list of branches associated with the GL tree.", alias="Branch")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Branch": [GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranchesBranchInner.from_dict(_item) for _item in obj["Branch"]] if obj.get("Branch") is not None else None
        })
        return _obj
