...
class GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner(BaseModel):
    """
    GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner
    """ # noqa: E501
    gl_total: GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal = Field(alias="glTotal")
    gl_details: Optional[GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetails] = Field(default=None, alias="glDetails")
    attributes: GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["glTotal", "glDetails", "@attributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of gl_total
        if self.gl_total:
            _dict['glTotal'] = self.gl_total.to_dict()
        # override the default output from pydantic by calling `to_dict()` of gl_details
        if self.gl_details:
            _dict['glDetails'] = self.gl_details.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glTotal": GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlTotal.from_dict(obj["glTotal"]) if obj.get("glTotal") is not None else None,
            "glDetails": GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetails.from_dict(obj["glDetails"]) if obj.get("glDetails") is not None else None,
            "@attributes": GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
