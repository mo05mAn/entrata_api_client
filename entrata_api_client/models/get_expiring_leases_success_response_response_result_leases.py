...
class GetExpiringLeasesSuccessResponseResponseResultLeases(BaseModel):
    """
    GetExpiringLeasesSuccessResponseResponseResultLeases
    """ # noqa: E501
    lease: List[GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInner] = Field(alias="Lease")
    __properties: ClassVar[List[str]] = ["Lease"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lease (list)
        _items = []
        if self.lease:
            for _item in self.lease:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Lease": [GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInner.from_dict(_item) for _item in obj["Lease"]] if obj.get("Lease") is not None else None
        })
        return _obj
