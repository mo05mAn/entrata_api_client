...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDeposit(BaseModel):
    """
    Deposit details for the floor plan
    """ # noqa: E501
    amount: Optional[GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAmount] = Field(default=None, alias="Amount")
    attributes: Optional[GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["Amount", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Amount": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAmount.from_dict(obj["Amount"]) if obj.get("Amount") is not None else None,
            "@attributes": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
