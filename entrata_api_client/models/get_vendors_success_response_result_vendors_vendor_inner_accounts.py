...
class GetVendorsSuccessResponseResultVendorsVendorInnerAccounts(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerAccounts
    """ # noqa: E501
    account: Optional[List[GetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": [GetVendorsSuccessResponseResultVendorsVendorInnerAccountsAccountInner.from_dict(_item) for _item in obj["account"]] if obj.get("account") is not None else None
        })
        return _obj
