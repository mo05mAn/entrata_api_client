...
class GetCallLogsSuccessResponseResult(BaseModel):
    """
    GetCallLogsSuccessResponseResult
    """ # noqa: E501
    calls: GetCallLogsSuccessResponseResultCalls
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of calls
        if self.calls:
            _dict['calls'] = self.calls.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calls": GetCallLogsSuccessResponseResultCalls.from_dict(obj["calls"]) if obj.get("calls") is not None else None
        })
        return _obj
