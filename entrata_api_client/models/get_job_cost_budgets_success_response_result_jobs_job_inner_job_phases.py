...
class GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhases(BaseModel):
    """
    GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhases
    """ # noqa: E501
    job_phase: List[GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner] = Field(description="A list of job phases associated with the job.", alias="jobPhase")
    __properties: ClassVar[List[str]] = ["jobPhase"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in job_phase (list)
        _items = []
        if self.job_phase:
            for _item in self.job_phase:
                if _item:
                    _items.append(_item.to_dict())
            _dict['jobPhase'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobPhase": [GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner.from_dict(_item) for _item in obj["jobPhase"]] if obj.get("jobPhase") is not None else None
        })
        return _obj
