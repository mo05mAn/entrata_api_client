...
class GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHoursAvailableHourInner(BaseModel):
    """
    GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHoursAvailableHourInner
    """ # noqa: E501
    var_date: StrictStr = Field(description="Date for the availability", alias="date")
