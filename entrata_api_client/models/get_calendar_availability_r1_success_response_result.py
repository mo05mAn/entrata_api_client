...
class GetCalendarAvailabilityR1SuccessResponseResult(BaseModel):
    """
    The result containing property calendar details
    """ # noqa: E501
    property_calendar_settings: Optional[GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings] = Field(default=None, alias="propertyCalendarSettings")
    property_calendar_availability: Optional[GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability] = Field(default=None, alias="propertyCalendarAvailability")
    __properties: ClassVar[List[str]] = ["propertyCalendarSettings", "propertyCalendarAvailability"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of property_calendar_settings
        if self.property_calendar_settings:
            _dict['propertyCalendarSettings'] = self.property_calendar_settings.to_dict()
        # override the default output from pydantic by calling `to_dict()` of property_calendar_availability
        if self.property_calendar_availability:
            _dict['propertyCalendarAvailability'] = self.property_calendar_availability.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "propertyCalendarSettings": GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettings.from_dict(obj["propertyCalendarSettings"]) if obj.get("propertyCalendarSettings") is not None else None,
            "propertyCalendarAvailability": GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability.from_dict(obj["propertyCalendarAvailability"]) if obj.get("propertyCalendarAvailability") is not None else None
        })
        return _obj
