...
class GetFinancialPickListR1SuccessResponseResultGlAccountTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlAccountTypes
    """ # noqa: E501
    gl_account_type: List[GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner] = Field(description="A list of GL account types.", alias="GlAccountType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlAccountType": [GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner.from_dict(_item) for _item in obj["GlAccountType"]] if obj.get("GlAccountType") is not None else None
        })
        return _obj
