...
class GetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerLocationsLocationInner
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the location.")
    name: StrictStr = Field(description="Name of the location.")
    vendor_code: StrictStr = Field(description="Vendor code associated with the location.", alias="vendorCode")
    is_primary: StrictStr = Field(description="Indicates if this is the primary location.", alias="isPrimary")
    property_ids: StrictStr = Field(description="Comma-separated list of property IDs associated with this location.", alias="propertyIds")
    __properties: ClassVar[List[str]] = ["id", "name", "vendorCode", "isPrimary", "propertyIds"]
