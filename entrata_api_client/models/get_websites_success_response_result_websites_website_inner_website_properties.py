...
class GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties(BaseModel):
    """
    GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties
    """ # noqa: E501
    website_property: List[GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner] = Field(alias="websiteProperty")
    __properties: ClassVar[List[str]] = ["websiteProperty"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in website_property (list)
        _items = []
        if self.website_property:
            for _item in self.website_property:
                if _item:
                    _items.append(_item.to_dict())
            _dict['websiteProperty'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "websiteProperty": [GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner.from_dict(_item) for _item in obj["websiteProperty"]] if obj.get("websiteProperty") is not None else None
        })
        return _obj
