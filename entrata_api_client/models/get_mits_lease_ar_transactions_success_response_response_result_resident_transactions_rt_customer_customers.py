...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomers(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomers
    """ # noqa: E501
    customer: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer = Field(alias="Customer")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Customer": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomer.from_dict(obj["Customer"]) if obj.get("Customer") is not None else None
        })
        return _obj
