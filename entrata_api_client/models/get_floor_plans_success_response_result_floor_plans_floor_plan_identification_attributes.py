...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes(BaseModel):
    """
    Attributes related to the floor plan identification
    """ # noqa: E501
    id_rank: Optional[StrictStr] = Field(default=None, description="Rank of the ID", alias="IDRank")
    id_scope_type: Optional[StrictStr] = Field(default=None, description="Scope type of the ID", alias="IDScopeType")
    id_type: Optional[StrictStr] = Field(default=None, description="Type of the ID", alias="IDType")
    __properties: ClassVar[List[str]] = ["IDRank", "IDScopeType", "IDType"]
