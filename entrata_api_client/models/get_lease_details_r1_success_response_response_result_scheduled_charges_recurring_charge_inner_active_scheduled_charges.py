...
class GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInnerActiveScheduledCharges(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInnerActiveScheduledCharges
    """ # noqa: E501
    active_scheduled_charge: List[GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInnerActiveScheduledChargesActiveScheduledChargeInner] = Field(alias="activeScheduledCharge")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activeScheduledCharge": [GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInnerActiveScheduledChargesActiveScheduledChargeInner.from_dict(_item) for _item in obj["activeScheduledCharge"]] if obj.get("activeScheduledCharge") is not None else None
        })
        return _obj
