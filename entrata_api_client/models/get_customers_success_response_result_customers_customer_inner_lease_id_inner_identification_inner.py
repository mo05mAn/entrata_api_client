...
class GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInner
    """ # noqa: E501
    id_value: StrictStr = Field(description="The ID value for the lease", alias="IDValue")
    attributes: GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
