...
class GetApCodesSuccessResponseResult(BaseModel):
    """
    GetApCodesSuccessResponseResult
    """ # noqa: E501
    ap_code_categories: GetApCodesSuccessResponseResultApCodeCategories = Field(alias="apCodeCategories")
    __properties: ClassVar[List[str]] = ["apCodeCategories"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ap_code_categories
        if self.ap_code_categories:
            _dict['apCodeCategories'] = self.ap_code_categories.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apCodeCategories": GetApCodesSuccessResponseResultApCodeCategories.from_dict(obj["apCodeCategories"]) if obj.get("apCodeCategories") is not None else None
        })
        return _obj
