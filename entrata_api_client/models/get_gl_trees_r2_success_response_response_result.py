...
class GetGlTreesR2SuccessResponseResponseResult(BaseModel):
    """
    The result object containing the GL Tree data
    """ # noqa: E501
    gl_trees: GetGlTreesR2SuccessResponseResponseResultGlTrees = Field(alias="glTrees")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glTrees": GetGlTreesR2SuccessResponseResponseResultGlTrees.from_dict(obj["glTrees"]) if obj.get("glTrees") is not None else None
        })
        return _obj
