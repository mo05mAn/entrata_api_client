...
class GetLeadPickListsR2SuccessResponseResultPsProducts(BaseModel):
    """
    PS products associated with the request.
    """ # noqa: E501
    ps_product: Optional[List[GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInner]] = Field(default=None, description="A list of PS products.", alias="psProduct")
    __properties: ClassVar[List[str]] = ["psProduct"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ps_product (list)
        _items = []
        if self.ps_product:
            for _item in self.ps_product:
                if _item:
                    _items.append(_item.to_dict())
            _dict['psProduct'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "psProduct": [GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInner.from_dict(_item) for _item in obj["psProduct"]] if obj.get("psProduct") is not None else None
        })
        return _obj
