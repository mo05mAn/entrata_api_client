...
class GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer(BaseModel):
    """
    GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the customer associated with the lease.")
    first_name: Optional[StrictStr] = Field(default=None, description="The first name of the customer.", alias="firstName")
    last_name: Optional[StrictStr] = Field(default=None, description="The last name of the customer.", alias="lastName")
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "isActiveBankruptcy", "bankruptcyDate", "bankruptcyNote"]
