...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertySearchAreasSearchAreas(BaseModel):
    """
    List of search areas for the property
    """ # noqa: E501
    search_area: List[GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertySearchAreasSearchAreasSearchAreaInner] = Field(description="List of search areas", alias="SearchArea")
    __properties: ClassVar[List[str]] = ["SearchArea"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "SearchArea": [GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertySearchAreasSearchAreasSearchAreaInner.from_dict(_item) for _item in obj["SearchArea"]] if obj.get("SearchArea") is not None else None
        })
        return _obj
