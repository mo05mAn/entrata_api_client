...
class GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations(BaseModel):
    """
    GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociations
    """ # noqa: E501
    level_id: Optional[StrictStr] = Field(default=None, alias="levelId")
    level_name: Optional[StrictStr] = Field(default=None, alias="levelName")
    unit_count: Optional[StrictInt] = Field(default=None, alias="unitCount")
    references: Optional[List[GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner]] = None
    __properties: ClassVar[List[str]] = ["levelId", "levelName", "unitCount", "references"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "references": [GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerAssociationsReferencesInner.from_dict(_item) for _item in obj["references"]] if obj.get("references") is not None else None
        })
        return _obj
