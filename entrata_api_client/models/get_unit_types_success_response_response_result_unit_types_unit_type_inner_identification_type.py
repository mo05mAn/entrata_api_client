...
class GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationType(BaseModel):
    """
    GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationType
    """ # noqa: E501
    attributes: GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes = Field(alias="@attributes")
    id_value: StrictStr = Field(description="The unique identifier for the unit type", alias="idValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerIdentificationTypeAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
