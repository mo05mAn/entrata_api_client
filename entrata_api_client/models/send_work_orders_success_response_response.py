...
class SendWorkOrdersSuccessResponseResponse(BaseModel):
    """
    SendWorkOrdersSuccessResponseResponse
    """ # noqa: E501
    code: StrictInt = Field(description="Successful response code.")
    result: SendWorkOrdersSuccessResponseResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "result": SendWorkOrdersSuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
