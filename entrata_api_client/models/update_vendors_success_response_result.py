...
class UpdateVendorsSuccessResponseResult(BaseModel):
    """
    UpdateVendorsSuccessResponseResult
    """ # noqa: E501
    vendors: Optional[UpdateVendorsSuccessResponseResultVendors] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vendors": UpdateVendorsSuccessResponseResultVendors.from_dict(obj["vendors"]) if obj.get("vendors") is not None else None
        })
        return _obj
