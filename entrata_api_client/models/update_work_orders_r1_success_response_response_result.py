...
class UpdateWorkOrdersR1SuccessResponseResponseResult(BaseModel):
    """
    The result of the work order operation
    """ # noqa: E501
    work_orders: Optional[UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders] = Field(default=None, alias="workOrders")
    __properties: ClassVar[List[str]] = ["workOrders"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of work_orders
        if self.work_orders:
            _dict['workOrders'] = self.work_orders.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workOrders": UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrders.from_dict(obj["workOrders"]) if obj.get("workOrders") is not None else None
        })
        return _obj
