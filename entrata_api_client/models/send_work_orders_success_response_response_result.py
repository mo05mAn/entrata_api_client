...
class SendWorkOrdersSuccessResponseResponseResult(BaseModel):
    """
    Result object containing the success details
    """ # noqa: E501
    success: Optional[List[SendWorkOrdersSuccessResponseResponseResultSuccessInner]] = Field(default=None, description="List of success messages", alias="Success")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Success": [SendWorkOrdersSuccessResponseResponseResultSuccessInner.from_dict(_item) for _item in obj["Success"]] if obj.get("Success") is not None else None
        })
        return _obj
