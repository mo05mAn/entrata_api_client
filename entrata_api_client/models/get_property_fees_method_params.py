...
class GetPropertyFeesMethodParams(BaseModel):
    """
    GetPropertyFeesMethodParams
    """ # noqa: E501
    property_id: StrictStr = Field(description="This is a required field. This field accepts single value. propertyId", alias="propertyId")
