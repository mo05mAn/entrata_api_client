...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerFileTransactionsInnerIdentificationAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    id_type: StrictStr = Field(description="Transaction ID type", alias="IDType")
    id_rank: StrictStr = Field(description="Transaction ID rank", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Transaction ID scope type", alias="IDScopeType")
