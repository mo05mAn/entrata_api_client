...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerLeaseTerms(BaseModel):
    """
    The lease terms for the quote.
    """ # noqa: E501
    lease_term: Optional[List[GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerLeaseTermsLeaseTermInner]] = Field(default=None, description="A list of lease terms.", alias="leaseTerm")
    __properties: ClassVar[List[str]] = ["leaseTerm"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.lease_term:
            for _item in self.lease_term:
                if _item:
                    _items.append(_item.to_dict())
            _dict['leaseTerm'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leaseTerm": [GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerLeaseTermsLeaseTermInner.from_dict(_item) for _item in obj["leaseTerm"]] if obj.get("leaseTerm") is not None else None
        })
        return _obj
