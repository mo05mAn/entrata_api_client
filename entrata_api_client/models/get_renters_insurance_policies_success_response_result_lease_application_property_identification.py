...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification
    """ # noqa: E501
    id_value: StrictStr = Field(description="Unique identifier for the property", alias="IDValue")
    organization_name: StrictStr = Field(description="Organization name", alias="OrganizationName")
    attributes: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentificationAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["IDValue", "OrganizationName", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentificationAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
