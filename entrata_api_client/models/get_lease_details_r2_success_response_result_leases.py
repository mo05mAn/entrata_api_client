...
class GetLeaseDetailsR2SuccessResponseResultLeases(BaseModel):
    """
    GetLeaseDetailsR2SuccessResponseResultLeases
    """ # noqa: E501
    lease: GetLeaseDetailsR2SuccessResponseResultLeasesLease
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lease": GetLeaseDetailsR2SuccessResponseResultLeasesLease.from_dict(obj["lease"]) if obj.get("lease") is not None else None
        })
        return _obj
