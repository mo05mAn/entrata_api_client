...
class GetLeasesR1SuccessResponseResultLeases(BaseModel):
    """
    The list of leases
    """ # noqa: E501
    lease: List[GetLeasesR1SuccessResponseResultLeasesLeaseInner] = Field(description="List of lease details")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lease": [GetLeasesR1SuccessResponseResultLeasesLeaseInner.from_dict(_item) for _item in obj["lease"]] if obj.get("lease") is not None else None
        })
        return _obj
