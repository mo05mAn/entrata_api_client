...
class GetVendorPickListsSuccessResponseResultUnitsOfMeasure(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultUnitsOfMeasure
    """ # noqa: E501
    unit_of_measure: Optional[List[GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInner]] = Field(default=None, alias="unitOfMeasure")
    __properties: ClassVar[List[str]] = ["unitOfMeasure"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in unit_of_measure (list)
        _items = []
        if self.unit_of_measure:
            for _item in self.unit_of_measure:
                if _item:
                    _items.append(_item.to_dict())
            _dict['unitOfMeasure'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitOfMeasure": [GetVendorPickListsSuccessResponseResultUnitsOfMeasureUnitOfMeasureInner.from_dict(_item) for _item in obj["unitOfMeasure"]] if obj.get("unitOfMeasure") is not None else None
        })
        return _obj
