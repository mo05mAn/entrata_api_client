...
class GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the AP payee type.")
    name: StrictStr = Field(description="Name of the AP payee type.")
