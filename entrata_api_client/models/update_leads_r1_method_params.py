...
class UpdateLeadsR1MethodParams(BaseModel):
    """
    ...
    application_id: StrictInt = Field(description="This is a required field. This field accepts single value. ApplicationId", alias="applicationId")
    __properties: ClassVar[List[str]] = ["propertyId", "applicationId"]
