...
class GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner(BaseModel):
    """
    GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner
    """ # noqa: E501
    attributes: Optional[GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
