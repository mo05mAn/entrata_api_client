...
class GetPropertyUnitsSuccessResponseResponse(BaseModel):
    """
    GetPropertyUnitsSuccessResponseResponse
    """ # noqa: E501
    request_id: StrictInt = Field(description="Request ID - The ID for the request", alias="requestId")
    result: GetPropertyUnitsSuccessResponseResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": GetPropertyUnitsSuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
