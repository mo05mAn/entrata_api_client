...
class GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity
    """ # noqa: E501
    value: StrictStr = Field(description="Legal entity name.", alias="@value")
    attributes: GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@value": obj.get("@value"),
            "@attributes": GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntityAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
