...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsProperty(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsProperty
    """ # noqa: E501
    property_id: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsPropertyPropertyID = Field(alias="PropertyID")
    marketing_name: StrictStr = Field(description="Marketing name of the property", alias="MarketingName")
    __properties: ClassVar[List[str]] = ["PropertyID", "MarketingName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PropertyID": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsPropertyPropertyID.from_dict(obj["PropertyID"]) if obj.get("PropertyID") is not None else None,
