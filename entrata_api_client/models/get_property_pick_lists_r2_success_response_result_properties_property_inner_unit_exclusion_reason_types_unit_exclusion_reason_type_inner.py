...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitExclusionReasonTypesUnitExclusionReasonTypeInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitExclusionReasonTypesUnitExclusionReasonTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="Exclusion reason type ID")
    name: StrictStr = Field(description="Exclusion reason type name")
