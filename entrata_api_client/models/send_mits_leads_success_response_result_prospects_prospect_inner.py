...
class SendMitsLeadsSuccessResponseResultProspectsProspectInner(BaseModel):
    """
    SendMitsLeadsSuccessResponseResultProspectsProspectInner
    """ # noqa: E501
    attributes: Optional[SendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": SendMitsLeadsSuccessResponseResultProspectsProspectInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
