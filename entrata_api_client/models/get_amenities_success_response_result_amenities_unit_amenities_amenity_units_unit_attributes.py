...
class GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes
    """ # noqa: E501
    property_unit_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the unit", alias="PropertyUnitId")
    is_published: Optional[StrictStr] = Field(default=None, description="Indicates if the unit is published", alias="IsPublished")
    is_featured: Optional[StrictStr] = Field(default=None, description="Indicates if the unit is featured", alias="IsFeatured")
    ...
    __properties: ClassVar[List[str]] = ["PropertyUnitId", "IsPublished", "IsFeatured", "HideRates", "ShowDescription", "IncludeInRent"]
