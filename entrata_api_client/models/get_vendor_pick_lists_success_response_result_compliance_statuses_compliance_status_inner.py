...
class GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInner(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInner
    """ # noqa: E501
    attributes: GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
