...
class GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValues(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValues
    """ # noqa: E501
    customer_identification_value: List[GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner] = Field(alias="CustomerIdentificationValue")
    __properties: ClassVar[List[str]] = ["CustomerIdentificationValue"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in customer_identification_value (list)
        _items = []
        if self.customer_identification_value:
            for _item in self.customer_identification_value:
                if _item:
                    _items.append(_item.to_dict())
            _dict['CustomerIdentificationValue'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CustomerIdentificationValue": [GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner.from_dict(_item) for _item in obj["CustomerIdentificationValue"]] if obj.get("CustomerIdentificationValue") is not None else None
        })
        return _obj
