...
class GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans
    """ # noqa: E501
    floorplan: GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "floorplan": GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplansFloorplan.from_dict(obj["floorplan"]) if obj.get("floorplan") is not None else None
        })
        return _obj
