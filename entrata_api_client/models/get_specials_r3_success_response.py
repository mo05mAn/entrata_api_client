...
class GetSpecialsR3SuccessResponse(BaseModel):
    """
    GetSpecialsR3SuccessResponse
    """ # noqa: E501
    response: GetSpecialsR3SuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetSpecialsR3SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
