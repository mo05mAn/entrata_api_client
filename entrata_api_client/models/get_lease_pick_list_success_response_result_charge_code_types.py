...
class GetLeasePickListSuccessResponseResultChargeCodeTypes(BaseModel):
    """
    GetLeasePickListSuccessResponseResultChargeCodeTypes
    """ # noqa: E501
    charge_code_type: List[GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner] = Field(alias="chargeCodeType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeCodeType": [GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner.from_dict(_item) for _item in obj["chargeCodeType"]] if obj.get("chargeCodeType") is not None else None
        })
        return _obj
