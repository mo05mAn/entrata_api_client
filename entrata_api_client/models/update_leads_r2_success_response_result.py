...
class UpdateLeadsR2SuccessResponseResult(BaseModel):
    """
    The result data of the request.
    """ # noqa: E501
    prospects: Optional[List[UpdateLeadsR2SuccessResponseResultProspectsInner]] = Field(default=None, description="A list of prospects with their status and message.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prospects": [UpdateLeadsR2SuccessResponseResultProspectsInner.from_dict(_item) for _item in obj["prospects"]] if obj.get("prospects") is not None else None
        })
        return _obj
