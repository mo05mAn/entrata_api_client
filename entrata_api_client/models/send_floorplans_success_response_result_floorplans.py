...
class SendFloorplansSuccessResponseResultFloorplans(BaseModel):
    """
    SendFloorplansSuccessResponseResultFloorplans
    """ # noqa: E501
    floorplan: List[SendFloorplansSuccessResponseResultFloorplansFloorplanInner] = Field(alias="Floorplan")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Floorplan": [SendFloorplansSuccessResponseResultFloorplansFloorplanInner.from_dict(_item) for _item in obj["Floorplan"]] if obj.get("Floorplan") is not None else None
        })
        return _obj
