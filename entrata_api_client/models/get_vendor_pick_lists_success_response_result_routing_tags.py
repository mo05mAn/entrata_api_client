...
class GetVendorPickListsSuccessResponseResultRoutingTags(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultRoutingTags
    """ # noqa: E501
    routing_tag: Optional[List[GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInner]] = Field(default=None, alias="routingTag")
    __properties: ClassVar[List[str]] = ["routingTag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in routing_tag (list)
        _items = []
        if self.routing_tag:
            for _item in self.routing_tag:
                if _item:
                    _items.append(_item.to_dict())
            _dict['routingTag'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "routingTag": [GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInner.from_dict(_item) for _item in obj["routingTag"]] if obj.get("routingTag") is not None else None
        })
        return _obj
