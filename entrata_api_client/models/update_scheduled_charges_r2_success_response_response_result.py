...
class UpdateScheduledChargesR2SuccessResponseResponseResult(BaseModel):
    """
    UpdateScheduledChargesR2SuccessResponseResponseResult
    """ # noqa: E501
    scheduled_charges: UpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges = Field(alias="scheduledCharges")
    __properties: ClassVar[List[str]] = ["scheduledCharges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scheduledCharges": UpdateScheduledChargesR2SuccessResponseResponseResultScheduledCharges.from_dict(obj["scheduledCharges"]) if obj.get("scheduledCharges") is not None else None
        })
        return _obj
