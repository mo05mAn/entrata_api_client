...
class GetMitsLeadsSuccessResponseResult(BaseModel):
    """
    The result data of the request.
    """ # noqa: E501
    currency_code: Optional[StrictStr] = Field(default=None, description="The currency code used in the request.", alias="CurrencyCode")
    lead_management: Optional[List[GetMitsLeadsSuccessResponseResultLeadManagementInner]] = Field(default=None, description="A list of lead management entries.", alias="LeadManagement")
    __properties: ClassVar[List[str]] = ["CurrencyCode", "LeadManagement"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lead_management (list)
        _items = []
        if self.lead_management:
            for _item in self.lead_management:
                if _item:
                    _items.append(_item.to_dict())
            _dict['LeadManagement'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LeadManagement": [GetMitsLeadsSuccessResponseResultLeadManagementInner.from_dict(_item) for _item in obj["LeadManagement"]] if obj.get("LeadManagement") is not None else None
        })
        return _obj
