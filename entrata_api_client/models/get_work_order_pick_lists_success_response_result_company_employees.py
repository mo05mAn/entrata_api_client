...
class GetWorkOrderPickListsSuccessResponseResultCompanyEmployees(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultCompanyEmployees
    """ # noqa: E501
    company_employee: List[GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner] = Field(alias="CompanyEmployee")
    __properties: ClassVar[List[str]] = ["CompanyEmployee"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in company_employee (list)
        _items = []
        if self.company_employee:
            for _item in self.company_employee:
                if _item:
                    _items.append(_item.to_dict())
            _dict['CompanyEmployee'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CompanyEmployee": [GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner.from_dict(_item) for _item in obj["CompanyEmployee"]] if obj.get("CompanyEmployee") is not None else None
        })
        return _obj
