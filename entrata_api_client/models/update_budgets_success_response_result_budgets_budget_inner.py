...
class UpdateBudgetsSuccessResponseResultBudgetsBudgetInner(BaseModel):
    """
    UpdateBudgetsSuccessResponseResultBudgetsBudgetInner
    """ # noqa: E501
    node: StrictStr = Field(description="The node identifier for the budget update.")
    status: StrictStr = Field(description="The status of the budget update.")
    message: StrictStr = Field(description="Message indicating the result of the budget update.")
