...
class GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyTypeCoverages(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyTypeCoverages
    """ # noqa: E501
    coverage: GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyTypeCoveragesCoverage = Field(alias="Coverage")
    __properties: ClassVar[List[str]] = ["Coverage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Coverage": GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyTypeCoveragesCoverage.from_dict(obj["Coverage"]) if obj.get("Coverage") is not None else None
        })
        return _obj
