...
class GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner(BaseModel):
    """
    GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner
    """ # noqa: E501
    list_items: Optional[GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems] = Field(default=None, alias="listItems")
    attributes: Optional[GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["listItems", "@attributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of list_items
        if self.list_items:
            _dict['listItems'] = self.list_items.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "listItems": GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems.from_dict(obj["listItems"]) if obj.get("listItems") is not None else None,
            "@attributes": GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
