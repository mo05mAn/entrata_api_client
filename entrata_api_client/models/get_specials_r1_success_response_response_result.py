...
class GetSpecialsR1SuccessResponseResponseResult(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResult
    """ # noqa: E501
    physical_property: GetSpecialsR1SuccessResponseResponseResultPhysicalProperty = Field(alias="PhysicalProperty")
    __properties: ClassVar[List[str]] = ["PhysicalProperty"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of physical_property
        if self.physical_property:
            _dict['PhysicalProperty'] = self.physical_property.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PhysicalProperty": GetSpecialsR1SuccessResponseResponseResultPhysicalProperty.from_dict(obj["PhysicalProperty"]) if obj.get("PhysicalProperty") is not None else None
        })
        return _obj
