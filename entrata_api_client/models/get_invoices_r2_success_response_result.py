...
class GetInvoicesR2SuccessResponseResult(BaseModel):
    """
    GetInvoicesR2SuccessResponseResult
    """ # noqa: E501
    invoices: GetInvoicesR2SuccessResponseResultInvoices
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": GetInvoicesR2SuccessResponseResultInvoices.from_dict(obj["invoices"]) if obj.get("invoices") is not None else None
        })
        return _obj
