...
class GetVendorsSuccessResponseResultVendorsVendorInnerContacts(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerContacts
    """ # noqa: E501
    contact: Optional[List[GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contact": [GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner.from_dict(_item) for _item in obj["contact"]] if obj.get("contact") is not None else None
        })
        return _obj
