...
class GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner(BaseModel):
    """
    GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientDetailsInner
    """ # noqa: E501
    special_recipient_id: Optional[StrictInt] = Field(default=None, alias="specialRecipientId")
    special_recipient_name: Optional[StrictStr] = Field(default=None, alias="specialRecipientName")
    __properties: ClassVar[List[str]] = ["specialRecipientId", "specialRecipientName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "specialRecipientId": obj.get("specialRecipientId"),
            "specialRecipientName": obj.get("specialRecipientName")
        })
        return _obj
