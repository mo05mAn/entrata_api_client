...
class GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems(BaseModel):
    """
    GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems
    """ # noqa: E501
    problem: List[GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "problem": [GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInner.from_dict(_item) for _item in obj["problem"]] if obj.get("problem") is not None else None
        })
        return _obj
