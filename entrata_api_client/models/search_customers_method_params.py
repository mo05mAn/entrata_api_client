...
class SearchCustomersMethodParams(BaseModel):
    """
    SearchCustomersMethodParams
    """ # noqa: E501
    property_id: StrictInt = Field(description="This is a required field. This field accepts single value. Property Id. This is system ID associated with each property.", alias="propertyId")
    search: StrictStr = Field(description="This is a required field. This field accepts single value. Search string accepts phone number, name, building, unit, secondary number.")
    __properties: ClassVar[List[str]] = ["propertyId", "search"]
