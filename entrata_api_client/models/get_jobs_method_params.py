...
class GetJobsMethodParams(BaseModel):
    """
    GetJobsMethodParams
    """ # noqa: E501
    property_id: StrictInt = Field(description="This is a required field. This field accepts single value. This node should accept the propertyId.", alias="propertyId")
    job_category_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. This node should accept the jobCategoryIds", alias="jobCategoryIds")
    job_status_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. This node should accept the job statusIds.", alias="jobStatusIds")
    __properties: ClassVar[List[str]] = ["propertyId", "jobCategoryIds", "jobStatusIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobCategoryIds": obj.get("jobCategoryIds"),
