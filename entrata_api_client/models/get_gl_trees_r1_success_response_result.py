...
class GetGlTreesR1SuccessResponseResult(BaseModel):
    """
    GetGlTreesR1SuccessResponseResult
    """ # noqa: E501
    gl_trees: GetGlTreesR1SuccessResponseResultGlTrees = Field(alias="GlTrees")
    __properties: ClassVar[List[str]] = ["GlTrees"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of gl_trees
        if self.gl_trees:
            _dict['GlTrees'] = self.gl_trees.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlTrees": GetGlTreesR1SuccessResponseResultGlTrees.from_dict(obj["GlTrees"]) if obj.get("GlTrees") is not None else None
        })
        return _obj
