...
class SendCustomerTestimonialsSuccessResponseResultTestimonials(BaseModel):
    """
    SendCustomerTestimonialsSuccessResponseResultTestimonials
    """ # noqa: E501
    testimonial: List[SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner] = Field(alias="Testimonial")
    __properties: ClassVar[List[str]] = ["Testimonial"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in testimonial (list)
        _items = []
        if self.testimonial:
            for _item in self.testimonial:
                if _item:
                    _items.append(_item.to_dict())
            _dict['Testimonial'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Testimonial": [SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner.from_dict(_item) for _item in obj["Testimonial"]] if obj.get("Testimonial") is not None else None
        })
        return _obj
