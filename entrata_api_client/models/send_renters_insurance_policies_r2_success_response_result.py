...
class SendRentersInsurancePoliciesR2SuccessResponseResult(BaseModel):
    """
    SendRentersInsurancePoliciesR2SuccessResponseResult
    """ # noqa: E501
    insurance_policies: SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies = Field(alias="InsurancePolicies")
    __properties: ClassVar[List[str]] = ["InsurancePolicies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "InsurancePolicies": SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies.from_dict(obj["InsurancePolicies"]) if obj.get("InsurancePolicies") is not None else None
        })
        return _obj
