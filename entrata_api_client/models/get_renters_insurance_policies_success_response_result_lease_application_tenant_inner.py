...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInner(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInner
    """ # noqa: E501
    identification: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerIdentification = Field(alias="Identification")
    lease_id: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerLeaseID = Field(alias="LeaseID")
    name: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName = Field(alias="Name")
    residence: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerResidence = Field(alias="Residence")
    phone: Optional[GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerPhone] = Field(default=None, alias="Phone")
    attributes: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["Identification", "LeaseID", "Name", "Residence", "Phone", "@attributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of lease_id
        if self.lease_id:
            _dict['LeaseID'] = self.lease_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of name
        if self.name:
            _dict['Name'] = self.name.to_dict()
        # override the default output from pydantic by calling `to_dict()` of residence
        if self.residence:
            _dict['Residence'] = self.residence.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "LeaseID": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerLeaseID.from_dict(obj["LeaseID"]) if obj.get("LeaseID") is not None else None,
            "Name": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName.from_dict(obj["Name"]) if obj.get("Name") is not None else None,
            "Residence": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerResidence.from_dict(obj["Residence"]) if obj.get("Residence") is not None else None,
            "Phone": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerPhone.from_dict(obj["Phone"]) if obj.get("Phone") is not None else None,
            "@attributes": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
