...
class GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner(BaseModel):
    """
    GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the amenity")
    name: StrictStr = Field(description="Name of the amenity")
    description: StrictStr = Field(description="Description of the amenity")
    is_published: StrictStr = Field(description="Indicates if the amenity is published", alias="isPublished")
    reservations: Optional[GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "isPublished", "reservations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reservations": GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations.from_dict(obj["reservations"]) if obj.get("reservations") is not None else None
        })
        return _obj
