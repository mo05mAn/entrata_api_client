...
class UpdateWorkOrdersR2SuccessResponse(BaseModel):
    """
    UpdateWorkOrdersR2SuccessResponse
    """ # noqa: E501
    response: UpdateWorkOrdersR1SuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": UpdateWorkOrdersR1SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
