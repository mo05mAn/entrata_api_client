...
class GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the owner.")
    name: StrictStr = Field(description="The name of the owner.")
    property_ids: StrictStr = Field(description="A comma-separated list of property IDs associated with the owner.", alias="propertyIds")
    __properties: ClassVar[List[str]] = ["id", "name", "propertyIds"]
