...
class UpdatePropertyMediaSuccessResponseResponseResult(BaseModel):
    """
    UpdatePropertyMediaSuccessResponseResponseResult
    """ # noqa: E501
    media: List[UpdatePropertyMediaSuccessResponseResponseResultMediaInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "media": [UpdatePropertyMediaSuccessResponseResponseResultMediaInner.from_dict(_item) for _item in obj["media"]] if obj.get("media") is not None else None
        })
        return _obj
