...
class SendApplicationVehiclesSuccessResponseResponseResult(BaseModel):
    """
    SendApplicationVehiclesSuccessResponseResponseResult
    """ # noqa: E501
    vehicles: SendApplicationVehiclesSuccessResponseResponseResultVehicles
    __properties: ClassVar[List[str]] = ["vehicles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vehicles": SendApplicationVehiclesSuccessResponseResponseResultVehicles.from_dict(obj["vehicles"]) if obj.get("vehicles") is not None else None
        })
        return _obj
