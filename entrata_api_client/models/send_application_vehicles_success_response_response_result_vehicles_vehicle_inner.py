...
class SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner(BaseModel):
    """
    SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner
    """ # noqa: E501
    status: StrictStr = Field(description="Status of the vehicle operation.")
    message: StrictStr = Field(description="Message indicating the vehicle operation result.")
    id: StrictInt = Field(description="Vehicle ID.")
    customer_id: StrictInt = Field(description="Customer ID.", alias="customerId")
    vehicle_type_id: StrictInt = Field(description="Type ID of the vehicle.", alias="vehicleTypeId")
    node: StrictInt = Field(description="Node number associated with the vehicle.")
    __properties: ClassVar[List[str]] = ["status", "message", "id", "customerId", "vehicleTypeId", "node"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vehicleTypeId": obj.get("vehicleTypeId"),
            "node": obj.get("node")
        })
        return _obj
