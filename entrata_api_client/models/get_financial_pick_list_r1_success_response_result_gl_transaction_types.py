...
class GetFinancialPickListR1SuccessResponseResultGlTransactionTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlTransactionTypes
    """ # noqa: E501
    gl_transaction_type: List[GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner] = Field(description="A list of GL transaction types.", alias="GlTransactionType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlTransactionType": [GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner.from_dict(_item) for _item in obj["GlTransactionType"]] if obj.get("GlTransactionType") is not None else None
        })
        return _obj
