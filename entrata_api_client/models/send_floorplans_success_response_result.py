...
class SendFloorplansSuccessResponseResult(BaseModel):
    """
    SendFloorplansSuccessResponseResult
    """ # noqa: E501
    floorplans: SendFloorplansSuccessResponseResultFloorplans = Field(alias="Floorplans")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Floorplans": SendFloorplansSuccessResponseResultFloorplans.from_dict(obj["Floorplans"]) if obj.get("Floorplans") is not None else None
        })
        return _obj
