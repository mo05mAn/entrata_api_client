...
class UpdateCustomerTestimonialsSuccessResponseResult(BaseModel):
    """
    UpdateCustomerTestimonialsSuccessResponseResult
    """ # noqa: E501
    testimonials: UpdateCustomerTestimonialsSuccessResponseResultTestimonials = Field(alias="Testimonials")
    __properties: ClassVar[List[str]] = ["Testimonials"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of testimonials
        if self.testimonials:
            _dict['Testimonials'] = self.testimonials.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Testimonials": UpdateCustomerTestimonialsSuccessResponseResultTestimonials.from_dict(obj["Testimonials"]) if obj.get("Testimonials") is not None else None
        })
        return _obj
