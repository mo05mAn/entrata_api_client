...
class GetVendorsSuccessResponseResult(BaseModel):
    """
    GetVendorsSuccessResponseResult
    """ # noqa: E501
    vendors: Optional[GetVendorsSuccessResponseResultVendors] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vendors": GetVendorsSuccessResponseResultVendors.from_dict(obj["vendors"]) if obj.get("vendors") is not None else None
        })
        return _obj
