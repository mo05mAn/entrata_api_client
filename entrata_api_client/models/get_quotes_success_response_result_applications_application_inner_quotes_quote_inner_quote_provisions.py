...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerQuoteProvisions(BaseModel):
    """
    The provisions or discounts available for the quote.
    """ # noqa: E501
    quote_provision: Optional[List[GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerQuoteProvisionsQuoteProvisionInner]] = Field(default=None, description="A list of quote provisions.", alias="quoteProvision")
    __properties: ClassVar[List[str]] = ["quoteProvision"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in quote_provision (list)
        _items = []
        if self.quote_provision:
            for _item in self.quote_provision:
                if _item:
                    _items.append(_item.to_dict())
            _dict['quoteProvision'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quoteProvision": [GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerQuoteProvisionsQuoteProvisionInner.from_dict(_item) for _item in obj["quoteProvision"]] if obj.get("quoteProvision") is not None else None
        })
        return _obj
