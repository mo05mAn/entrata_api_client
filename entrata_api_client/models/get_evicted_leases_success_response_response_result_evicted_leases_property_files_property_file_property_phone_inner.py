...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFilePropertyPhoneInner(BaseModel):
    """
    GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFilePropertyPhoneInner
    """ # noqa: E501
    phone_type: StrictStr = Field(description="Type of phone (e.g., Office, Other).", alias="phoneType")
