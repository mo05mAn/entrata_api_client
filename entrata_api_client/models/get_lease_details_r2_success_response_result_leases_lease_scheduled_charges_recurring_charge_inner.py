...
class GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner(BaseModel):
    """
    ...
    lease_start_date: StrictStr = Field(description="Start date of the lease interval.", alias="leaseStartDate")
    lease_end_date: StrictStr = Field(description="End date of the lease interval.", alias="leaseEndDate")
    __properties: ClassVar[List[str]] = ["leaseIntervalId", "leaseIntervalStatus", "leaseIntervalType", "leaseStartDate", "leaseEndDate"]
