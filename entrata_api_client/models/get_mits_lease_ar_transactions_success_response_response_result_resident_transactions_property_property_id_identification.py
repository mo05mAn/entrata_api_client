...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsPropertyPropertyIDIdentification(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsPropertyPropertyIDIdentification
    """ # noqa: E501
    attributes: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsPropertyPropertyIDIdentificationAttributes = Field(alias="@attributes")
    id_value: StrictInt = Field(description="Property ID value", alias="IDValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsPropertyPropertyIDIdentificationAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
