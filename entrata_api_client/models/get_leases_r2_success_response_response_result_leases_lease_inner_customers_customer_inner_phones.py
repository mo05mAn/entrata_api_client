...
class GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhones(BaseModel):
    """
    Phone information of the customer
    """ # noqa: E501
    phone: List[GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhonesPhoneInner] = Field(description="List of phones")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "phone": [GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhonesPhoneInner.from_dict(_item) for _item in obj["phone"]] if obj.get("phone") is not None else None
        })
        return _obj
