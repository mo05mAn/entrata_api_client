...
class GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations(BaseModel):
    """
    GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocations
    """ # noqa: E501
    location: List[GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "location": [GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner.from_dict(_item) for _item in obj["location"]] if obj.get("location") is not None else None
        })
        return _obj
