...
class GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal(BaseModel):
    """
    GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal
    """ # noqa: E501
    total_charge: StrictStr = Field(description="Total charge for all labor", alias="totalCharge")
    total_minutes: StrictInt = Field(description="Total minutes worked for all labor", alias="totalMinutes")
    __properties: ClassVar[List[str]] = ["totalCharge", "totalMinutes"]
