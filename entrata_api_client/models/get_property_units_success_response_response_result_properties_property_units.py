...
class GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnits(BaseModel):
    """
    GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnits
    """ # noqa: E501
    unit: GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unit": GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnit.from_dict(obj["unit"]) if obj.get("unit") is not None else None
        })
        return _obj
