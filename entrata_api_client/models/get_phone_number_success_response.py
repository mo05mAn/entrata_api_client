...
class GetPhoneNumberSuccessResponse(BaseModel):
    """
    GetPhoneNumberSuccessResponse
    """ # noqa: E501
    response: GetPhoneNumberSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetPhoneNumberSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
