...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItems(BaseModel):
    """
    Items that can be assigned
    """ # noqa: E501
    assignable_item: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner] = Field(alias="assignableItem")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignableItem": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner.from_dict(_item) for _item in obj["assignableItem"]] if obj.get("assignableItem") is not None else None
        })
        return _obj
