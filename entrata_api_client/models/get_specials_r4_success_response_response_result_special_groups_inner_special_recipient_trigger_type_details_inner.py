...
class GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientTriggerTypeDetailsInner(BaseModel):
    """
    GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpecialRecipientTriggerTypeDetailsInner
    """ # noqa: E501
    special_recipient_trigger_type_id: Optional[StrictStr] = Field(default=None, alias="specialRecipientTriggerTypeId")
    special_recipient_trigger_type_name: Optional[StrictStr] = Field(default=None, alias="specialRecipientTriggerTypeName")
    __properties: ClassVar[List[str]] = ["specialRecipientTriggerTypeId", "specialRecipientTriggerTypeName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "specialRecipientTriggerTypeId": obj.get("specialRecipientTriggerTypeId"),
            "specialRecipientTriggerTypeName": obj.get("specialRecipientTriggerTypeName")
        })
        return _obj
