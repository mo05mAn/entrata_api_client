...
class ErrorResponseResponseError(BaseModel):
    """
    ErrorResponseResponseError
    """ # noqa: E501
    code: StrictInt = Field(description="error code one of the [ 1xx, 3xx, 4xx, 5xx ]")
    message: StrictStr = Field(description="error details.")
