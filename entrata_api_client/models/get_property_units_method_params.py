...
class GetPropertyUnitsMethodParams(BaseModel):
    """
    ...
    available_units_only: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="availableUnitsOnly")
    use_property_preferences: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. If enabled then the Entrata setting \"Max Available Units per Floor P lan\" will be honored and the available units returned will be reduced. Also requires using the availableUnitsOnly parameter as true (1).", alias="usePropertyPreferences")
    include_disabled_floorplans: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="includeDisabledFloorplans")
    include_disabled_units: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="includeDisabledUnits")
    __properties: ClassVar[List[str]] = ["propertyIds", "availableUnitsOnly", "usePropertyPreferences", "includeDisabledFloorplans", "includeDisabledUnits"]
    ...
    @field_validator('use_property_preferences')
    def use_property_preferences_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usePropertyPreferences": obj.get("usePropertyPreferences"),
