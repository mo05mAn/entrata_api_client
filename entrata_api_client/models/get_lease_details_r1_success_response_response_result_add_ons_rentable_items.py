...
class GetLeaseDetailsR1SuccessResponseResponseResultAddOnsRentableItems(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResultAddOnsRentableItems
    """ # noqa: E501
    rentable_item: List[GetLeaseDetailsR1SuccessResponseResponseResultAddOnsRentableItemsRentableItemInner] = Field(alias="rentableItem")
    __properties: ClassVar[List[str]] = ["rentableItem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in rentable_item (list)
        _items = []
        if self.rentable_item:
            for _item in self.rentable_item:
                if _item:
                    _items.append(_item.to_dict())
            _dict['rentableItem'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rentableItem": [GetLeaseDetailsR1SuccessResponseResponseResultAddOnsRentableItemsRentableItemInner.from_dict(_item) for _item in obj["rentableItem"]] if obj.get("rentableItem") is not None else None
        })
        return _obj
