...
class GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the unit amenity", alias="Id")
    is_standard_amenity: Optional[StrictStr] = Field(default=None, description="Indicates if the amenity is standard", alias="IsStandardAmenity")
    is_optional: Optional[StrictStr] = Field(default=None, description="Indicates if the amenity is optional", alias="IsOptional")
    is_published: Optional[StrictStr] = Field(default=None, description="Indicates if the amenity is published", alias="IsPublished")
    is_featured: Optional[StrictStr] = Field(default=None, description="Indicates if the amenity is featured", alias="IsFeatured")
    hide_rates: Optional[StrictStr] = Field(default=None, description="Indicates if the rates are hidden", alias="HideRates")
    show_description: Optional[StrictStr] = Field(default=None, description="Indicates if the description is shown", alias="ShowDescription")
    include_in_rent: Optional[StrictStr] = Field(default=None, description="Indicates if the amenity is included in rent", alias="IncludeInRent")
    __properties: ClassVar[List[str]] = ["Id", "IsStandardAmenity", "IsOptional", "IsPublished", "IsFeatured", "HideRates", "ShowDescription", "IncludeInRent"]
