...
class GetAccessibleClientsSuccessResponseResult(BaseModel):
    """
    The result of the request
    """ # noqa: E501
    orgs: List[GetAccessibleClientsSuccessResponseResultOrgsInner] = Field(description="List of organizations")
    __properties: ClassVar[List[str]] = ["orgs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orgs": [GetAccessibleClientsSuccessResponseResultOrgsInner.from_dict(_item) for _item in obj["orgs"]] if obj.get("orgs") is not None else None
        })
        return _obj
