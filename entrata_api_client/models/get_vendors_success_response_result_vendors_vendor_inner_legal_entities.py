...
class GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntities(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntities
    """ # noqa: E501
    legal_entity: Optional[List[GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner]] = Field(default=None, alias="legalEntity")
    __properties: ClassVar[List[str]] = ["legalEntity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in legal_entity (list)
        _items = []
        if self.legal_entity:
            for _item in self.legal_entity:
                if _item:
                    _items.append(_item.to_dict())
            _dict['legalEntity'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "legalEntity": [GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner.from_dict(_item) for _item in obj["legalEntity"]] if obj.get("legalEntity") is not None else None
        })
        return _obj
