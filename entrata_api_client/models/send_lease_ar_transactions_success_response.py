...
class SendLeaseArTransactionsSuccessResponse(BaseModel):
    """
    SendLeaseArTransactionsSuccessResponse
    """ # noqa: E501
    response: SendLeaseArTransactionsSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SendLeaseArTransactionsSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
