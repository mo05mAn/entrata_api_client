...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner
    """ # noqa: E501
    identification: List[GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerIdentificationInner] = Field(alias="Identification")
    accounting_data: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingData = Field(alias="AccountingData")
    lease_events: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents = Field(alias="LeaseEvents")
    var_property: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerProperty = Field(alias="Property")
    status: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus = Field(alias="Status")
    unit: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit = Field(alias="Unit")
    __properties: ClassVar[List[str]] = ["Identification", "AccountingData", "LeaseEvents", "Property", "Status", "Unit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in identification (list)
        _items = []
        if self.identification:
            for _item in self.identification:
                if _item:
                    _items.append(_item.to_dict())
            _dict['Identification'] = _items
        # override the default output from pydantic by calling `to_dict()` of accounting_data
        if self.accounting_data:
            _dict['AccountingData'] = self.accounting_data.to_dict()
        # override the default output from pydantic by calling `to_dict()` of lease_events
        if self.lease_events:
            _dict['LeaseEvents'] = self.lease_events.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": [GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerIdentificationInner.from_dict(_item) for _item in obj["Identification"]] if obj.get("Identification") is not None else None,
            "AccountingData": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingData.from_dict(obj["AccountingData"]) if obj.get("AccountingData") is not None else None,
            "LeaseEvents": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents.from_dict(obj["LeaseEvents"]) if obj.get("LeaseEvents") is not None else None,
            "Property": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerProperty.from_dict(obj["Property"]) if obj.get("Property") is not None else None,
            "Status": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus.from_dict(obj["Status"]) if obj.get("Status") is not None else None,
            "Unit": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit.from_dict(obj["Unit"]) if obj.get("Unit") is not None else None
        })
        return _obj
