...
class GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner(BaseModel):
    """
    GetJobCategoriesSuccessResponseResultJobCategoriesJobCategoryInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the job category.")
    name: StrictStr = Field(description="The name of the job category.")
    gl_account_id: Optional[StrictStr] = Field(default=None, description="The general ledger (GL) account ID associated with the job category, if applicable.", alias="glAccountId")
    __properties: ClassVar[List[str]] = ["id", "name", "glAccountId"]
