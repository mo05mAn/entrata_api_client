...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSetCharge(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSetCharge
    """ # noqa: E501
    charge_type: StrictStr = Field(description="Type of the charge", alias="ChargeType")
    identification: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSetChargeIdentification = Field(alias="Identification")
    label: StrictStr = Field(description="Label for the charge", alias="Label")
    amount: StrictStr = Field(description="Amount of the charge", alias="Amount")
    __properties: ClassVar[List[str]] = ["ChargeType", "Identification", "Label", "Amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Identification": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSetChargeIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "Label": obj.get("Label"),
