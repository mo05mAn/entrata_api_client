...
class SendJournalEntriesSuccessResponseResultGlHeaders(BaseModel):
    """
    SendJournalEntriesSuccessResponseResultGlHeaders
    """ # noqa: E501
    gl_header: List[SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner] = Field(alias="glHeader")
    __properties: ClassVar[List[str]] = ["glHeader"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_header (list)
        _items = []
        if self.gl_header:
            for _item in self.gl_header:
                if _item:
                    _items.append(_item.to_dict())
            _dict['glHeader'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glHeader": [SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner.from_dict(_item) for _item in obj["glHeader"]] if obj.get("glHeader") is not None else None
        })
        return _obj
