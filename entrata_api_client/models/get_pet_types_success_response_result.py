...
class GetPetTypesSuccessResponseResult(BaseModel):
    """
    Result containing pet types for properties
    """ # noqa: E501
    pet_types: GetPetTypesSuccessResponseResultPetTypes = Field(alias="PetTypes")
    __properties: ClassVar[List[str]] = ["PetTypes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pet_types
        if self.pet_types:
            _dict['PetTypes'] = self.pet_types.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PetTypes": GetPetTypesSuccessResponseResultPetTypes.from_dict(obj["PetTypes"]) if obj.get("PetTypes") is not None else None
        })
        return _obj
