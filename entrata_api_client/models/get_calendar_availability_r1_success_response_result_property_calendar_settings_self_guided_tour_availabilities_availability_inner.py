...
class GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilitiesAvailabilityInner(BaseModel):
    """
    ...
    start_time: StrictStr = Field(description="Start time of the self-guided tour availability", alias="startTime")
    end_time: StrictStr = Field(description="End time of the self-guided tour availability", alias="endTime")
    simultaneous_appointment_limit: StrictStr = Field(description="Limit of simultaneous self-guided tours", alias="simultaneousAppointmentLimit")
