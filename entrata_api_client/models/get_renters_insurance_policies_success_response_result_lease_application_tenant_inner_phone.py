...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerPhone(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerPhone
    """ # noqa: E501
    phone_number: StrictStr = Field(description="Phone number of the tenant", alias="PhoneNumber")
    attributes: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerPhoneAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerPhoneAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
