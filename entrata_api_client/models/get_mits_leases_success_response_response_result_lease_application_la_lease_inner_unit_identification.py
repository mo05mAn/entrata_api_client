...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitIdentification(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitIdentification
    """ # noqa: E501
    id_type: StrictStr = Field(description="Type of the unit ID", alias="IDType")
    id_rank: StrictStr = Field(description="Rank of the unit ID", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Scope type of the unit ID", alias="IDScopeType")
    id_value: StrictStr = Field(description="Value of the unit ID", alias="IDValue")
