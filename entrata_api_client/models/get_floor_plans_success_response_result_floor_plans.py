...
class GetFloorPlansSuccessResponseResultFloorPlans(BaseModel):
    """
    Details about the floor plans
    """ # noqa: E501
    floor_plan: Optional[GetFloorPlansSuccessResponseResultFloorPlansFloorPlan] = Field(default=None, alias="FloorPlan")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of floor_plan
        if self.floor_plan:
            _dict['FloorPlan'] = self.floor_plan.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "FloorPlan": GetFloorPlansSuccessResponseResultFloorPlansFloorPlan.from_dict(obj["FloorPlan"]) if obj.get("FloorPlan") is not None else None
        })
        return _obj
