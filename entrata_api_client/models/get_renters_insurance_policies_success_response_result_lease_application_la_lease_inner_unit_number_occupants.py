...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupants(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupants
    """ # noqa: E501
    value: StrictStr = Field(description="Total number of occupants", alias="@value")
    attributes: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@value": obj.get("@value"),
            "@attributes": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
