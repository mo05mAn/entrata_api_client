...
class GetLeaseDocumentsListSuccessResponseResult(BaseModel):
    """
    GetLeaseDocumentsListSuccessResponseResult
    """ # noqa: E501
    lease_documents: GetLeaseDocumentsListSuccessResponseResultLeaseDocuments = Field(alias="leaseDocuments")
    __properties: ClassVar[List[str]] = ["leaseDocuments"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of lease_documents
        if self.lease_documents:
            _dict['leaseDocuments'] = self.lease_documents.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leaseDocuments": GetLeaseDocumentsListSuccessResponseResultLeaseDocuments.from_dict(obj["leaseDocuments"]) if obj.get("leaseDocuments") is not None else None
        })
        return _obj
