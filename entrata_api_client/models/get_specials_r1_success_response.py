...
class GetSpecialsR1SuccessResponse(BaseModel):
    """
    GetSpecialsR1SuccessResponse
    """ # noqa: E501
    response: GetSpecialsR1SuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetSpecialsR1SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
