...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventIDIdentificationInnerAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    id_type: Optional[StrictStr] = Field(default=None, description="The type of identification.", alias="IDType")
    id_scope_type: Optional[StrictStr] = Field(default=None, description="The scope of the identification.", alias="IDScopeType")
