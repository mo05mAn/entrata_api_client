...
class GetLeadPickListsR2SuccessResponse(BaseModel):
    """
    ...
    code: StrictStr = Field(description="The response code indicating the result.")
    result: GetLeadPickListsR2SuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetLeadPickListsR2SuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
