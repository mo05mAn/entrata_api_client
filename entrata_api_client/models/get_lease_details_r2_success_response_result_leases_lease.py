...
class GetLeaseDetailsR2SuccessResponseResultLeasesLease(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Name of the resident.")
    property_unit_id: StrictStr = Field(description="Unique identifier for the property unit.", alias="propertyUnitId")
    unit_number: StrictStr = Field(description="Unit number of the leased property.", alias="unitNumber")
    add_ons: GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns = Field(alias="addOns")
    scheduled_charges: GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledCharges = Field(alias="scheduledCharges")
    __properties: ClassVar[List[str]] = ["leaseId", "name", "propertyUnitId", "unitNumber", "addOns", "scheduledCharges"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of scheduled_charges
        if self.scheduled_charges:
            _dict['scheduledCharges'] = self.scheduled_charges.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addOns": GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns.from_dict(obj["addOns"]) if obj.get("addOns") is not None else None,
            "scheduledCharges": GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledCharges.from_dict(obj["scheduledCharges"]) if obj.get("scheduledCharges") is not None else None
        })
        return _obj
