...
class GetCallLogsSuccessResponseResultCalls(BaseModel):
    """
    GetCallLogsSuccessResponseResultCalls
    """ # noqa: E501
    call: List[GetCallLogsSuccessResponseResultCallsCallInner]
    __properties: ClassVar[List[str]] = ["call"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "call": [GetCallLogsSuccessResponseResultCallsCallInner.from_dict(_item) for _item in obj["call"]] if obj.get("call") is not None else None
        })
        return _obj
