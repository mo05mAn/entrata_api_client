...
class GetVendorPickListsSuccessResponseResultForm1099Types(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultForm1099Types
    """ # noqa: E501
    form1099_type: Optional[GetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type] = Field(default=None, alias="form1099Type")
    __properties: ClassVar[List[str]] = ["form1099Type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of form1099_type
        if self.form1099_type:
            _dict['form1099Type'] = self.form1099_type.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "form1099Type": GetVendorPickListsSuccessResponseResultForm1099TypesForm1099Type.from_dict(obj["form1099Type"]) if obj.get("form1099Type") is not None else None
        })
        return _obj
