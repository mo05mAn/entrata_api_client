...
class GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInnerAttributes(BaseModel):
    """
    Attributes of each pricing level
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the pricing level")
    name: Optional[StrictStr] = Field(default=None, description="Name of the pricing level")
