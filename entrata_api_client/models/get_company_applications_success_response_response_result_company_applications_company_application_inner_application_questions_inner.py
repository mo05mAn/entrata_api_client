...
class GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInnerApplicationQuestionsInner(BaseModel):
    """
    GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInnerApplicationQuestionsInner
    """ # noqa: E501
    application_question: List[GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInnerApplicationQuestionsInnerApplicationQuestionInner] = Field(alias="applicationQuestion")
    __properties: ClassVar[List[str]] = ["applicationQuestion"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in application_question (list)
        _items = []
        if self.application_question:
            for _item in self.application_question:
                if _item:
                    _items.append(_item.to_dict())
            _dict['applicationQuestion'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicationQuestion": [GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInnerApplicationQuestionsInnerApplicationQuestionInner.from_dict(_item) for _item in obj["applicationQuestion"]] if obj.get("applicationQuestion") is not None else None
        })
        return _obj
