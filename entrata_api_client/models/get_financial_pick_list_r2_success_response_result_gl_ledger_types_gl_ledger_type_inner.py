...
class GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlLedgerTypesGlLedgerTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL ledger type.")
    name: StrictStr = Field(description="The name of the GL ledger type.")
