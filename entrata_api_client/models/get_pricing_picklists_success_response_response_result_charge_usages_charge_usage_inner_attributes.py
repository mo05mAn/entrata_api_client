...
class GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInnerAttributes(BaseModel):
    """
    Attributes of each charge usage
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the charge usage")
    name: Optional[StrictStr] = Field(default=None, description="Name of the charge usage")
