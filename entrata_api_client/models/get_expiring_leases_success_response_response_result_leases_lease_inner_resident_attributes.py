...
class GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes(BaseModel):
    """
    GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAttributes
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the resident.", alias="Id")
