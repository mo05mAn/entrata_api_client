...
class GetLeadPickListsR1SuccessResponseResponseResultLeadStatusesLeadStatusInnerAttributes(BaseModel):
    """
    Attributes related to the lead status.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The unique ID for the lead status.", alias="Id")
    name: Optional[StrictStr] = Field(default=None, description="The name of the lead status.")
    lease_interval_type_name: Optional[StrictStr] = Field(default=None, description="The type of lease interval.", alias="leaseIntervalTypeName")
    __properties: ClassVar[List[str]] = ["Id", "name", "leaseIntervalTypeName"]
