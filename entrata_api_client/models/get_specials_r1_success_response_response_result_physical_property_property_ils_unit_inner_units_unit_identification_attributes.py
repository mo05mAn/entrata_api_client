...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitIdentificationAttributes(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitIdentificationAttributes
    """ # noqa: E501
    id_rank: StrictStr = Field(description="The rank of the unit ID.", alias="IDRank")
    id_scope_type: StrictStr = Field(description="The scope type for the unit ID.", alias="IDScopeType")
    id_type: StrictStr = Field(description="The type of the unit ID.", alias="IDType")
