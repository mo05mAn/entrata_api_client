...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsInner(BaseModel):
    """
    ...
    """ # noqa: E501
    person_details: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsInnerPersonDetails = Field(alias="PersonDetails")
    date_of_birth: StrictStr = Field(description="Tenant's date of birth", alias="DateOfBirth")
    __properties: ClassVar[List[str]] = ["PersonDetails", "DateOfBirth"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of person_details
        if self.person_details:
            _dict['PersonDetails'] = self.person_details.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PersonDetails": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsInnerPersonDetails.from_dict(obj["PersonDetails"]) if obj.get("PersonDetails") is not None else None,
