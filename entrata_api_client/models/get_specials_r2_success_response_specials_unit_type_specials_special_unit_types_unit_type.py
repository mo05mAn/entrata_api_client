...
class GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypesUnitType(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypesUnitType
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the unit type.")
    name: StrictStr = Field(description="The name of the unit type.")
    rates: List[GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypesUnitTypeRatesInner] = Field(description="List of rates associated with the unit type.")
    lease_terms: List[GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner] = Field(description="List of lease terms for the unit type.", alias="leaseTerms")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "rates": [GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypesUnitTypeRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None,
