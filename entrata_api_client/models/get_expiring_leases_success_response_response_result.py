...
class GetExpiringLeasesSuccessResponseResponseResult(BaseModel):
    """
    GetExpiringLeasesSuccessResponseResponseResult
    """ # noqa: E501
    leases: GetExpiringLeasesSuccessResponseResponseResultLeases = Field(alias="Leases")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Leases": GetExpiringLeasesSuccessResponseResponseResultLeases.from_dict(obj["Leases"]) if obj.get("Leases") is not None else None
        })
        return _obj
