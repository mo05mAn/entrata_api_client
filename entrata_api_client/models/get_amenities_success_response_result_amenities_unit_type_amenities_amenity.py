...
class GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenity
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the unit type amenity", alias="Name")
    ...
    units: GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits = Field(alias="Units")
    attributes: GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["Name", "ImageUrl", "Description", "Units", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Units": GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits.from_dict(obj["Units"]) if obj.get("Units") is not None else None,
            "@attributes": GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
