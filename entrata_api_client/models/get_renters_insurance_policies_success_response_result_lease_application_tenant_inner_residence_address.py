...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerResidenceAddress(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerResidenceAddress
    """ # noqa: E501
    address: StrictStr = Field(description="Street address of the tenant", alias="Address")
    city: StrictStr = Field(description="City of the tenant's residence", alias="City")
    state: StrictStr = Field(description="State of the tenant's residence", alias="State")
    postal_code: StrictStr = Field(description="Postal code of the tenant's residence", alias="PostalCode")
    country_name: StrictStr = Field(description="Country of the tenant's residence", alias="CountryName")
    email: Optional[StrictStr] = Field(default=None, description="Email address of the tenant", alias="Email")
    attributes: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerResidenceAddressAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["Address", "City", "State", "PostalCode", "CountryName", "Email", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Email": obj.get("Email"),
            "@attributes": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerResidenceAddressAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
