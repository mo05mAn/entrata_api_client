...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypes(BaseModel):
    """
    Unit types available at the property
    """ # noqa: E501
    unit_type: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner] = Field(alias="unitType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitType": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitTypesUnitTypeInner.from_dict(_item) for _item in obj["unitType"]] if obj.get("unitType") is not None else None
        })
        return _obj
