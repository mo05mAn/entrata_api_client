...
class GetPropertiesSuccessResponseResultPhysicalProperty(BaseModel):
    """
    Physical property details
    """ # noqa: E501
    var_property: List[GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInner] = Field(description="List of properties", alias="Property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": [GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInner.from_dict(_item) for _item in obj["Property"]] if obj.get("Property") is not None else None
        })
        return _obj
