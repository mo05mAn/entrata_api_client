...
class GetVendorsSuccessResponseResultVendors(BaseModel):
    """
    GetVendorsSuccessResponseResultVendors
    """ # noqa: E501
    vendor: Optional[List[GetVendorsSuccessResponseResultVendorsVendorInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vendor": [GetVendorsSuccessResponseResultVendorsVendorInner.from_dict(_item) for _item in obj["vendor"]] if obj.get("vendor") is not None else None
        })
        return _obj
