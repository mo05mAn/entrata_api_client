...
class SendLeaseDocumentsRequestBodyMethodParams(BaseModel):
    """
    ...
    lease_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. This is the conditionally required, if applicationId and applicantId is not provided.", alias="leaseId")
    application_id: Optional[StrictInt] = Field(default=None, description="This is a optional field. This field accepts single value. This is the conditionally required, if leaseId and applicantId is not provided.", alias="applicationId")
    applicant_id: Optional[StrictInt] = Field(default=None, description="This is a optional field. This field accepts single value. This is conditionally required, if leaseId and applicationId is not provided.", alias="applicantId")
    files: SendLeaseDocumentsRequestBodyMethodParamsFiles
    __properties: ClassVar[List[str]] = ["propertyId", "leaseId", "applicationId", "applicantId", "files"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "files": SendLeaseDocumentsRequestBodyMethodParamsFiles.from_dict(obj["files"]) if obj.get("files") is not None else None
        })
        return _obj
