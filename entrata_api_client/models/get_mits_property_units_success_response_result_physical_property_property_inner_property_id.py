...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyID(BaseModel):
    """
    Property ID and details
    """ # noqa: E501
    identification: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDIdentification] = Field(default=None, alias="Identification")
    marketing_name: Optional[StrictStr] = Field(default=None, description="Marketing name of the property", alias="MarketingName")
    legal_name: Optional[StrictStr] = Field(default=None, description="Legal name of the property", alias="LegalName")
    web_site: Optional[StrictStr] = Field(default=None, description="Property website", alias="WebSite")
    address: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDAddress] = Field(default=None, alias="Address")
    phone: Optional[List[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner]] = Field(default=None, description="Phone numbers associated with the property", alias="Phone")
    __properties: ClassVar[List[str]] = ["Identification", "MarketingName", "LegalName", "WebSite", "Address", "Phone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "MarketingName": obj.get("MarketingName"),
            "LegalName": obj.get("LegalName"),
            "WebSite": obj.get("WebSite"),
            "Address": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDAddress.from_dict(obj["Address"]) if obj.get("Address") is not None else None,
            "Phone": [GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner.from_dict(_item) for _item in obj["Phone"]] if obj.get("Phone") is not None else None
        })
        return _obj
