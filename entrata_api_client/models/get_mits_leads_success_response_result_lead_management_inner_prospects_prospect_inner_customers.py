...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomers(BaseModel):
    """
    Customer-related information.
    """ # noqa: E501
    customer: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer] = Field(default=None, alias="Customer")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Customer": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer.from_dict(obj["Customer"]) if obj.get("Customer") is not None else None
        })
        return _obj
