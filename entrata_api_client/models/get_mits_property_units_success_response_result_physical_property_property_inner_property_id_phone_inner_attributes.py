...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInnerAttributes(BaseModel):
    """
    Attributes related to the phone number
    """ # noqa: E501
    phone_type: Optional[StrictStr] = Field(default=None, description="Type of phone", alias="PhoneType")
