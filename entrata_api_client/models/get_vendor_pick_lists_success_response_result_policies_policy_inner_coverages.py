...
class GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoverages(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoverages
    """ # noqa: E501
    coverage: List[GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "coverage": [GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner.from_dict(_item) for _item in obj["coverage"]] if obj.get("coverage") is not None else None
        })
        return _obj
