...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner(BaseModel):
    """
    GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInner
    """ # noqa: E501
    phone_description: Optional[StrictStr] = Field(default=None, description="Description of the phone number", alias="PhoneDescription")
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number", alias="PhoneNumber")
    attributes: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInnerAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["PhoneDescription", "PhoneNumber", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PhoneDescription": obj.get("PhoneDescription"),
            "PhoneNumber": obj.get("PhoneNumber"),
            "@attributes": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDPhoneInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
