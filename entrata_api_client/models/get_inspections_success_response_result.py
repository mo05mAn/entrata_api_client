...
class GetInspectionsSuccessResponseResult(BaseModel):
    """
    GetInspectionsSuccessResponseResult
    """ # noqa: E501
    inspections: GetInspectionsSuccessResponseResultInspections
    __properties: ClassVar[List[str]] = ["inspections"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of inspections
        if self.inspections:
            _dict['inspections'] = self.inspections.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inspections": GetInspectionsSuccessResponseResultInspections.from_dict(obj["inspections"]) if obj.get("inspections") is not None else None
        })
        return _obj
