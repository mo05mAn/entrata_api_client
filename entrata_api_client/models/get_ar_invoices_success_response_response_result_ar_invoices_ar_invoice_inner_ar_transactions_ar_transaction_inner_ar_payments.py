...
class GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactionsArTransactionInnerArPayments(BaseModel):
    """
    GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactionsArTransactionInnerArPayments
    """ # noqa: E501
    ar_payment: List[GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactionsArTransactionInnerArPaymentsArPaymentInner] = Field(alias="arPayment")
    __properties: ClassVar[List[str]] = ["arPayment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ar_payment (list)
        _items = []
        if self.ar_payment:
            for _item in self.ar_payment:
                if _item:
                    _items.append(_item.to_dict())
            _dict['arPayment'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arPayment": [GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactionsArTransactionInnerArPaymentsArPaymentInner.from_dict(_item) for _item in obj["arPayment"]] if obj.get("arPayment") is not None else None
        })
        return _obj
