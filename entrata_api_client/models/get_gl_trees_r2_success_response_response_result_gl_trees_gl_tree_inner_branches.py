...
class GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches(BaseModel):
    """
    Branch details related to the GL Tree
    """ # noqa: E501
    branch: List[GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner] = Field(description="Array of branches associated with the GL Tree")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "branch": [GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranchesBranchInner.from_dict(_item) for _item in obj["branch"]] if obj.get("branch") is not None else None
        })
        return _obj
