...
class GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRates
    """ # noqa: E501
    rate: List[GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRatesRateInner] = Field(alias="Rate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Rate": [GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerRatesRateInner.from_dict(_item) for _item in obj["Rate"]] if obj.get("Rate") is not None else None
        })
        return _obj
