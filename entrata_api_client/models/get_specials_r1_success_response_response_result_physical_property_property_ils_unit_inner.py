...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInner(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInner
    """ # noqa: E501
    units: GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnits = Field(alias="Units")
    concession: List[GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerConcessionInner] = Field(description="List of concessions for the unit.", alias="Concession")
    __properties: ClassVar[List[str]] = ["Units", "Concession"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Units": GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnits.from_dict(obj["Units"]) if obj.get("Units") is not None else None,
            "Concession": [GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerConcessionInner.from_dict(_item) for _item in obj["Concession"]] if obj.get("Concession") is not None else None
        })
        return _obj
