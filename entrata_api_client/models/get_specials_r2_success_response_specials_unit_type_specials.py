...
class GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecials(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecials
    """ # noqa: E501
    special: GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "special": GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecial.from_dict(obj["special"]) if obj.get("special") is not None else None
        })
        return _obj
