...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnit(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnit
    """ # noqa: E501
    attributes: GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitAttributes = Field(alias="@attributes")
    identification: GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitIdentification = Field(alias="Identification")
    marketing_name: StrictStr = Field(description="The marketing name for the unit.", alias="MarketingName")
    __properties: ClassVar[List[str]] = ["@attributes", "Identification", "MarketingName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "Identification": GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
