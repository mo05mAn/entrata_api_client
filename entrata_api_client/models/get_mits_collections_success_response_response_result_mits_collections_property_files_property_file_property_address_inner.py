...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyAddressInner(BaseModel):
    """
    GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyAddressInner
    """ # noqa: E501
    attributes: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyAddressInnerAttributes = Field(alias="@attributes")
    description: StrictStr = Field(description="Address description", alias="Description")
    address: StrictStr = Field(description="Street address", alias="Address")
    ...
    county_name: StrictStr = Field(description="County name", alias="CountyName")
    __properties: ClassVar[List[str]] = ["@attributes", "Description", "Address", "City", "State", "PostalCode", "Country", "CountyName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyAddressInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
