...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty(BaseModel):
    """
    ...
    floorplans: GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplans = Field(alias="Floorplans")
    __properties: ClassVar[List[str]] = ["PropertyId", "MarketingName", "Floorplans"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Floorplans": GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplans.from_dict(obj["Floorplans"]) if obj.get("Floorplans") is not None else None
        })
        return _obj
