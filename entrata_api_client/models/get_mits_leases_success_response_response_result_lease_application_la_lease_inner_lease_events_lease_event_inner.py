...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEventsLeaseEventInner(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEventsLeaseEventInner
    """ # noqa: E501
    var_date: StrictStr = Field(description="Date of the lease event", alias="Date")
    event_type: StrictStr = Field(description="Type of the lease event", alias="EventType")
    move_out_reason: Optional[StrictStr] = Field(default=None, description="Reason for the move-out", alias="MoveOutReason")
    __properties: ClassVar[List[str]] = ["Date", "EventType", "MoveOutReason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MoveOutReason": obj.get("MoveOutReason")
        })
        return _obj
