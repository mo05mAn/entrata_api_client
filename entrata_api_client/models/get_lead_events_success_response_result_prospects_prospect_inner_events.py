...
class GetLeadEventsSuccessResponseResultProspectsProspectInnerEvents(BaseModel):
    """
    Events associated with the prospect.
    """ # noqa: E501
    event: Optional[List[GetLeadEventsSuccessResponseResultProspectsProspectInnerEventsEventInner]] = Field(default=None, description="A list of events related to the prospect.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event": [GetLeadEventsSuccessResponseResultProspectsProspectInnerEventsEventInner.from_dict(_item) for _item in obj["event"]] if obj.get("event") is not None else None
        })
        return _obj
