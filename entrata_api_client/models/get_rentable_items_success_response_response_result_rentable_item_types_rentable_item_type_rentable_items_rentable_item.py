...
class GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItem(BaseModel):
    """
    GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItem
    """ # noqa: E501
    id: StrictInt = Field(description="ID of the rentable item", alias="Id")
    name: StrictStr = Field(description="Name of the rentable item", alias="Name")
    reservation_start_date: StrictStr = Field(description="Start date for reservations", alias="ReservationStartDate")
    reservation_end_date: StrictStr = Field(description="End date for reservations", alias="ReservationEndDate")
    hold_until: StrictStr = Field(description="Hold until date for the item", alias="HoldUntil")
    rents: GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItemRents = Field(alias="Rents")
    deposits: GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItemDeposits = Field(alias="Deposits")
    description: StrictStr = Field(description="Description of the rentable item", alias="Description")
    __properties: ClassVar[List[str]] = ["Id", "Name", "ReservationStartDate", "ReservationEndDate", "HoldUntil", "Rents", "Deposits", "Description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "HoldUntil": obj.get("HoldUntil"),
            "Rents": GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItemRents.from_dict(obj["Rents"]) if obj.get("Rents") is not None else None,
            "Deposits": GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItemDeposits.from_dict(obj["Deposits"]) if obj.get("Deposits") is not None else None,
