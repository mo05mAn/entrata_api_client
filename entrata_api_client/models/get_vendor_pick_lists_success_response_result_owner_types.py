...
class GetVendorPickListsSuccessResponseResultOwnerTypes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultOwnerTypes
    """ # noqa: E501
    owner_type: Optional[List[GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInner]] = Field(default=None, alias="ownerType")
    __properties: ClassVar[List[str]] = ["ownerType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in owner_type (list)
        _items = []
        if self.owner_type:
            for _item in self.owner_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['ownerType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ownerType": [GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInner.from_dict(_item) for _item in obj["ownerType"]] if obj.get("ownerType") is not None else None
        })
        return _obj
