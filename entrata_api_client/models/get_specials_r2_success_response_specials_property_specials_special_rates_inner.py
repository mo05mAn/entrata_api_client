...
class GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialRatesInner(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialRatesInner
    """ # noqa: E501
    charge_code_id: StrictStr = Field(description="The charge code ID for the rate.", alias="chargeCodeId")
    charge_code_type_id: StrictStr = Field(description="The charge code type ID.", alias="chargeCodeTypeId")
    amount: StrictStr = Field(description="The amount for the rate.")
    show_on_website: Optional[StrictBool] = Field(default=None, description="Indicates whether the rate should be shown on the website.", alias="showOnWebsite")
    lease_term_id: Optional[StrictStr] = Field(default=None, description="The ID of the lease term associated with the rate.", alias="leaseTermId")
    __properties: ClassVar[List[str]] = ["chargeCodeId", "chargeCodeTypeId", "amount", "showOnWebsite", "leaseTermId"]
