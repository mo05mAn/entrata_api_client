...
class GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the status type", alias="Id")
    name: StrictStr = Field(description="Name of the status type", alias="Name")
    code: StrictStr = Field(description="Code of the status type", alias="Code")
