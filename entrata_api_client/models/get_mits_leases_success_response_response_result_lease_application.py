...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplication(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplication
    """ # noqa: E501
    tenant: List[GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInner] = Field(alias="Tenant")
    la_lease: List[GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner] = Field(alias="LA_Lease")
    __properties: ClassVar[List[str]] = ["Tenant", "LA_Lease"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Tenant": [GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInner.from_dict(_item) for _item in obj["Tenant"]] if obj.get("Tenant") is not None else None,
            "LA_Lease": [GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInner.from_dict(_item) for _item in obj["LA_Lease"]] if obj.get("LA_Lease") is not None else None
        })
        return _obj
