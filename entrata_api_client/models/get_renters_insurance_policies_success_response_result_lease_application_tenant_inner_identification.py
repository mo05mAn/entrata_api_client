...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerIdentification(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerIdentification
    """ # noqa: E501
    id_value: StrictStr = Field(description="Unique identifier for the tenant", alias="IDValue")
    attributes: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerIdentificationAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerIdentificationAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
