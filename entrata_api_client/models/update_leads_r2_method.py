...
class UpdateLeadsR2Method(BaseModel):
    """
    UpdateLeadsR2Method
    """ # noqa: E501
    name: StrictStr
    version: Optional[StrictStr] = None
    params: Optional[UpdateLeadsR2MethodParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": UpdateLeadsR2MethodParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
