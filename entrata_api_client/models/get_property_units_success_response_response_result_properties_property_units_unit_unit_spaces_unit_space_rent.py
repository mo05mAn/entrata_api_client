...
class GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpaceRent(BaseModel):
    """
    GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpaceRent
    """ # noqa: E501
    min_rent: StrictInt = Field(description="Minimum rent for the unit space", alias="minRent")
    max_rent: StrictInt = Field(description="Maximum rent for the unit space", alias="maxRent")
    term_rent: GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpaceRentTermRent = Field(alias="termRent")
    __properties: ClassVar[List[str]] = ["minRent", "maxRent", "termRent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of term_rent
        if self.term_rent:
            _dict['termRent'] = self.term_rent.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minRent": obj.get("minRent"),
            "maxRent": obj.get("maxRent"),
            "termRent": GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpaceRentTermRent.from_dict(obj["termRent"]) if obj.get("termRent") is not None else None
        })
        return _obj
