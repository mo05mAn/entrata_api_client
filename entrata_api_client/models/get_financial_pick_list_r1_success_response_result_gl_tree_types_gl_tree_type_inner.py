...
class GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL tree type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL tree type.", alias="Name")
