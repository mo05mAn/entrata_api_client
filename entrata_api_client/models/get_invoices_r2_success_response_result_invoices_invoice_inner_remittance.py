...
class GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance(BaseModel):
    """
    GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerRemittance
    """ # noqa: E501
    id: StrictStr = Field(description="Remittance identifier")
    name: StrictStr = Field(description="Name of the remittance")
    ap_payment_type_id: StrictStr = Field(description="Payment type ID", alias="apPaymentTypeId")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "apPaymentTypeId", "apPaymentType", "streetLine1", "streetLine2", "city", "stateCode", "postalCode"]
