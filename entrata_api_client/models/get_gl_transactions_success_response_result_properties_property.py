...
class GetGlTransactionsSuccessResponseResultPropertiesProperty(BaseModel):
    """
    GetGlTransactionsSuccessResponseResultPropertiesProperty
    """ # noqa: E501
    is_cash_book: StrictStr = Field(description="Indicates whether the property is a cash book.", alias="isCashBook")
    transactions: GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions
    attributes: GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["isCashBook", "transactions", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions.from_dict(obj["transactions"]) if obj.get("transactions") is not None else None,
            "@attributes": GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
