...
class GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInnerApplicationsApplicationInner(BaseModel):
    """
    GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInnerApplicationsApplicationInner
    """ # noqa: E501
    lease_term: StrictStr = Field(description="Term of the lease", alias="leaseTerm")
    lease_start_date: StrictStr = Field(description="Start date of the lease", alias="leaseStartDate")
    lease_end_date: StrictStr = Field(description="End date of the lease", alias="leaseEndDate")
    application_approved_on: Optional[StrictStr] = Field(default=None, description="Date when the application was approved", alias="applicationApprovedOn")
    __properties: ClassVar[List[str]] = ["leaseTerm", "leaseStartDate", "leaseEndDate", "applicationApprovedOn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "applicationApprovedOn": obj.get("applicationApprovedOn")
        })
        return _obj
