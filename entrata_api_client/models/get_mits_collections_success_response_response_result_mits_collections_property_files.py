...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFiles(BaseModel):
    """
    GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFiles
    """ # noqa: E501
    property_file: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFile = Field(alias="PropertyFile")
    __properties: ClassVar[List[str]] = ["PropertyFile"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of property_file
        if self.property_file:
            _dict['PropertyFile'] = self.property_file.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PropertyFile": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFile.from_dict(obj["PropertyFile"]) if obj.get("PropertyFile") is not None else None
        })
        return _obj
