...
class GetLeadPickListsR1SuccessResponseResponseResultProperty18462Attributes(BaseModel):
    """
    Attributes related to the property.
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The unique ID for the property.", alias="Id")
