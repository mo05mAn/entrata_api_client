...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFiles(BaseModel):
    """
    GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFiles
    """ # noqa: E501
    lease_file: List[GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInner] = Field(alias="leaseFile")
    __properties: ClassVar[List[str]] = ["leaseFile"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lease_file (list)
        _items = []
        if self.lease_file:
            for _item in self.lease_file:
                if _item:
                    _items.append(_item.to_dict())
            _dict['leaseFile'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leaseFile": [GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInner.from_dict(_item) for _item in obj["leaseFile"]] if obj.get("leaseFile") is not None else None
        })
        return _obj
