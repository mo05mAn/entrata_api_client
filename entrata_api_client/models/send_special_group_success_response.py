...
class SendSpecialGroupSuccessResponse(BaseModel):
    """
    SendSpecialGroupSuccessResponse
    """ # noqa: E501
    response: SendSpecialGroupSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SendSpecialGroupSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
