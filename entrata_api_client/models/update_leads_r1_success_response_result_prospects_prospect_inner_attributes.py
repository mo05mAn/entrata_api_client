...
class UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes(BaseModel):
    """
    ...
    reference_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the reference.")
    ...
    __properties: ClassVar[List[str]] = ["node", "reference_id", "applicant_id", "status", "message"]
