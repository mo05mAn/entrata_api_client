...
class GetMitsLeadsSuccessResponseResultLeadManagementInner(BaseModel):
    """
    GetMitsLeadsSuccessResponseResultLeadManagementInner
    """ # noqa: E501
    prospects: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspects] = Field(default=None, alias="Prospects")
    __properties: ClassVar[List[str]] = ["Prospects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Prospects": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspects.from_dict(obj["Prospects"]) if obj.get("Prospects") is not None else None
        })
        return _obj
