...
class UpdateLeadsR1SuccessResponseResultProspectsProspectInner(BaseModel):
    """
    UpdateLeadsR1SuccessResponseResultProspectsProspectInner
    """ # noqa: E501
    attributes: Optional[UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": UpdateLeadsR1SuccessResponseResultProspectsProspectInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
