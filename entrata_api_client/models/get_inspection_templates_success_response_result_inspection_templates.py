...
class GetInspectionTemplatesSuccessResponseResultInspectionTemplates(BaseModel):
    """
    GetInspectionTemplatesSuccessResponseResultInspectionTemplates
    """ # noqa: E501
    inspection_template: List[GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInner] = Field(alias="inspectionTemplate")
    __properties: ClassVar[List[str]] = ["inspectionTemplate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in inspection_template (list)
        _items = []
        if self.inspection_template:
            for _item in self.inspection_template:
                if _item:
                    _items.append(_item.to_dict())
            _dict['inspectionTemplate'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inspectionTemplate": [GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInner.from_dict(_item) for _item in obj["inspectionTemplate"]] if obj.get("inspectionTemplate") is not None else None
        })
        return _obj
