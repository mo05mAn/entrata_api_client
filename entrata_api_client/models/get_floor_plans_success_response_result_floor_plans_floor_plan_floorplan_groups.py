...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFloorplanGroups(BaseModel):
    """
    Groups associated with the floor plan
    """ # noqa: E501
    floorplan_group: Optional[GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFloorplanGroupsFloorplanGroup] = Field(default=None, alias="FloorplanGroup")
    __properties: ClassVar[List[str]] = ["FloorplanGroup"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of floorplan_group
        if self.floorplan_group:
            _dict['FloorplanGroup'] = self.floorplan_group.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "FloorplanGroup": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFloorplanGroupsFloorplanGroup.from_dict(obj["FloorplanGroup"]) if obj.get("FloorplanGroup") is not None else None
        })
        return _obj
