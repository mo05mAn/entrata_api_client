...
class GetUnitTypesSuccessResponseResponseResultUnitTypes(BaseModel):
    """
    GetUnitTypesSuccessResponseResponseResultUnitTypes
    """ # noqa: E501
    unit_type: List[GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInner] = Field(description="List of unit types available in the property", alias="unitType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitType": [GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInner.from_dict(_item) for _item in obj["unitType"]] if obj.get("unitType") is not None else None
        })
        return _obj
