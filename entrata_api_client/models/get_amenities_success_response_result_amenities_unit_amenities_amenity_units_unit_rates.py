...
class GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates
    """ # noqa: E501
    rate: GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRatesRate = Field(alias="Rate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Rate": GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRatesRate.from_dict(obj["Rate"]) if obj.get("Rate") is not None else None
        })
        return _obj
