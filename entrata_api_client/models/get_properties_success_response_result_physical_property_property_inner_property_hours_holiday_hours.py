...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHours(BaseModel):
    """
    Holiday hours
    """ # noqa: E501
    holiday_hour: Optional[GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour] = Field(default=None, alias="HolidayHour")
    __properties: ClassVar[List[str]] = ["HolidayHour"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of holiday_hour
        if self.holiday_hour:
            _dict['HolidayHour'] = self.holiday_hour.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "HolidayHour": GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour.from_dict(obj["HolidayHour"]) if obj.get("HolidayHour") is not None else None
        })
        return _obj
