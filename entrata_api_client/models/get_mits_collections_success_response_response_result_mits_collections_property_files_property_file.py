...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFile(BaseModel):
    """
    GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFile
    """ # noqa: E501
    var_property: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileProperty = Field(alias="Property")
    property_client: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyClient = Field(alias="PropertyClient")
    lease_files: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFiles = Field(alias="LeaseFiles")
    __properties: ClassVar[List[str]] = ["Property", "PropertyClient", "LeaseFiles"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of property_client
        if self.property_client:
            _dict['PropertyClient'] = self.property_client.to_dict()
        # override the default output from pydantic by calling `to_dict()` of lease_files
        if self.lease_files:
            _dict['LeaseFiles'] = self.lease_files.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileProperty.from_dict(obj["Property"]) if obj.get("Property") is not None else None,
            "PropertyClient": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyClient.from_dict(obj["PropertyClient"]) if obj.get("PropertyClient") is not None else None,
            "LeaseFiles": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFiles.from_dict(obj["LeaseFiles"]) if obj.get("LeaseFiles") is not None else None
        })
        return _obj
