...
class GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeDepositsDeposit(BaseModel):
    """
    GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeDepositsDeposit
    """ # noqa: E501
    type: StrictStr = Field(description="Type of deposit charge", alias="Type")
    charge_code: StrictStr = Field(description="Charge code for deposit", alias="ChargeCode")
    amount: StrictStr = Field(description="Amount of the deposit charge", alias="Amount")
    __properties: ClassVar[List[str]] = ["Type", "ChargeCode", "Amount"]
