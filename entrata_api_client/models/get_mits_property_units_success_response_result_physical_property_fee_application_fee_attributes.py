...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyFeeApplicationFeeAttributes(BaseModel):
    """
    Attributes related to the fee
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of applicant", alias="Type")
    amount: Optional[StrictStr] = Field(default=None, description="Fee amount", alias="Amount")
