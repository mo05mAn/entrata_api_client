...
class GetUnitsAvailabilityAndPricingSuccessResponseResultProperties(BaseModel):
    """
    Information about the property
    """ # noqa: E501
    var_property: GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty = Field(alias="Property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesProperty.from_dict(obj["Property"]) if obj.get("Property") is not None else None
        })
        return _obj
