...
class GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnits
    """ # noqa: E501
    unit: GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnit = Field(alias="Unit")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Unit": GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnit.from_dict(obj["Unit"]) if obj.get("Unit") is not None else None
        })
        return _obj
