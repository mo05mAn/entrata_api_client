...
class SendApplicationPetsSuccessResponseResponseResultPetsPetInner(BaseModel):
    """
    SendApplicationPetsSuccessResponseResponseResultPetsPetInner
    """ # noqa: E501
    status: StrictStr = Field(description="Success")
    message: StrictStr = Field(description="Customer pets saved successfully.")
    id: StrictInt = Field(description="Pet ID.")
    customer_id: StrictInt = Field(description="Customer ID.", alias="customerId")
    type_id: StrictInt = Field(description="Type ID.", alias="typeId")
    node: StrictInt = Field(description="Node number.")
    __properties: ClassVar[List[str]] = ["status", "message", "id", "customerId", "typeId", "node"]
