...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagement(BaseModel):
    """
    Property management information
    """ # noqa: E501
    identification: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification] = Field(default=None, alias="Identification")
    property_contacts: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementPropertyContacts] = Field(default=None, alias="PropertyContacts")
    __properties: ClassVar[List[str]] = ["Identification", "PropertyContacts"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of property_contacts
        if self.property_contacts:
            _dict['PropertyContacts'] = self.property_contacts.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "PropertyContacts": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementPropertyContacts.from_dict(obj["PropertyContacts"]) if obj.get("PropertyContacts") is not None else None
        })
        return _obj
