...
class GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrdersChildWorkOrderInner(BaseModel):
    """
    GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrdersChildWorkOrderInner
    """ # noqa: E501
    maintenance_request_id: StrictStr = Field(description="ID of the child maintenance request", alias="maintenanceRequestId")
    maintenance_status: StrictStr = Field(description="Status of the child maintenance request", alias="maintenanceStatus")
    maintenance_priority: StrictStr = Field(description="Priority level of the child work order", alias="maintenancePriority")
    maintenance_problem: StrictStr = Field(description="Problem related to the maintenance", alias="maintenanceProblem")
    maintenance_location: Optional[StrictStr] = Field(default=None, description="Location of the maintenance", alias="maintenanceLocation")
    completed_on: Optional[StrictStr] = Field(default=None, description="Completion date of the child work order", alias="completedOn")
    entry_notes: Optional[StrictStr] = Field(default=None, description="Entry notes for the child work order", alias="entryNotes")
    __properties: ClassVar[List[str]] = ["maintenanceRequestId", "maintenanceStatus", "maintenancePriority", "maintenanceProblem", "maintenanceLocation", "completedOn", "entryNotes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maintenanceLocation": obj.get("maintenanceLocation"),
