...
class SendAmenitiesMethodParams(BaseModel):
    """
    SendAmenitiesMethodParams
    """ # noqa: E501
    property_id: StrictInt = Field(description="This is a required field. This field accepts single value. This field accepts a single integer value for Property ID", alias="propertyId")
    name: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts single value. This accepts name of the amenity")
    description: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts single value. This accepts description of the amenity.")
    is_published: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. This flag accepts 1 or 0 ,whether amenity needs to be published or not .", alias="isPublished")
    unit_space_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. This accepts unit space id for the amenity.", alias="unitSpaceId")
    __properties: ClassVar[List[str]] = ["propertyId", "name", "description", "isPublished", "unitSpaceId"]
    ...
    @field_validator('unit_space_id')
    def unit_space_id_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
