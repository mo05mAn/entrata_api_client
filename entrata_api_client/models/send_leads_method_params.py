...
class SendLeadsMethodParams(BaseModel):
    """
    SendLeadsMethodParams
    """ # noqa: E501
    property_id: StrictInt = Field(description="This is a required field. This field accepts single value. This is a required field. This field accepts a single integer value fo r Property ID.", alias="propertyId")
    subtype_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. This node supports following subtypeId values, under event type \"Appointment\":- 453:\"Leasing Appointments\", 560:\"Self-Guided Tour\", 454:\" Tour\", 525:\"Virtual Tour\"", alias="subtypeId")
    __properties: ClassVar[List[str]] = ["propertyId", "subtypeId"]
