...
class GetPoReceivingRecordsSuccessResponseResult(BaseModel):
    """
    GetPoReceivingRecordsSuccessResponseResult
    """ # noqa: E501
    purchase_orders: Optional[GetPoReceivingRecordsSuccessResponseResultPurchaseOrders] = Field(default=None, alias="purchaseOrders")
    __properties: ClassVar[List[str]] = ["purchaseOrders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "purchaseOrders": GetPoReceivingRecordsSuccessResponseResultPurchaseOrders.from_dict(obj["purchaseOrders"]) if obj.get("purchaseOrders") is not None else None
        })
        return _obj
