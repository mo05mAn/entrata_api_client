...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutTypes(BaseModel):
    """
    Types of move-out scenarios
    """ # noqa: E501
    move_out_type: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutTypesMoveOutTypeInner] = Field(alias="moveOutType")
    __properties: ClassVar[List[str]] = ["moveOutType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in move_out_type (list)
        _items = []
        if self.move_out_type:
            for _item in self.move_out_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['moveOutType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "moveOutType": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutTypesMoveOutTypeInner.from_dict(_item) for _item in obj["moveOutType"]] if obj.get("moveOutType") is not None else None
        })
        return _obj
