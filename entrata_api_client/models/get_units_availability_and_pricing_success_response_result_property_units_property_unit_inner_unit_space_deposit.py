...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInnerUnitSpaceDeposit(BaseModel):
    """
    Deposit details for the unit
    """ # noqa: E501
    min_deposit: Optional[StrictStr] = Field(default=None, description="Minimum deposit for the unit", alias="MinDeposit")
    max_deposit: Optional[StrictStr] = Field(default=None, description="Maximum deposit for the unit", alias="MaxDeposit")
    __properties: ClassVar[List[str]] = ["MinDeposit", "MaxDeposit"]
