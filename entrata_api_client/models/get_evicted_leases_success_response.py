...
class GetEvictedLeasesSuccessResponse(BaseModel):
    """
    GetEvictedLeasesSuccessResponse
    """ # noqa: E501
    response: GetEvictedLeasesSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetEvictedLeasesSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
