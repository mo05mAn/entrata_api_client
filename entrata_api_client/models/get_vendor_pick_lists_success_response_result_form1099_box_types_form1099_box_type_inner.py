...
class GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInner(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInner
    """ # noqa: E501
    attributes: GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
