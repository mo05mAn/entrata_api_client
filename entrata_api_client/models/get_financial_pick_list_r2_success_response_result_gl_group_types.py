...
class GetFinancialPickListR2SuccessResponseResultGlGroupTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlGroupTypes
    """ # noqa: E501
    gl_group_type: List[GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner] = Field(description="A list of GL group types.", alias="glGroupType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glGroupType": [GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner.from_dict(_item) for _item in obj["glGroupType"]] if obj.get("glGroupType") is not None else None
        })
        return _obj
