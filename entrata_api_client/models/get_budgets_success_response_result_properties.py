...
class GetBudgetsSuccessResponseResultProperties(BaseModel):
    """
    GetBudgetsSuccessResponseResultProperties
    """ # noqa: E501
    var_property: List[GetBudgetsSuccessResponseResultPropertiesPropertyInner] = Field(description="A list of properties with associated budget data.", alias="property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property": [GetBudgetsSuccessResponseResultPropertiesPropertyInner.from_dict(_item) for _item in obj["property"]] if obj.get("property") is not None else None
        })
        return _obj
