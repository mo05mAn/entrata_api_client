...
class GetFinancialPickListR2SuccessResponseResultGlTransactionTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlTransactionTypes
    """ # noqa: E501
    gl_transaction_type: List[GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner] = Field(description="A list of GL transaction types.", alias="glTransactionType")
    __properties: ClassVar[List[str]] = ["glTransactionType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_transaction_type (list)
        _items = []
        if self.gl_transaction_type:
            for _item in self.gl_transaction_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['glTransactionType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glTransactionType": [GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner.from_dict(_item) for _item in obj["glTransactionType"]] if obj.get("glTransactionType") is not None else None
        })
        return _obj
