...
class GetLeasePickListSuccessResponseResultChargeTimings(BaseModel):
    """
    GetLeasePickListSuccessResponseResultChargeTimings
    """ # noqa: E501
    charge_timing: List[GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner] = Field(alias="chargeTiming")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeTiming": [GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner.from_dict(_item) for _item in obj["chargeTiming"]] if obj.get("chargeTiming") is not None else None
        })
        return _obj
