...
class GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner(BaseModel):
    """
    GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the call result")
    name: StrictStr = Field(description="Name of the call result")
