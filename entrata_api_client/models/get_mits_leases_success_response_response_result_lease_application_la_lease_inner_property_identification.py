...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyIdentification(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyIdentification
    """ # noqa: E501
    id_type: StrictStr = Field(description="Type of the property ID", alias="IDType")
    id_rank: StrictStr = Field(description="Rank of the property ID", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Scope type of the property ID", alias="IDScopeType")
    id_value: StrictStr = Field(description="Value of the property ID", alias="IDValue")
