...
class SendLeaseArTransactionReversalsSuccessResponseResponseResult(BaseModel):
    """
    SendLeaseArTransactionReversalsSuccessResponseResponseResult
    """ # noqa: E501
    transactions: SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions = Field(alias="Transactions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Transactions": SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions.from_dict(obj["Transactions"]) if obj.get("Transactions") is not None else None
        })
        return _obj
