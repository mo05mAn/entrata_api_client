...
class UpdateLeadsR2SuccessResponse(BaseModel):
    """
    UpdateLeadsR2SuccessResponse
    """ # noqa: E501
    request_id: StrictStr = Field(description="A unique identifier for the request.", alias="requestId")
    code: StrictStr = Field(description="The response status code.")
    result: UpdateLeadsR2SuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": UpdateLeadsR2SuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
