...
class GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypes
    """ # noqa: E501
    gl_header_status_type: List[GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner] = Field(description="A list of GL header status types.", alias="glHeaderStatusType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glHeaderStatusType": [GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner.from_dict(_item) for _item in obj["glHeaderStatusType"]] if obj.get("glHeaderStatusType") is not None else None
        })
        return _obj
