...
class UpdateInvoicesSuccessResponseResultApHeadersApHeaderInner(BaseModel):
    """
    UpdateInvoicesSuccessResponseResultApHeadersApHeaderInner
    """ # noqa: E501
    reference_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the invoice update request.")
    status: Optional[StrictStr] = Field(default=None, description="Status of the invoice update.")
    message: Optional[StrictStr] = Field(default=None, description="Message indicating the result of the invoice update.")
    __properties: ClassVar[List[str]] = ["reference_id", "status", "message"]
