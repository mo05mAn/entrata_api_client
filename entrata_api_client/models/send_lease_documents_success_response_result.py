...
class SendLeaseDocumentsSuccessResponseResult(BaseModel):
    """
    SendLeaseDocumentsSuccessResponseResult
    """ # noqa: E501
    files: SendLeaseDocumentsSuccessResponseResultFiles
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "files": SendLeaseDocumentsSuccessResponseResultFiles.from_dict(obj["files"]) if obj.get("files") is not None else None
        })
        return _obj
