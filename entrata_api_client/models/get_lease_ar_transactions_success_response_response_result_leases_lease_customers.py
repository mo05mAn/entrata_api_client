...
class GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomers(BaseModel):
    """
    GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomers
    """ # noqa: E501
    customer: GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer
    ledgers: GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgers
    __properties: ClassVar[List[str]] = ["customer", "ledgers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ledgers
        if self.ledgers:
            _dict['ledgers'] = self.ledgers.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer": GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "ledgers": GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgers.from_dict(obj["ledgers"]) if obj.get("ledgers") is not None else None
        })
        return _obj
