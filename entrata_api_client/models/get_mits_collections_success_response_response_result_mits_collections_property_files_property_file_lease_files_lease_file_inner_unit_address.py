...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerUnitAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["@attributes", "State", "Country"]
