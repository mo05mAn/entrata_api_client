...
class GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypes
    """ # noqa: E501
    gl_header_status_type: List[GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner] = Field(description="A list of GL header status types.", alias="GlHeaderStatusType")
    __properties: ClassVar[List[str]] = ["GlHeaderStatusType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_header_status_type (list)
        _items = []
        if self.gl_header_status_type:
            for _item in self.gl_header_status_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['GlHeaderStatusType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlHeaderStatusType": [GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner.from_dict(_item) for _item in obj["GlHeaderStatusType"]] if obj.get("GlHeaderStatusType") is not None else None
        })
        return _obj
