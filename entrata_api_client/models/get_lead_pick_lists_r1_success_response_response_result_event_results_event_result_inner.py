...
class GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=None, description="The unique ID of the event result.", alias="Id")
