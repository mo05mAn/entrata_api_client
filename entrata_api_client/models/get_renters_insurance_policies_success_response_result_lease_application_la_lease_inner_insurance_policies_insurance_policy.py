...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerInsurancePoliciesInsurancePolicy(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerInsurancePoliciesInsurancePolicy
    """ # noqa: E501
    id: StrictStr = Field(description="Insurance policy ID")
    name: StrictStr = Field(description="Insurance policy name")
    unit_number: StrictStr = Field(description="Unit number", alias="unitNumber")
    lease_id: StrictStr = Field(description="Lease ID associated with the insurance policy", alias="leaseId")
    customer_id: StrictStr = Field(description="Customer ID associated with the insurance policy", alias="customerId")
    policy_number: StrictStr = Field(description="Insurance policy number", alias="policyNumber")
    start_date: StrictStr = Field(description="Start date of the insurance policy", alias="startDate")
    liability: StrictStr = Field(description="Liability coverage amount")
    deductible: StrictStr = Field(description="Insurance policy deductible")
    personal_contents: StrictStr = Field(description="Personal contents coverage", alias="personalContents")
    policy_type_id: StrictInt = Field(description="ID for the type of insurance policy", alias="policyTypeId")
    policy_type_name: StrictStr = Field(description="Name of the insurance policy type", alias="policyTypeName")
    __properties: ClassVar[List[str]] = ["id", "name", "unitNumber", "leaseId", "customerId", "policyNumber", "startDate", "liability", "deductible", "personalContents", "policyTypeId", "policyTypeName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policyTypeId": obj.get("policyTypeId"),
            "policyTypeName": obj.get("policyTypeName")
        })
        return _obj
