...
class GetSpecialsR1SuccessResponseResponse(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponse
    """ # noqa: E501
    request_id: StrictInt = Field(description="The unique ID for the request.", alias="requestId")
    result: GetSpecialsR1SuccessResponseResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": GetSpecialsR1SuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
