...
class GetBudgetActualsMethodParams(BaseModel):
    """
    ...
    gl_tree_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="glTreeId")
    budget_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="budgetId")
    post_month_from: StrictStr = Field(description="This is a required field. This field accepts single value. MM/YYYY", alias="postMonthFrom")
    post_month_to: StrictStr = Field(description="This is a required field. This field accepts single value. MM/YYYY", alias="postMonthTo")
    gl_book_type_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. glBookTypeIds", alias="glBookTypeIds")
    budget_status_type_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. budgetStatusTypeId", alias="budgetStatusTypeId")
    accounting_method: Optional[StrictStr] = Field(default=None, description="This is a required field. This field accepts single value. accountingMethod", alias="accountingMethod")
    __properties: ClassVar[List[str]] = ["propertyId", "glTreeId", "budgetId", "postMonthFrom", "postMonthTo", "glBookTypeIds", "budgetStatusTypeId", "accountingMethod"]
