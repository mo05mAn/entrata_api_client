...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollections(BaseModel):
    """
    GetMitsCollectionsSuccessResponseResponseResultMITSCollections
    """ # noqa: E501
    summary: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsSummary = Field(alias="Summary")
    property_files: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFiles = Field(alias="PropertyFiles")
    __properties: ClassVar[List[str]] = ["Summary", "PropertyFiles"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of property_files
        if self.property_files:
            _dict['PropertyFiles'] = self.property_files.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Summary": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsSummary.from_dict(obj["Summary"]) if obj.get("Summary") is not None else None,
            "PropertyFiles": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFiles.from_dict(obj["PropertyFiles"]) if obj.get("PropertyFiles") is not None else None
        })
        return _obj
