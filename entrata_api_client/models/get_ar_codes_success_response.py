...
class GetArCodesSuccessResponse(BaseModel):
    """
    GetArCodesSuccessResponse
    """ # noqa: E501
    response: GetArCodesSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetArCodesSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
