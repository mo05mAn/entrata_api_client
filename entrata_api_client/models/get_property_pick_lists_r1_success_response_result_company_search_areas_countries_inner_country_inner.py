...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInner(BaseModel):
    """
    GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInner
    """ # noqa: E501
    states: GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStates
    var_property: Optional[List[GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInner]] = Field(default=None, description="List of properties", alias="Property")
    __properties: ClassVar[List[str]] = ["states", "Property"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "states": GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStates.from_dict(obj["states"]) if obj.get("states") is not None else None,
            "Property": [GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInner.from_dict(_item) for _item in obj["Property"]] if obj.get("Property") is not None else None
        })
        return _obj
