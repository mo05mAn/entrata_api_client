...
class GetVendorPickListsSuccessResponseResultPoliciesPolicyInner(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultPoliciesPolicyInner
    """ # noqa: E501
    policy_type_id: StrictStr = Field(description="ID for the policy type.", alias="policyTypeId")
    policy_type_name: StrictStr = Field(description="Name of the policy type.", alias="policyTypeName")
    coverages: GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoverages
    __properties: ClassVar[List[str]] = ["policyTypeId", "policyTypeName", "coverages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "coverages": GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoverages.from_dict(obj["coverages"]) if obj.get("coverages") is not None else None
        })
        return _obj
