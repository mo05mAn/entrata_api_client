...
class GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyTypeCoveragesCoverageAttributes(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypesPolicyTypeCoveragesCoverageAttributes
    """ # noqa: E501
    item: StrictStr = Field(description="Coverage item.", alias="Item")
    amount: StrictStr = Field(description="Coverage amount.", alias="Amount")
    __properties: ClassVar[List[str]] = ["Item", "Amount"]
