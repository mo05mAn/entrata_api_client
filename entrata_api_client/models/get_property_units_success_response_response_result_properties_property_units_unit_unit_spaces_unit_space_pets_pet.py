...
class GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpacePetsPet(BaseModel):
    """
    ...
    count: StrictInt = Field(description="Number of pets allowed")
    deposit: StrictInt = Field(description="Deposit for the pet")
    rent: StrictInt = Field(description="Rent for the pet")
    fee: StrictInt = Field(description="Fee for the pet")
    pet_care: StrictBool = Field(description="Indicates if pet care is provided", alias="petCare")
    restrictions: StrictStr = Field(description="Pet restrictions")
    description: StrictStr = Field(description="Description of pet policy")
    __properties: ClassVar[List[str]] = ["type", "count", "deposit", "rent", "fee", "petCare", "restrictions", "description"]
