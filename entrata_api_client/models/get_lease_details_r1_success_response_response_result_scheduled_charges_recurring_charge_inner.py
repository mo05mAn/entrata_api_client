...
class GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInner(BaseModel):
    """
    ...
    active_scheduled_charges: GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInnerActiveScheduledCharges = Field(alias="activeScheduledCharges")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activeScheduledCharges": GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInnerActiveScheduledCharges.from_dict(obj["activeScheduledCharges"]) if obj.get("activeScheduledCharges") is not None else None
        })
        return _obj
