...
class GetSpecialsR4SuccessResponse(BaseModel):
    """
    GetSpecialsR4SuccessResponse
    """ # noqa: E501
    response: GetSpecialsR4SuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetSpecialsR4SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
