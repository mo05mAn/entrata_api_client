...
class UpdateVendorsSuccessResponseResultVendorsVendor1(BaseModel):
    """
    UpdateVendorsSuccessResponseResultVendorsVendor1
    """ # noqa: E501
    attributes: Optional[UpdateVendorsSuccessResponseResultVendorsVendor1Attributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": UpdateVendorsSuccessResponseResultVendorsVendor1Attributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
