...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInner
    """ # noqa: E501
    lease_term_id: StrictInt = Field(description="Lease term ID", alias="leaseTermId")
    lease_term_name: StrictStr = Field(description="Lease term name", alias="leaseTermName")
    lease_start_windows: GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInnerLeaseStartWindows = Field(alias="leaseStartWindows")
    __properties: ClassVar[List[str]] = ["leaseTermId", "leaseTermName", "leaseStartWindows"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of lease_start_windows
        if self.lease_start_windows:
            _dict['leaseStartWindows'] = self.lease_start_windows.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "leaseStartWindows": GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInnerLeaseStartWindows.from_dict(obj["leaseStartWindows"]) if obj.get("leaseStartWindows") is not None else None
        })
        return _obj
