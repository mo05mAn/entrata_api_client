...
class GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpaces(BaseModel):
    """
    GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpaces
    """ # noqa: E501
    unit_space: GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpace = Field(alias="unitSpace")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of unit_space
        if self.unit_space:
            _dict['unitSpace'] = self.unit_space.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitSpace": GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpace.from_dict(obj["unitSpace"]) if obj.get("unitSpace") is not None else None
        })
        return _obj
