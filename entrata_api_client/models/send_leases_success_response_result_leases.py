...
class SendLeasesSuccessResponseResultLeases(BaseModel):
    """
    SendLeasesSuccessResponseResultLeases
    """ # noqa: E501
    lease: List[SendLeasesSuccessResponseResultLeasesLeaseInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lease": [SendLeasesSuccessResponseResultLeasesLeaseInner.from_dict(_item) for _item in obj["lease"]] if obj.get("lease") is not None else None
        })
        return _obj
