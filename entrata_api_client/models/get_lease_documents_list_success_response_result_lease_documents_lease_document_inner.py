...
class GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner(BaseModel):
    """
    GetLeaseDocumentsListSuccessResponseResultLeaseDocumentsLeaseDocumentInner
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the lease document.")
    type: StrictStr = Field(description="Type of the lease document.")
    name: StrictStr = Field(description="Name of the lease document file.")
    title: StrictStr = Field(description="Title of the lease document.")
    lease_id: StrictStr = Field(description="Unique identifier for the lease.", alias="leaseId")
    external_lease_id: StrictStr = Field(description="External lease identifier used for cross-referencing.", alias="externalLeaseId")
    __properties: ClassVar[List[str]] = ["id", "type", "name", "title", "leaseId", "externalLeaseId"]
