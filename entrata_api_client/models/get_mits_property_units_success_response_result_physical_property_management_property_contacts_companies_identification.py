...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementPropertyContactsCompaniesIdentification(BaseModel):
    """
    Identification details for the company
    """ # noqa: E501
    id_value: Optional[StrictStr] = Field(default=None, description="Unique company ID", alias="IDValue")
