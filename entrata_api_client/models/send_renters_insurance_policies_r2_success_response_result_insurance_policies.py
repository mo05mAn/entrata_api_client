...
class SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies(BaseModel):
    """
    SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePolicies
    """ # noqa: E501
    insurance_policy: List[SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner] = Field(alias="InsurancePolicy")
    __properties: ClassVar[List[str]] = ["InsurancePolicy"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in insurance_policy (list)
        _items = []
        if self.insurance_policy:
            for _item in self.insurance_policy:
                if _item:
                    _items.append(_item.to_dict())
            _dict['InsurancePolicy'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "InsurancePolicy": [SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner.from_dict(_item) for _item in obj["InsurancePolicy"]] if obj.get("InsurancePolicy") is not None else None
        })
        return _obj
