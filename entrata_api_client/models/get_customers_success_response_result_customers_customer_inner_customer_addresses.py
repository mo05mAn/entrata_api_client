...
class GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddresses(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddresses
    """ # noqa: E501
    customer_address: List[GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddressesCustomerAddressInner] = Field(alias="CustomerAddress")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in customer_address (list)
        _items = []
        if self.customer_address:
            for _item in self.customer_address:
                if _item:
                    _items.append(_item.to_dict())
            _dict['CustomerAddress'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CustomerAddress": [GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddressesCustomerAddressInner.from_dict(_item) for _item in obj["CustomerAddress"]] if obj.get("CustomerAddress") is not None else None
        })
        return _obj
