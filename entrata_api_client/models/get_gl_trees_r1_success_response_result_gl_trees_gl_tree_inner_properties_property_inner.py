...
class GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner(BaseModel):
    """
    GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner
    """ # noqa: E501
    attributes: GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
