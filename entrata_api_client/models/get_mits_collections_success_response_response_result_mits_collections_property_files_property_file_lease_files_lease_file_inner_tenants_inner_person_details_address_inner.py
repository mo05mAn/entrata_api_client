...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsInnerPersonDetailsAddressInner(BaseModel):
    """
    ...
    """ # noqa: E501
    attributes: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerUnitAddressAttributes = Field(alias="@attributes")
    description: StrictStr = Field(description="Address description", alias="Description")
    address: StrictStr = Field(description="Address", alias="Address")
    city: StrictStr = Field(description="City", alias="City")
    state: StrictStr = Field(description="State", alias="State")
    postal_code: StrictStr = Field(description="Postal code", alias="PostalCode")
    country: StrictStr = Field(description="Country", alias="Country")
    email: StrictStr = Field(description="Email address", alias="Email")
    __properties: ClassVar[List[str]] = ["@attributes", "Description", "Address", "City", "State", "PostalCode", "Country", "Email"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerUnitAddressAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
