...
class GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailability(BaseModel):
    """
    Availability for specific dates in the property calendar
    """ # noqa: E501
    available_hours: Optional[GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours] = Field(default=None, alias="availableHours")
    __properties: ClassVar[List[str]] = ["availableHours"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of available_hours
        if self.available_hours:
            _dict['availableHours'] = self.available_hours.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availableHours": GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours.from_dict(obj["availableHours"]) if obj.get("availableHours") is not None else None
        })
        return _obj
