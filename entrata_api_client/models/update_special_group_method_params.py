...
class UpdateSpecialGroupMethodParams(BaseModel):
    """
    UpdateSpecialGroupMethodParams
    """ # noqa: E501
    property_id: StrictStr = Field(description="Required. Property ID for updating specials", alias="propertyId")
    special_group: UpdateSpecialGroupMethodParamsSpecialGroup = Field(alias="specialGroup")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specialGroup": UpdateSpecialGroupMethodParamsSpecialGroup.from_dict(obj["specialGroup"]) if obj.get("specialGroup") is not None else None
        })
        return _obj
