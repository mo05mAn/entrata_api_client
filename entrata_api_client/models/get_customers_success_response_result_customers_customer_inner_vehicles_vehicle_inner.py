...
class GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner
    """ # noqa: E501
    model: StrictStr = Field(description="The model of the vehicle", alias="Model")
    color: StrictStr = Field(description="The color of the vehicle", alias="Color")
    make: StrictStr = Field(description="The make of the vehicle", alias="Make")
    license_plate_number: StrictStr = Field(description="The license plate number of the vehicle", alias="LicensePlateNumber")
    state_code: StrictStr = Field(description="State code where the vehicle is registered", alias="StateCode")
    year: StrictStr = Field(description="The manufacturing year of the vehicle", alias="Year")
    __properties: ClassVar[List[str]] = ["Model", "Color", "Make", "LicensePlateNumber", "StateCode", "Year"]
