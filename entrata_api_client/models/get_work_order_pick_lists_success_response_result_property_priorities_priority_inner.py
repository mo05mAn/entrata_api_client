...
class GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the priority", alias="Id")
    name: StrictStr = Field(description="Name of the priority", alias="Name")
