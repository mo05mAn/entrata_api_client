...
class GetFinancialPickListR2SuccessResponseResultLedgerIds(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultLedgerIds
    """ # noqa: E501
    ledger_id: List[GetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner] = Field(description="A list of ledger identifiers.", alias="ledgerId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ledgerId": [GetFinancialPickListR2SuccessResponseResultLedgerIdsLedgerIdInner.from_dict(_item) for _item in obj["ledgerId"]] if obj.get("ledgerId") is not None else None
        })
        return _obj
