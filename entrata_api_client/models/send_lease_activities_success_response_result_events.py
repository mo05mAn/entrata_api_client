...
class SendLeaseActivitiesSuccessResponseResultEvents(BaseModel):
    """
    SendLeaseActivitiesSuccessResponseResultEvents
    """ # noqa: E501
    event: SendLeaseActivitiesSuccessResponseResultEventsEvent
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event": SendLeaseActivitiesSuccessResponseResultEventsEvent.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj
