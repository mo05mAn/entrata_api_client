...
class UpdateAmenitiesSuccessResponseResponseResultPropertyAmenities(BaseModel):
    """
    UpdateAmenitiesSuccessResponseResponseResultPropertyAmenities
    """ # noqa: E501
    property_amenity: List[UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner] = Field(description="List of property amenities updated", alias="propertyAmenity")
    __properties: ClassVar[List[str]] = ["propertyAmenity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in property_amenity (list)
        _items = []
        if self.property_amenity:
            for _item in self.property_amenity:
                if _item:
                    _items.append(_item.to_dict())
            _dict['propertyAmenity'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "propertyAmenity": [UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner.from_dict(_item) for _item in obj["propertyAmenity"]] if obj.get("propertyAmenity") is not None else None
        })
        return _obj
