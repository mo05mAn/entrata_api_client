...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutReasons(BaseModel):
    """
    Reasons for move-out
    """ # noqa: E501
    move_out_reason: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutReasonsMoveOutReasonInner] = Field(alias="moveOutReason")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "moveOutReason": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutReasonsMoveOutReasonInner.from_dict(_item) for _item in obj["moveOutReason"]] if obj.get("moveOutReason") is not None else None
        })
        return _obj
