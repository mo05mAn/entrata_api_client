...
class GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlAccountTypesGlAccountTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL account type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL account type.", alias="Name")
