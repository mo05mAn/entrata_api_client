...
class GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor(BaseModel):
    """
    GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendor
    """ # noqa: E501
    id: StrictStr = Field(description="Vendor identifier")
    name: StrictStr = Field(description="Vendor name")
    location_name: StrictStr = Field(description="Location name of the vendor", alias="locationName")
    location_code: Optional[StrictStr] = Field(default=None, description="Location code of the vendor", alias="locationCode")
    external_id: Optional[StrictStr] = Field(default=None, description="External ID of the vendor", alias="externalId")
    address: GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress
    __properties: ClassVar[List[str]] = ["id", "name", "locationName", "locationCode", "externalId", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerVendorAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
