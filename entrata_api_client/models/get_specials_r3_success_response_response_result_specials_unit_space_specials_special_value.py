...
class GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue
    """ # noqa: E501
    id: StrictStr = Field(description="The unique ID for the unit space special.")
    ...
    unit_spaces: GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValueUnitSpaces = Field(alias="unitSpaces")
    __properties: ClassVar[List[str]] = ["id", "name", "showOnWebsite", "isActive", "giftValue", "unitSpaces"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitSpaces": GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValueUnitSpaces.from_dict(obj["unitSpaces"]) if obj.get("unitSpaces") is not None else None
        })
        return _obj
