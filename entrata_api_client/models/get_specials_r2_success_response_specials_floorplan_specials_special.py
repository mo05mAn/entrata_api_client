...
class GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial(BaseModel):
    """
    ...
    floorplans: GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans
    __properties: ClassVar[List[str]] = ["id", "name", "description", "startDate", "endDate", "couponCode", "cap", "remaining", "showOnWebsite", "isActive", "floorplans"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of floorplans
        if self.floorplans:
            _dict['floorplans'] = self.floorplans.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "floorplans": GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecialFloorplans.from_dict(obj["floorplans"]) if obj.get("floorplans") is not None else None
        })
        return _obj
