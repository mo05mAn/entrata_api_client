...
class GetRentersInsurancePoliciesSuccessResponse(BaseModel):
    """
    ...
    code: Optional[StrictStr] = Field(default=None, description="Response status code")
    result: Optional[GetRentersInsurancePoliciesSuccessResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetRentersInsurancePoliciesSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
