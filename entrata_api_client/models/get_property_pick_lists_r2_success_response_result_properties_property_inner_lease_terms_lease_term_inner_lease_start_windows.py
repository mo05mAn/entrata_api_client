...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInnerLeaseStartWindows(BaseModel):
    """
    Lease start windows for the term
    """ # noqa: E501
    lease_start_window: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInnerLeaseStartWindowsLeaseStartWindowInner] = Field(alias="leaseStartWindow")
    __properties: ClassVar[List[str]] = ["leaseStartWindow"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lease_start_window (list)
        _items = []
        if self.lease_start_window:
            for _item in self.lease_start_window:
                if _item:
                    _items.append(_item.to_dict())
            _dict['leaseStartWindow'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leaseStartWindow": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerLeaseTermsLeaseTermInnerLeaseStartWindowsLeaseStartWindowInner.from_dict(_item) for _item in obj["leaseStartWindow"]] if obj.get("leaseStartWindow") is not None else None
        })
        return _obj
