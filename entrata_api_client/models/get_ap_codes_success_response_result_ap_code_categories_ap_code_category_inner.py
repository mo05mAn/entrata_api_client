...
class GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner(BaseModel):
    """
    GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the accounts payable category.")
    name: StrictStr = Field(description="The name of the accounts payable category.")
    ap_codes: GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodes = Field(alias="apCodes")
    __properties: ClassVar[List[str]] = ["id", "name", "apCodes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "apCodes": GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodes.from_dict(obj["apCodes"]) if obj.get("apCodes") is not None else None
        })
        return _obj
