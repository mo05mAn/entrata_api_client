...
class GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlBranchTypesGlBranchTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL branch type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL branch type.", alias="Name")
