...
class GetInvoicesR2SuccessResponseResultInvoices(BaseModel):
    """
    GetInvoicesR2SuccessResponseResultInvoices
    """ # noqa: E501
    invoice: List[GetInvoicesR2SuccessResponseResultInvoicesInvoiceInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoice": [GetInvoicesR2SuccessResponseResultInvoicesInvoiceInner.from_dict(_item) for _item in obj["invoice"]] if obj.get("invoice") is not None else None
        })
        return _obj
