...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInner(BaseModel):
    """
    GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInner
    """ # noqa: E501
    transaction_data: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerTransactionData] = Field(default=None, alias="TransactionData")
    last_update_date: Optional[StrictStr] = Field(default=None, description="The date when the prospect was last updated.", alias="LastUpdateDate")
    customers: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomers] = Field(default=None, alias="Customers")
    customer_preferences: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomerPreferences] = Field(default=None, alias="CustomerPreferences")
    events: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEvents] = Field(default=None, alias="Events")
    __properties: ClassVar[List[str]] = ["TransactionData", "LastUpdateDate", "Customers", "CustomerPreferences", "Events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "TransactionData": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerTransactionData.from_dict(obj["TransactionData"]) if obj.get("TransactionData") is not None else None,
            "LastUpdateDate": obj.get("LastUpdateDate"),
            "Customers": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomers.from_dict(obj["Customers"]) if obj.get("Customers") is not None else None,
            "CustomerPreferences": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomerPreferences.from_dict(obj["CustomerPreferences"]) if obj.get("CustomerPreferences") is not None else None,
            "Events": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEvents.from_dict(obj["Events"]) if obj.get("Events") is not None else None
        })
        return _obj
