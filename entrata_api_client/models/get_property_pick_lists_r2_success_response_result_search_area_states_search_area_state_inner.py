...
class GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInner
    """ # noqa: E501
    state: StrictStr = Field(description="State name")
    ...
    search_areas: GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInnerSearchAreas = Field(alias="searchAreas")
    __properties: ClassVar[List[str]] = ["state", "stateCode", "countryCode", "searchAreas"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of search_areas
        if self.search_areas:
            _dict['searchAreas'] = self.search_areas.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searchAreas": GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInnerSearchAreas.from_dict(obj["searchAreas"]) if obj.get("searchAreas") is not None else None
        })
        return _obj
