...
class GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions(BaseModel):
    """
    GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactions
    """ # noqa: E501
    transaction: List[GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner] = Field(description="A list of transactions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transaction": [GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInner.from_dict(_item) for _item in obj["transaction"]] if obj.get("transaction") is not None else None
        })
        return _obj
