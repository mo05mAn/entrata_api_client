...
class UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenities(BaseModel):
    """
    UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenities
    """ # noqa: E501
    floorplan_amenity: List[UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner] = Field(description="List of floorplan amenities updated", alias="floorplanAmenity")
    __properties: ClassVar[List[str]] = ["floorplanAmenity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in floorplan_amenity (list)
        _items = []
        if self.floorplan_amenity:
            for _item in self.floorplan_amenity:
                if _item:
                    _items.append(_item.to_dict())
            _dict['floorplanAmenity'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "floorplanAmenity": [UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner.from_dict(_item) for _item in obj["floorplanAmenity"]] if obj.get("floorplanAmenity") is not None else None
        })
        return _obj
