...
class SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes(BaseModel):
    """
    ...
    reference_id: Optional[StrictStr] = Field(default=None, description="The unique reference ID for the AP Header.")
    ...
    __properties: ClassVar[List[str]] = ["invoice_number", "reference_id", "status", "message"]
