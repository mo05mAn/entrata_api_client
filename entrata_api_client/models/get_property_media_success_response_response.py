...
class GetPropertyMediaSuccessResponseResponse(BaseModel):
    """
    GetPropertyMediaSuccessResponseResponse
    """ # noqa: E501
    code: StrictInt = Field(description="Response code indicating success")
    result: GetPropertyMediaSuccessResponseResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "result": GetPropertyMediaSuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
