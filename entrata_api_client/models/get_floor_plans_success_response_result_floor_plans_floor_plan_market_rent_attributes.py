...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes(BaseModel):
    """
    Attributes related to market rent
    """ # noqa: E501
    max: Optional[StrictStr] = Field(default=None, description="Maximum rent", alias="Max")
    min: Optional[StrictStr] = Field(default=None, description="Minimum rent", alias="Min")
