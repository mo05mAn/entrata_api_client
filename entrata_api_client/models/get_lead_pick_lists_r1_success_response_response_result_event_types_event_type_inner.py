...
class GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner(BaseModel):
    """
    GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner
    """ # noqa: E501
    attributes: Optional[GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
