...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnitNumberOccupantsAttributes
    """ # noqa: E501
    total: StrictStr = Field(description="Total number of occupants", alias="Total")
