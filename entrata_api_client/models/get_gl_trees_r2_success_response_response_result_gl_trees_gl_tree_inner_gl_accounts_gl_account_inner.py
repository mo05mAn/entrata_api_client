...
class GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner(BaseModel):
    """
    GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the GL Account")
    branch_id: StrictStr = Field(description="Unique identifier for the branch associated with the GL Account", alias="branchId")
    account_number: StrictStr = Field(description="Account number for the GL Account", alias="accountNumber")
    account_name: StrictStr = Field(description="The name of the GL Account", alias="accountName")
    external_id: StrictStr = Field(description="External identifier for the GL Account", alias="externalId")
    gl_group_type: StrictStr = Field(description="The group type to which the GL Account belongs", alias="glGroupType")
    group_location: Optional[StrictStr] = Field(default=None, description="The location of the group for the GL Account", alias="groupLocation")
    description: Optional[StrictStr] = Field(default=None, description="A description of the GL Account")
    status: StrictStr = Field(description="The status of the GL Account (e.g., Enabled, Disabled)")
    is_system: Optional[StrictInt] = Field(default=None, description="Indicates if the GL Account is a system account (1 = true, 0 = false)", alias="isSystem")
    __properties: ClassVar[List[str]] = ["id", "branchId", "accountNumber", "accountName", "externalId", "glGroupType", "groupLocation", "description", "status", "isSystem"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "glGroupType": obj.get("glGroupType"),
            "groupLocation": obj.get("groupLocation"),
