...
class GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpaces(BaseModel):
    """
    Information about unit spaces
    """ # noqa: E501
    unit_space: List[GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner] = Field(description="List of unit spaces", alias="unitSpace")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitSpace": [GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner.from_dict(_item) for _item in obj["unitSpace"]] if obj.get("unitSpace") is not None else None
        })
        return _obj
