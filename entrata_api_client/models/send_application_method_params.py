...
class SendApplicationMethodParams(BaseModel):
    """
    ...
    originating_lead_source_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="originatingLeadSourceId")
    leasing_agent_id: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value.", alias="leasingAgentId")
    unit_space_id: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value.", alias="unitSpaceId")
    move_in_date: Optional[date] = Field(default=None, description="This is a required field. This field accepts single value.", alias="moveInDate")
    floorplan_id: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value.", alias="floorplanId")
    lease_term_id: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value.", alias="leaseTermId")
    application_status_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Acceptable values are 3 (COMPLETED ) & 4 (APPLICATION_APPROVED )", alias="applicationStatusId")
    __properties: ClassVar[List[str]] = ["propertyId", "originatingLeadSourceId", "leasingAgentId", "unitSpaceId", "moveInDate", "floorplanId", "leaseTermId", "applicationStatusId"]
