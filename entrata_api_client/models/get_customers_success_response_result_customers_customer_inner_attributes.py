...
class GetCustomersSuccessResponseResultCustomersCustomerInnerAttributes(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerAttributes
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the customer", alias="Id")
    external_id: Optional[StrictStr] = Field(default=None, description="External identifier for the customer", alias="ExternalId")
    __properties: ClassVar[List[str]] = ["Id", "ExternalId"]
