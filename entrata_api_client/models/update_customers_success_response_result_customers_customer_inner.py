...
class UpdateCustomersSuccessResponseResultCustomersCustomerInner(BaseModel):
    """
    UpdateCustomersSuccessResponseResultCustomersCustomerInner
    """ # noqa: E501
    node: StrictStr = Field(description="The unique identifier for the customer node.")
    reference_id: StrictStr = Field(description="The reference ID of the customer.", alias="referenceId")
    status: StrictStr = Field(description="The status of the customer update request.")
    message: StrictStr = Field(description="The message indicating the result of the customer update.")
    __properties: ClassVar[List[str]] = ["node", "referenceId", "status", "message"]
