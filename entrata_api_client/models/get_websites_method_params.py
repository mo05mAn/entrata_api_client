...
class GetWebsitesMethodParams(BaseModel):
    """
    GetWebsitesMethodParams
    """ # noqa: E501
    property_ids: StrictInt = Field(description="This is a required field. This field accepts comma seperated multiple values. PropertyIds", alias="propertyIds")
