...
class GetMitsPropertyUnitsSuccessResponseResult(BaseModel):
    """
    Result data containing detailed property information
    """ # noqa: E501
    physical_property: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalProperty] = Field(default=None, alias="PhysicalProperty")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PhysicalProperty": GetMitsPropertyUnitsSuccessResponseResultPhysicalProperty.from_dict(obj["PhysicalProperty"]) if obj.get("PhysicalProperty") is not None else None
        })
        return _obj
