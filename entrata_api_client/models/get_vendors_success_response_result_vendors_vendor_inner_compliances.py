...
class GetVendorsSuccessResponseResultVendorsVendorInnerCompliances(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerCompliances
    """ # noqa: E501
    compliance: Optional[List[GetVendorsSuccessResponseResultVendorsVendorInnerCompliancesComplianceInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compliance": [GetVendorsSuccessResponseResultVendorsVendorInnerCompliancesComplianceInner.from_dict(_item) for _item in obj["compliance"]] if obj.get("compliance") is not None else None
        })
        return _obj
