...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgentAgentIDIdentificationAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    id_type: Optional[StrictStr] = Field(default=None, description="The type of agent identification.", alias="IDType")
    id_scope_type: Optional[StrictStr] = Field(default=None, description="The scope of agent identification.", alias="IDScopeType")
    __properties: ClassVar[List[str]] = ["IDType", "IDScopeType"]
