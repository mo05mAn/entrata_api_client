...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress
    """ # noqa: E501
    address_type: StrictStr = Field(description="Type of the address", alias="AddressType")
    address: StrictStr = Field(description="Address of the property", alias="Address")
    ...
    __properties: ClassVar[List[str]] = ["AddressType", "Address", "City", "State", "PostalCode", "Country"]
