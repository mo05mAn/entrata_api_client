...
class GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervals(BaseModel):
    """
    List of lease intervals
    """ # noqa: E501
    lease_interval: List[GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner] = Field(description="Array of lease intervals", alias="leaseInterval")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leaseInterval": [GetLeasesR1SuccessResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner.from_dict(_item) for _item in obj["leaseInterval"]] if obj.get("leaseInterval") is not None else None
        })
        return _obj
