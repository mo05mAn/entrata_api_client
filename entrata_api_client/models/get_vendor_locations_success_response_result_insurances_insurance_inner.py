...
class GetVendorLocationsSuccessResponseResultInsurancesInsuranceInner(BaseModel):
    """
    ...
    policy_types: GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypes = Field(alias="PolicyTypes")
    attributes: GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["VendorId", "PolicyTypes", "@attributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of policy_types
        if self.policy_types:
            _dict['PolicyTypes'] = self.policy_types.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "PolicyTypes": GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerPolicyTypes.from_dict(obj["PolicyTypes"]) if obj.get("PolicyTypes") is not None else None,
            "@attributes": GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
