...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerRentableItemsRentableItemInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerRentableItemsRentableItemInner
    """ # noqa: E501
    id: StrictInt = Field(description="Rentable item ID")
    name: StrictStr = Field(description="Rentable item name")
