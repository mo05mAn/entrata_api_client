...
class GetGlTransactionsSuccessResponse(BaseModel):
    """
    ...
    result: GetGlTransactionsSuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": GetGlTransactionsSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
