...
class GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInnerAttributes(BaseModel):
    """
    Additional attributes for the announcement
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the announcement", alias="Id")
