...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerCharges(BaseModel):
    """
    The list of charges associated with the lease.
    """ # noqa: E501
    charge: Optional[List[GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerChargesChargeInner]] = Field(default=None, description="A list of charges.")
    __properties: ClassVar[List[str]] = ["charge"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in charge (list)
        _items = []
        if self.charge:
            for _item in self.charge:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "charge": [GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerChargesChargeInner.from_dict(_item) for _item in obj["charge"]] if obj.get("charge") is not None else None
        })
        return _obj
