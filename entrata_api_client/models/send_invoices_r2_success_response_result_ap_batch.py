...
class SendInvoicesR2SuccessResponseResultApBatch(BaseModel):
    """
    SendInvoicesR2SuccessResponseResultApBatch
    """ # noqa: E501
    ap_batch_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the AP batch.", alias="apBatchId")
    ap_headers: Optional[SendInvoicesR2SuccessResponseResultApBatchApHeaders] = Field(default=None, alias="apHeaders")
    __properties: ClassVar[List[str]] = ["apBatchId", "apHeaders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apBatchId": obj.get("apBatchId"),
            "apHeaders": SendInvoicesR2SuccessResponseResultApBatchApHeaders.from_dict(obj["apHeaders"]) if obj.get("apHeaders") is not None else None
        })
        return _obj
