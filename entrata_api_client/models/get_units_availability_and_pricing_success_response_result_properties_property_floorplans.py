...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplans(BaseModel):
    """
    List of floor plans available in the property
    """ # noqa: E501
    floorplan: List[GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInner] = Field(description="List of floor plans for the property", alias="Floorplan")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Floorplan": [GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInner.from_dict(_item) for _item in obj["Floorplan"]] if obj.get("Floorplan") is not None else None
        })
        return _obj
