...
class GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrder(BaseModel):
    """
    GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrder
    """ # noqa: E501
    purchase_order_number: StrictStr = Field(description="The unique purchase order number.", alias="purchaseOrderNumber")
    purchase_order_post_month: StrictStr = Field(description="The post month for the purchase order.", alias="purchaseOrderPostMonth")
    po_details: GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetails = Field(alias="poDetails")
    __properties: ClassVar[List[str]] = ["purchaseOrderNumber", "purchaseOrderPostMonth", "poDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of po_details
        if self.po_details:
            _dict['poDetails'] = self.po_details.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "purchaseOrderPostMonth": obj.get("purchaseOrderPostMonth"),
            "poDetails": GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetails.from_dict(obj["poDetails"]) if obj.get("poDetails") is not None else None
        })
        return _obj
