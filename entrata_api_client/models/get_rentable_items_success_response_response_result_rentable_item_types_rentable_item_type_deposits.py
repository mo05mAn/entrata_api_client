...
class GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeDeposits(BaseModel):
    """
    Deposit charges associated with the item
    """ # noqa: E501
    deposit: GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeDepositsDeposit = Field(alias="Deposit")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Deposit": GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeDepositsDeposit.from_dict(obj["Deposit"]) if obj.get("Deposit") is not None else None
        })
        return _obj
