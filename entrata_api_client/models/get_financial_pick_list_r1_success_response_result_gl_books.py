...
class GetFinancialPickListR1SuccessResponseResultGlBooks(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlBooks
    """ # noqa: E501
    gl_book: List[GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner] = Field(description="A list of GL books.", alias="GlBook")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlBook": [GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner.from_dict(_item) for _item in obj["GlBook"]] if obj.get("GlBook") is not None else None
        })
        return _obj
