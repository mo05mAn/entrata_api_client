...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInner(BaseModel):
    """
    GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInner
    """ # noqa: E501
    pets: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPets] = Field(default=None, alias="Pets")
    attributes: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["Pets", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Pets": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPets.from_dict(obj["Pets"]) if obj.get("Pets") is not None else None,
            "@attributes": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
