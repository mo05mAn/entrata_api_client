...
class GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplans(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplans
    """ # noqa: E501
    floorplan: GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplansFloorplan = Field(alias="Floorplan")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of floorplan
        if self.floorplan:
            _dict['Floorplan'] = self.floorplan.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Floorplan": GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplansFloorplan.from_dict(obj["Floorplan"]) if obj.get("Floorplan") is not None else None
        })
        return _obj
