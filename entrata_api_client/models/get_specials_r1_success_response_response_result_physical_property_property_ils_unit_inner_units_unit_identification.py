...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitIdentification(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitIdentification
    """ # noqa: E501
    attributes: GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitIdentificationAttributes = Field(alias="@attributes")
    id_value: StrictInt = Field(description="The unique identifier for the unit.", alias="IDValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitIdentificationAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
