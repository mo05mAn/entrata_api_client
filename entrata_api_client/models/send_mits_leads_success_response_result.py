...
class SendMitsLeadsSuccessResponseResult(BaseModel):
    """
    The result data of the request.
    """ # noqa: E501
    prospects: Optional[SendMitsLeadsSuccessResponseResultProspects] = Field(default=None, alias="Prospects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Prospects": SendMitsLeadsSuccessResponseResultProspects.from_dict(obj["Prospects"]) if obj.get("Prospects") is not None else None
        })
        return _obj
