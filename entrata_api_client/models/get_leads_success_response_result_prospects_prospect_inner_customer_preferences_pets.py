...
class GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPets(BaseModel):
    """
    GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPets
    """ # noqa: E501
    pet: Optional[List[GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner]] = None
    __properties: ClassVar[List[str]] = ["pet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pet": [GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesPetsPetInner.from_dict(_item) for _item in obj["pet"]] if obj.get("pet") is not None else None
        })
        return _obj
