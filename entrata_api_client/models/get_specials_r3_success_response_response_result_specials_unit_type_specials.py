...
class GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecials(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecials
    """ # noqa: E501
    special: Dict[str, GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValue]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "special": dict(
                (_k, GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValue.from_dict(_v))
