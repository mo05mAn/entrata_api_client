...
class GetFinancialPickListR2SuccessResponseResultGlBooks(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlBooks
    """ # noqa: E501
    gl_book: List[GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner] = Field(description="A list of GL books.", alias="glBook")
    __properties: ClassVar[List[str]] = ["glBook"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_book (list)
        _items = []
        if self.gl_book:
            for _item in self.gl_book:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glBook": [GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner.from_dict(_item) for _item in obj["glBook"]] if obj.get("glBook") is not None else None
        })
        return _obj
