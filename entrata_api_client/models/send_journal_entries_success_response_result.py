...
class SendJournalEntriesSuccessResponseResult(BaseModel):
    """
    SendJournalEntriesSuccessResponseResult
    """ # noqa: E501
    gl_headers: SendJournalEntriesSuccessResponseResultGlHeaders = Field(alias="glHeaders")
    __properties: ClassVar[List[str]] = ["glHeaders"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of gl_headers
        if self.gl_headers:
            _dict['glHeaders'] = self.gl_headers.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glHeaders": SendJournalEntriesSuccessResponseResultGlHeaders.from_dict(obj["glHeaders"]) if obj.get("glHeaders") is not None else None
        })
        return _obj
