...
class GetJobCostBudgetsSuccessResponseResultJobsJobInner(BaseModel):
    """
    ...
    job_id: StrictStr = Field(description="The unique identifier for the job.", alias="jobId")
    job_status_id: StrictStr = Field(description="The status identifier of the job.", alias="jobStatusId")
    job_phases: GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhases = Field(alias="jobPhases")
    __properties: ClassVar[List[str]] = ["propertyId", "jobId", "jobStatusId", "jobPhases"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobPhases": GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhases.from_dict(obj["jobPhases"]) if obj.get("jobPhases") is not None else None
        })
        return _obj
