...
class GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner(BaseModel):
    """
    GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the GL Tree")
    name: StrictStr = Field(description="The name of the GL Tree")
    is_master_gl_tree: StrictInt = Field(description="Indicates if the GL Tree is a master GL Tree (1 = true, 0 = false)", alias="isMasterGlTree")
    branches: GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches
    gl_accounts: GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts = Field(alias="glAccounts")
    __properties: ClassVar[List[str]] = ["id", "name", "isMasterGlTree", "branches", "glAccounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "isMasterGlTree": obj.get("isMasterGlTree"),
            "branches": GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerBranches.from_dict(obj["branches"]) if obj.get("branches") is not None else None,
            "glAccounts": GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts.from_dict(obj["glAccounts"]) if obj.get("glAccounts") is not None else None
        })
        return _obj
