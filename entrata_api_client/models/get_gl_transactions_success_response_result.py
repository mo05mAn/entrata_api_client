...
class GetGlTransactionsSuccessResponseResult(BaseModel):
    """
    GetGlTransactionsSuccessResponseResult
    """ # noqa: E501
    properties: GetGlTransactionsSuccessResponseResultProperties
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": GetGlTransactionsSuccessResponseResultProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
