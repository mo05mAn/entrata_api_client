...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsPropertyPropertyIDIdentificationAttributes(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsPropertyPropertyIDIdentificationAttributes
    """ # noqa: E501
    id_type: Optional[StrictStr] = Field(default=None, description="Property ID", alias="IDType")
