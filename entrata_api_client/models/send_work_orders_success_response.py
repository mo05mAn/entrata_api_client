...
class SendWorkOrdersSuccessResponse(BaseModel):
    """
    SendWorkOrdersSuccessResponse
    """ # noqa: E501
    response: SendWorkOrdersSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SendWorkOrdersSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
