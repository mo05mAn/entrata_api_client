...
class GetFinancialPickListR1SuccessResponseResultGlExportBatchTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlExportBatchTypes
    """ # noqa: E501
    gl_export_batch_type: List[GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner] = Field(description="A list of GL export batch types.", alias="GlExportBatchType")
    __properties: ClassVar[List[str]] = ["GlExportBatchType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_export_batch_type (list)
        _items = []
        if self.gl_export_batch_type:
            for _item in self.gl_export_batch_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['GlExportBatchType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlExportBatchType": [GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner.from_dict(_item) for _item in obj["GlExportBatchType"]] if obj.get("GlExportBatchType") is not None else None
        })
        return _obj
