...
class GetReservableAmenitiesSuccessResponseResultAmenities(BaseModel):
    """
    GetReservableAmenitiesSuccessResponseResultAmenities
    """ # noqa: E501
    amenity: List[GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amenity": [GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInner.from_dict(_item) for _item in obj["amenity"]] if obj.get("amenity") is not None else None
        })
        return _obj
