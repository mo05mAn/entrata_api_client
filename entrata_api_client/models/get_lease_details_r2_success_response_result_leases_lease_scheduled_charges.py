...
class GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledCharges(BaseModel):
    """
    GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledCharges
    """ # noqa: E501
    recurring_charge: List[GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner] = Field(alias="recurringCharge")
    one_time_charge: List[GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner] = Field(alias="oneTimeCharge")
    installment: Optional[GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment] = None
    __properties: ClassVar[List[str]] = ["recurringCharge", "oneTimeCharge", "installment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recurringCharge": [GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner.from_dict(_item) for _item in obj["recurringCharge"]] if obj.get("recurringCharge") is not None else None,
            "oneTimeCharge": [GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesRecurringChargeInner.from_dict(_item) for _item in obj["oneTimeCharge"]] if obj.get("oneTimeCharge") is not None else None,
            "installment": GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment.from_dict(obj["installment"]) if obj.get("installment") is not None else None
        })
        return _obj
