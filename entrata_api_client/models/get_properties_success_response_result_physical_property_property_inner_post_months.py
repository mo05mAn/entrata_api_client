...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPostMonths(BaseModel):
    """
    Post months for accounting
    """ # noqa: E501
    ar_post_month: Optional[StrictStr] = Field(default=None, description="Account receivable post month", alias="ArPostMonth")
    ap_post_month: Optional[StrictStr] = Field(default=None, description="Account payable post month", alias="ApPostMonth")
    gl_post_month: Optional[StrictStr] = Field(default=None, description="General ledger post month", alias="GlPostMonth")
    __properties: ClassVar[List[str]] = ["ArPostMonth", "ApPostMonth", "GlPostMonth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ApPostMonth": obj.get("ApPostMonth"),
            "GlPostMonth": obj.get("GlPostMonth")
        })
        return _obj
