...
class UpdateScheduledChargesR1SuccessResponseResultScheduledCharges(BaseModel):
    """
    UpdateScheduledChargesR1SuccessResponseResultScheduledCharges
    """ # noqa: E501
    scheduled_charge: List[UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner] = Field(alias="scheduledCharge")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in scheduled_charge (list)
        _items = []
        if self.scheduled_charge:
            for _item in self.scheduled_charge:
                if _item:
                    _items.append(_item.to_dict())
            _dict['scheduledCharge'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scheduledCharge": [UpdateScheduledChargesR1SuccessResponseResultScheduledChargesScheduledChargeInner.from_dict(_item) for _item in obj["scheduledCharge"]] if obj.get("scheduledCharge") is not None else None
        })
        return _obj
