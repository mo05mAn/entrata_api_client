...
class GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpaceRentTermRent(BaseModel):
    """
    ...
    start_date: StrictStr = Field(description="Lease start date", alias="startDate")
    end_date: StrictStr = Field(description="Lease end date", alias="endDate")
    amount: StrictInt = Field(description="Amount of the lease term")
    is_best_price: StrictInt = Field(description="Indicates if the price is the best price", alias="isBestPrice")
    __properties: ClassVar[List[str]] = ["leaseTermId", "leaseTermName", "startDate", "endDate", "amount", "isBestPrice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isBestPrice": obj.get("isBestPrice")
        })
        return _obj
