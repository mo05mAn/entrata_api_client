...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInnerDeposit(BaseModel):
    """
    Deposit details for the floor plan
    """ # noqa: E501
    amount: GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInnerDepositAmount = Field(alias="Amount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Amount": GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInnerDepositAmount.from_dict(obj["Amount"]) if obj.get("Amount") is not None else None
        })
        return _obj
