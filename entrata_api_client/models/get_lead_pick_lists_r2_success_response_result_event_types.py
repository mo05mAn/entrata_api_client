...
class GetLeadPickListsR2SuccessResponseResultEventTypes(BaseModel):
    """
    The event types associated with the request.
    """ # noqa: E501
    event_type: Optional[List[GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner]] = Field(default=None, description="A list of event types.", alias="eventType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventType": [GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInner.from_dict(_item) for _item in obj["eventType"]] if obj.get("eventType") is not None else None
        })
        return _obj
