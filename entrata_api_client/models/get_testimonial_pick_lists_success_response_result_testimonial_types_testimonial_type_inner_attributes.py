...
class GetTestimonialPickListsSuccessResponseResultTestimonialTypesTestimonialTypeInnerAttributes(BaseModel):
    """
    GetTestimonialPickListsSuccessResponseResultTestimonialTypesTestimonialTypeInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the testimonial type", alias="Id")
    name: StrictStr = Field(description="The name of the testimonial type", alias="Name")
