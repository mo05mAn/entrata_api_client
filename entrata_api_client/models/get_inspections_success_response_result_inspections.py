...
class GetInspectionsSuccessResponseResultInspections(BaseModel):
    """
    GetInspectionsSuccessResponseResultInspections
    """ # noqa: E501
    inspection: List[GetInspectionsSuccessResponseResultInspectionsInspectionInner]
    __properties: ClassVar[List[str]] = ["inspection"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in inspection (list)
        _items = []
        if self.inspection:
            for _item in self.inspection:
                if _item:
                    _items.append(_item.to_dict())
            _dict['inspection'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inspection": [GetInspectionsSuccessResponseResultInspectionsInspectionInner.from_dict(_item) for _item in obj["inspection"]] if obj.get("inspection") is not None else None
        })
        return _obj
