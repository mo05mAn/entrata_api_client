...
class GetPropertyPickListsR2SuccessResponse(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponse
    """ # noqa: E501
    request_id: StrictInt = Field(description="Unique identifier for the request", alias="requestId")
    code: StrictInt = Field(description="Success response code")
    result: GetPropertyPickListsR2SuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetPropertyPickListsR2SuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
