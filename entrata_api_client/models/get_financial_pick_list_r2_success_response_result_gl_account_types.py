...
class GetFinancialPickListR2SuccessResponseResultGlAccountTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlAccountTypes
    """ # noqa: E501
    gl_account_type: List[GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner] = Field(description="A list of GL account types.", alias="glAccountType")
    __properties: ClassVar[List[str]] = ["glAccountType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_account_type (list)
        _items = []
        if self.gl_account_type:
            for _item in self.gl_account_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['glAccountType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glAccountType": [GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner.from_dict(_item) for _item in obj["glAccountType"]] if obj.get("glAccountType") is not None else None
        })
        return _obj
