...
class GetCalendarAvailabilityR2SuccessResponseResponseResult(BaseModel):
    """
    The result containing available tours and their timeslots
    """ # noqa: E501
    available_tours: Optional[GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours] = Field(default=None, alias="availableTours")
    __properties: ClassVar[List[str]] = ["availableTours"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of available_tours
        if self.available_tours:
            _dict['availableTours'] = self.available_tours.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availableTours": GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableTours.from_dict(obj["availableTours"]) if obj.get("availableTours") is not None else None
        })
        return _obj
