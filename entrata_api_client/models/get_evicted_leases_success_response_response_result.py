...
class GetEvictedLeasesSuccessResponseResponseResult(BaseModel):
    """
    GetEvictedLeasesSuccessResponseResponseResult
    """ # noqa: E501
    evicted_leases: GetEvictedLeasesSuccessResponseResponseResultEvictedLeases = Field(alias="evictedLeases")
    __properties: ClassVar[List[str]] = ["evictedLeases"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of evicted_leases
        if self.evicted_leases:
            _dict['evictedLeases'] = self.evicted_leases.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "evictedLeases": GetEvictedLeasesSuccessResponseResponseResultEvictedLeases.from_dict(obj["evictedLeases"]) if obj.get("evictedLeases") is not None else None
        })
        return _obj
