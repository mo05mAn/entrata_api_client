...
class GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the inspection status", alias="Id")
    name: StrictStr = Field(description="Name of the inspection status", alias="Name")
