...
class GetLeadPickListsR2SuccessResponseResultProperty(BaseModel):
    """
    The property data associated with the request.
    """ # noqa: E501
    leasing_agents: Optional[GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents] = Field(default=None, alias="leasingAgents")
    quote_provisions: Optional[GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions] = Field(default=None, alias="quoteProvisions")
    attributes: Optional[GetLeadPickListsR2SuccessResponseResultPropertyAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["leasingAgents", "quoteProvisions", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leasingAgents": GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgents.from_dict(obj["leasingAgents"]) if obj.get("leasingAgents") is not None else None,
            "quoteProvisions": GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions.from_dict(obj["quoteProvisions"]) if obj.get("quoteProvisions") is not None else None,
            "@attributes": GetLeadPickListsR2SuccessResponseResultPropertyAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
