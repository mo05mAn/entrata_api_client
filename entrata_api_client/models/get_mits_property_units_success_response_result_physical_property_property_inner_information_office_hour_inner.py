...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerInformationOfficeHourInner(BaseModel):
    """
    GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerInformationOfficeHourInner
    """ # noqa: E501
    open_time: Optional[StrictStr] = Field(default=None, description="Opening time for the property office", alias="OpenTime")
    close_time: Optional[StrictStr] = Field(default=None, description="Closing time for the property office", alias="CloseTime")
    day: Optional[StrictStr] = Field(default=None, description="Day of the week for the office hours", alias="Day")
    __properties: ClassVar[List[str]] = ["OpenTime", "CloseTime", "Day"]
