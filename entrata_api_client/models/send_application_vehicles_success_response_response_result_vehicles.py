...
class SendApplicationVehiclesSuccessResponseResponseResultVehicles(BaseModel):
    """
    SendApplicationVehiclesSuccessResponseResponseResultVehicles
    """ # noqa: E501
    vehicle: List[SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vehicle": [SendApplicationVehiclesSuccessResponseResponseResultVehiclesVehicleInner.from_dict(_item) for _item in obj["vehicle"]] if obj.get("vehicle") is not None else None
        })
        return _obj
