...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerResidenceAddress(BaseModel):
    """
    ...
    address: StrictStr = Field(description="Address of the tenant", alias="Address")
    city: StrictStr = Field(description="City of the residence", alias="City")
    state: StrictStr = Field(description="State of the residence", alias="State")
    postal_code: StrictStr = Field(description="Postal code of the residence", alias="PostalCode")
    email: Optional[StrictStr] = Field(default=None, description="Email address of the tenant", alias="Email")
    __properties: ClassVar[List[str]] = ["AddressType", "Address", "City", "State", "PostalCode", "Email"]
