...
class SendLeaseActivitiesSuccessResponseResult(BaseModel):
    """
    SendLeaseActivitiesSuccessResponseResult
    """ # noqa: E501
    events: SendLeaseActivitiesSuccessResponseResultEvents
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": SendLeaseActivitiesSuccessResponseResultEvents.from_dict(obj["events"]) if obj.get("events") is not None else None
        })
        return _obj
