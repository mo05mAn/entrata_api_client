...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerResidence(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerResidence
    """ # noqa: E501
    address: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerResidenceAddress = Field(alias="Address")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Address": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerResidenceAddress.from_dict(obj["Address"]) if obj.get("Address") is not None else None
        })
        return _obj
