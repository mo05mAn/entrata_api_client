...
class GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItems(BaseModel):
    """
    The list items associated with the list item type.
    """ # noqa: E501
    list_item: Optional[List[GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInner]] = Field(default=None, description="A list of list items.", alias="listItem")
    __properties: ClassVar[List[str]] = ["listItem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in list_item (list)
        _items = []
        if self.list_item:
            for _item in self.list_item:
                if _item:
                    _items.append(_item.to_dict())
            _dict['listItem'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "listItem": [GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInner.from_dict(_item) for _item in obj["listItem"]] if obj.get("listItem") is not None else None
        })
        return _obj
