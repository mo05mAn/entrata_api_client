...
class GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSources(BaseModel):
    """
    Lead sources associated with the property.
    """ # noqa: E501
    lead_source: Optional[List[GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSourcesLeadSourceInner]] = Field(default=None, description="A list of lead sources.", alias="LeadSource")
    __properties: ClassVar[List[str]] = ["LeadSource"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lead_source (list)
        _items = []
        if self.lead_source:
            for _item in self.lead_source:
                if _item:
                    _items.append(_item.to_dict())
            _dict['LeadSource'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LeadSource": [GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSourcesLeadSourceInner.from_dict(_item) for _item in obj["LeadSource"]] if obj.get("LeadSource") is not None else None
        })
        return _obj
