...
class GetUnitTypesSuccessResponse(BaseModel):
    """
    GetUnitTypesSuccessResponse
    """ # noqa: E501
    response: Optional[GetUnitTypesSuccessResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetUnitTypesSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
