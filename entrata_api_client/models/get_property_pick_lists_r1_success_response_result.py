...
class GetPropertyPickListsR1SuccessResponseResult(BaseModel):
    """
    Contains company, property, and search area data
    """ # noqa: E501
    company: GetPropertyPickListsR1SuccessResponseResultCompany
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "company": GetPropertyPickListsR1SuccessResponseResultCompany.from_dict(obj["company"]) if obj.get("company") is not None else None
        })
        return _obj
