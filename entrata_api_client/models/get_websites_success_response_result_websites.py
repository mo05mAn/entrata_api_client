...
class GetWebsitesSuccessResponseResultWebsites(BaseModel):
    """
    GetWebsitesSuccessResponseResultWebsites
    """ # noqa: E501
    website: List[GetWebsitesSuccessResponseResultWebsitesWebsiteInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "website": [GetWebsitesSuccessResponseResultWebsitesWebsiteInner.from_dict(_item) for _item in obj["website"]] if obj.get("website") is not None else None
        })
        return _obj
