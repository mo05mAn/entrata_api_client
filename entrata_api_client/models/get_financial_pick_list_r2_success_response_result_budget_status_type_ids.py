...
class GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIds(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIds
    """ # noqa: E501
    budget_status_type_id: List[GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIdsBudgetStatusTypeIdInner] = Field(description="A list of budget status type identifiers.", alias="budgetStatusTypeId")
    __properties: ClassVar[List[str]] = ["budgetStatusTypeId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in budget_status_type_id (list)
        _items = []
        if self.budget_status_type_id:
            for _item in self.budget_status_type_id:
                if _item:
                    _items.append(_item.to_dict())
            _dict['budgetStatusTypeId'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budgetStatusTypeId": [GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIdsBudgetStatusTypeIdInner.from_dict(_item) for _item in obj["budgetStatusTypeId"]] if obj.get("budgetStatusTypeId") is not None else None
        })
        return _obj
