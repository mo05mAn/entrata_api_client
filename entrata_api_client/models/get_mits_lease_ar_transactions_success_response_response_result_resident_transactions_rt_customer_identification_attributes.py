...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerIdentificationAttributes(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerIdentificationAttributes
    """ # noqa: E501
    id_type: Optional[StrictStr] = Field(default=None, description="Lease ID", alias="IDType")
