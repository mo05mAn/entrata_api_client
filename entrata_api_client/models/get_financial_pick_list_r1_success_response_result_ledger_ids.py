...
class GetFinancialPickListR1SuccessResponseResultLedgerIds(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultLedgerIds
    """ # noqa: E501
    ledger_id: List[GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner] = Field(description="A list of ledger identifiers.", alias="LedgerId")
    __properties: ClassVar[List[str]] = ["LedgerId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ledger_id (list)
        _items = []
        if self.ledger_id:
            for _item in self.ledger_id:
                if _item:
                    _items.append(_item.to_dict())
            _dict['LedgerId'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LedgerId": [GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner.from_dict(_item) for _item in obj["LedgerId"]] if obj.get("LedgerId") is not None else None
        })
        return _obj
