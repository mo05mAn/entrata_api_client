...
class GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL header status type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL header status type.", alias="Name")
