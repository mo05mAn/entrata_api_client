...
class GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInnerAttributes(BaseModel):
    """
    Attributes related to the quote provision.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the quote provision.")
