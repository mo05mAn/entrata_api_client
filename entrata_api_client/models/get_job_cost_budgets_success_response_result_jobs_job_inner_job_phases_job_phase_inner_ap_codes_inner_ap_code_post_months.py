...
class GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInnerApCodesInnerApCodePostMonths(BaseModel):
    """
    GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInnerApCodesInnerApCodePostMonths
    """ # noqa: E501
    post_month: List[GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInnerApCodesInnerApCodePostMonthsPostMonthInner] = Field(description="A list of post months for the AP code.", alias="postMonth")
    __properties: ClassVar[List[str]] = ["postMonth"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in post_month (list)
        _items = []
        if self.post_month:
            for _item in self.post_month:
                if _item:
                    _items.append(_item.to_dict())
            _dict['postMonth'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "postMonth": [GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInnerApCodesInnerApCodePostMonthsPostMonthInner.from_dict(_item) for _item in obj["postMonth"]] if obj.get("postMonth") is not None else None
        })
        return _obj
