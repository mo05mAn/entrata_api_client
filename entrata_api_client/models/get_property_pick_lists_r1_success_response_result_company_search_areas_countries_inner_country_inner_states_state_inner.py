...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStatesStateInner(BaseModel):
    """
    GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStatesStateInner
    """ # noqa: E501
    attributes: GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStatesStateInnerAttributes = Field(alias="@attributes")
    search_area: List[GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStatesStateInnerSearchAreaInner] = Field(description="Search areas within the state", alias="searchArea")
    __properties: ClassVar[List[str]] = ["@attributes", "searchArea"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in search_area (list)
        _items = []
        if self.search_area:
            for _item in self.search_area:
                if _item:
                    _items.append(_item.to_dict())
            _dict['searchArea'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStatesStateInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "searchArea": [GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStatesStateInnerSearchAreaInner.from_dict(_item) for _item in obj["searchArea"]] if obj.get("searchArea") is not None else None
        })
        return _obj
