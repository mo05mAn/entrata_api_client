...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreas(BaseModel):
    """
    Details of search areas
    """ # noqa: E501
    countries: List[GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInner] = Field(description="List of countries with states and search areas")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "countries": [GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInner.from_dict(_item) for _item in obj["countries"]] if obj.get("countries") is not None else None
        })
        return _obj
