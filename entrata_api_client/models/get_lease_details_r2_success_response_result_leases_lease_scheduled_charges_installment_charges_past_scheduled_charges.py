...
class GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges(BaseModel):
    """
    GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledCharges
    """ # noqa: E501
    past_scheduled_charge: GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge = Field(alias="pastScheduledCharge")
    __properties: ClassVar[List[str]] = ["pastScheduledCharge"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of past_scheduled_charge
        if self.past_scheduled_charge:
            _dict['pastScheduledCharge'] = self.past_scheduled_charge.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pastScheduledCharge": GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesPastScheduledChargesPastScheduledCharge.from_dict(obj["pastScheduledCharge"]) if obj.get("pastScheduledCharge") is not None else None
        })
        return _obj
