...
class GetVendorLocationsSuccessResponseResultLocationsLocationInner(BaseModel):
    """
    ...
    status: StrictStr = Field(description="Current status of the vendor.", alias="Status")
    term: StrictStr = Field(description="Payment terms for the vendor.", alias="Term")
    legal_entity: GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity = Field(alias="LegalEntity")
    properties: GetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties = Field(alias="Properties")
    contacts: GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts = Field(alias="Contacts")
    attributes: GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["VendorId", "VendorName", "Status", "Term", "LegalEntity", "Properties", "Contacts", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Term": obj.get("Term"),
            "LegalEntity": GetVendorLocationsSuccessResponseResultLocationsLocationInnerLegalEntity.from_dict(obj["LegalEntity"]) if obj.get("LegalEntity") is not None else None,
            "Properties": GetVendorLocationsSuccessResponseResultLocationsLocationInnerProperties.from_dict(obj["Properties"]) if obj.get("Properties") is not None else None,
            "Contacts": GetVendorLocationsSuccessResponseResultLocationsLocationInnerContacts.from_dict(obj["Contacts"]) if obj.get("Contacts") is not None else None,
            "@attributes": GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
