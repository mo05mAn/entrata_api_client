...
class GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypes
    """ # noqa: E501
    gl_reconciliation_status_type: List[GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner] = Field(description="A list of GL reconciliation status types.", alias="glReconciliationStatusType")
    __properties: ClassVar[List[str]] = ["glReconciliationStatusType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_reconciliation_status_type (list)
        _items = []
        if self.gl_reconciliation_status_type:
            for _item in self.gl_reconciliation_status_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['glReconciliationStatusType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glReconciliationStatusType": [GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner.from_dict(_item) for _item in obj["glReconciliationStatusType"]] if obj.get("glReconciliationStatusType") is not None else None
        })
        return _obj
