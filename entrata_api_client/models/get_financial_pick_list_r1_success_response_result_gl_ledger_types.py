...
class GetFinancialPickListR1SuccessResponseResultGlLedgerTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlLedgerTypes
    """ # noqa: E501
    gl_ledger_type: List[GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner] = Field(description="A list of GL ledger types.", alias="GlLedgerType")
    __properties: ClassVar[List[str]] = ["GlLedgerType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_ledger_type (list)
        _items = []
        if self.gl_ledger_type:
            for _item in self.gl_ledger_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['GlLedgerType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlLedgerType": [GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner.from_dict(_item) for _item in obj["GlLedgerType"]] if obj.get("GlLedgerType") is not None else None
        })
        return _obj
