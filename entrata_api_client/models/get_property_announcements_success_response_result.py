...
class GetPropertyAnnouncementsSuccessResponseResult(BaseModel):
    """
    Contains the announcements information
    """ # noqa: E501
    announcements: GetPropertyAnnouncementsSuccessResponseResultAnnouncements = Field(alias="Announcements")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Announcements": GetPropertyAnnouncementsSuccessResponseResultAnnouncements.from_dict(obj["Announcements"]) if obj.get("Announcements") is not None else None
        })
        return _obj
