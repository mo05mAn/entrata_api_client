...
class GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisions(BaseModel):
    """
    Quote provisions associated with the property.
    """ # noqa: E501
    quote_provision: Optional[List[GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner]] = Field(default=None, description="A list of quote provisions.", alias="quoteProvision")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quoteProvision": [GetLeadPickListsR2SuccessResponseResultPropertyQuoteProvisionsQuoteProvisionInner.from_dict(_item) for _item in obj["quoteProvision"]] if obj.get("quoteProvision") is not None else None
        })
        return _obj
