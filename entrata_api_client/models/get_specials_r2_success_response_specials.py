...
class GetSpecialsR2SuccessResponseSpecials(BaseModel):
    """
    ...
    property_specials: GetSpecialsR2SuccessResponseSpecialsPropertySpecials = Field(alias="propertySpecials")
    floorplan_specials: GetSpecialsR2SuccessResponseSpecialsFloorplanSpecials = Field(alias="floorplanSpecials")
    unit_type_specials: GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecials = Field(alias="unitTypeSpecials")
    unit_space_specials: GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecials = Field(alias="unitSpaceSpecials")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "propertySpecials": GetSpecialsR2SuccessResponseSpecialsPropertySpecials.from_dict(obj["propertySpecials"]) if obj.get("propertySpecials") is not None else None,
            "floorplanSpecials": GetSpecialsR2SuccessResponseSpecialsFloorplanSpecials.from_dict(obj["floorplanSpecials"]) if obj.get("floorplanSpecials") is not None else None,
            "unitTypeSpecials": GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecials.from_dict(obj["unitTypeSpecials"]) if obj.get("unitTypeSpecials") is not None else None,
            "unitSpaceSpecials": GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecials.from_dict(obj["unitSpaceSpecials"]) if obj.get("unitSpaceSpecials") is not None else None
        })
        return _obj
