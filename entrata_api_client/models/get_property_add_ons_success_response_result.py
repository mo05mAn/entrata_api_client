...
class GetPropertyAddOnsSuccessResponseResult(BaseModel):
    """
    Result containing the add-on details
    """ # noqa: E501
    currency_code: StrictStr = Field(description="Currency code for pricing information", alias="currencyCode")
    add_ons: GetPropertyAddOnsSuccessResponseResultAddOns = Field(alias="addOns")
    __properties: ClassVar[List[str]] = ["currencyCode", "addOns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addOns": GetPropertyAddOnsSuccessResponseResultAddOns.from_dict(obj["addOns"]) if obj.get("addOns") is not None else None
        })
        return _obj
