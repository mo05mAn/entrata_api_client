...
class GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications(BaseModel):
    """
    GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications
    """ # noqa: E501
    company_application: List[GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner] = Field(alias="companyApplication")
    __properties: ClassVar[List[str]] = ["companyApplication"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in company_application (list)
        _items = []
        if self.company_application:
            for _item in self.company_application:
                if _item:
                    _items.append(_item.to_dict())
            _dict['companyApplication'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "companyApplication": [GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner.from_dict(_item) for _item in obj["companyApplication"]] if obj.get("companyApplication") is not None else None
        })
        return _obj
