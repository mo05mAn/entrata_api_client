...
class UpdateCustomerTestimonialsSuccessResponseResultTestimonials(BaseModel):
    """
    UpdateCustomerTestimonialsSuccessResponseResultTestimonials
    """ # noqa: E501
    testimonial: UpdateCustomerTestimonialsSuccessResponseResultTestimonialsTestimonial = Field(alias="Testimonial")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of testimonial
        if self.testimonial:
            _dict['Testimonial'] = self.testimonial.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Testimonial": UpdateCustomerTestimonialsSuccessResponseResultTestimonialsTestimonial.from_dict(obj["Testimonial"]) if obj.get("Testimonial") is not None else None
        })
        return _obj
