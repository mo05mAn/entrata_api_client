...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertyBuildings(BaseModel):
    """
    Buildings within the property
    """ # noqa: E501
    property_building: List[GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertyBuildingsPropertyBuildingInner] = Field(description="List of buildings", alias="PropertyBuilding")
    __properties: ClassVar[List[str]] = ["PropertyBuilding"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in property_building (list)
        _items = []
        if self.property_building:
            for _item in self.property_building:
                if _item:
                    _items.append(_item.to_dict())
            _dict['PropertyBuilding'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PropertyBuilding": [GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertyBuildingsPropertyBuildingInner.from_dict(_item) for _item in obj["PropertyBuilding"]] if obj.get("PropertyBuilding") is not None else None
        })
        return _obj
