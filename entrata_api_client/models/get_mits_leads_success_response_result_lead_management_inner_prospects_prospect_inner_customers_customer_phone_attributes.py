...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomerPhoneAttributes(BaseModel):
    """
    GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomerPhoneAttributes
    """ # noqa: E501
    phone_type: Optional[StrictStr] = Field(default=None, description="The type of phone number.", alias="PhoneType")
    __properties: ClassVar[List[str]] = ["PhoneType"]
