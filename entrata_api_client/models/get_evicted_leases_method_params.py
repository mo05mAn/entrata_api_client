...
class GetEvictedLeasesMethodParams(BaseModel):
    """
    GetEvictedLeasesMethodParams
    """ # noqa: E501
    property_id: StrictInt = Field(description="This is a required field. This field accepts single value. Provide a valid propertyId.", alias="propertyId")
    eviction_start_date_from: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value. Provide a valid evictionStartDateFrom.", alias="evictionStartDateFrom")
    eviction_start_date_to: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value. Provide a valid evictionStartDateTo", alias="evictionStartDateTo")
    __properties: ClassVar[List[str]] = ["propertyId", "evictionStartDateFrom", "evictionStartDateTo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "evictionStartDateFrom": obj.get("evictionStartDateFrom"),
            "evictionStartDateTo": obj.get("evictionStartDateTo")
        })
        return _obj
