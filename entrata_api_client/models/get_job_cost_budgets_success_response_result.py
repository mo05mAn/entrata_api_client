...
class GetJobCostBudgetsSuccessResponseResult(BaseModel):
    """
    GetJobCostBudgetsSuccessResponseResult
    """ # noqa: E501
    jobs: GetJobCostBudgetsSuccessResponseResultJobs
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": GetJobCostBudgetsSuccessResponseResultJobs.from_dict(obj["jobs"]) if obj.get("jobs") is not None else None
        })
        return _obj
