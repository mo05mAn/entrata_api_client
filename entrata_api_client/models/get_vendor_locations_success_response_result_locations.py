...
class GetVendorLocationsSuccessResponseResultLocations(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultLocations
    """ # noqa: E501
    location: Optional[List[GetVendorLocationsSuccessResponseResultLocationsLocationInner]] = Field(default=None, alias="Location")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Location": [GetVendorLocationsSuccessResponseResultLocationsLocationInner.from_dict(_item) for _item in obj["Location"]] if obj.get("Location") is not None else None
        })
        return _obj
