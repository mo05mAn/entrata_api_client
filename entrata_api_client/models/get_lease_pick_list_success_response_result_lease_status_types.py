...
class GetLeasePickListSuccessResponseResultLeaseStatusTypes(BaseModel):
    """
    GetLeasePickListSuccessResponseResultLeaseStatusTypes
    """ # noqa: E501
    lease_status_type: List[GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner] = Field(alias="leaseStatusType")
    __properties: ClassVar[List[str]] = ["leaseStatusType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lease_status_type (list)
        _items = []
        if self.lease_status_type:
            for _item in self.lease_status_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['leaseStatusType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leaseStatusType": [GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner.from_dict(_item) for _item in obj["leaseStatusType"]] if obj.get("leaseStatusType") is not None else None
        })
        return _obj
