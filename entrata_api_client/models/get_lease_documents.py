...
class GetLeaseDocuments(BaseModel):
    """
    GetLeaseDocuments
    """ # noqa: E501
    ...
    method: GetLeaseDocumentsMethod
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": GetLeaseDocumentsMethod.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
