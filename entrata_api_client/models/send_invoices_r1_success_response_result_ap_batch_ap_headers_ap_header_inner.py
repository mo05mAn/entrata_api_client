...
class SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInner(BaseModel):
    """
    SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInner
    """ # noqa: E501
    attributes: Optional[SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": SendInvoicesR1SuccessResponseResultApBatchApHeadersApHeaderInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
