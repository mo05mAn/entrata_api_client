...
class SendLeadsSuccessResponseResultProspectsProspectInner(BaseModel):
    """
    SendLeadsSuccessResponseResultProspectsProspectInner
    """ # noqa: E501
    node: Optional[StrictStr] = Field(default=None, description="A node identifier for the prospect.")
    ...
    applicant_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the applicant.", alias="applicantId")
    status: Optional[StrictStr] = Field(default=None, description="The status of the prospect.")
    message: Optional[StrictStr] = Field(default=None, description="A message associated with the prospect.")
    applicants: Optional[SendLeadsSuccessResponseResultProspectsProspectInnerApplicants] = None
    __properties: ClassVar[List[str]] = ["node", "applicationId", "applicantId", "status", "message", "applicants"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of applicants
        if self.applicants:
            _dict['applicants'] = self.applicants.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "applicants": SendLeadsSuccessResponseResultProspectsProspectInnerApplicants.from_dict(obj["applicants"]) if obj.get("applicants") is not None else None
        })
        return _obj
