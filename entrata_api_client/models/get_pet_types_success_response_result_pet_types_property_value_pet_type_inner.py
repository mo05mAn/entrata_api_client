...
class GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInner(BaseModel):
    """
    GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInner
    """ # noqa: E501
    attributes: GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
