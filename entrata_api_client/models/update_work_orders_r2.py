...
class UpdateWorkOrdersR2(BaseModel):
    """
    UpdateWorkOrdersR2
    """ # noqa: E501
    ...
    method: UpdateWorkOrdersR2Method
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": UpdateWorkOrdersR2Method.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
