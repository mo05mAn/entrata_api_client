...
class SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes(BaseModel):
    """
    SendCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerAttributes
    """ # noqa: E501
    node: StrictInt = Field(description="The identifier for the testimonial node")
    reference_id: StrictInt = Field(description="The reference ID of the testimonial")
    status: StrictStr = Field(description="The status of the testimonial submission")
    message: StrictStr = Field(description="The message indicating the result of the submission")
    __properties: ClassVar[List[str]] = ["node", "reference_id", "status", "message"]
