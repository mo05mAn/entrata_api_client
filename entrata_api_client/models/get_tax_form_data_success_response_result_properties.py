...
class GetTaxFormDataSuccessResponseResultProperties(BaseModel):
    """
    GetTaxFormDataSuccessResponseResultProperties
    """ # noqa: E501
    var_property: Optional[List[GetTaxFormDataSuccessResponseResultPropertiesPropertyInner]] = Field(default=None, alias="property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property": [GetTaxFormDataSuccessResponseResultPropertiesPropertyInner.from_dict(_item) for _item in obj["property"]] if obj.get("property") is not None else None
        })
        return _obj
