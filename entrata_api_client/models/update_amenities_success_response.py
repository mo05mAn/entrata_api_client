...
class UpdateAmenitiesSuccessResponse(BaseModel):
    """
    UpdateAmenitiesSuccessResponse
    """ # noqa: E501
    response: Optional[UpdateAmenitiesSuccessResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": UpdateAmenitiesSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
