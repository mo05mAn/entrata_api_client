...
class GetJobsSuccessResponseResultJobsJobInnerApContracts(BaseModel):
    """
    GetJobsSuccessResponseResultJobsJobInnerApContracts
    """ # noqa: E501
    ap_contract: List[GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner] = Field(description="A list of AP contracts associated with the job.", alias="apContract")
    __properties: ClassVar[List[str]] = ["apContract"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_contract (list)
        _items = []
        if self.ap_contract:
            for _item in self.ap_contract:
                if _item:
                    _items.append(_item.to_dict())
            _dict['apContract'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apContract": [GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInner.from_dict(_item) for _item in obj["apContract"]] if obj.get("apContract") is not None else None
        })
        return _obj
