...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerILSIdentificationAttributes(BaseModel):
    """
    Attributes related to ILS identification
    """ # noqa: E501
    ils_identification_type: Optional[StrictStr] = Field(default=None, description="Type of ILS identification", alias="ILS_IdentificationType")
    rental_type: Optional[StrictStr] = Field(default=None, description="Rental type", alias="RentalType")
    __properties: ClassVar[List[str]] = ["ILS_IdentificationType", "RentalType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ILS_IdentificationType": obj.get("ILS_IdentificationType"),
