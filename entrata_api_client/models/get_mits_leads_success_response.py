...
class GetMitsLeadsSuccessResponse(BaseModel):
    """
    ...
    result: GetMitsLeadsSuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetMitsLeadsSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
