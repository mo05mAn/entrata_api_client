...
class GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocationsArAllocationInner(BaseModel):
    """
    GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocationsArAllocationInner
    """ # noqa: E501
    ar_transaction_id: StrictInt = Field(description="The ID of the AR transaction.", alias="ArTransactionId")
    charge_code_id: Optional[StrictInt] = Field(default=None, description="The ID of the charge code associated with the payment.", alias="ChargeCodeId")
    charge_code_name: Optional[StrictStr] = Field(default=None, description="The name of the charge code.", alias="ChargeCodeName")
    allocation_date_time: Optional[StrictStr] = Field(default=None, description="The date and time when the allocation was made.", alias="AllocationDateTime")
    amount: Optional[StrictInt] = Field(default=None, description="The amount allocated to this AR transaction.", alias="Amount")
    __properties: ClassVar[List[str]] = ["ArTransactionId", "ChargeCodeId", "ChargeCodeName", "AllocationDateTime", "Amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ArTransactionId": obj.get("ArTransactionId"),
            "ChargeCodeId": obj.get("ChargeCodeId"),
            "ChargeCodeName": obj.get("ChargeCodeName"),
            "AllocationDateTime": obj.get("AllocationDateTime"),
