...
class GetFinancialPickListR1SuccessResponseResultBudgets(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultBudgets
    """ # noqa: E501
    budget: List[GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner] = Field(description="A list of budget records.", alias="Budget")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Budget": [GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner.from_dict(_item) for _item in obj["Budget"]] if obj.get("Budget") is not None else None
        })
        return _obj
