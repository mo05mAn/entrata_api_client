...
class GetVendorPickListsSuccessResponseResultApPayeeTerms(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultApPayeeTerms
    """ # noqa: E501
    ap_payee_term: Optional[List[GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInner]] = Field(default=None, alias="apPayeeTerm")
    __properties: ClassVar[List[str]] = ["apPayeeTerm"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_payee_term (list)
        _items = []
        if self.ap_payee_term:
            for _item in self.ap_payee_term:
                if _item:
                    _items.append(_item.to_dict())
            _dict['apPayeeTerm'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apPayeeTerm": [GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInner.from_dict(_item) for _item in obj["apPayeeTerm"]] if obj.get("apPayeeTerm") is not None else None
        })
        return _obj
