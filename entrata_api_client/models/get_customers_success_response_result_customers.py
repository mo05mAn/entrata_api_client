...
class GetCustomersSuccessResponseResultCustomers(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomers
    """ # noqa: E501
    customer: List[GetCustomersSuccessResponseResultCustomersCustomerInner] = Field(alias="Customer")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Customer": [GetCustomersSuccessResponseResultCustomersCustomerInner.from_dict(_item) for _item in obj["Customer"]] if obj.get("Customer") is not None else None
        })
        return _obj
