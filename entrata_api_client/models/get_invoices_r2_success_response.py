...
class GetInvoicesR2SuccessResponse(BaseModel):
    """
    ...
    code: Optional[StrictStr] = Field(default=None, description="Response code indicating success")
    result: Optional[GetInvoicesR2SuccessResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetInvoicesR2SuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
