...
class SendBudgetedRentSuccessResponseResult(BaseModel):
    """
    The result containing pricing details
    """ # noqa: E501
    pricing: Optional[List[SendBudgetedRentSuccessResponseResultPricingInner]] = Field(default=None, description="List of pricing nodes")
    __properties: ClassVar[List[str]] = ["pricing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pricing": [SendBudgetedRentSuccessResponseResultPricingInner.from_dict(_item) for _item in obj["pricing"]] if obj.get("pricing") is not None else None
        })
        return _obj
