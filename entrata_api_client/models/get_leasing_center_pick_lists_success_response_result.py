...
class GetLeasingCenterPickListsSuccessResponseResult(BaseModel):
    """
    GetLeasingCenterPickListsSuccessResponseResult
    """ # noqa: E501
    call_sources: GetLeasingCenterPickListsSuccessResponseResultCallSources = Field(alias="callSources")
    call_types: GetLeasingCenterPickListsSuccessResponseResultCallTypes = Field(alias="callTypes")
    call_results: GetLeasingCenterPickListsSuccessResponseResultCallResults = Field(alias="callResults")
    __properties: ClassVar[List[str]] = ["callSources", "callTypes", "callResults"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of call_sources
        if self.call_sources:
            _dict['callSources'] = self.call_sources.to_dict()
        # override the default output from pydantic by calling `to_dict()` of call_types
        if self.call_types:
            _dict['callTypes'] = self.call_types.to_dict()
        # override the default output from pydantic by calling `to_dict()` of call_results
        if self.call_results:
            _dict['callResults'] = self.call_results.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "callSources": GetLeasingCenterPickListsSuccessResponseResultCallSources.from_dict(obj["callSources"]) if obj.get("callSources") is not None else None,
            "callTypes": GetLeasingCenterPickListsSuccessResponseResultCallTypes.from_dict(obj["callTypes"]) if obj.get("callTypes") is not None else None,
            "callResults": GetLeasingCenterPickListsSuccessResponseResultCallResults.from_dict(obj["callResults"]) if obj.get("callResults") is not None else None
        })
        return _obj
