...
class SendSpecialGroupSuccessResponseResponseResult(BaseModel):
    """
    SendSpecialGroupSuccessResponseResponseResult
    """ # noqa: E501
    status: StrictStr = Field(description="Status of the operation")
    special_group_id: StrictInt = Field(description="ID of the created special group", alias="specialGroupId")
