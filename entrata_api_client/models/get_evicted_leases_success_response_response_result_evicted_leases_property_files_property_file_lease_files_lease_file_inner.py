...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInner(BaseModel):
    """
    GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInner
    """ # noqa: E501
    lease_id: StrictStr = Field(description="Unique identifier for the lease.", alias="leaseId")
    eviction_status: StrictStr = Field(description="Status of the eviction (e.g., Evicted).", alias="evictionStatus")
    move_in_date: StrictStr = Field(description="Move-in date.", alias="moveInDate")
    eviction_start_date: StrictStr = Field(description="Start date of eviction.", alias="evictionStartDate")
    eviction_date: StrictStr = Field(description="Date of eviction.", alias="evictionDate")
    lease_begin: StrictStr = Field(description="Lease start date.", alias="leaseBegin")
    lease_end: StrictStr = Field(description="Lease end date.", alias="leaseEnd")
    monthly_rent_amount: StrictStr = Field(description="Amount of monthly rent.", alias="monthlyRentAmount")
    rent_due_from_date: StrictStr = Field(description="Start date for rent due period.", alias="rentDueFromDate")
    rent_due_to_date: StrictStr = Field(description="End date for rent due period.", alias="rentDueToDate")
    building_name: StrictStr = Field(description="Name of the building.", alias="buildingName")
    unit: GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerUnit
    tenants: GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenants
    transactions: GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTransactions
    __properties: ClassVar[List[str]] = ["leaseId", "evictionStatus", "moveInDate", "evictionStartDate", "evictionDate", "leaseBegin", "leaseEnd", "monthlyRentAmount", "rentDueFromDate", "rentDueToDate", "buildingName", "unit", "tenants", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "evictionStatus": obj.get("evictionStatus"),
            "moveInDate": obj.get("moveInDate"),
            "evictionStartDate": obj.get("evictionStartDate"),
            "evictionDate": obj.get("evictionDate"),
            "leaseBegin": obj.get("leaseBegin"),
            "leaseEnd": obj.get("leaseEnd"),
            "monthlyRentAmount": obj.get("monthlyRentAmount"),
            "rentDueFromDate": obj.get("rentDueFromDate"),
            "rentDueToDate": obj.get("rentDueToDate"),
            "buildingName": obj.get("buildingName"),
            "unit": GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerUnit.from_dict(obj["unit"]) if obj.get("unit") is not None else None,
            "tenants": GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenants.from_dict(obj["tenants"]) if obj.get("tenants") is not None else None,
            "transactions": GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTransactions.from_dict(obj["transactions"]) if obj.get("transactions") is not None else None
        })
        return _obj
