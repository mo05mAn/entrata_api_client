...
class GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents(BaseModel):
    """
    Leasing agents associated with the property.
    """ # noqa: E501
    leasing_agent: Optional[List[GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInner]] = Field(default=None, description="A list of leasing agents.", alias="LeasingAgent")
    __properties: ClassVar[List[str]] = ["LeasingAgent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in leasing_agent (list)
        _items = []
        if self.leasing_agent:
            for _item in self.leasing_agent:
                if _item:
                    _items.append(_item.to_dict())
            _dict['LeasingAgent'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LeasingAgent": [GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInner.from_dict(_item) for _item in obj["LeasingAgent"]] if obj.get("LeasingAgent") is not None else None
        })
        return _obj
