...
class SendInvoicesR2SuccessResponse(BaseModel):
    """
    SendInvoicesR2SuccessResponse
    """ # noqa: E501
    result: SendInvoicesR2SuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": SendInvoicesR2SuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
