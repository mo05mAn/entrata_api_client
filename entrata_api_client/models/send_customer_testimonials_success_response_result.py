...
class SendCustomerTestimonialsSuccessResponseResult(BaseModel):
    """
    SendCustomerTestimonialsSuccessResponseResult
    """ # noqa: E501
    testimonials: SendCustomerTestimonialsSuccessResponseResultTestimonials = Field(alias="Testimonials")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Testimonials": SendCustomerTestimonialsSuccessResponseResultTestimonials.from_dict(obj["Testimonials"]) if obj.get("Testimonials") is not None else None
        })
        return _obj
