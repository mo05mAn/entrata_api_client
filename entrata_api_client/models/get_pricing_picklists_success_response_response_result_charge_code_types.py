...
class GetPricingPicklistsSuccessResponseResponseResultChargeCodeTypes(BaseModel):
    """
    Charge code types details
    """ # noqa: E501
    charge_code_type: Optional[List[GetPricingPicklistsSuccessResponseResponseResultChargeCodeTypesChargeCodeTypeInner]] = Field(default=None, description="List of charge code types", alias="chargeCodeType")
    __properties: ClassVar[List[str]] = ["chargeCodeType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in charge_code_type (list)
        _items = []
        if self.charge_code_type:
            for _item in self.charge_code_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['chargeCodeType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeCodeType": [GetPricingPicklistsSuccessResponseResponseResultChargeCodeTypesChargeCodeTypeInner.from_dict(_item) for _item in obj["chargeCodeType"]] if obj.get("chargeCodeType") is not None else None
        })
        return _obj
