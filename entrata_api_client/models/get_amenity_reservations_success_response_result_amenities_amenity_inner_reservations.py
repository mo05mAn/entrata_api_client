...
class GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservations(BaseModel):
    """
    Reservations for the amenity
    """ # noqa: E501
    reservation: Optional[List[GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner]] = Field(default=None, description="List of reservations for the amenity")
    __properties: ClassVar[List[str]] = ["reservation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in reservation (list)
        _items = []
        if self.reservation:
            for _item in self.reservation:
                if _item:
                    _items.append(_item.to_dict())
            _dict['reservation'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reservation": [GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInnerReservationsReservationInner.from_dict(_item) for _item in obj["reservation"]] if obj.get("reservation") is not None else None
        })
        return _obj
