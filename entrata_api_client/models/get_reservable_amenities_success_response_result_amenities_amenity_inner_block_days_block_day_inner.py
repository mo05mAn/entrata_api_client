...
class GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner(BaseModel):
    """
    ...
    block_hours: StrictStr = Field(description="Blocked hours for that day", alias="blockHours")
    __properties: ClassVar[List[str]] = ["day", "blockHours"]
