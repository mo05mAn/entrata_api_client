...
class UpdatePropertyResponseSuccessResponseResultTestimonials(BaseModel):
    """
    UpdatePropertyResponseSuccessResponseResultTestimonials
    """ # noqa: E501
    testimonial: UpdatePropertyResponseSuccessResponseResultTestimonialsTestimonial
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testimonial": UpdatePropertyResponseSuccessResponseResultTestimonialsTestimonial.from_dict(obj["testimonial"]) if obj.get("testimonial") is not None else None
        })
        return _obj
