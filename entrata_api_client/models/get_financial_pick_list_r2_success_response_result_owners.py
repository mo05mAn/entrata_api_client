...
class GetFinancialPickListR2SuccessResponseResultOwners(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultOwners
    """ # noqa: E501
    owner: List[GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner] = Field(description="A list of owners.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "owner": [GetFinancialPickListR2SuccessResponseResultOwnersOwnerInner.from_dict(_item) for _item in obj["owner"]] if obj.get("owner") is not None else None
        })
        return _obj
