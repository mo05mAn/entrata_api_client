...
class SendSpecialGroupMethodParamsSpecialGroupSpecialsInner(BaseModel):
    """
    SendSpecialGroupMethodParamsSpecialGroupSpecialsInner
    """ # noqa: E501
    special_type_id: StrictStr = Field(description="This is a required field. Special type identifier.", alias="specialTypeId")
    special_name: StrictStr = Field(description="This is a required field. Name of the special.", alias="specialName")
    gift_value: Optional[StrictStr] = Field(default=None, description="This is an optional field. Value of gift type special.", alias="giftValue")
    rates: Optional[List[SendSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner]] = None
    __properties: ClassVar[List[str]] = ["specialTypeId", "specialName", "giftValue", "rates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rates": [SendSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
