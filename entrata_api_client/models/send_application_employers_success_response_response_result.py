...
class SendApplicationEmployersSuccessResponseResponseResult(BaseModel):
    """
    SendApplicationEmployersSuccessResponseResponseResult
    """ # noqa: E501
    employers: SendApplicationEmployersSuccessResponseResponseResultEmployers
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of employers
        if self.employers:
            _dict['employers'] = self.employers.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "employers": SendApplicationEmployersSuccessResponseResponseResultEmployers.from_dict(obj["employers"]) if obj.get("employers") is not None else None
        })
        return _obj
