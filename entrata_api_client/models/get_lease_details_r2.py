...
class GetLeaseDetailsR2(BaseModel):
    """
    GetLeaseDetailsR2
    """ # noqa: E501
    ...
    method: GetLeaseDetailsR2Method
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": GetLeaseDetailsR2Method.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
