...
class UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInnerAttributes(BaseModel):
    """
    Attributes of the work order
    """ # noqa: E501
    work_order_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the work order", alias="workOrderId")
    status: Optional[StrictStr] = Field(default=None, description="The current status of the work order")
    message: Optional[StrictStr] = Field(default=None, description="Message detailing the outcome of the work order")
    __properties: ClassVar[List[str]] = ["workOrderId", "status", "message"]
