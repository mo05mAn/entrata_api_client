...
class GetTestimonialPickListsSuccessResponseResultTestimonialRatingTypesTestimonialRatingTypeInnerAttributes(BaseModel):
    """
    GetTestimonialPickListsSuccessResponseResultTestimonialRatingTypesTestimonialRatingTypeInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the testimonial rating type", alias="Id")
    name: StrictStr = Field(description="The name of the testimonial rating type", alias="Name")
