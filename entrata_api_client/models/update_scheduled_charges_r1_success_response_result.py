...
class UpdateScheduledChargesR1SuccessResponseResult(BaseModel):
    """
    UpdateScheduledChargesR1SuccessResponseResult
    """ # noqa: E501
    scheduled_charges: UpdateScheduledChargesR1SuccessResponseResultScheduledCharges = Field(alias="scheduledCharges")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scheduledCharges": UpdateScheduledChargesR1SuccessResponseResultScheduledCharges.from_dict(obj["scheduledCharges"]) if obj.get("scheduledCharges") is not None else None
        })
        return _obj
