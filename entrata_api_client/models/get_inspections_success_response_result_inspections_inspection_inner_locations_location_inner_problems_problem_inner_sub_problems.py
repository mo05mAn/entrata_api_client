...
class GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInnerSubProblems(BaseModel):
    """
    GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInnerSubProblems
    """ # noqa: E501
    sub_problem: Optional[List[GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInnerSubProblemsSubProblemInner]] = Field(default=None, alias="subProblem")
    __properties: ClassVar[List[str]] = ["subProblem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sub_problem (list)
        _items = []
        if self.sub_problem:
            for _item in self.sub_problem:
                if _item:
                    _items.append(_item.to_dict())
            _dict['subProblem'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subProblem": [GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInnerSubProblemsSubProblemInner.from_dict(_item) for _item in obj["subProblem"]] if obj.get("subProblem") is not None else None
        })
        return _obj
