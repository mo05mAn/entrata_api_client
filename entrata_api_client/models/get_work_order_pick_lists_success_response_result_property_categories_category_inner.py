...
class GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the category", alias="Id")
    name: StrictStr = Field(description="Name of the category", alias="Name")
