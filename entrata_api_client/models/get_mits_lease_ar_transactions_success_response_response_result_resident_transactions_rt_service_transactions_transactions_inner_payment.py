...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPayment(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPayment
    """ # noqa: E501
    attributes: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPaymentAttributes = Field(alias="@attributes")
    detail: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPaymentDetail = Field(alias="Detail")
    __properties: ClassVar[List[str]] = ["@attributes", "Detail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPaymentAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "Detail": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPaymentDetail.from_dict(obj["Detail"]) if obj.get("Detail") is not None else None
        })
        return _obj
