...
class GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes(BaseModel):
    """
    GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes
    """ # noqa: E501
    is_company_level: Optional[StrictStr] = Field(default=None, description="Indicates if the property level is a company level.", alias="isCompanyLevel")
    __properties: ClassVar[List[str]] = ["isCompanyLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "isCompanyLevel": obj.get("isCompanyLevel")
        })
        return _obj
