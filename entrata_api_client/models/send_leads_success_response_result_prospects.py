...
class SendLeadsSuccessResponseResultProspects(BaseModel):
    """
    Information about the prospects.
    """ # noqa: E501
    prospect: Optional[List[SendLeadsSuccessResponseResultProspectsProspectInner]] = Field(default=None, description="A list of prospect entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prospect": [SendLeadsSuccessResponseResultProspectsProspectInner.from_dict(_item) for _item in obj["prospect"]] if obj.get("prospect") is not None else None
        })
        return _obj
