...
class GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLabors(BaseModel):
    """
    GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLabors
    """ # noqa: E501
    labor: Optional[List[GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsLaborInner]] = None
    sub_total: Optional[GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal] = Field(default=None, alias="subTotal")
    __properties: ClassVar[List[str]] = ["labor", "subTotal"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in labor (list)
        _items = []
        if self.labor:
            for _item in self.labor:
                if _item:
                    _items.append(_item.to_dict())
            _dict['labor'] = _items
        # override the default output from pydantic by calling `to_dict()` of sub_total
        if self.sub_total:
            _dict['subTotal'] = self.sub_total.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labor": [GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsLaborInner.from_dict(_item) for _item in obj["labor"]] if obj.get("labor") is not None else None,
            "subTotal": GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerLaborsSubTotal.from_dict(obj["subTotal"]) if obj.get("subTotal") is not None else None
        })
        return _obj
