...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRent(BaseModel):
    """
    Market rent details of the floor plan
    """ # noqa: E501
    attributes: Optional[GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanMarketRentAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
