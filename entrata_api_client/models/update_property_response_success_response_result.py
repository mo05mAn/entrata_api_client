...
class UpdatePropertyResponseSuccessResponseResult(BaseModel):
    """
    UpdatePropertyResponseSuccessResponseResult
    """ # noqa: E501
    testimonials: UpdatePropertyResponseSuccessResponseResultTestimonials
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testimonials": UpdatePropertyResponseSuccessResponseResultTestimonials.from_dict(obj["testimonials"]) if obj.get("testimonials") is not None else None
        })
        return _obj
