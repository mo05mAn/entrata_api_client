...
class SendInvoicesR1SuccessResponseResult(BaseModel):
    """
    SendInvoicesR1SuccessResponseResult
    """ # noqa: E501
    ap_batch: Optional[SendInvoicesR1SuccessResponseResultApBatch] = Field(default=None, alias="ApBatch")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ApBatch": SendInvoicesR1SuccessResponseResultApBatch.from_dict(obj["ApBatch"]) if obj.get("ApBatch") is not None else None
        })
        return _obj
