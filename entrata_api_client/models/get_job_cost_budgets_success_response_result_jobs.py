...
class GetJobCostBudgetsSuccessResponseResultJobs(BaseModel):
    """
    GetJobCostBudgetsSuccessResponseResultJobs
    """ # noqa: E501
    job: List[GetJobCostBudgetsSuccessResponseResultJobsJobInner] = Field(description="A list of jobs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "job": [GetJobCostBudgetsSuccessResponseResultJobsJobInner.from_dict(_item) for _item in obj["job"]] if obj.get("job") is not None else None
        })
        return _obj
