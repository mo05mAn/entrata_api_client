...
class MarkInvoicesExportedMethodParams(BaseModel):
    """
    MarkInvoicesExportedMethodParams
    """ # noqa: E501
    line_item_id: StrictInt = Field(description="This is a required field. This field accepts comma seperated multiple values.", alias="lineItemId")
    __properties: ClassVar[List[str]] = ["lineItemId"]
