...
class GetVendorPickListsSuccessResponseResultApPayeeTypes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultApPayeeTypes
    """ # noqa: E501
    ap_payee_type: Optional[List[GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInner]] = Field(default=None, alias="apPayeeType")
    __properties: ClassVar[List[str]] = ["apPayeeType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_payee_type (list)
        _items = []
        if self.ap_payee_type:
            for _item in self.ap_payee_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['apPayeeType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apPayeeType": [GetVendorPickListsSuccessResponseResultApPayeeTypesApPayeeTypeInner.from_dict(_item) for _item in obj["apPayeeType"]] if obj.get("apPayeeType") is not None else None
        })
        return _obj
