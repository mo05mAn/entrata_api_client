...
class GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerLineItems(BaseModel):
    """
    GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerLineItems
    """ # noqa: E501
    line_item: List[GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerLineItemsLineItemInner] = Field(alias="lineItem")
    __properties: ClassVar[List[str]] = ["lineItem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in line_item (list)
        _items = []
        if self.line_item:
            for _item in self.line_item:
                if _item:
                    _items.append(_item.to_dict())
            _dict['lineItem'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lineItem": [GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerLineItemsLineItemInner.from_dict(_item) for _item in obj["lineItem"]] if obj.get("lineItem") is not None else None
        })
        return _obj
