...
class GetWorkOrdersSuccessResponseResultWorkOrders(BaseModel):
    """
    GetWorkOrdersSuccessResponseResultWorkOrders
    """ # noqa: E501
    work_order: List[GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner] = Field(alias="workOrder")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workOrder": [GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInner.from_dict(_item) for _item in obj["workOrder"]] if obj.get("workOrder") is not None else None
        })
        return _obj
