...
class SendLeadsSuccessResponseResult(BaseModel):
    """
    The result data of the request.
    """ # noqa: E501
    prospects: Optional[SendLeadsSuccessResponseResultProspects] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prospects": SendLeadsSuccessResponseResultProspects.from_dict(obj["prospects"]) if obj.get("prospects") is not None else None
        })
        return _obj
