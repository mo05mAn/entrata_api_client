...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServices(BaseModel):
    """
    The list of services available with the lease.
    """ # noqa: E501
    service: Optional[List[GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServicesServiceInner]] = Field(default=None, description="A list of services.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "service": [GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServicesServiceInner.from_dict(_item) for _item in obj["service"]] if obj.get("service") is not None else None
        })
        return _obj
