...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertyFloorplansPropertyFloorplanInnerAttributes(BaseModel):
    """
    Floorplan attributes
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Floorplan ID", alias="Id")
    name: Optional[StrictStr] = Field(default=None, description="Floorplan name", alias="Name")
