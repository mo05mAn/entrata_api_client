...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyID(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyID
    """ # noqa: E501
    identification: GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification = Field(alias="Identification")
    ...
    __properties: ClassVar[List[str]] = ["Identification", "MarketingName", "LegalName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
