...
class GetAmenitiesMethodParams(BaseModel):
    """
    ...
    unit_number: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Unit Number", alias="unitNumber")
    charge_code_type_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values.", alias="chargeCodeTypeIds")
    __properties: ClassVar[List[str]] = ["propertyId", "unitNumber", "chargeCodeTypeIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chargeCodeTypeIds": obj.get("chargeCodeTypeIds")
        })
        return _obj
