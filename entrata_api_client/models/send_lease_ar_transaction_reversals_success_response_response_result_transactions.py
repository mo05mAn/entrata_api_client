...
class SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions(BaseModel):
    """
    SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactions
    """ # noqa: E501
    transaction: List[SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner] = Field(alias="Transaction")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Transaction": [SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInner.from_dict(_item) for _item in obj["Transaction"]] if obj.get("Transaction") is not None else None
        })
        return _obj
