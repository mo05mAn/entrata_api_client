...
class GetCustomersSuccessResponseResultCustomersCustomerInnerVehicles(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerVehicles
    """ # noqa: E501
    vehicle: List[GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner] = Field(alias="Vehicle")
    __properties: ClassVar[List[str]] = ["Vehicle"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in vehicle (list)
        _items = []
        if self.vehicle:
            for _item in self.vehicle:
                if _item:
                    _items.append(_item.to_dict())
            _dict['Vehicle'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Vehicle": [GetCustomersSuccessResponseResultCustomersCustomerInnerVehiclesVehicleInner.from_dict(_item) for _item in obj["Vehicle"]] if obj.get("Vehicle") is not None else None
        })
        return _obj
