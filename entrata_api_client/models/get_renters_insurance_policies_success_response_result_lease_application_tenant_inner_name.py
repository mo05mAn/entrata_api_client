...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerName
    """ # noqa: E501
    first_name: StrictStr = Field(description="Tenant's first name", alias="FirstName")
    last_name: StrictStr = Field(description="Tenant's last name", alias="LastName")
