...
class GetCustomerTestimonialsMethodParams(BaseModel):
    """
    ...
    from_date: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value. This will fetch the testimonials from this date", alias="fromDate")
    to_date: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value. This will fetch the testimonials until this date", alias="toDate")
    __properties: ClassVar[List[str]] = ["propertyId", "isApproved", "fromDate", "toDate"]
