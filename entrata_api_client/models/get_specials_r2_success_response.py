...
class GetSpecialsR2SuccessResponse(BaseModel):
    """
    GetSpecialsR2SuccessResponse
    """ # noqa: E501
    specials: GetSpecialsR2SuccessResponseSpecials
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "specials": GetSpecialsR2SuccessResponseSpecials.from_dict(obj["specials"]) if obj.get("specials") is not None else None
        })
        return _obj
