...
class GetLeadPickListsR1SuccessResponseResponseResultEventResults(BaseModel):
    """
    Event results associated with the request.
    """ # noqa: E501
    event_result: Optional[List[GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner]] = Field(default=None, description="A list of event results.", alias="EventResult")
    __properties: ClassVar[List[str]] = ["EventResult"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in event_result (list)
        _items = []
        if self.event_result:
            for _item in self.event_result:
                if _item:
                    _items.append(_item.to_dict())
            _dict['EventResult'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "EventResult": [GetLeadPickListsR1SuccessResponseResponseResultEventResultsEventResultInner.from_dict(_item) for _item in obj["EventResult"]] if obj.get("EventResult") is not None else None
        })
        return _obj
