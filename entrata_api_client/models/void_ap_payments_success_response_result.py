...
class VoidApPaymentsSuccessResponseResult(BaseModel):
    """
    VoidApPaymentsSuccessResponseResult
    """ # noqa: E501
    ap_payments: Optional[VoidApPaymentsSuccessResponseResultApPayments] = Field(default=None, alias="apPayments")
    __properties: ClassVar[List[str]] = ["apPayments"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ap_payments
        if self.ap_payments:
            _dict['apPayments'] = self.ap_payments.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apPayments": VoidApPaymentsSuccessResponseResultApPayments.from_dict(obj["apPayments"]) if obj.get("apPayments") is not None else None
        })
        return _obj
