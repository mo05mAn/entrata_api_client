...
class GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItemsLineItemInvoices(BaseModel):
    """
    GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItemsLineItemInvoices
    """ # noqa: E501
    invoice: Optional[List[GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItemsLineItemInvoicesInvoiceInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoice": [GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItemsLineItemInvoicesInvoiceInner.from_dict(_item) for _item in obj["invoice"]] if obj.get("invoice") is not None else None
        })
        return _obj
