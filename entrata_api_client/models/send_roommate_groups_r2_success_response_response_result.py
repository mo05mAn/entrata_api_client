...
class SendRoommateGroupsR2SuccessResponseResponseResult(BaseModel):
    """
    SendRoommateGroupsR2SuccessResponseResponseResult
    """ # noqa: E501
    roommate_groups: List[SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner] = Field(alias="roommateGroups")
    __properties: ClassVar[List[str]] = ["roommateGroups"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in roommate_groups (list)
        _items = []
        if self.roommate_groups:
            for _item in self.roommate_groups:
                if _item:
                    _items.append(_item.to_dict())
            _dict['roommateGroups'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roommateGroups": [SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner.from_dict(_item) for _item in obj["roommateGroups"]] if obj.get("roommateGroups") is not None else None
        })
        return _obj
