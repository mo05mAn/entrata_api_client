...
class GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerInvoicePayments(BaseModel):
    """
    GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerInvoicePayments
    """ # noqa: E501
    invoice_payment: List[GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerInvoicePaymentsInvoicePaymentInner] = Field(alias="invoicePayment")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoicePayment": [GetInvoicesR2SuccessResponseResultInvoicesInvoiceInnerInvoicePaymentsInvoicePaymentInner.from_dict(_item) for _item in obj["invoicePayment"]] if obj.get("invoicePayment") is not None else None
        })
        return _obj
