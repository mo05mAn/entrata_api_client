...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInnerSquareFeet(BaseModel):
    """
    Square footage of the floor plan
    """ # noqa: E501
    avg: Optional[StrictInt] = Field(default=None, description="Average square footage", alias="Avg")
    max: Optional[StrictInt] = Field(default=None, description="Maximum square footage", alias="Max")
    min: Optional[StrictInt] = Field(default=None, description="Minimum square footage", alias="Min")
