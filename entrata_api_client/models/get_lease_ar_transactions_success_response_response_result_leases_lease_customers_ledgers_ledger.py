...
class GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger(BaseModel):
    """
    GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the ledger.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the ledger associated with the lease.")
    balance: Optional[StrictInt] = Field(default=None, description="The current balance of the ledger.")
    past_due_balance: Optional[StrictInt] = Field(default=None, description="The overdue balance of the ledger.", alias="pastDueBalance")
    write_off: Optional[StrictInt] = Field(default=None, description="The amount that has been written off from the ledger.", alias="writeOff")
    transactions: Optional[GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedgerTransactions] = None
    __properties: ClassVar[List[str]] = ["id", "name", "balance", "pastDueBalance", "writeOff", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pastDueBalance": obj.get("pastDueBalance"),
            "writeOff": obj.get("writeOff"),
            "transactions": GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedgerTransactions.from_dict(obj["transactions"]) if obj.get("transactions") is not None else None
        })
        return _obj
