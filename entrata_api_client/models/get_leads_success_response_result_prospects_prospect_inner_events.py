...
class GetLeadsSuccessResponseResultProspectsProspectInnerEvents(BaseModel):
    """
    GetLeadsSuccessResponseResultProspectsProspectInnerEvents
    """ # noqa: E501
    event: List[GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event": [GetLeadsSuccessResponseResultProspectsProspectInnerEventsEventInner.from_dict(_item) for _item in obj["event"]] if obj.get("event") is not None else None
        })
        return _obj
