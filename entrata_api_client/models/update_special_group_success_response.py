...
class UpdateSpecialGroupSuccessResponse(BaseModel):
    """
    UpdateSpecialGroupSuccessResponse
    """ # noqa: E501
    response: UpdateSpecialGroupSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": UpdateSpecialGroupSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
