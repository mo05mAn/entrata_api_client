...
class MarkInvoicesExportedSuccessResponseResult(BaseModel):
    """
    MarkInvoicesExportedSuccessResponseResult
    """ # noqa: E501
    success: Optional[StrictStr] = Field(default=None, description="Message indicating the success of the export action.")
