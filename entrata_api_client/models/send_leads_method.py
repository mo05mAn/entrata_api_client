...
class SendLeadsMethod(BaseModel):
    """
    SendLeadsMethod
    """ # noqa: E501
    name: StrictStr
    version: Optional[StrictStr] = None
    params: Optional[SendLeadsMethodParams] = None
    __properties: ClassVar[List[str]] = ["name", "version", "params"]

    @field_validator('name')
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['sendLeads']):
            raise ValueError("must be one of enum values ('sendLeads')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": SendLeadsMethodParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
