...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerProperty(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerProperty
    """ # noqa: E501
    identification: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyIdentification = Field(alias="Identification")
    marketing_name: StrictStr = Field(description="Marketing name of the property", alias="MarketingName")
    address: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress = Field(alias="Address")
    __properties: ClassVar[List[str]] = ["Identification", "MarketingName", "Address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "MarketingName": obj.get("MarketingName"),
            "Address": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerPropertyAddress.from_dict(obj["Address"]) if obj.get("Address") is not None else None
        })
        return _obj
