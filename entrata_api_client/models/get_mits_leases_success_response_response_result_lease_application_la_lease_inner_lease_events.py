...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEvents
    """ # noqa: E501
    lease_event: List[GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEventsLeaseEventInner] = Field(alias="LeaseEvent")
    __properties: ClassVar[List[str]] = ["LeaseEvent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lease_event (list)
        _items = []
        if self.lease_event:
            for _item in self.lease_event:
                if _item:
                    _items.append(_item.to_dict())
            _dict['LeaseEvent'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LeaseEvent": [GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerLeaseEventsLeaseEventInner.from_dict(_item) for _item in obj["LeaseEvent"]] if obj.get("LeaseEvent") is not None else None
        })
        return _obj
