...
class SendRentersInsurancePoliciesR1MethodParams(BaseModel):
    """
    ...
    customer_id: StrictInt = Field(description="This is a required field. This field accepts single value. customerId", alias="customerId")
    ...
    __properties: ClassVar[List[str]] = ["propertyId", "id", "leaseId", "customerId", "provider", "policyNumber", "startDate", "endDate", "liability"]
