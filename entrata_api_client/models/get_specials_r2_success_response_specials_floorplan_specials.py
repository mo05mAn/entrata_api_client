...
class GetSpecialsR2SuccessResponseSpecialsFloorplanSpecials(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsFloorplanSpecials
    """ # noqa: E501
    special: GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "special": GetSpecialsR2SuccessResponseSpecialsFloorplanSpecialsSpecial.from_dict(obj["special"]) if obj.get("special") is not None else None
        })
        return _obj
