...
class SendApplicationEmployersSuccessResponseResponse(BaseModel):
    """
    SendApplicationEmployersSuccessResponseResponse
    """ # noqa: E501
    request_id: Optional[StrictStr] = Field(default=None, description="An arbitrary value sent with the request.", alias="requestId")
    code: StrictInt = Field(description="Successful response code.")
    result: SendApplicationEmployersSuccessResponseResponseResult
    __properties: ClassVar[List[str]] = ["requestId", "code", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": SendApplicationEmployersSuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
