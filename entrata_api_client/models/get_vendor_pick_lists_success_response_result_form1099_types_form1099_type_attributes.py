...
class GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultForm1099TypesForm1099TypeAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the 1099 form type.")
    name: StrictStr = Field(description="Name of the 1099 form type.")
