...
class GetLeasingCenterPickListsMethod(BaseModel):
    """
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['getLeasingCenterPickLists']):
            raise ValueError("must be one of enum values ('getLeasingCenterPickLists')")
        return value
