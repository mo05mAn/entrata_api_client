...
class GetLeaseArTransactionsSuccessResponseResponseResultLeases(BaseModel):
    """
    GetLeaseArTransactionsSuccessResponseResponseResultLeases
    """ # noqa: E501
    lease: GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lease": GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease.from_dict(obj["lease"]) if obj.get("lease") is not None else None
        })
        return _obj
