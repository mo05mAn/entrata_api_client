...
class GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInner(BaseModel):
    """
    GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the GL account.")
    account_name: StrictStr = Field(description="The name of the GL account.", alias="accountName")
    account_number: StrictStr = Field(description="The account number for the GL account.", alias="accountNumber")
    gl_totals: GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerGlTotals = Field(alias="glTotals")
    budget_months: GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerBudgetMonths = Field(alias="budgetMonths")
    __properties: ClassVar[List[str]] = ["id", "accountName", "accountNumber", "glTotals", "budgetMonths"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of gl_totals
        if self.gl_totals:
            _dict['glTotals'] = self.gl_totals.to_dict()
        # override the default output from pydantic by calling `to_dict()` of budget_months
        if self.budget_months:
            _dict['budgetMonths'] = self.budget_months.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "glTotals": GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerGlTotals.from_dict(obj["glTotals"]) if obj.get("glTotals") is not None else None,
            "budgetMonths": GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerBudgetMonths.from_dict(obj["budgetMonths"]) if obj.get("budgetMonths") is not None else None
        })
        return _obj
