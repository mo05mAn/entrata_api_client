...
class SendLeaseDocumentsRequestBodyMethodParamsFiles(BaseModel):
    """
    SendLeaseDocumentsRequestBodyMethodParamsFiles
    """ # noqa: E501
    file: List[SendLeaseDocumentsRequestBodyMethodParamsFilesFileInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "file": [SendLeaseDocumentsRequestBodyMethodParamsFilesFileInner.from_dict(_item) for _item in obj["file"]] if obj.get("file") is not None else None
        })
        return _obj
