...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactions(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactions
    """ # noqa: E501
    transactions: List[GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInner] = Field(alias="Transactions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Transactions": [GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInner.from_dict(_item) for _item in obj["Transactions"]] if obj.get("Transactions") is not None else None
        })
        return _obj
