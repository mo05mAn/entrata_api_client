...
class GetFinancialPickListR2SuccessResponseResultGlTreeTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlTreeTypes
    """ # noqa: E501
    gl_tree_type: List[GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner] = Field(description="A list of GL tree types.", alias="glTreeType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glTreeType": [GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner.from_dict(_item) for _item in obj["glTreeType"]] if obj.get("glTreeType") is not None else None
        })
        return _obj
