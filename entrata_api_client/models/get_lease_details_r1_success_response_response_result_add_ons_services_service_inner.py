...
class GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner
    """ # noqa: E501
    add_on_type: StrictStr = Field(description="Type of the service.", alias="addOnType")
    add_on_category: StrictStr = Field(description="Category of the service.", alias="addOnCategory")
    add_on_group: Optional[StrictStr] = Field(default=None, description="Group the service belongs to.", alias="addOnGroup")
    add_on_name: StrictStr = Field(description="Name of the service.", alias="addOnName")
    lease_status_type: StrictStr = Field(description="Lease status of the service.", alias="leaseStatusType")
    start_date: StrictStr = Field(description="Start date of the service.", alias="startDate")
    end_date: StrictStr = Field(description="End date of the service.", alias="endDate")
    agent: StrictStr = Field(description="Agent responsible for the service.")
