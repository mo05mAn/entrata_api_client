...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyClientIdentification(BaseModel):
    """
    GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyClientIdentification
    """ # noqa: E501
    id_value: StrictInt = Field(description="The ID value of the property client", alias="IDValue")
