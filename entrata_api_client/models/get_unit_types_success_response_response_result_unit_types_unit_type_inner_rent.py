...
class GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRent(BaseModel):
    """
    GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRent
    """ # noqa: E501
    term_rent: List[GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRentTermRentInner] = Field(description="List of available rent terms for the unit", alias="termRent")
    __properties: ClassVar[List[str]] = ["termRent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in term_rent (list)
        _items = []
        if self.term_rent:
            for _item in self.term_rent:
                if _item:
                    _items.append(_item.to_dict())
            _dict['termRent'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "termRent": [GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRentTermRentInner.from_dict(_item) for _item in obj["termRent"]] if obj.get("termRent") is not None else None
        })
        return _obj
