...
class GetArCodesSuccessResponseResponseResultArcodes(BaseModel):
    """
    GetArCodesSuccessResponseResponseResultArcodes
    """ # noqa: E501
    arcode: List[GetArCodesSuccessResponseResponseResultArcodesArcodeInner]
    __properties: ClassVar[List[str]] = ["arcode"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in arcode (list)
        _items = []
        if self.arcode:
            for _item in self.arcode:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arcode": [GetArCodesSuccessResponseResponseResultArcodesArcodeInner.from_dict(_item) for _item in obj["arcode"]] if obj.get("arcode") is not None else None
        })
        return _obj
