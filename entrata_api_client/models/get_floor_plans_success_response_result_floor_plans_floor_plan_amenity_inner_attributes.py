...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanAmenityInnerAttributes(BaseModel):
    """
    Attributes related to the amenity
    """ # noqa: E501
    amenity_type: Optional[StrictStr] = Field(default=None, description="Type of amenity", alias="AmenityType")
