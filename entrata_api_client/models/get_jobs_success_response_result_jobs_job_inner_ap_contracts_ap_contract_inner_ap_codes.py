...
class GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodes(BaseModel):
    """
    GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodes
    """ # noqa: E501
    ap_code: List[GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner] = Field(description="A list of accounts payable codes associated with the AP contract.", alias="apCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apCode": [GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner.from_dict(_item) for _item in obj["apCode"]] if obj.get("apCode") is not None else None
        })
        return _obj
