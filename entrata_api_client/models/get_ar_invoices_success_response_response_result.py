...
class GetArInvoicesSuccessResponseResponseResult(BaseModel):
    """
    GetArInvoicesSuccessResponseResponseResult
    """ # noqa: E501
    ar_invoices: GetArInvoicesSuccessResponseResponseResultArInvoices = Field(alias="arInvoices")
    __properties: ClassVar[List[str]] = ["arInvoices"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ar_invoices
        if self.ar_invoices:
            _dict['arInvoices'] = self.ar_invoices.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arInvoices": GetArInvoicesSuccessResponseResponseResultArInvoices.from_dict(obj["arInvoices"]) if obj.get("arInvoices") is not None else None
        })
        return _obj
