...
class GetQuotesSuccessResponseResult(BaseModel):
    """
    ...
    applications: Optional[GetQuotesSuccessResponseResultApplications] = None
    __properties: ClassVar[List[str]] = ["currencyCode", "applications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "applications": GetQuotesSuccessResponseResultApplications.from_dict(obj["applications"]) if obj.get("applications") is not None else None
        })
        return _obj
