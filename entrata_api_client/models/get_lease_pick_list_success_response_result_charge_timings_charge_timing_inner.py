...
class GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner(BaseModel):
    """
    GetLeasePickListSuccessResponseResultChargeTimingsChargeTimingInner
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the charge timing.")
    name: StrictStr = Field(description="Name of the charge timing.")
