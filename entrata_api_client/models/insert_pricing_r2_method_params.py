...
class InsertPricingR2MethodParams(BaseModel):
    """
    ...
    pricing: List[InsertPricingR2MethodParamsPricingInner] = Field(description="Array of pricing objects")
    __properties: ClassVar[List[str]] = ["propertyId", "pricing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pricing": [InsertPricingR2MethodParamsPricingInner.from_dict(_item) for _item in obj["pricing"]] if obj.get("pricing") is not None else None
        })
        return _obj
