...
class GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInnerApplications(BaseModel):
    """
    List of applications for the lease interval
    """ # noqa: E501
    application: List[GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInnerApplicationsApplicationInner] = Field(description="List of applications")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "application": [GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInnerApplicationsApplicationInner.from_dict(_item) for _item in obj["application"]] if obj.get("application") is not None else None
        })
        return _obj
