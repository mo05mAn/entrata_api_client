...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertySearchAreasSearchAreasSearchAreaInnerAttributes(BaseModel):
    """
    Search area attributes
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Search area ID", alias="Id")
    company_search_area_id: Optional[StrictInt] = Field(default=None, description="Company-specific search area ID", alias="CompanySearchAreaId")
    __properties: ClassVar[List[str]] = ["Id", "CompanySearchAreaId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Id": obj.get("Id"),
            "CompanySearchAreaId": obj.get("CompanySearchAreaId")
        })
        return _obj
