...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyConcessionInnerAttributes(BaseModel):
    """
    Attributes related to the concession
    """ # noqa: E501
    active: Optional[StrictStr] = Field(default=None, description="Indicates if the concession is active", alias="Active")
