...
class GetBudgetsSuccessResponseResultPropertiesPropertyInner(BaseModel):
    """
    ...
    budgets: GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgets
    __properties: ClassVar[List[str]] = ["propertyId", "propertyName", "budgets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "budgets": GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgets.from_dict(obj["budgets"]) if obj.get("budgets") is not None else None
        })
        return _obj
