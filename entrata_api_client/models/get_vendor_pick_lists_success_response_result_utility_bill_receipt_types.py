...
class GetVendorPickListsSuccessResponseResultUtilityBillReceiptTypes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultUtilityBillReceiptTypes
    """ # noqa: E501
    utility_bill_receipt_type: Optional[List[GetVendorPickListsSuccessResponseResultUtilityBillReceiptTypesUtilityBillReceiptTypeInner]] = Field(default=None, alias="utilityBillReceiptType")
    __properties: ClassVar[List[str]] = ["utilityBillReceiptType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in utility_bill_receipt_type (list)
        _items = []
        if self.utility_bill_receipt_type:
            for _item in self.utility_bill_receipt_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['utilityBillReceiptType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "utilityBillReceiptType": [GetVendorPickListsSuccessResponseResultUtilityBillReceiptTypesUtilityBillReceiptTypeInner.from_dict(_item) for _item in obj["utilityBillReceiptType"]] if obj.get("utilityBillReceiptType") is not None else None
        })
        return _obj
