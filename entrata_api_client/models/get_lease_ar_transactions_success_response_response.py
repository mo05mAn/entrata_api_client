...
class GetLeaseArTransactionsSuccessResponseResponse(BaseModel):
    """
    GetLeaseArTransactionsSuccessResponseResponse
    """ # noqa: E501
    request_id: Optional[StrictStr] = Field(default=None, description="An arbitrary identifier used to trace or track the request.", alias="requestId")
    code: StrictInt = Field(description="Successful response code.")
    result: GetLeaseArTransactionsSuccessResponseResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetLeaseArTransactionsSuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
