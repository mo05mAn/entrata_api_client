...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnit(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnit
    """ # noqa: E501
    identification: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnitIdentification = Field(alias="Identification")
    marketing_name: StrictStr = Field(description="Unit marketing name", alias="MarketingName")
    __properties: ClassVar[List[str]] = ["Identification", "MarketingName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnitIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
