...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotes(BaseModel):
    """
    The list of quotes associated with the application.
    """ # noqa: E501
    quote: Optional[List[GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner]] = Field(default=None, description="A list of quotes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quote": [GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInner.from_dict(_item) for _item in obj["quote"]] if obj.get("quote") is not None else None
        })
        return _obj
