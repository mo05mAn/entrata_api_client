...
class GetLeaseDetailsR1SuccessResponseResponseResultAddOnsRentableItemsRentableItemInner(BaseModel):
    """
    ...
    add_on_group: Optional[StrictStr] = Field(default=None, description="Group the rentable item belongs to.", alias="addOnGroup")
    add_on_name: StrictStr = Field(description="Name of the rentable item.", alias="addOnName")
    lease_status_type: StrictStr = Field(description="Lease status of the rentable item.", alias="leaseStatusType")
    start_date: StrictStr = Field(description="Start date of the rentable item.", alias="startDate")
    end_date: StrictStr = Field(description="End date of the rentable item.", alias="endDate")
    agent: StrictStr = Field(description="Agent responsible for the rentable item.")
    __properties: ClassVar[List[str]] = ["addOnType", "addOnCategory", "addOnGroup", "addOnName", "leaseStatusType", "startDate", "endDate", "agent"]
