...
class GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgets(BaseModel):
    """
    GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgets
    """ # noqa: E501
    budget: List[GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInner] = Field(description="A list of budget records for the property.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budget": [GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInner.from_dict(_item) for _item in obj["budget"]] if obj.get("budget") is not None else None
        })
        return _obj
