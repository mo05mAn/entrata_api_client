...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInner(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInner
    """ # noqa: E501
    resident_type: StrictStr = Field(description="Type of the resident", alias="ResidentType")
    identification: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification = Field(alias="Identification")
    lease_id: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseID = Field(alias="LeaseID")
    name: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName = Field(alias="Name")
    residence: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerResidence = Field(alias="Residence")
    phone: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone = Field(alias="Phone")
    __properties: ClassVar[List[str]] = ["ResidentType", "Identification", "LeaseID", "Name", "Residence", "Phone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ResidentType": obj.get("ResidentType"),
            "Identification": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "LeaseID": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseID.from_dict(obj["LeaseID"]) if obj.get("LeaseID") is not None else None,
            "Name": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerName.from_dict(obj["Name"]) if obj.get("Name") is not None else None,
            "Residence": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerResidence.from_dict(obj["Residence"]) if obj.get("Residence") is not None else None,
            "Phone": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone.from_dict(obj["Phone"]) if obj.get("Phone") is not None else None
        })
        return _obj
