...
class GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL branch type.")
    name: StrictStr = Field(description="The name of the GL branch type.")
