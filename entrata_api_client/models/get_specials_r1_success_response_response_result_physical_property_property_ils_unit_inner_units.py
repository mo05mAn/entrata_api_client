...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnits(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnits
    """ # noqa: E501
    unit: GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnit = Field(alias="Unit")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Unit": GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnit.from_dict(obj["Unit"]) if obj.get("Unit") is not None else None
        })
        return _obj
