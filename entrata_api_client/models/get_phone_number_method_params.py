...
class GetPhoneNumberMethodParams(BaseModel):
    """
    GetPhoneNumberMethodParams
    """ # noqa: E501
    property_ids: Optional[List[StrictInt]] = Field(default=None, description="Array of property IDs", alias="propertyIds")
    switch_code: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="switchCode")
    ref: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts single value.")
    __properties: ClassVar[List[str]] = ["propertyIds", "switchCode", "ref"]
