...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentification(BaseModel):
    """
    Identification information for the floor plan
    """ # noqa: E501
    id_value: Optional[StrictStr] = Field(default=None, description="ID value for the floor plan", alias="IDValue")
    attributes: Optional[GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanIdentificationAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
