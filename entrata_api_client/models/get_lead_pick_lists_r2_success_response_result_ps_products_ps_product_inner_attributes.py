...
class GetLeadPickListsR2SuccessResponseResultPsProductsPsProductInnerAttributes(BaseModel):
    """
    Attributes related to the PS product.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the PS product.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the PS product.")
