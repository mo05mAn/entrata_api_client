...
class GetQuotesMethodParams(BaseModel):
    """
    GetQuotesMethodParams
    """ # noqa: E501
    property_id: StrictInt = Field(description="This is a required field. This field accepts single value. This will fetch quotes associated with the property.", alias="propertyId")
    application_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. This will fetch quotes associated with the property and the application.", alias="applicationId")
    lease_start_date: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value. Format: MM/DD/YYYY, YYYY-MM-DD, MM/DD/YY", alias="leaseStartDate")
    quote_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="quoteId")
    include_expired_quotes: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. If pass value \"1\" then expired quotes should get returned in the response.", alias="includeExpiredQuotes")
    __properties: ClassVar[List[str]] = ["propertyId", "applicationId", "leaseStartDate", "quoteId", "includeExpiredQuotes"]

    @field_validator('include_expired_quotes')
    def include_expired_quotes_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeExpiredQuotes": obj.get("includeExpiredQuotes")
        })
        return _obj
