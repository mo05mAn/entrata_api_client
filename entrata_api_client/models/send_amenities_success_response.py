...
class SendAmenitiesSuccessResponse(BaseModel):
    """
    SendAmenitiesSuccessResponse
    """ # noqa: E501
    response: Optional[SendAmenitiesSuccessResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SendAmenitiesSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
