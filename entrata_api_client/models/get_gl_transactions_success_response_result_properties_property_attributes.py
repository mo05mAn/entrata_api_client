...
class GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes(BaseModel):
    """
    GetGlTransactionsSuccessResponseResultPropertiesPropertyAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the property.")
    name: StrictStr = Field(description="The name of the property.")
    lookup_code: StrictStr = Field(description="The lookup code for the property.", alias="lookupCode")
    business_unit_code: StrictStr = Field(description="The business unit code for the property.", alias="businessUnitCode")
    __properties: ClassVar[List[str]] = ["id", "name", "lookupCode", "businessUnitCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "lookupCode": obj.get("lookupCode"),
            "businessUnitCode": obj.get("businessUnitCode")
        })
        return _obj
