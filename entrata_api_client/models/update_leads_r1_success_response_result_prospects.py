...
class UpdateLeadsR1SuccessResponseResultProspects(BaseModel):
    """
    Information about the prospects.
    """ # noqa: E501
    prospect: Optional[List[UpdateLeadsR1SuccessResponseResultProspectsProspectInner]] = Field(default=None, description="A list of prospect entries.", alias="Prospect")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Prospect": [UpdateLeadsR1SuccessResponseResultProspectsProspectInner.from_dict(_item) for _item in obj["Prospect"]] if obj.get("Prospect") is not None else None
        })
        return _obj
