...
class GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the work order type", alias="Id")
    name: StrictStr = Field(description="Name of the work order type", alias="Name")
