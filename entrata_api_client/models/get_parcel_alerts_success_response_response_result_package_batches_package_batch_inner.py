...
class GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInner(BaseModel):
    """
    GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInner
    """ # noqa: E501
    attributes: GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerAttributes = Field(alias="@attributes")
    total_packages: StrictStr = Field(description="Total number of packages in the batch", alias="totalPackages")
    total_picked_up: StrictStr = Field(description="Total number of packages picked up", alias="totalPickedUp")
    total_delivered: StrictStr = Field(description="Total number of packages delivered", alias="totalDelivered")
    total_print: StrictStr = Field(description="Total number of packages printed", alias="totalPrint")
    total_resend: StrictStr = Field(description="Total number of packages resent", alias="totalResend")
    package_batch_date: StrictStr = Field(description="Date of the package batch", alias="packageBatchDate")
    packages: GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackages
    __properties: ClassVar[List[str]] = ["@attributes", "totalPackages", "totalPickedUp", "totalDelivered", "totalPrint", "totalResend", "packageBatchDate", "packages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "totalPackages": obj.get("totalPackages"),
            "totalPickedUp": obj.get("totalPickedUp"),
            "totalDelivered": obj.get("totalDelivered"),
            "totalPrint": obj.get("totalPrint"),
            "totalResend": obj.get("totalResend"),
            "packageBatchDate": obj.get("packageBatchDate"),
            "packages": GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerPackages.from_dict(obj["packages"]) if obj.get("packages") is not None else None
        })
        return _obj
