...
class SendInvoicesR2SuccessResponseResult(BaseModel):
    """
    SendInvoicesR2SuccessResponseResult
    """ # noqa: E501
    ap_batch: Optional[SendInvoicesR2SuccessResponseResultApBatch] = Field(default=None, alias="apBatch")
    __properties: ClassVar[List[str]] = ["apBatch"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ap_batch
        if self.ap_batch:
            _dict['apBatch'] = self.ap_batch.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apBatch": SendInvoicesR2SuccessResponseResultApBatch.from_dict(obj["apBatch"]) if obj.get("apBatch") is not None else None
        })
        return _obj
