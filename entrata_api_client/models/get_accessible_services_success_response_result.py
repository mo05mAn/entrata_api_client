...
class GetAccessibleServicesSuccessResponseResult(BaseModel):
    """
    The result of the request
    """ # noqa: E501
    services: List[GetAccessibleServicesSuccessResponseResultServicesInner] = Field(description="List of services available")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "services": [GetAccessibleServicesSuccessResponseResultServicesInner.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
