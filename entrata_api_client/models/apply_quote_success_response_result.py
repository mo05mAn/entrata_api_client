...
class ApplyQuoteSuccessResponseResult(BaseModel):
    """
    The result data of the request.
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="The status of the request.")
    quote_id: Optional[StrictStr] = Field(default=None, description="The unique ID of the quote.", alias="quoteId")
    message: Optional[StrictStr] = Field(default=None, description="Message providing additional details about the result.")
    __properties: ClassVar[List[str]] = ["status", "quoteId", "message"]
