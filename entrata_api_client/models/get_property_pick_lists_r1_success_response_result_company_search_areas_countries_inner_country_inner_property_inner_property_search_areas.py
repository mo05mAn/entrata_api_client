...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertySearchAreas(BaseModel):
    """
    Search areas related to the property
    """ # noqa: E501
    search_areas: GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertySearchAreasSearchAreas = Field(alias="SearchAreas")
    __properties: ClassVar[List[str]] = ["SearchAreas"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "SearchAreas": GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertySearchAreasSearchAreas.from_dict(obj["SearchAreas"]) if obj.get("SearchAreas") is not None else None
        })
        return _obj
