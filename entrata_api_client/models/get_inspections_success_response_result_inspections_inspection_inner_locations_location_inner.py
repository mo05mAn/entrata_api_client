...
class GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner(BaseModel):
    """
    GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInner
    """ # noqa: E501
    location_id: StrictStr = Field(description="ID of the location", alias="locationId")
    location_name: StrictStr = Field(description="Name of the location", alias="locationName")
    problems: GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems
    __properties: ClassVar[List[str]] = ["locationId", "locationName", "problems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "problems": GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblems.from_dict(obj["problems"]) if obj.get("problems") is not None else None
        })
        return _obj
