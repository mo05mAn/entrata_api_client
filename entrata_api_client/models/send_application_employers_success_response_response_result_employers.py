...
class SendApplicationEmployersSuccessResponseResponseResultEmployers(BaseModel):
    """
    SendApplicationEmployersSuccessResponseResponseResultEmployers
    """ # noqa: E501
    employers: List[SendApplicationEmployersSuccessResponseResponseResultEmployersEmployersInner]
    __properties: ClassVar[List[str]] = ["employers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in employers (list)
        _items = []
        if self.employers:
            for _item in self.employers:
                if _item:
                    _items.append(_item.to_dict())
            _dict['employers'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "employers": [SendApplicationEmployersSuccessResponseResponseResultEmployersEmployersInner.from_dict(_item) for _item in obj["employers"]] if obj.get("employers") is not None else None
        })
        return _obj
