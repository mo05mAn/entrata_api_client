...
class GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner(BaseModel):
    """
    GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInner
    """ # noqa: E501
    company_application_id: StrictStr = Field(description="The unique identifier for the company application.", alias="companyApplicationId")
    company_application_name: StrictStr = Field(description="The name of the company application.", alias="companyApplicationName")
    application_questions: List[GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInnerApplicationQuestionsInner] = Field(alias="applicationQuestions")
    __properties: ClassVar[List[str]] = ["companyApplicationId", "companyApplicationName", "applicationQuestions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in application_questions (list)
        _items = []
        if self.application_questions:
            for _item in self.application_questions:
                if _item:
                    _items.append(_item.to_dict())
            _dict['applicationQuestions'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "companyApplicationId": obj.get("companyApplicationId"),
            "companyApplicationName": obj.get("companyApplicationName"),
            "applicationQuestions": [GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInnerApplicationQuestionsInner.from_dict(_item) for _item in obj["applicationQuestions"]] if obj.get("applicationQuestions") is not None else None
        })
        return _obj
