...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplication(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplication
    """ # noqa: E501
    var_property: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationProperty = Field(alias="Property")
    tenant: List[GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInner] = Field(alias="Tenant")
    la_lease: List[GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInner] = Field(alias="LA_Lease")
    __properties: ClassVar[List[str]] = ["Property", "Tenant", "LA_Lease"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.tenant:
            for _item in self.tenant:
                if _item:
                    _items.append(_item.to_dict())
            _dict['Tenant'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in la_lease (list)
        _items = []
        if self.la_lease:
            for _item in self.la_lease:
                if _item:
                    _items.append(_item.to_dict())
            _dict['LA_Lease'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationProperty.from_dict(obj["Property"]) if obj.get("Property") is not None else None,
            "Tenant": [GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInner.from_dict(_item) for _item in obj["Tenant"]] if obj.get("Tenant") is not None else None,
            "LA_Lease": [GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInner.from_dict(_item) for _item in obj["LA_Lease"]] if obj.get("LA_Lease") is not None else None
        })
        return _obj
