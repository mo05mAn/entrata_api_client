...
class SendLeaseActivities(BaseModel):
    """
    SendLeaseActivities
    """ # noqa: E501
    ...
    method: SendLeaseActivitiesMethod
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": SendLeaseActivitiesMethod.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
