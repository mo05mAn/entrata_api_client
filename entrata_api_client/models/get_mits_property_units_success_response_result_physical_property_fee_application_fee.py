...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyFeeApplicationFee(BaseModel):
    """
    Application fee details
    """ # noqa: E501
    attributes: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyFeeApplicationFeeAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyFeeApplicationFeeAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
