...
class GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["chargeCode", "chargeUsage", "chargeStartDate", "chargeAmount"]
