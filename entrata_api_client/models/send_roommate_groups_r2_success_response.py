...
class SendRoommateGroupsR2SuccessResponse(BaseModel):
    """
    SendRoommateGroupsR2SuccessResponse
    """ # noqa: E501
    response: SendRoommateGroupsR2SuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SendRoommateGroupsR2SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
