...
class GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems(BaseModel):
    """
    GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems
    """ # noqa: E501
    rentable_item: GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem = Field(alias="rentableItem")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rentableItem": GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItemsRentableItem.from_dict(obj["rentableItem"]) if obj.get("rentableItem") is not None else None
        })
        return _obj
