...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertyFloorplans(BaseModel):
    """
    Floorplans available at the property
    """ # noqa: E501
    property_floorplan: List[GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertyFloorplansPropertyFloorplanInner] = Field(description="List of floorplans", alias="PropertyFloorplan")
    __properties: ClassVar[List[str]] = ["PropertyFloorplan"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in property_floorplan (list)
        _items = []
        if self.property_floorplan:
            for _item in self.property_floorplan:
                if _item:
                    _items.append(_item.to_dict())
            _dict['PropertyFloorplan'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PropertyFloorplan": [GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertyFloorplansPropertyFloorplanInner.from_dict(_item) for _item in obj["PropertyFloorplan"]] if obj.get("PropertyFloorplan") is not None else None
        })
        return _obj
