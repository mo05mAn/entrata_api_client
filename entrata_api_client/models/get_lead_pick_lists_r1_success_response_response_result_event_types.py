...
class GetLeadPickListsR1SuccessResponseResponseResultEventTypes(BaseModel):
    """
    The event types associated with the request.
    """ # noqa: E501
    event_type: Optional[List[GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner]] = Field(default=None, description="A list of event types.", alias="EventType")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in event_type (list)
        _items = []
        if self.event_type:
            for _item in self.event_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['EventType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "EventType": [GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInner.from_dict(_item) for _item in obj["EventType"]] if obj.get("EventType") is not None else None
        })
        return _obj
