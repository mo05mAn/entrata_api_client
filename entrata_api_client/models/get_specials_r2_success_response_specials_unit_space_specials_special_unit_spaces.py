...
class GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecialUnitSpaces(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecialUnitSpaces
    """ # noqa: E501
    unit_space: GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecialUnitSpacesUnitSpace = Field(alias="unitSpace")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitSpace": GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecialUnitSpacesUnitSpace.from_dict(obj["unitSpace"]) if obj.get("unitSpace") is not None else None
        })
        return _obj
