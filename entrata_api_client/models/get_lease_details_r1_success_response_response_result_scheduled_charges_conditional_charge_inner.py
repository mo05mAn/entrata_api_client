...
class GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInner
    """ # noqa: E501
    lease_interval_status: StrictStr = Field(description="The status of the lease interval.", alias="leaseIntervalStatus")
    lease_interval_type: StrictStr = Field(description="Type of lease interval.", alias="leaseIntervalType")
    active_scheduled_charges: GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges = Field(alias="activeScheduledCharges")
    __properties: ClassVar[List[str]] = ["leaseIntervalStatus", "leaseIntervalType", "activeScheduledCharges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "leaseIntervalType": obj.get("leaseIntervalType"),
            "activeScheduledCharges": GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges.from_dict(obj["activeScheduledCharges"]) if obj.get("activeScheduledCharges") is not None else None
        })
        return _obj
