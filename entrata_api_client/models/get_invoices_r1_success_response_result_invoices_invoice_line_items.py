...
class GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItems(BaseModel):
    """
    GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItems
    """ # noqa: E501
    lineitem: List[GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInner] = Field(description="List of line items for the invoice")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lineitem (list)
        _items = []
        if self.lineitem:
            for _item in self.lineitem:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lineitem": [GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInner.from_dict(_item) for _item in obj["lineitem"]] if obj.get("lineitem") is not None else None
        })
        return _obj
