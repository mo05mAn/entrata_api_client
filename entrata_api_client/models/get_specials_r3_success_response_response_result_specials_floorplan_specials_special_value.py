...
class GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue
    """ # noqa: E501
    id: StrictStr = Field(description="The unique ID for the floorplan special.")
    ...
    show_on_website: StrictInt = Field(description="Indicates if the special is shown on the website.", alias="showOnWebsite")
    is_active: StrictInt = Field(description="Indicates if the special is active.", alias="isActive")
    gift_value: StrictStr = Field(description="The value of the gift associated with the special.", alias="giftValue")
    floorplans: GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans
    __properties: ClassVar[List[str]] = ["id", "name", "description", "startDate", "endDate", "showOnWebsite", "isActive", "giftValue", "floorplans"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "floorplans": GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans.from_dict(obj["floorplans"]) if obj.get("floorplans") is not None else None
        })
        return _obj
