...
class SendInvoicesR1SuccessResponseResultApBatch(BaseModel):
    """
    SendInvoicesR1SuccessResponseResultApBatch
    """ # noqa: E501
    attributes: Optional[SendInvoicesR1SuccessResponseResultApBatchAttributes] = Field(default=None, alias="@attributes")
    ap_headers: Optional[SendInvoicesR1SuccessResponseResultApBatchApHeaders] = Field(default=None, alias="ApHeaders")
    __properties: ClassVar[List[str]] = ["@attributes", "ApHeaders"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ap_headers
        if self.ap_headers:
            _dict['ApHeaders'] = self.ap_headers.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": SendInvoicesR1SuccessResponseResultApBatchAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "ApHeaders": SendInvoicesR1SuccessResponseResultApBatchApHeaders.from_dict(obj["ApHeaders"]) if obj.get("ApHeaders") is not None else None
        })
        return _obj
