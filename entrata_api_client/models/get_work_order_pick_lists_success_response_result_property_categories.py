...
class GetWorkOrderPickListsSuccessResponseResultPropertyCategories(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyCategories
    """ # noqa: E501
    category: List[GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner] = Field(alias="Category")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Category": [GetWorkOrderPickListsSuccessResponseResultPropertyCategoriesCategoryInner.from_dict(_item) for _item in obj["Category"]] if obj.get("Category") is not None else None
        })
        return _obj
