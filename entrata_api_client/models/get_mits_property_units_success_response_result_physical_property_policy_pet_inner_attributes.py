...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerAttributes(BaseModel):
    """
    Attributes related to the pet policy
    """ # noqa: E501
    allowed: Optional[StrictStr] = Field(default=None, description="Indicates if pets are allowed", alias="Allowed")
