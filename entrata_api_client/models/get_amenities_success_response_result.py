...
class GetAmenitiesSuccessResponseResult(BaseModel):
    """
    GetAmenitiesSuccessResponseResult
    """ # noqa: E501
    amenities: GetAmenitiesSuccessResponseResultAmenities = Field(alias="Amenities")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Amenities": GetAmenitiesSuccessResponseResultAmenities.from_dict(obj["Amenities"]) if obj.get("Amenities") is not None else None
        })
        return _obj
