...
class GetFinancialPickListR1SuccessResponseResultGlTreeTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlTreeTypes
    """ # noqa: E501
    gl_tree_type: List[GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner] = Field(description="A list of GL tree types.", alias="GlTreeType")
    __properties: ClassVar[List[str]] = ["GlTreeType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_tree_type (list)
        _items = []
        if self.gl_tree_type:
            for _item in self.gl_tree_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['GlTreeType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlTreeType": [GetFinancialPickListR1SuccessResponseResultGlTreeTypesGlTreeTypeInner.from_dict(_item) for _item in obj["GlTreeType"]] if obj.get("GlTreeType") is not None else None
        })
        return _obj
