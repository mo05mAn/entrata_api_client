...
class GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValue(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValue
    """ # noqa: E501
    id: StrictStr = Field(description="The unique ID for the unit type special.")
    ...
    unit_types: GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes = Field(alias="unitTypes")
    __properties: ClassVar[List[str]] = ["id", "name", "showOnWebsite", "isActive", "giftValue", "unitTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitTypes": GetSpecialsR3SuccessResponseResponseResultSpecialsUnitTypeSpecialsSpecialValueUnitTypes.from_dict(obj["unitTypes"]) if obj.get("unitTypes") is not None else None
        })
        return _obj
