...
class GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerBudgetMonths(BaseModel):
    """
    GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerBudgetMonths
    """ # noqa: E501
    budget_month: List[GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerBudgetMonthsBudgetMonthInner] = Field(description="The list of budget months with amounts.", alias="budgetMonth")
    __properties: ClassVar[List[str]] = ["budgetMonth"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in budget_month (list)
        _items = []
        if self.budget_month:
            for _item in self.budget_month:
                if _item:
                    _items.append(_item.to_dict())
            _dict['budgetMonth'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budgetMonth": [GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerBudgetMonthsBudgetMonthInner.from_dict(_item) for _item in obj["budgetMonth"]] if obj.get("budgetMonth") is not None else None
        })
        return _obj
