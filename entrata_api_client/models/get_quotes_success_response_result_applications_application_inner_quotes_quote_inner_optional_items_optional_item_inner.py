...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerOptionalItemsOptionalItemInner(BaseModel):
    """
    GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerOptionalItemsOptionalItemInner
    """ # noqa: E501
    add_on_type_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the add-on type.", alias="addOnTypeId")
    name: Optional[StrictStr] = Field(default=None, description="The name of the optional item.")
    type: Optional[StrictStr] = Field(default=None, description="The type of the optional item.")
    current_rate: Optional[StrictStr] = Field(default=None, description="The current rate for the optional item.", alias="currentRate")
    deposit: Optional[StrictStr] = Field(default=None, description="The deposit amount for the optional item.")
    reservation_fee: Optional[StrictStr] = Field(default=None, description="The reservation fee for the optional item.", alias="reservationFee")
    __properties: ClassVar[List[str]] = ["addOnTypeId", "name", "type", "currentRate", "deposit", "reservationFee"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "type": obj.get("type"),
            "currentRate": obj.get("currentRate"),
            "deposit": obj.get("deposit"),
            "reservationFee": obj.get("reservationFee")
        })
        return _obj
