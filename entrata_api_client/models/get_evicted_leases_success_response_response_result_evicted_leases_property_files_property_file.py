...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile(BaseModel):
    """
    GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile
    """ # noqa: E501
    var_property: GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileProperty = Field(alias="property")
    lease_files: GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFiles = Field(alias="leaseFiles")
    __properties: ClassVar[List[str]] = ["property", "leaseFiles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property": GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileProperty.from_dict(obj["property"]) if obj.get("property") is not None else None,
            "leaseFiles": GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFiles.from_dict(obj["leaseFiles"]) if obj.get("leaseFiles") is not None else None
        })
        return _obj
