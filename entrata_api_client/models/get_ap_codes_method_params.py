...
class GetApCodesMethodParams(BaseModel):
    """
    GetApCodesMethodParams
    """ # noqa: E501
    gl_account_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values.", alias="glAccountIds")
    ap_code_type_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. Currently supporting only job cost (3)", alias="apCodeTypeIds")
    __properties: ClassVar[List[str]] = ["glAccountIds", "apCodeTypeIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glAccountIds": obj.get("glAccountIds"),
            "apCodeTypeIds": obj.get("apCodeTypeIds")
        })
        return _obj
