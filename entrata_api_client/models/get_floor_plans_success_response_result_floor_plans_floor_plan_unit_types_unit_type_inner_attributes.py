...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInnerAttributes(BaseModel):
    """
    Attributes related to the unit type
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the unit type", alias="Id")
