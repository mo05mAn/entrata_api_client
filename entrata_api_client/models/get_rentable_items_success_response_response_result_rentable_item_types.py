...
class GetRentableItemsSuccessResponseResponseResultRentableItemTypes(BaseModel):
    """
    Types of rentable items available
    """ # noqa: E501
    rentable_item_type: GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType = Field(alias="RentableItemType")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rentable_item_type
        if self.rentable_item_type:
            _dict['RentableItemType'] = self.rentable_item_type.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "RentableItemType": GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemType.from_dict(obj["RentableItemType"]) if obj.get("RentableItemType") is not None else None
        })
        return _obj
