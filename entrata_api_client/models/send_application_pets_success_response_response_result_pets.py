...
class SendApplicationPetsSuccessResponseResponseResultPets(BaseModel):
    """
    SendApplicationPetsSuccessResponseResponseResultPets
    """ # noqa: E501
    pet: List[SendApplicationPetsSuccessResponseResponseResultPetsPetInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pet": [SendApplicationPetsSuccessResponseResponseResultPetsPetInner.from_dict(_item) for _item in obj["pet"]] if obj.get("pet") is not None else None
        })
        return _obj
