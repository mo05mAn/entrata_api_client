...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypes(BaseModel):
    """
    Types of units in the floor plan
    """ # noqa: E501
    unit_type: Optional[List[GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner]] = Field(default=None, description="List of unit types", alias="UnitType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "UnitType": [GetFloorPlansSuccessResponseResultFloorPlansFloorPlanUnitTypesUnitTypeInner.from_dict(_item) for _item in obj["UnitType"]] if obj.get("UnitType") is not None else None
        })
        return _obj
