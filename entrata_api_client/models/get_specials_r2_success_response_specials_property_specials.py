...
class GetSpecialsR2SuccessResponseSpecialsPropertySpecials(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsPropertySpecials
    """ # noqa: E501
    special: GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "special": GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial.from_dict(obj["special"]) if obj.get("special") is not None else None
        })
        return _obj
