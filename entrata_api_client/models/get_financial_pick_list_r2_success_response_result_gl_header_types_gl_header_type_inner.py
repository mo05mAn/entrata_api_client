...
class GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL header type.")
    name: StrictStr = Field(description="The name of the GL header type.")
