...
class GetAmenitiesSuccessResponseResultAmenities(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenities
    """ # noqa: E501
    property_amenities: GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities = Field(alias="PropertyAmenities")
    unit_amenities: GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities = Field(alias="UnitAmenities")
    floorplan_amenities: GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenities = Field(alias="FloorplanAmenities")
    unit_type_amenities: GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenities = Field(alias="UnitTypeAmenities")
    __properties: ClassVar[List[str]] = ["PropertyAmenities", "UnitAmenities", "FloorplanAmenities", "UnitTypeAmenities"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of unit_amenities
        if self.unit_amenities:
            _dict['UnitAmenities'] = self.unit_amenities.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PropertyAmenities": GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities.from_dict(obj["PropertyAmenities"]) if obj.get("PropertyAmenities") is not None else None,
            "UnitAmenities": GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities.from_dict(obj["UnitAmenities"]) if obj.get("UnitAmenities") is not None else None,
            "FloorplanAmenities": GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenities.from_dict(obj["FloorplanAmenities"]) if obj.get("FloorplanAmenities") is not None else None,
            "UnitTypeAmenities": GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenities.from_dict(obj["UnitTypeAmenities"]) if obj.get("UnitTypeAmenities") is not None else None
        })
        return _obj
