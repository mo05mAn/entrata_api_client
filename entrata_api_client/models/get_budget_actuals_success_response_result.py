...
class GetBudgetActualsSuccessResponseResult(BaseModel):
    """
    GetBudgetActualsSuccessResponseResult
    """ # noqa: E501
    budget_vs_actuals: GetBudgetActualsSuccessResponseResultBudgetVsActuals = Field(alias="budgetVsActuals")
    __properties: ClassVar[List[str]] = ["budgetVsActuals"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of budget_vs_actuals
        if self.budget_vs_actuals:
            _dict['budgetVsActuals'] = self.budget_vs_actuals.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budgetVsActuals": GetBudgetActualsSuccessResponseResultBudgetVsActuals.from_dict(obj["budgetVsActuals"]) if obj.get("budgetVsActuals") is not None else None
        })
        return _obj
