...
class SendRentersInsurancePoliciesR2SuccessResponse(BaseModel):
    """
    ...
    result: SendRentersInsurancePoliciesR2SuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": SendRentersInsurancePoliciesR2SuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
