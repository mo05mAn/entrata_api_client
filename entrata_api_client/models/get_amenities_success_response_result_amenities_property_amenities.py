...
class GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenities
    """ # noqa: E501
    amenity: List[GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInner] = Field(alias="Amenity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Amenity": [GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInner.from_dict(_item) for _item in obj["Amenity"]] if obj.get("Amenity") is not None else None
        })
        return _obj
