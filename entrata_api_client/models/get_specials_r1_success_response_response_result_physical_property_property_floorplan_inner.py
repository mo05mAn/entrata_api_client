...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInner(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInner
    """ # noqa: E501
    identification: GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerIdentification = Field(alias="Identification")
    name: StrictStr = Field(description="The name of the floorplan.", alias="Name")
    comment: StrictStr = Field(description="A comment about the floorplan.", alias="Comment")
    concession: List[GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerConcessionInner] = Field(description="List of concessions for the floorplan.", alias="Concession")
    __properties: ClassVar[List[str]] = ["Identification", "Name", "Comment", "Concession"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "Name": obj.get("Name"),
            "Comment": obj.get("Comment"),
            "Concession": [GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerConcessionInner.from_dict(_item) for _item in obj["Concession"]] if obj.get("Concession") is not None else None
        })
        return _obj
