...
class GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhonesPhoneInner(BaseModel):
    """
    GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInnerPhonesPhoneInner
    """ # noqa: E501
    phone_type_name: StrictStr = Field(description="Phone type name", alias="phoneTypeName")
    phone_type: StrictStr = Field(description="Type of phone", alias="phoneType")
    phone_number: StrictStr = Field(description="Phone number", alias="phoneNumber")
    country_code: StrictInt = Field(description="Country code of the phone number", alias="countryCode")
    __properties: ClassVar[List[str]] = ["phoneTypeName", "phoneType", "phoneNumber", "countryCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "phoneTypeName": obj.get("phoneTypeName"),
