...
class GetBudgetActuals(BaseModel):
    """
    GetBudgetActuals
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": GetBudgetActualsMethod.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
