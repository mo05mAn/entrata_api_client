...
class GetCustomersSuccessResponseResult(BaseModel):
    """
    GetCustomersSuccessResponseResult
    """ # noqa: E501
    customers: GetCustomersSuccessResponseResultCustomers = Field(alias="Customers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Customers": GetCustomersSuccessResponseResultCustomers.from_dict(obj["Customers"]) if obj.get("Customers") is not None else None
        })
        return _obj
