...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerIdentification(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyFloorplanInnerIdentification
    """ # noqa: E501
    id_value: StrictInt = Field(description="The unique identifier for the floorplan.", alias="IDValue")
