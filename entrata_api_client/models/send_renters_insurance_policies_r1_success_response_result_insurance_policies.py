...
class SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies(BaseModel):
    """
    SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies
    """ # noqa: E501
    insurance_policy: List[SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner] = Field(alias="insurancePolicy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "insurancePolicy": [SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInner.from_dict(_item) for _item in obj["insurancePolicy"]] if obj.get("insurancePolicy") is not None else None
        })
        return _obj
