...
class GetCustomerTestimonialsSuccessResponseResultTestimonials(BaseModel):
    """
    GetCustomerTestimonialsSuccessResponseResultTestimonials
    """ # noqa: E501
    testimonial: List[GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner] = Field(alias="Testimonial")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Testimonial": [GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInner.from_dict(_item) for _item in obj["Testimonial"]] if obj.get("Testimonial") is not None else None
        })
        return _obj
