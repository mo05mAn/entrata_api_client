...
class GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInnerApCodesInnerApCodePostMonthsPostMonthInner(BaseModel):
    """
    GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInnerApCodesInnerApCodePostMonthsPostMonthInner
    """ # noqa: E501
    ap_detail_id: StrictStr = Field(description="The unique identifier for the AP detail.", alias="apDetailId")
    post_month: StrictStr = Field(description="The month in which the AP code is posted.", alias="postMonth")
    monthly_amount: StrictStr = Field(description="The amount for the given month.", alias="monthlyAmount")
    __properties: ClassVar[List[str]] = ["apDetailId", "postMonth", "monthlyAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apDetailId": obj.get("apDetailId"),
            "postMonth": obj.get("postMonth"),
            "monthlyAmount": obj.get("monthlyAmount")
        })
        return _obj
