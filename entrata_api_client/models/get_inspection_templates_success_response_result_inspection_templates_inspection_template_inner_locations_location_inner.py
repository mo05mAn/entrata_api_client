...
class GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInnerLocationsLocationInner(BaseModel):
    """
    GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInnerLocationsLocationInner
    """ # noqa: E501
    maintenance_location_id: StrictStr = Field(description="ID of the maintenance location", alias="maintenanceLocationId")
    location_name: StrictStr = Field(description="Name of the location", alias="locationName")
    problems: GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInnerLocationsLocationInnerProblems
    __properties: ClassVar[List[str]] = ["maintenanceLocationId", "locationName", "problems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "problems": GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInnerLocationsLocationInnerProblems.from_dict(obj["problems"]) if obj.get("problems") is not None else None
        })
        return _obj
