...
class GetRentersInsurancePoliciesSuccessResponseResult(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResult
    """ # noqa: E501
    lease_application: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplication = Field(alias="LeaseApplication")
    __properties: ClassVar[List[str]] = ["LeaseApplication"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of lease_application
        if self.lease_application:
            _dict['LeaseApplication'] = self.lease_application.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LeaseApplication": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplication.from_dict(obj["LeaseApplication"]) if obj.get("LeaseApplication") is not None else None
        })
        return _obj
