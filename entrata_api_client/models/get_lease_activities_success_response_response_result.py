...
class GetLeaseActivitiesSuccessResponseResponseResult(BaseModel):
    """
    GetLeaseActivitiesSuccessResponseResponseResult
    """ # noqa: E501
    events: List[GetLeaseActivitiesSuccessResponseResponseResultEventsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [GetLeaseActivitiesSuccessResponseResponseResultEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
