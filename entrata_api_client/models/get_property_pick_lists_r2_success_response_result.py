...
class GetPropertyPickListsR2SuccessResponseResult(BaseModel):
    """
    Contains properties, search areas, and other relevant data
    """ # noqa: E501
    properties: GetPropertyPickListsR2SuccessResponseResultProperties
    search_area_states: GetPropertyPickListsR2SuccessResponseResultSearchAreaStates = Field(alias="searchAreaStates")
    __properties: ClassVar[List[str]] = ["properties", "searchAreaStates"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of search_area_states
        if self.search_area_states:
            _dict['searchAreaStates'] = self.search_area_states.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": GetPropertyPickListsR2SuccessResponseResultProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "searchAreaStates": GetPropertyPickListsR2SuccessResponseResultSearchAreaStates.from_dict(obj["searchAreaStates"]) if obj.get("searchAreaStates") is not None else None
        })
        return _obj
