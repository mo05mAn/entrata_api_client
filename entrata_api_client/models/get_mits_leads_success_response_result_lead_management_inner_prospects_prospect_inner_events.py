...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEvents(BaseModel):
    """
    A list of events associated with the lead.
    """ # noqa: E501
    event: Optional[List[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInner]] = Field(default=None, description="A list of events.", alias="Event")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Event": [GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInner.from_dict(_item) for _item in obj["Event"]] if obj.get("Event") is not None else None
        })
        return _obj
