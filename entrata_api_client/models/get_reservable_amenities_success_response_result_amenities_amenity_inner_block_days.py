...
class GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDays(BaseModel):
    """
    List of block hours for specific days
    """ # noqa: E501
    block_day: List[GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner] = Field(alias="blockDay")
    __properties: ClassVar[List[str]] = ["blockDay"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in block_day (list)
        _items = []
        if self.block_day:
            for _item in self.block_day:
                if _item:
                    _items.append(_item.to_dict())
            _dict['blockDay'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blockDay": [GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerBlockDaysBlockDayInner.from_dict(_item) for _item in obj["blockDay"]] if obj.get("blockDay") is not None else None
        })
        return _obj
