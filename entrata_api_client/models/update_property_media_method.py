...
class UpdatePropertyMediaMethod(BaseModel):
    """
    UpdatePropertyMediaMethod
    """ # noqa: E501
    name: StrictStr
    params: UpdatePropertyMediaMethodParams
    __properties: ClassVar[List[str]] = ["name", "params"]

    @field_validator('name')
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['updatePropertyMedia']):
            raise ValueError("must be one of enum values ('updatePropertyMedia')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "params": UpdatePropertyMediaMethodParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
