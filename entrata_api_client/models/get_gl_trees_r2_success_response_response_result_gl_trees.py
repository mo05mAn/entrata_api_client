...
class GetGlTreesR2SuccessResponseResponseResultGlTrees(BaseModel):
    """
    GL Tree container object
    """ # noqa: E501
    gl_tree: List[GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner] = Field(description="Array of GL Trees", alias="glTree")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glTree": [GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInner.from_dict(_item) for _item in obj["glTree"]] if obj.get("glTree") is not None else None
        })
        return _obj
