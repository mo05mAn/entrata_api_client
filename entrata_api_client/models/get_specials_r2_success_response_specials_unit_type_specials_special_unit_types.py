...
class GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypes
    """ # noqa: E501
    unit_type: GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypesUnitType = Field(alias="unitType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitType": GetSpecialsR2SuccessResponseSpecialsUnitTypeSpecialsSpecialUnitTypesUnitType.from_dict(obj["unitType"]) if obj.get("unitType") is not None else None
        })
        return _obj
