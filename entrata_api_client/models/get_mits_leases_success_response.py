...
class GetMitsLeasesSuccessResponse(BaseModel):
    """
    GetMitsLeasesSuccessResponse
    """ # noqa: E501
    response: Optional[GetMitsLeasesSuccessResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetMitsLeasesSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
