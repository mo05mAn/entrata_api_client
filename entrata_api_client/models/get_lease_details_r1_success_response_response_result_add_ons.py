...
class GetLeaseDetailsR1SuccessResponseResponseResultAddOns(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResultAddOns
    """ # noqa: E501
    assignable_items: GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems = Field(alias="assignableItems")
    rentable_items: GetLeaseDetailsR1SuccessResponseResponseResultAddOnsRentableItems = Field(alias="rentableItems")
    services: GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices
    __properties: ClassVar[List[str]] = ["assignableItems", "rentableItems", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignableItems": GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems.from_dict(obj["assignableItems"]) if obj.get("assignableItems") is not None else None,
            "rentableItems": GetLeaseDetailsR1SuccessResponseResponseResultAddOnsRentableItems.from_dict(obj["rentableItems"]) if obj.get("rentableItems") is not None else None,
            "services": GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices.from_dict(obj["services"]) if obj.get("services") is not None else None
        })
        return _obj
