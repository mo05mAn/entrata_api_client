...
class GetGlTreesR2SuccessResponse(BaseModel):
    """
    GetGlTreesR2SuccessResponse
    """ # noqa: E501
    response: Optional[GetGlTreesR2SuccessResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetGlTreesR2SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
