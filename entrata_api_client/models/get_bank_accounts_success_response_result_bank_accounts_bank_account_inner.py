...
class GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner(BaseModel):
    """
    GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the bank account.", alias="Id")
    account_name: StrictStr = Field(description="The name of the bank account.", alias="AccountName")
    bank_account_type_id: StrictStr = Field(description="The type ID of the bank account.", alias="BankAccountTypeId")
    property_bank_accounts: GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts = Field(alias="PropertyBankAccounts")
    account_type: StrictStr = Field(description="The type of the bank account.", alias="AccountType")
    check_bank_name: StrictStr = Field(description="The name of the bank associated with checks for the account.", alias="CheckBankName")
    next_check_number: StrictStr = Field(description="The next check number to be issued for the account.", alias="NextCheckNumber")
    __properties: ClassVar[List[str]] = ["Id", "AccountName", "BankAccountTypeId", "PropertyBankAccounts", "AccountType", "CheckBankName", "NextCheckNumber"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of property_bank_accounts
        if self.property_bank_accounts:
            _dict['PropertyBankAccounts'] = self.property_bank_accounts.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BankAccountTypeId": obj.get("BankAccountTypeId"),
            "PropertyBankAccounts": GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccounts.from_dict(obj["PropertyBankAccounts"]) if obj.get("PropertyBankAccounts") is not None else None,
            "AccountType": obj.get("AccountType"),
            "CheckBankName": obj.get("CheckBankName"),
            "NextCheckNumber": obj.get("NextCheckNumber")
        })
        return _obj
