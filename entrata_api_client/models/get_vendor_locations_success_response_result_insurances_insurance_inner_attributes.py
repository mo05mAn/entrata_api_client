...
class GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultInsurancesInsuranceInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the insurance.", alias="Id")
    provider: StrictStr = Field(description="Provider name for the insurance.", alias="Provider")
