...
class GetArInvoicesSuccessResponseResponseResultArInvoices(BaseModel):
    """
    GetArInvoicesSuccessResponseResponseResultArInvoices
    """ # noqa: E501
    ar_invoice: List[GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner] = Field(alias="arInvoice")
    __properties: ClassVar[List[str]] = ["arInvoice"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ar_invoice (list)
        _items = []
        if self.ar_invoice:
            for _item in self.ar_invoice:
                if _item:
                    _items.append(_item.to_dict())
            _dict['arInvoice'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arInvoice": [GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInner.from_dict(_item) for _item in obj["arInvoice"]] if obj.get("arInvoice") is not None else None
        })
        return _obj
