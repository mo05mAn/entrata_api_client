...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeases(BaseModel):
    """
    GetEvictedLeasesSuccessResponseResponseResultEvictedLeases
    """ # noqa: E501
    summary: GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesSummary
    property_files: GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFiles = Field(alias="propertyFiles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summary": GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
            "propertyFiles": GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFiles.from_dict(obj["propertyFiles"]) if obj.get("propertyFiles") is not None else None
        })
        return _obj
