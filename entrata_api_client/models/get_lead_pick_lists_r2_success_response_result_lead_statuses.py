...
class GetLeadPickListsR2SuccessResponseResultLeadStatuses(BaseModel):
    """
    Lead statuses associated with the request.
    """ # noqa: E501
    lead_status: Optional[List[GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner]] = Field(default=None, description="A list of lead statuses.", alias="leadStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leadStatus": [GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner.from_dict(_item) for _item in obj["leadStatus"]] if obj.get("leadStatus") is not None else None
        })
        return _obj
