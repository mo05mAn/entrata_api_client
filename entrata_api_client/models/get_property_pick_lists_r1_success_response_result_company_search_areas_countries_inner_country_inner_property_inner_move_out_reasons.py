...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerMoveOutReasons(BaseModel):
    """
    Reasons for moving out of the property
    """ # noqa: E501
    move_out_reason: List[GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerMoveOutReasonsMoveOutReasonInner] = Field(description="List of move-out reasons", alias="MoveOutReason")
    __properties: ClassVar[List[str]] = ["MoveOutReason"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in move_out_reason (list)
        _items = []
        if self.move_out_reason:
            for _item in self.move_out_reason:
                if _item:
                    _items.append(_item.to_dict())
            _dict['MoveOutReason'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "MoveOutReason": [GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerMoveOutReasonsMoveOutReasonInner.from_dict(_item) for _item in obj["MoveOutReason"]] if obj.get("MoveOutReason") is not None else None
        })
        return _obj
