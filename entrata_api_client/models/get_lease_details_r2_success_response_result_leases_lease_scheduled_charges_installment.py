...
class GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment(BaseModel):
    """
    GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallment
    """ # noqa: E501
    installment_name: StrictStr = Field(description="Name of the installment.", alias="installmentName")
    installment_start_date: StrictStr = Field(description="Start date of the installment.", alias="installmentStartDate")
    installment_end_date: StrictStr = Field(description="End date of the installment.", alias="installmentEndDate")
    charges: GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentCharges
    __properties: ClassVar[List[str]] = ["installmentName", "installmentStartDate", "installmentEndDate", "charges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "installmentName": obj.get("installmentName"),
            "installmentStartDate": obj.get("installmentStartDate"),
            "installmentEndDate": obj.get("installmentEndDate"),
            "charges": GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentCharges.from_dict(obj["charges"]) if obj.get("charges") is not None else None
        })
        return _obj
