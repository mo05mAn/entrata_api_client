...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStatesStateInnerSearchAreaInnerAttributes(BaseModel):
    """
    Search area attributes
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Search area ID", alias="Id")
    name: Optional[StrictStr] = Field(default=None, description="Search area name", alias="Name")
