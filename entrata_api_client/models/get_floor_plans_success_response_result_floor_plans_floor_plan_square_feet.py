...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeet(BaseModel):
    """
    Square footage of the floor plan
    """ # noqa: E501
    attributes: Optional[GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
