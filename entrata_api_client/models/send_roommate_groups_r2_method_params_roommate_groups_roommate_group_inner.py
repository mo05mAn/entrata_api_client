...
class SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner(BaseModel):
    """
    SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner
    """ # noqa: E501
    invitor_application_id: Optional[StrictInt] = Field(default=None, description="Required field unless inviteeApplicationId is provided. This field accepts single value.", alias="invitorApplicationId")
    invitee_application_id: Optional[SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId] = Field(default=None, alias="inviteeApplicationId")
    __properties: ClassVar[List[str]] = ["invitorApplicationId", "inviteeApplicationId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of invitee_application_id
        if self.invitee_application_id:
            _dict['inviteeApplicationId'] = self.invitee_application_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invitorApplicationId": obj.get("invitorApplicationId"),
            "inviteeApplicationId": SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInnerInviteeApplicationId.from_dict(obj["inviteeApplicationId"]) if obj.get("inviteeApplicationId") is not None else None
        })
        return _obj
