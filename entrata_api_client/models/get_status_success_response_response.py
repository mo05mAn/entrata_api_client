...
class GetStatusSuccessResponseResponse(BaseModel):
    """
    GetStatusSuccessResponseResponse
    """ # noqa: E501
    request_id: Optional[StrictStr] = Field(default=None, description="an arbitary value sent with the request.", alias="requestId")
    code: StrictInt
    result: GetStatusSuccessResponseResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetStatusSuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
