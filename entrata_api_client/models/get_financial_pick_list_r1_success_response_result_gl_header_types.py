...
class GetFinancialPickListR1SuccessResponseResultGlHeaderTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlHeaderTypes
    """ # noqa: E501
    gl_header_type: List[GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner] = Field(description="A list of GL header types.", alias="GlHeaderType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlHeaderType": [GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner.from_dict(_item) for _item in obj["GlHeaderType"]] if obj.get("GlHeaderType") is not None else None
        })
        return _obj
