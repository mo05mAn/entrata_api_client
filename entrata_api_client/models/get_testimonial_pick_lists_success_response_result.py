...
class GetTestimonialPickListsSuccessResponseResult(BaseModel):
    """
    GetTestimonialPickListsSuccessResponseResult
    """ # noqa: E501
    testimonial_types: GetTestimonialPickListsSuccessResponseResultTestimonialTypes = Field(alias="TestimonialTypes")
    testimonial_rating_types: GetTestimonialPickListsSuccessResponseResultTestimonialRatingTypes = Field(alias="TestimonialRatingTypes")
    __properties: ClassVar[List[str]] = ["TestimonialTypes", "TestimonialRatingTypes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of testimonial_types
        if self.testimonial_types:
            _dict['TestimonialTypes'] = self.testimonial_types.to_dict()
        # override the default output from pydantic by calling `to_dict()` of testimonial_rating_types
        if self.testimonial_rating_types:
            _dict['TestimonialRatingTypes'] = self.testimonial_rating_types.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "TestimonialTypes": GetTestimonialPickListsSuccessResponseResultTestimonialTypes.from_dict(obj["TestimonialTypes"]) if obj.get("TestimonialTypes") is not None else None,
            "TestimonialRatingTypes": GetTestimonialPickListsSuccessResponseResultTestimonialRatingTypes.from_dict(obj["TestimonialRatingTypes"]) if obj.get("TestimonialRatingTypes") is not None else None
        })
        return _obj
