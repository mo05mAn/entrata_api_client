...
class GetPropertiesSuccessResponseResult(BaseModel):
    """
    Result containing the property details
    """ # noqa: E501
    physical_property: GetPropertiesSuccessResponseResultPhysicalProperty = Field(alias="PhysicalProperty")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PhysicalProperty": GetPropertiesSuccessResponseResultPhysicalProperty.from_dict(obj["PhysicalProperty"]) if obj.get("PhysicalProperty") is not None else None
        })
        return _obj
