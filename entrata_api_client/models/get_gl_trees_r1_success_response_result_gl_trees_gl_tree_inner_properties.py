...
class GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerProperties(BaseModel):
    """
    GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerProperties
    """ # noqa: E501
    var_property: List[GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner] = Field(description="A list of properties associated with the GL tree.", alias="Property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": [GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerPropertiesPropertyInner.from_dict(_item) for _item in obj["Property"]] if obj.get("Property") is not None else None
        })
        return _obj
