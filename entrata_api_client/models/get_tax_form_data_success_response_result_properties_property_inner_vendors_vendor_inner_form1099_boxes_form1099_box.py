...
class GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box(BaseModel):
    """
    GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendorsVendorInnerForm1099BoxesForm1099Box
    """ # noqa: E501
    box_number: StrictStr = Field(description="The box number on the form.", alias="boxNumber")
    box_value: StrictStr = Field(description="The value inside the box on the form.", alias="boxValue")
    __properties: ClassVar[List[str]] = ["boxNumber", "boxValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "boxNumber": obj.get("boxNumber"),
            "boxValue": obj.get("boxValue")
        })
        return _obj
