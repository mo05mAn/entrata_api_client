...
class GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesAmenities(BaseModel):
    """
    GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesAmenities
    """ # noqa: E501
    property_amenities: Optional[GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesAmenitiesPropertyAmenities] = Field(default=None, alias="propertyAmenities")
    __properties: ClassVar[List[str]] = ["propertyAmenities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "propertyAmenities": GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesAmenitiesPropertyAmenities.from_dict(obj["propertyAmenities"]) if obj.get("propertyAmenities") is not None else None
        })
        return _obj
