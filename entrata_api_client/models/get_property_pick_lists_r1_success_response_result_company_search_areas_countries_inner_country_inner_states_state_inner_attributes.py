...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerStatesStateInnerAttributes(BaseModel):
    """
    Additional metadata for the state
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="State code", alias="Code")
    name: Optional[StrictStr] = Field(default=None, description="State name", alias="Name")
