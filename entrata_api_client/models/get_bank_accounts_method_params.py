...
class GetBankAccountsMethodParams(BaseModel):
    """
    GetBankAccountsMethodParams
    """ # noqa: E501
    bank_account_type_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Bank Account Type Identification Number", alias="bankAccountTypeId")
    is_credit_card_account: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="isCreditCardAccount")
    __properties: ClassVar[List[str]] = ["bankAccountTypeId", "isCreditCardAccount"]

    @field_validator('is_credit_card_account')
    def is_credit_card_account_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isCreditCardAccount": obj.get("isCreditCardAccount")
        })
        return _obj
