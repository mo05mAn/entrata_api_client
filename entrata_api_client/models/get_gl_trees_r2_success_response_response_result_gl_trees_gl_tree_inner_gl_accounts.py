...
class GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccounts(BaseModel):
    """
    GL Accounts associated with the GL Tree
    """ # noqa: E501
    gl_account: List[GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner] = Field(description="Array of GL Accounts", alias="glAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glAccount": [GetGlTreesR2SuccessResponseResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner.from_dict(_item) for _item in obj["glAccount"]] if obj.get("glAccount") is not None else None
        })
        return _obj
