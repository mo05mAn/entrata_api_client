...
conf = entrata_api_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://apis.entrata.com/ext/orgs" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("entrata_api_client")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://apis.entrata.com/ext/orgs",
                'description': "US Server",
            },
            {
                'url': "https://apis.entrata.global/ext/orgs",
