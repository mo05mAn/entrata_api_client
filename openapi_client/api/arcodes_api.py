...
class ArcodesApi:
    ...
    @validate_call
    def orgs_v1_arcodes_post(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        get_ar_codes: Annotated[GetArCodes, Field(description="Returns all AR codes for a specified management company.")],
        ...
        :type orgs: str
        :param get_ar_codes: Returns all AR codes for a specified management company. (required)
        :type get_ar_codes: GetArCodes
        ...
        _param = self._orgs_v1_arcodes_post_serialize(
            orgs=orgs,
            get_ar_codes=get_ar_codes,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrgsV1ArcodesPost200Response",
            '400': "ErrorResponse",
        }
    ...
    @validate_call
    def orgs_v1_arcodes_post_with_http_info(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        get_ar_codes: Annotated[GetArCodes, Field(description="Returns all AR codes for a specified management company.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrgsV1ArcodesPost200Response]:
        """Charge codes
    ...
    @validate_call
    def orgs_v1_arcodes_post_without_preload_content(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        get_ar_codes: Annotated[GetArCodes, Field(description="Returns all AR codes for a specified management company.")],
        _request_timeout: Union[
    ...
    def _orgs_v1_arcodes_post_serialize(
        self,
        orgs,
        get_ar_codes,
        _request_auth,
        ...
        if get_ar_codes is not None:
            _body_params = get_ar_codes
