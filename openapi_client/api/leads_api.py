...
class LeadsApi:
    ...
    @validate_call
    def orgs_v1_leads_post(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        orgs_v1_leads_post_request_inner: List[OrgsV1LeadsPostRequestInner],
        ...
        :type orgs: str
        :param orgs_v1_leads_post_request_inner: (required)
        :type orgs_v1_leads_post_request_inner: List[OrgsV1LeadsPostRequestInner]
        ...
        _param = self._orgs_v1_leads_post_serialize(
            orgs=orgs,
            orgs_v1_leads_post_request_inner=orgs_v1_leads_post_request_inner,
            page_no=page_no,
            per_page=per_page,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrgsV1LeadsPost200Response",
            '400': "ErrorResponse",
        }
    ...
    @validate_call
    def orgs_v1_leads_post_with_http_info(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        orgs_v1_leads_post_request_inner: List[OrgsV1LeadsPostRequestInner],
        page_no: Annotated[Optional[StrictInt], Field(description="The page number of paginated respons.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrgsV1LeadsPost200Response]:
        """Lead related APIs
    ...
    @validate_call
    def orgs_v1_leads_post_without_preload_content(
        self,
        orgs: Annotated[StrictStr, Field(description="Client subdomain.")],
        orgs_v1_leads_post_request_inner: List[OrgsV1LeadsPostRequestInner],
        page_no: Annotated[Optional[StrictInt], Field(description="The page number of paginated respons.")] = None,
    ...
    def _orgs_v1_leads_post_serialize(
        self,
        orgs,
        orgs_v1_leads_post_request_inner,
        page_no,
        per_page,
        ...
        if orgs_v1_leads_post_request_inner is not None:
            _body_params = orgs_v1_leads_post_request_inner
