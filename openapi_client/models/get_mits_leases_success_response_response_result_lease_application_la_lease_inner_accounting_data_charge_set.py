...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSet(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSet
    """ # noqa: E501
    start: StrictStr = Field(description="Start date of the charge period", alias="Start")
    end: StrictStr = Field(description="End date of the charge period", alias="End")
    frequency: StrictStr = Field(description="Frequency of the charge", alias="Frequency")
    charge: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSetCharge = Field(alias="Charge")
    __properties: ClassVar[List[str]] = ["Start", "End", "Frequency", "Charge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Charge": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSetCharge.from_dict(obj["Charge"]) if obj.get("Charge") is not None else None
        })
        return _obj
