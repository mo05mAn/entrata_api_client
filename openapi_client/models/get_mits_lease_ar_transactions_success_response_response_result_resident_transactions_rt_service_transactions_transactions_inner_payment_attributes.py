...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPaymentAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    payment_type: Optional[StrictStr] = Field(default=None, description="Payment type (e.g., ACH)", alias="PaymentType")
