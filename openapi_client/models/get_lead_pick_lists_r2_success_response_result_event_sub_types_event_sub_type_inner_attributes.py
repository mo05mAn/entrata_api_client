...
class GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInnerAttributes(BaseModel):
    """
    Attributes related to the event subtype.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the event subtype.")
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the event subtype.")
    event_type_id: Optional[StrictStr] = Field(default=None, description="The ID of the related event type.", alias="eventTypeId")
    __properties: ClassVar[List[str]] = ["name", "id", "eventTypeId"]
