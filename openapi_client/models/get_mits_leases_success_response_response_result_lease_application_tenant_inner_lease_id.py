...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseID(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseID
    """ # noqa: E501
    identification: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification = Field(alias="Identification")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None
        })
        return _obj
