...
class GetSpecialsR1MethodParams(BaseModel):
    """
    GetSpecialsR1MethodParams
    """ # noqa: E501
    property_id: StrictInt = Field(description="This is a required field. This field accepts single value. Property ID for getting Specials", alias="propertyId")
