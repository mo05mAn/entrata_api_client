...
class GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner(BaseModel):
    """
    GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner
    """ # noqa: E501
    ar_code_id: StrictStr = Field(description="AR code ID for the rate", alias="arCodeId")
    ar_code_type_id: StrictStr = Field(description="AR code type ID", alias="arCodeTypeId")
    charge_type_id: StrictStr = Field(description="Charge type ID", alias="chargeTypeId")
    amount: StrictStr = Field(description="Amount for the rate")
    active: StrictStr = Field(description="Whether the rate is active")
    is_publish: StrictStr = Field(description="Indicates whether the rate is published", alias="isPublish")
    __properties: ClassVar[List[str]] = ["arCodeId", "arCodeTypeId", "chargeTypeId", "amount", "active", "isPublish"]
