...
class GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInnerActiveScheduledChargesActiveScheduledChargeInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["chargeCode", "chargeTiming", "chargeUsage", "chargeStartDate", "chargeAmount"]
