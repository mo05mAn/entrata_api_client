...
class GetPropertyMediaMethodParams(BaseModel):
    """
    GetPropertyMediaMethodParams
    """ # noqa: E501
    property_id: StrictStr = Field(description="This is a required field. This field accepts single value.", alias="propertyId")
    media_type_id: StrictStr = Field(description="This is a required field. This field accepts single value.", alias="mediaTypeId")
    media_sub_type_id: StrictStr = Field(description="This is a required field. This field accepts single value.", alias="mediaSubTypeId")
    reference_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts single value. reference id for mediaType", alias="referenceIds")
    __properties: ClassVar[List[str]] = ["propertyId", "mediaTypeId", "mediaSubTypeId", "referenceIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "referenceIds": obj.get("referenceIds")
        })
        return _obj
