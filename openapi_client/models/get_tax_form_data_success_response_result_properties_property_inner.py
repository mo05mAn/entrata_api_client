...
class GetTaxFormDataSuccessResponseResultPropertiesPropertyInner(BaseModel):
    """
    GetTaxFormDataSuccessResponseResultPropertiesPropertyInner
    """ # noqa: E501
    vendors: GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendors
    payers: GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers
    attributes: GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes = Field(alias="@attributes")
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the property.")
    __properties: ClassVar[List[str]] = ["vendors", "payers", "@attributes", "id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of payers
        if self.payers:
            _dict['payers'] = self.payers.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vendors": GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerVendors.from_dict(obj["vendors"]) if obj.get("vendors") is not None else None,
            "payers": GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers.from_dict(obj["payers"]) if obj.get("payers") is not None else None,
            "@attributes": GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "id": obj.get("id")
        })
        return _obj
