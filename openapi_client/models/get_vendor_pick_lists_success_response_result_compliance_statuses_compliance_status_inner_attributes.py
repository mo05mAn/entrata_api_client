...
class GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the compliance status.")
    name: StrictStr = Field(description="Name of the compliance status.")
