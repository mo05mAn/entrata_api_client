...
class GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlBooksGlBookInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL book.", alias="Id")
    name: StrictStr = Field(description="The name of the GL book.", alias="Name")
