...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress(BaseModel):
    """
    ...
    address: StrictStr = Field(description="Address of the unit", alias="Address")
    city: StrictStr = Field(description="City of the unit", alias="City")
    state: StrictStr = Field(description="State of the unit", alias="State")
    postal_code: StrictStr = Field(description="Postal code of the unit", alias="PostalCode")
    __properties: ClassVar[List[str]] = ["AddressType", "Address", "City", "State", "PostalCode"]
