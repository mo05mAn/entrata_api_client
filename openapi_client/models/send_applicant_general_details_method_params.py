...
class SendApplicantGeneralDetailsMethodParams(BaseModel):
    """
    SendApplicantGeneralDetailsMethodParams
    """ # noqa: E501
    application_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="applicationId")
    property_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="propertyId")
    applicant_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="applicantId")
    id: StrictInt = Field(description="This is a required field. This field accepts single value.")
    is_true: Optional[StrictInt] = Field(default=None, alias="isTrue")
    comments: Optional[StrictStr] = Field(default=None, description="This is a required field. This field accepts single value.")
    __properties: ClassVar[List[str]] = ["applicationId", "propertyId", "applicantId", "id", "isTrue", "comments"]

    @field_validator('is_true')
    def is_true_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
