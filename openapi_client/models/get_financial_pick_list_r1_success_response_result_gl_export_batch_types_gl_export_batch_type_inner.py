...
class GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL export batch type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL export batch type.", alias="Name")
