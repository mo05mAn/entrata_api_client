...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInner(BaseModel):
    """
    GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of the amenity", alias="Description")
    attributes: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
