...
class GetJobCostBudgetsMethodParams(BaseModel):
    """
    GetJobCostBudgetsMethodParams
    """ # noqa: E501
    property_ids: StrictInt = Field(description="This is a required field. This field accepts comma seperated multiple values. This node should accept property Id.", alias="propertyIds")
    job_ids: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts comma seperated multiple values. This node should accept property Id.", alias="jobIds")
    job_status_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. This node should accept job status Id.", alias="jobStatusIds")
    ap_code_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. This node should accept apCode Id", alias="apCodeIds")
    job_phase_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. This node should accept job Phase Id", alias="jobPhaseId")
    __properties: ClassVar[List[str]] = ["propertyIds", "jobIds", "jobStatusIds", "apCodeIds", "jobPhaseId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobStatusIds": obj.get("jobStatusIds"),
            "apCodeIds": obj.get("apCodeIds"),
