...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInnerPetsAttributes(BaseModel):
    """
    Attributes related to the pet policy
    """ # noqa: E501
    count: Optional[StrictStr] = Field(default=None, description="Number of pets allowed", alias="Count")
    description: Optional[StrictStr] = Field(default=None, description="Description of the pets allowed", alias="Description")
    pet_type: Optional[StrictStr] = Field(default=None, description="Type of pet allowed", alias="PetType")
    size: Optional[StrictStr] = Field(default=None, description="Size of the pet", alias="Size")
    weight: Optional[StrictStr] = Field(default=None, description="Weight of the pet", alias="Weight")
    __properties: ClassVar[List[str]] = ["Count", "Description", "PetType", "Size", "Weight"]
