...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingData(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingData
    """ # noqa: E501
    charge_set: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSet = Field(alias="ChargeSet")
    __properties: ClassVar[List[str]] = ["ChargeSet"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of charge_set
        if self.charge_set:
            _dict['ChargeSet'] = self.charge_set.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ChargeSet": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerAccountingDataChargeSet.from_dict(obj["ChargeSet"]) if obj.get("ChargeSet") is not None else None
        })
        return _obj
