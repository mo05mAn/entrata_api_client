...
class GetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner(BaseModel):
    """
    GetMarketingPreferencePickListSuccessResponseResponseResultAvailabilityAlertFrequenciesInner
    """ # noqa: E501
    frequency_id: StrictInt = Field(description="The identifier for the frequency of alerts", alias="frequencyId")
    frequency_name: StrictStr = Field(description="The name of the frequency", alias="frequencyName")
    __properties: ClassVar[List[str]] = ["frequencyId", "frequencyName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frequencyName": obj.get("frequencyName")
        })
        return _obj
