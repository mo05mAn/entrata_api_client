...
class GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor(BaseModel):
    """
    GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendor
    """ # noqa: E501
    id: StrictStr = Field(description="Vendor ID")
    ...
    address: GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress
    __properties: ClassVar[List[str]] = ["id", "name", "locationName", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": GetInvoicesR1SuccessResponseResultInvoicesInvoiceVendorAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
