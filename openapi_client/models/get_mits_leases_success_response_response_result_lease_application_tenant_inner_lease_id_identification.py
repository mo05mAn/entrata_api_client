...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerLeaseIDIdentification
    """ # noqa: E501
    id_type: StrictStr = Field(description="Type of the lease identification", alias="IDType")
    id_rank: StrictStr = Field(description="Rank of the lease identification", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Scope type of the lease identification", alias="IDScopeType")
    id_value: StrictStr = Field(description="Value of the lease identification", alias="IDValue")
    __properties: ClassVar[List[str]] = ["IDType", "IDRank", "IDScopeType", "IDValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IDRank": obj.get("IDRank"),
            "IDScopeType": obj.get("IDScopeType"),
