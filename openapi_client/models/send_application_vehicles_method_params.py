...
class SendApplicationVehiclesMethodParams(BaseModel):
    """
    SendApplicationVehiclesMethodParams
    """ # noqa: E501
    vehicle_type_id: StrictInt = Field(description="This is a required field. This field accepts single value. Indicates the type of vehicle. Possible values are 1, 2, or 3 where 1 = Primary, 2 = Secondary, and 3 = Other.", alias="vehicleTypeId")
    __properties: ClassVar[List[str]] = ["vehicleTypeId"]
