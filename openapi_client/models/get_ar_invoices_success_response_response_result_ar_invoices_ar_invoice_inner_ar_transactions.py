...
class GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions(BaseModel):
    """
    GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactions
    """ # noqa: E501
    ar_transaction: List[GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactionsArTransactionInner] = Field(alias="arTransaction")
    __properties: ClassVar[List[str]] = ["arTransaction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ar_transaction (list)
        _items = []
        if self.ar_transaction:
            for _item in self.ar_transaction:
                if _item:
                    _items.append(_item.to_dict())
            _dict['arTransaction'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arTransaction": [GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactionsArTransactionInner.from_dict(_item) for _item in obj["arTransaction"]] if obj.get("arTransaction") is not None else None
        })
        return _obj
