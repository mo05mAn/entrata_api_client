...
class SendRentersInsurancePoliciesR1SuccessResponseResult(BaseModel):
    """
    SendRentersInsurancePoliciesR1SuccessResponseResult
    """ # noqa: E501
    insurance_policies: SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies = Field(alias="insurancePolicies")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "insurancePolicies": SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePolicies.from_dict(obj["insurancePolicies"]) if obj.get("insurancePolicies") is not None else None
        })
        return _obj
