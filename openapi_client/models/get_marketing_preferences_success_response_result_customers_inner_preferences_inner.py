...
class GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner(BaseModel):
    """
    GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner
    """ # noqa: E501
    communication_channel: StrictStr = Field(description="The communication channel used for notifications", alias="communicationChannel")
    recipient_type: StrictStr = Field(description="The type of recipient (e.g., LEAD, RESIDENT)", alias="recipientType")
    recipient_type_id: StrictStr = Field(description="The identifier for the recipient type", alias="recipientTypeId")
    consent_type: StrictStr = Field(description="The type of consent for the communication", alias="consentType")
    consent_type_id: StrictInt = Field(description="The identifier for the consent type", alias="consentTypeId")
    opt_in: StrictStr = Field(description="Opt-in status for the communication (1 for opted-in, 0 for opted-out)", alias="optIn")
    __properties: ClassVar[List[str]] = ["communicationChannel", "recipientType", "recipientTypeId", "consentType", "consentTypeId", "optIn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recipientTypeId": obj.get("recipientTypeId"),
            "consentType": obj.get("consentType"),
            "consentTypeId": obj.get("consentTypeId"),
            "optIn": obj.get("optIn")
        })
        return _obj
