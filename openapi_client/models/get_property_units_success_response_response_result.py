...
class GetPropertyUnitsSuccessResponseResponseResult(BaseModel):
    """
    GetPropertyUnitsSuccessResponseResponseResult
    """ # noqa: E501
    properties: GetPropertyUnitsSuccessResponseResponseResultProperties
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": GetPropertyUnitsSuccessResponseResponseResultProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
