...
class GetLeaseDetailsR1SuccessResponse(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponse
    """ # noqa: E501
    response: GetLeaseDetailsR1SuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetLeaseDetailsR1SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
