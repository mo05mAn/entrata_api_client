...
class UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner(BaseModel):
    """
    UpdateAmenitiesSuccessResponseResponseResultPropertyAmenitiesPropertyAmenityInner
    """ # noqa: E501
    node: StrictInt = Field(description="Unique identifier for the property amenity node")
    status: StrictStr = Field(description="Status of the operation")
    amenity_id: StrictInt = Field(description="ID of the property amenity", alias="amenityId")
    message: StrictStr = Field(description="Message about the property amenity operation")
