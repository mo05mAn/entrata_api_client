...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHours(BaseModel):
    """
    Operating hours for the property
    """ # noqa: E501
    holiday_hours: Optional[GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHours] = Field(default=None, alias="HolidayHours")
    office_hours: Optional[GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursOfficeHours] = Field(default=None, alias="OfficeHours")
    pool_hours: Optional[GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHours] = Field(default=None, alias="PoolHours")
    __properties: ClassVar[List[str]] = ["HolidayHours", "OfficeHours", "PoolHours"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of holiday_hours
        if self.holiday_hours:
            _dict['HolidayHours'] = self.holiday_hours.to_dict()
        # override the default output from pydantic by calling `to_dict()` of office_hours
        if self.office_hours:
            _dict['OfficeHours'] = self.office_hours.to_dict()
        # override the default output from pydantic by calling `to_dict()` of pool_hours
        if self.pool_hours:
            _dict['PoolHours'] = self.pool_hours.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "HolidayHours": GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHours.from_dict(obj["HolidayHours"]) if obj.get("HolidayHours") is not None else None,
            "OfficeHours": GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursOfficeHours.from_dict(obj["OfficeHours"]) if obj.get("OfficeHours") is not None else None,
            "PoolHours": GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHours.from_dict(obj["PoolHours"]) if obj.get("PoolHours") is not None else None
        })
        return _obj
