...
class GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultLedgerIdsLedgerIdInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the ledger.", alias="Id")
    name: StrictStr = Field(description="The name of the ledger.", alias="Name")
