...
class GetTestimonialPickLists(BaseModel):
    """
    ...
    method: GetTestimonialPickListsMethod
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": GetTestimonialPickListsMethod.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
