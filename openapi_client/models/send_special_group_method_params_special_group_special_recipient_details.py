...
class SendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails(BaseModel):
    """
    SendSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails
    """ # noqa: E501
    special_recipient_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. Comma separated recipient IDs.", alias="specialRecipientIds")
    special_trigger_type_id_prospect: Optional[StrictStr] = Field(default=None, description="This is an optional field. Special trigger type for prospects.", alias="specialTriggerTypeIdProspect")
    special_trigger_type_id_renewal: Optional[StrictStr] = Field(default=None, description="This is an optional field. Special trigger type for renewals.", alias="specialTriggerTypeIdRenewal")
    __properties: ClassVar[List[str]] = ["specialRecipientIds", "specialTriggerTypeIdProspect", "specialTriggerTypeIdRenewal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "specialRecipientIds": obj.get("specialRecipientIds"),
            "specialTriggerTypeIdProspect": obj.get("specialTriggerTypeIdProspect"),
            "specialTriggerTypeIdRenewal": obj.get("specialTriggerTypeIdRenewal")
        })
        return _obj
