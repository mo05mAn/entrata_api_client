...
class GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlHeaderTypesGlHeaderTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL header type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL header type.", alias="Name")
