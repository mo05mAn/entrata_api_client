...
class GetGlTransactionsSuccessResponseResultProperties(BaseModel):
    """
    GetGlTransactionsSuccessResponseResultProperties
    """ # noqa: E501
    var_property: GetGlTransactionsSuccessResponseResultPropertiesProperty = Field(alias="property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property": GetGlTransactionsSuccessResponseResultPropertiesProperty.from_dict(obj["property"]) if obj.get("property") is not None else None
        })
        return _obj
