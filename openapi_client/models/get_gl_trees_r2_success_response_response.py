...
class GetGlTreesR2SuccessResponseResponse(BaseModel):
    """
    ...
    code: Optional[StrictInt] = Field(default=None, description="HTTP status code indicating the result of the request")
    result: Optional[GetGlTreesR2SuccessResponseResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetGlTreesR2SuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
