...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloorsPropertyFloorInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloorsPropertyFloorInner
    """ # noqa: E501
    id: StrictInt = Field(description="Floor ID")
    title: StrictStr = Field(description="Floor title")
