...
class GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddresses(BaseModel):
    """
    GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddresses
    """ # noqa: E501
    address: List[GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddressesAddressInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": [GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddressesAddressInner.from_dict(_item) for _item in obj["address"]] if obj.get("address") is not None else None
        })
        return _obj
