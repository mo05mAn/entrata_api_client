...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInner(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInner
    """ # noqa: E501
    charge: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerCharge = Field(alias="Charge")
    payment: Optional[GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPayment] = Field(default=None, alias="Payment")
    __properties: ClassVar[List[str]] = ["Charge", "Payment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Charge": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerCharge.from_dict(obj["Charge"]) if obj.get("Charge") is not None else None,
            "Payment": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPayment.from_dict(obj["Payment"]) if obj.get("Payment") is not None else None
        })
        return _obj
