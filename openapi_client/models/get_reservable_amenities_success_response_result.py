...
class GetReservableAmenitiesSuccessResponseResult(BaseModel):
    """
    GetReservableAmenitiesSuccessResponseResult
    """ # noqa: E501
    amenities: GetReservableAmenitiesSuccessResponseResultAmenities
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amenities": GetReservableAmenitiesSuccessResponseResultAmenities.from_dict(obj["amenities"]) if obj.get("amenities") is not None else None
        })
        return _obj
