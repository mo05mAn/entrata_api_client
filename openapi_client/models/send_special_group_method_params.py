...
class SendSpecialGroupMethodParams(BaseModel):
    """
    SendSpecialGroupMethodParams
    """ # noqa: E501
    property_id: StrictStr = Field(description="This is a required field. Property ID for insert Specials", alias="propertyId")
    special_group: SendSpecialGroupMethodParamsSpecialGroup = Field(alias="specialGroup")
    __properties: ClassVar[List[str]] = ["propertyId", "specialGroup"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of special_group
        if self.special_group:
            _dict['specialGroup'] = self.special_group.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specialGroup": SendSpecialGroupMethodParamsSpecialGroup.from_dict(obj["specialGroup"]) if obj.get("specialGroup") is not None else None
        })
        return _obj
