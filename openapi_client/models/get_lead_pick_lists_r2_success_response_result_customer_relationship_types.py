...
class GetLeadPickListsR2SuccessResponseResultCustomerRelationshipTypes(BaseModel):
    """
    Customer relationship types associated with the request.
    """ # noqa: E501
    customer_relationship_type: Optional[List[GetLeadPickListsR2SuccessResponseResultCustomerRelationshipTypesCustomerRelationshipTypeInner]] = Field(default=None, description="A list of customer relationship types.", alias="customerRelationshipType")
    __properties: ClassVar[List[str]] = ["customerRelationshipType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in customer_relationship_type (list)
        _items = []
        if self.customer_relationship_type:
            for _item in self.customer_relationship_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['customerRelationshipType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customerRelationshipType": [GetLeadPickListsR2SuccessResponseResultCustomerRelationshipTypesCustomerRelationshipTypeInner.from_dict(_item) for _item in obj["customerRelationshipType"]] if obj.get("customerRelationshipType") is not None else None
        })
        return _obj
