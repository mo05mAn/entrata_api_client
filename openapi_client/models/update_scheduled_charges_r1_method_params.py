...
class UpdateScheduledChargesR1MethodParams(BaseModel):
    """
    UpdateScheduledChargesR1MethodParams
    """ # noqa: E501
    id: StrictInt = Field(description="This is a required field. This field accepts single value. scheduledChargeid")
    ...
    amount: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value. amount")
    is_deleted: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. This field support value 0 and 1.", alias="isDeleted")
    __properties: ClassVar[List[str]] = ["id", "propertyId", "leaseId", "amount", "isDeleted"]

    @field_validator('is_deleted')
    def is_deleted_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
