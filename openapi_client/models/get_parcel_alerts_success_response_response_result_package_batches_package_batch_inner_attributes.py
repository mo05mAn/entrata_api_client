...
class GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerAttributes(BaseModel):
    """
    GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInnerAttributes
    """ # noqa: E501
    id: StrictInt = Field(description="Identifier for the package batch")
    name: StrictStr = Field(description="Name of the package batch")
