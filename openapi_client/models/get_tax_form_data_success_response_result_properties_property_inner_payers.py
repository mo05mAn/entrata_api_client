...
class GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers(BaseModel):
    """
    GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayers
    """ # noqa: E501
    payer: Optional[List[GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayersPayerInner]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in payer (list)
        _items = []
        if self.payer:
            for _item in self.payer:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payer": [GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayersPayerInner.from_dict(_item) for _item in obj["payer"]] if obj.get("payer") is not None else None
        })
        return _obj
