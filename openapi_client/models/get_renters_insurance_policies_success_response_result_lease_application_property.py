...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationProperty(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationProperty
    """ # noqa: E501
    identification: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification = Field(alias="Identification")
    marketing_name: StrictStr = Field(description="Marketing name for the property", alias="MarketingName")
    address: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress = Field(alias="Address")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "MarketingName": obj.get("MarketingName"),
            "Address": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress.from_dict(obj["Address"]) if obj.get("Address") is not None else None
        })
        return _obj
