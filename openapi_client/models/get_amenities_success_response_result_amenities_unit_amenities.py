...
class GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesUnitAmenities
    """ # noqa: E501
    amenity: GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity = Field(alias="Amenity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Amenity": GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity.from_dict(obj["Amenity"]) if obj.get("Amenity") is not None else None
        })
        return _obj
