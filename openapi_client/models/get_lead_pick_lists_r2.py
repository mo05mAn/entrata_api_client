...
class GetLeadPickListsR2(BaseModel):
    """
    GetLeadPickListsR2
    """ # noqa: E501
    ...
    method: GetLeadPickListsR2Method
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": GetLeadPickListsR2Method.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
