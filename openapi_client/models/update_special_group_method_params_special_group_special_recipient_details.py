...
class UpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails(BaseModel):
    """
    UpdateSpecialGroupMethodParamsSpecialGroupSpecialRecipientDetails
    """ # noqa: E501
    special_recipient_ids: Optional[StrictStr] = Field(default=None, description="Optional. Comma-separated recipient IDs", alias="specialRecipientIds")
    special_trigger_type_id_prospect: Optional[StrictStr] = Field(default=None, description="Optional. Prospect trigger type ID", alias="specialTriggerTypeIdProspect")
    special_trigger_type_id_renewal: Optional[StrictStr] = Field(default=None, description="Optional. Renewal trigger type ID", alias="specialTriggerTypeIdRenewal")
