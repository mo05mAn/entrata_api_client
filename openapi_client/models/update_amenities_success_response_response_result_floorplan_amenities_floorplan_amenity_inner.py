...
class UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner(BaseModel):
    """
    UpdateAmenitiesSuccessResponseResponseResultFloorplanAmenitiesFloorplanAmenityInner
    """ # noqa: E501
    node: StrictInt = Field(description="Unique identifier for the floorplan amenity node")
    status: StrictStr = Field(description="Status of the operation")
    amenity_id: StrictInt = Field(description="ID of the floorplan amenity", alias="amenityId")
    message: StrictStr = Field(description="Message about the floorplan amenity operation")
