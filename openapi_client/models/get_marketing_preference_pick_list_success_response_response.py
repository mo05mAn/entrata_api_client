...
class GetMarketingPreferencePickListSuccessResponseResponse(BaseModel):
    """
    GetMarketingPreferencePickListSuccessResponseResponse
    """ # noqa: E501
    request_id: StrictStr = Field(description="The unique identifier for the request", alias="requestId")
    code: StrictInt = Field(description="Successful response code")
    result: GetMarketingPreferencePickListSuccessResponseResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetMarketingPreferencePickListSuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
