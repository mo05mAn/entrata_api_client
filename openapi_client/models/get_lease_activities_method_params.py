...
class GetLeaseActivitiesMethodParams(BaseModel):
    """
    ...
    lease_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="leaseId")
    created_on_date_to: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="createdOnDateTo")
    created_on_date_from: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="createdOnDateFrom")
    ...
    __properties: ClassVar[List[str]] = ["propertyId", "leaseId", "createdOnDateTo", "createdOnDateFrom", "eventTypeIds", "leaseStatusTypeIds"]
