...
class SendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner(BaseModel):
    """
    ...
    po_number: Optional[StrictInt] = Field(default=None, description="Purchase Order number associated with the AP header.", alias="poNumber")
    message: Optional[StrictStr] = Field(default=None, description="Message indicating the result of the AP header insertion.")
    __properties: ClassVar[List[str]] = ["node", "status", "apHeaderId", "poNumber", "message"]
