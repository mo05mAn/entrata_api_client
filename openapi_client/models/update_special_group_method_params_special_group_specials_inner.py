...
class UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner(BaseModel):
    """
    UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInner
    """ # noqa: E501
    special_id: StrictStr = Field(description="Required. ID of the special", alias="specialId")
    special_type_id: StrictStr = Field(description="Required. Type ID of the special", alias="specialTypeId")
    special_name: StrictStr = Field(description="Required. Name of the special", alias="specialName")
    gift_value: Optional[StrictStr] = Field(default=None, description="Optional. Value for gift type specials", alias="giftValue")
    is_delete: Optional[StrictInt] = Field(default=None, description="Optional. pass this field if only wants to delete the special. otherwise do not pass this field.", alias="isDelete")
    rates: Optional[List[UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner]] = None
    __properties: ClassVar[List[str]] = ["specialId", "specialTypeId", "specialName", "giftValue", "isDelete", "rates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rates": [UpdateSpecialGroupMethodParamsSpecialGroupSpecialsInnerRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
