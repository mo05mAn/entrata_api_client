...
class SendLeaseDocumentsRequestBody(BaseModel):
    """
    This is required field. This field accept the details of lease, and ducuments being uploaded.
    """ # noqa: E501
    auth: RequestBodyAuth
    method: SendLeaseDocumentsRequestBodyMethod
    __properties: ClassVar[List[str]] = ["auth", "method"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "method": SendLeaseDocumentsRequestBodyMethod.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
