...
class GetInvoicesR1SuccessResponse(BaseModel):
    """
    ...
    code: Optional[StrictStr] = Field(default=None, description="Success response code")
    result: Optional[GetInvoicesR1SuccessResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetInvoicesR1SuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
