...
class GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIdsBudgetStatusTypeIdInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultBudgetStatusTypeIdsBudgetStatusTypeIdInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the budget status type.")
    name: StrictStr = Field(description="The name of the budget status type.")
