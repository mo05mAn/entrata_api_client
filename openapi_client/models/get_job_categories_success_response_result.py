...
class GetJobCategoriesSuccessResponseResult(BaseModel):
    """
    GetJobCategoriesSuccessResponseResult
    """ # noqa: E501
    job_categories: GetJobCategoriesSuccessResponseResultJobCategories = Field(alias="jobCategories")
    __properties: ClassVar[List[str]] = ["jobCategories"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of job_categories
        if self.job_categories:
            _dict['jobCategories'] = self.job_categories.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobCategories": GetJobCategoriesSuccessResponseResultJobCategories.from_dict(obj["jobCategories"]) if obj.get("jobCategories") is not None else None
        })
        return _obj
