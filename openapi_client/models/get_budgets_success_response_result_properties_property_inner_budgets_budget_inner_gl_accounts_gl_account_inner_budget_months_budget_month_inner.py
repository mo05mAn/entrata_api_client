...
class GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerBudgetMonthsBudgetMonthInner(BaseModel):
    """
    ...
    """ # noqa: E501
    month: StrictStr = Field(description="The month of the budget entry.")
    amount: StrictStr = Field(description="The budgeted amount for the month.")
    gl_dimension_id: Optional[StrictStr] = Field(default=None, description="The GL dimension ID for the month.", alias="glDimensionId")
    __properties: ClassVar[List[str]] = ["month", "amount", "glDimensionId"]
