...
class GetMitsPropertyUnitsMethodParams(BaseModel):
    """
    GetMitsPropertyUnitsMethodParams
    """ # noqa: E501
    property_ids: StrictStr = Field(description="This is a required field. This field accepts comma seperated multiple values. PSI Property Identification number", alias="propertyIds")
    available_units_only: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Flag for getting available units only", alias="availableUnitsOnly")
    use_property_preferences: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Flag for implementing preferences on result.", alias="usePropertyPreferences")
    ...
    show_unit_spaces: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Flag for implementing Unit Spaces on result.", alias="showUnitSpaces")
    __properties: ClassVar[List[str]] = ["propertyIds", "availableUnitsOnly", "usePropertyPreferences", "includeDisabledFloorplans", "includeDisabledUnits", "showUnitSpaces"]
