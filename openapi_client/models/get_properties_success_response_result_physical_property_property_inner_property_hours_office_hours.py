...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursOfficeHours(BaseModel):
    """
    Office operating hours
    """ # noqa: E501
    office_hour: Optional[GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursOfficeHoursOfficeHour] = Field(default=None, alias="OfficeHour")
    __properties: ClassVar[List[str]] = ["OfficeHour"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of office_hour
        if self.office_hour:
            _dict['OfficeHour'] = self.office_hour.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "OfficeHour": GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursOfficeHoursOfficeHour.from_dict(obj["OfficeHour"]) if obj.get("OfficeHour") is not None else None
        })
        return _obj
