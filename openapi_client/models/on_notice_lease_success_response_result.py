...
class OnNoticeLeaseSuccessResponseResult(BaseModel):
    """
    OnNoticeLeaseSuccessResponseResult
    """ # noqa: E501
    status: StrictStr = Field(description="Status of the lease notice placement")
    message: StrictStr = Field(description="Message regarding the lease notice placement")
