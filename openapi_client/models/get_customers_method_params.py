...
class GetCustomersMethodParams(BaseModel):
    """
    ...
    customer_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. Customer Ids", alias="customerIds")
    lease_status_type_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. Lease Status types", alias="leaseStatusTypeIds")
    is_agreed_to_terms_only: Optional[StrictBool] = Field(default=None, alias="isAgreedToTermsOnly")
    company_identification_type_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. company Identification type IDs", alias="companyIdentificationTypeIds")
    __properties: ClassVar[List[str]] = ["propertyId", "customerIds", "leaseStatusTypeIds", "isAgreedToTermsOnly", "companyIdentificationTypeIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isAgreedToTermsOnly": obj.get("isAgreedToTermsOnly"),
            "companyIdentificationTypeIds": obj.get("companyIdentificationTypeIds")
        })
        return _obj
