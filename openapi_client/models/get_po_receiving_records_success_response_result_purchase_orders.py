...
class GetPoReceivingRecordsSuccessResponseResultPurchaseOrders(BaseModel):
    """
    GetPoReceivingRecordsSuccessResponseResultPurchaseOrders
    """ # noqa: E501
    purchase_order: Optional[GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrder] = Field(default=None, alias="purchaseOrder")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "purchaseOrder": GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrder.from_dict(obj["purchaseOrder"]) if obj.get("purchaseOrder") is not None else None
        })
        return _obj
