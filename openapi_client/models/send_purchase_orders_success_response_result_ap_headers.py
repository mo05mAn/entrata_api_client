...
class SendPurchaseOrdersSuccessResponseResultApHeaders(BaseModel):
    """
    SendPurchaseOrdersSuccessResponseResultApHeaders
    """ # noqa: E501
    ap_header: Optional[List[SendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner]] = Field(default=None, alias="apHeader")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apHeader": [SendPurchaseOrdersSuccessResponseResultApHeadersApHeaderInner.from_dict(_item) for _item in obj["apHeader"]] if obj.get("apHeader") is not None else None
        })
        return _obj
