...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer(BaseModel):
    """
    GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomer
    """ # noqa: E501
    identification: Optional[List[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomerIdentificationInner]] = Field(default=None, description="A list of identification details for the customer.", alias="Identification")
    name: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomerName] = Field(default=None, alias="Name")
    phone: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomerPhone] = Field(default=None, alias="Phone")
    __properties: ClassVar[List[str]] = ["Identification", "Name", "Phone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": [GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomerIdentificationInner.from_dict(_item) for _item in obj["Identification"]] if obj.get("Identification") is not None else None,
            "Name": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomerName.from_dict(obj["Name"]) if obj.get("Name") is not None else None,
            "Phone": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomersCustomerPhone.from_dict(obj["Phone"]) if obj.get("Phone") is not None else None
        })
        return _obj
