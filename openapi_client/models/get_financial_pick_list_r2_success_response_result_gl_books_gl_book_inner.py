...
class GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlBooksGlBookInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL book.")
    name: StrictStr = Field(description="The name of the GL book.")
