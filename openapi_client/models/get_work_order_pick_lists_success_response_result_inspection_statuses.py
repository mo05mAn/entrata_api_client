...
class GetWorkOrderPickListsSuccessResponseResultInspectionStatuses(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultInspectionStatuses
    """ # noqa: E501
    inspection_status: List[GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner] = Field(alias="InspectionStatus")
    __properties: ClassVar[List[str]] = ["InspectionStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in inspection_status (list)
        _items = []
        if self.inspection_status:
            for _item in self.inspection_status:
                if _item:
                    _items.append(_item.to_dict())
            _dict['InspectionStatus'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "InspectionStatus": [GetWorkOrderPickListsSuccessResponseResultInspectionStatusesInspectionStatusInner.from_dict(_item) for _item in obj["InspectionStatus"]] if obj.get("InspectionStatus") is not None else None
        })
        return _obj
