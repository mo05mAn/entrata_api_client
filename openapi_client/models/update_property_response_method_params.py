...
class UpdatePropertyResponseMethodParams(BaseModel):
    """
    ...
    testimonial_id: StrictInt = Field(description="This is an optional field. This field accepts single value.", alias="testimonialId")
    review_response: Optional[StrictStr] = Field(default=None, description="Test Review Response", alias="reviewResponse")
    is_publish: StrictBool = Field(description="This is a required field. This field accepts single value.", alias="isPublish")
    __properties: ClassVar[List[str]] = ["propertyId", "testimonialId", "reviewResponse", "isPublish"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reviewResponse": obj.get("reviewResponse"),
