...
class GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultApPayeeTermsApPayeeTermInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the AP payee term.")
    name: StrictStr = Field(description="Name of the AP payee term.")
