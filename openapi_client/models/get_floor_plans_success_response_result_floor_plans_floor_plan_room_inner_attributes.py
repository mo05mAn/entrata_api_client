...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes(BaseModel):
    """
    Attributes related to the room
    """ # noqa: E501
    room_type: Optional[StrictStr] = Field(default=None, description="Type of the room", alias="RoomType")
    __properties: ClassVar[List[str]] = ["RoomType"]
