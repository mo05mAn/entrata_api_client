...
class GetPricingPicklistsSuccessResponseResponseResultChargeTimingsChargeTimingInnerAttributes(BaseModel):
    """
    Attributes of each charge timing
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the charge timing")
    name: Optional[StrictStr] = Field(default=None, description="Name of the charge timing")
