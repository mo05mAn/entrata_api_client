...
class SendScheduledChargesSuccessResponseResult(BaseModel):
    """
    SendScheduledChargesSuccessResponseResult
    """ # noqa: E501
    scheduled_charges: SendScheduledChargesSuccessResponseResultScheduledCharges = Field(alias="scheduledCharges")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scheduledCharges": SendScheduledChargesSuccessResponseResultScheduledCharges.from_dict(obj["scheduledCharges"]) if obj.get("scheduledCharges") is not None else None
        })
        return _obj
