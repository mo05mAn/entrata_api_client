...
class GetVendorPickListsSuccessResponseResultComplianceStatuses(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultComplianceStatuses
    """ # noqa: E501
    compliance_status: Optional[List[GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInner]] = Field(default=None, alias="complianceStatus")
    __properties: ClassVar[List[str]] = ["complianceStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in compliance_status (list)
        _items = []
        if self.compliance_status:
            for _item in self.compliance_status:
                if _item:
                    _items.append(_item.to_dict())
            _dict['complianceStatus'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "complianceStatus": [GetVendorPickListsSuccessResponseResultComplianceStatusesComplianceStatusInner.from_dict(_item) for _item in obj["complianceStatus"]] if obj.get("complianceStatus") is not None else None
        })
        return _obj
