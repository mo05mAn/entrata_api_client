...
class SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner(BaseModel):
    """
    SendRoommateGroupsR2SuccessResponseResponseResultRoommateGroupsInner
    """ # noqa: E501
    node: StrictInt = Field(description="Node identifier for the roommate group")
    roommate_group_id: StrictInt = Field(description="Unique identifier for the roommate group. Returns 0 if creation fails.", alias="roommateGroupId")
    status: StrictStr = Field(description="Status of the roommate group creation")
    message: StrictStr = Field(description="Message detailing the result of the group creation")
    __properties: ClassVar[List[str]] = ["node", "roommateGroupId", "status", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "node": obj.get("node"),
            "roommateGroupId": obj.get("roommateGroupId"),
