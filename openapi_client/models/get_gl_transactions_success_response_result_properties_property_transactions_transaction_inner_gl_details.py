...
class GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetails(BaseModel):
    """
    GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetails
    """ # noqa: E501
    gl_detail: List[GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetailsGlDetailInner] = Field(description="A list of GL detail entries for the transaction.", alias="glDetail")
    __properties: ClassVar[List[str]] = ["glDetail"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_detail (list)
        _items = []
        if self.gl_detail:
            for _item in self.gl_detail:
                if _item:
                    _items.append(_item.to_dict())
            _dict['glDetail'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glDetail": [GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetailsGlDetailInner.from_dict(_item) for _item in obj["glDetail"]] if obj.get("glDetail") is not None else None
        })
        return _obj
