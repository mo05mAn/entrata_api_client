...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInnerAttributes(BaseModel):
    """
    Attributes related to the file
    """ # noqa: E501
    file_id: Optional[StrictStr] = Field(default=None, description="Unique file ID", alias="FileID")
    active: Optional[StrictStr] = Field(default=None, description="Indicates if the file is active", alias="Active")
    __properties: ClassVar[List[str]] = ["FileID", "Active"]
