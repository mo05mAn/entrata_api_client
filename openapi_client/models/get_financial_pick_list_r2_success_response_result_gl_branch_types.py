...
class GetFinancialPickListR2SuccessResponseResultGlBranchTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlBranchTypes
    """ # noqa: E501
    gl_branch_type: List[GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner] = Field(description="A list of GL branch types.", alias="glBranchType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glBranchType": [GetFinancialPickListR2SuccessResponseResultGlBranchTypesGlBranchTypeInner.from_dict(_item) for _item in obj["glBranchType"]] if obj.get("glBranchType") is not None else None
        })
        return _obj
