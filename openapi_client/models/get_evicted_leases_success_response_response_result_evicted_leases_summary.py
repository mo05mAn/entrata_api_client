...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesSummary(BaseModel):
    """
    GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesSummary
    """ # noqa: E501
    generation_time_stamp: StrictStr = Field(description="Timestamp when the report was generated.", alias="generationTimeStamp")
    source_organization: StrictStr = Field(description="The source organization providing the report.", alias="SourceOrganization")
    total_properties: StrictStr = Field(description="Total number of properties.", alias="totalProperties")
    total_lease_files: StrictStr = Field(description="Total number of lease files.", alias="totalLeaseFiles")
    total_tenants: StrictStr = Field(description="Total number of tenants.", alias="TotalTenants")
    total_open_amount: StrictStr = Field(description="Total open amount in dollars.", alias="TotalOpenAmount")
    __properties: ClassVar[List[str]] = ["generationTimeStamp", "SourceOrganization", "totalProperties", "totalLeaseFiles", "TotalTenants", "TotalOpenAmount"]
