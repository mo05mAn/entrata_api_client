...
class GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayersPayerInner(BaseModel):
    """
    GetTaxFormDataSuccessResponseResultPropertiesPropertyInnerPayersPayerInner
    """ # noqa: E501
    payer_type: StrictStr = Field(description="The type of payer (e.g., Business, Individual).", alias="payerType")
    payer_tin_type: StrictStr = Field(description="Type of the payer's tax identification number.", alias="payerTinType")
    payer_tin: StrictStr = Field(description="Tax Identification Number of the payer.", alias="payerTin")
    payer_business_name_or_name: StrictStr = Field(description="Business name or individual's name for the payer.", alias="payerBusinessNameOrName")
    payer_address1: Optional[StrictStr] = Field(default=None, description="Street address of the payer.", alias="payerAddress1")
    payer_city: Optional[StrictStr] = Field(default=None, description="City where the payer is located.", alias="payerCity")
    payer_state: Optional[StrictStr] = Field(default=None, description="State where the payer is located.", alias="payerState")
    payer_zip_code: Optional[StrictStr] = Field(default=None, description="Postal code of the payer's location.", alias="payerZipCode")
    __properties: ClassVar[List[str]] = ["payerType", "payerTinType", "payerTin", "payerBusinessNameOrName", "payerAddress1", "payerCity", "payerState", "payerZipCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payerType": obj.get("payerType"),
            "payerTinType": obj.get("payerTinType"),
            "payerTin": obj.get("payerTin"),
            "payerBusinessNameOrName": obj.get("payerBusinessNameOrName"),
            "payerAddress1": obj.get("payerAddress1"),
            "payerCity": obj.get("payerCity"),
            "payerState": obj.get("payerState"),
            "payerZipCode": obj.get("payerZipCode")
        })
        return _obj
