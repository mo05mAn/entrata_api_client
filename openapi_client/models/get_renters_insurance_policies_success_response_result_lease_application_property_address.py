...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddress
    """ # noqa: E501
    description: StrictStr = Field(description="Description of the address", alias="Description")
    address: StrictStr = Field(description="Street address", alias="Address")
    city: StrictStr = Field(description="City of the property", alias="City")
    state: StrictStr = Field(description="State of the property", alias="State")
    postal_code: StrictStr = Field(description="Postal code of the property", alias="PostalCode")
    country: StrictStr = Field(description="Country of the property", alias="Country")
    attributes: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["Description", "Address", "City", "State", "PostalCode", "Country", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationPropertyAddressAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
