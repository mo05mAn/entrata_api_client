...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicy(BaseModel):
    """
    Property policies
    """ # noqa: E501
    pet: Optional[List[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInner]] = Field(default=None, description="Pet policy", alias="Pet")
    general: Optional[StrictStr] = Field(default=None, description="General policies for the property", alias="General")
    __properties: ClassVar[List[str]] = ["Pet", "General"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pet (list)
        _items = []
        if self.pet:
            for _item in self.pet:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Pet": [GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPolicyPetInner.from_dict(_item) for _item in obj["Pet"]] if obj.get("Pet") is not None else None,
