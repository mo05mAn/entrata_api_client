...
class GetMarketingPreferencesSuccessResponseResult(BaseModel):
    """
    GetMarketingPreferencesSuccessResponseResult
    """ # noqa: E501
    customers: List[GetMarketingPreferencesSuccessResponseResultCustomersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": [GetMarketingPreferencesSuccessResponseResultCustomersInner.from_dict(_item) for _item in obj["customers"]] if obj.get("customers") is not None else None
        })
        return _obj
