...
class GetLeasesR1SuccessResponseResult(BaseModel):
    """
    The result object containing lease information
    """ # noqa: E501
    leases: Optional[GetLeasesR1SuccessResponseResultLeases] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leases": GetLeasesR1SuccessResponseResultLeases.from_dict(obj["leases"]) if obj.get("leases") is not None else None
        })
        return _obj
