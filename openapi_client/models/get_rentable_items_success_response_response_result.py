...
class GetRentableItemsSuccessResponseResponseResult(BaseModel):
    """
    Contains rentable item types, items, and charge details
    """ # noqa: E501
    rentable_item_types: GetRentableItemsSuccessResponseResponseResultRentableItemTypes = Field(alias="RentableItemTypes")
    __properties: ClassVar[List[str]] = ["RentableItemTypes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rentable_item_types
        if self.rentable_item_types:
            _dict['RentableItemTypes'] = self.rentable_item_types.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "RentableItemTypes": GetRentableItemsSuccessResponseResponseResultRentableItemTypes.from_dict(obj["RentableItemTypes"]) if obj.get("RentableItemTypes") is not None else None
        })
        return _obj
