...
class GetLeasesR2SuccessResponseResponseResultLeases(BaseModel):
    """
    Information about leases
    """ # noqa: E501
    lease: List[GetLeasesR2SuccessResponseResponseResultLeasesLeaseInner] = Field(description="List of leases")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lease": [GetLeasesR2SuccessResponseResponseResultLeasesLeaseInner.from_dict(_item) for _item in obj["lease"]] if obj.get("lease") is not None else None
        })
        return _obj
