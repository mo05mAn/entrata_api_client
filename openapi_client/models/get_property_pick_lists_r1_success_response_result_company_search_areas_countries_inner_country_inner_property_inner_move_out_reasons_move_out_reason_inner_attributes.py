...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerMoveOutReasonsMoveOutReasonInnerAttributes(BaseModel):
    """
    Move-out reason attributes
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Move-out reason ID", alias="Id")
    system_code: Optional[StrictStr] = Field(default=None, description="System code for the move-out reason", alias="SystemCode")
    name: Optional[StrictStr] = Field(default=None, description="Move-out reason name", alias="Name")
    __properties: ClassVar[List[str]] = ["Id", "SystemCode", "Name"]
