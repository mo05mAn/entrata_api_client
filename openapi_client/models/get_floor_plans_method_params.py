...
class GetFloorPlansMethodParams(BaseModel):
    """
    ...
    property_floor_plan_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. propertyFloorPlanIds.", alias="propertyFloorPlanIds")
    use_property_preferences: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Checks for the property settings manipulate floorplan data and honour those settings.", alias="usePropertyPreferences")
    include_disabled_floorplans: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. If provided value is 1, then user should get disabled floorplans along with the enabled one.", alias="includeDisabledFloorplans")
    __properties: ClassVar[List[str]] = ["propertyId", "propertyFloorPlanIds", "usePropertyPreferences", "includeDisabledFloorplans"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "propertyFloorPlanIds": obj.get("propertyFloorPlanIds"),
