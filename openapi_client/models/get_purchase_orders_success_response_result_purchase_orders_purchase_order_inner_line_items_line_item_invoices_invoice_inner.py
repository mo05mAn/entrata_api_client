...
class GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItemsLineItemInvoicesInvoiceInner(BaseModel):
    """
    GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItemsLineItemInvoicesInvoiceInner
    """ # noqa: E501
    invoice_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the invoice.", alias="invoiceId")
    invoice_number: Optional[StrictStr] = Field(default=None, description="Invoice number associated with the purchase order.", alias="invoiceNumber")
    __properties: ClassVar[List[str]] = ["invoiceId", "invoiceNumber"]
