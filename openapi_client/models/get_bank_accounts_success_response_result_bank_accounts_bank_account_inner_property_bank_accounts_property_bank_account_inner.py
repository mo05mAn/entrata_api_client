...
class GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccountsPropertyBankAccountInner(BaseModel):
    """
    GetBankAccountsSuccessResponseResultBankAccountsBankAccountInnerPropertyBankAccountsPropertyBankAccountInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the property bank account.", alias="Id")
    property_id: StrictStr = Field(description="The property identifier associated with the property bank account.", alias="PropertyId")
    gl_account_id: StrictStr = Field(description="The general ledger account ID associated with the property.", alias="GlAccountId")
    is_due_to_from: StrictStr = Field(description="Indicates if the account is due to/from a particular property.", alias="IsDueToFrom")
    __properties: ClassVar[List[str]] = ["Id", "PropertyId", "GlAccountId", "IsDueToFrom"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IsDueToFrom": obj.get("IsDueToFrom")
        })
        return _obj
