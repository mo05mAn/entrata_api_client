...
class UpdatePropertyMediaMethodParams(BaseModel):
    """
    UpdatePropertyMediaMethodParams
    """ # noqa: E501
    property_id: StrictStr = Field(description="This is a required field. This field accepts single value. The unique identifier for the property.", alias="propertyId")
    media: List[MediaItem]
    __properties: ClassVar[List[str]] = ["propertyId", "media"]
