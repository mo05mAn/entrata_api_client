...
class GetVendorsMethodParams(BaseModel):
    """
    GetVendorsMethodParams
    """ # noqa: E501
    vendor_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. Once passing this parameter web service will return Vendor details for those Vendor Ids. Conditional mandatory, If vendorIds are provided t hen vendorsCodes is not required.", alias="vendorIds")
    vendor_codes: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. Conditional mandatory, If \"vendorsCodes\" are provided then \"vendorIds \" are not required.", alias="vendorCodes")
    __properties: ClassVar[List[str]] = ["vendorIds", "vendorCodes"]
