...
class UpdateVendorsSuccessResponseResultVendorsVendor(BaseModel):
    """
    UpdateVendorsSuccessResponseResultVendorsVendor
    """ # noqa: E501
    var_1: Optional[UpdateVendorsSuccessResponseResultVendorsVendor1] = Field(default=None, alias="1")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "1": UpdateVendorsSuccessResponseResultVendorsVendor1.from_dict(obj["1"]) if obj.get("1") is not None else None
        })
        return _obj
