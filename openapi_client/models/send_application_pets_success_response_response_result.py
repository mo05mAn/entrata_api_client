...
class SendApplicationPetsSuccessResponseResponseResult(BaseModel):
    """
    SendApplicationPetsSuccessResponseResponseResult
    """ # noqa: E501
    pets: SendApplicationPetsSuccessResponseResponseResultPets
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pets": SendApplicationPetsSuccessResponseResponseResultPets.from_dict(obj["pets"]) if obj.get("pets") is not None else None
        })
        return _obj
