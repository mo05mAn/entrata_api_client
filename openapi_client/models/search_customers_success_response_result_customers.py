...
class SearchCustomersSuccessResponseResultCustomers(BaseModel):
    """
    SearchCustomersSuccessResponseResultCustomers
    """ # noqa: E501
    customer: List[SearchCustomersSuccessResponseResultCustomersCustomerInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer": [SearchCustomersSuccessResponseResultCustomersCustomerInner.from_dict(_item) for _item in obj["customer"]] if obj.get("customer") is not None else None
        })
        return _obj
