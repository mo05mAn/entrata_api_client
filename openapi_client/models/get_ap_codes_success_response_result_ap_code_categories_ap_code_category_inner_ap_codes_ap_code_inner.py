...
class GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner(BaseModel):
    """
    GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the accounts payable code.")
    name: StrictStr = Field(description="The name of the accounts payable code.")
    gl_account_id: StrictStr = Field(description="The general ledger account ID associated with the AP code.", alias="glAccountId")
    ap_code_type_id: StrictStr = Field(description="The ID representing the type of the accounts payable code.", alias="apCodeTypeId")
    ap_code_type: StrictStr = Field(description="The type of the accounts payable code.", alias="apCodeType")
    __properties: ClassVar[List[str]] = ["id", "name", "glAccountId", "apCodeTypeId", "apCodeType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apCodeTypeId": obj.get("apCodeTypeId"),
            "apCodeType": obj.get("apCodeType")
        })
        return _obj
