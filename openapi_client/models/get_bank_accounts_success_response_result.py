...
class GetBankAccountsSuccessResponseResult(BaseModel):
    """
    GetBankAccountsSuccessResponseResult
    """ # noqa: E501
    bank_accounts: GetBankAccountsSuccessResponseResultBankAccounts = Field(alias="BankAccounts")
    __properties: ClassVar[List[str]] = ["BankAccounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "BankAccounts": GetBankAccountsSuccessResponseResultBankAccounts.from_dict(obj["BankAccounts"]) if obj.get("BankAccounts") is not None else None
        })
        return _obj
