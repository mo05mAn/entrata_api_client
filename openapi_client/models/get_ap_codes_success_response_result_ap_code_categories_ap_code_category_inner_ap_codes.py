...
class GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodes(BaseModel):
    """
    GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodes
    """ # noqa: E501
    ap_code: List[GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner] = Field(description="A list of accounts payable codes associated with the category.", alias="apCode")
    __properties: ClassVar[List[str]] = ["apCode"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_code (list)
        _items = []
        if self.ap_code:
            for _item in self.ap_code:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apCode": [GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInnerApCodesApCodeInner.from_dict(_item) for _item in obj["apCode"]] if obj.get("apCode") is not None else None
        })
        return _obj
