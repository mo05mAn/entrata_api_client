...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAssignableItemsAssignableItemInner
    """ # noqa: E501
    id: StrictInt = Field(description="Assignable item ID")
    name: StrictStr = Field(description="Assignable item name")
