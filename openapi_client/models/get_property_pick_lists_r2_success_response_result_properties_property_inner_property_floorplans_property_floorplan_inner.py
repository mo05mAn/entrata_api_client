...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloorplansPropertyFloorplanInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloorplansPropertyFloorplanInner
    """ # noqa: E501
    id: StrictInt = Field(description="Floorplan ID")
    name: StrictStr = Field(description="Floorplan name")
