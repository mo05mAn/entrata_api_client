...
class SendVendorsSuccessResponseResultVendorsVendorInnerAttributes(BaseModel):
    """
    SendVendorsSuccessResponseResultVendorsVendorInnerAttributes
    """ # noqa: E501
    vendor_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the vendor.", alias="vendorId")
    status: Optional[StrictStr] = Field(default=None, description="Status of the vendor insertion.")
    message: Optional[StrictStr] = Field(default=None, description="Message indicating the result of the vendor insertion.")
    __properties: ClassVar[List[str]] = ["vendorId", "status", "message"]
