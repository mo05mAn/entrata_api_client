...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildings(BaseModel):
    """
    Buildings within the property
    """ # noqa: E501
    property_building: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner] = Field(alias="propertyBuilding")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "propertyBuilding": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyBuildingsPropertyBuildingInner.from_dict(_item) for _item in obj["propertyBuilding"]] if obj.get("propertyBuilding") is not None else None
        })
        return _obj
