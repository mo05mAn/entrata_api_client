...
class GetWorkOrderPickListsMethodParams(BaseModel):
    """
    GetWorkOrderPickListsMethodParams
    """ # noqa: E501
    property_ids: Optional[StrictStr] = Field(default=None, description="This is a required field. This field accepts comma seperated multiple values. The node accepts multiple propertyIds as the input value.", alias="propertyIds")
    __properties: ClassVar[List[str]] = ["propertyIds"]
