...
class GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner(BaseModel):
    """
    GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInner
    """ # noqa: E501
    attributes: Optional[GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
