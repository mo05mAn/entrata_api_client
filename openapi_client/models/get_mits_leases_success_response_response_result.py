...
class GetMitsLeasesSuccessResponseResponseResult(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResult
    """ # noqa: E501
    lease_application: GetMitsLeasesSuccessResponseResponseResultLeaseApplication = Field(alias="LeaseApplication")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LeaseApplication": GetMitsLeasesSuccessResponseResponseResultLeaseApplication.from_dict(obj["LeaseApplication"]) if obj.get("LeaseApplication") is not None else None
        })
        return _obj
