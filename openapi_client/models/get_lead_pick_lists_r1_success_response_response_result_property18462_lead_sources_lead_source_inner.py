...
class GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSourcesLeadSourceInner(BaseModel):
    """
    GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSourcesLeadSourceInner
    """ # noqa: E501
    attributes: Optional[GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSourcesLeadSourceInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSourcesLeadSourceInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
