...
class GetAccessibleClientsSuccessResponseResultOrgsInner(BaseModel):
    """
    GetAccessibleClientsSuccessResponseResultOrgsInner
    """ # noqa: E501
    subdomain: StrictStr = Field(description="The subdomain of the organization")
    id: StrictInt = Field(description="The unique identifier of the organization")
    name: StrictStr = Field(description="The name of the organization")
    __properties: ClassVar[List[str]] = ["subdomain", "id", "name"]
