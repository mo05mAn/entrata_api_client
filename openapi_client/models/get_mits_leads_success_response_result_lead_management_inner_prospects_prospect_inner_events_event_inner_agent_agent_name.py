...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgentAgentName(BaseModel):
    """
    GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgentAgentName
    """ # noqa: E501
    first_name: Optional[StrictStr] = Field(default=None, description="The first name of the agent.", alias="FirstName")
    last_name: Optional[StrictStr] = Field(default=None, description="The last name of the agent.", alias="LastName")
