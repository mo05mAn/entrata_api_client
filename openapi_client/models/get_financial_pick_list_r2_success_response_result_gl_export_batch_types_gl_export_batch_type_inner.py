...
class GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL export batch type.")
    name: StrictStr = Field(description="The name of the GL export batch type.")
