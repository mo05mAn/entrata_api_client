...
class GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInnerLocationsLocationInnerProblems(BaseModel):
    """
    GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInnerLocationsLocationInnerProblems
    """ # noqa: E501
    problem: List[GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInnerLocationsLocationInnerProblemsProblemInner]
    __properties: ClassVar[List[str]] = ["problem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in problem (list)
        _items = []
        if self.problem:
            for _item in self.problem:
                if _item:
                    _items.append(_item.to_dict())
            _dict['problem'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "problem": [GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInnerLocationsLocationInnerProblemsProblemInner.from_dict(_item) for _item in obj["problem"]] if obj.get("problem") is not None else None
        })
        return _obj
