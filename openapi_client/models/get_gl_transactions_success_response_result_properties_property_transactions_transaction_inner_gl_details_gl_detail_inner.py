...
class GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetailsGlDetailInner(BaseModel):
    """
    GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetailsGlDetailInner
    """ # noqa: E501
    transaction_date: StrictStr = Field(description="The date of the transaction.", alias="transactionDate")
    post_month: StrictStr = Field(description="The posting month of the transaction.", alias="postMonth")
    post_date: StrictStr = Field(description="The posting date of the transaction.", alias="postDate")
    debit: StrictStr = Field(description="The debit amount of the transaction.")
    credit: StrictStr = Field(description="The credit amount of the transaction.")
    balance: StrictStr = Field(description="The balance after the transaction.")
    reference: StrictStr = Field(description="The reference for the transaction.")
    memo: StrictStr = Field(description="The memo for the transaction.")
    attributes: GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetailsGlDetailInnerAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["transactionDate", "postMonth", "postDate", "debit", "credit", "balance", "reference", "memo", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memo": obj.get("memo"),
            "@attributes": GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetailsGlDetailInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
