...
class SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner(BaseModel):
    """
    SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the applicant.")
    first_name: Optional[StrictStr] = Field(default=None, description="The first name of the applicant.", alias="firstName")
    last_name: Optional[StrictStr] = Field(default=None, description="The last name of the applicant.", alias="lastName")
