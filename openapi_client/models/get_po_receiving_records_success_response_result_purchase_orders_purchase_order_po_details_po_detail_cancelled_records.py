...
class GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetailsPoDetailCancelledRecords(BaseModel):
    """
    GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetailsPoDetailCancelledRecords
    """ # noqa: E501
    cancelled_record: Optional[List[GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetailsPoDetailCancelledRecordsCancelledRecordInner]] = Field(default=None, alias="cancelledRecord")
    __properties: ClassVar[List[str]] = ["cancelledRecord"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in cancelled_record (list)
        _items = []
        if self.cancelled_record:
            for _item in self.cancelled_record:
                if _item:
                    _items.append(_item.to_dict())
            _dict['cancelledRecord'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cancelledRecord": [GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetailsPoDetailCancelledRecordsCancelledRecordInner.from_dict(_item) for _item in obj["cancelledRecord"]] if obj.get("cancelledRecord") is not None else None
        })
        return _obj
