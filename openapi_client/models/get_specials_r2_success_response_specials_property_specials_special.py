...
class GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecial(BaseModel):
    """
    ...
    rates: List[GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialRatesInner] = Field(description="List of rates associated with the special.")
    lease_terms: List[GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner] = Field(description="List of lease terms for the special.", alias="leaseTerms")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "startDate", "endDate", "couponCode", "cap", "remaining", "showOnWebsite", "isActive", "rates", "leaseTerms"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.rates:
            ...
            _dict['rates'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in lease_terms (list)
        _items = []
        if self.lease_terms:
            for _item in self.lease_terms:
                if _item:
                    _items.append(_item.to_dict())
            _dict['leaseTerms'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rates": [GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None,
            "leaseTerms": [GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner.from_dict(_item) for _item in obj["leaseTerms"]] if obj.get("leaseTerms") is not None else None
        })
        return _obj
