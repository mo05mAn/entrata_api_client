...
class GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlTransactionTypesGlTransactionTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL transaction type.")
    name: StrictStr = Field(description="The name of the GL transaction type.")
