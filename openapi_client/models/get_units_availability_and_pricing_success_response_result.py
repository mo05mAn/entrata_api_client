...
class GetUnitsAvailabilityAndPricingSuccessResponseResult(BaseModel):
    """
    Result object containing properties and units
    """ # noqa: E501
    properties: GetUnitsAvailabilityAndPricingSuccessResponseResultProperties = Field(alias="Properties")
    property_units: GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits = Field(alias="PropertyUnits")
    __properties: ClassVar[List[str]] = ["Properties", "PropertyUnits"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of property_units
        if self.property_units:
            _dict['PropertyUnits'] = self.property_units.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Properties": GetUnitsAvailabilityAndPricingSuccessResponseResultProperties.from_dict(obj["Properties"]) if obj.get("Properties") is not None else None,
            "PropertyUnits": GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits.from_dict(obj["PropertyUnits"]) if obj.get("PropertyUnits") is not None else None
        })
        return _obj
