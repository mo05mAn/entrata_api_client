...
class GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRates(BaseModel):
    """
    List of rates associated with the amenity
    """ # noqa: E501
    rate: List[GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rate": [GetReservableAmenitiesSuccessResponseResultAmenitiesAmenityInnerRatesRateInner.from_dict(_item) for _item in obj["rate"]] if obj.get("rate") is not None else None
        })
        return _obj
