...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursHolidayHoursHolidayHour(BaseModel):
    """
    Specific holiday hour
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the holiday", alias="Name")
    var_date: Optional[StrictStr] = Field(default=None, description="Date of the holiday", alias="Date")
