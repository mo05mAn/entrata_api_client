...
class SendRentableItemsSuccessResponseResult(BaseModel):
    """
    SendRentableItemsSuccessResponseResult
    """ # noqa: E501
    rentable_item_types: SendRentableItemsSuccessResponseResultRentableItemTypes = Field(alias="rentableItemTypes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rentableItemTypes": SendRentableItemsSuccessResponseResultRentableItemTypes.from_dict(obj["rentableItemTypes"]) if obj.get("rentableItemTypes") is not None else None
        })
        return _obj
