...
class GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerGlAccount(BaseModel):
    """
    GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerGlAccount
    """ # noqa: E501
    id: StrictStr = Field(description="GL account ID")
    name: StrictStr = Field(description="GL account name")
    account_number: StrictStr = Field(description="GL account number", alias="accountNumber")
    __properties: ClassVar[List[str]] = ["id", "name", "accountNumber"]
