...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAttributes(BaseModel):
    """
    GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAttributes
    """ # noqa: E501
    event_type: Optional[StrictStr] = Field(default=None, description="The type of the event.", alias="EventType")
    event_date: Optional[StrictStr] = Field(default=None, description="The date and time of the event.", alias="EventDate")
    __properties: ClassVar[List[str]] = ["EventType", "EventDate"]
