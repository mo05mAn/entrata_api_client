...
class GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomers(BaseModel):
    """
    Information about the customer
    """ # noqa: E501
    customer: List[GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner] = Field(description="List of customers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer": [GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerCustomersCustomerInner.from_dict(_item) for _item in obj["customer"]] if obj.get("customer") is not None else None
        })
        return _obj
