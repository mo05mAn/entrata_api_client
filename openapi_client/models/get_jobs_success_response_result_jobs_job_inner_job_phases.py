...
class GetJobsSuccessResponseResultJobsJobInnerJobPhases(BaseModel):
    """
    GetJobsSuccessResponseResultJobsJobInnerJobPhases
    """ # noqa: E501
    job_phase: List[GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner] = Field(description="A list of job phases associated with the job.", alias="jobPhase")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobPhase": [GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner.from_dict(_item) for _item in obj["jobPhase"]] if obj.get("jobPhase") is not None else None
        })
        return _obj
