...
class GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesAmenitiesPropertyAmenitiesAmenityInner(BaseModel):
    """
    GetLeadsSuccessResponseResultProspectsProspectInnerCustomerPreferencesAmenitiesPropertyAmenitiesAmenityInner
    """ # noqa: E501
    amenity_type: StrictStr = Field(description="The type of amenity.", alias="amenityType")
    amenity: StrictStr = Field(description="The amenity itself.")
    description: Optional[StrictStr] = Field(default=None, description="The description of the amenity.")
    __properties: ClassVar[List[str]] = ["amenityType", "amenity", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amenityType": obj.get("amenityType"),
