...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsInnerPersonDetailsIdentificationAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    id_type: StrictStr = Field(description="ID type", alias="IDType")
    id_rank: StrictStr = Field(description="ID rank", alias="IDRank")
    id_scope_type: StrictStr = Field(description="ID scope type", alias="IDScopeType")
