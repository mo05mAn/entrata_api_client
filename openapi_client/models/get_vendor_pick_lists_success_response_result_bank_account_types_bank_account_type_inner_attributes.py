...
class GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultBankAccountTypesBankAccountTypeInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the bank account type.")
    name: StrictStr = Field(description="Name of the bank account type.")
