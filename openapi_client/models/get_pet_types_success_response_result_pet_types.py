...
class GetPetTypesSuccessResponseResultPetTypes(BaseModel):
    """
    Pet types available for the properties
    """ # noqa: E501
    var_property: Dict[str, GetPetTypesSuccessResponseResultPetTypesPropertyValue] = Field(description="Properties containing pet type data", alias="Property")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in var_property (dict)
        _field_dict = {}
        if self.var_property:
            for _key in self.var_property:
                if self.var_property[_key]:
                    _field_dict[_key] = self.var_property[_key].to_dict()
            _dict['Property'] = _field_dict
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": dict(
                (_k, GetPetTypesSuccessResponseResultPetTypesPropertyValue.from_dict(_v))
                for _k, _v in obj["Property"].items()
            )
