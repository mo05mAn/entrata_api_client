...
class GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultPoliciesPolicyInnerCoveragesCoverageInner
    """ # noqa: E501
    id: StrictStr = Field(description="Coverage ID.")
    name: StrictStr = Field(description="Coverage name.")
