...
class GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInner(BaseModel):
    """
    ...
    lease_interval_type_id: StrictInt = Field(description="ID of the lease interval type", alias="leaseIntervalTypeId")
    lease_interval_type_name: StrictStr = Field(description="Name of the lease interval type", alias="leaseIntervalTypeName")
    lease_interval_status_type_id: StrictInt = Field(description="ID of the lease interval status", alias="leaseIntervalStatusTypeId")
    interval_date_time: StrictStr = Field(description="Date and time of the lease interval", alias="intervalDateTime")
    applications: GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInnerApplications
    __properties: ClassVar[List[str]] = ["id", "startDate", "endDate", "leaseIntervalTypeId", "leaseIntervalTypeName", "leaseIntervalStatusTypeId", "intervalDateTime", "applications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intervalDateTime": obj.get("intervalDateTime"),
            "applications": GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerLeaseIntervalsLeaseIntervalInnerApplications.from_dict(obj["applications"]) if obj.get("applications") is not None else None
        })
        return _obj
