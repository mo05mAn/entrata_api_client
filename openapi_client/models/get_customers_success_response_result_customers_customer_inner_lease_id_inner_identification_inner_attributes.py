...
class GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerLeaseIdInnerIdentificationInnerAttributes
    """ # noqa: E501
    id_type: Optional[StrictStr] = Field(default=None, description="Type of ID", alias="IDType")
    id_rank: Optional[StrictStr] = Field(default=None, description="Rank of ID", alias="IDRank")
    id_scope_type: Optional[StrictStr] = Field(default=None, description="Scope type of the ID", alias="IDScopeType")
    status: Optional[StrictStr] = Field(default=None, description="Status of the lease", alias="Status")
    __properties: ClassVar[List[str]] = ["IDType", "IDRank", "IDScopeType", "Status"]
