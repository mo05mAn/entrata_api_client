...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerUnitTypes(BaseModel):
    """
    Unit types available at the property
    """ # noqa: E501
    unit_type: List[GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerUnitTypesUnitTypeInner] = Field(description="List of unit types", alias="UnitType")
    __properties: ClassVar[List[str]] = ["UnitType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in unit_type (list)
        _items = []
        if self.unit_type:
            for _item in self.unit_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['UnitType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "UnitType": [GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerUnitTypesUnitTypeInner.from_dict(_item) for _item in obj["UnitType"]] if obj.get("UnitType") is not None else None
        })
        return _obj
