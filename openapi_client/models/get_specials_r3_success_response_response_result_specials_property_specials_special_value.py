...
class GetSpecialsR3SuccessResponseResponseResultSpecialsPropertySpecialsSpecialValue(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "showOnWebsite", "isActive", "giftValue"]
