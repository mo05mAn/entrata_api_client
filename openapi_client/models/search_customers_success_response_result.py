...
class SearchCustomersSuccessResponseResult(BaseModel):
    """
    SearchCustomersSuccessResponseResult
    """ # noqa: E501
    customers: SearchCustomersSuccessResponseResultCustomers
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": SearchCustomersSuccessResponseResultCustomers.from_dict(obj["customers"]) if obj.get("customers") is not None else None
        })
        return _obj
