...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerIdentificationAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    id_type: Optional[StrictStr] = Field(default=None, description="Customer ID", alias="IDType")
