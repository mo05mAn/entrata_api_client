...
class GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlHeaderStatusTypesGlHeaderStatusTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL header status type.")
    name: StrictStr = Field(description="The name of the GL header status type.")
