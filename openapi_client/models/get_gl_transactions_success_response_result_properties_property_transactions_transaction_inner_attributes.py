...
class GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerAttributes(BaseModel):
    """
    ...
    external_id: Optional[StrictStr] = Field(default=None, description="The external ID associated with the account.", alias="externalId")
    __properties: ClassVar[List[str]] = ["accountId", "accountName", "accountNumber", "externalId"]
