...
class GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecials(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecials
    """ # noqa: E501
    special: Dict[str, GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "special": dict(
                (_k, GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValue.from_dict(_v))
