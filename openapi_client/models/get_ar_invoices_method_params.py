...
class GetArInvoicesMethodParams(BaseModel):
    """
    ...
    lease_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. leaseIds", alias="leaseIds")
    ar_invoice_id: Optional[StrictInt] = Field(default=None, description="  This is an optional field. This field accepts single value. arInvoiceId", alias="arInvoiceId")
    ...
    __properties: ClassVar[List[str]] = ["propertyId", "leaseIds", "arInvoiceId", "fromDate", "toDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "arInvoiceId": obj.get("arInvoiceId"),
