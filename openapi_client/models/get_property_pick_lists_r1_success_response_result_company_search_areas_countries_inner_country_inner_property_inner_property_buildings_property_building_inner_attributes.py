...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerPropertyBuildingsPropertyBuildingInnerAttributes(BaseModel):
    """
    Building attributes
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Building ID", alias="Id")
    name: Optional[StrictStr] = Field(default=None, description="Building name", alias="Name")
