...
class GetPetTypesSuccessResponseResultPetTypesPropertyValuePetTypeInnerAttributes(BaseModel):
    """
    Attributes related to the pet type
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the pet type", alias="Name")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the pet type", alias="Id")
