...
class GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner
    """ # noqa: E501
    add_on_type: StrictStr = Field(description="Type of the add-on item.", alias="addOnType")
    add_on_category: StrictStr = Field(description="Category of the add-on.", alias="addOnCategory")
    add_on_group: Optional[StrictStr] = Field(default=None, description="Group the add-on belongs to.", alias="addOnGroup")
    add_on_name: StrictStr = Field(description="Name of the add-on item.", alias="addOnName")
    lease_status_type: StrictStr = Field(description="Lease status of the add-on item.", alias="leaseStatusType")
