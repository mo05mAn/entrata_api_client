...
class GetTestimonialPickListsMethod(BaseModel):
    """
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['getTestimonialPickLists']):
            raise ValueError("must be one of enum values ('getTestimonialPickLists')")
        return value
