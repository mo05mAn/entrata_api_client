...
class GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityAttributes(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityAttributes
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the floorplan amenity", alias="Id")
