...
class GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner(BaseModel):
    """
    GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner
    """ # noqa: E501
    job_phase_id: StrictStr = Field(description="The unique identifier for the job phase.", alias="jobPhaseId")
    job_phase_name: StrictStr = Field(description="The name of the job phase.", alias="jobPhaseName")
    ap_codes: List[GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInnerApCodesInner] = Field(description="A list of accounts payable codes associated with the job phase.", alias="apCodes")
    __properties: ClassVar[List[str]] = ["jobPhaseId", "jobPhaseName", "apCodes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_codes (list)
        _items = []
        if self.ap_codes:
            for _item in self.ap_codes:
                if _item:
                    _items.append(_item.to_dict())
            _dict['apCodes'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobPhaseName": obj.get("jobPhaseName"),
            "apCodes": [GetJobCostBudgetsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInnerApCodesInner.from_dict(_item) for _item in obj["apCodes"]] if obj.get("apCodes") is not None else None
        })
        return _obj
