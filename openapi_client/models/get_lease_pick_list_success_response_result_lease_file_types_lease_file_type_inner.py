...
class GetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner(BaseModel):
    """
    GetLeasePickListSuccessResponseResultLeaseFileTypesLeaseFileTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the lease file type.")
    system_code: StrictStr = Field(description="System code associated with the lease file type.", alias="systemCode")
    name: StrictStr = Field(description="Name of the lease file type.")
