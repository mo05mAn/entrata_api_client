...
class DeletePropertyMedia(BaseModel):
    """
    DeletePropertyMedia
    """ # noqa: E501
    auth: UpdatePropertyMediaAuth
    request_id: Optional[StrictStr] = Field(default=None, description="An arbitrary value to relate with response.", alias="requestId")
    method: DeletePropertyMediaMethod
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auth": UpdatePropertyMediaAuth.from_dict(obj["auth"]) if obj.get("auth") is not None else None,
            "requestId": obj.get("requestId"),
            "method": DeletePropertyMediaMethod.from_dict(obj["method"]) if obj.get("method") is not None else None
        })
        return _obj
