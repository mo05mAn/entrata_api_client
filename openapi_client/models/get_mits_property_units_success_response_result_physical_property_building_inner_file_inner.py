...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInner(BaseModel):
    """
    ...
    format: Optional[StrictStr] = Field(default=None, description="File format", alias="Format")
    src: Optional[StrictStr] = Field(default=None, description="Source URL of the file", alias="Src")
    rank: Optional[StrictStr] = Field(default=None, description="Rank of the file", alias="Rank")
    attributes: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInnerAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["FileType", "Name", "Format", "Src", "Rank", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Src": obj.get("Src"),
            "Rank": obj.get("Rank"),
            "@attributes": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerFileInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
