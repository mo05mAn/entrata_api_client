...
class SendPropertyMediaSuccessResponseResponseResult(BaseModel):
    """
    SendPropertyMediaSuccessResponseResponseResult
    """ # noqa: E501
    media: List[SendPropertyMediaSuccessResponseResponseResultMediaInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "media": [SendPropertyMediaSuccessResponseResponseResultMediaInner.from_dict(_item) for _item in obj["media"]] if obj.get("media") is not None else None
        })
        return _obj
