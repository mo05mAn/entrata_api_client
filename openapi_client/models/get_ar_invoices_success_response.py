...
class GetArInvoicesSuccessResponse(BaseModel):
    """
    GetArInvoicesSuccessResponse
    """ # noqa: E501
    response: GetArInvoicesSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetArInvoicesSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
