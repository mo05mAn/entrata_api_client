...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomerPreferencesAmenitiesInnerAttributes(BaseModel):
    """
    GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomerPreferencesAmenitiesInnerAttributes
    """ # noqa: E501
    amenity_type: Optional[StrictStr] = Field(default=None, description="The type of amenity.", alias="AmenityType")
    __properties: ClassVar[List[str]] = ["AmenityType"]
