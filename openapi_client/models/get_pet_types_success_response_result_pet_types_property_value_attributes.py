...
class GetPetTypesSuccessResponseResultPetTypesPropertyValueAttributes(BaseModel):
    """
    Attributes related to the property
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique property identifier")
