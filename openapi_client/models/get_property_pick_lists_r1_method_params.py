...
class GetPropertyPickListsR1MethodParams(BaseModel):
    """
    GetPropertyPickListsR1MethodParams
    """ # noqa: E501
    property_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. Comman seperated list of properties", alias="propertyIds")
