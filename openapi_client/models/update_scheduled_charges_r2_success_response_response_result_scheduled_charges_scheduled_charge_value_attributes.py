...
class UpdateScheduledChargesR2SuccessResponseResponseResultScheduledChargesScheduledChargeValueAttributes(BaseModel):
    """
    ...
    node: StrictStr = Field(description="Node identifier")
    status: StrictStr = Field(description="Status of the scheduled charge update")
    message: StrictStr = Field(description="Message detailing the result of the scheduled charge update")
