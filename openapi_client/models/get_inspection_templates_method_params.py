...
class GetInspectionTemplatesMethodParams(BaseModel):
    """
    GetInspectionTemplatesMethodParams
    """ # noqa: E501
    property_ids: StrictStr = Field(description="This is a required field. This field accepts comma seperated multiple values. The node accepts multiple propertyIds as the input value.", alias="propertyIds")
    show_disabled: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. The node accepts a boolean value and default value for this node is \"0\".", alias="showDisabled")
    __properties: ClassVar[List[str]] = ["propertyIds", "showDisabled"]

    @field_validator('show_disabled')
    def show_disabled_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "showDisabled": obj.get("showDisabled")
        })
        return _obj
