...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddress(BaseModel):
    """
    Address of the property
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Street address", alias="Address")
    city: Optional[StrictStr] = Field(default=None, description="City of the property", alias="City")
    state: Optional[StrictStr] = Field(default=None, description="State of the property", alias="State")
    postal_code: Optional[StrictStr] = Field(default=None, description="Postal code of the property", alias="PostalCode")
    country: Optional[StrictStr] = Field(default=None, description="Country of the property", alias="Country")
    email: Optional[StrictStr] = Field(default=None, description="Contact email for the property", alias="Email")
    attributes: Optional[GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddressAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["Address", "City", "State", "PostalCode", "Country", "Email", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Email": obj.get("Email"),
            "@attributes": GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerAddressAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
