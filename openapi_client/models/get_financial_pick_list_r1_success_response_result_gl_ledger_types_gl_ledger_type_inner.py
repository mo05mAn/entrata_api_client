...
class GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlLedgerTypesGlLedgerTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL ledger type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL ledger type.", alias="Name")
