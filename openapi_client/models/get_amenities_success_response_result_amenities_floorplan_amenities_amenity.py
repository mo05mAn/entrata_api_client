...
class GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenity
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the floorplan amenity", alias="Name")
    ...
    floorplans: GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplans = Field(alias="Floorplans")
    attributes: GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["Name", "ImageUrl", "Description", "Floorplans", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Floorplans": GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplans.from_dict(obj["Floorplans"]) if obj.get("Floorplans") is not None else None,
            "@attributes": GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
