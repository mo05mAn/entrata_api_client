...
class GetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance(BaseModel):
    """
    GetInvoicesR1SuccessResponseResultInvoicesInvoiceRemittance
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the remittance")
    name: StrictStr = Field(description="Name of the remittance")
    ap_payment_type_id: StrictStr = Field(description="ID for the payment type", alias="apPaymentTypeId")
    ap_payment_type: StrictStr = Field(description="Payment type", alias="apPaymentType")
    street_line1: StrictStr = Field(description="Street address line 1", alias="streetLine1")
    street_line2: StrictStr = Field(description="Street address line 2", alias="streetLine2")
    street_line3: Optional[List[StrictStr]] = Field(default=None, description="Additional street address lines", alias="streetLine3")
    city: StrictStr = Field(description="City", alias="City")
    state_code: StrictStr = Field(description="State code", alias="stateCode")
    postal_code: StrictStr = Field(description="Postal code", alias="postalCode")
    __properties: ClassVar[List[str]] = ["id", "name", "apPaymentTypeId", "apPaymentType", "streetLine1", "streetLine2", "streetLine3", "City", "stateCode", "postalCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apPaymentType": obj.get("apPaymentType"),
