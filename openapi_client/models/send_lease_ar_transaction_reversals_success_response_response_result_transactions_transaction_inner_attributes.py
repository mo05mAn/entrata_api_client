...
class SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInnerAttributes(BaseModel):
    """
    SendLeaseArTransactionReversalsSuccessResponseResponseResultTransactionsTransactionInnerAttributes
    """ # noqa: E501
    reference_id: StrictStr = Field(description="The reference identifier for the transaction")
    transaction_id: StrictStr = Field(description="The transaction identifier")
    status: StrictStr = Field(description="The status of the transaction")
    message: StrictStr = Field(description="Message associated with the transaction")
    __properties: ClassVar[List[str]] = ["reference_id", "transaction_id", "status", "message"]
