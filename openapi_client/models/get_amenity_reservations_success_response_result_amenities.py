...
class GetAmenityReservationsSuccessResponseResultAmenities(BaseModel):
    """
    List of amenities
    """ # noqa: E501
    amenity: Optional[List[GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner]] = Field(default=None, description="List of amenity objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amenity": [GetAmenityReservationsSuccessResponseResultAmenitiesAmenityInner.from_dict(_item) for _item in obj["amenity"]] if obj.get("amenity") is not None else None
        })
        return _obj
