...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgent(BaseModel):
    """
    The agent related to the event.
    """ # noqa: E501
    agent_id: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgentAgentID] = Field(default=None, alias="AgentID")
    agent_name: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgentAgentName] = Field(default=None, alias="AgentName")
    __properties: ClassVar[List[str]] = ["AgentID", "AgentName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.agent_name:
            _dict['AgentName'] = self.agent_name.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "AgentID": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgentAgentID.from_dict(obj["AgentID"]) if obj.get("AgentID") is not None else None,
            "AgentName": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgentAgentName.from_dict(obj["AgentName"]) if obj.get("AgentName") is not None else None
        })
        return _obj
