...
class GetMitsCollectionsMethodParams(BaseModel):
    """
    ...
    include_evictions: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Include Evictions leases", alias="includeEvictions")
    ...
    __properties: ClassVar[List[str]] = ["propertyId", "includeEvictions", "fromDate", "transactionFromDate"]

    @field_validator('include_evictions')
    def include_evictions_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeEvictions": obj.get("includeEvictions"),
