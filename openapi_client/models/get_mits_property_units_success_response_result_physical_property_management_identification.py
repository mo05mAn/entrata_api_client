...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyManagementIdentification(BaseModel):
    """
    Identification details for the management
    """ # noqa: E501
    id_value: Optional[StrictStr] = Field(default=None, description="Unique ID for the management", alias="IDValue")
    organization_name: Optional[StrictStr] = Field(default=None, description="Name of the managing organization", alias="OrganizationName")
