...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServices(BaseModel):
    """
    Services available at the property
    """ # noqa: E501
    service: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "service": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerServicesServiceInner.from_dict(_item) for _item in obj["service"]] if obj.get("service") is not None else None
        })
        return _obj
