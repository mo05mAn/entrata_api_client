...
class GetLeadPickListsR2SuccessResponseResultLeadStatusesLeadStatusInnerAttributes(BaseModel):
    """
    Attributes related to the lead status.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the lead status.")
