...
class GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultBudgetsBudgetInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the budget.", alias="Id")
    name: StrictStr = Field(description="The name of the budget.", alias="Name")
    status_type_id: StrictInt = Field(description="The status type identifier for the budget.", alias="StatusTypeId")
    is_default: StrictInt = Field(description="Indicates if the budget is the default budget.", alias="IsDefault")
    status_type: StrictStr = Field(description="The status of the budget.", alias="StatusType")
    __properties: ClassVar[List[str]] = ["Id", "Name", "StatusTypeId", "IsDefault", "StatusType"]
