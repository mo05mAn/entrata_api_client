...
class GetFinancialPickListR2SuccessResponseResultGlExportBatchTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlExportBatchTypes
    """ # noqa: E501
    gl_export_batch_type: List[GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner] = Field(description="A list of GL export batch types.", alias="glExportBatchType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glExportBatchType": [GetFinancialPickListR2SuccessResponseResultGlExportBatchTypesGlExportBatchTypeInner.from_dict(_item) for _item in obj["glExportBatchType"]] if obj.get("glExportBatchType") is not None else None
        })
        return _obj
