...
class UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenities(BaseModel):
    """
    UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenities
    """ # noqa: E501
    unit_space_amenity: List[UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner] = Field(description="List of unit space amenities updated", alias="unitSpaceAmenity")
    __properties: ClassVar[List[str]] = ["unitSpaceAmenity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in unit_space_amenity (list)
        _items = []
        if self.unit_space_amenity:
            for _item in self.unit_space_amenity:
                if _item:
                    _items.append(_item.to_dict())
            _dict['unitSpaceAmenity'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitSpaceAmenity": [UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner.from_dict(_item) for _item in obj["unitSpaceAmenity"]] if obj.get("unitSpaceAmenity") is not None else None
        })
        return _obj
