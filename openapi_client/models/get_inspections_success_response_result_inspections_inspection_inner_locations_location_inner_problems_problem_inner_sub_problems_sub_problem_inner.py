...
class GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInnerSubProblemsSubProblemInner(BaseModel):
    """
    ...
    """ # noqa: E501
    sub_problem_id: StrictStr = Field(description="ID of the subproblem", alias="subProblemId")
    sub_problem_name: StrictStr = Field(description="Name of the subproblem", alias="subProblemName")
    __properties: ClassVar[List[str]] = ["subProblemId", "subProblemName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subProblemId": obj.get("subProblemId"),
            "subProblemName": obj.get("subProblemName")
        })
        return _obj
