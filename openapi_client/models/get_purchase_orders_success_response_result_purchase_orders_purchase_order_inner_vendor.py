...
class GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor(BaseModel):
    """
    GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerVendor
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the vendor.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the vendor.")
