...
class GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerListItemsListItemInnerAttributes(BaseModel):
    """
    Attributes related to the list item.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the list item.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the list item.")
