...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactions(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactions
    """ # noqa: E501
    var_property: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsProperty = Field(alias="Property")
    rt_customer: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomer = Field(alias="RT_Customer")
    unit: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnit = Field(alias="Unit")
    rt_service_transactions: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactions = Field(alias="RTServiceTransactions")
    __properties: ClassVar[List[str]] = ["Property", "RT_Customer", "Unit", "RTServiceTransactions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rt_customer
        if self.rt_customer:
            _dict['RT_Customer'] = self.rt_customer.to_dict()
        # override the default output from pydantic by calling `to_dict()` of unit
        if self.unit:
            _dict['Unit'] = self.unit.to_dict()
        # override the default output from pydantic by calling `to_dict()` of rt_service_transactions
        if self.rt_service_transactions:
            _dict['RTServiceTransactions'] = self.rt_service_transactions.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsProperty.from_dict(obj["Property"]) if obj.get("Property") is not None else None,
            "RT_Customer": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomer.from_dict(obj["RT_Customer"]) if obj.get("RT_Customer") is not None else None,
            "Unit": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnit.from_dict(obj["Unit"]) if obj.get("Unit") is not None else None,
            "RTServiceTransactions": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactions.from_dict(obj["RTServiceTransactions"]) if obj.get("RTServiceTransactions") is not None else None
        })
        return _obj
