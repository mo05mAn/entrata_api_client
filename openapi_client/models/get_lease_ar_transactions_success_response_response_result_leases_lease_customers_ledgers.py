...
class GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgers(BaseModel):
    """
    GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgers
    """ # noqa: E501
    ledger: GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger
    __properties: ClassVar[List[str]] = ["ledger"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ledger": GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomersLedgersLedger.from_dict(obj["ledger"]) if obj.get("ledger") is not None else None
        })
        return _obj
