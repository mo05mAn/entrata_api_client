...
class GetMitsCollectionsSuccessResponseResponse(BaseModel):
    """
    GetMitsCollectionsSuccessResponseResponse
    """ # noqa: E501
    code: StrictInt = Field(description="Successful response code.")
    result: GetMitsCollectionsSuccessResponseResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "result": GetMitsCollectionsSuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
