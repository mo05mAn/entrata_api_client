...
class UpdateInvoicesSuccessResponseResult(BaseModel):
    """
    UpdateInvoicesSuccessResponseResult
    """ # noqa: E501
    ap_headers: Optional[UpdateInvoicesSuccessResponseResultApHeaders] = Field(default=None, alias="apHeaders")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apHeaders": UpdateInvoicesSuccessResponseResultApHeaders.from_dict(obj["apHeaders"]) if obj.get("apHeaders") is not None else None
        })
        return _obj
