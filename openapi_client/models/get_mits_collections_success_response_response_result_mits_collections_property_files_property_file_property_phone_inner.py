...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyPhoneInner(BaseModel):
    """
    GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyPhoneInner
    """ # noqa: E501
    attributes: GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyPhoneInnerAttributes = Field(alias="@attributes")
    phone_description: StrictStr = Field(description="Phone description", alias="PhoneDescription")
    phone_number: StrictStr = Field(description="Phone number", alias="PhoneNumber")
    __properties: ClassVar[List[str]] = ["@attributes", "PhoneDescription", "PhoneNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFilePropertyPhoneInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
