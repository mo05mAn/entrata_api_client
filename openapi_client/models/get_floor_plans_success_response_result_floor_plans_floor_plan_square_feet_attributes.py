...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanSquareFeetAttributes(BaseModel):
    """
    Attributes related to the square footage
    """ # noqa: E501
    max: Optional[StrictStr] = Field(default=None, description="Maximum square footage", alias="Max")
    min: Optional[StrictStr] = Field(default=None, description="Minimum square footage", alias="Min")
