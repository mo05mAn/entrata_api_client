...
class GenerateQuotesSuccessResponseResult(BaseModel):
    """
    The result data of the request.
    """ # noqa: E501
    quotes: Optional[GenerateQuotesSuccessResponseResultQuotes] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quotes": GenerateQuotesSuccessResponseResultQuotes.from_dict(obj["quotes"]) if obj.get("quotes") is not None else None
        })
        return _obj
