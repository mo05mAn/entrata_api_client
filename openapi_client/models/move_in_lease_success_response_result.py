...
class MoveInLeaseSuccessResponseResult(BaseModel):
    """
    MoveInLeaseSuccessResponseResult
    """ # noqa: E501
    status: StrictStr = Field(description="Status of the move-in request")
    message: StrictStr = Field(description="Message regarding the move-in request")
