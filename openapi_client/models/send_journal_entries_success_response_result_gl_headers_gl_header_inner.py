...
class SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner(BaseModel):
    """
    SendJournalEntriesSuccessResponseResultGlHeadersGlHeaderInner
    """ # noqa: E501
    node: StrictStr = Field(description="The node identifier for the GL header insertion.")
    status: StrictStr = Field(description="The status of the GL header insertion.")
    message: StrictStr = Field(description="Message indicating the result of the GL header insertion.")
    gl_header_id: StrictStr = Field(description="The unique identifier for the GL header.", alias="glHeaderId")
    je_number: StrictStr = Field(description="The journal entry number.", alias="jeNumber")
    __properties: ClassVar[List[str]] = ["node", "status", "message", "glHeaderId", "jeNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "glHeaderId": obj.get("glHeaderId"),
            "jeNumber": obj.get("jeNumber")
        })
        return _obj
