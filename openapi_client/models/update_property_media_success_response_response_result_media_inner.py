...
class UpdatePropertyMediaSuccessResponseResponseResultMediaInner(BaseModel):
    """
    ...
    id: StrictStr = Field(description="ID of the updated media")
    status: StrictStr = Field(description="Status of the media update")
