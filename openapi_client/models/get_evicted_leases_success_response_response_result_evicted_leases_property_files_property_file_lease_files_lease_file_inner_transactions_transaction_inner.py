...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTransactionsTransactionInner(BaseModel):
    """
    ...
    transaction_date: StrictStr = Field(description="Date of the transaction.", alias="transactionDate")
    description: StrictStr = Field(description="Description of the transaction.")
    transaction_type: StrictStr = Field(description="Type of the transaction.", alias="transactionType")
    transaction_amount: StrictStr = Field(description="Amount of the transaction.", alias="transactionAmount")
    open_amount: StrictStr = Field(description="Open amount for the transaction.", alias="openAmount")
    __properties: ClassVar[List[str]] = ["transactionId", "transactionDate", "description", "transactionType", "transactionAmount", "openAmount"]
