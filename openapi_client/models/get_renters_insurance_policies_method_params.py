...
class GetRentersInsurancePoliciesMethodParams(BaseModel):
    """
    ...
    last_updated_on: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value. lastUpdatedOn", alias="lastUpdatedOn")
    __properties: ClassVar[List[str]] = ["propertyId", "leaseStatusTypeIds", "lastUpdatedOn"]
