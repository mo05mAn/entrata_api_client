...
class SendPropertyMediaSuccessResponseResponseResultMediaInner(BaseModel):
    """
    SendPropertyMediaSuccessResponseResponseResultMediaInner
    """ # noqa: E501
    node: StrictInt = Field(description="Node number of the media in request")
    id: StrictInt = Field(description="ID of the newly created media")
    status: StrictStr = Field(description="Status of the media insertion")
    message: StrictStr = Field(description="Detailed message about the operation")
    __properties: ClassVar[List[str]] = ["node", "id", "status", "message"]
