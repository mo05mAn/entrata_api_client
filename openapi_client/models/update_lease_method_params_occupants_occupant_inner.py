...
class UpdateLeaseMethodParamsOccupantsOccupantInner(BaseModel):
    """
    UpdateLeaseMethodParamsOccupantsOccupantInner
    """ # noqa: E501
    first_name: Optional[StrictStr] = Field(default=None, description="This is a required field. This field accepts single value. firstName", alias="firstName")
    last_name: Optional[StrictStr] = Field(default=None, description="This is a required field. This field accepts single value. lastName", alias="lastName")
