...
class GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner(BaseModel):
    """
    GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsitePropertiesWebsitePropertyInner
    """ # noqa: E501
    property_id: StrictStr = Field(description="ID of the property associated with the website", alias="propertyId")
    property_name: StrictStr = Field(description="Name of the property associated with the website", alias="propertyName")
    __properties: ClassVar[List[str]] = ["propertyId", "propertyName"]
