...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutTypesMoveOutTypeInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutTypesMoveOutTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="Move-out type ID")
    name: StrictStr = Field(description="Move-out type name")
