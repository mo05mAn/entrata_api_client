...
class GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesActiveScheduledChargesActiveScheduledCharge(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["arCodeId", "chargeCode", "chargeTiming", "chargeAmount"]
