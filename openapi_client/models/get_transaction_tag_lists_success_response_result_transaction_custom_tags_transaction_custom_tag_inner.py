...
class GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner(BaseModel):
    """
    GetTransactionTagListsSuccessResponseResultTransactionCustomTagsTransactionCustomTagInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the custom tag.")
    name: StrictStr = Field(description="The name of the custom tag.")
    code: Optional[StrictStr] = Field(default=None, description="The code associated with the custom tag.")
    description: Optional[StrictStr] = Field(default=None, description="The description of the custom tag.")
    is_published: StrictInt = Field(description="Indicates whether the custom tag is published.", alias="isPublished")
    __properties: ClassVar[List[str]] = ["id", "name", "code", "description", "isPublished"]
