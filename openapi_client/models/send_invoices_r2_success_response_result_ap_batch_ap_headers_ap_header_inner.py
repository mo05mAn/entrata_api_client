...
class SendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner(BaseModel):
    """
    SendInvoicesR2SuccessResponseResultApBatchApHeadersApHeaderInner
    """ # noqa: E501
    node: Optional[StrictInt] = Field(default=None, description="Node identifier for the AP header.")
    invoice_number: Optional[StrictStr] = Field(default=None, description="The invoice number associated with the AP header.", alias="invoiceNumber")
    ap_header_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the AP header.", alias="apHeaderId")
    status: Optional[StrictStr] = Field(default=None, description="Status of the AP header insertion.")
    message: Optional[StrictStr] = Field(default=None, description="Message indicating the result of the AP header insertion.")
    __properties: ClassVar[List[str]] = ["node", "invoiceNumber", "apHeaderId", "status", "message"]
