...
class GetMitsLeaseArTransactionsSuccessResponseResponseResult(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResult
    """ # noqa: E501
    resident_transactions: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactions = Field(alias="ResidentTransactions")
    __properties: ClassVar[List[str]] = ["ResidentTransactions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of resident_transactions
        if self.resident_transactions:
            _dict['ResidentTransactions'] = self.resident_transactions.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ResidentTransactions": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactions.from_dict(obj["ResidentTransactions"]) if obj.get("ResidentTransactions") is not None else None
        })
        return _obj
