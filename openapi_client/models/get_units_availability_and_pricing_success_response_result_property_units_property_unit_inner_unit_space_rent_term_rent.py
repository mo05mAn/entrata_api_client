...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInnerUnitSpaceRentTermRent(BaseModel):
    """
    Details about the lease term
    """ # noqa: E501
    lease_term: StrictStr = Field(description="Length of the lease", alias="LeaseTerm")
    rent: StrictStr = Field(description="Monthly rent amount", alias="Rent")
    rate_frequency: Optional[StrictStr] = Field(default=None, description="Frequency of rent payment", alias="RateFrequency")
    __properties: ClassVar[List[str]] = ["LeaseTerm", "Rent", "RateFrequency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Rent": obj.get("Rent"),
            "RateFrequency": obj.get("RateFrequency")
        })
        return _obj
