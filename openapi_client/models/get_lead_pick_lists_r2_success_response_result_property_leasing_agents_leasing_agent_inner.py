...
class GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner(BaseModel):
    """
    GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInner
    """ # noqa: E501
    attributes: Optional[GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetLeadPickListsR2SuccessResponseResultPropertyLeasingAgentsLeasingAgentInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
