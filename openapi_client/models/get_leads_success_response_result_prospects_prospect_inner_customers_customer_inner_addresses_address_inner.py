...
class GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddressesAddressInner(BaseModel):
    """
    GetLeadsSuccessResponseResultProspectsProspectInnerCustomersCustomerInnerAddressesAddressInner
    """ # noqa: E501
    address_line: StrictStr = Field(description="The address line.", alias="addressLine")
    city: StrictStr = Field(description="The city of the address.")
    state: StrictStr = Field(description="The state of the address.")
    province: Optional[StrictStr] = Field(default=None, description="The province of the address.")
    ...
    __properties: ClassVar[List[str]] = ["addressLine", "city", "state", "province", "countryCode", "postalCode"]
