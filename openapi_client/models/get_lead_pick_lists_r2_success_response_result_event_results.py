...
class GetLeadPickListsR2SuccessResponseResultEventResults(BaseModel):
    """
    Event results associated with the request.
    """ # noqa: E501
    event_result: Optional[List[GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner]] = Field(default=None, description="A list of event results.", alias="eventResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventResult": [GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInner.from_dict(_item) for _item in obj["eventResult"]] if obj.get("eventResult") is not None else None
        })
        return _obj
