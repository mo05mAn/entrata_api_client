...
class UpdateBudgetsMethodParams(BaseModel):
    """
    ...
    month: date = Field(description="This is a required field. This field accepts single value. Accepts budget month in MM/YYYY format.")
    amount: StrictInt = Field(description="This is a required field. This field accepts single value.")
    __properties: ClassVar[List[str]] = ["propertyId", "id", "month", "amount"]
