...
class GetVendorPickListsSuccessResponseResultVendorCategoryTypesVendorCategoryTypeInnerAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultVendorCategoryTypesVendorCategoryTypeInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the vendor category.")
    name: StrictStr = Field(description="Name of the vendor category.")
