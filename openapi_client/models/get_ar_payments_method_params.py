...
class GetArPaymentsMethodParams(BaseModel):
    """
    GetArPaymentsMethodParams
    """ # noqa: E501
    ar_payment_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. Comma separated ar payment ids.", alias="arPaymentIds")
    payment_status_type_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. Comma separated payment status type ids.", alias="paymentStatusTypeIds")
    from_date: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value. From date.", alias="fromDate")
    to_date: Optional[date] = Field(default=None, description="This is an optional field. This field accepts single value. To date", alias="toDate")
    is_include_allocations: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. This node should include allocations details of payment", alias="isIncludeAllocations")
    __properties: ClassVar[List[str]] = ["arPaymentIds", "paymentStatusTypeIds", "fromDate", "toDate", "isIncludeAllocations"]

    @field_validator('is_include_allocations')
    def is_include_allocations_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arPaymentIds": obj.get("arPaymentIds"),
            "paymentStatusTypeIds": obj.get("paymentStatusTypeIds"),
            "fromDate": obj.get("fromDate"),
            "toDate": obj.get("toDate"),
            "isIncludeAllocations": obj.get("isIncludeAllocations")
        })
        return _obj
