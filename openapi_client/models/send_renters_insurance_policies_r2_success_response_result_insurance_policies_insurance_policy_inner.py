...
class SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner(BaseModel):
    """
    SendRentersInsurancePoliciesR2SuccessResponseResultInsurancePoliciesInsurancePolicyInner
    """ # noqa: E501
    node: StrictStr = Field(description="Node identifier for the insurance policy", alias="Node")
    reference_id: StrictStr = Field(description="Unique reference ID for the insurance policy", alias="ReferenceId")
    lease_id: StrictStr = Field(description="Unique identifier for the lease associated with the policy", alias="LeaseId")
    customer_id: StrictStr = Field(description="Comma-separated list of customer IDs associated with the insurance policy", alias="CustomerId")
    status: StrictStr = Field(description="Status of the insurance policy update or insertion", alias="Status")
    message: StrictStr = Field(description="Message detailing the result of the policy update or insertion", alias="Message")
    __properties: ClassVar[List[str]] = ["Node", "ReferenceId", "LeaseId", "CustomerId", "Status", "Message"]
