...
class GetLeadsSuccessResponseResult(BaseModel):
    """
    GetLeadsSuccessResponseResult
    """ # noqa: E501
    property_id: StrictStr = Field(description="The property identifier.", alias="propertyId")
    currency_code: StrictStr = Field(description="The currency code used.", alias="currencyCode")
    prospects: GetLeadsSuccessResponseResultProspects
    __properties: ClassVar[List[str]] = ["propertyId", "currencyCode", "prospects"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of prospects
        if self.prospects:
            _dict['prospects'] = self.prospects.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prospects": GetLeadsSuccessResponseResultProspects.from_dict(obj["prospects"]) if obj.get("prospects") is not None else None
        })
        return _obj
