...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnitIdentification(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnitIdentification
    """ # noqa: E501
    attributes: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnitIdentificationAttributes = Field(alias="@attributes")
    id_value: StrictInt = Field(description="Unit ID value", alias="IDValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnitIdentificationAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
