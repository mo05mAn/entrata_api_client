...
class GetPricingPicklistsSuccessResponseResponseResultChargeUsages(BaseModel):
    """
    Charge usages details
    """ # noqa: E501
    charge_usage: Optional[List[GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInner]] = Field(default=None, description="List of charge usages", alias="chargeUsage")
    __properties: ClassVar[List[str]] = ["chargeUsage"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in charge_usage (list)
        _items = []
        if self.charge_usage:
            for _item in self.charge_usage:
                if _item:
                    _items.append(_item.to_dict())
            _dict['chargeUsage'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeUsage": [GetPricingPicklistsSuccessResponseResponseResultChargeUsagesChargeUsageInner.from_dict(_item) for _item in obj["chargeUsage"]] if obj.get("chargeUsage") is not None else None
        })
        return _obj
