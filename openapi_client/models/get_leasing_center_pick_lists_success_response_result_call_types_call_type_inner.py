...
class GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner(BaseModel):
    """
    GetLeasingCenterPickListsSuccessResponseResultCallTypesCallTypeInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the call type")
    name: StrictStr = Field(description="Name of the call type")
