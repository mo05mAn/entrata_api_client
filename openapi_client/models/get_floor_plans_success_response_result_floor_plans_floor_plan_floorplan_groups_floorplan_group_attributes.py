...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFloorplanGroupsFloorplanGroupAttributes(BaseModel):
    """
    Attributes of the floor plan group
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the floor plan group")
    name: Optional[StrictStr] = Field(default=None, description="Name of the floor plan group")
