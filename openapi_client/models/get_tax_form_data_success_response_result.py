...
class GetTaxFormDataSuccessResponseResult(BaseModel):
    """
    GetTaxFormDataSuccessResponseResult
    """ # noqa: E501
    properties: Optional[GetTaxFormDataSuccessResponseResultProperties] = Field(default=None, alias="Properties")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Properties": GetTaxFormDataSuccessResponseResultProperties.from_dict(obj["Properties"]) if obj.get("Properties") is not None else None
        })
        return _obj
