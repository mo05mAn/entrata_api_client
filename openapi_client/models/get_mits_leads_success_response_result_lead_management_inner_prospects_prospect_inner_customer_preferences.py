...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomerPreferences(BaseModel):
    """
    Customer preferences related to the lead.
    """ # noqa: E501
    target_move_in_date: Optional[StrictStr] = Field(default=None, description="The target move-in date for the customer.", alias="TargetMoveInDate")
    desired_lease_terms: Optional[StrictStr] = Field(default=None, description="The desired lease terms.", alias="DesiredLeaseTerms")
    desired_lease_term_name: Optional[StrictStr] = Field(default=None, description="The name of the desired lease term.", alias="DesiredLeaseTermName")
    amenities: Optional[List[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomerPreferencesAmenitiesInner]] = Field(default=None, description="A list of customer amenities.", alias="Amenities")
    __properties: ClassVar[List[str]] = ["TargetMoveInDate", "DesiredLeaseTerms", "DesiredLeaseTermName", "Amenities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Amenities": [GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerCustomerPreferencesAmenitiesInner.from_dict(_item) for _item in obj["Amenities"]] if obj.get("Amenities") is not None else None
        })
        return _obj
