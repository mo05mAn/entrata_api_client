...
class GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitAddress(BaseModel):
    """
    GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitAddress
    """ # noqa: E501
    address: StrictStr = Field(description="Unit address")
    city: StrictStr = Field(description="City where the unit is located")
    state: StrictStr = Field(description="State where the unit is located")
    postal_code: StrictInt = Field(description="Postal code of the unit", alias="postalCode")
    country: StrictStr = Field(description="Country of the unit")
