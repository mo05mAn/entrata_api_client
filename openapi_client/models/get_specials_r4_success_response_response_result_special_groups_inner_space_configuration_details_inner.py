...
class GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner(BaseModel):
    """
    GetSpecialsR4SuccessResponseResponseResultSpecialGroupsInnerSpaceConfigurationDetailsInner
    """ # noqa: E501
    space_configuration_id: Optional[StrictInt] = Field(default=None, alias="spaceConfigurationId")
    space_configuration_name: Optional[StrictStr] = Field(default=None, alias="spaceConfigurationName")
    __properties: ClassVar[List[str]] = ["spaceConfigurationId", "spaceConfigurationName"]
