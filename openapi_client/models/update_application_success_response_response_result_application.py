...
class UpdateApplicationSuccessResponseResponseResultApplication(BaseModel):
    """
    UpdateApplicationSuccessResponseResponseResultApplication
    """ # noqa: E501
    status: StrictStr = Field(description="Status of the application.")
    message: StrictStr = Field(description="Message indicating the application update result.")
    application_id: StrictInt = Field(description="Unique ID of the application.", alias="applicationId")
    applicant_ids: StrictStr = Field(description="Comma-separated list of applicant IDs.", alias="applicantIds")
    __properties: ClassVar[List[str]] = ["status", "message", "applicationId", "applicantIds"]
