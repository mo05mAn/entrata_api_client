...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAmountValueRangeAttributes(BaseModel):
    """
    Attributes related to the deposit range
    """ # noqa: E501
    min: Optional[StrictStr] = Field(default=None, description="Minimum deposit", alias="Min")
    max: Optional[StrictStr] = Field(default=None, description="Maximum deposit", alias="Max")
