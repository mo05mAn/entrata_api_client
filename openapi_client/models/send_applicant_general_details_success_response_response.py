...
class SendApplicantGeneralDetailsSuccessResponseResponse(BaseModel):
    """
    ...
    result: List[SendApplicantGeneralDetailsSuccessResponseResponseResultInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": [SendApplicantGeneralDetailsSuccessResponseResponseResultInner.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
