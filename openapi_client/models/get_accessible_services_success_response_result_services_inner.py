...
class GetAccessibleServicesSuccessResponseResultServicesInner(BaseModel):
    """
    GetAccessibleServicesSuccessResponseResultServicesInner
    """ # noqa: E501
    uri: StrictStr = Field(description="The URI endpoint for the service")
    service: StrictStr = Field(description="The name of the service")
    __properties: ClassVar[List[str]] = ["uri", "service"]
