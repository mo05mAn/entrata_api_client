...
class SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner(BaseModel):
    """
    SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner
    """ # noqa: E501
    node: StrictInt = Field(description="Node identifier for the rentable item type")
    rentable_item_type_id: StrictInt = Field(description="Unique identifier for the rentable item type", alias="rentableItemTypeId")
    rentable_item_ids: StrictStr = Field(description="Comma-separated list of rentable item IDs associated with this type", alias="rentableItemIds")
    status: StrictStr = Field(description="Status of the rentable item type insertion")
    message: StrictStr = Field(description="Message related to the rentable item type insertion")
    __properties: ClassVar[List[str]] = ["node", "rentableItemTypeId", "rentableItemIds", "status", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "node": obj.get("node"),
            "rentableItemTypeId": obj.get("rentableItemTypeId"),
            "rentableItemIds": obj.get("rentableItemIds"),
