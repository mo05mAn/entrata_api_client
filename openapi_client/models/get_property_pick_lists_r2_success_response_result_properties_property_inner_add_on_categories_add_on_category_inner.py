...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAddOnCategoriesAddOnCategoryInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerAddOnCategoriesAddOnCategoryInner
    """ # noqa: E501
    id: StrictInt = Field(description="Add-on category ID")
    name: StrictStr = Field(description="Add-on category name")
