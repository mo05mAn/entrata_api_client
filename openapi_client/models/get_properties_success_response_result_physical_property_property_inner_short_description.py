...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerShortDescription(BaseModel):
    """
    Short description of the property
    """ # noqa: E501
    b: Optional[StrictStr] = Field(default=None, description="Text in bold")
