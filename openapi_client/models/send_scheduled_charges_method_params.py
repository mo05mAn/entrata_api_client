...
class SendScheduledChargesMethodParams(BaseModel):
    """
    ...
    charge_timing_id: StrictInt = Field(description="This is a required field. This field accepts single value. chargeTimingId", alias="chargeTimingId")
    charge_code_type_id: StrictInt = Field(description="This is a required field. This field accepts single value. chargeCodeTypeId", alias="chargeCodeTypeId")
    charge_code_id: StrictInt = Field(description="This is a required field. This field accepts single value. chargeCodeId", alias="chargeCodeId")
    ...
    lease_interval_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. leaseIntervalId", alias="leaseIntervalId")
    __properties: ClassVar[List[str]] = ["propertyId", "leaseId", "chargeTimingId", "chargeCodeTypeId", "chargeCodeId", "amount", "startDate", "leaseIntervalId"]
