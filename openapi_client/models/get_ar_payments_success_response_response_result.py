...
class GetArPaymentsSuccessResponseResponseResult(BaseModel):
    """
    GetArPaymentsSuccessResponseResponseResult
    """ # noqa: E501
    ar_payments: GetArPaymentsSuccessResponseResponseResultArPayments = Field(alias="ArPayments")
    __properties: ClassVar[List[str]] = ["ArPayments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ArPayments": GetArPaymentsSuccessResponseResponseResultArPayments.from_dict(obj["ArPayments"]) if obj.get("ArPayments") is not None else None
        })
        return _obj
