...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysDataCustomKeyDataInner(BaseModel):
    """
    GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerCustomKeysDataCustomKeyDataInner
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Custom key", alias="Key")
    value: Optional[StrictStr] = Field(default=None, description="Custom value", alias="Value")
