...
class GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerContactsContactInner
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the contact.")
    name_first: StrictStr = Field(description="First name of the contact.", alias="nameFirst")
    name_last: StrictStr = Field(description="Last name of the contact.", alias="nameLast")
    email: StrictStr = Field(description="Email address of the contact.")
    phone: StrictStr = Field(description="Phone number of the contact.")
    position: StrictStr = Field(description="Position of the contact within the company.")
    __properties: ClassVar[List[str]] = ["id", "nameFirst", "nameLast", "email", "phone", "position"]
