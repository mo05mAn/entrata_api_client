...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerConcessionInner(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerConcessionInner
    """ # noqa: E501
    attributes: GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes = Field(alias="@attributes")
    value: StrictStr = Field(description="The value of the concession.", alias="Value")
    description_header: StrictStr = Field(description="The header for the concession description.", alias="DescriptionHeader")
    description_body: StrictStr = Field(description="The body of the concession description.", alias="DescriptionBody")
    description_footer: StrictStr = Field(description="The footer for the concession description.", alias="DescriptionFooter")
    __properties: ClassVar[List[str]] = ["@attributes", "Value", "DescriptionHeader", "DescriptionBody", "DescriptionFooter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "Value": obj.get("Value"),
            "DescriptionHeader": obj.get("DescriptionHeader"),
            "DescriptionBody": obj.get("DescriptionBody"),
            "DescriptionFooter": obj.get("DescriptionFooter")
        })
        return _obj
