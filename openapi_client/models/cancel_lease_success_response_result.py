...
class CancelLeaseSuccessResponseResult(BaseModel):
    """
    The result data of the request.
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="The status of the operation.")
    message: Optional[StrictStr] = Field(default=None, description="A message describing the result of the operation.")
