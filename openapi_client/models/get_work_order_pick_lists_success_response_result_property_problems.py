...
class GetWorkOrderPickListsSuccessResponseResultPropertyProblems(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyProblems
    """ # noqa: E501
    problem: List[GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner] = Field(alias="Problem")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Problem": [GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner.from_dict(_item) for _item in obj["Problem"]] if obj.get("Problem") is not None else None
        })
        return _obj
