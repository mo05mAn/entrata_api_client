...
class GetCustomerTestimonialsSuccessResponse(BaseModel):
    """
    GetCustomerTestimonialsSuccessResponse
    """ # noqa: E501
    request_id: StrictInt = Field(description="The unique identifier for the request", alias="requestId")
    result: GetCustomerTestimonialsSuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": GetCustomerTestimonialsSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
