...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsSummary(BaseModel):
    """
    GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsSummary
    """ # noqa: E501
    mits_doc_version: StrictStr = Field(description="Version of the MIT document", alias="MITSDocVersion")
    generation_time_stamp: StrictStr = Field(description="Timestamp when the document was generated", alias="GenerationTimeStamp")
    source_organization: StrictStr = Field(description="Name of the source organization", alias="SourceOrganization")
    total_properties: StrictStr = Field(description="Total number of properties", alias="TotalProperties")
    total_lease_files: StrictInt = Field(description="Total number of lease files", alias="TotalLeaseFiles")
    total_tenants: StrictInt = Field(description="Total number of tenants", alias="TotalTenants")
    total_open_amount: StrictStr = Field(description="Total open amount", alias="TotalOpenAmount")
    __properties: ClassVar[List[str]] = ["MITSDocVersion", "GenerationTimeStamp", "SourceOrganization", "TotalProperties", "TotalLeaseFiles", "TotalTenants", "TotalOpenAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "MITSDocVersion": obj.get("MITSDocVersion"),
            "GenerationTimeStamp": obj.get("GenerationTimeStamp"),
            "SourceOrganization": obj.get("SourceOrganization"),
            "TotalProperties": obj.get("TotalProperties"),
            "TotalLeaseFiles": obj.get("TotalLeaseFiles"),
            "TotalTenants": obj.get("TotalTenants"),
            "TotalOpenAmount": obj.get("TotalOpenAmount")
        })
        return _obj
