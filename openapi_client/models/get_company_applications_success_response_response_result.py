...
class GetCompanyApplicationsSuccessResponseResponseResult(BaseModel):
    """
    GetCompanyApplicationsSuccessResponseResponseResult
    """ # noqa: E501
    company_applications: GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications = Field(alias="companyApplications")
    __properties: ClassVar[List[str]] = ["companyApplications"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of company_applications
        if self.company_applications:
            _dict['companyApplications'] = self.company_applications.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "companyApplications": GetCompanyApplicationsSuccessResponseResponseResultCompanyApplications.from_dict(obj["companyApplications"]) if obj.get("companyApplications") is not None else None
        })
        return _obj
