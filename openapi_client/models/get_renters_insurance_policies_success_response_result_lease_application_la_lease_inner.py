...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInner(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInner
    """ # noqa: E501
    identification: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentification = Field(alias="Identification")
    status: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerStatus = Field(alias="Status")
    unit: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnit = Field(alias="Unit")
    insurance_policies: GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerInsurancePolicies = Field(alias="InsurancePolicies")
    __properties: ClassVar[List[str]] = ["Identification", "Status", "Unit", "InsurancePolicies"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of insurance_policies
        if self.insurance_policies:
            _dict['InsurancePolicies'] = self.insurance_policies.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            ...
            "Unit": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerUnit.from_dict(obj["Unit"]) if obj.get("Unit") is not None else None,
            "InsurancePolicies": GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerInsurancePolicies.from_dict(obj["InsurancePolicies"]) if obj.get("InsurancePolicies") is not None else None
        })
        return _obj
