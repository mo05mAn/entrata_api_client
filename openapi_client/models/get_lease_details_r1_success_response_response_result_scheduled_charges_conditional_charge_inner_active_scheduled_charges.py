...
class GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledCharges
    """ # noqa: E501
    active_scheduled_charge: List[GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner] = Field(alias="activeScheduledCharge")
    __properties: ClassVar[List[str]] = ["activeScheduledCharge"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in active_scheduled_charge (list)
        _items = []
        if self.active_scheduled_charge:
            for _item in self.active_scheduled_charge:
                if _item:
                    _items.append(_item.to_dict())
            _dict['activeScheduledCharge'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activeScheduledCharge": [GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesConditionalChargeInnerActiveScheduledChargesActiveScheduledChargeInner.from_dict(_item) for _item in obj["activeScheduledCharge"]] if obj.get("activeScheduledCharge") is not None else None
        })
        return _obj
