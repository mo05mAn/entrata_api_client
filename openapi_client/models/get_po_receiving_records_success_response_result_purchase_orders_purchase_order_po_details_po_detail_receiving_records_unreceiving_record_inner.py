...
class GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetailsPoDetailReceivingRecordsUnreceivingRecordInner(BaseModel):
    """
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the unreceived record.")
    property_id: Optional[StrictInt] = Field(default=None, description="Property ID where the item was unreceived.", alias="propertyId")
    post_month_unreceived: Optional[StrictStr] = Field(default=None, description="Month when the item was unreceived.", alias="postMonthUnreceived")
    unreceiver_name: Optional[StrictStr] = Field(default=None, description="Name of the unreceiver.", alias="unreceiverName")
    qty_unreceived: Optional[StrictStr] = Field(default=None, description="Quantity of items unreceived.", alias="qtyUnreceived")
    unit_cost: Optional[StrictStr] = Field(default=None, description="Cost per unit of the unreceived item.", alias="unitCost")
    date_unreceived: Optional[StrictStr] = Field(default=None, description="Date when the item was unreceived.", alias="dateUnreceived")
    qty_invoiced: Optional[StrictInt] = Field(default=None, description="Quantity of items invoiced.", alias="qtyInvoiced")
    __properties: ClassVar[List[str]] = ["id", "propertyId", "postMonthUnreceived", "unreceiverName", "qtyUnreceived", "unitCost", "dateUnreceived", "qtyInvoiced"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "postMonthUnreceived": obj.get("postMonthUnreceived"),
            "unreceiverName": obj.get("unreceiverName"),
            "qtyUnreceived": obj.get("qtyUnreceived"),
            "unitCost": obj.get("unitCost"),
            "dateUnreceived": obj.get("dateUnreceived"),
            "qtyInvoiced": obj.get("qtyInvoiced")
        })
        return _obj
