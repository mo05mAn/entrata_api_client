...
class GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSourcesLeadSourceInnerAttributes(BaseModel):
    """
    Attributes related to the lead source.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the lead source.")
    id: Optional[StrictInt] = Field(default=None, description="The unique ID for the lead source.", alias="Id")
    web_visible: Optional[StrictStr] = Field(default=None, description="Indicates if the lead source is visible on the web.", alias="WebVisible")
    __properties: ClassVar[List[str]] = ["name", "Id", "WebVisible"]
