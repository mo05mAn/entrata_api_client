...
class SendMitsLeadsMethodParams(BaseModel):
    """
    ...
    do_not_send_confirmation_email: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Allows restricting the guest card confirmation emails to prospect/prop erty if set to 1.", alias="doNotSendConfirmationEmail")
    is_wait_list: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. When sent as 1, Units will be listed in waitlist.", alias="isWaitList")
    last_update_date: Optional[date] = Field(default=None, description="This is a required field. This field accepts single value. LastUpdateDate", alias="LastUpdateDate")
    __properties: ClassVar[List[str]] = ["propertyId", "doNotSendConfirmationEmail", "isWaitList", "LastUpdateDate"]

    @field_validator('do_not_send_confirmation_email')
    def do_not_send_confirmation_email_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "doNotSendConfirmationEmail": obj.get("doNotSendConfirmationEmail"),
