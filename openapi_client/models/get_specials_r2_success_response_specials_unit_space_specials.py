...
class GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecials(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecials
    """ # noqa: E501
    special: GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "special": GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecial.from_dict(obj["special"]) if obj.get("special") is not None else None
        })
        return _obj
