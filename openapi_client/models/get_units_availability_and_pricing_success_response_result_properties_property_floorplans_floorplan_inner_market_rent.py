...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInnerMarketRent(BaseModel):
    """
    Market rent details for the floor plan
    """ # noqa: E501
    avg: Optional[StrictInt] = Field(default=None, description="Average market rent", alias="Avg")
    max: Optional[StrictInt] = Field(default=None, description="Maximum rent", alias="Max")
    min: Optional[StrictInt] = Field(default=None, description="Minimum rent", alias="Min")
