...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerIdentification
    """ # noqa: E501
    id_type: StrictStr = Field(description="Type of the identification", alias="IDType")
    id_rank: StrictStr = Field(description="Rank of the identification", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Scope type of the identification", alias="IDScopeType")
    id_value: StrictStr = Field(description="Value of the identification", alias="IDValue")
    organization_name: StrictStr = Field(description="Name of the organization", alias="OrganizationName")
    __properties: ClassVar[List[str]] = ["IDType", "IDRank", "IDScopeType", "IDValue", "OrganizationName"]
