...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerILSIdentification(BaseModel):
    """
    ILS identification details
    """ # noqa: E501
    daylight_saving: Optional[StrictStr] = Field(default=None, description="Daylight saving time status", alias="DaylightSaving")
    time_zone: Optional[StrictStr] = Field(default=None, description="Time zone of the property", alias="TimeZone")
    attributes: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerILSIdentificationAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["DaylightSaving", "TimeZone", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DaylightSaving": obj.get("DaylightSaving"),
            "TimeZone": obj.get("TimeZone"),
            "@attributes": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerILSIdentificationAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
