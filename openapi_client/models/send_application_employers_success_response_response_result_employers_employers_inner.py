...
class SendApplicationEmployersSuccessResponseResponseResultEmployersEmployersInner(BaseModel):
    """
    SendApplicationEmployersSuccessResponseResponseResultEmployersEmployersInner
    """ # noqa: E501
    status: StrictStr = Field(description="Success")
    message: StrictStr = Field(description="Customer employers saved successfully.")
    id: StrictInt = Field(description="Employer ID.")
    customer_id: StrictInt = Field(description="Customer ID.", alias="customerId")
    income_type_id: StrictInt = Field(description="Income type ID.", alias="incomeTypeId")
    node: StrictInt = Field(description="Node number.")
    __properties: ClassVar[List[str]] = ["status", "message", "id", "customerId", "incomeTypeId", "node"]
