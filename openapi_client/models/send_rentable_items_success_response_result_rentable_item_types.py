...
class SendRentableItemsSuccessResponseResultRentableItemTypes(BaseModel):
    """
    SendRentableItemsSuccessResponseResultRentableItemTypes
    """ # noqa: E501
    rentable_item_type: List[SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner] = Field(alias="rentableItemType")
    __properties: ClassVar[List[str]] = ["rentableItemType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in rentable_item_type (list)
        _items = []
        if self.rentable_item_type:
            for _item in self.rentable_item_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['rentableItemType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rentableItemType": [SendRentableItemsSuccessResponseResultRentableItemTypesRentableItemTypeInner.from_dict(_item) for _item in obj["rentableItemType"]] if obj.get("rentableItemType") is not None else None
        })
        return _obj
