...
class SendLeaseDocumentsSuccessResponseResultFilesFileInner(BaseModel):
    """
    SendLeaseDocumentsSuccessResponseResultFilesFileInner
    """ # noqa: E501
    node: StrictStr = Field(description="Node identifier for the file")
    file_id: StrictStr = Field(description="Unique identifier for the file", alias="fileId")
    file_name: StrictStr = Field(description="Name of the uploaded file", alias="fileName")
    status: StrictStr = Field(description="Status of the file upload")
    message: StrictStr = Field(description="Message detailing the result of the upload")
    __properties: ClassVar[List[str]] = ["node", "fileId", "fileName", "status", "message"]
