...
class GetVendorPickListsSuccessResponseResultForm1099BoxTypes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultForm1099BoxTypes
    """ # noqa: E501
    form1099_box_type: Optional[List[GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInner]] = Field(default=None, alias="form1099BoxType")
    __properties: ClassVar[List[str]] = ["form1099BoxType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in form1099_box_type (list)
        _items = []
        if self.form1099_box_type:
            for _item in self.form1099_box_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['form1099BoxType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "form1099BoxType": [GetVendorPickListsSuccessResponseResultForm1099BoxTypesForm1099BoxTypeInner.from_dict(_item) for _item in obj["form1099BoxType"]] if obj.get("form1099BoxType") is not None else None
        })
        return _obj
