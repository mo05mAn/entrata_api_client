...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsInnerPersonDetailsPhoneInnerAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    phone_type: StrictStr = Field(description="Phone type", alias="PhoneType")
