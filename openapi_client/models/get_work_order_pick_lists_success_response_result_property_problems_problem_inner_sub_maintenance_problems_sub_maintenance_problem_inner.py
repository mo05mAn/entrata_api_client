...
class GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInnerSubMaintenanceProblemsSubMaintenanceProblemInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInnerSubMaintenanceProblemsSubMaintenanceProblemInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the sub-maintenance problem", alias="Id")
