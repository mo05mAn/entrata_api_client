...
class GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnit(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnit
    """ # noqa: E501
    rates: GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates = Field(alias="Rates")
    attributes: GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Rates": GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitRates.from_dict(obj["Rates"]) if obj.get("Rates") is not None else None,
            "@attributes": GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityUnitsUnitAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
