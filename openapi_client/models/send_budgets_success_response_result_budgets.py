...
class SendBudgetsSuccessResponseResultBudgets(BaseModel):
    """
    SendBudgetsSuccessResponseResultBudgets
    """ # noqa: E501
    budget: List[SendBudgetsSuccessResponseResultBudgetsBudgetInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budget": [SendBudgetsSuccessResponseResultBudgetsBudgetInner.from_dict(_item) for _item in obj["budget"]] if obj.get("budget") is not None else None
        })
        return _obj
