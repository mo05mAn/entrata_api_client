...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitAttributes(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyILSUnitInnerUnitsUnitAttributes
    """ # noqa: E501
    building_id: StrictInt = Field(description="The building ID for the unit.", alias="BuildingId")
    floor_plan_id: StrictInt = Field(description="The floorplan ID associated with the unit.", alias="FloorPlanId")
    __properties: ClassVar[List[str]] = ["BuildingId", "FloorPlanId"]
