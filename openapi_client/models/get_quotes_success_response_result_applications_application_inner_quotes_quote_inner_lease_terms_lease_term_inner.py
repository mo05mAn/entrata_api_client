...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerLeaseTermsLeaseTermInner(BaseModel):
    """
    GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerLeaseTermsLeaseTermInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the lease term.")
    term_month: Optional[StrictStr] = Field(default=None, description="The duration of the lease in months.", alias="termMonth")
    quote_amount: Optional[StrictStr] = Field(default=None, description="The quote amount for the lease.", alias="quoteAmount")
    __properties: ClassVar[List[str]] = ["id", "termMonth", "quoteAmount"]
