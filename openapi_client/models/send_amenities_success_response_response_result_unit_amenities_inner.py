...
class SendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner(BaseModel):
    """
    SendAmenitiesSuccessResponseResponseResultUnitAmenitiesInner
    """ # noqa: E501
    node: StrictInt = Field(description="Unique identifier for the unit amenity node")
    status: StrictStr = Field(description="Status of the unit amenity operation")
    amenity_id: StrictInt = Field(description="Unique identifier for the unit amenity", alias="amenityId")
    rate_association_id: StrictInt = Field(description="Unique identifier for the rate association", alias="rateAssociationId")
    name: StrictStr = Field(description="Name of the unit amenity")
    message: StrictStr = Field(description="Message about the unit amenity operation")
    __properties: ClassVar[List[str]] = ["node", "status", "amenityId", "rateAssociationId", "name", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rateAssociationId": obj.get("rateAssociationId"),
            "name": obj.get("name"),
