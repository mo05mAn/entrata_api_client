...
class SendApplicationVehiclesSuccessResponse(BaseModel):
    """
    SendApplicationVehiclesSuccessResponse
    """ # noqa: E501
    response: SendApplicationVehiclesSuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": SendApplicationVehiclesSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
