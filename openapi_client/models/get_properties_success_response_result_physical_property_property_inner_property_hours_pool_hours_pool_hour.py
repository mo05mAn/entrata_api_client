...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursPoolHoursPoolHour(BaseModel):
    """
    Specific pool hour
    """ # noqa: E501
    day: Optional[StrictStr] = Field(default=None, description="Day of the week", alias="Day")
    open_time: Optional[StrictStr] = Field(default=None, description="Pool open time", alias="OpenTime")
    close_time: Optional[StrictStr] = Field(default=None, description="Pool close time", alias="CloseTime")
    __properties: ClassVar[List[str]] = ["Day", "OpenTime", "CloseTime"]
