...
class GetLeadPickListsR1SuccessResponseResponseResultProperty18462(BaseModel):
    """
    Property with ID 18462.
    """ # noqa: E501
    attributes: Optional[GetLeadPickListsR1SuccessResponseResponseResultProperty18462Attributes] = Field(default=None, alias="@attributes")
    leasing_agents: Optional[GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents] = Field(default=None, alias="LeasingAgents")
    lead_sources: Optional[GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSources] = Field(default=None, alias="LeadSources")
    __properties: ClassVar[List[str]] = ["@attributes", "LeasingAgents", "LeadSources"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of leasing_agents
        if self.leasing_agents:
            _dict['LeasingAgents'] = self.leasing_agents.to_dict()
        # override the default output from pydantic by calling `to_dict()` of lead_sources
        if self.lead_sources:
            _dict['LeadSources'] = self.lead_sources.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": GetLeadPickListsR1SuccessResponseResponseResultProperty18462Attributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None,
            "LeasingAgents": GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgents.from_dict(obj["LeasingAgents"]) if obj.get("LeasingAgents") is not None else None,
            "LeadSources": GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeadSources.from_dict(obj["LeadSources"]) if obj.get("LeadSources") is not None else None
        })
        return _obj
