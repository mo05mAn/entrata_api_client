...
class GetLeadPickListsR2SuccessResponseResultEventResultsEventResultInnerAttributes(BaseModel):
    """
    Attributes related to the event result.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the event result.")
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the event result.")
    event_type_id: Optional[StrictStr] = Field(default=None, description="The ID of the related event type.", alias="eventTypeId")
    default_event_result_id: Optional[StrictStr] = Field(default=None, description="The ID of the default event result.", alias="defaultEventResultId")
    default_event_result: Optional[StrictStr] = Field(default=None, description="The name of the default event result.", alias="defaultEventResult")
    __properties: ClassVar[List[str]] = ["name", "id", "eventTypeId", "defaultEventResultId", "defaultEventResult"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "defaultEventResultId": obj.get("defaultEventResultId"),
            "defaultEventResult": obj.get("defaultEventResult")
        })
        return _obj
