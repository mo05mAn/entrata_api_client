...
class GetBudgetsSuccessResponseResult(BaseModel):
    """
    GetBudgetsSuccessResponseResult
    """ # noqa: E501
    properties: GetBudgetsSuccessResponseResultProperties
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": GetBudgetsSuccessResponseResultProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
