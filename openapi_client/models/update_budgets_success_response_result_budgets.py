...
class UpdateBudgetsSuccessResponseResultBudgets(BaseModel):
    """
    UpdateBudgetsSuccessResponseResultBudgets
    """ # noqa: E501
    budget: List[UpdateBudgetsSuccessResponseResultBudgetsBudgetInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budget": [UpdateBudgetsSuccessResponseResultBudgetsBudgetInner.from_dict(_item) for _item in obj["budget"]] if obj.get("budget") is not None else None
        })
        return _obj
