...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInner(BaseModel):
    """
    GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInner
    """ # noqa: E501
    event_id: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID] = Field(default=None, alias="EventID")
    agent: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgent] = Field(default=None, alias="Agent")
    comments: Optional[StrictStr] = Field(default=None, description="Comments related to the event.", alias="Comments")
    event_reasons: Optional[StrictStr] = Field(default=None, description="The reasons for the event.", alias="EventReasons")
    attributes: Optional[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAttributes] = Field(default=None, alias="@attributes")
    __properties: ClassVar[List[str]] = ["EventID", "Agent", "Comments", "EventReasons", "@attributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.event_id:
            _dict['EventID'] = self.event_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "EventID": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerEventID.from_dict(obj["EventID"]) if obj.get("EventID") is not None else None,
            "Agent": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAgent.from_dict(obj["Agent"]) if obj.get("Agent") is not None else None,
            "Comments": obj.get("Comments"),
            "EventReasons": obj.get("EventReasons"),
            "@attributes": GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerEventsEventInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
