...
class GenerateQuotesMethodParams(BaseModel):
    """
    ...
    adjustments_and_provision_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. adjustmentsAndProvisionIds", alias="adjustmentsAndProvisionIds")
    __properties: ClassVar[List[str]] = ["propertyId", "applicationId", "adjustmentsAndProvisionIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "adjustmentsAndProvisionIds": obj.get("adjustmentsAndProvisionIds")
        })
        return _obj
