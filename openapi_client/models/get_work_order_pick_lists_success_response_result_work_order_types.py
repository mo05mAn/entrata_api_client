...
class GetWorkOrderPickListsSuccessResponseResultWorkOrderTypes(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultWorkOrderTypes
    """ # noqa: E501
    work_order_type: List[GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner] = Field(alias="WorkOrderType")
    __properties: ClassVar[List[str]] = ["WorkOrderType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in work_order_type (list)
        _items = []
        if self.work_order_type:
            for _item in self.work_order_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['WorkOrderType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "WorkOrderType": [GetWorkOrderPickListsSuccessResponseResultWorkOrderTypesWorkOrderTypeInner.from_dict(_item) for _item in obj["WorkOrderType"]] if obj.get("WorkOrderType") is not None else None
        })
        return _obj
