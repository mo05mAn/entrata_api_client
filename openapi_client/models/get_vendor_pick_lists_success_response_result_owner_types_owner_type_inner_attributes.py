...
class GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultOwnerTypesOwnerTypeInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the owner type.")
    name: StrictStr = Field(description="Name of the owner type.")
