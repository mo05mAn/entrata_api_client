...
class GetLeaseDetailsR2SuccessResponseResult(BaseModel):
    """
    GetLeaseDetailsR2SuccessResponseResult
    """ # noqa: E501
    leases: GetLeaseDetailsR2SuccessResponseResultLeases
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leases": GetLeaseDetailsR2SuccessResponseResultLeases.from_dict(obj["leases"]) if obj.get("leases") is not None else None
        })
        return _obj
