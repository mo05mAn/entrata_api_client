...
class UpdatePropertyResponseSuccessResponseResultTestimonialsTestimonial(BaseModel):
    """
    UpdatePropertyResponseSuccessResponseResultTestimonialsTestimonial
    """ # noqa: E501
    testimonial_id: StrictStr = Field(description="The unique identifier for the testimonial.", alias="testimonialId")
    status: StrictStr = Field(description="The status of the testimonial update.")
    message: StrictStr = Field(description="The message indicating the result of the testimonial update.")
    __properties: ClassVar[List[str]] = ["testimonialId", "status", "message"]
