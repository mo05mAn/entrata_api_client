...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnit
    """ # noqa: E501
    identification: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitIdentification = Field(alias="Identification")
    marketing_name: StrictStr = Field(description="Marketing name of the unit", alias="MarketingName")
    ...
    address: GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress = Field(alias="Address")
    __properties: ClassVar[List[str]] = ["Identification", "MarketingName", "UnitType", "UnitLeasedStatus", "Address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "MarketingName": obj.get("MarketingName"),
            "UnitType": obj.get("UnitType"),
            "UnitLeasedStatus": obj.get("UnitLeasedStatus"),
            "Address": GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerUnitAddress.from_dict(obj["Address"]) if obj.get("Address") is not None else None
        })
        return _obj
