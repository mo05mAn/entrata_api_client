...
class GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServices
    """ # noqa: E501
    service: List[GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "service": [GetLeaseDetailsR1SuccessResponseResponseResultAddOnsServicesServiceInner.from_dict(_item) for _item in obj["service"]] if obj.get("service") is not None else None
        })
        return _obj
