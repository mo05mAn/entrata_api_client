...
class InsertPricingR2SuccessResponseResultPricingInner(BaseModel):
    """
    InsertPricingR2SuccessResponseResultPricingInner
    """ # noqa: E501
    node: StrictStr = Field(description="Unique identifier for the pricing node")
    reference_id: StrictStr = Field(description="Reference ID associated with the pricing operation", alias="referenceId")
    status: StrictStr = Field(description="Status of the pricing operation (e.g., 'Success')")
    is_valid: StrictStr = Field(description="Indicates if the pricing is valid (e.g., 'Yes')", alias="isValid")
    message: StrictStr = Field(description="Message describing the result of the pricing operation")
    __properties: ClassVar[List[str]] = ["node", "referenceId", "status", "isValid", "message"]
