...
class GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the location", alias="Id")
    name: StrictStr = Field(description="Name of the location", alias="Name")
    type: StrictStr = Field(description="Type of the location", alias="Type")
    is_resident_portal_enabled: StrictStr = Field(description="Indicates if the location is enabled on the resident portal", alias="IsResidentPortalEnabled")
    unit_types: Optional[GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypes] = Field(default=None, alias="unitTypes")
    __properties: ClassVar[List[str]] = ["Id", "Name", "Type", "IsResidentPortalEnabled", "unitTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitTypes": GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypes.from_dict(obj["unitTypes"]) if obj.get("unitTypes") is not None else None
        })
        return _obj
