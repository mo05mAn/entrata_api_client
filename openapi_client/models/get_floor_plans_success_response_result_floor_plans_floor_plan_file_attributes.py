...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanFileAttributes(BaseModel):
    """
    Attributes related to the file
    """ # noqa: E501
    file_id: Optional[StrictStr] = Field(default=None, description="ID of the file", alias="FileID")
    active: Optional[StrictStr] = Field(default=None, description="Whether the file is active", alias="Active")
    is_default: Optional[StrictBool] = Field(default=None, description="Whether the file is the default file", alias="IsDefault")
    __properties: ClassVar[List[str]] = ["FileID", "Active", "IsDefault"]
