...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerIdentificationInner(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationLALeaseInnerIdentificationInner
    """ # noqa: E501
    id_type: StrictStr = Field(description="Type of the lease ID", alias="IDType")
    id_rank: StrictStr = Field(description="Rank of the lease ID", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Scope type of the lease ID", alias="IDScopeType")
    id_value: StrictStr = Field(description="Value of the lease ID", alias="IDValue")
