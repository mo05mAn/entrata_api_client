...
class MarkGlTransactionsExportedMethodParams(BaseModel):
    """
    MarkGlTransactionsExportedMethodParams
    """ # noqa: E501
    gl_detail_id: StrictInt = Field(description="This is a required field. This field accepts comma seperated multiple values.", alias="glDetailId")
    __properties: ClassVar[List[str]] = ["glDetailId"]
