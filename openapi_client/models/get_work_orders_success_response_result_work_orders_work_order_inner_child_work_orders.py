...
class GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrders(BaseModel):
    """
    GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrders
    """ # noqa: E501
    child_work_order: Optional[List[GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrdersChildWorkOrderInner]] = Field(default=None, alias="childWorkOrder")
    __properties: ClassVar[List[str]] = ["childWorkOrder"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in child_work_order (list)
        _items = []
        if self.child_work_order:
            for _item in self.child_work_order:
                if _item:
                    _items.append(_item.to_dict())
            _dict['childWorkOrder'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "childWorkOrder": [GetWorkOrdersSuccessResponseResultWorkOrdersWorkOrderInnerChildWorkOrdersChildWorkOrderInner.from_dict(_item) for _item in obj["childWorkOrder"]] if obj.get("childWorkOrder") is not None else None
        })
        return _obj
