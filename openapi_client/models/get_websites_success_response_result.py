...
class GetWebsitesSuccessResponseResult(BaseModel):
    """
    GetWebsitesSuccessResponseResult
    """ # noqa: E501
    websites: GetWebsitesSuccessResponseResultWebsites
    __properties: ClassVar[List[str]] = ["websites"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "websites": GetWebsitesSuccessResponseResultWebsites.from_dict(obj["websites"]) if obj.get("websites") is not None else None
        })
        return _obj
