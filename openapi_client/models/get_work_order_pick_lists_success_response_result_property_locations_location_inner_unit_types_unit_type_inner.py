...
class GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the unit type", alias="Id")
    name: StrictStr = Field(description="Name of the unit type", alias="Name")
