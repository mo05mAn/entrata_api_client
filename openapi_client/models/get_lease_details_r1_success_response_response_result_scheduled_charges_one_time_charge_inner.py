...
class GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInner(BaseModel):
    """
    ...
    active_scheduled_charges: GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInnerActiveScheduledCharges = Field(alias="activeScheduledCharges")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activeScheduledCharges": GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesOneTimeChargeInnerActiveScheduledCharges.from_dict(obj["activeScheduledCharges"]) if obj.get("activeScheduledCharges") is not None else None
        })
        return _obj
