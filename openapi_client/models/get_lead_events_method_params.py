...
class GetLeadEventsMethodParams(BaseModel):
    """
    ...
    application_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Conditionally required, If eventTypeIds and eventDates are not passed then applicationId is required.", alias="applicationId")
    event_type_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="eventTypeIds")
    ...
    __properties: ClassVar[List[str]] = ["propertyId", "applicationId", "eventTypeIds", "eventDateFrom", "eventDateTo"]
