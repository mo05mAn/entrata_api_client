...
class GetTransactionTagListsSuccessResponseResultTransactionRoutingTagsTransactionRoutingTagInner(BaseModel):
    """
    GetTransactionTagListsSuccessResponseResultTransactionRoutingTagsTransactionRoutingTagInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the routing tag.")
    name: StrictStr = Field(description="The name of the routing tag.")
    description: Optional[StrictStr] = Field(default=None, description="The description of the routing tag.")
    is_published: StrictInt = Field(description="Indicates whether the routing tag is published.", alias="isPublished")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "isPublished"]
