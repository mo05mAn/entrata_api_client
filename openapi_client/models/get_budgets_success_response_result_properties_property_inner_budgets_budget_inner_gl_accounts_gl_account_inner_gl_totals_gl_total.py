...
class GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerGlTotalsGlTotal(BaseModel):
    """
    GetBudgetsSuccessResponseResultPropertiesPropertyInnerBudgetsBudgetInnerGlAccountsGlAccountInnerGlTotalsGlTotal
    """ # noqa: E501
    amount: StrictStr = Field(description="The total amount for the GL account.")
    gl_dimension_id: StrictStr = Field(description="The GL dimension ID.", alias="glDimensionId")
    __properties: ClassVar[List[str]] = ["amount", "glDimensionId"]
