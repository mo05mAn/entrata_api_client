...
class GetPropertiesSuccessResponseResultPhysicalPropertyPropertyInnerPropertyHoursOfficeHoursOfficeHour(BaseModel):
    """
    Specific office hour
    """ # noqa: E501
    day: Optional[StrictStr] = Field(default=None, description="Day of the week", alias="Day")
    availability_type: Optional[StrictStr] = Field(default=None, description="Office availability type", alias="AvailabilityType")
    open_time: Optional[StrictStr] = Field(default=None, description="Office open time", alias="OpenTime")
    close_time: Optional[StrictStr] = Field(default=None, description="Office close time", alias="CloseTime")
    lunch_start_time: Optional[StrictStr] = Field(default=None, description="Lunch start time", alias="LunchStartTime")
    lunch_end_time: Optional[StrictStr] = Field(default=None, description="Lunch end time", alias="LunchEndTime")
    __properties: ClassVar[List[str]] = ["Day", "AvailabilityType", "OpenTime", "CloseTime", "LunchStartTime", "LunchEndTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LunchStartTime": obj.get("LunchStartTime"),
            "LunchEndTime": obj.get("LunchEndTime")
        })
        return _obj
