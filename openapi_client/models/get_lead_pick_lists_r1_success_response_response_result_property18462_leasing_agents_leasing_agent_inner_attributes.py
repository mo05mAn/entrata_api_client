...
class GetLeadPickListsR1SuccessResponseResponseResultProperty18462LeasingAgentsLeasingAgentInnerAttributes(BaseModel):
    """
    Attributes related to the leasing agent.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the leasing agent.")
    id: Optional[StrictStr] = Field(default=None, description="The unique ID for the leasing agent.", alias="Id")
