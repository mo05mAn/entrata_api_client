...
class UpdateLeaseMethodParamsOccupants(BaseModel):
    """
    Optional object containing occupant details
    """ # noqa: E501
    occupant: Optional[List[UpdateLeaseMethodParamsOccupantsOccupantInner]] = Field(default=None, description="List of occupants")
    __properties: ClassVar[List[str]] = ["occupant"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in occupant (list)
        _items = []
        if self.occupant:
            for _item in self.occupant:
                if _item:
                    _items.append(_item.to_dict())
            _dict['occupant'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "occupant": [UpdateLeaseMethodParamsOccupantsOccupantInner.from_dict(_item) for _item in obj["occupant"]] if obj.get("occupant") is not None else None
        })
        return _obj
