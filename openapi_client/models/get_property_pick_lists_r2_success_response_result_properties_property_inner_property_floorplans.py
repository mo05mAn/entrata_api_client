...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloorplans(BaseModel):
    """
    Floorplans available at the property
    """ # noqa: E501
    property_floorplan: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloorplansPropertyFloorplanInner] = Field(alias="propertyFloorplan")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "propertyFloorplan": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerPropertyFloorplansPropertyFloorplanInner.from_dict(_item) for _item in obj["propertyFloorplan"]] if obj.get("propertyFloorplan") is not None else None
        })
        return _obj
