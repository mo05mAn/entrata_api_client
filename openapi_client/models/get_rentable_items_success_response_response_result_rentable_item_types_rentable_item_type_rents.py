...
class GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRents(BaseModel):
    """
    Rent charges associated with the item
    """ # noqa: E501
    rent: GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentsRent = Field(alias="Rent")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Rent": GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentsRent.from_dict(obj["Rent"]) if obj.get("Rent") is not None else None
        })
        return _obj
