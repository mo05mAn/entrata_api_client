...
class GetPropertyAnnouncementsSuccessResponseResultAnnouncements(BaseModel):
    """
    Details of the announcements
    """ # noqa: E501
    announcement: List[GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner] = Field(description="List of announcements", alias="Announcement")
    __properties: ClassVar[List[str]] = ["Announcement"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Announcement": [GetPropertyAnnouncementsSuccessResponseResultAnnouncementsAnnouncementInner.from_dict(_item) for _item in obj["Announcement"]] if obj.get("Announcement") is not None else None
        })
        return _obj
