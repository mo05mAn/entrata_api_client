...
class GetFinancialPickListR2SuccessResponseResultGlHeaderTypes(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlHeaderTypes
    """ # noqa: E501
    gl_header_type: List[GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner] = Field(description="A list of GL header types.", alias="glHeaderType")
    __properties: ClassVar[List[str]] = ["glHeaderType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_header_type (list)
        _items = []
        if self.gl_header_type:
            for _item in self.gl_header_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['glHeaderType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "glHeaderType": [GetFinancialPickListR2SuccessResponseResultGlHeaderTypesGlHeaderTypeInner.from_dict(_item) for _item in obj["glHeaderType"]] if obj.get("glHeaderType") is not None else None
        })
        return _obj
