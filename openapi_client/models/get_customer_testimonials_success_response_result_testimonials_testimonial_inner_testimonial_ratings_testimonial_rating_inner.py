...
class GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatingsTestimonialRatingInner(BaseModel):
    """
    GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatingsTestimonialRatingInner
    """ # noqa: E501
    type: StrictStr = Field(description="The type of the rating", alias="Type")
    rating: StrictStr = Field(description="The rating score", alias="Rating")
    __properties: ClassVar[List[str]] = ["Type", "Rating"]
