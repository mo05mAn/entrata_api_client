...
class GetPropertiesMethodParams(BaseModel):
    """
    GetPropertiesMethodParams
    """ # noqa: E501
    property_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. PropertyIds", alias="propertyIds")
    property_lookup_code: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="propertyLookupCode")
    show_all_status: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Show all properties with any status.", alias="showAllStatus")
    __properties: ClassVar[List[str]] = ["propertyIds", "propertyLookupCode", "showAllStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "propertyLookupCode": obj.get("propertyLookupCode"),
