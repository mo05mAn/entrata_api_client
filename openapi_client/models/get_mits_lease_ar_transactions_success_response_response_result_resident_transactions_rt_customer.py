...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomer(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomer
    """ # noqa: E501
    identification: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerIdentification = Field(alias="Identification")
    customers: GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomers = Field(alias="Customers")
    __properties: ClassVar[List[str]] = ["Identification", "Customers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerIdentification.from_dict(obj["Identification"]) if obj.get("Identification") is not None else None,
            "Customers": GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomers.from_dict(obj["Customers"]) if obj.get("Customers") is not None else None
        })
        return _obj
