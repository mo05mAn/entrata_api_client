...
class GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRatesRateInner(BaseModel):
    """
    GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRatesRateInner
    """ # noqa: E501
    charge_timing_id: StrictInt = Field(description="Unique identifier for the charge timing", alias="chargeTimingId")
    charge_code_id: StrictInt = Field(description="Unique identifier for the charge code", alias="chargeCodeId")
    amount: StrictStr = Field(description="Charge amount for the rate")
    __properties: ClassVar[List[str]] = ["chargeTimingId", "chargeCodeId", "amount"]
