...
class GetParcelAlertsSuccessResponse(BaseModel):
    """
    GetParcelAlertsSuccessResponse
    """ # noqa: E501
    response: Optional[GetParcelAlertsSuccessResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetParcelAlertsSuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
