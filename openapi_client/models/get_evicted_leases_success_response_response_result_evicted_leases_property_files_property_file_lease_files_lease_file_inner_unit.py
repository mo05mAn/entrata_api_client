...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFileLeaseFilesLeaseFileInnerUnit(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["unitNumber", "address", "city", "country", "state", "postalCode"]
