...
class GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilities(BaseModel):
    """
    Availability schedule for self-guided tours
    """ # noqa: E501
    availability: Optional[List[GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilitiesAvailabilityInner]] = Field(default=None, description="List of self-guided tour availability slots")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.availability:
            for _item in self.availability:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availability": [GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsSelfGuidedTourAvailabilitiesAvailabilityInner.from_dict(_item) for _item in obj["availability"]] if obj.get("availability") is not None else None
        })
        return _obj
