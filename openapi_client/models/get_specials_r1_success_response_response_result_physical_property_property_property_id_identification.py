...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyPropertyIDIdentification
    """ # noqa: E501
    id_value: StrictInt = Field(description="The unique identifier for the property.", alias="IDValue")
    organization_name: StrictStr = Field(description="The organization name associated with the property.", alias="OrganizationName")
    __properties: ClassVar[List[str]] = ["IDValue", "OrganizationName"]
