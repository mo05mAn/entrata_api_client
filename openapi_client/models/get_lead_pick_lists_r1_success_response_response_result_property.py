...
class GetLeadPickListsR1SuccessResponseResponseResultProperty(BaseModel):
    """
    Properties associated with the request.
    """ # noqa: E501
    var_18462: Optional[GetLeadPickListsR1SuccessResponseResponseResultProperty18462] = Field(default=None, alias="18462")
    __properties: ClassVar[List[str]] = ["18462"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of var_18462
        if self.var_18462:
            _dict['18462'] = self.var_18462.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "18462": GetLeadPickListsR1SuccessResponseResponseResultProperty18462.from_dict(obj["18462"]) if obj.get("18462") is not None else None
        })
        return _obj
