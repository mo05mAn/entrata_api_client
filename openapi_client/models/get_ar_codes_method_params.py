...
class GetArCodesMethodParams(BaseModel):
    """
    GetArCodesMethodParams
    """ # noqa: E501
    property_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value. Provide a valid propertyid.", alias="propertyId")
