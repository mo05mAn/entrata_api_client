...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentification(BaseModel):
    """
    Identification details of the property
    """ # noqa: E501
    id_value: Optional[StrictStr] = Field(default=None, description="Property ID value", alias="IDValue")
    attributes: Optional[GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentificationAttributes] = Field(default=None, alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerIdentificationAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
