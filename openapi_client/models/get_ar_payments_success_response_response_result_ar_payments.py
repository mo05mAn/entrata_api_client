...
class GetArPaymentsSuccessResponseResponseResultArPayments(BaseModel):
    """
    GetArPaymentsSuccessResponseResponseResultArPayments
    """ # noqa: E501
    ar_payment: List[GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInner] = Field(alias="ArPayment")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ArPayment": [GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInner.from_dict(_item) for _item in obj["ArPayment"]] if obj.get("ArPayment") is not None else None
        })
        return _obj
