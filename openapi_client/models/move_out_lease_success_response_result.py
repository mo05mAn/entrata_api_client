...
class MoveOutLeaseSuccessResponseResult(BaseModel):
    """
    MoveOutLeaseSuccessResponseResult
    """ # noqa: E501
    status: StrictStr = Field(description="Status of the move-out request")
    message: StrictStr = Field(description="Message regarding the move-out request")
