...
class GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultRoutingTagsRoutingTagInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the routing tag.")
    name: StrictStr = Field(description="Name of the routing tag.")
