...
class GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypes(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypes
    """ # noqa: E501
    unit_type: Optional[List[GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner]] = Field(default=None, alias="unitType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitType": [GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInnerUnitTypesUnitTypeInner.from_dict(_item) for _item in obj["unitType"]] if obj.get("unitType") is not None else None
        })
        return _obj
