...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerUnitAddressAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    address_type: StrictStr = Field(description="Address type", alias="AddressType")
    __properties: ClassVar[List[str]] = ["AddressType"]
