...
class GetParcelAlertsMethodParams(BaseModel):
    """
    ...
    lease_id: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value.", alias="leaseId")
    customer_id: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value.", alias="customerId")
    is_active: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="isActive")
    __properties: ClassVar[List[str]] = ["propertyId", "leaseId", "customerId", "isActive"]
