...
class GetVendorPickListsSuccessResponseResultApRemittanceTypes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultApRemittanceTypes
    """ # noqa: E501
    ap_remittance_type: Optional[List[GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInner]] = Field(default=None, alias="apRemittanceType")
    __properties: ClassVar[List[str]] = ["apRemittanceType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_remittance_type (list)
        _items = []
        if self.ap_remittance_type:
            for _item in self.ap_remittance_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['apRemittanceType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apRemittanceType": [GetVendorPickListsSuccessResponseResultApRemittanceTypesApRemittanceTypeInner.from_dict(_item) for _item in obj["apRemittanceType"]] if obj.get("apRemittanceType") is not None else None
        })
        return _obj
