...
class GetSpecialsR1SuccessResponseResponseResultPhysicalProperty(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalProperty
    """ # noqa: E501
    var_property: GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyProperty = Field(alias="Property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Property": GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyProperty.from_dict(obj["Property"]) if obj.get("Property") is not None else None
        })
        return _obj
