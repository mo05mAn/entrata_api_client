...
class GetLeaseDetailsR2MethodParams(BaseModel):
    """
    ...
    include_add_ons: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value.", alias="includeAddOns")
    include_charge: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value.", alias="includeCharge")
    __properties: ClassVar[List[str]] = ["propertyId", "leaseId", "leaseStatusTypeIds", "includeAddOns", "includeCharge"]

    @field_validator('include_add_ons')
    def include_add_ons_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('include_charge')
    def include_charge_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeAddOns": obj.get("includeAddOns"),
            "includeCharge": obj.get("includeCharge")
        })
        return _obj
