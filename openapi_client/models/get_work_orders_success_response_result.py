...
class GetWorkOrdersSuccessResponseResult(BaseModel):
    """
    GetWorkOrdersSuccessResponseResult
    """ # noqa: E501
    work_orders: GetWorkOrdersSuccessResponseResultWorkOrders = Field(alias="workOrders")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workOrders": GetWorkOrdersSuccessResponseResultWorkOrders.from_dict(obj["workOrders"]) if obj.get("workOrders") is not None else None
        })
        return _obj
