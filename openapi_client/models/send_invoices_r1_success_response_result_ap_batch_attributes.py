...
class SendInvoicesR1SuccessResponseResultApBatchAttributes(BaseModel):
    """
    SendInvoicesR1SuccessResponseResultApBatchAttributes
    """ # noqa: E501
    reference_id: Optional[StrictStr] = Field(default=None, description="Unique reference ID for the batch.")
