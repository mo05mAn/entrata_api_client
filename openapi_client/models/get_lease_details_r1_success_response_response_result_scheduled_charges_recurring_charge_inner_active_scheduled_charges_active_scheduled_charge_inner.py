...
class GetLeaseDetailsR1SuccessResponseResponseResultScheduledChargesRecurringChargeInnerActiveScheduledChargesActiveScheduledChargeInner(BaseModel):
    """
    ...
    charge_timing: StrictStr = Field(description="Timing for the charge.", alias="chargeTiming")
    charge_usage: StrictStr = Field(description="Usage of the charge.", alias="chargeUsage")
    charge_start_date: StrictStr = Field(description="Start date for the charge.", alias="chargeStartDate")
    charge_end_date: Optional[StrictStr] = Field(default=None, description="End date for the charge.", alias="chargeEndDate")
    charge_amount: StrictStr = Field(description="Amount of the charge.", alias="chargeAmount")
    __properties: ClassVar[List[str]] = ["chargeCode", "chargeTiming", "chargeUsage", "chargeStartDate", "chargeEndDate", "chargeAmount"]
