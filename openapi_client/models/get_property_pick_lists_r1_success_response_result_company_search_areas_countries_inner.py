...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInner(BaseModel):
    """
    GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInner
    """ # noqa: E501
    country: List[GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInner] = Field(description="List of countries with states")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "country": [GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInner.from_dict(_item) for _item in obj["country"]] if obj.get("country") is not None else None
        })
        return _obj
