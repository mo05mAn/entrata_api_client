...
class GetLeadPickListsR1SuccessResponse(BaseModel):
    """
    GetLeadPickListsR1SuccessResponse
    """ # noqa: E501
    response: GetLeadPickListsR1SuccessResponseResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GetLeadPickListsR1SuccessResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
