...
class GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItems(BaseModel):
    """
    List of specific rentable items available
    """ # noqa: E501
    rentable_item: GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItem = Field(alias="RentableItem")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of rentable_item
        if self.rentable_item:
            _dict['RentableItem'] = self.rentable_item.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "RentableItem": GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItem.from_dict(obj["RentableItem"]) if obj.get("RentableItem") is not None else None
        })
        return _obj
