...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerUnitTypesUnitTypeInnerAttributes(BaseModel):
    """
    Unit type attributes
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unit type ID", alias="Id")
    name: Optional[StrictStr] = Field(default=None, description="Unit type name", alias="Name")
