...
class UpdateBudgetsSuccessResponseResult(BaseModel):
    """
    UpdateBudgetsSuccessResponseResult
    """ # noqa: E501
    budgets: UpdateBudgetsSuccessResponseResultBudgets
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "budgets": UpdateBudgetsSuccessResponseResultBudgets.from_dict(obj["budgets"]) if obj.get("budgets") is not None else None
        })
        return _obj
