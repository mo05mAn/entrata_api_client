...
class GetLeaseArTransactionsSuccessResponseResponseResult(BaseModel):
    """
    GetLeaseArTransactionsSuccessResponseResponseResult
    """ # noqa: E501
    leases: GetLeaseArTransactionsSuccessResponseResponseResultLeases
    __properties: ClassVar[List[str]] = ["leases"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leases": GetLeaseArTransactionsSuccessResponseResponseResultLeases.from_dict(obj["leases"]) if obj.get("leases") is not None else None
        })
        return _obj
