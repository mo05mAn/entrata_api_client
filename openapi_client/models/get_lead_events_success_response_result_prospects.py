...
class GetLeadEventsSuccessResponseResultProspects(BaseModel):
    """
    Prospects related to the request.
    """ # noqa: E501
    prospect: Optional[List[GetLeadEventsSuccessResponseResultProspectsProspectInner]] = Field(default=None, description="Array of prospects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prospect": [GetLeadEventsSuccessResponseResultProspectsProspectInner.from_dict(_item) for _item in obj["prospect"]] if obj.get("prospect") is not None else None
        })
        return _obj
