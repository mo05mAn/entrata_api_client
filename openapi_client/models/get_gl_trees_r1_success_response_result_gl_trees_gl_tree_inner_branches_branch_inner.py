...
class GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranchesBranchInner(BaseModel):
    """
    GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerBranchesBranchInner
    """ # noqa: E501
    branch_id: StrictStr = Field(description="The unique identifier for the branch.", alias="BranchId")
    group_type: StrictStr = Field(description="The type of the group.", alias="GroupType")
    is_enabled: StrictStr = Field(description="Indicates whether the branch is enabled.", alias="IsEnabled")
    show_group_name: StrictStr = Field(description="Indicates whether to show the group name.", alias="ShowGroupName")
    group_name: StrictStr = Field(description="The name of the group.", alias="GroupName")
    show_summary_row: StrictStr = Field(description="Indicates whether to show the summary row.", alias="ShowSummaryRow")
    description: StrictStr = Field(description="The description of the branch.", alias="Description")
