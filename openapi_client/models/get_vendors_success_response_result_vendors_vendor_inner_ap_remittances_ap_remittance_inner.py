...
class GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the AP remittance.")
    name: StrictStr = Field(description="Name of the AP remittance.")
    ap_payment_type_id: StrictStr = Field(description="Payment type identifier.", alias="apPaymentTypeId")
    ap_payment_type: StrictStr = Field(description="Type of payment.", alias="apPaymentType")
    check_account_type_id: StrictStr = Field(description="Account type identifier.", alias="checkAccountTypeId")
    check_account_type: StrictStr = Field(description="Type of check account.", alias="checkAccountType")
    is_default: StrictStr = Field(description="Indicates if this remittance is the default.", alias="isDefault")
    __properties: ClassVar[List[str]] = ["id", "name", "apPaymentTypeId", "apPaymentType", "checkAccountTypeId", "checkAccountType", "isDefault"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "checkAccountTypeId": obj.get("checkAccountTypeId"),
            "checkAccountType": obj.get("checkAccountType"),
