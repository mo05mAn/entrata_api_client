...
class GetLeadPickListsR2SuccessResponseResultEventTypesEventTypeInnerAttributes(BaseModel):
    """
    Attributes related to the event type.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the event.")
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the event.")
