...
class GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner
    """ # noqa: E501
    lease_term_id: StrictStr = Field(description="The lease term ID.", alias="leaseTermId")
    lease_term_name: StrictStr = Field(description="The lease term name.", alias="leaseTermName")
    is_active: StrictStr = Field(description="Indicates if the lease term is active.", alias="isActive")
    __properties: ClassVar[List[str]] = ["leaseTermId", "leaseTermName", "isActive"]
