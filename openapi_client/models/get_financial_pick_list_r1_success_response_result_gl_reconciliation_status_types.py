...
class GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypes
    """ # noqa: E501
    gl_reconciliation_status_types: List[GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypesInner] = Field(description="A list of GL reconciliation status types.", alias="GlReconciliationStatusTypes")
    __properties: ClassVar[List[str]] = ["GlReconciliationStatusTypes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_reconciliation_status_types (list)
        _items = []
        if self.gl_reconciliation_status_types:
            for _item in self.gl_reconciliation_status_types:
                if _item:
                    _items.append(_item.to_dict())
            _dict['GlReconciliationStatusTypes'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlReconciliationStatusTypes": [GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypesInner.from_dict(_item) for _item in obj["GlReconciliationStatusTypes"]] if obj.get("GlReconciliationStatusTypes") is not None else None
        })
        return _obj
