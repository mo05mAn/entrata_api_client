...
class GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner(BaseModel):
    """
    GetLeasePickListSuccessResponseResultChargeCodeTypesChargeCodeTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the charge code type.")
    name: StrictStr = Field(description="Name of the charge code type.")
    allowed_charge_timing_ids: StrictStr = Field(description="Allowed charge timing IDs for this charge code type.")
