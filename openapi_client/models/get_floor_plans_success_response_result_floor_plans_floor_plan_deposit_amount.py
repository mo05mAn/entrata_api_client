...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAmount(BaseModel):
    """
    Deposit amount information
    """ # noqa: E501
    value_range: Optional[GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAmountValueRange] = Field(default=None, alias="ValueRange")
    __properties: ClassVar[List[str]] = ["ValueRange"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ValueRange": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanDepositAmountValueRange.from_dict(obj["ValueRange"]) if obj.get("ValueRange") is not None else None
        })
        return _obj
