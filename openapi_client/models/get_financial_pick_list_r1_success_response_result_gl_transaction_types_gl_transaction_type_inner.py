...
class GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlTransactionTypesGlTransactionTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL transaction type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL transaction type.", alias="Name")
