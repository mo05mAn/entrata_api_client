...
class GetInspectionTemplatesSuccessResponseResultInspectionTemplatesInspectionTemplateInnerLocationsLocationInnerProblemsProblemInner(BaseModel):
    """
    ...
    """ # noqa: E501
    maintenance_problem_id: StrictStr = Field(description="ID of the maintenance problem", alias="maintenanceProblemId")
    problem_name: StrictStr = Field(description="Name of the maintenance problem", alias="problemName")
    __properties: ClassVar[List[str]] = ["maintenanceProblemId", "problemName"]
