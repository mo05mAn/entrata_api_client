...
class GetPricingPicklistsSuccessResponseResponseResultPricingLevels(BaseModel):
    """
    Pricing levels details
    """ # noqa: E501
    pricing_level: Optional[List[GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner]] = Field(default=None, description="List of pricing levels", alias="pricingLevel")
    __properties: ClassVar[List[str]] = ["pricingLevel"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pricing_level (list)
        _items = []
        if self.pricing_level:
            for _item in self.pricing_level:
                if _item:
                    _items.append(_item.to_dict())
            _dict['pricingLevel'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pricingLevel": [GetPricingPicklistsSuccessResponseResponseResultPricingLevelsPricingLevelInner.from_dict(_item) for _item in obj["pricingLevel"]] if obj.get("pricingLevel") is not None else None
        })
        return _obj
