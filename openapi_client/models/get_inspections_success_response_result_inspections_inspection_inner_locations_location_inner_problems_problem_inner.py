...
class GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInner(BaseModel):
    """
    GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInner
    """ # noqa: E501
    problem_id: StrictStr = Field(description="ID of the problem", alias="problemId")
    problem_name: StrictStr = Field(description="Name of the problem", alias="problemName")
    response: StrictStr = Field(description="Response to the problem")
    sub_problems: Optional[GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInnerSubProblems] = Field(default=None, alias="subProblems")
    __properties: ClassVar[List[str]] = ["problemId", "problemName", "response", "subProblems"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sub_problems
        if self.sub_problems:
            _dict['subProblems'] = self.sub_problems.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "problemName": obj.get("problemName"),
            "response": obj.get("response"),
            "subProblems": GetInspectionsSuccessResponseResultInspectionsInspectionInnerLocationsLocationInnerProblemsProblemInnerSubProblems.from_dict(obj["subProblems"]) if obj.get("subProblems") is not None else None
        })
        return _obj
