...
class GetLeasesR2SuccessResponseResponseResult(BaseModel):
    """
    The result containing lease information
    """ # noqa: E501
    currency_code: StrictStr = Field(description="The currency code used in the lease", alias="currencyCode")
    leases: GetLeasesR2SuccessResponseResponseResultLeases
    __properties: ClassVar[List[str]] = ["currencyCode", "leases"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of leases
        if self.leases:
            _dict['leases'] = self.leases.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "leases": GetLeasesR2SuccessResponseResponseResultLeases.from_dict(obj["leases"]) if obj.get("leases") is not None else None
        })
        return _obj
