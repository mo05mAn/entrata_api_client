...
class SendInvoicesR1SuccessResponse(BaseModel):
    """
    SendInvoicesR1SuccessResponse
    """ # noqa: E501
    result: SendInvoicesR1SuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": SendInvoicesR1SuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
