...
class GetMarketingPreferencePickListMethod(BaseModel):
    """
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['getMarketingPreferencePickList']):
            raise ValueError("must be one of enum values ('getMarketingPreferencePickList')")
        return value
