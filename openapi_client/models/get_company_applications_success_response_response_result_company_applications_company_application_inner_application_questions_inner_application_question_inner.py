...
class GetCompanyApplicationsSuccessResponseResponseResultCompanyApplicationsCompanyApplicationInnerApplicationQuestionsInnerApplicationQuestionInner(BaseModel):
    """
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="A unique identifier for the application question.")
    question: StrictStr = Field(description="The application question text.")
    __properties: ClassVar[List[str]] = ["id", "question"]
