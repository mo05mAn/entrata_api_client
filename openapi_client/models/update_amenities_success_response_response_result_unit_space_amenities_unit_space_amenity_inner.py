...
class UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner(BaseModel):
    """
    UpdateAmenitiesSuccessResponseResponseResultUnitSpaceAmenitiesUnitSpaceAmenityInner
    """ # noqa: E501
    node: StrictInt = Field(description="Unique identifier for the unit space amenity node")
    status: StrictStr = Field(description="Status of the operation")
    amenity_id: StrictInt = Field(description="ID of the unit space amenity", alias="amenityId")
    message: StrictStr = Field(description="Message about the unit space amenity operation")
    __properties: ClassVar[List[str]] = ["node", "status", "amenityId", "message"]
