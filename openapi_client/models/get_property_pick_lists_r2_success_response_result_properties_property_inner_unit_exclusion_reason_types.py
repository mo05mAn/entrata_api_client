...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitExclusionReasonTypes(BaseModel):
    """
    Exclusion reasons for units
    """ # noqa: E501
    unit_exclusion_reason_type: List[GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitExclusionReasonTypesUnitExclusionReasonTypeInner] = Field(alias="UnitExclusionReasonType")
    __properties: ClassVar[List[str]] = ["UnitExclusionReasonType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in unit_exclusion_reason_type (list)
        _items = []
        if self.unit_exclusion_reason_type:
            for _item in self.unit_exclusion_reason_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['UnitExclusionReasonType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "UnitExclusionReasonType": [GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerUnitExclusionReasonTypesUnitExclusionReasonTypeInner.from_dict(_item) for _item in obj["UnitExclusionReasonType"]] if obj.get("UnitExclusionReasonType") is not None else None
        })
        return _obj
