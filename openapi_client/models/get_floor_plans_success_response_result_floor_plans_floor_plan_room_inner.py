...
class GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInner(BaseModel):
    """
    GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInner
    """ # noqa: E501
    count: StrictStr = Field(description="Number of rooms of a particular type", alias="Count")
    attributes: GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes = Field(alias="@attributes")
    __properties: ClassVar[List[str]] = ["Count", "@attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Count": obj.get("Count"),
            "@attributes": GetFloorPlansSuccessResponseResultFloorPlansFloorPlanRoomInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
