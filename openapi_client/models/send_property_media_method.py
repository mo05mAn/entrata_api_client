...
class SendPropertyMediaMethod(BaseModel):
    """
    SendPropertyMediaMethod
    """ # noqa: E501
    name: StrictStr
    params: SendPropertyMediaMethodParams
    __properties: ClassVar[List[str]] = ["name", "params"]

    @field_validator('name')
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['sendPropertyMedia']):
            raise ValueError("must be one of enum values ('sendPropertyMedia')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "params": SendPropertyMediaMethodParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
