...
class GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypes(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypes
    """ # noqa: E501
    status_type: List[GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner] = Field(alias="StatusType")
    __properties: ClassVar[List[str]] = ["StatusType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in status_type (list)
        _items = []
        if self.status_type:
            for _item in self.status_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['StatusType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "StatusType": [GetWorkOrderPickListsSuccessResponseResultPropertyStatusTypesStatusTypeInner.from_dict(_item) for _item in obj["StatusType"]] if obj.get("StatusType") is not None else None
        })
        return _obj
