...
class GetLeaseActivitiesSuccessResponseResponseResultEventsInnerCallData(BaseModel):
    """
    Call-specific data (only present for call events)
    """ # noqa: E501
    call_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the call", alias="callId")
    call_from: Optional[StrictStr] = Field(default=None, description="Phone number that initiated the call", alias="callFrom")
    ring_through: Optional[StrictStr] = Field(default=None, description="Phone number that received the call", alias="ringThrough")
    duration: Optional[StrictStr] = Field(default=None, description="Duration of the call")
    call_status: Optional[StrictStr] = Field(default=None, description="Status of the call", alias="callStatus")
    audio_link: Optional[StrictStr] = Field(default=None, description="URL to the call audio recording", alias="audioLink")
    __properties: ClassVar[List[str]] = ["callId", "callFrom", "ringThrough", "duration", "callStatus", "audioLink"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "callFrom": obj.get("callFrom"),
            "ringThrough": obj.get("ringThrough"),
            "duration": obj.get("duration"),
            "callStatus": obj.get("callStatus"),
            "audioLink": obj.get("audioLink")
        })
        return _obj
