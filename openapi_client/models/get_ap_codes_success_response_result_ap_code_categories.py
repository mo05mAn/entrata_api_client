...
class GetApCodesSuccessResponseResultApCodeCategories(BaseModel):
    """
    GetApCodesSuccessResponseResultApCodeCategories
    """ # noqa: E501
    ap_code_category: List[GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner] = Field(description="A list of accounts payable categories.", alias="apCodeCategory")
    __properties: ClassVar[List[str]] = ["apCodeCategory"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_code_category (list)
        _items = []
        if self.ap_code_category:
            for _item in self.ap_code_category:
                if _item:
                    _items.append(_item.to_dict())
            _dict['apCodeCategory'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apCodeCategory": [GetApCodesSuccessResponseResultApCodeCategoriesApCodeCategoryInner.from_dict(_item) for _item in obj["apCodeCategory"]] if obj.get("apCodeCategory") is not None else None
        })
        return _obj
