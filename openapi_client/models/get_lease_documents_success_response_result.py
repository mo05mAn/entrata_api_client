...
class GetLeaseDocumentsSuccessResponseResult(BaseModel):
    """
    GetLeaseDocumentsSuccessResponseResult
    """ # noqa: E501
    lease_documents: GetLeaseDocumentsSuccessResponseResultLeaseDocuments = Field(alias="LeaseDocuments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LeaseDocuments": GetLeaseDocumentsSuccessResponseResultLeaseDocuments.from_dict(obj["LeaseDocuments"]) if obj.get("LeaseDocuments") is not None else None
        })
        return _obj
