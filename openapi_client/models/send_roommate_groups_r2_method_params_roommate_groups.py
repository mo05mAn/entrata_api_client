...
class SendRoommateGroupsR2MethodParamsRoommateGroups(BaseModel):
    """
    SendRoommateGroupsR2MethodParamsRoommateGroups
    """ # noqa: E501
    roommate_group: List[SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner] = Field(alias="roommateGroup")
    __properties: ClassVar[List[str]] = ["roommateGroup"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in roommate_group (list)
        _items = []
        if self.roommate_group:
            for _item in self.roommate_group:
                if _item:
                    _items.append(_item.to_dict())
            _dict['roommateGroup'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roommateGroup": [SendRoommateGroupsR2MethodParamsRoommateGroupsRoommateGroupInner.from_dict(_item) for _item in obj["roommateGroup"]] if obj.get("roommateGroup") is not None else None
        })
        return _obj
