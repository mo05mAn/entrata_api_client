...
class GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRates(BaseModel):
    """
    Pricing information for the add-on
    """ # noqa: E501
    rate: Optional[List[GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRatesRateInner]] = Field(default=None, description="List of rate details")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rate": [GetPropertyAddOnsSuccessResponseResultAddOnsAddonInnerRatesRateInner.from_dict(_item) for _item in obj["rate"]] if obj.get("rate") is not None else None
        })
        return _obj
