...
class GetSpecialsR4SuccessResponseResponse(BaseModel):
    """
    GetSpecialsR4SuccessResponseResponse
    """ # noqa: E501
    request_id: Optional[StrictStr] = Field(default=None, alias="requestId")
    code: StrictInt
    result: GetSpecialsR4SuccessResponseResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetSpecialsR4SuccessResponseResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
