...
class GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesUnitTypeAmenitiesAmenityAttributes
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the unit type amenity", alias="Id")
