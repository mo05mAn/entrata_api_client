...
class GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetailsGlDetailInnerAttributes(BaseModel):
    """
    GetGlTransactionsSuccessResponseResultPropertiesPropertyTransactionsTransactionInnerGlDetailsGlDetailInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the transaction.")
    transaction_type: StrictStr = Field(description="The type of the transaction.", alias="transactionType")
