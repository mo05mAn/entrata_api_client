...
class GetParcelAlertsSuccessResponseResponseResultPackageBatches(BaseModel):
    """
    GetParcelAlertsSuccessResponseResponseResultPackageBatches
    """ # noqa: E501
    package_batch: List[GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInner] = Field(alias="packageBatch")
    __properties: ClassVar[List[str]] = ["packageBatch"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in package_batch (list)
        _items = []
        if self.package_batch:
            for _item in self.package_batch:
                if _item:
                    _items.append(_item.to_dict())
            _dict['packageBatch'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "packageBatch": [GetParcelAlertsSuccessResponseResponseResultPackageBatchesPackageBatchInner.from_dict(_item) for _item in obj["packageBatch"]] if obj.get("packageBatch") is not None else None
        })
        return _obj
