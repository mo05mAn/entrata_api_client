...
class GetArInvoicesSuccessResponseResponseResultArInvoicesArInvoiceInnerArTransactionsArTransactionInnerArPaymentsArPaymentInner(BaseModel):
    """
    ...
    """ # noqa: E501
    ar_payment_id: StrictInt = Field(description="The unique identifier for the payment related to this transaction.", alias="arPaymentId")
    payment_amount: Optional[StrictInt] = Field(default=None, description="The total amount paid for the transaction.", alias="PaymentAmount")
    payment_date: Optional[StrictStr] = Field(default=None, description="The date the payment was made.", alias="PaymentDate")
    payment_type_id: Optional[StrictInt] = Field(default=None, description="The identifier for the type of payment made.", alias="PaymentTypeId")
    payment_type_name: Optional[StrictStr] = Field(default=None, description="The name of the payment method used.", alias="PaymentTypeName")
    payment_status_type_id: Optional[StrictInt] = Field(default=None, description="The identifier for the status of the payment.", alias="PaymentStatusTypeId")
    payment_status_type_name: Optional[StrictStr] = Field(default=None, description="The name of the payment status.", alias="PaymentStatusTypeName")
    __properties: ClassVar[List[str]] = ["arPaymentId", "PaymentAmount", "PaymentDate", "PaymentTypeId", "PaymentTypeName", "PaymentStatusTypeId", "PaymentStatusTypeName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "PaymentTypeName": obj.get("PaymentTypeName"),
            "PaymentStatusTypeId": obj.get("PaymentStatusTypeId"),
            "PaymentStatusTypeName": obj.get("PaymentStatusTypeName")
        })
        return _obj
