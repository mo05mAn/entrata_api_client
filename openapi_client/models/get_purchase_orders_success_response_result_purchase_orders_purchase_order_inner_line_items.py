...
class GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems(BaseModel):
    """
    GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItems
    """ # noqa: E501
    line_item: Optional[GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItemsLineItem] = Field(default=None, alias="lineItem")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lineItem": GetPurchaseOrdersSuccessResponseResultPurchaseOrdersPurchaseOrderInnerLineItemsLineItem.from_dict(obj["lineItem"]) if obj.get("lineItem") is not None else None
        })
        return _obj
