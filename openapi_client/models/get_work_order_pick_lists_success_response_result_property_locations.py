...
class GetWorkOrderPickListsSuccessResponseResultPropertyLocations(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyLocations
    """ # noqa: E501
    location: List[GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner] = Field(alias="Location")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Location": [GetWorkOrderPickListsSuccessResponseResultPropertyLocationsLocationInner.from_dict(_item) for _item in obj["Location"]] if obj.get("Location") is not None else None
        })
        return _obj
