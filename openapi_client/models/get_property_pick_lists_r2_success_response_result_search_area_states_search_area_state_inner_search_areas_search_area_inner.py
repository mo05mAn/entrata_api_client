...
class GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInnerSearchAreasSearchAreaInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultSearchAreaStatesSearchAreaStateInnerSearchAreasSearchAreaInner
    """ # noqa: E501
    id: StrictInt = Field(description="Search area ID")
    name: StrictStr = Field(description="Search area name")
