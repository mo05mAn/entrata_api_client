...
class UpdateCustomerTestimonialsSuccessResponse(BaseModel):
    """
    ...
    code: StrictInt = Field(description="The response code indicating the status of the request.")
    result: UpdateCustomerTestimonialsSuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": UpdateCustomerTestimonialsSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
