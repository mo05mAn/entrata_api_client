...
class GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the problem", alias="Id")
    name: StrictStr = Field(description="Name of the problem", alias="Name")
    is_resident_portal_enabled: Optional[StrictStr] = Field(default=None, description="Indicates if the problem is visible on the resident portal", alias="IsResidentPortalEnabled")
    sub_maintenance_problems: Optional[GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInnerSubMaintenanceProblems] = Field(default=None, alias="subMaintenanceProblems")
    __properties: ClassVar[List[str]] = ["Id", "Name", "IsResidentPortalEnabled", "subMaintenanceProblems"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sub_maintenance_problems
        if self.sub_maintenance_problems:
            _dict['subMaintenanceProblems'] = self.sub_maintenance_problems.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Id": obj.get("Id"),
            "Name": obj.get("Name"),
            "IsResidentPortalEnabled": obj.get("IsResidentPortalEnabled"),
            "subMaintenanceProblems": GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInnerSubMaintenanceProblems.from_dict(obj["subMaintenanceProblems"]) if obj.get("subMaintenanceProblems") is not None else None
        })
        return _obj
