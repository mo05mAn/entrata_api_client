...
class GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHours(BaseModel):
    """
    List of available hours for specific dates
    """ # noqa: E501
    available_hour: Optional[List[GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHoursAvailableHourInner]] = Field(default=None, description="List of available hours", alias="availableHour")
    __properties: ClassVar[List[str]] = ["availableHour"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in available_hour (list)
        _items = []
        if self.available_hour:
            for _item in self.available_hour:
                if _item:
                    _items.append(_item.to_dict())
            _dict['availableHour'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availableHour": [GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarAvailabilityAvailableHoursAvailableHourInner.from_dict(_item) for _item in obj["availableHour"]] if obj.get("availableHour") is not None else None
        })
        return _obj
