...
class GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocations(BaseModel):
    """
    GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocations
    """ # noqa: E501
    ar_allocation: List[GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocationsArAllocationInner] = Field(alias="ArAllocation")
    __properties: ClassVar[List[str]] = ["ArAllocation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ar_allocation (list)
        _items = []
        if self.ar_allocation:
            for _item in self.ar_allocation:
                if _item:
                    _items.append(_item.to_dict())
            _dict['ArAllocation'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ArAllocation": [GetArPaymentsSuccessResponseResponseResultArPaymentsArPaymentInnerArAllocationsArAllocationInner.from_dict(_item) for _item in obj["ArAllocation"]] if obj.get("ArAllocation") is not None else None
        })
        return _obj
