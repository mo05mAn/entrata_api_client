...
class UpdateCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialAttributes(BaseModel):
    """
    UpdateCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialAttributes
    """ # noqa: E501
    status: StrictStr = Field(description="The status of the transmission vendor activation/deactivation.")
    message: StrictStr = Field(description="The message indicating the result of the transmission vendor operation.")
