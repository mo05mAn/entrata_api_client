...
class GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerLegalEntitiesLegalEntityInner
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the legal entity.")
    name: StrictStr = Field(description="Name of the legal entity.")
    tax_id_number: StrictStr = Field(description="Tax ID number of the legal entity.", alias="taxIdNumber")
    receives1099: StrictStr = Field(description="Indicates if the legal entity receives a 1099 form.")
    form1099_type_id: StrictStr = Field(description="Unique identifier for the 1099 form type.", alias="form1099TypeId")
    form1099_type: StrictStr = Field(description="Type of 1099 form.", alias="form1099Type")
    form1099_box_type_id: StrictStr = Field(description="Unique identifier for the 1099 form box type.", alias="form1099BoxTypeId")
    form1099_box_type: StrictStr = Field(description="Box type of the 1099 form.", alias="form1099BoxType")
    __properties: ClassVar[List[str]] = ["id", "name", "taxIdNumber", "receives1099", "form1099TypeId", "form1099Type", "form1099BoxTypeId", "form1099BoxType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "receives1099": obj.get("receives1099"),
            "form1099TypeId": obj.get("form1099TypeId"),
            "form1099Type": obj.get("form1099Type"),
            "form1099BoxTypeId": obj.get("form1099BoxTypeId"),
            "form1099BoxType": obj.get("form1099BoxType")
        })
        return _obj
