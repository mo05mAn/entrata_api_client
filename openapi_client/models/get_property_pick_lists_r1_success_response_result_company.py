...
class GetPropertyPickListsR1SuccessResponseResultCompany(BaseModel):
    """
    Contains search areas and countries
    """ # noqa: E501
    search_areas: GetPropertyPickListsR1SuccessResponseResultCompanySearchAreas = Field(alias="searchAreas")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "searchAreas": GetPropertyPickListsR1SuccessResponseResultCompanySearchAreas.from_dict(obj["searchAreas"]) if obj.get("searchAreas") is not None else None
        })
        return _obj
