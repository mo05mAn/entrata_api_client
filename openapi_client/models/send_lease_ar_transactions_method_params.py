...
class SendLeaseArTransactionsMethodParams(BaseModel):
    """
    SendLeaseArTransactionsMethodParams
    """ # noqa: E501
    transaction_id: StrictInt = Field(description="This is a required field. This field accepts single value. Unique Transaction ID of client system", alias="transactionId")
    lease_id: StrictInt = Field(description="This is a required field. This field accepts single value. Lease ID", alias="leaseId")
    ar_code_id: StrictInt = Field(description="This is a required field. This field accepts single value. Ar Code ID", alias="arCodeId")
    transaction_amount: StrictInt = Field(description="This is a required field. This field accepts single value. Transaction Amount", alias="transactionAmount")
    transaction_date: date = Field(description="This is a required field. This field accepts single value. transactionDate", alias="transactionDate")
    ar_post_month: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts single value. Charge Posting Month", alias="arPostMonth")
    __properties: ClassVar[List[str]] = ["transactionId", "leaseId", "arCodeId", "transactionAmount", "transactionDate", "arPostMonth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "arPostMonth": obj.get("arPostMonth")
        })
        return _obj
