...
class GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerIdentificationValuesCustomerIdentificationValueInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identification number for the customer", alias="Id")
    value: StrictStr = Field(description="The value of the identification", alias="Value")
    company_identification_type_id: StrictInt = Field(description="The ID representing the company identification type", alias="CompanyIdentificationTypeId")
    __properties: ClassVar[List[str]] = ["Id", "Value", "CompanyIdentificationTypeId"]
