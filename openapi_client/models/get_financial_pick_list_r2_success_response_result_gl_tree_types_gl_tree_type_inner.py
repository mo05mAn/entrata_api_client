...
class GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlTreeTypesGlTreeTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL tree type.")
    name: StrictStr = Field(description="The name of the GL tree type.")
