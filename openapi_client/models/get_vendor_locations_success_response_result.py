...
class GetVendorLocationsSuccessResponseResult(BaseModel):
    """
    GetVendorLocationsSuccessResponseResult
    """ # noqa: E501
    locations: Optional[GetVendorLocationsSuccessResponseResultLocations] = Field(default=None, alias="Locations")
    insurances: Optional[GetVendorLocationsSuccessResponseResultInsurances] = Field(default=None, alias="Insurances")
    __properties: ClassVar[List[str]] = ["Locations", "Insurances"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of insurances
        if self.insurances:
            _dict['Insurances'] = self.insurances.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Locations": GetVendorLocationsSuccessResponseResultLocations.from_dict(obj["Locations"]) if obj.get("Locations") is not None else None,
            "Insurances": GetVendorLocationsSuccessResponseResultInsurances.from_dict(obj["Insurances"]) if obj.get("Insurances") is not None else None
        })
        return _obj
