...
class SendBudgetsSuccessResponseResultBudgetsBudgetInner(BaseModel):
    """
    SendBudgetsSuccessResponseResultBudgetsBudgetInner
    """ # noqa: E501
    node: StrictInt = Field(description="The node identifier for the budget insertion.")
    status: StrictStr = Field(description="The status of the budget insertion.")
    message: StrictStr = Field(description="Message indicating the result of the budget insertion.")
