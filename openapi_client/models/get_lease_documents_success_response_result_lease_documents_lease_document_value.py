...
class GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue(BaseModel):
    """
    GetLeaseDocumentsSuccessResponseResultLeaseDocumentsLeaseDocumentValue
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the lease document.", alias="Id")
    applies_to: StrictStr = Field(description="Indicates who the document applies to.", alias="AppliesTo")
    type: StrictStr = Field(description="Type of the lease document.", alias="Type")
    title: StrictStr = Field(description="Title of the lease document.", alias="Title")
    name: StrictStr = Field(description="Filename of the lease document.", alias="Name")
    path: StrictStr = Field(description="Path where the document is stored.", alias="Path")
    file_data: StrictStr = Field(description="Data related to the file (empty in this case).", alias="FileData")
    added_on: StrictStr = Field(description="Timestamp when the document was added.", alias="AddedOn")
    __properties: ClassVar[List[str]] = ["Id", "AppliesTo", "Type", "Title", "Name", "Path", "FileData", "AddedOn"]
