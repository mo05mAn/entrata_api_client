...
class GetLeasingCenterPickListsSuccessResponseResultCallResults(BaseModel):
    """
    GetLeasingCenterPickListsSuccessResponseResultCallResults
    """ # noqa: E501
    call_result: List[GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner] = Field(alias="callResult")
    __properties: ClassVar[List[str]] = ["callResult"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in call_result (list)
        _items = []
        if self.call_result:
            for _item in self.call_result:
                if _item:
                    _items.append(_item.to_dict())
            _dict['callResult'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "callResult": [GetLeasingCenterPickListsSuccessResponseResultCallResultsCallResultInner.from_dict(_item) for _item in obj["callResult"]] if obj.get("callResult") is not None else None
        })
        return _obj
