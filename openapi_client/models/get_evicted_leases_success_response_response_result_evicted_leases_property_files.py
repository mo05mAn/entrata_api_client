...
class GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFiles(BaseModel):
    """
    GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFiles
    """ # noqa: E501
    property_file: GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile = Field(alias="propertyFile")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "propertyFile": GetEvictedLeasesSuccessResponseResponseResultEvictedLeasesPropertyFilesPropertyFile.from_dict(obj["propertyFile"]) if obj.get("propertyFile") is not None else None
        })
        return _obj
