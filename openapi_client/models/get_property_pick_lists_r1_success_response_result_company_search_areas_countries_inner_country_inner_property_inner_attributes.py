...
class GetPropertyPickListsR1SuccessResponseResultCompanySearchAreasCountriesInnerCountryInnerPropertyInnerAttributes(BaseModel):
    """
    Property metadata
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique property ID", alias="Id")
    name: Optional[StrictStr] = Field(default=None, description="Property name", alias="Name")
    is_disabled: Optional[StrictInt] = Field(default=None, description="Flag to indicate if the property is disabled", alias="IsDisabled")
    __properties: ClassVar[List[str]] = ["Id", "Name", "IsDisabled"]
