...
class SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner(BaseModel):
    """
    SendScheduledChargesSuccessResponseResultScheduledChargesScheduledChargeInner
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the scheduled charge")
    node: StrictStr = Field(description="Node identifier for the scheduled charge")
    status: StrictStr = Field(description="Status of the scheduled charge insertion")
    message: StrictStr = Field(description="Message detailing the result of the scheduled charge insertion")
    __properties: ClassVar[List[str]] = ["id", "node", "status", "message"]
