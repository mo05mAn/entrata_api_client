...
class GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns(BaseModel):
    """
    GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOns
    """ # noqa: E501
    rentable_items: GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems = Field(alias="rentableItems")
    __properties: ClassVar[List[str]] = ["rentableItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rentableItems": GetLeaseDetailsR2SuccessResponseResultLeasesLeaseAddOnsRentableItems.from_dict(obj["rentableItems"]) if obj.get("rentableItems") is not None else None
        })
        return _obj
