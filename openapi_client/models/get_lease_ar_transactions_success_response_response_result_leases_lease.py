...
class GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease(BaseModel):
    """
    GetLeaseArTransactionsSuccessResponseResponseResultLeasesLease
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the lease.")
    property_id: Optional[StrictInt] = Field(default=None, description="The identifier for the property associated with the lease.", alias="propertyId")
    unit_space_id: Optional[StrictInt] = Field(default=None, description="The identifier for the unit space associated with the lease.", alias="unitSpaceId")
    customers: Optional[GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomers] = None
    __properties: ClassVar[List[str]] = ["id", "propertyId", "unitSpaceId", "customers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customers": GetLeaseArTransactionsSuccessResponseResponseResultLeasesLeaseCustomers.from_dict(obj["customers"]) if obj.get("customers") is not None else None
        })
        return _obj
