...
class GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpaceAmenitiesAmenity(BaseModel):
    """
    GetPropertyUnitsSuccessResponseResponseResultPropertiesPropertyUnitsUnitUnitSpacesUnitSpaceAmenitiesAmenity
    """ # noqa: E501
    id: StrictInt = Field(description="Amenity ID")
    name: StrictStr = Field(description="Amenity name")
    type: StrictStr = Field(description="Amenity type")
