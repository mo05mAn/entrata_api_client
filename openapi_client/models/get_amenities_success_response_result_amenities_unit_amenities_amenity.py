...
class GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenity
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the unit amenity", alias="Name")
    ...
    attributes: GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@attributes": GetAmenitiesSuccessResponseResultAmenitiesUnitAmenitiesAmenityAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
