...
class GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentableItemsRentableItemRents(BaseModel):
    """
    Rent charges for the specific item
    """ # noqa: E501
    rent: List[GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentsRent] = Field(alias="Rent")
    __properties: ClassVar[List[str]] = ["Rent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Rent": [GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentsRent.from_dict(_item) for _item in obj["Rent"]] if obj.get("Rent") is not None else None
        })
        return _obj
