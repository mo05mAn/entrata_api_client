...
class GetAmenityReservationsMethodParams(BaseModel):
    """
    ...
    amenity_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values.", alias="amenityIds")
    amenity_reservation_status_type_ids: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values.", alias="amenityReservationStatusTypeIds")
    __properties: ClassVar[List[str]] = ["propertyId", "amenityIds", "amenityReservationStatusTypeIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "amenityIds": obj.get("amenityIds"),
            "amenityReservationStatusTypeIds": obj.get("amenityReservationStatusTypeIds")
        })
        return _obj
