...
class GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty(BaseModel):
    """
    GetInvoicesR1SuccessResponseResultInvoicesInvoiceLineItemsLineitemInnerProperty
    """ # noqa: E501
    id: StrictStr = Field(description="Property ID")
    name: StrictStr = Field(description="Property name")
    lookup_code: StrictStr = Field(description="Lookup code for the property", alias="lookupCode")
    __properties: ClassVar[List[str]] = ["id", "name", "lookupCode"]
