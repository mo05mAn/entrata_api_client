...
class GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetails(BaseModel):
    """
    GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetails
    """ # noqa: E501
    po_detail: Optional[GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetailsPoDetail] = Field(default=None, alias="poDetail")
    __properties: ClassVar[List[str]] = ["poDetail"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of po_detail
        if self.po_detail:
            _dict['poDetail'] = self.po_detail.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "poDetail": GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetailsPoDetail.from_dict(obj["poDetail"]) if obj.get("poDetail") is not None else None
        })
        return _obj
