...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationLALeaseInnerIdentificationAttributes
    """ # noqa: E501
    id_type: StrictStr = Field(description="Type of lease identifier", alias="IDType")
    id_rank: StrictStr = Field(description="Rank of lease identifier", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Scope type of the lease identifier", alias="IDScopeType")
