...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspects(BaseModel):
    """
    The prospects associated with the lead management.
    """ # noqa: E501
    prospect: Optional[List[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInner]] = Field(default=None, description="A list of prospects.", alias="Prospect")
    __properties: ClassVar[List[str]] = ["Prospect"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in prospect (list)
        _items = []
        if self.prospect:
            for _item in self.prospect:
                if _item:
                    _items.append(_item.to_dict())
            _dict['Prospect'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Prospect": [GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInner.from_dict(_item) for _item in obj["Prospect"]] if obj.get("Prospect") is not None else None
        })
        return _obj
