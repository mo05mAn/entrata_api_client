...
class VoidApPaymentsSuccessResponseResultApPayments(BaseModel):
    """
    VoidApPaymentsSuccessResponseResultApPayments
    """ # noqa: E501
    ap_payment: Optional[List[VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner]] = Field(default=None, alias="apPayment")
    __properties: ClassVar[List[str]] = ["apPayment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_payment (list)
        _items = []
        if self.ap_payment:
            for _item in self.ap_payment:
                if _item:
                    _items.append(_item.to_dict())
            _dict['apPayment'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apPayment": [VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner.from_dict(_item) for _item in obj["apPayment"]] if obj.get("apPayment") is not None else None
        })
        return _obj
