...
class GetBankAccountsSuccessResponseResultBankAccounts(BaseModel):
    """
    GetBankAccountsSuccessResponseResultBankAccounts
    """ # noqa: E501
    bank_account: List[GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner] = Field(description="A list of bank accounts.", alias="BankAccount")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in bank_account (list)
        _items = []
        if self.bank_account:
            for _item in self.bank_account:
                if _item:
                    _items.append(_item.to_dict())
            _dict['BankAccount'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "BankAccount": [GetBankAccountsSuccessResponseResultBankAccountsBankAccountInner.from_dict(_item) for _item in obj["BankAccount"]] if obj.get("BankAccount") is not None else None
        })
        return _obj
