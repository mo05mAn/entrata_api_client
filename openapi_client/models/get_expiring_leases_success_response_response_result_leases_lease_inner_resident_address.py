...
class GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress(BaseModel):
    """
    GetExpiringLeasesSuccessResponseResponseResultLeasesLeaseInnerResidentAddress
    """ # noqa: E501
    street_line1: StrictStr = Field(description="First line of the address.", alias="StreetLine1")
    street_line2: Optional[StrictStr] = Field(default=None, description="Second line of the address.", alias="StreetLine2")
    city: StrictStr = Field(description="City of the address.", alias="City")
    state_code: StrictStr = Field(description="State code of the address.", alias="StateCode")
    postal_code: StrictStr = Field(description="Postal code of the address.", alias="PostalCode")
    __properties: ClassVar[List[str]] = ["StreetLine1", "StreetLine2", "City", "StateCode", "PostalCode"]
