...
class GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL reconciliation status type.")
    name: StrictStr = Field(description="The name of the GL reconciliation status type.")
