...
class GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner(BaseModel):
    """
    GetCalendarAvailabilityR2SuccessResponseResponseResultAvailableToursAvailableTourInner
    """ # noqa: E501
    tour_date: StrictStr = Field(description="The date when the tour is available", alias="tourDate")
    tour_time: List[StrictStr] = Field(description="List of available time slots for the tour", alias="tourTime")
    __properties: ClassVar[List[str]] = ["tourDate", "tourTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tourDate": obj.get("tourDate"),
            "tourTime": obj.get("tourTime")
        })
        return _obj
