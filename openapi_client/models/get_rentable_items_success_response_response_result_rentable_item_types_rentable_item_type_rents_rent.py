...
class GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentsRent(BaseModel):
    """
    GetRentableItemsSuccessResponseResponseResultRentableItemTypesRentableItemTypeRentsRent
    """ # noqa: E501
    type: StrictStr = Field(description="Type of rent charge", alias="Type")
    charge_code: StrictStr = Field(description="Charge code for rent", alias="ChargeCode")
    amount: StrictStr = Field(description="Amount of the rent charge", alias="Amount")
