...
class GetLeadPickListsR2SuccessResponseResultEventSubTypes(BaseModel):
    """
    The event subtypes associated with the request.
    """ # noqa: E501
    event_sub_type: Optional[List[GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner]] = Field(default=None, description="A list of event subtypes.", alias="eventSubType")
    __properties: ClassVar[List[str]] = ["eventSubType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in event_sub_type (list)
        _items = []
        if self.event_sub_type:
            for _item in self.event_sub_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['eventSubType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventSubType": [GetLeadPickListsR2SuccessResponseResultEventSubTypesEventSubTypeInner.from_dict(_item) for _item in obj["eventSubType"]] if obj.get("eventSubType") is not None else None
        })
        return _obj
