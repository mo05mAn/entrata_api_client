...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerIdentificationAttributes(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerIdentificationAttributes
    """ # noqa: E501
    id_type: StrictStr = Field(description="Type of identifier", alias="IDType")
    id_rank: StrictStr = Field(description="Rank of the identifier", alias="IDRank")
    id_scope_type: StrictStr = Field(description="Scope type of the identifier", alias="IDScopeType")
    __properties: ClassVar[List[str]] = ["IDType", "IDRank", "IDScopeType"]
