...
class GetPoReceivingRecordsSuccessResponseResultPurchaseOrdersPurchaseOrderPoDetailsPoDetailReceivingRecordsReceivingRecordInner(BaseModel):
    """
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the receiving record.")
    property_id: StrictInt = Field(description="Property ID where the item was received.", alias="propertyId")
    post_month_received: StrictStr = Field(description="Month when the item was received.", alias="postMonthReceived")
    receiver_name: StrictStr = Field(description="Name of the receiver.", alias="receiverName")
    asset_location: StrictStr = Field(description="Location where the asset is stored.", alias="assetLocation")
    qty_received: StrictStr = Field(description="Quantity of items received.", alias="qtyReceived")
    unit_cost: StrictStr = Field(description="Cost per unit of the received item.", alias="unitCost")
    date_received: StrictStr = Field(description="Date when the item was received.", alias="dateReceived")
    qty_invoiced: StrictStr = Field(description="Quantity of items invoiced.", alias="qtyInvoiced")
    __properties: ClassVar[List[str]] = ["id", "propertyId", "postMonthReceived", "receiverName", "assetLocation", "qtyReceived", "unitCost", "dateReceived", "qtyInvoiced"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "postMonthReceived": obj.get("postMonthReceived"),
            "receiverName": obj.get("receiverName"),
            "assetLocation": obj.get("assetLocation"),
            "qtyReceived": obj.get("qtyReceived"),
