...
class GetMarketingPreferencePickListSuccessResponseResponseResultPreferencesInner(BaseModel):
    """
    ...
    recipient_type_id: StrictInt = Field(description="The identifier for the recipient type", alias="recipientTypeId")
    ...
    __properties: ClassVar[List[str]] = ["communicationChannel", "recipientType", "recipientTypeId", "consentType", "consentTypeId"]
