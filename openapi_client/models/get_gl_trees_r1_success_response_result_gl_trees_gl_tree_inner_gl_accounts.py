...
class GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccounts(BaseModel):
    """
    GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccounts
    """ # noqa: E501
    gl_account: List[GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner] = Field(description="A list of GL accounts within the GL tree.", alias="GlAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlAccount": [GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInner.from_dict(_item) for _item in obj["GlAccount"]] if obj.get("GlAccount") is not None else None
        })
        return _obj
