...
class GetMarketingPreferencesSuccessResponseResultCustomersInner(BaseModel):
    """
    GetMarketingPreferencesSuccessResponseResultCustomersInner
    """ # noqa: E501
    customer_id: StrictInt = Field(description="The unique identifier for the customer", alias="customerId")
    preferences: List[GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner]
    __properties: ClassVar[List[str]] = ["customerId", "preferences"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "preferences": [GetMarketingPreferencesSuccessResponseResultCustomersInnerPreferencesInner.from_dict(_item) for _item in obj["preferences"]] if obj.get("preferences") is not None else None
        })
        return _obj
