...
class SendApplicantGeneralDetailsSuccessResponseResponseResultInner(BaseModel):
    """
    ...
    message: StrictStr = Field(description="Message indicating the general details were updated successfully.")
    applicant_id: StrictStr = Field(description="The unique identifier for the applicant.", alias="applicantId")
    __properties: ClassVar[List[str]] = ["status", "message", "applicantId"]
