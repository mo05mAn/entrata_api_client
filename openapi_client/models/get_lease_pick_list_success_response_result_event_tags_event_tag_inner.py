...
class GetLeasePickListSuccessResponseResultEventTagsEventTagInner(BaseModel):
    """
    GetLeasePickListSuccessResponseResultEventTagsEventTagInner
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the event tag.")
    name: StrictStr = Field(description="Name of the event tag.")
