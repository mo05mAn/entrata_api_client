...
class GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServicesServiceInner(BaseModel):
    """
    GetQuotesSuccessResponseResultApplicationsApplicationInnerQuotesQuoteInnerServicesServiceInner
    """ # noqa: E501
    add_on_type_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the add-on service.", alias="addOnTypeId")
    name: Optional[StrictStr] = Field(default=None, description="The name of the service.")
    type: Optional[StrictStr] = Field(default=None, description="The type of the service.")
    current_rate: Optional[StrictStr] = Field(default=None, description="The current rate for the service.", alias="currentRate")
    deposit: Optional[StrictStr] = Field(default=None, description="The deposit for the service.")
    reservation_fee: Optional[StrictStr] = Field(default=None, description="The reservation fee for the service.", alias="reservationFee")
