...
class GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner(BaseModel):
    """
    GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the call source")
    name: StrictStr = Field(description="Name of the call source")
