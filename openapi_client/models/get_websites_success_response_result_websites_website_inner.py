...
class GetWebsitesSuccessResponseResultWebsitesWebsiteInner(BaseModel):
    """
    GetWebsitesSuccessResponseResultWebsitesWebsiteInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the website")
    name: StrictStr = Field(description="Name of the website")
    subdomain: StrictStr = Field(description="Subdomain of the website")
    is_corporate_website: StrictInt = Field(description="Indicates if the website is corporate", alias="isCorporateWebsite")
    website_properties: GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties = Field(alias="websiteProperties")
    website_domains: GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains = Field(alias="websiteDomains")
    __properties: ClassVar[List[str]] = ["id", "name", "subdomain", "isCorporateWebsite", "websiteProperties", "websiteDomains"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of website_properties
        if self.website_properties:
            _dict['websiteProperties'] = self.website_properties.to_dict()
        # override the default output from pydantic by calling `to_dict()` of website_domains
        if self.website_domains:
            _dict['websiteDomains'] = self.website_domains.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isCorporateWebsite": obj.get("isCorporateWebsite"),
            "websiteProperties": GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteProperties.from_dict(obj["websiteProperties"]) if obj.get("websiteProperties") is not None else None,
            "websiteDomains": GetWebsitesSuccessResponseResultWebsitesWebsiteInnerWebsiteDomains.from_dict(obj["websiteDomains"]) if obj.get("websiteDomains") is not None else None
        })
        return _obj
