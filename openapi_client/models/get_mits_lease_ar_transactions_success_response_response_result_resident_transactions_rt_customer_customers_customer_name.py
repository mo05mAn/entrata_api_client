...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTCustomerCustomersCustomerName
    """ # noqa: E501
    first_name: StrictStr = Field(description="Customer's first name", alias="FirstName")
    last_name: StrictStr = Field(description="Customer's last name", alias="LastName")
