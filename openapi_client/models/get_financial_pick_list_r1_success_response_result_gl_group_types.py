...
class GetFinancialPickListR1SuccessResponseResultGlGroupTypes(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlGroupTypes
    """ # noqa: E501
    gl_group_type: List[GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner] = Field(description="A list of GL group types.", alias="GlGroupType")
    __properties: ClassVar[List[str]] = ["GlGroupType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_group_type (list)
        _items = []
        if self.gl_group_type:
            for _item in self.gl_group_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['GlGroupType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlGroupType": [GetFinancialPickListR1SuccessResponseResultGlGroupTypesGlGroupTypeInner.from_dict(_item) for _item in obj["GlGroupType"]] if obj.get("GlGroupType") is not None else None
        })
        return _obj
