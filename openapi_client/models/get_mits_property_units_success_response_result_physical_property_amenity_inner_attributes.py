...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyAmenityInnerAttributes(BaseModel):
    """
    Attributes related to the amenity
    """ # noqa: E501
    amenity_type: Optional[StrictStr] = Field(default=None, description="Type of the amenity", alias="AmenityType")
