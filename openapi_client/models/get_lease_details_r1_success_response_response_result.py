...
class GetLeaseDetailsR1SuccessResponseResponseResult(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResult
    """ # noqa: E501
    lease_id: StrictInt = Field(description="Unique identifier for the lease.", alias="leaseId")
    name: StrictStr = Field(description="Name of the resident.")
    property_unit_id: StrictInt = Field(description="Unique identifier for the property unit.", alias="propertyUnitId")
    unit_number: StrictStr = Field(description="Unit number of the leased property.", alias="unitNumber")
    add_ons: GetLeaseDetailsR1SuccessResponseResponseResultAddOns = Field(alias="addOns")
    scheduled_charges: GetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges = Field(alias="scheduledCharges")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addOns": GetLeaseDetailsR1SuccessResponseResponseResultAddOns.from_dict(obj["addOns"]) if obj.get("addOns") is not None else None,
            "scheduledCharges": GetLeaseDetailsR1SuccessResponseResponseResultScheduledCharges.from_dict(obj["scheduledCharges"]) if obj.get("scheduledCharges") is not None else None
        })
        return _obj
