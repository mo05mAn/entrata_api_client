...
class GetLeadPickListsR2SuccessResponseResultPropertyAttributes(BaseModel):
    """
    Attributes related to the property.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the property.")
