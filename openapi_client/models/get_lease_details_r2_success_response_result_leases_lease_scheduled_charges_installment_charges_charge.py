...
class GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesCharge(BaseModel):
    """
    GetLeaseDetailsR2SuccessResponseResultLeasesLeaseScheduledChargesInstallmentChargesCharge
    """ # noqa: E501
    ar_code_id: StrictStr = Field(description="The AR code identifier.", alias="arCodeId")
    charge_code: StrictStr = Field(description="Code for the charge.", alias="chargeCode")
    charge_timing: StrictStr = Field(description="When the charge is applied.", alias="chargeTiming")
    charge_usage: StrictStr = Field(description="Usage type of the charge.", alias="chargeUsage")
    charge_start_date: StrictStr = Field(description="Start date of the charge.", alias="chargeStartDate")
    charge_end_date: Optional[StrictStr] = Field(default=None, description="End date of the charge.", alias="chargeEndDate")
    charge_amount: StrictStr = Field(description="Amount for the charge.", alias="chargeAmount")
    __properties: ClassVar[List[str]] = ["arCodeId", "chargeCode", "chargeTiming", "chargeUsage", "chargeStartDate", "chargeEndDate", "chargeAmount"]
