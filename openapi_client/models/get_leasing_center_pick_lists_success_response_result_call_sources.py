...
class GetLeasingCenterPickListsSuccessResponseResultCallSources(BaseModel):
    """
    GetLeasingCenterPickListsSuccessResponseResultCallSources
    """ # noqa: E501
    call_source: List[GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner] = Field(alias="callSource")
    __properties: ClassVar[List[str]] = ["callSource"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in call_source (list)
        _items = []
        if self.call_source:
            for _item in self.call_source:
                if _item:
                    _items.append(_item.to_dict())
            _dict['callSource'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "callSource": [GetLeasingCenterPickListsSuccessResponseResultCallSourcesCallSourceInner.from_dict(_item) for _item in obj["callSource"]] if obj.get("callSource") is not None else None
        })
        return _obj
