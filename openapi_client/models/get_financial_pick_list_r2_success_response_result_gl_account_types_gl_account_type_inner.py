...
class GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlAccountTypesGlAccountTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL account type.")
    name: StrictStr = Field(description="The name of the GL account type.")
