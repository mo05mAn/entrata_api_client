...
class GetGlTreesR1SuccessResponseResultGlTrees(BaseModel):
    """
    GetGlTreesR1SuccessResponseResultGlTrees
    """ # noqa: E501
    gl_tree: List[GetGlTreesR1SuccessResponseResultGlTreesGlTreeInner] = Field(description="A list of GL trees.", alias="GlTree")
    __properties: ClassVar[List[str]] = ["GlTree"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in gl_tree (list)
        _items = []
        if self.gl_tree:
            for _item in self.gl_tree:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GlTree": [GetGlTreesR1SuccessResponseResultGlTreesGlTreeInner.from_dict(_item) for _item in obj["GlTree"]] if obj.get("GlTree") is not None else None
        })
        return _obj
