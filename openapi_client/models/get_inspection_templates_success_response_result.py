...
class GetInspectionTemplatesSuccessResponseResult(BaseModel):
    """
    GetInspectionTemplatesSuccessResponseResult
    """ # noqa: E501
    inspection_templates: GetInspectionTemplatesSuccessResponseResultInspectionTemplates = Field(alias="inspectionTemplates")
    __properties: ClassVar[List[str]] = ["inspectionTemplates"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of inspection_templates
        if self.inspection_templates:
            _dict['inspectionTemplates'] = self.inspection_templates.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inspectionTemplates": GetInspectionTemplatesSuccessResponseResultInspectionTemplates.from_dict(obj["inspectionTemplates"]) if obj.get("inspectionTemplates") is not None else None
        })
        return _obj
