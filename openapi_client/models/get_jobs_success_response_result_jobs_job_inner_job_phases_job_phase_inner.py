...
class GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner(BaseModel):
    """
    GetJobsSuccessResponseResultJobsJobInnerJobPhasesJobPhaseInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the job phase.")
    name: StrictStr = Field(description="The name of the job phase.")
    budget: StrictStr = Field(description="The budget allocated to the job phase.")
    __properties: ClassVar[List[str]] = ["id", "name", "budget"]
