...
class SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes(BaseModel):
    """
    SendRentersInsurancePoliciesR1SuccessResponseResultInsurancePoliciesInsurancePolicyInnerAttributes
    """ # noqa: E501
    node: StrictStr = Field(description="Node identifier for the insurance policy")
    reference_id: StrictStr = Field(description="Unique reference ID for the insurance policy")
    lease_id: StrictStr = Field(description="Unique identifier for the lease associated with the policy")
    customer_id: StrictStr = Field(description="Unique identifier for the customer associated with the policy")
    status: StrictStr = Field(description="Status of the insurance policy update or insertion")
    message: StrictStr = Field(description="Message detailing the result of the policy update or insertion")
    __properties: ClassVar[List[str]] = ["node", "reference_id", "lease_id", "customer_id", "status", "message"]
