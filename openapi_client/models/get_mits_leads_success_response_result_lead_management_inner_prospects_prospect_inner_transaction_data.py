...
class GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerTransactionData(BaseModel):
    """
    Transaction-related data for the prospect.
    """ # noqa: E501
    identification: Optional[List[GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerTransactionDataIdentificationInner]] = Field(default=None, description="A list of identification details for the transaction.", alias="Identification")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Identification": [GetMitsLeadsSuccessResponseResultLeadManagementInnerProspectsProspectInnerTransactionDataIdentificationInner.from_dict(_item) for _item in obj["Identification"]] if obj.get("Identification") is not None else None
        })
        return _obj
