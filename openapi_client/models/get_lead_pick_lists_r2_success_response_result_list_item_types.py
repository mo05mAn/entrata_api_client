...
class GetLeadPickListsR2SuccessResponseResultListItemTypes(BaseModel):
    """
    List item types associated with the request.
    """ # noqa: E501
    list_item_type: Optional[List[GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner]] = Field(default=None, description="A list of list item types.", alias="listItemType")
    __properties: ClassVar[List[str]] = ["listItemType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in list_item_type (list)
        _items = []
        if self.list_item_type:
            for _item in self.list_item_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['listItemType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "listItemType": [GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInner.from_dict(_item) for _item in obj["listItemType"]] if obj.get("listItemType") is not None else None
        })
        return _obj
