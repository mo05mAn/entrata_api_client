...
class UpdateSpecialGroupSuccessResponseResponseResult(BaseModel):
    """
    UpdateSpecialGroupSuccessResponseResponseResult
    """ # noqa: E501
    status: StrictStr = Field(description="Status of the operation")
    special_group_id: StrictInt = Field(description="ID of the updated special group", alias="specialGroupId")
    message: StrictStr = Field(description="Detailed message about the operation")
    __properties: ClassVar[List[str]] = ["status", "specialGroupId", "message"]
