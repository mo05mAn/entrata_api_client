...
class GetUnitsAvailabilityAndPricingSuccessResponse(BaseModel):
    """
    ...
    result: Optional[GetUnitsAvailabilityAndPricingSuccessResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": GetUnitsAvailabilityAndPricingSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
