...
class UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenities(BaseModel):
    """
    UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenities
    """ # noqa: E501
    unit_type_amenity: List[UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner] = Field(description="List of unit type amenities updated", alias="unitTypeAmenity")
    __properties: ClassVar[List[str]] = ["unitTypeAmenity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in unit_type_amenity (list)
        _items = []
        if self.unit_type_amenity:
            for _item in self.unit_type_amenity:
                if _item:
                    _items.append(_item.to_dict())
            _dict['unitTypeAmenity'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitTypeAmenity": [UpdateAmenitiesSuccessResponseResponseResultUnitTypeAmenitiesUnitTypeAmenityInner.from_dict(_item) for _item in obj["unitTypeAmenity"]] if obj.get("unitTypeAmenity") is not None else None
        })
        return _obj
