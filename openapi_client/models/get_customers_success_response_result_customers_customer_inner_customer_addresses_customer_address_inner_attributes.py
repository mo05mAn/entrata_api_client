...
class GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddressesCustomerAddressInnerAttributes(BaseModel):
    """
    GetCustomersSuccessResponseResultCustomersCustomerInnerCustomerAddressesCustomerAddressInnerAttributes
    """ # noqa: E501
    address_type: Optional[StrictStr] = Field(default=None, description="Type of the address", alias="AddressType")
