...
class GetVendorPickListsSuccessResponseResultVendorCategoryTypes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultVendorCategoryTypes
    """ # noqa: E501
    vendor_category_type: Optional[List[GetVendorPickListsSuccessResponseResultVendorCategoryTypesVendorCategoryTypeInner]] = Field(default=None, alias="vendorCategoryType")
    __properties: ClassVar[List[str]] = ["vendorCategoryType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in vendor_category_type (list)
        _items = []
        if self.vendor_category_type:
            for _item in self.vendor_category_type:
                if _item:
                    _items.append(_item.to_dict())
            _dict['vendorCategoryType'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vendorCategoryType": [GetVendorPickListsSuccessResponseResultVendorCategoryTypesVendorCategoryTypeInner.from_dict(_item) for _item in obj["vendorCategoryType"]] if obj.get("vendorCategoryType") is not None else None
        })
        return _obj
