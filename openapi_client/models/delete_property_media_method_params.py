...
class DeletePropertyMediaMethodParams(BaseModel):
    """
    DeletePropertyMediaMethodParams
    """ # noqa: E501
    property_id: StrictStr = Field(description="Required. The unique identifier for the property.", alias="propertyId")
    id: StrictStr = Field(description="Required. The unique identifier for the media.")
    __properties: ClassVar[List[str]] = ["propertyId", "id"]
