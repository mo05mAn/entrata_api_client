...
class GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypesInner(BaseModel):
    """
    GetFinancialPickListR1SuccessResponseResultGlReconciliationStatusTypesGlReconciliationStatusTypesInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL reconciliation status type.", alias="Id")
    name: StrictStr = Field(description="The name of the GL reconciliation status type.", alias="Name")
