...
class GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes(BaseModel):
    """
    GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the GL tree.", alias="Id")
    name: StrictStr = Field(description="The name of the GL tree.", alias="Name")
