...
class GetLeadPickListsR1SuccessResponseResponseResultEventTypesEventTypeInnerAttributes(BaseModel):
    """
    Attributes related to the event type.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the event.")
    id: Optional[StrictInt] = Field(default=None, description="The unique ID of the event.", alias="Id")
    entrata_name: Optional[StrictStr] = Field(default=None, description="The name of the event in the system.", alias="entrataName")
    __properties: ClassVar[List[str]] = ["name", "Id", "entrataName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "Id": obj.get("Id"),
            "entrataName": obj.get("entrataName")
        })
        return _obj
