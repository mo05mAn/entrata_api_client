...
class GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerAttributes(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesPropertyAmenitiesAmenityInnerAttributes
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the amenity", alias="Id")
    external_id: Optional[StrictStr] = Field(default=None, description="External identifier for the amenity", alias="ExternalId")
    ...
    __properties: ClassVar[List[str]] = ["Id", "ExternalId", "IsOptional", "IsPublished", "IsFeatured", "HideRates"]
