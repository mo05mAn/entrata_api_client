...
class GetVendorsSuccessResponseResultVendorsVendorInnerApRemittances(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerApRemittances
    """ # noqa: E501
    ap_remittance: Optional[List[GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner]] = Field(default=None, alias="apRemittance")
    __properties: ClassVar[List[str]] = ["apRemittance"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ap_remittance (list)
        _items = []
        if self.ap_remittance:
            for _item in self.ap_remittance:
                if _item:
                    _items.append(_item.to_dict())
            _dict['apRemittance'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apRemittance": [GetVendorsSuccessResponseResultVendorsVendorInnerApRemittancesApRemittanceInner.from_dict(_item) for _item in obj["apRemittance"]] if obj.get("apRemittance") is not None else None
        })
        return _obj
