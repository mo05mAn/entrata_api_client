...
class SendPropertyUnitsSuccessResponseResponseResultUnits(BaseModel):
    """
    SendPropertyUnitsSuccessResponseResponseResultUnits
    """ # noqa: E501
    unit: List[SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner] = Field(description="List of units inserted")
    __properties: ClassVar[List[str]] = ["unit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unit": [SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner.from_dict(_item) for _item in obj["unit"]] if obj.get("unit") is not None else None
        })
        return _obj
