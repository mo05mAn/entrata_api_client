...
class GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes(BaseModel):
    """
    GetSpecialsR1SuccessResponseResponseResultPhysicalPropertyPropertyConcessionInnerAttributes
    """ # noqa: E501
    active: StrictInt = Field(description="Indicates if the concession is active.", alias="Active")
