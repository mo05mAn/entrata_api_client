...
class GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatings(BaseModel):
    """
    GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatings
    """ # noqa: E501
    testimonial_rating: List[GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatingsTestimonialRatingInner] = Field(alias="TestimonialRating")
    __properties: ClassVar[List[str]] = ["TestimonialRating"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in testimonial_rating (list)
        _items = []
        if self.testimonial_rating:
            for _item in self.testimonial_rating:
                if _item:
                    _items.append(_item.to_dict())
            _dict['TestimonialRating'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "TestimonialRating": [GetCustomerTestimonialsSuccessResponseResultTestimonialsTestimonialInnerTestimonialRatingsTestimonialRatingInner.from_dict(_item) for _item in obj["TestimonialRating"]] if obj.get("TestimonialRating") is not None else None
        })
        return _obj
