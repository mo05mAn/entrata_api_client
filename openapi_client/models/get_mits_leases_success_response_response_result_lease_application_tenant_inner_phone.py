...
class GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone(BaseModel):
    """
    GetMitsLeasesSuccessResponseResponseResultLeaseApplicationTenantInnerPhone
    """ # noqa: E501
    phone_type: StrictStr = Field(description="Type of the phone", alias="PhoneType")
    phone_number: StrictStr = Field(description="Phone number of the tenant", alias="PhoneNumber")
    __properties: ClassVar[List[str]] = ["PhoneType", "PhoneNumber"]
