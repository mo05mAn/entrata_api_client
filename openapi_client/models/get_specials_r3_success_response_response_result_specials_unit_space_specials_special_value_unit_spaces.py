...
class GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValueUnitSpaces(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValueUnitSpaces
    """ # noqa: E501
    unit_space: List[GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValueUnitSpacesUnitSpaceInner] = Field(description="List of unit spaces included in the special.", alias="unitSpace")
    __properties: ClassVar[List[str]] = ["unitSpace"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in unit_space (list)
        _items = []
        if self.unit_space:
            for _item in self.unit_space:
                if _item:
                    _items.append(_item.to_dict())
            _dict['unitSpace'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unitSpace": [GetSpecialsR3SuccessResponseResponseResultSpecialsUnitSpaceSpecialsSpecialValueUnitSpacesUnitSpaceInner.from_dict(_item) for _item in obj["unitSpace"]] if obj.get("unitSpace") is not None else None
        })
        return _obj
