...
class GetFloorPlansSuccessResponseResult(BaseModel):
    """
    Result containing floor plan details
    """ # noqa: E501
    floor_plans: Optional[GetFloorPlansSuccessResponseResultFloorPlans] = Field(default=None, alias="FloorPlans")
    __properties: ClassVar[List[str]] = ["FloorPlans"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of floor_plans
        if self.floor_plans:
            _dict['FloorPlans'] = self.floor_plans.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "FloorPlans": GetFloorPlansSuccessResponseResultFloorPlans.from_dict(obj["FloorPlans"]) if obj.get("FloorPlans") is not None else None
        })
        return _obj
