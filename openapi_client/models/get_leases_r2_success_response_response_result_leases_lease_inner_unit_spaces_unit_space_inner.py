...
class GetLeasesR2SuccessResponseResponseResultLeasesLeaseInnerUnitSpacesUnitSpaceInner(BaseModel):
    """
    ...
    unit_space: StrictStr = Field(description="Name of the unit space", alias="unitSpace")
    __properties: ClassVar[List[str]] = ["unitSpaceId", "unitSpace"]
