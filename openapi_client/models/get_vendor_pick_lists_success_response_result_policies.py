...
class GetVendorPickListsSuccessResponseResultPolicies(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultPolicies
    """ # noqa: E501
    policy: Optional[List[GetVendorPickListsSuccessResponseResultPoliciesPolicyInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policy": [GetVendorPickListsSuccessResponseResultPoliciesPolicyInner.from_dict(_item) for _item in obj["policy"]] if obj.get("policy") is not None else None
        })
        return _obj
