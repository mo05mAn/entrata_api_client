...
class UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner(BaseModel):
    """
    UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInner
    """ # noqa: E501
    attributes: UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInnerAttributes = Field(alias="@attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@attributes": UpdateWorkOrdersR1SuccessResponseResponseResultWorkOrdersWorkOrderInnerAttributes.from_dict(obj["@attributes"]) if obj.get("@attributes") is not None else None
        })
        return _obj
