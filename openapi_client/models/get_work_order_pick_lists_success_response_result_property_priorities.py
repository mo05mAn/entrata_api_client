...
class GetWorkOrderPickListsSuccessResponseResultPropertyPriorities(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyPriorities
    """ # noqa: E501
    priority: List[GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner] = Field(alias="Priority")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Priority": [GetWorkOrderPickListsSuccessResponseResultPropertyPrioritiesPriorityInner.from_dict(_item) for _item in obj["Priority"]] if obj.get("Priority") is not None else None
        })
        return _obj
