...
class GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInnerSubMaintenanceProblems(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInnerSubMaintenanceProblems
    """ # noqa: E501
    sub_maintenance_problem: Optional[List[GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInnerSubMaintenanceProblemsSubMaintenanceProblemInner]] = Field(default=None, alias="subMaintenanceProblem")
    __properties: ClassVar[List[str]] = ["subMaintenanceProblem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sub_maintenance_problem (list)
        _items = []
        if self.sub_maintenance_problem:
            for _item in self.sub_maintenance_problem:
                if _item:
                    _items.append(_item.to_dict())
            _dict['subMaintenanceProblem'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subMaintenanceProblem": [GetWorkOrderPickListsSuccessResponseResultPropertyProblemsProblemInnerSubMaintenanceProblemsSubMaintenanceProblemInner.from_dict(_item) for _item in obj["subMaintenanceProblem"]] if obj.get("subMaintenanceProblem") is not None else None
        })
        return _obj
