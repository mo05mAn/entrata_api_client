...
class GetLeadsSuccessResponseResultProspectsProspectInnerLease(BaseModel):
    """
    GetLeadsSuccessResponseResultProspectsProspectInnerLease
    """ # noqa: E501
    lease_id: StrictStr = Field(description="The lease identifier.", alias="leaseId")
    status: StrictStr = Field(description="The status of the lease.")
    lease_interval_id: Optional[StrictStr] = Field(default=None, description="The lease interval ID.", alias="leaseIntervalId")
    expected_move_in_date: Optional[StrictStr] = Field(default=None, description="The expected move-in date.", alias="expectedMoveInDate")
    expected_move_out_date: Optional[List[StrictStr]] = Field(default=None, alias="expectedMoveOutDate")
    lease_from_date: StrictStr = Field(description="The date when the lease starts.", alias="leaseFromDate")
    lease_to_date: Optional[List[StrictStr]] = Field(default=None, alias="leaseToDate")
    __properties: ClassVar[List[str]] = ["leaseId", "status", "leaseIntervalId", "expectedMoveInDate", "expectedMoveOutDate", "leaseFromDate", "leaseToDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expectedMoveInDate": obj.get("expectedMoveInDate"),
            "expectedMoveOutDate": obj.get("expectedMoveOutDate"),
