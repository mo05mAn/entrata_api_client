...
class GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner(BaseModel):
    """
    GetLeasePickListSuccessResponseResultLeaseStatusTypesLeaseStatusTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the lease status type.")
    name: StrictStr = Field(description="Name of the lease status type.")
    type: StrictStr = Field(description="Type of the lease status.")
