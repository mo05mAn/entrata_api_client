...
class GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplans
    """ # noqa: E501
    floorplan: List[GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner] = Field(description="List of floorplans included in the special.")
    __properties: ClassVar[List[str]] = ["floorplan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "floorplan": [GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValueFloorplansFloorplanInner.from_dict(_item) for _item in obj["floorplan"]] if obj.get("floorplan") is not None else None
        })
        return _obj
