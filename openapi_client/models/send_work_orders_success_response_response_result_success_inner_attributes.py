...
class SendWorkOrdersSuccessResponseResponseResultSuccessInnerAttributes(BaseModel):
    """
    Attributes of the success message
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Message indicating success")
    node: Optional[StrictInt] = Field(default=None, description="Node ID where the operation was performed")
    reference_id: Optional[StrictInt] = Field(default=None, description="Reference ID associated with the operation")
    __properties: ClassVar[List[str]] = ["message", "node", "reference_id"]
