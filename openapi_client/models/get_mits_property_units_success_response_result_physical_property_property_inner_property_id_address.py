...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyPropertyInnerPropertyIDAddress(BaseModel):
    """
    Address of the property
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="Street address of the property", alias="Address")
    ...
    postal_code: Optional[StrictStr] = Field(default=None, description="Postal code for the property", alias="PostalCode")
    country: Optional[StrictStr] = Field(default=None, description="Country of the property", alias="Country")
    __properties: ClassVar[List[str]] = ["Address", "City", "State", "PostalCode", "Country"]
