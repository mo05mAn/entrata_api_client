...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerIdentificationAttributes(BaseModel):
    """
    ...
    """ # noqa: E501
    id_type: StrictStr = Field(description="The type of the ID", alias="IDType")
    id_rank: StrictStr = Field(description="The rank of the ID", alias="IDRank")
    id_scope_type: StrictStr = Field(description="The scope type of the ID", alias="IDScopeType")
