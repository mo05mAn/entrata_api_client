...
class GetParcelAlertsSuccessResponseResponseResult(BaseModel):
    """
    GetParcelAlertsSuccessResponseResponseResult
    """ # noqa: E501
    package_batches: GetParcelAlertsSuccessResponseResponseResultPackageBatches = Field(alias="packageBatches")
    __properties: ClassVar[List[str]] = ["packageBatches"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of package_batches
        if self.package_batches:
            _dict['packageBatches'] = self.package_batches.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "packageBatches": GetParcelAlertsSuccessResponseResponseResultPackageBatches.from_dict(obj["packageBatches"]) if obj.get("packageBatches") is not None else None
        })
        return _obj
