...
class GetMitsCollectionsSuccessResponseResponseResultMITSCollectionsPropertyFilesPropertyFileLeaseFilesLeaseFileInnerTenantsInnerPersonDetailsName(BaseModel):
    """
    ...
    """ # noqa: E501
    first_name: StrictStr = Field(description="Customer first name", alias="FirstName")
    last_name: StrictStr = Field(description="Customer last name", alias="LastName")
