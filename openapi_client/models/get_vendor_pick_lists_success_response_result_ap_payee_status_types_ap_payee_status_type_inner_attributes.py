...
class GetVendorPickListsSuccessResponseResultApPayeeStatusTypesApPayeeStatusTypeInnerAttributes(BaseModel):
    """
    GetVendorPickListsSuccessResponseResultApPayeeStatusTypesApPayeeStatusTypeInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the AP payee status type.")
    name: StrictStr = Field(description="Name of the AP payee status type.")
