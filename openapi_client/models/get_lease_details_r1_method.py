...
class GetLeaseDetailsR1Method(BaseModel):
    """
    GetLeaseDetailsR1Method
    """ # noqa: E501
    name: StrictStr
    version: Optional[StrictStr] = None
    params: Optional[GetLeaseDetailsR1MethodParams] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": GetLeaseDetailsR1MethodParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
