...
class GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplansFloorplanRatesRateAttributes(BaseModel):
    """
    GetAmenitiesSuccessResponseResultAmenitiesFloorplanAmenitiesAmenityFloorplansFloorplanRatesRateAttributes
    """ # noqa: E501
    ar_code_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the charge code", alias="ArCodeId")
    ar_code_type_id: Optional[StrictStr] = Field(default=None, description="Type of the charge", alias="ArCodeTypeId")
    charge_type_id: Optional[StrictStr] = Field(default=None, description="Charge type ID", alias="ChargeTypeId")
    amount: Optional[StrictStr] = Field(default=None, description="The amount associated with the rate", alias="Amount")
    is_published: Optional[StrictStr] = Field(default=None, description="Indicates if the rate is published", alias="IsPublished")
    is_active: Optional[StrictStr] = Field(default=None, description="Indicates if the rate is active", alias="IsActive")
    lease_term_id: Optional[StrictStr] = Field(default=None, description="The lease term ID", alias="LeaseTermId")
    lease_start_window_id: Optional[StrictStr] = Field(default=None, description="The lease start window ID", alias="LeaseStartWindowId")
    __properties: ClassVar[List[str]] = ["ArCodeId", "ArCodeTypeId", "ChargeTypeId", "Amount", "IsPublished", "IsActive", "LeaseTermId", "LeaseStartWindowId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ChargeTypeId": obj.get("ChargeTypeId"),
