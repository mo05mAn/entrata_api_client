...
class GetInvoicesR1SuccessResponseResult(BaseModel):
    """
    GetInvoicesR1SuccessResponseResult
    """ # noqa: E501
    invoices: GetInvoicesR1SuccessResponseResultInvoices
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": GetInvoicesR1SuccessResponseResultInvoices.from_dict(obj["invoices"]) if obj.get("invoices") is not None else None
        })
        return _obj
