...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertiesPropertyFloorplansFloorplanInnerDepositAmountValueRange(BaseModel):
    """
    Range for deposit amount
    """ # noqa: E501
    min: StrictStr = Field(description="Minimum deposit amount", alias="Min")
    max: StrictStr = Field(description="Maximum deposit amount", alias="Max")
