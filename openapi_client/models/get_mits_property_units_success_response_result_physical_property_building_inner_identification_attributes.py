...
class GetMitsPropertyUnitsSuccessResponseResultPhysicalPropertyBuildingInnerIdentificationAttributes(BaseModel):
    """
    Attributes related to the building ID
    """ # noqa: E501
    id_scope_type: Optional[StrictStr] = Field(default=None, description="Scope type of the building ID", alias="IDScopeType")
    id_rank: Optional[StrictStr] = Field(default=None, description="Rank of the building ID", alias="IDRank")
    __properties: ClassVar[List[str]] = ["IDScopeType", "IDRank"]
