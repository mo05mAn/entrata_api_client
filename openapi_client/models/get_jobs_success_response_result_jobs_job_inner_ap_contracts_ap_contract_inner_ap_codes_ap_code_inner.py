...
class GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner(BaseModel):
    """
    GetJobsSuccessResponseResultJobsJobInnerApContractsApContractInnerApCodesApCodeInner
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the AP code.")
    job_phase_id: StrictStr = Field(description="The ID of the associated job phase.", alias="jobPhaseId")
    gl_account_id: StrictStr = Field(description="The unique identifier for the general ledger account.", alias="glAccountId")
    contract_amount: StrictStr = Field(description="The amount specified for the AP code in the contract.", alias="contractAmount")
    change_order_id: Optional[StrictStr] = Field(default=None, description="The change order ID if applicable.", alias="changeOrderId")
    __properties: ClassVar[List[str]] = ["id", "jobPhaseId", "glAccountId", "contractAmount", "changeOrderId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changeOrderId": obj.get("changeOrderId")
        })
        return _obj
