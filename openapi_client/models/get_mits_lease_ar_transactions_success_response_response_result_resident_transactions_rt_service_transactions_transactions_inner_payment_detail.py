...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsRTServiceTransactionsTransactionsInnerPaymentDetail(BaseModel):
    """
    ...
    """ # noqa: E501
    description: StrictStr = Field(description="Payment description", alias="Description")
    transaction_id: StrictInt = Field(description="Transaction ID", alias="TransactionID")
    amount_paid: StrictStr = Field(description="Amount paid", alias="AmountPaid")
    balance_due: StrictStr = Field(description="Remaining balance due", alias="BalanceDue")
    __properties: ClassVar[List[str]] = ["Description", "TransactionID", "AmountPaid", "BalanceDue"]
