...
class UpdateVendorsSuccessResponseResultVendorsVendor1Attributes(BaseModel):
    """
    UpdateVendorsSuccessResponseResultVendorsVendor1Attributes
    """ # noqa: E501
    reference_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the vendor update request.")
    status: Optional[StrictStr] = Field(default=None, description="Status of the vendor update.")
    message: Optional[StrictStr] = Field(default=None, description="Message indicating the result of the vendor update.")
