...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerLeaseIDAttributes(BaseModel):
    """
    ...
    id_rank: StrictStr = Field(description="Rank of the lease identifier", alias="IDRank")
