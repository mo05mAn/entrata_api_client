...
class UpdateCustomerTestimonialsMethodParams(BaseModel):
    """
    ...
    transmission_vendor_id: StrictInt = Field(description="This is a required field. This field accepts single value.", alias="transmissionVendorId")
    testimonial_id: Optional[StrictInt] = Field(default=None, description="This is an optional field. This field accepts single value.", alias="testimonialId")
    is_published: StrictBool = Field(description="This is a required field. This field accepts single value.", alias="isPublished")
    __properties: ClassVar[List[str]] = ["propertyId", "transmissionVendorId", "testimonialId", "isPublished"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testimonialId": obj.get("testimonialId"),
