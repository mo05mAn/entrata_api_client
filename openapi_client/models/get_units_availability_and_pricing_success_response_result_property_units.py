...
class GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnits(BaseModel):
    """
    Details about available units in the property
    """ # noqa: E501
    property_unit: List[GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner] = Field(description="List of available units", alias="PropertyUnit")
    __properties: ClassVar[List[str]] = ["PropertyUnit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in property_unit (list)
        _items = []
        if self.property_unit:
            for _item in self.property_unit:
                if _item:
                    _items.append(_item.to_dict())
            _dict['PropertyUnit'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PropertyUnit": [GetUnitsAvailabilityAndPricingSuccessResponseResultPropertyUnitsPropertyUnitInner.from_dict(_item) for _item in obj["PropertyUnit"]] if obj.get("PropertyUnit") is not None else None
        })
        return _obj
