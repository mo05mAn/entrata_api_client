...
class GetLeadPickListsR2SuccessResponseResultListItemTypesListItemTypeInnerAttributes(BaseModel):
    """
    Attributes related to the list item type.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique ID of the list item type.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the list item type.")
