...
class GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner(BaseModel):
    """
    GetFinancialPickListR2SuccessResponseResultGlGroupTypesGlGroupTypeInner
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier for the GL group type.")
    name: StrictStr = Field(description="The name of the GL group type.")
