...
class SendLeadsSuccessResponseResultProspectsProspectInnerApplicants(BaseModel):
    """
    Information about the applicants.
    """ # noqa: E501
    applicant: Optional[List[SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner]] = Field(default=None, description="A list of applicants.")
    __properties: ClassVar[List[str]] = ["applicant"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in applicant (list)
        _items = []
        if self.applicant:
            for _item in self.applicant:
                if _item:
                    _items.append(_item.to_dict())
            _dict['applicant'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicant": [SendLeadsSuccessResponseResultProspectsProspectInnerApplicantsApplicantInner.from_dict(_item) for _item in obj["applicant"]] if obj.get("applicant") is not None else None
        })
        return _obj
