...
class GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutReasonsMoveOutReasonInner(BaseModel):
    """
    GetPropertyPickListsR2SuccessResponseResultPropertiesPropertyInnerMoveOutReasonsMoveOutReasonInner
    """ # noqa: E501
    id: StrictInt = Field(description="Move-out reason ID")
    name: StrictStr = Field(description="Move-out reason name")
    move_out_type_id: StrictInt = Field(description="Associated move-out type ID", alias="moveOutTypeId")
    __properties: ClassVar[List[str]] = ["id", "name", "moveOutTypeId"]
