...
class GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner(BaseModel):
    """
    GetWorkOrderPickListsSuccessResponseResultCompanyEmployeesCompanyEmployeeInner
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the company employee", alias="Id")
    name: StrictStr = Field(description="Name of the company employee", alias="Name")
