...
class GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecials(BaseModel):
    """
    GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecials
    """ # noqa: E501
    special: Dict[str, GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue]
    __properties: ClassVar[List[str]] = ["special"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in special (dict)
        _field_dict = {}
        if self.special:
            for _key in self.special:
                if self.special[_key]:
                    _field_dict[_key] = self.special[_key].to_dict()
            _dict['special'] = _field_dict
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "special": dict(
                (_k, GetSpecialsR3SuccessResponseResponseResultSpecialsFloorplanSpecialsSpecialValue.from_dict(_v))
                for _k, _v in obj["special"].items()
            )
