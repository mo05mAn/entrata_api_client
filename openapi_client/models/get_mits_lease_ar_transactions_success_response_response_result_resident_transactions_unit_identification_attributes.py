...
class GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnitIdentificationAttributes(BaseModel):
    """
    GetMitsLeaseArTransactionsSuccessResponseResponseResultResidentTransactionsUnitIdentificationAttributes
    """ # noqa: E501
    id_type: Optional[StrictStr] = Field(default=None, description="Unit ID", alias="IDType")
