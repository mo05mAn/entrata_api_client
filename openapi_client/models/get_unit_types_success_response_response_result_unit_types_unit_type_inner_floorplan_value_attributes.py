...
class GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValueAttributes(BaseModel):
    """
    GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerFloorplanValueAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Floorplan ID", alias="Id")
