...
class GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInnerAttributes(BaseModel):
    """
    GetGlTreesR1SuccessResponseResultGlTreesGlTreeInnerGlAccountsGlAccountInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the GL account.", alias="Id")
    branch_id: StrictStr = Field(description="The unique identifier for the branch.", alias="BranchId")
    __properties: ClassVar[List[str]] = ["Id", "BranchId"]
