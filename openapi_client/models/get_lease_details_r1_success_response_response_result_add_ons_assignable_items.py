...
class GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems(BaseModel):
    """
    GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItems
    """ # noqa: E501
    assignable_item: List[GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner] = Field(alias="assignableItem")
    __properties: ClassVar[List[str]] = ["assignableItem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in assignable_item (list)
        _items = []
        if self.assignable_item:
            for _item in self.assignable_item:
                if _item:
                    _items.append(_item.to_dict())
            _dict['assignableItem'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignableItem": [GetLeaseDetailsR1SuccessResponseResponseResultAddOnsAssignableItemsAssignableItemInner.from_dict(_item) for _item in obj["assignableItem"]] if obj.get("assignableItem") is not None else None
        })
        return _obj
