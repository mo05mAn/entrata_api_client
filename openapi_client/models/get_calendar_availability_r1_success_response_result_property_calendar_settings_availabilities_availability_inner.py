...
class GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner(BaseModel):
    """
    GetCalendarAvailabilityR1SuccessResponseResultPropertyCalendarSettingsAvailabilitiesAvailabilityInner
    """ # noqa: E501
    day: StrictStr = Field(description="Day of the week")
    start_time: StrictStr = Field(description="Start time of the availability slot", alias="startTime")
    end_time: StrictStr = Field(description="End time of the availability slot", alias="endTime")
    simultaneous_appointment_limit: StrictStr = Field(description="Limit of simultaneous appointments", alias="simultaneousAppointmentLimit")
    __properties: ClassVar[List[str]] = ["day", "startTime", "endTime", "simultaneousAppointmentLimit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "simultaneousAppointmentLimit": obj.get("simultaneousAppointmentLimit")
        })
        return _obj
