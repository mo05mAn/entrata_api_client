...
class GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerAttributes(BaseModel):
    """
    GetRentersInsurancePoliciesSuccessResponseResultLeaseApplicationTenantInnerAttributes
    """ # noqa: E501
    resident_type: StrictStr = Field(description="Type of resident", alias="ResidentType")
    __properties: ClassVar[List[str]] = ["ResidentType"]
