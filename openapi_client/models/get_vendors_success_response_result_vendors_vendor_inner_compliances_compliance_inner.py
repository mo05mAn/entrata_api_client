...
class GetVendorsSuccessResponseResultVendorsVendorInnerCompliancesComplianceInner(BaseModel):
    """
    GetVendorsSuccessResponseResultVendorsVendorInnerCompliancesComplianceInner
    """ # noqa: E501
    legal_entity_id: StrictStr = Field(description="ID of the legal entity.", alias="legalEntityId")
    legal_entity: StrictStr = Field(description="Name of the legal entity.", alias="legalEntity")
    property_id: StrictStr = Field(description="ID of the property.", alias="propertyId")
    status_id: StrictStr = Field(description="ID of the compliance status.", alias="statusId")
    status: StrictStr = Field(description="Compliance status.")
    __properties: ClassVar[List[str]] = ["legalEntityId", "legalEntity", "propertyId", "statusId", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "legalEntity": obj.get("legalEntity"),
