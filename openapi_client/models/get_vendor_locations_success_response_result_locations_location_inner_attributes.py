...
class GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes(BaseModel):
    """
    GetVendorLocationsSuccessResponseResultLocationsLocationInnerAttributes
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the location.", alias="Id")
