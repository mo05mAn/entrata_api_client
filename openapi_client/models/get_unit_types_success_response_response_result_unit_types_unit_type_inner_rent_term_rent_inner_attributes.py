...
class GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRentTermRentInnerAttributes(BaseModel):
    """
    GetUnitTypesSuccessResponseResponseResultUnitTypesUnitTypeInnerRentTermRentInnerAttributes
    """ # noqa: E501
    lease_term: StrictStr = Field(description="Duration of the lease", alias="leaseTerm")
    lease_term_id: StrictInt = Field(description="Unique identifier for the lease term", alias="leaseTermId")
    lease_term_name: StrictStr = Field(description="Name of the lease term", alias="leaseTermName")
    rent: StrictStr = Field(description="Rent for the unit for this lease term")
    start_date: StrictStr = Field(description="Start date of the lease term", alias="startDate")
    end_date: StrictStr = Field(description="End date of the lease term", alias="endDate")
    space_option: StrictStr = Field(description="Space option for the unit", alias="spaceOption")
    is_sold_out: StrictBool = Field(description="Whether the unit is sold out", alias="isSoldOut")
    __properties: ClassVar[List[str]] = ["leaseTerm", "leaseTermId", "leaseTermName", "rent", "startDate", "endDate", "spaceOption", "isSoldOut"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spaceOption": obj.get("spaceOption"),
