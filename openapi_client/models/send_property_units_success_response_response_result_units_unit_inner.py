...
class SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner(BaseModel):
    """
    SendPropertyUnitsSuccessResponseResponseResultUnitsUnitInner
    """ # noqa: E501
    node: StrictInt = Field(description="Unique identifier for the unit node")
    unit_id: StrictInt = Field(description="Unique identifier for the unit", alias="unitId")
    unit_number: StrictStr = Field(description="Unit number", alias="unitNumber")
    unit_space: StrictStr = Field(description="Space associated with the unit", alias="unitSpace")
    status: StrictStr = Field(description="Status of the unit operation")
    message: StrictStr = Field(description="Message about the unit operation")
    __properties: ClassVar[List[str]] = ["node", "unitId", "unitNumber", "unitSpace", "status", "message"]
