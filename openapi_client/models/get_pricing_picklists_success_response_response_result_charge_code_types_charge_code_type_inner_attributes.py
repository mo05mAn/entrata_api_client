...
class GetPricingPicklistsSuccessResponseResponseResultChargeCodeTypesChargeCodeTypeInnerAttributes(BaseModel):
    """
    Attributes of each charge code type
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the charge code type")
    name: Optional[StrictStr] = Field(default=None, description="Name of the charge code type")
    allowed_charge_timing_ids: Optional[StrictStr] = Field(default=None, description="Comma-separated list of allowed charge timing IDs for the charge code type")
    __properties: ClassVar[List[str]] = ["id", "name", "allowed_charge_timing_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "allowed_charge_timing_ids": obj.get("allowed_charge_timing_ids")
        })
        return _obj
