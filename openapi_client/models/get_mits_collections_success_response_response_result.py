...
class GetMitsCollectionsSuccessResponseResponseResult(BaseModel):
    """
    The result of the API request
    """ # noqa: E501
    mits_collections: Optional[GetMitsCollectionsSuccessResponseResponseResultMITSCollections] = Field(default=None, alias="MITS-Collections")
    __properties: ClassVar[List[str]] = ["MITS-Collections"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of mits_collections
        if self.mits_collections:
            _dict['MITS-Collections'] = self.mits_collections.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "MITS-Collections": GetMitsCollectionsSuccessResponseResponseResultMITSCollections.from_dict(obj["MITS-Collections"]) if obj.get("MITS-Collections") is not None else None
        })
        return _obj
