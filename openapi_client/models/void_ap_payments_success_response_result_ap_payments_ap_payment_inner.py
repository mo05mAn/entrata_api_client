...
class VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner(BaseModel):
    """
    VoidApPaymentsSuccessResponseResultApPaymentsApPaymentInner
    """ # noqa: E501
    node: Optional[StrictStr] = Field(default=None, description="The node identifier of the payment.")
    status: Optional[StrictStr] = Field(default=None, description="Status of the payment void operation.")
    message: Optional[StrictStr] = Field(default=None, description="Message indicating the result of the payment void.")
    payment_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the payment.", alias="paymentId")
    payment_number: Optional[StrictStr] = Field(default=None, description="The payment number.", alias="paymentNumber")
    __properties: ClassVar[List[str]] = ["node", "status", "message", "paymentId", "paymentNumber"]
