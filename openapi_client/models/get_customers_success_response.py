...
class GetCustomersSuccessResponse(BaseModel):
    """
    GetCustomersSuccessResponse
    """ # noqa: E501
    request_id: StrictStr = Field(description="The unique identifier for the request", alias="requestId")
    code: StrictStr = Field(description="Response code indicating the status of the request")
    result: GetCustomersSuccessResponseResult
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "result": GetCustomersSuccessResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
