...
class GetMarketingPreferencesMethodParams(BaseModel):
    """
    ...
    customer_ids: StrictStr = Field(description="This is a required field. This field accepts comma seperated multiple values. Customer Ids", alias="customerIds")
    recipient_type_id: Optional[StrictInt] = Field(default=None, description="This is a required field. This field accepts single value. Possible values are 1 = Lead 2 = Resident", alias="recipientTypeId")
    __properties: ClassVar[List[str]] = ["propertyId", "customerIds", "recipientTypeId"]
