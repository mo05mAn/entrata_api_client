...
class GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecialUnitSpacesUnitSpace(BaseModel):
    """
    GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecialUnitSpacesUnitSpace
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier for the unit space.")
    building_id: StrictStr = Field(description="The building ID for the unit space.", alias="buildingId")
    building_name: StrictStr = Field(description="The name of the building.", alias="buildingName")
    property_unit_id: StrictStr = Field(description="The property unit ID for the unit space.", alias="propertyUnitId")
    name: StrictStr = Field(description="The name of the unit space.")
    rates: List[GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecialUnitSpacesUnitSpaceRatesInner] = Field(description="List of rates associated with the unit space.")
    lease_terms: List[GetSpecialsR2SuccessResponseSpecialsPropertySpecialsSpecialLeaseTermsInner] = Field(description="List of lease terms for the unit space.", alias="leaseTerms")
    __properties: ClassVar[List[str]] = ["id", "buildingId", "buildingName", "propertyUnitId", "name", "rates", "leaseTerms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "rates": [GetSpecialsR2SuccessResponseSpecialsUnitSpaceSpecialsSpecialUnitSpacesUnitSpaceRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None,
