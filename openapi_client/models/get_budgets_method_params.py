...
class GetBudgetsMethodParams(BaseModel):
    """
    GetBudgetsMethodParams
    """ # noqa: E501
    property_ids: StrictStr = Field(description="This is a required field. This field accepts comma seperated multiple values. propertyIds", alias="propertyIds")
    budget_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. budgetIds", alias="budgetIds")
    budget_status_type_ids: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. budgetStatusTypeIds", alias="budgetStatusTypeIds")
    fiscal_years: Optional[StrictStr] = Field(default=None, description="This is an optional field. This field accepts comma seperated multiple values. fiscalYears", alias="fiscalYears")
    __properties: ClassVar[List[str]] = ["propertyIds", "budgetIds", "budgetStatusTypeIds", "fiscalYears"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "budgetStatusTypeIds": obj.get("budgetStatusTypeIds"),
            "fiscalYears": obj.get("fiscalYears")
        })
        return _obj
