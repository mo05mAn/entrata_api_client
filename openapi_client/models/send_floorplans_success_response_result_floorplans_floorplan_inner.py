...
class SendFloorplansSuccessResponseResultFloorplansFloorplanInner(BaseModel):
    """
    SendFloorplansSuccessResponseResultFloorplansFloorplanInner
    """ # noqa: E501
    node: StrictInt = Field(description="Node identifier for the floorplan")
    status: StrictStr = Field(description="Status of the floorplan insertion")
    floorplan_id: StrictInt = Field(description="Unique identifier for the floorplan", alias="floorplanId")
    name: StrictStr = Field(description="Name of the floorplan")
    message: StrictStr = Field(description="Message related to the floorplan insertion")
    __properties: ClassVar[List[str]] = ["node", "status", "floorplanId", "name", "message"]
